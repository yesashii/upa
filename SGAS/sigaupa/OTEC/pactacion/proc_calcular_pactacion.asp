...
q_dcur_ncorr 	= request.Form("dcur_ncorr")
...
'response.Write("<br>Estado: "&conexion.obtenerEstadoTransaccion)
...
'------------------------------------------------------------------------------------------------------------------
if q_num_oc<>"" then
	url = "pactacion_cargo.asp?num_oc="&q_num_oc&"&fpot_ccod="&q_fpot_ccod&"&dgso_ncorr="&q_dgso_ncorr&"&q_tipo_persona="&q_tipo_persona&"&tcom_ccod=" & v_tcom_ccod & "&inst_ccod=" & v_inst_ccod & "&comp_ndocto=" & v_comp_ndocto & "&pers_ncorr_codeudor=" & pers_ncorr_codeudor
else
	url = "pactacion_cargo.asp?fpot_ccod="&q_fpot_ccod&"&dgso_ncorr="&q_dgso_ncorr&"&q_tipo_persona="&q_tipo_persona&"&tcom_ccod=" & v_tcom_ccod & "&inst_ccod=" & v_inst_ccod & "&comp_ndocto=" & v_comp_ndocto & "&pers_ncorr_codeudor=" & pers_ncorr_codeudor
end if
