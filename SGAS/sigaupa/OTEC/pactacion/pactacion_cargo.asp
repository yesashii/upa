...
'--ACTUALIZACION--
'
'FECHA ACTUALIZACION 	:24/04/2013
'ACTUALIZADO POR		:Luis Herrera.
...
if v_pote_ncorr="15860" then 'Caso especial, eliminar despues del 22/01/2013

				sql_datos_postulante= 	" Select a.pers_ncorr,d.dcur_ncorr,a.epot_ccod,d.dcur_tdesc, "&vbcrlf&_
										"  575000 as spac_mdescuento,"&vbcrlf&_
										"  575000 as c_comp_mdescuento,"&vbcrlf&_
										" (c.ofot_nmatricula+c.ofot_narancel)- 575000 as c_comp_mdocumento,"&vbcrlf&_
										" c.ofot_nmatricula+c.ofot_narancel as c_arancel "&vbcrlf&_
										" from postulacion_otec a "&vbcrlf&_
										"join datos_generales_secciones_otec b  "&vbcrlf&_
										"    on a.pers_ncorr="&v_pers_ncorr &vbcrlf&_
...
'--------------------------------------------------------------------------------------------------ACTUALIZACIÓN 24_04_2013 
consulta  = ""
consulta = consulta & "select a.tcom_ccod, " & vbCrLf
consulta = consulta & "       a.ting_ccod, " & vbCrLf
consulta = consulta & "       a.ting_ccod                                                         as " & vbCrLf
consulta = consulta & "       c_ting_ccod, " & vbCrLf
consulta = consulta & "       b.comp_ndocto, " & vbCrLf
consulta = consulta & "       b.sfpa_mmonto, " & vbCrLf
consulta = consulta & "       b.sfpa_ncuotas, " & vbCrLf
consulta = consulta & "       b.sfpa_ndocto_inicial, " & vbCrLf
consulta = consulta & "       b.sfpa_nfrecuencia, " & vbCrLf
consulta = consulta & "       b.sfpa_finicio_pago, " & vbCrLf
consulta = consulta & "       b.banc_ccod, " & vbCrLf
consulta = consulta & "       b.plaz_ccod, " & vbCrLf
consulta = consulta & "       b.sfpa_tctacte, " & vbCrLf
consulta = consulta & "       isnull(b.pers_ncorr_codeudor, ' " & pers_ncorr_codeudor & " ')      as " & vbCrLf
consulta = consulta & "       pers_ncorr_codeudor, " & vbCrLf
consulta = consulta & "       ltrim(rtrim(isnull(b.sfpa_mtasa_interes, isnull(c.tint_mtasa, 0)))) as " & vbCrLf
consulta = consulta & "       sfpa_mtasa_interes, " & vbCrLf
consulta = consulta & "       case isnull(b.ting_ccod, 0) " & vbCrLf
consulta = consulta & "         when 0 then 'N' " & vbCrLf
consulta = consulta & "         else 'S' " & vbCrLf
consulta = consulta & "       end                                                                 as " & vbCrLf
consulta = consulta & "       butiliza " & vbCrLf
consulta = consulta & "from   ("&sql_oc_variable&") as a " & vbCrLf
consulta = consulta & "       left outer join sim_forma_pactaciones as b " & vbCrLf
consulta = consulta & "                    on a.ting_ccod = b.ting_ccod " & vbCrLf
consulta = consulta & "                       and cast(b.comp_ndocto as varchar) = " & vbCrLf
consulta = consulta & "                           ' " & q_comp_ndocto & " ' " & vbCrLf
consulta = consulta & "       left outer join tasas_interes as c " & vbCrLf
consulta = consulta & "                    on a.ting_ccod = c.ting_ccod " & vbCrLf
consulta = consulta & "                       and c.ttin_ccod = 1 " & vbCrLf
consulta = consulta & "                       and c.peri_ccod = ' " & v_peri_ccod & " ' "			
'--------------------------------------------------------------------------------------------------ACTUALIZACIÓN 24_04_2013 
