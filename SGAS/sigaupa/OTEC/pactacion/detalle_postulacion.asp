...
'									"	 and a.empr_ncorr_otic*=y.pers_ncorr"		
			...
			sql_datos_postulante= 	" select top 1 protic.obtener_rut(x.pers_ncorr) as rut_empresa,x.pers_tnombre as empresa, "&vbcrlf&_
									...
									"	ON a.pers_ncorr = e.pers_ncorr AND cast(a.pers_ncorr as varchar) = '"&q_pers_ncorr&"' "&vbcrlf&_
									...
									"	LEFT OUTER JOIN personas x "&vbcrlf&_
									"	ON a.empr_ncorr_empresa = x.pers_ncorr "&vbcrlf&_
									"	LEFT OUTER JOIN personas y "&vbcrlf&_
									"	ON a.empr_ncorr_otic = y.pers_ncorr "	
...
'									"	 and a.empr_ncorr_otic*=y.pers_ncorr"		
			...
			sql_datos_postulante= 	" select top 1 protic.obtener_rut(x.pers_ncorr) as rut_empresa,x.pers_tnombre as empresa, "&vbcrlf&_
									...
									"	from postulacion_otec a "&vbcrlf&_
									"	INNER JOIN personas e "&vbcrlf&_
									"	ON a.pers_ncorr = e.pers_ncorr AND cast(a.empr_ncorr_empresa as varchar) = '"&q_pers_ncorr&"' and a.dgso_ncorr = '"&q_dgso_ncorr&"' "&vbcrlf&_
									"	INNER JOIN datos_generales_secciones_otec b "&vbcrlf&_
									"	ON a.dgso_ncorr = b.dgso_ncorr "&vbcrlf&_
									"	INNER JOIN ofertas_otec c "&vbcrlf&_
									"	ON b.dgso_ncorr = c.dgso_ncorr "&vbcrlf&_
									"	INNER JOIN diplomados_cursos d "&vbcrlf&_
									"	ON c.dcur_ncorr = d.dcur_ncorr and c.dcur_ncorr = d.dcur_ncorr "&vbcrlf&_
									"	LEFT OUTER JOIN personas x "&vbcrlf&_
									"	ON a.empr_ncorr_empresa = x.pers_ncorr "&vbcrlf&_
									"	LEFT OUTER JOIN  personas y "&vbcrlf&_
									"	ON a.empr_ncorr_otic = y.pers_ncorr "	
...
'									"	 and a.empr_ncorr_otic*=y.pers_ncorr"		
			...
			sql_datos_postulante= 	" select top 1 protic.obtener_rut(x.pers_ncorr) as rut_empresa,x.pers_tnombre as empresa, "&vbcrlf&_
									...
									"	from postulacion_otec a "&vbcrlf&_
									"	INNER JOIN personas e "&vbcrlf&_
									"	ON a.pers_ncorr = e.pers_ncorr AND cast(a.empr_ncorr_otic as varchar) = '"&q_pers_ncorr&"' AND a.dgso_ncorr = '"&q_dgso_ncorr&"' "&vbcrlf&_
									"	INNER JOIN datos_generales_secciones_otec b "&vbcrlf&_
									"	ON a.dgso_ncorr = b.dgso_ncorr "&vbcrlf&_
									"	INNER JOIN ofertas_otec c "&vbcrlf&_
									"	ON b.dgso_ncorr = c.dgso_ncorr "&vbcrlf&_
...
if v_norc_empresa<>"" then
			...
			sql_detalle_postulantes="select protic.obtener_rut(a.pers_ncorr) as rut_alumno, pers_tnombre, pers_tape_paterno, pers_tape_materno "&vbcrlf&_ 
								...
								"  and case when a.fpot_ccod=4 then norc_otic else a.norc_empresa end="&v_norc_empresa&" "&vbcrlf&_
								"  and a.dgso_ncorr=b.dgso_ncorr "&vbcrlf&_
								"  and b.dgso_ncorr=c.dgso_ncorr "&vbcrlf&_
								"  and c.dcur_ncorr=d.dcur_ncorr "&vbcrlf&_
          ...
          <tr>
            ...
            <form name="edicion">
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <br/>
				  P&aacute;ginas:&nbsp; <%f_detalle.AccesoPagina%>
