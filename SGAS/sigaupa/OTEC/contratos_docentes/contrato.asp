...
"protic.obtener_rut(a.pers_ncorr)as Rut_Docente,datepart(dd,cdot_finicio)as dia_actual,datepart(yyyy,cdot_finicio)as ano_actual,"& vbCrLf &_ 																			
...
"protic.trunc(cdot_finicio) as cdot_ffinicio,"& vbCrLf &_
...
f_datos.Siguiente
 ...
 f_anexos.Inicializar conexion
				 ...
				 selec_anexos="select  mote_tdesc,dcur_ncorr,anot_ncodigo,daot_mhora,daot_nhora,protic.trunc(anot_finicio)as anot_finicio,protic.trunc(anot_ffin)as anot_ffin,anot_ncuotas,seot_tdesc,"& vbCrLf &_
							...
							"and rp.pers_ncorr="&q_pers_ncorr&""& vbCrLf &_
							"group by mote_tdesc,dcur_ncorr,anot_ncodigo,daot_mhora,daot_nhora,anot_finicio,anot_ffin,anot_ncuotas,seot_tdesc"	
 f_anexos.Consultar selec_anexos
 'f_anexos.Siguiente
 
 'response.Write(selec_anexos&"<br/>")
...
pdf.Open()
''__________________________________________________________HONORARIOS____________________________________________________________________________________________________________________
...
dcur_ncorr=f_anexos.ObtenerValor("dcur_ncorr")
dcur_tdesc=conexion.consultaUno("select upper(dcur_tdesc) from diplomados_cursos where dcur_ncorr="&dcur_ncorr)
...
pdf.ln(9)
pdf.MultiCell 170,5,"    PROGRAMA: "&dcur_tdesc&"","","0","L"
pdf.ln(9)
...
pdf.SetFont "Arial","",12
pdf.ln(0)
pdf.MultiCell 180,5,"                     Los cursos referidos en la cláusula anterior se impartirán en un número de "&f_anexos.ObtenerValor("daot_nhora")&" horas, El valor utilizado por hora cronológica en el cálculo es de :"&valor_hora_a&"","","","L"
pdf.ln(5)
pdf.SetFont "Arial","B",12
pdf.Cell 180,5,"    Tercero:","","","L"
pdf.SetFont "Arial","",12
