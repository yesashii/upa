...
formulario.Carga_Parametros "numeros_notas_credito.xml", "detalle_facturas"
...
if conexion.ObtenerEstadoTransaccion  then
	...
	session("mensajeError")="Ocurrio un error al intentar actualizar uno o mas rangos notas de credito.\nAsegurece de haber ingresado los datos correctos y vuelva a intentarlo."
end if
response.Redirect(Request.ServerVariables("HTTP_REFERER"))
%>