...
nombre = conexion.consultauno("select pers_tnombre from personas where cast(pers_nrut as varchar) ='"&q_pers_nrut&"' and cast(pers_xdv as varchar) = '"&q_pers_xdv&"'")
	...
	select case q_tipo_persona
		case "1"
			sql_datos_postulante= 	" Select 1 as alumnos,a.pers_ncorr,d.dcur_ncorr,a.epot_ccod,d.dcur_tdesc,c.ofot_nmatricula,c.ofot_narancel, "&vbcrlf&_
									" isnull(c.ofot_nmatricula,0) as monto_matricula,isnull(c.ofot_narancel,0) as monto_arancel,a.fpot_ccod, "&vbcrlf&_
									" isnull(c.ofot_nmatricula,0)+isnull(c.ofot_narancel,0) as monto_total, isnull(d.tdet_ccod,1281) as tdet_ccod,"&vbcrlf&_
								    ...
								    " and a.dgso_ncorr*=f.dgso_ncorr "
		case "2"
	
			sql_datos_postulante= 	" Select count(a.pers_ncorr) as alumnos,a.empr_ncorr_empresa as pers_ncorr,d.dcur_ncorr,a.epot_ccod,d.dcur_tdesc,sum(c.ofot_nmatricula) as ofot_nmatricula, "&vbcrlf&_
								" sum(c.ofot_narancel) as ofot_narancel,a.fpot_ccod,0 as monto_matricula,ocot_monto_empresa as monto_arancel, isnull(d.tdet_ccod,1281) as tdet_ccod,nord_compra, "&vbcrlf&_
								" sum(isnull(c.ofot_nmatricula,0))+sum(isnull(c.ofot_narancel,0)) as monto_total,ocot_monto_empresa as financia_empresa,ocot_monto_otic as financia_otic "&vbcrlf&_
								" from postulacion_otec a, datos_generales_secciones_otec b ,  "&vbcrlf&_
								" ofertas_otec c , diplomados_cursos d, personas e, ordenes_compras_otec f "&vbcrlf&_
								" where cast(e.pers_nrut as varchar)='"&q_pers_nrut&"' "&vbcrlf&_
								...
								" group by ocot_monto_empresa,ocot_monto_otic,a.empr_ncorr_empresa,d.dcur_ncorr,a.epot_ccod,d.dcur_tdesc,a.fpot_ccod,d.tdet_ccod,nord_compra "
		case "3"
	
			sql_datos_postulante= 	" Select a.empr_ncorr_otic as pers_ncorr,d.dcur_ncorr,a.epot_ccod,d.dcur_tdesc,sum(c.ofot_nmatricula) as ofot_nmatricula,sum(c.ofot_narancel) as ofot_narancel,a.fpot_ccod, "&vbcrlf&_
								" sum(isnull(c.ofot_nmatricula,0)) as monto_matricula,sum(isnull(c.ofot_narancel,0)) as monto_arancel, isnull(d.tdet_ccod,1281) as tdet_ccod,nord_compra, "&vbcrlf&_
								" sum(isnull(c.ofot_nmatricula,0))+sum(isnull(c.ofot_narancel,0)) as monto_total,ocot_monto_empresa as financia_empresa,ocot_monto_otic as financia_otic "&vbcrlf&_
								" from postulacion_otec a, datos_generales_secciones_otec b ,  "&vbcrlf&_
								" ofertas_otec c , diplomados_cursos d, personas e,ordenes_compras_otec f "&vbcrlf&_
								" where cast(e.pers_nrut as varchar)='"&q_pers_nrut&"' "&vbcrlf&_
								...
								" and a.dgso_ncorr=f.dgso_ncorr "&vbcrlf&_
								" and a.empr_ncorr_empresa=case when a.fpot_ccod=4 then f.empr_ncorr_2 else f.empr_ncorr end "&vbcrlf&_
								" group by ocot_monto_empresa,ocot_monto_otic,a.empr_ncorr_otic,d.dcur_ncorr,a.epot_ccod,d.dcur_tdesc,a.fpot_ccod,d.tdet_ccod,nord_compra "
		end select
else
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td valign="top" bgcolor="#EAEAEA">	  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
                ...
                <tr>
                  <td width="81%"><div align="center">
                    <table width="98%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="114"><div align="right"><strong>R.U.T. Alumno</strong></div></td>
                        <td width="27"><div align="center">:</div></td>
                        <td width="147"><%f_busqueda.DibujaCampo("pers_nrut")%>-<%f_busqueda.DibujaCampo("pers_xdv")%> 
						<%pagina.DibujarBuscaPersonas "busqueda[0][pers_nrut]", "busqueda[0][pers_xdv]"%></td>
						<td width="10"></td>
						<td width="95"><strong>Tipo Persona</strong></td>
						<td width="9">:</td>
						<td width="117"><%f_busqueda.DibujaCampo("tipo_persona")%></td>
                      </tr>
                    </table>
                  </div></td>
