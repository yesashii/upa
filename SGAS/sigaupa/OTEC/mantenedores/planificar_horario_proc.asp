...
if request.form("pl[0][bhot_nayudantia]") <> "1" then
	...
	consulta = "select isnull(maot_nhoras_ayudantia,0) from secciones_otec a, mallas_otec b where cast(seot_ncorr as varchar) = '"& seot_ncorr &"' and a.maot_ncorr=b.maot_ncorr "
	horas_asig = cint(conectar.consultaUno(consulta))
	'response.Write("<br>horas_asig "&horas_asig)
end if
