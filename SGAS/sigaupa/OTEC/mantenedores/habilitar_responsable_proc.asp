...
pers_ncorr = formulario.ObtenerValorPost (filai, "pers_ncorr")
	...
	Sinsert="update   responsable_unidad set esre_ccod='1', audi_tusuario='"&usu&"', audi_fmodificacion=getdate() where udpo_ccod="&UDPO_CCOD&" and pers_ncorr="&pers_ncorr&""
					'response.Write("<br>"&Sinsert)
					conexion.ejecutaS(Sinsert)
					
		if conexion.ObtenerEstadoTransaccion  then
		session("mensajeError")="El Responsable fue Habilitado"
		else'
			session("mensajeError")="El Responsable NO fue Habilitado."
		end if
