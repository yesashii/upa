		  ...
		  <tr>
			...
			<td>
				...
				<table width="100%"  border="0">
					  ...
					  <tr>
						<td><%pagina.DibujarSubtitulo "Ingresar Responsable"%></td>
					  </tr>
					  <tr>
						<td>&nbsp;</td>
					  </tr>
				 ...
				 <table width="100%">
				 	<tr>
						...
						<td><%formulario.DibujaCampo("pers_nrut")%>-<%formulario.DibujaCampo("pers_xdv")%><%pagina.DibujarBuscaPersonas "a[0][pers_nrut]", "a[0][pers_xdv]"%></td>
					</tr>
					<tr>
				 	...
				 	<tr>
						...
						<td width="84%"><%formulario.DibujaCampo("UDPO_ccod")%></td>
					</tr>
					<tr>
