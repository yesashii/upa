...
consulta =" select MAOT_NCORR,DCUR_NCORR,MOTE_CCOD,MAOT_NHORAS_PROGRAMA,MAOT_NPRESUPUESTO_RELATOR,MAOT_NHORAS_AYUDANTIA,MAOT_NPRESUPUESTO_AYUDANTIA," & vbCrlf & _
          " MAOT_NORDEN,AUDI_TUSUARIO,AUDI_FMODIFICACION,MAOT_ORDEN_RELACION," & vbCrlf & _
		  " isnull(MAOT_NHORAS_ELEARNING,0) as MAOT_NHORAS_ELEARNING,isnull(MAOT_NPRESUPUESTO_ELEARNING,0) as MAOT_NPRESUPUESTO_ELEARNING, " & vbCrlf & _
		  " isnull(MAOT_NHORAS_BILEARNING,0) as MAOT_NHORAS_BILEARNING, isnull(MAOT_NPRESUPUESTO_BILEARNING,0) as MAOT_NPRESUPUESTO_BILEARNING " & vbCrlf & _
...
if tiene_contrato > "0" then
	mensaje = "El programa ya se encuentra asociado a un contrato docente, no olvide que cualquier modificación puede afectar el contrato."
end if
%>
                    ...
                    <td align="center">
                                       <form name="edicion">
										  ...
										  <table width="98%"  border="0" align="center">
											 <tr>
												<td width="32%"><div align="left"><strong>Programa</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
												<td colspan="2"><strong><%=dcur_tdesc%><%formulario.dibujaCampo("maot_ncorr")%></strong></td>
											 </tr>
                                             <tr>
												<td width="32%"><div align="left"><strong>Módulo</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
												<td colspan="2"><strong><%=mote_tdesc%></td>
											 </tr>
                                             <tr>
												<td width="32%"><div align="left"><strong>Horas Programa</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
												<td colspan="2"><%formulario.dibujaCampo("maot_nhoras_programa")%></td>
											 </tr>
                                             <tr>
												<td width="32%"><div align="left"><strong>Presupuesto relator</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
												<td colspan="2"><%formulario.dibujaCampo("maot_npresupuesto_relator")%></td>
											 </tr>
											 <tr>
												<td width="32%"><div align="left"><strong>Horas Ayudantía</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
												<td colspan="2"><%formulario.dibujaCampo("maot_nhoras_ayudantia")%></td>
											 </tr>
                                             <tr>
												<td width="32%"><div align="left"><strong>Presupuesto ayudantía</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
												<td colspan="2"><%formulario.dibujaCampo("maot_npresupuesto_ayudantia")%></td>
											 </tr>
                                             <tr>
												<td width="32%"><div align="left"><strong>Horas E-learning</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
												<td colspan="2"><%formulario.dibujaCampo("maot_nhoras_elearning")%></td>
											 </tr>
                                             <tr>
												<td width="32%"><div align="left"><strong>Presupuesto E-learning</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
												<td colspan="2"><%formulario.dibujaCampo("maot_npresupuesto_elearning")%></td>
											 </tr>
                                             <tr>
												<td width="32%"><div align="left"><strong>Horas Bi-learning</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
												<td colspan="2"><%formulario.dibujaCampo("maot_nhoras_bilearning")%></td>
											 </tr>
                                             <tr>
												<td width="32%"><div align="left"><strong>Presupuesto Bi-learning</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
												<td colspan="2"><%formulario.dibujaCampo("maot_npresupuesto_bilearning")%></td>
											 </tr>
                                             <tr>
												<td width="32%"><div align="left"><strong>Orden en malla</strong></td>
												<td width="3%"><div align="center"><strong>:</strong></td>
