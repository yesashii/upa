...
rut = q_pers_nrut&"-"&q_pers_xdv 
	...
	consulta =  " select a.dgso_ncorr,a.pers_ncorr,datepart(yyyy,dgso_finicio) as anos_ccod,dcur_tdesc as programa, dcur_nsence as sence,datepart(yyyy,dgso_finicio) as anio" & vbCrLf &_
				" from relatores_programa a, " & vbCrLf &_
				...
				" and cast(a.pers_ncorr as varchar)='"&pers_ncorr&"' order by  anos_ccod desc" 
...
f_nuevo.Carga_Parametros "habilitar_relator.xml", "f_nuevo2"
f_nuevo.Inicializar conexion

anos_ccod = conexion.consultaUno("select datePart(year,getDate())")
dgso_ncorr="0"
programa="--"
consulta = "Select '' as anos_ccod,'' as dgso_ncorr, '' as programa"
f_nuevo.consultar consulta
'--Se quita la opción de bloqueo a programas cerrados a solicitud de Guillermo Araya el 22-08-2013
'-------------Marcelo Sandoval--------------------------------------------------------------------

consulta= " select datepart(yyyy,dgso_finicio)as anos_ccod, b.dgso_ncorr,c.sede_tdesc,dcur_tdesc as programa  " & vbCrLf &_
				     ...
				     " and cast(cc.pers_ncorr as varchar)='"&pers_ncorr&"') order by sede_tdesc,anos_ccod,programa"
					 
'response.Write("<pre>"&consulta&"</pre>")

f_nuevo.inicializaListaDependiente "lBusqueda",consulta
f_nuevo.Siguiente
'f_nuevo.AgregaCampoCons "dgso_ncorr", pers_ncorr
            ...
            <td>
                <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
				  	<td align="center">
						<form name="edicion2">
						<input type="hidden" name="n[0][pers_ncorr]" value="<%=pers_ncorr%>"/>
						  <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
						  <tr>
							<td><%pagina.DibujarSubtitulo "Habilitar Relator a Programa"%>
							  ...
							  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
							    <tr>
								  <td width="19%"><strong>Año</strong></td>
								  <td width="1%"><strong>:</strong></td>
								  <td width="80%"><%f_nuevo.dibujaCampoLista "lBusqueda","anos_ccod"%></td>
							    </tr>
								 <tr>
								  <td width="19%"><strong>Sede</strong></td>
								  <td width="1%"><strong>:</strong></td>
								  <td width="80%"><%f_nuevo.dibujaCampoLista "lBusqueda","sede_tdesc"%></td>
							    </tr>
								<tr>
								  <td width="19%"><strong>Programas</strong></td>
								  <td width="1%"><strong>:</strong></td>
								  <td width="80%"><%f_nuevo.dibujaCampoLista "lBusqueda","dgso_ncorr"%></td>
							    </tr>
								<tr> 
								<td width="19%"></td>
								</tr>
