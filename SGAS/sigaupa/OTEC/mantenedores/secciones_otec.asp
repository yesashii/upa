...
"       dcur_ncorr, " & vbCrlf & _
"       sede_ccod, " & vbCrlf & _
"       protic.Trunc(dgso_finicio)  AS dgso_finicio, " & vbCrlf & _
"       protic.Trunc(dgso_ftermino) AS dgso_ftermino, " & vbCrlf & _
"       dgso_ncupo, " & vbCrlf & _
"       dgso_nquorum, " & vbCrlf & _
"       esot_ccod," & vbCrlf & _
"       ISNULL(multianio,0) as multianio," & vbCrlf & _
"       ISNULL(cerrado,0) as cerrado," & vbCrlf & _
"       ISNULL(tiene_entrevista,0) as tiene_entrevista," & vbCrlf & _
"       ISNULL(tiene_test,0) as tiene_test" & vbCrlf & _
          ...
          <tr>
            <td><form name="edicion">
                <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr >
                   <%if detalle="2" then%>
                    <td><table width="559" border="0">
                    <tr>
                    	<td width="100%">
                    	  <table width="100%" border="0">
                    	    <tr>
                    	      <td width="102"><strong>Tiene entrevista</strong></td>
                    	      <td width="14" align="center">:</td>
                    	      <td width="26"><%datos_generales.dibujaCampo("tiene_entrevista")%></td>
                    	      <td width="12">&nbsp;</td>
                    	      <td width="62"><strong>Multi a&ntilde;o</strong></td>
                    	      <td width="19" align="center">:</td>
                    	      <td width="288"><%datos_generales.dibujaCampo("multianio")%></td>
                  	      </tr>
                    	    <tr>
                    	      <td width="102"><strong>Tiene test</strong></td>
                              <td width="14" align="center">:</td>
                    	      <td width="26"><%datos_generales.dibujaCampo("tiene_test")%></td>                  	      
                    	      <td>&nbsp;</td>
                    	      <td><strong>Cerrado</strong></td>
                    	      <td width="19" align="center">:</td>
                    	      <td><%datos_generales.dibujaCampo("cerrado")%></td>
                  	      </tr>
                    	    <tr>
                            	<td>&nbsp;</td>
                                <td>&nbsp;</td>
