...
'*********************************************************************************'-------------
	...
	consulta_horas 		= "" & vbCrLf & _  
						"select isnull((select cast(b.dorc_nhoras as varchar)               " & vbCrLf & _
						"               from   ordenes_compras_otec as a                    " & vbCrLf & _
				...
				'**NumFactura>>	
						...
						'factura 		= conexion.consultaUno(consulta_f) 
...
"       isnull(e.pote_nasistencia_parcial, '0')  as asistencia 			" & vbCrLf & _
...
"                  and nord_compra = '"&tipo_doc&"' 	                " 

'------------------------------------------------------------------------------debug
'consulta = "" & vbCrLf & _
'"select top 37 protic.obtener_rut(a.pers_ncorr) as rut, 				" & vbCrLf & _		
'"       case a.pers_tnombre 									" & vbCrLf & _		
'"         when '' then '' 										" & vbCrLf & _		
'"         else protic.initcap(a.pers_tnombre) 					" & vbCrLf & _		
'"       end                              as pers_tnombre, 		" & vbCrLf & _		
