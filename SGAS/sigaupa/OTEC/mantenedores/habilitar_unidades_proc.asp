...
UDPO_TDESC = formulario.ObtenerValorPost (filai, "UDPO_TDESC")
	...
	Sinsert="update   unidades_dictan_programas_otec set udpo_bhabilitado='S', audi_tusuario='"&usu&"', audi_fmodificacion=getdate()  where udpo_ccod="&UDPO_CCOD&""
...
'else'
	session("mensajeError")="La Unidad se Habilito."
'end if
'response.End()
