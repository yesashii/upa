...
<%
udp_ccod= request.QueryString("UDPO_ccod")
...
consulta= "SELECT UDPO_ccod, UDPO_tdesc " & vbCrlf & _
		  " FROM UNIDADES_DICTAN_PROGRAMAS_OTEC where UDPO_ccod='"&udp_ccod&"' " 
		  ...
		  <tr>
			...
			<td>
				...
				<form name="edicion" method="post"><table width="100%"  border="0">
					  ...
					  <tr>
						<td><%pagina.DibujarSubtitulo "Editar Unidad"%></td>
					  </tr>
					  <tr>
						<td>&nbsp;</td>
					  </tr>
				 ...
				 <table width="98%" align="center">
					  ...
					  <tr> 
						 <td colspan="2" align="center"><% formulario.DibujaCampo ("UDPO_TDESC") %><input type="hidden" value="<%=udp_ccod%>" name="agregar_unidad[0][UDPO_CCOD]" ></td>
					  </tr>
					  <tr> 
			  ...
			  <tr>
				<td width="38%" height="20"><div align="center">
				  <table width="90%"  border="0" cellspacing="0" cellpadding="0">
					<tr>
					  <td><div align="center"><%botonera.dibujaboton "guardar2"%></div></td>
