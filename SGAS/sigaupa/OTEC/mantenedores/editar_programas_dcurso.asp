...
consulta =" select '"&dcur_ncorr&"' as dcur_ncorr,a.mote_ccod,protic.initcap(a.mote_tdesc) + ' (' + ltrim(rtrim(a.mote_ccod)) + ')' as mote_tdesc " & vbCrlf & _
" from modulos_otec a" & vbCrlf & _
" Where ( a.mote_tdesc like '%"&mote_tdesc&"%' or '%"&mote_tdesc&"%' is null )" & vbCrlf & _
" and not exists (select 1 from mallas_otec b where a.mote_ccod=b.mote_ccod and cast(b.dcur_ncorr as varchar)='"&dcur_ncorr&"')" & vbCrlf & _
" and isnull(mote_boculto,0) = 0 "
	...
	if (elemento.checked)
	 {
					...
					if ( (elemento2.type=="checkbox") && (elemento2.name!=str) )
						{
						  if(elemento2.checked)
						  {
							 ...
							 document.edicion.elements["m["+v_indice2+"][maot_nhoras_ayudantia]"].disabled=true;
							 document.edicion.elements["m["+v_indice2+"][maot_npresupuesto_ayudantia]"].disabled=true;
							 document.edicion.elements["m["+v_indice2+"][maot_nhoras_elearning]"].disabled=true;
							 document.edicion.elements["m["+v_indice2+"][maot_npresupuesto_elearning]"].disabled=true;
							 document.edicion.elements["m["+v_indice2+"][maot_nhoras_bilearning]"].disabled=true;
							 document.edicion.elements["m["+v_indice2+"][maot_npresupuesto_bilearning]"].disabled=true;
							 ...
							 document.edicion.elements["m["+v_indice2+"][maot_nhoras_ayudantia]"].value="";
							 document.edicion.elements["m["+v_indice2+"][maot_npresupuesto_ayudantia]"].value="";
							 document.edicion.elements["m["+v_indice2+"][maot_nhoras_elearning]"].value="";
							 document.edicion.elements["m["+v_indice2+"][maot_npresupuesto_elearning]"].value="";
							 document.edicion.elements["m["+v_indice2+"][maot_nhoras_bilearning]"].value="";
							 document.edicion.elements["m["+v_indice2+"][maot_npresupuesto_bilearning]"].value="";
							 ...
							 document.edicion.elements["m["+v_indice2+"][maot_nhoras_ayudantia]"].id="NU-S";
							 document.edicion.elements["m["+v_indice2+"][maot_npresupuesto_ayudantia]"].id="NU-S";
							 document.edicion.elements["m["+v_indice2+"][maot_nhoras_elearning]"].id="NU-S";
							 document.edicion.elements["m["+v_indice2+"][maot_npresupuesto_elearning]"].id="NU-S";
							 document.edicion.elements["m["+v_indice2+"][maot_nhoras_bilearning]"].id="NU-S";
							 document.edicion.elements["m["+v_indice2+"][maot_npresupuesto_bilearning]"].id="NU-S";
		...
		document.edicion.elements["m["+v_indice+"][maot_nhoras_ayudantia]"].disabled=false;
		document.edicion.elements["m["+v_indice+"][maot_npresupuesto_ayudantia]"].disabled=false;
		document.edicion.elements["m["+v_indice+"][maot_nhoras_elearning]"].disabled=false;
		document.edicion.elements["m["+v_indice+"][maot_npresupuesto_elearning]"].disabled=false;
		document.edicion.elements["m["+v_indice+"][maot_nhoras_bilearning]"].disabled=false;
		document.edicion.elements["m["+v_indice+"][maot_npresupuesto_bilearning]"].disabled=false;
		...
		document.edicion.elements["m["+v_indice+"][maot_nhoras_ayudantia]"].id="NU-S";
		document.edicion.elements["m["+v_indice+"][maot_npresupuesto_ayudantia]"].id="NU-S";
		document.edicion.elements["m["+v_indice+"][maot_nhoras_elearning]"].id="NU-S";
		document.edicion.elements["m["+v_indice+"][maot_npresupuesto_elearning]"].id="NU-S";
		document.edicion.elements["m["+v_indice+"][maot_nhoras_bilearning]"].id="NU-S";
		document.edicion.elements["m["+v_indice+"][maot_npresupuesto_bilearning]"].id="NU-S";
	...
	else
	 {
		...
		document.edicion.elements["m["+v_indice+"][maot_nhoras_ayudantia]"].disabled=true;
		document.edicion.elements["m["+v_indice+"][maot_npresupuesto_ayudantia]"].disabled=true;
		document.edicion.elements["m["+v_indice+"][maot_nhoras_elearning]"].disabled=true;
		document.edicion.elements["m["+v_indice+"][maot_npresupuesto_elearning]"].disabled=true;
		document.edicion.elements["m["+v_indice+"][maot_nhoras_bilearning]"].disabled=true;
		document.edicion.elements["m["+v_indice+"][maot_npresupuesto_bilearning]"].disabled=true;
