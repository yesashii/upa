...
session("url_actual")="../mantenedores/ingreso_calificaciones.asp?busqueda[0][dgso_ncorr]="&dgso_ncorr&"&busqueda[0][mote_ccod]="&mote_ccod&"&busqueda[0][seot_ncorr]="&seot_ncorr&"&busqueda[0][anio_admision]="&anio_admision
...
consulta = "  select anio_admision,a.dgso_ncorr,sede_tdesc + ' : ' + c.dcur_tdesc as dgso_tdesc, " & vbCrLf & _
		   "  f.mote_ccod,f.mote_tdesc,seot_ncorr, seot_tdesc " & vbCrLf & _
		   "  from datos_generales_secciones_otec a, sedes b,diplomados_cursos c,secciones_otec d,mallas_otec e, modulos_otec f,ofertas_otec tt  " & vbCrLf & _
		   ...
		   "  and d.maot_ncorr=e.maot_ncorr and e.mote_ccod=f.mote_ccod  and a.dgso_ncorr=tt.dgso_ncorr " & vbCrLf & _
		   "  UNION " & vbCrLf & _
		   "  select anio_admision,a.dgso_ncorr,sede_tdesc + ' : ' + c.dcur_tdesc as dgso_tdesc,    " & vbCrLf & _
		   "  f.mote_ccod,f.mote_tdesc,seot_ncorr, seot_tdesc    " & vbCrLf & _
		   "  from datos_generales_secciones_otec a, sedes b,diplomados_cursos c,secciones_otec d,mallas_otec e, modulos_otec f,ofertas_otec tt " & vbCrLf & _    
		   "  where a.sede_ccod = b.sede_ccod   " & vbCrLf & _  
		   ...
		   "  and a.dgso_ncorr=106  and a.dgso_ncorr=tt.dgso_ncorr "& vbCrLf & _
		   "  UNION " & vbCrLf & _
		   "  select anio_admision,a.dgso_ncorr,sede_tdesc + ' : ' + c.dcur_tdesc as dgso_tdesc,  " & vbCrLf & _
		   "  f.mote_ccod,f.mote_tdesc,seot_ncorr, seot_tdesc  " & vbCrLf & _
		   "  from datos_generales_secciones_otec a, sedes b,diplomados_cursos c,secciones_otec d,mallas_otec e, modulos_otec f,ofertas_otec tt  " & vbCrLf & _
		   "  where a.sede_ccod = b.sede_ccod  " & vbCrLf & _
		   "  and a.dcur_ncorr=c.dcur_ncorr and esot_ccod=1  " & vbCrLf & _
		   "  and a.seot_ncorr_comun=d.seot_ncorr and isnull(a.seot_ncorr_comun,0)<> 0  and a.dgso_ncorr=tt.dgso_ncorr " & vbCrLf & _
		   "  and d.maot_ncorr=e.maot_ncorr and e.mote_ccod=f.mote_ccod  order by anio_admision desc,dgso_tdesc asc "
                      ...
                      <tr>
                        <td width="100%">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  ...
								  <tr> 
									<td colspan="3"><div id="texto_alerta" style="position:absolute; visibility: hidden; width:418px; height: 16px;"><font color="#0000FF" size="-1">Espere 
          ...
          <tr>
            <td>
                <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
                    <td>Los alumnos que aparecen de color en la nómina, estan morosos y no serán grabadas sus calificaciones.</td>
                  </tr>
                </table>
              <br>
            </td></tr>
