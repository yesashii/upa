...
formulario.carga_parametros "cierre_alumnos_otec_tg.xml", "f_listado_asociado"
...
for i=0 to formulario.cuentaPost - 1
	...
	if pers_ncorr  <> "" and dgso_ncorr <> "" and bloqueado = "0" then
	 	consulta_actualizacion = " update postulacion_asociada_otec set vb_finanzas = '"&vb_finanzas&"', vb_biblioteca = '"&vb_biblioteca&"',"&_
		                         " vb_audiovisual = '"&vb_audiovisual&"',audi_tvb = '"&usua&"',audi_fvb = getDate() "&_
