...
rut = q_pers_nrut&"-"&q_pers_xdv 
	...
	consulta =  " select a.dgso_ncorr,a.pers_ncorr,a.anos_ccod,dcur_tdesc as programa, dcur_nsence as sence,a.anos_ccod as anio,tcat_tdesc+ '->($'+cast(tcat_valor as varchar)+')' as tcat_tdesc  " & vbCrLf &_
