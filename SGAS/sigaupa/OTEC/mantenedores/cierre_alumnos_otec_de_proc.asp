...
formulario.carga_parametros "cierre_alumnos_otec_de.xml", "f_listado"
...
for i=0 to formulario.cuentaPost - 1
	...
	if pers_ncorr <> "" and dgso_ncorr <> "" and pote_nnota_final <> "" and pote_nasistencia <> "" and pote_nest_final <> "" and bloqueado = "0" then
	 	consulta_actualizacion = " update postulacion_otec set pote_nnota_final = "&pote_nnota_final&", pote_nasistencia = "&pote_nasistencia&",pote_nest_final = "&pote_nest_final&",audi_tfinal = '"&usua&"',audi_ffinal = getDate() "&_
