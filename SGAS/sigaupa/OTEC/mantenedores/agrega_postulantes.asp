...
anio_admision = conexion.consultaUno("select anio_admision from ofertas_otec where cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and cast(dcur_ncorr as varchar)='"&dcur_ncorr&"' and cast(sede_ccod as varchar)='"&sede_ccod&"'")
...
forma_pago = conexion.consultaUno("select fpot_ccod from postulacion_otec a, personas b where a.pers_ncorr=b.pers_ncorr and cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and cast(pers_nrut as varchar)='"&q_pers_nrut&"' and epot_ccod not in (5) ")
...
consulta= "   select a.pote_ncorr,a.pers_ncorr,a.norc_empresa, " & vbCrlf & _ 
		  ...
		  "   and a.epot_ccod not in (5) " & vbCrlf & _ 
...
if forma_pago = "4" then '-------------en el caso de ser otic debemos ver si ya tiene ingresada la empresa antes de la otic
	tiene_empresa_1 = conexion.consultaUno("select isnull(empr_ncorr_empresa,0) from postulacion_otec a, personas b where a.pers_ncorr=b.pers_ncorr and cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and cast(pers_nrut as varchar)='"&q_pers_nrut&"' and epot_ccod not in (5) ")
...
mensaje_orden=""
if (forma_pago="3" or forma_pago="5") and tiene_postulacion="S" then
	tiene_empresa = conexion.consultaUno("select empr_ncorr_empresa from postulacion_otec a, personas b where a.pers_ncorr=b.pers_ncorr and cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and cast(pers_nrut as varchar)='"&q_pers_nrut&"' and epot_ccod not in (5) ")
	orden_compra  = conexion.consultaUno("select norc_empresa from postulacion_otec a, personas b where a.pers_ncorr=b.pers_ncorr and cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and cast(pers_nrut as varchar)='"&q_pers_nrut&"' and epot_ccod not in (5) ")
...
elseif (forma_pago="4") and tiene_postulacion="S" then
	tiene_empresa = conexion.consultaUno("select empr_ncorr_otic from postulacion_otec a, personas b where a.pers_ncorr=b.pers_ncorr and cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and cast(pers_nrut as varchar)='"&q_pers_nrut&"' and epot_ccod not in (5) ")
	orden_compra  = conexion.consultaUno("select norc_otic from postulacion_otec a, personas b where a.pers_ncorr=b.pers_ncorr and cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and cast(pers_nrut as varchar)='"&q_pers_nrut&"' and epot_ccod not in (5) ")
    registro_orden = conexion.consultaUno("select case count(*) when 0 then 'N' else 'S' end from ordenes_compras_otec where cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and cast(empr_ncorr as varchar)='"&tiene_empresa&"' and cast(nord_compra as varchar)='"&orden_compra&"'")
	empr_ncorr_2 = conexion.consultaUno("select empr_ncorr_empresa from postulacion_otec a, personas b where a.pers_ncorr=b.pers_ncorr and cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and cast(pers_nrut as varchar)='"&q_pers_nrut&"' and epot_ccod not in (5) ")
	if registro_orden = "N" and orden_compra <> "" then
		mensaje_orden = "Aún no agrega los datos de la orden de compra, dichos datos son necesarios para la matrícula, el proceso es una vez independiente de la cantidad de alumnos que beneficie."
...
if tiene_postulacion="S" then
	pote_ncorr = conexion.consultaUno("select pote_ncorr from postulacion_otec a, personas b where a.pers_ncorr=b.pers_ncorr and cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and cast(pers_nrut as varchar)='"&q_pers_nrut&"' and epot_ccod not in (5) order by pote_ncorr desc")
	...
	pers_ncorr_hist = conexion.consultaUno("select pers_ncorr from postulacion_otec where cast(pote_ncorr as varchar)='"&pote_ncorr&"'")
	...
	consulta_historico =  " Select * from (" & vbCrLf &_
						  ...
						  " where cast(c.anio_admision as varchar)='"&anio_admision&"' " & vbCrLf &_
						  " and cast(a.pers_ncorr as varchar)='"&pers_ncorr_hist&"' " & vbCrLf &_
						  " UNION " & vbCrLf &_
						  " select distinct a.pote_ncorr as post_ncorr,a.dgso_ncorr as ofer_ncorr, " & vbCrLf &_
	                      "  protic.initcap(e.sede_tdesc) +' : '+  protic.initCap(f.dcur_tdesc) as escuela, " & vbCrLf &_
		  				  " case a.epot_ccod when 4 then 'Sí' else 'No' end as matriculado, " & vbCrLf &_
		...
		url_observacion = "agrega_postulantes_observacion.asp?dgso_ncorr="&dgso_ncorr&"&pote_ncorr="&pote_ncorr
...
function forma_pago(valor)
{
	...
	if (forma_pago_registrada != valor)
	{
		...
		if ((forma_pago_registrada=="3") || (forma_pago_registrada=="5"))
...
function ValidaRut22()
{
	...
	if (!valida_rut(rut)) {
		alert('Ingrese un rut válido.');		
		document.edicion2.elements['e[0][empr_nrut]'].focus()
		document.edicion2.elements['e[0][empr_nrut]'].select()
		return false;
	}
...
function ValidaRut33()
{
	...
	if (!valida_rut(rut)) {
		alert('Ingrese un rut válido.');		
		document.edicion2.elements['o[0][empr_nrut]'].focus()
		document.edicion2.elements['o[0][empr_nrut]'].select()
		return false;
	}
...
_Buscar(this, document.forms['edicion2'],'agrega_postulantes.asp', 'ValidaRut22();', 'FALSE');
}
...
function genera_digito2 (rut){
 ...
 if (otro_rut == rut)
 ...
 else
	 {
		...
		//alert(rut+IgDigitoVerificador);
		_Buscar(this, document.forms['edicion2'],'agrega_postulantes.asp', 'ValidaRut33();', 'FALSE');
	 }	
}
...
function configurar_orden_compra() {
	...
	direccion = '<%=url_orden%>';
	resultado=window.open(direccion, "ventana1","width=400,height=400,scrollbars=yes,resizable=yes, left=380, top=150");
...
function agregar_observacion() {
	...
	direccion = '<%=url_observacion%>';
	resultado=window.open(direccion, "ventana2","width=500,height=270,scrollbars=yes,resizable=yes, left=380, top=150");
...
{forma_pago = '<%=forma_pago%>';
 valor = 1;
  //alert(formulario.elements["_m[0][datos_persona_correctos]"].checked);
	...
	if (((forma_pago=='3')||(forma_pago=='5'))&&((document.edicion_fin.elements["_m[0][datos_persona_correctos]"].checked==false)||(document.edicion_fin.elements["_m[0][datos_empresa_correctos]"].checked==false)))
		{ valor = 0;
              ...
              <table width="98%"  border="0" align="center">
                <tr>
				 ...
				 <tr>
                    <td width="20%">&nbsp;</td>
					<td width="3%">&nbsp;</td>
                    <td colspan="2" align="right"><% botonera.agregaBotonParam "volver","url","postulacion_otec.asp?b[0][dcur_ncorr]="&dcur_ncorr&"&b[0][sede_ccod]="&sede_ccod&"&detalle=2&b[0][anio_admision]="&anio_admision
                ...
                <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
                                ...
                                <td width="100%">
                                  <table width="100%" border="0">
                                    ...
                                    <tr>
                                      ...
                                      <td width="25%" align="center">Persona Nat. y Empresa</td>
                                    ...
                                    <tr>
                                      ...
                                      <td width="25%" align="center">
                                        <%if datos_postulante.obtenerValor("fpot_ccod")= "5" then %>
                                        <input type="radio" name="m[0][fpot_ccod]" value="5" checked onClick="forma_pago(this.value);">
                                        <%else%>
                                        <input type="radio" name="m[0][fpot_ccod]" value="5" onClick="forma_pago(this.value);">
                                        <%end if%>
                                      </td>
                                      <td width="25%" align="center">
                      ...
                      <form name="edicion2">
                        ...
                        <%if forma_pago="3" or forma_pago="4" or forma_pago="5" then%>
                        <tr>
                        ...
                        <%end if%>
                        <%if (forma_pago="3" or forma_pago="4" or forma_pago="5") and tiene_empresa_1 <> "0" then%>
                        <tr>
                          <td colspan="6">&nbsp;</td>
                        </tr>
                        <tr>
                      ...
                      <form name="edicion_fin">
                        ...
                        <%elseif (forma_pago="3" or forma_pago="5") and tiene_empresa <> "" and not Esvacio(tiene_empresa) then%>
                        <tr>
                          <td colspan="6">&nbsp;</td>
                        </tr>
                        <tr>
                  ...
                  <tr>
                      <td align="left"> <%pagina.DibujarSubtitulo "Detalle Observaciones alumno"%></td>
                  </tr>
				  <tr>
                  ...
                  <tr> 
                      <td align="center" >&nbsp; <%f_historico.dibujatabla()%> </td>
                  </tr>
                  <tr>
                    <td align="right"><%botonera.dibujaBoton "agrega_observacion"%></td>
                  </tr>
                  <%end if%>
                </table>
              <br>
