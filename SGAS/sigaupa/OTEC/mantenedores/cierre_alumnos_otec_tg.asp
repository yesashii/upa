...
session("url_actual")="../mantenedores/cierre_alumnos_otec_tg.asp?b[0][dcur_ncorr]="&dcur_ncorr&"&b[0][sede_ccod]="&sede_ccod&"&detalle=2&b[0][anio_admision]="&anio_admision&""
'response.Write("../mantenedores/m_modulos.asp?mote_tdesc="&mote_tdesc&"&mote_ccod="&mote_ccod)
set pagina = new CPagina
pagina.Titulo = "Cierre Alumnos por Programa Títulos y Grados"

set botonera =  new CFormulario
botonera.carga_parametros "cierre_alumnos_otec_tg.xml", "botonera"
'response.End()
'---------------------------------------------------------------------------------------------------
...
'----------------------------------------------------------------------- 
 ...
 f_busqueda.Carga_Parametros "cierre_alumnos_otec_tg.xml", "f_busqueda"
...
datos_generales.carga_parametros "cierre_alumnos_otec_tg.xml", "datos_generales"
...
listado_postulaciones.carga_parametros "cierre_alumnos_otec_tg.xml", "f_listado"
...
consulta= " select a.pers_ncorr,cast(a.pers_nrut as varchar)+'-'+a.pers_xdv as rut,a.pers_nrut,a.pers_xdv, " & vbCrlf & _
		  ...
		  " isnull(vb_finanzas,'0') as vb_finanzas, isnull(vb_biblioteca,'0') as vb_biblioteca, isnull(vb_audiovisual,'0') as vb_audiovisual, " & vbCrlf & _
		  ...
		  " and cast(dgso_ncorr as varchar)='"&dgso_ncorr&"' and isnull(pote_nest_final,'') <> ''  order by alumno" 

'response.write("<pre>"&consulta&"</pre>")
listado_postulaciones.consultar consulta 
'listado_postulaciones.siguiente

'-------------------ALUMNOS ASOCIADOS A PROGRAMA---------------------------------
set listado_postulaciones_asociadas = new cformulario
listado_postulaciones_asociadas.carga_parametros "cierre_alumnos_otec_tg.xml", "f_listado_asociado"
...
'response.write("<pre>"&consulta&"</pre>")
listado_postulaciones_asociadas.consultar consulta 
'listado_postulaciones.siguiente
  ...
  <tr>
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas Array("Títulos y Grados"), 1 %></td>
          </tr>
          <tr>
            <td height="2" background="../imagenes/top_r3_c2.gif"></td>
          </tr>
                ...
                <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
				  	<td align="center">
									  <table width="80%">
									  <tr>
									  	  <td align="center"><%botonera.dibujaBoton "guardar_datos"%></td>
									  </tr>
									  </table>
					</td>
				  </tr>
				  ...
				  <tr>
					  <td align="right">* Los certificados que ya han sido solicitados no permiten modificación de datos</td>
				  </tr>
				  <tr>
					  <td>&nbsp;</td>
				  </tr>
				  <tr>
				  	<td align="center">
									  <table width="80%">
									  <tr>
									  	  <td align="center"><%botonera.dibujaBoton "guardar_datos_asociados"%></td>
									  </tr>
									  </table>
					</td>
				  </tr>
