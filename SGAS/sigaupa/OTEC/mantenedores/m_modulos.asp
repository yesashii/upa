...
consulta =" select a.mote_ccod, REPLACE(REPLACE(LTRIM(RTRIM( protic.Initcap(a.mote_tdesc))),'¿',''),'?','') AS mote_tdesc, " & vbCrlf & _
          " case isnull(a.mote_boculto,0) when 0 then '<img width=16 height=16 src=../imagenes/hide.gif border=0>' " & vbCrlf & _
		  " else '<img width=16 height=16 src=../imagenes/show.gif border=0>' end as ver_ocultar" & vbCrlf & _
...
{
	//irA("editar_modulos.asp?codigo="+ valor , "1", 400, 200);
	direccion = "editar_modulos.asp?codigo="+valor;
	resultado2 = window.open(direccion, "ventana2","width=400,height=200,scrollbars=no, left=380, top=350");
}
            ...
            <td width="28%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><div align="center"><%botonera.dibujaboton "ver_ocultar"%></div></td>
