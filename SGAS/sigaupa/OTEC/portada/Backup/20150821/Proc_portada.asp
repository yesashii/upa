...
'////////////////////////////////////// Revisamos si la persona que ingresa tiene los roles para el permiso solicitado //////////////////////////////////////
		...
		elseif tipo_usuario = "Externo" then
   			 c_permiso = "select case count(*) when 0 then 'N' else 'S' end from sis_roles_usuarios rus, sis_roles rol where rus.srol_ncorr = rol.srol_ncorr and rol.srol_tdesc = 'EXTERNO_OTEC' and cast(rus.pers_ncorr as varchar) = '"&v_pers_ncorr&"'"  
