...
'response.Write("ip usuario : "&ip_usuario)
'response.End
'--ip usuario : 172.16.100.91

if ip_usuario="172.16.100.91" or ip_usuario="172.16.100.82" or ip_usuario="172.16.100.160" then
	if ip_usuario="172.16.100.91" then
		v_persenecor=30126 	'-->>LUIS TORRES 
	end if
...
'response.Write("ip usuario : "&ip_usuario&" , v_persenecor : "&v_persenecor)
'response.End
'--ip usuario : 172.16.100.91 , v_persenecor : 30126
...
'response.Write("ip usuario : "&ip_usuario&" , v_persenecor : "&v_persenecor&" , consulta_login : "&consulta_login&" , v_login : "&v_login&" , v_clave : "&v_clave)
'response.End
'--ip usuario : 172.16.100.91 , v_persenecor : 30126 , consulta_login : select susu_tlogin, susu_tclave from sis_usuarios where pers_ncorr=30126 , v_login : DTI , v_clave : --NULO--
					...
					<table width="100%" border="0" cellpadding="0">
                        ...
                        <tr><td width="10%" align="center"><input type="radio" name="tipo_usuario" value="Call Center"></td>
						 ...
						 <tr><td width="10%" align="center"><input type="radio" name="tipo_usuario" value="Asistente"></td>
						    <td width="2%" align="center"><strong>:</strong></td>
							<td align="left"><strong>Asistente Admisión</strong></td>
					    </tr>
						 <tr><td width="10%" align="center"><input type="radio" name="tipo_usuario" value="Muestra"></td>
						    <td width="2%" align="center"><strong>:</strong></td>
							<td align="left"><strong>Muestra</strong></td>
					    </tr>
                        <tr><td width="10%" align="center"><input type="radio" name="tipo_usuario" value="Externo"></td>
						    <td width="2%" align="center"><strong>:</strong></td>
							<td align="left"><strong>Externo</strong></td>
					    </tr>
					</table>
				</td>
