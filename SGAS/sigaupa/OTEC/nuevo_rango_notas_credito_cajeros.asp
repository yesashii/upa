...
f_contrato.Carga_Parametros "numeros_notas_credito_cajeros.xml", "nuevo_rango"
        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td bgcolor="#D8D8DE">
				<%pagina.DibujarLenguetas Array("Ingresar nuevo rango notas credito"), 1 %>				
				</td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <%pagina.DibujarSubtitulo "Datos rango notas credito"%><br>
				  <form name="edicion">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
							  <td>Cajero</td>
					 ...
					 <tr>
							  <td>N. Credito  Inicio</td>
							  <td><% f_contrato.DibujaCampo ("rncc_ninicio") %></td>
					  </tr>
					  <tr>
							  <td>N. Credito Fin</td>
							  <td><% f_contrato.DibujaCampo ("rncc_nfin") %></td>
					  </tr>
                    </table>
