...
<table width="93%" border="1" align="center">
  ...
  <td width="16%" height="17" ><div align="center"><strong>Sede</strong></div></td>
   ...
   <td width="6%" ><div align="center"><strong>Fecha Incio</strong></div></td>
	...
	<td width="6%"><div align="center"><strong>Unidad que lo dicta</strong></div></td>
	<td width="6%"><div align="center"><strong>Nro Resolución</strong></div></td>
  ...
  <tr borderColor="#999999"> 
	...
	<td ><div align="right"><%=lista.Obtenervalor("unidad_dicta")%></div></td>
	<td ><div align="right"><%=lista.Obtenervalor("nro_resolucion")%></div></td>
  ...
  <tr> 
    ...
    <td colspan="7"><div align="center"><strong>Total</strong></div></td>
