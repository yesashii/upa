...
s_programa="select distinct dcur_tdesc from datos_generales_secciones_otec a , diplomados_cursos b"& vbcrlf & _
"where a.dcur_ncorr=b.DCUR_NCORR"& vbcrlf & _
"and a.dgso_ncorr="&dgso_ncorr&""
programa=conexion.ConsultaUno(s_programa)
          ...
          <tr>
            <td><br><div align="center"> 
              ...
              <form name="edicion" method="post" action="">
			  	<table align="center">
					<tr>
						<td align="center" ><strong><font size="3">Programa:<%=programa%></font></strong></td>
					</tr>
				</table>
			  	<table>
				 	...
				 	<td colspan="6">
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>	
								<td colspan="2"><strong>Simbología</strong></td>
							</tr>
							<tr>
								<td><img src="../imagenes/sem_rojo.png"width="25" height="25"/></td>
								<td>&nbsp;Es Moroso</td>
							</tr>
							<tr>
								<td><img src="../imagenes/sem_amarillo.png"width="25" height="25"/></td>
								<td>&nbsp;Esta al día pero tiene cuotas por vencer</td>
							</tr>
							<tr>
								<td><img src="../imagenes/sem_verde.png"width="25" height="25"/></td>
								<td>&nbsp;Esta al día y sin cuotas por vencer</td>
							</tr>
						</table>
					</td>
				 </tr>
				 ...
				 <table width="100%" border="1" align="center">
				  ...
				  <td width="11%" bgColor="#c4d7ff"><div align="center"><strong>Monto Total por vencer particular</strong></div></td>
				  <td width="11%" bgColor="#c4d7ff"><div align="center"><strong>Deuda Empresa</strong></div></td> 
				   <td width="11%" bgColor="#c4d7ff"><div align="center"><strong>Monto Total por vencer Empresa</strong></div></td>
				  <td width="11%" bgColor="#c4d7ff"><div align="center"><strong>Deuda Otic</strong></div></td>
				   <td width="11%" bgColor="#c4d7ff"><div align="center"><strong>Monto Total por vencer Otic</strong></div></td>	 
				  </tr>
				...
				'	img_deuda="stop_x_mora.gif"
				 ' else
				  ...
				  <tr borderColor="#999999"> 
					...
					<td bgcolor="#FFFFFF"><div align="left"><img src="../imagenes/<%=img_deuda%>"width="20" height="20"/></div></td>
					<td bgcolor="#FFFFFF"><div align="left"><%=sede_tdesc%></div></td>
					<td bgcolor="#FFFFFF"><div align="left"><%=lista.Obtenervalor("nombre")%></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><%=lista.Obtenervalor("rut")%></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><%=lista.Obtenervalor("fecha_post")%></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><%=lista.Obtenervalor("fecha_matr")%></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=lista.Obtenervalor("estado")%></strong></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=lista.Obtenervalor("empresa")%></strong></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=lista.Obtenervalor("rut_empresa")%></strong></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=lista.Obtenervalor("otic")%></strong></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=lista.Obtenervalor("rut_otic")%></strong></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=FormatCurrency(lista.Obtenervalor("deuda_particuar"),0)%></strong></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=FormatCurrency(lista.Obtenervalor("por_pagar_particuar"),0)%></strong></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=FormatCurrency(lista.Obtenervalor("deuda_empresa"),0)%></strong></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=FormatCurrency(lista.Obtenervalor("por_pagar_empresa"),0)%></strong></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=FormatCurrency(lista.Obtenervalor("deuda_otic"),0)%></strong></div></td>
					<td bgcolor="#FFFFFF" ><div align="right"><strong><%=FormatCurrency(lista.Obtenervalor("por_pagar_otic"),0)%></strong></div></td>
