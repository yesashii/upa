...
f_contrato.Carga_Parametros "numeros_notas_credito.xml", "nuevo_rango"
          ...
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <%pagina.DibujarSubtitulo "Datos rango notas de credito"%><br>
				  <form name="edicion">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
							<tr>
							<td width="27%" >Sede</td>
					...
					<tr>
							  ...
							  <td><% f_contrato.DibujaCampo ("rncr_ninicio") %></td>
					  </tr>
							<tr>
							  <td>N. Credito  Fin</td>
							  <td><% f_contrato.DibujaCampo ("rncr_nfin") %></td>
					  </tr>
                    </table>
