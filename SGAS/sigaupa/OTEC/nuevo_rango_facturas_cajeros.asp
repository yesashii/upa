...
pagina.Titulo = "Ingreso nuevo rango cajero"
'-----------------------------------------------------------------------
...
v_tfac_ccod = request.querystring("tfac_ccod")
...
f_contrato.Carga_Parametros "numeros_facturas_cajeros.xml", "nuevo_rango"
...
f_contrato.AgregaCampoCons "tfac_ccod", v_tfac_ccod
f_contrato.AgregaCampoCons "pers_ncorr", v_pers_ncorr
        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td bgcolor="#D8D8DE">
				<%pagina.DibujarLenguetas Array("Ingresar nuevo rango facturas"), 1 %>				
				</td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <%pagina.DibujarSubtitulo "Datos rango facturas"%><br>
				  <form name="edicion">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
							  <td>Cajero</td>
							  <td><% f_contrato.DibujaCampo ("pers_ncorr") %></td>
					  </tr>
					  <tr>
							<td width="27%" >Sede</td>
							<td width="73%" ><% f_contrato.DibujaCampo ("sede_ccod") %></td>
					  </tr>
					    <tr>
							<td width="27%" >Institucion</td>
							<td width="73%" ><% f_contrato.DibujaCampo ("inst_ccod") %></td>
					  </tr>
					 <tr>
							<td >Tipo Factura</td>
						<td >						    <% f_contrato.DibujaCampo ("tfac_ccod") %></td>
                     </tr>
					 <tr>
							  <td>Factura Inicio</td>
							  <td><% f_contrato.DibujaCampo ("rfca_ninicio") %></td>
					  </tr>
					  <tr>
							  <td>Factura Fin</td>
							  <td><% f_contrato.DibujaCampo ("rfca_nfin") %></td>
					  </tr>
