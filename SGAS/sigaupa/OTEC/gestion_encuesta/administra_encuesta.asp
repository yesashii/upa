...
'f_dcur_tdesc = Request.Form("b[0][dcur_tdesc]")
f_dcur_tdesc = Request.QueryString("b[0][dcur_tdesc]")
'--------------------------------------------------
                ...
                <tr>
				  ...
				  <form name="buscador">
				  	<table width="95%">
						<br></br>
						<tr>
							<td width="38%">Ingrese el nombre del diplomado o curso</td>
						</tr>
						<tr>
							<td width="62%"><%f_busqueda.DibujaCampo("dcur_tdesc")%></td>
						</tr>
					</table>
				  </form>
				  <% if f_dcur_tdesc <>"" then %>
				  <table width="95%">
						...
						<tr>
						  <td width="52%" align="center"><%f_resultado.DibujaTabla()%></td>
						</tr>
					</table>
				  <%end if%>
				  <br>  <br/>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="125" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center"><%botonera.DibujaBoton"buscar"%></td>
                    </tr>
                  </table>                    
                  </td>
