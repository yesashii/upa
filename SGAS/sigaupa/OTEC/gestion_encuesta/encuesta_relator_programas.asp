                ...
                <tr>
				  ...
				  <input type="hidden"  name="d[0]dcur_ncorr" value="<%=f_dcur_ncorr%>">
				  	<table width="95%">
						...
						<tr>
						  <td align="center"><strong><font size="2">Puntaje Promedio Modulos </font></strong></td>
						</tr>
						<tr>
						...
						<tr>
						  <td align="center"><p>* Haga click en el Módulo para ver el promedio por Pregunta</p></td>
						</tr>
						  ...
						  <td width="62%" align="center">
						  		<table width="80%" border="1">
									<tr borderColor="#999999"> 
									  <td width="70%" bgColor="#c4d7ff"><div align="center"><strong>Módulos</strong></div></td>
									  <td width="30%" height="17" bgColor="#c4d7ff"><div align="center"><strong>Ptje Promedio</strong></div></td>
									</tr>
							...
							%>
								  <tr borderColor="#999999"> 
									 <td bgcolor="#FFECC6" class='click' onClick='irA("encuesta_relator_programas_detalle.asp?seot_ncorr=<%=seot_ncorr%>&DCUR_NCORR=<%=f_dcur_ncorr%>&pers_ncorr_relator=<%=f_pers_ncorr_relator%>&mote_ccod=<%=mote_ccod%>", "2", 600, 400)'><div align="center"><%=f_relatores.Obtenervalor("mote_tdesc")%></div></td>
									 <td bgcolor="#FFECC6"class='click' onClick='irA("detalle_gestion_matricula_matriculados.asp?sede_ccod=<%'=lista.obtenervalor("sede_ccod")%>&ano_ccod=<%=ano_ccod%>&epot_ccod=4&dgso_ncorr=<%'=lista.obtenervalor("dgso_ncorr")%>", "2", 600, 400)'><div align="center"><%=prom%></div></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="125" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center"><%botonera.AgregaBotonParam "excel_estado", "url", "encuesta_relator_programas_excel.asp?dcur_ncorr="&f_dcur_ncorr&"&pers_ncorr="&pers_ncorr&""
					  botonera.DibujaBoton"excel_estado"%></td>
					  <td align="center"><%	botonera.AgregaBotonParam "volver", "url", "encuesta_relator.asp?dcur_ncorr="&f_dcur_ncorr
