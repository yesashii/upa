...
sql_datos_alumno = " select top 1 protic.obtener_nombre_completo(a.pers_ncorr, 'n') as " & vbCrLf &_
"             nombre_completo,                                                         " & vbCrLf &_
"             protic.obtener_nombre_carrera(a.ofer_ncorr, 'CE') as carrera,            " & vbCrLf &_
"             protic.obtener_rut(a.pers_ncorr)                  as rut,                " & vbCrLf &_
"             c.sede_tdesc,                                                            " & vbCrLf &_
"             isnull(protic.ano_ingreso_carrera(a.pers_ncorr, (select                  " & vbCrLf &_
"                           protic.obtener_nombre_carrera(                             " & vbCrLf &_
"                           (select top 1 ofer_ncorr                                   " & vbCrLf &_
"                                                   from   alumnos                     " & vbCrLf &_
"                                                   where                              " & vbCrLf &_
"                           matr_ncorr = '" & matr_ncorr & "'                          " & vbCrLf &_
"                                                   order  by matr_ncorr desc),        " & vbCrLf &_
"                           'CC'))),                                                   " & vbCrLf &_
"             protic.ano_ingreso_universidad(a.pers_ncorr))     as ano_ingreso,        " & vbCrLf &_
"             case d.econ_ccod                                                         " & vbCrLf &_
"               when 1 then 'MATRICULADO'                                              " & vbCrLf &_
"               when 2 then 'PENDIENTE'                                                " & vbCrLf &_
"               else 'NO MATRICULADO'                                                  " & vbCrLf &_
"             end                                               as                     " & vbCrLf &_
"             estado_matricula,                                                        " & vbCrLf &_
"             case isnull(e.emat_ccod, 0)                                              " & vbCrLf &_
"               when 1 then 'ACTIVO'                                                   " & vbCrLf &_
"               else e.emat_tdesc                                                      " & vbCrLf &_
"             end                                               as estado_alumno       " & vbCrLf &_
"from   alumnos as a                                                                   " & vbCrLf &_
"       join ofertas_academicas as b                                                   " & vbCrLf &_
"	   on a.ofer_ncorr = b.ofer_ncorr                                                    " & vbCrLf &_
"       join sedes as c                                                                " & vbCrLf &_
"	   on b.sede_ccod = c.sede_ccod                                                      " & vbCrLf &_
"      left outer join contratos as d                                                  " & vbCrLf &_
"	   on a.matr_ncorr = d.matr_ncorr                                                    " & vbCrLf &_
"      join estados_matriculas as e                                                    " & vbCrLf &_
"	   on a.emat_ccod = e.emat_ccod                                                      " & vbCrLf &_
...
"       c.sede_tdesc,                                                                               " & vbCrLf &_
"       isnull(protic.ano_ingreso_carrera(a.pers_ncorr, (select                                     " & vbCrLf &_
"                     protic.obtener_nombre_carrera((select top 1 ofer_ncorr                        " & vbCrLf &_
"                                             from   alumnos                                        " & vbCrLf &_
"                                             where  matr_ncorr = a.matr_ncorr                      " & vbCrLf &_
"                                             order  by matr_ncorr desc), 'CC')))                   " & vbCrLf &_
"       ,                                                                                           " & vbCrLf &_
"       protic.ano_ingreso_universidad(a.pers_ncorr))     as ano_ingreso,                           " & vbCrLf &_
"       case d.econ_ccod                                                                            " & vbCrLf &_
"         when 1 then 'MATRICULADO'                                                                 " & vbCrLf &_
"         when 2 then 'PENDIENTE'                                                                   " & vbCrLf &_
"         else 'NO MATRICULADO'                                                                     " & vbCrLf &_
"       end                                               as estado_matricula,                      " & vbCrLf &_
"       case isnull(e.emat_ccod, 0)                                                                 " & vbCrLf &_
"         when 1 then 'ACTIVO'                                                                      " & vbCrLf &_
"         else e.emat_tdesc                                                                         " & vbCrLf &_
"       end                                               as estado_alumno                          " & vbCrLf &_
"from   alumnos as a                                                                                " & vbCrLf &_
"       inner join ofertas_academicas as b                                                          " & vbCrLf &_
"         on a.ofer_ncorr = b.ofer_ncorr                                                            " & vbCrLf &_
"       inner join sedes as c                                                                       " & vbCrLf &_
"         on b.sede_ccod = c.sede_ccod                                                              " & vbCrLf &_
"       left outer join contratos as d                                                              " & vbCrLf &_
"                    on a.matr_ncorr = d.matr_ncorr                                                 " & vbCrLf &_
"                       and d.econ_ccod <> 3                                                        " & vbCrLf &_
"       inner join estados_matriculas as e                                                          " & vbCrLf &_
"         on a.emat_ccod = e.emat_ccod                                                              " & vbCrLf &_
...
'							 "  and a.emat_ccod  = e.emat_ccod  " & vbCrLf &_
'							 "  and cast(a.pers_ncorr as varchar)= '" & pers_ncorr & "' " & vbCrLf &_
'							 "  and b.peri_ccod = " & v_peri_ccod & " ) as tabla"
							 
'--------------------------------------------------------------------------------------------------------------------------ACTUALIZACIÓN SQLServer 2008	
sql_carrera_alumno = " select nombre_completo, 																						" & vbCrLf &_	
"       carrera,                                                                                                                    " & vbCrLf &_
"       rut,                                                                                                                        " & vbCrLf &_
"       sede_tdesc,                                                                                                                 " & vbCrLf &_
"       ano_ingreso,                                                                                                                " & vbCrLf &_
"       estado_matricula,                                                                                                           " & vbCrLf &_
"	   estado_alumno,                                                                                                               " & vbCrLf &_
"       ingreso_u,                                                                                                                  " & vbCrLf &_
"       peri_tdesc                                                                                                                  " & vbCrLf &_
"from   (select protic.obtener_nombre_completo(a.pers_ncorr, 'n') as                                                                " & vbCrLf &_
"               nombre_completo,                                                                                                    " & vbCrLf &_
"               protic.obtener_nombre_carrera(a.ofer_ncorr, 'CE') as carrera,                                                       " & vbCrLf &_
"               protic.obtener_rut(a.pers_ncorr)                  as rut,                                                           " & vbCrLf &_
"               c.sede_tdesc,                                                                                                       " & vbCrLf &_
...
"                                                     from   alumnos                                                                " & vbCrLf &_
"                                                     where                                                                         " & vbCrLf &_
"                             matr_ncorr = a.matr_ncorr),                                                                           " & vbCrLf &_
"                             'CC')))                                                                                               " & vbCrLf &_
"               , protic.ano_ingreso_universidad(a.pers_ncorr))   as ano_ingreso,                                                   " & vbCrLf &_
"               case                                                                                                                " & vbCrLf &_
"                 when                                                                                                              " & vbCrLf &_
"       protic.tiene_contrato_periodo("&v_peri_selec&", a.pers_ncorr) >= 1 then                                                     " & vbCrLf &_
"                 'MATRICULADO'                                                                                                     " & vbCrLf &_
"                 else 'NO MATRICULADO'                                                                                             " & vbCrLf &_
"               end                                               as                                                                " & vbCrLf &_
"               estado_matricula,                                                                                                   " & vbCrLf &_
"               --case d.econ_ccod when 1 then 'MATRICULADO' when 2 then 'PENDIENTE' else 'NO MATRICULADO' end as estado_matricula, " & vbCrLf &_
...
"               end                                               as                                                                " & vbCrLf &_
"               estado_alumno,                                                                                                      " & vbCrLf &_
"               protic.ano_ingreso_universidad(a.pers_ncorr)      as ingreso_u,                                                     " & vbCrLf &_
"               (select peri_tdesc                                                                                                  " & vbCrLf &_
"                from   periodos_academicos                                                                                         " & vbCrLf &_
"                where  peri_ccod = '"&v_peri_selec&"')           as peri_tdesc                                                     " & vbCrLf &_
"        from   alumnos a                                                                                                           " & vbCrLf &_
"               inner join ofertas_academicas b                                                                                     " & vbCrLf &_
"                       on a.ofer_ncorr = b.ofer_ncorr                                                                              " & vbCrLf &_
"               inner join sedes c                                                                                                  " & vbCrLf &_
"                       on b.sede_ccod = c.sede_ccod                                                                                " & vbCrLf &_
"               left outer join contratos d                                                                                         " & vbCrLf &_
"                            on a.matr_ncorr = d.matr_ncorr                                                                         " & vbCrLf &_
"                               and d.econ_ccod <> 3                                                                                " & vbCrLf &_
"               inner join estados_matriculas e                                                                                     " & vbCrLf &_
"                       on a.emat_ccod = e.emat_ccod                                                                                " & vbCrLf &_
"        where  cast(a.pers_ncorr as varchar) = '" & pers_ncorr & "'                                                                " & vbCrLf &_
"               and b.peri_ccod = '" & v_peri_ccod & "'                                                                             " & vbCrLf &_
"               and a.emat_ccod <> 9) as tabla                                                                                      " & vbCrLf &_
"union                                                                                                                              " & vbCrLf &_
"select nombre_completo,                                                                                                            " & vbCrLf &_
"       carrera,                                                                                                                    " & vbCrLf &_
"       rut,                                                                                                                        " & vbCrLf &_
"       sede_tdesc,                                                                                                                 " & vbCrLf &_
"       ano_ingreso,                                                                                                                " & vbCrLf &_
...
"               inner join sedes c                                                                                                  " & vbCrLf &_
"                       on b.sede_ccod = c.sede_ccod                                                                                " & vbCrLf &_
"               inner join contratos d                                                                                              " & vbCrLf &_
"                       on a.matr_ncorr = d.matr_ncorr                                                                              " & vbCrLf &_
"                          and d.econ_ccod <> 3                                                                                     " & vbCrLf &_
"               inner join estados_matriculas e                                                                                     " & vbCrLf &_
"                       on a.emat_ccod = e.emat_ccod                                                                                " & vbCrLf &_
...
'--------------------------------------------------------------------------------------------------------------------------ACTUALIZACIÓN SQLServer 2008	
situacion_asignaturas_sql = "" & _ 											   	
"select nive_ccod,                                                             " & vbCrLf &_
"       isnull(a.asig_ccod, 'P ' + cast(b.asig_ccod as varchar)) as asignatura " & vbCrLf &_
"from   (select distinct asig_ccod                                             " & vbCrLf &_
...
"        where  d.sitf_baprueba = 'S'                                          " & vbCrLf &_
"               and cast(c.pers_ncorr as varchar) = '" & pers_ncorr & "'       " & vbCrLf &_
"        union                                                                 " & vbCrLf &_
"        select distinct asig_ccod                                             " & vbCrLf &_
"        from   convalidaciones a                                              " & vbCrLf &_
"               inner join alumnos b                                           " & vbCrLf &_
"                       on a.matr_ncorr = b.matr_ncorr                         " & vbCrLf &_
"               inner join situaciones_finales c                               " & vbCrLf &_
"                       on a.sitf_ccod = c.sitf_ccod                           " & vbCrLf &_
"        where  c.sitf_baprueba = 'S'                                          " & vbCrLf &_
"               and cast(b.pers_ncorr as varchar) = '" & pers_ncorr & "') a    " & vbCrLf &_
"       right outer join malla_curricular b                                    " & vbCrLf &_
