...
consulta = " select distinct d.pers_nrut as rut, d.pers_xdv as dv, d.pers_tnombre as nombres, "& vbCrLf &_
		   ...
		   "                         and o1.peri_ccod=p1.peri_ccod and cast(p1.anos_ccod as varchar)= '"&v_anos&"' "& vbCrLf &_
		   ...
		   " and b.peri_ccod=c.peri_ccod and cast(c.anos_ccod as varchar)='"&v_anos&"' "& vbCrLf &_
...
'response.Write("<pre>"&consulta&" order by carrera, apellidos</pre>")
                  ...
                  <tr>
                    <td>
						<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        	<tr>
							    <td align="left"><strong>Total alumnos encontrados :</strong><%=total%></td>
						    </tr>
							<tr>
