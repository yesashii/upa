...
'----------------------------------------------------------------------------------------------------------------------ACTUALIZACIÓN LUIS HERRERA 22/04/2013
consulta = ""
consulta = consulta & "select distinct pea.anos_ccod, " & vbCrLf
consulta = consulta & "                f.sede_ccod, " & vbCrLf
consulta = consulta & "                f.sede_tdesc, " & vbCrLf
consulta = consulta & "                ltrim(rtrim(cast(a.carr_ccod as varchar))) as carr_ccod, " & vbCrLf
...
consulta = consulta & "from   carreras as a " & vbCrLf
consulta = consulta & "       inner join especialidades as es " & vbCrLf
consulta = consulta & "               on a.carr_ccod = es.carr_ccod " & vbCrLf
consulta = consulta & "                  and es.espe_ccod in (select espe_ccod " & vbCrLf
consulta = consulta & "                                       from   sis_especialidades_usuario " & vbCrLf
consulta = consulta & "                                       where " & vbCrLf
consulta = consulta & "                      pers_ncorr = '"&pers_ncorr_encargado&"') " & vbCrLf
consulta = consulta & "       inner join secciones as b " & vbCrLf
consulta = consulta & "               on a.carr_ccod = b.carr_ccod " & vbCrLf
consulta = consulta & "                  and b.secc_tdesc <> 'Poblamiento' " & vbCrLf
consulta = consulta & "                  and exists(select 1 " & vbCrLf
consulta = consulta & "                             from   cargas_academicas as aca " & vbCrLf
consulta = consulta & "                             where  aca.secc_ccod = b.secc_ccod) " & vbCrLf
consulta = consulta & "       inner join asignaturas as d " & vbCrLf
consulta = consulta & "               on b.asig_ccod = d.asig_ccod " & vbCrLf
consulta = consulta & "       inner join jornadas as e " & vbCrLf
consulta = consulta & "               on b.jorn_ccod = e.jorn_ccod " & vbCrLf
consulta = consulta & "       inner join sedes as f " & vbCrLf
consulta = consulta & "               on b.sede_ccod = f.sede_ccod " & vbCrLf
consulta = consulta & "       inner join periodos_academicos as pea " & vbCrLf
consulta = consulta & "               on b.peri_ccod = pea.peri_ccod " & vbCrLf
consulta = consulta & "                  and pea.anos_ccod >= 2005 " & vbCrLf
consulta = consulta & "where  a.tcar_ccod = 1 " & vbCrLf
consulta = consulta & "order  by pea.anos_ccod, " & vbCrLf
consulta = consulta & "          f.sede_tdesc, " & vbCrLf
consulta = consulta & "          a.carr_tdesc, " & vbCrLf
