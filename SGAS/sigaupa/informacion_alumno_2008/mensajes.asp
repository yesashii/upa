									...
									<table width="100%">
										<tr>
										   ...
										   <td width="38" height="38">
												...
												onmouseover="window.status='botón pulsado';document.images[0].src='imagenes/ayuda2.png';return true "
												onmouseout="window.status='';document.images[0].src='imagenes/ayuda1.png';return true ">
