				...
				<form name="buscador" method="get">
                  <table width="98%"  border="0">
                    <tr>
                        ...
                        <tbody>
                          <tr>
                            <td valign=top align=middle height=40>
                              <div align="center"><strong><font size="3">Listado de profesores (valor sesion x escuela)</font></strong><br>
                      ...
                      <td width="19%"><div align="center"><%    botonera.AgregaBotonParam "excel", "url", "valores_sesion_docentes_excel.asp"
