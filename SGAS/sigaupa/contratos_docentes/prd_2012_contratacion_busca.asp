...
formulario.inicializar conexion 'conectar
 ...
 consulta= " select distinct e.tcdo_ccod as tipo_contrato,e.tcdo_ccod,e.cdoc_ncorr,b.sede_ccod,b.carr_ccod,b.jorn_ccod,a.pers_ncorr, " &vbCrlf &_
			 " protic.obtener_rut(a.pers_ncorr) as rut,max(d.tcat_valor) as categoria, " &vbCrlf &_
			 "  (select tcat_valor from tipos_categoria where tcat_ccod=protic.obtiene_categoria_carrera(a.pers_ncorr,'"&sede_ccod&"','"& carr_ccod &"','"&jorn_ccod&"','"&v_peri_ccod&"',0)) as valor_categoria, "&vbCrlf &_
			 " protic.obtener_nombre_completo(a.pers_ncorr,'a') as nom, " &vbCrlf &_
			 " protic.anexos_pendientes(a.pers_ncorr,'"& carr_ccod &"') as pendientes, "&vbCrlf &_
			 " protic.anexos_pendientes(a.pers_ncorr,'"& carr_ccod &"') as calcular, "&vbCrlf &_
			 " --protic.anexos_nuevos(a.pers_ncorr,"&anio_sem&") as anexos_nuevos ,"&vbCrlf &_
			 " protic.anexos_nuevos_escuela(a.pers_ncorr,'"& carr_ccod &"','" & sede_ccod & "','" & jorn_ccod & "',"&anio_sem&") as anexos_nuevos_escuela ,"&vbCrlf &_
			 " protic.anexos_nuevos(a.pers_ncorr,"&anio_sem&") as anexos_creados ,"&vbCrlf &_
			 " protic.maxima_duracion_asignatura(a.pers_ncorr) as duracion_asignatura " &vbCrlf &_
			 " from " &vbCrlf &_
			 " personas a, carreras_docente b, bloques_profesores c, tipos_categoria D, contratos_docentes_upa e, periodos_academicos f " &vbCrlf &_
			 " where " &vbCrlf &_
			 ...
			 " and e.ano_contrato="&anio_sem&" "&vbCrlf &_
			 " and e.ecdo_ccod =1 " &vbCrlf &_
			 " and b.peri_ccod=f.peri_ccod " &vbCrlf &_
			 " and f.anos_ccod="&anio_sem&" " &vbCrlf &_
			 " Group by a.pers_ncorr,b.sede_ccod,b.carr_ccod,b.jorn_ccod,e.cdoc_ncorr,e.tcdo_ccod  " &vbCrlf &_
			 " order by nom " 
