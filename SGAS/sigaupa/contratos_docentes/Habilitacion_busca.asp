...
"       b.carr_ccod, " &vbCrlf &_ 
"       c.tcat_tdesc, " &vbCrlf &_ 
"       c.tcat_valor, " &vbCrlf &_ 
"       b.observaciones1, " &vbCrlf &_ 
"       b.observaciones2, " &vbCrlf &_ 
"       -- (select top 1 F.GRAC_TDESC  from GRADOS_PROFESOR D, GRADOS_ACADEMICOS F where D.PERS_NCORR = B.pers_ncorr and F.GRAC_CCOD = D.GRAC_CCOD order by F.GRAC_NORDEN asc) as Grado_Acad, " &vbCrlf &_ 
"       protic.obtener_grado_docente(a.pers_ncorr, 'G') as grado_acad, " &vbCrlf &_ 
"       b.sede_ccod, " &vbCrlf &_ 
"       b.jorn_ccod, " &vbCrlf &_ 
"       (select top 1 isnull(jdoc_ccod, 0) " &vbCrlf &_ 
"        from   profesores " &vbCrlf &_ 
"        where  pers_ncorr = a.pers_ncorr)              as jdoc_ccod " &vbCrlf &_ 
"from   personas as a " &vbCrlf &_ 
"       join carreras_docente as b " &vbCrlf &_ 
"         on a.pers_ncorr = b.pers_ncorr " &vbCrlf &_ 
"       left outer join tipos_categoria as c " &vbCrlf &_ 
"                    on b.tcat_ccod = c.tcat_ccod " &vbCrlf &_  
"       join periodos_academicos as d " &vbCrlf &_ 
