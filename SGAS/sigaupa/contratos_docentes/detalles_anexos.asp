...
'---------------------------------------------------------------------------------------------------
 ...
 v_cdoc_ncorr = request.querystring("cdoc_ncorr")
 v_anex_ncorr = request.querystring("anex_ncorr")
 


'----------------------------------------------------------------------------------
set f_envios = new CFormulario
f_envios.Carga_Parametros "detalle_contratos_docentes.xml", "detalle_anexos"
f_envios.Inicializar conexion

				 
consulta =	" Select *, c.asig_ccod as asignatura, c.secc_ccod as seccion "& vbCrLf &_
			" From contratos_docentes_upa a, anexos b , detalle_anexos c, secciones d, asignaturas e  "& vbCrLf &_    
			...
			"	 and b.cdoc_ncorr="&v_cdoc_ncorr&""& vbCrLf &_
			"	 and b.anex_ncorr="&v_anex_ncorr&" "
