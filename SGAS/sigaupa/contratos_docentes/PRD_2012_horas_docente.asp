...
sql_primer_sem= " select b.peri_ccod from periodos_academicos a,periodos_academicos b  "& vbCrLf & _
				" where a.anos_ccod=b.anos_ccod "& vbCrLf & _
				" and a.peri_ccod="&Periodo&" "& vbCrLf & _
				" and b.plec_ccod=1 "

peri = conexion.consultaUno(sql_primer_sem)
...
f_copia.Inicializar conexion
 ...
 consulta = "SELECT  a.ASIG_CCOD, a.ASIG_TDESC , secc_tdesc ,b.secc_ccod, case b.moda_ccod when 2 then b.secc_nhoras_pagar  else a.asig_nhoras end as asig_nhoras  "& vbCrLf &_
