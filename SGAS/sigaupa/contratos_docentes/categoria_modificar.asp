...
<%
TCAT_CCOD = Request.QueryString("codigo")

set pagina = new CPagina
pagina.Titulo = "Mantener Categoria"
...
if TCAT_CCOD = "NUEVO" then
  TCAT_CCOD = conexion.consultauno("exec ObtenerSecuencia 'TCAT_CCOD'")
  consulta = "select "&TCAT_CCOD&" as TCAT_CCOD, '' as TCAT_tdesc, ''  as jdoc_ccod "
else
  consulta = "select * from tipos_categoria where TCAT_CCOD = " & TCAT_CCOD
end if
...
<html>
<head>
<title>Mantenedor de Categorias</title>
                    ...
                    <table width="99%" border="0">
                      <tr> 
                        <td width="14%"> <div align="right"><strong> 
                            <%formulario.DibujaCampo("TCAT_CCOD") %>
                            Categoria </strong></div></td>
                        <td width="7%"><div align="center"><strong>:</strong></div></td>
                        <td width="79%"> <%formulario.DibujaCampo("TCAT_tdesc")  %> </td>					
                      </tr>
                      <tr> 
                        <td width="14%"> <div align="right"><strong> 
                            Valor</strong></div></td>
                        <td width="7%"><div align="center"><strong>:</strong></div></td>
                        <td width="79%"> <%formulario.DibujaCampo("TCAT_VALOR")  %> </td>					
                      </tr>
					  <tr> 
                        <td width="14%"> <div align="right"><strong> 
                            Año</strong></div></td>
					  ...
					  <tr>
					    <td><div align="right"><strong>Tipo Jerarquia</strong></div> </td>
					    <td><strong>:</strong></td>
