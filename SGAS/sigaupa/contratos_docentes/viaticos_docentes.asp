...
botonera.carga_parametros "botonera_viaticos.xml", "botonera"
...
<html>
<head>
<title>Reporte Viaticos Docentes</title>
            ...
            <tr>
              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="105" align="right" bgcolor="#D8D8DE"></td>
                  </tr>
              </table></td>
				...
				<form name="buscador" method="get">
                  <table width="98%"  border="0">
                    <tr>
                        ...
                        <tbody>
                          <tr>
                            <td valign=top align=middle height=40>
                              <div align="center"><strong><font size="3">Listado dias clase (para calculo viaticos)</font></strong><br>
                      ...
                      <td width="19%">
					  	<div align="center">
						<% botonera.AgregaBotonParam "viaticos_mensual", "url", "viaticos_docentes_mensual.asp"
							botonera.dibujaboton "viaticos_mensual"%>
						</div>
						<br/>
					  	<div align="center">
						<% botonera.AgregaBotonParam "viaticos_semanal", "url", "viaticos_docentes_semanal.asp"
							botonera.dibujaboton "viaticos_semanal"%>
						</div>
						<br/>
						<div align="center">
						<% botonera.AgregaBotonParam "consolidado_viatico", "url", "viaticos_docentes_consolidado.asp"
							botonera.dibujaboton "consolidado_viatico"%>
						</div>
						<br/>
						<div align="center">
							<%    botonera.AgregaBotonParam "detalle_viatico", "url", "viaticos_docentes_detalle.asp"
					  											botonera.dibujaboton "detalle_viatico"%><br></div>
						</td>
                    </tr>
                  </table>
				</form>
