...
<html>
<head>
<title>Reporte Contratatos Docentes</title>
				...
				<form name="buscador" method="get">
                  <table width="98%"  border="0">
                    <tr>
                          ...
                          <tr>
                            <td valign=top align=middle height=40>
                              <div align="center"><strong><font size="3">Listado
                                    de Docentes por Contratar</font></strong><br>
                                  Presione bot&oacute;n para generar archivo</div></td>
                            <td align=middle>&nbsp;</td>
                            <td  align=middle height=40><% 'f_busqueda.dibujaCampo("carr_ccod")%></td>
                            <td align=middle>&nbsp;</td>
                            <td>
                      ...
                      <td width="19%"><div align="center"><%    botonera.AgregaBotonParam "excel", "url", "docentes_no_contratados_excel.asp"
