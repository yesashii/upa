...
"    from ( " & vbcrlf & _
"        select a.pers_ncorr,(c.dane_nsesiones/2) as sesiones, b.anex_ncorr,c.dane_msesion as monto_cuota,o.tpro_tdesc as tipo_profesor " & vbcrlf & _
"	          From contratos_docentes_upa a INNER JOIN anexos b " & vbcrlf & _
"						ON a.cdoc_ncorr = b.cdoc_ncorr and a.ecdo_ccod <> 3 and b.eane_ccod <> 3 " & vbcrlf & _
"						INNER JOIN detalle_anexos c " & vbcrlf & _
"						ON b.anex_ncorr = c.anex_ncorr " & vbcrlf & _
"						INNER JOIN personas d " & vbcrlf & _
"						ON a.pers_ncorr = d.pers_ncorr " & vbcrlf & _
"						INNER JOIN sedes e " & vbcrlf & _
"						ON b.sede_ccod = e.sede_ccod " & vbcrlf & _
"						INNER JOIN asignaturas j " & vbcrlf & _
"						ON c.asig_ccod = j.asig_ccod " & vbcrlf & _
"						INNER JOIN secciones n " & vbcrlf & _
"						ON n.secc_ccod = c.secc_ccod " & vbcrlf & _
"						INNER JOIN profesores p " & vbcrlf & _
"						ON p.pers_ncorr = d.pers_ncorr " & vbcrlf & _
"						INNER JOIN tipos_profesores o " & vbcrlf & _
"						ON o.TPRO_CCOD = p.TPRO_CCOD AND b.SEDE_CCOD = p.sede_ccod " & vbcrlf & _
"						WHERE convert(datetime,getdate(),103) between  convert(datetime,b.anex_finicio,103) and convert(datetime,b.anex_ffin,103) " & vbcrlf & _
"        group by c.secc_ccod,a.pers_ncorr,b.anex_ncorr,a.cdoc_ncorr,c.dane_nsesiones,c.dane_msesion,tpro_tdesc " & vbcrlf & _
"    ) as aa INNER JOIN " & vbcrlf & _
"   anexos b " & vbcrlf & _
"    ON aa.anex_ncorr = b.anex_ncorr  " & vbcrlf & _
"    group by b.anex_ncorr,pers_ncorr,b.anex_nhoras_coordina,monto_cuota,b.anex_ncuotas,tipo_profesor  " & vbcrlf & _
" ) ss ,personas b " & vbcrlf & _
" where ss.pers_ncorr=cast(b.pers_ncorr as varchar) " & vbcrlf & _
" group by  b.pers_nrut,b.pers_ncorr,b.pers_tnombre,b.pers_tape_paterno,b.pers_tape_materno,ss.tipo_profesor " & vbcrlf & _
...
"	,case F.DUAS_CCOD WHEN 5 then protic.trunc(c.SECC_FINICIO_SEC) else protic.trunc(h.PROC_FINICIO) end AS FECHA_INICIO     " & vbcrlf & _
"    ,protic.trunc(CASE F.DUAS_CCOD WHEN 1 THEN h.PROC_FFIN_TRIMESTRAL WHEN 2 THEN h.PROC_FFIN_SEMESTRAL WHEN 3 THEN h.PROC_FFIN_ANUAL WHEN 4 THEN h.PROC_FFIN_ANUAL WHEN 5 THEN c.SECC_FTERMINO_SEC END) AS FECHA_FIN     " & vbcrlf & _
"  from bloques_profesores a INNER JOIN bloques_horarios b " & vbcrlf & _
"  ON a.bloq_ccod=b.bloq_ccod and a.bloq_anexo is not null and isnull(a.eblo_ccod,0)<>3 " & vbcrlf & _
"  INNER JOIN tipos_profesores d " & vbcrlf & _
"  ON a.tpro_ccod=d.tpro_ccod " & vbcrlf & _
"  INNER JOIN procesos h " & vbcrlf & _
"  ON a.proc_ccod=h.proc_ccod " & vbcrlf & _
"  INNER JOIN secciones c " & vbcrlf & _
"  ON b.secc_ccod=c.secc_ccod and b.bloq_ccod=(select max(bb.bloq_ccod) from bloques_horarios bb,bloques_profesores cc  where bb.bloq_ccod=cc.bloq_ccod and c.secc_ccod=bb.secc_ccod and a.pers_ncorr=cc.pers_ncorr ) " & vbcrlf & _
"  INNER JOIN asignaturas e " & vbcrlf & _
"  ON c.asig_ccod=e.asig_ccod " & vbcrlf & _
"  INNER JOIN duracion_asignatura f " & vbcrlf & _
"  ON e.duas_ccod=f.duas_ccod " & vbcrlf & _
"  INNER JOIN personas g " & vbcrlf & _
"  ON a.pers_ncorr=g.pers_ncorr " & vbcrlf & _
"  LEFT OUTER JOIN horas_profesores Y " & vbcrlf & _
"  ON a.PERS_NCORR = Y.pers_ncorr and b.SECC_CCOD = Y.secc_ccod and Y.hopr_nhoras > 0       " & vbcrlf & _
"	  group by a.pers_ncorr,g.pers_nrut,g.pers_xdv,g.pers_tape_paterno,g.pers_tape_materno,g.pers_tnombre,c.sede_ccod,carr_ccod,jorn_ccod,e.duas_ccod,bloq_anexo,hcor_valor1,h.PROC_CUOTAS_TRIMESTRAL,h.PROC_CUOTAS_SEMESTRAL,h.PROC_CUOTAS_ANUAL,c.SECC_FINICIO_SEC,F.DUAS_CCOD,h.PROC_FINICIO,h.PROC_FFIN_ANUAL,h.PROC_FFIN_TRIMESTRAL,c.SECC_FTERMINO_SEC,h.PROC_FFIN_SEMESTRAL     " & vbcrlf & _
" ) as a     " & vbcrlf & _
"       where  datepart(month,convert(datetime,getdate(),103)) between  datepart(month,convert(datetime,a.fecha_inicio,103)) and datepart(month,convert(datetime,a.fecha_fin,103))    " & vbcrlf & _
" group by a.tipo_profe,a.ficha,a.rut,a.pers_tape_paterno,a.pers_tape_materno,a.pers_tnombre     " & vbcrlf & _
