...
c_encuesta = " select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'03/11/2015',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'24/03/2016',103) "&_
              " then 'S' else 'N' end "
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                          ...
                                          <td width="75%" align="left">
										            <font color="#0033FF" size="2">Período encuesta docente 2015-02:<br>
                                                      <!-- <li><strong>Las Condes  : 05-01-2015 -> 27-03-2015.</strong></li>-->
													   ...
													   <li><strong> 03-11-2015 --> 24-03-2016.</strong></li></font>
