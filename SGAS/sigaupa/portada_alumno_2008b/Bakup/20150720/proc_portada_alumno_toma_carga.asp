...
'----------------------------------------------------------------------------------------------------------------
         'para el mes de matricula "v_mes_actual" = 7 (Julio)
		 'si la carrera es Publicidad y el "promedio" NO es vacio
		 ...
		 'si la carrera es Publicidad y no se matriculo en los dias indicados
...
'----------------------------------------------------------------------------------------------------------------
'Para la Carrera de PSICOLOGÍA = 43
'----------------------------------------------------------------------------------------------------------------
		 'si la carrera es PSICOLOGÍA
		 ...
		 'si la carrera es PSICOLOGÍA y no se matriculo en los dias indicados
		 if carr_ccod = "43" then
			es_carrera = true	
			if v_mes_actual = 7 and v_dia_actual >= 17 and v_dia_actual <= 26 then
				crear_acceso = true
...
'----------------------------------------------------------------------------------------------------------------
'Para la Carrera de RELACIONES PÚBLICAS = 47
'----------------------------------------------------------------------------------------------------------------
		'si la carrera es RELACIONES PÚBLICAS
		...
		'si la carrera es RELACIONES PÚBLICAS y no se matriculo en los dias indicados
		if carr_ccod = "47" then
			es_carrera = true	
			if v_mes_actual = 7 and v_dia_actual >= 17 and v_dia_actual <= 26 then
				crear_acceso = true
