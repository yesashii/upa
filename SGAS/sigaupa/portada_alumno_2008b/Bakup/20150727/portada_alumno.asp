...
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
'habilitar encuesta docente cambiando las fechas correspondientes
c_encuesta = " select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'01/06/2015',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'14/08/2015',103) "&_
              " then 'S' else 'N' end "
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
'-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
'habilitar toma de ramos cambiando las fechas correspondientes
 pasa_fecha2 = conexion.consultaUno("select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'13/07/2015',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'26/07/2015',103) then 'S' else 'N' end")
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
							...
							<tr>
								<td width="100%" align="center">
                                    ...
                                    <td align="center" width="25%" background="../imagenes/degradado.jpg"><font size="2" color="#990000"><strong>Encuesta 
                                      Docente 2015-01</strong></font></td>
														<td colspan="3">&nbsp;</td>
													</tr>
													<tr>
                                          ...
                                          <td width="75%" align="left">
										            <font color="#0033FF" size="2">Período encuesta docente 2015-01:<br>
                                                      <!-- <li><strong>Las Condes  : 05-01-2015 -> 27-03-2015.</strong></li>-->
													   <!--<li><strong>Melipilla   : 05-01-2015 -> 27-03-2015.</strong></li>-->
													   <li><strong> 01-06-2015 --> <font color="#FF0000">14-08-2015</font>.</strong></li>
                                                    </font>
													</td>
															</tr>
														</table>
													...
													<tr>
														...
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
															    ...
															    <!--Sedes Las Condes y Melipilla: 12-01-2015 -> 27-02-2015.-<br>-->
															    <!--La Araucana: 06-04-2015 -> 18-04-2015.</strong></li><br>-->
														                                                    </font></td>
															</tr>
														</table>
														</td>
