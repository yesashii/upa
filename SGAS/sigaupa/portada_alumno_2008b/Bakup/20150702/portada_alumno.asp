...
if ip_usuario="172.16.11.67" or ip_usuario="172.16.100.83"then
...
c_encuesta = " select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'01/06/2015',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'13/07/2015',103) "&_
              " then 'S' else 'N' end "
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
'habilitar toma de ramos cambiando las fechas correspondientes
 pasa_fecha2 = conexion.consultaUno("select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'01/03/2015',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'13/07/2015',103) then 'S' else 'N' end")
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                    ...
                                    <td align="center" width="25%" background="../imagenes/degradado.jpg"><font size="2" color="#990000"><strong>Encuesta 
                                          ...
                                          <td width="75%" align="left">
										            <font color="#0033FF" size="2">Período encuesta docente 2015-01:<br>
                                                      <!-- <li><strong>Las Condes  : 05-01-2015 -> 27-03-2015.</strong></li>-->
													   ...
													   <li><strong> 01-06-2015 --> <font color="#FF0000">13-07-2015</font>.</strong></li>
                                                    </font>
													</td>
															</tr>
														</table>
													...
													<tr>
														<td align="center" colspan="4"  background="../imagenes/degradado.jpg"><input type="button" id="evaluacion" name="evaluacion" value="Contestar Encuesta" onClick="_Guardar(this, document.forms['valida'], 'proc_portada_alumno_evaluacion.asp','', '', '', 'FALSE');" title="Revisar estado o contestar evaluación docente"></td>
													</tr>
													<tr>
									  ...
									  <tr>
									      <td height="20" colspan="4" align="center">
										  		<table width="90%" cellpadding="0" cellspacing="0" border="0">
													<tr>
														<td align="center" width="25%" background="../imagenes/degradado.jpg"><font size="2" color="#006600"><strong>Toma de Carga "2015-01"</strong></font></td>
													...
													<tr>
														...
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																<td width="25%" align="center"><img width="85" height="59" src="../imagenes/megafonos.png"></td>
																<td width="75%" align="left"><font color="#006600" size="2">Estimado(a) alumno(a):<br> Ya se encuentra disponible el acceso a toma de carga online, no olvides consultar el calendario de esta actividad para tu escuela (<a href="../doc/calendario_toma_de_carga_2015_01.pdf" target="_blank">AQUI</a>).<br>
