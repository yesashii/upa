  ...
  if ucase(password) =  ucase(clave_alumno) then
	 ...
	 if RUT <> "" then
	   ...
	   if es_alumno <> "0" then
		 ...
		 promedio     = conexion.consultaUno("select promedio from PROMEDIOS_ALUMNOS_CARRERA where cast(pers_ncorr as varchar)='"&pers_ncorr&"' and carr_ccod='"&carr_ccod&"' and peri_ccod=234")
		 crear_acceso=false
		 es_carrera = false
		 ...
		 if carr_ccod ="45" and v_mes_actual=7 and not esVacio(promedio) then 'Para la Carrera de Publicidad
			es_carrera = true
			crear_acceso = false
			if  v_dia_actual=14 and cDbl(promedio) >= 5.3 then 
		  		    es_carrera = true
					crear_acceso = true
					'RESPONSE.Write("9")		
			elseif anio_ingreso <= "2012" and v_dia_actual=15 then 
			...
			elseif anio_ingreso = "2013" and v_dia_actual=16 then 
				if v_hora_sys < 12 and cDbl(promedio) >= 5.0 then
					es_carrera = true
					crear_acceso = true
					'RESPONSE.Write("12")
			...
			elseif anio_ingreso = "2014" and v_dia_actual=17 then 
				if v_hora_sys < 12 and cDbl(promedio) >= 5.0 then
					es_carrera = true
					crear_acceso = true
					'RESPONSE.Write("14")
		 ...
		 if carr_ccod ="45" then
			es_carrera = true	
			if ((v_mes_actual=7 and v_dia_actual >= 18 and v_dia_actual <= 25 )) then
				crear_acceso = true
			end if
		 ...
		 if carr_ccod ="43" then
			es_carrera = true	
			if v_mes_actual=7 and (v_dia_actual = 18 or v_dia_actual = 19) and  anio_ingreso <= "2010" then
				crear_acceso = true
			elseif v_mes_actual=7 and (v_dia_actual = 19 or v_dia_actual = 20) and  anio_ingreso = "2011" then
				crear_acceso = true
			elseif v_mes_actual=7 and (v_dia_actual = 20 or v_dia_actual = 21) and  anio_ingreso = "2012" then
				crear_acceso = true	
			elseif v_mes_actual=7 and (v_dia_actual = 21 or v_dia_actual = 22) and  anio_ingreso = "2013" then
				crear_acceso = true
			elseif v_mes_actual=7 and (v_dia_actual = 22 or v_dia_actual = 23) and  anio_ingreso = "2014" then
				crear_acceso = true	
			end if
		 end if 
		 ...
		 if carr_ccod ="43" then
			es_carrera = true	
			if v_mes_actual=7 and v_dia_actual >= 24 and v_dia_actual <= 27 then
				crear_acceso = true
			end if
			'if v_mes_actual=7 and v_dia_actual <= 28 then
			'	crear_acceso = true
			'end if
		 end if 	 
		...
		' end if 	
		 ...
		 if carr_ccod ="800" or carr_ccod ="8" or carr_ccod ="975" or carr_ccod ="970" or carr_ccod ="41" or carr_ccod ="17" or carr_ccod ="16" or carr_ccod ="860" or carr_ccod ="880" or carr_ccod ="940" or carr_ccod ="49" or carr_ccod ="99" or carr_ccod ="51" or carr_ccod ="106" or carr_ccod ="105" or carr_ccod ="830" or carr_ccod ="850" or carr_ccod ="108" or carr_ccod ="32" or carr_ccod ="14" or carr_ccod ="104" or carr_ccod ="112" or carr_ccod ="103" or carr_ccod ="113" or carr_ccod ="100" or carr_ccod ="101" or carr_ccod ="102"   then
			es_carrera = true	
			if v_mes_actual=7 and (v_dia_actual >= 18) and (v_dia_actual <= 27) then
				crear_acceso = true
			end if
		 end if 
		 ...
		 if sede_ccod = "9" then
			es_carrera = true	
			if (v_mes_actual=7 and v_dia_actual >= 28 and v_dia_actual <= 31 ) then
				crear_acceso = true
			end if
			if (v_mes_actual=8 and v_dia_actual >= 1 and v_dia_actual <= 10 ) then
				crear_acceso = true
			end if
		 end if
