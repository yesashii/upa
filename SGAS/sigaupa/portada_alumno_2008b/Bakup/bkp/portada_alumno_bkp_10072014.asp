...
' pasa_fecha = conexion.consultaUno("select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'25/04/2011',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'22/05/2011',103) then 'S' else 'N' end")
 c_encuesta = " select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'07/04/2014',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'14/08/2014',103) "&_
              " then 'S' else 'N' end "
 ...
 pasa_fecha2 = conexion.consultaUno("select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'07/04/2014',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'27/04/2014',103) then 'S' else 'N' end")
 if pasa_fecha2 = "N" then 
	 ...
	 grabo_promedio  = conexion.consultaUno("select count(*) from PROMEDIOS_ALUMNOS_CARRERA where peri_ccod=232")
	 if grabo_promedio = "0" then
		c_graba_promedio = "insert into PROMEDIOS_ALUMNOS_CARRERA "& vbCrLf &_
						   ...
						   " and b.peri_ccod=232 and a.alum_nmatricula <> 7777 "& vbCrLf &_
							...
							<tr>
								<td width="100%" align="center">
                                    ...
                                    <td align="center" width="25%" background="../imagenes/degradado.jpg"><font size="2" color="#990000"><strong>Encuesta 
                                      Docente 2013-2014</strong></font></td>
														<td colspan="3">&nbsp;</td>
													</tr>
													<tr>
                                          ...
                                          <td width="75%" align="left">
										            <font color="#0033FF" size="2">Período encuesta docente 2013-02:<br>
                                                       <li><strong>La Araucana : 07-04-2014 --> <font color="#FF0000">05-05-2014</font>.</strong></li>
                                                    </font>
													<br>
													 <font color="#0033FF" size="2">Período encuesta docente 2014-01:<br>
                                                       <li><strong>Las Condes  : 28-04-2014 --> <font color="#FF0000">23-06-2014</font>.</strong></li>
													   <li><strong>Melipilla   : 28-04-2014 --> <font color="#FF0000">23-06-2014</font>.</strong></li>
													   <li><strong>La Araucana : 09-06-2014 --> <font color="#FF0000">14-06-2014</font>.</strong></li>
                                                    </font>
													<br>
													</td>
															</tr>
									  ...
									  <tr>
									      <td height="20" colspan="4" align="center">
										  		<table width="90%" cellpadding="0" cellspacing="0" border="0">
													<tr>
														<td align="center" width="25%" background="../imagenes/degradado.jpg"><font size="2" color="#006600"><strong>Toma de Carga "2014-01"</strong></font></td>
														<td colspan="3"><font size="2" color="#006600"><strong>La Araucana</strong></font></td>
													</tr>
													<tr>
														<td align="center" colspan="4" background="../imagenes/degradado.jpg">
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																<td width="25%" align="center"><img width="85" height="59" src="../imagenes/megafonos.png"></td>
																<td width="75%" align="left"><font color="#006600" size="2">Estimado(a) alumno(a):<br> Ya se encuentra disponible el acceso a toma de carga online, no olvides consultar el calendario de esta actividad para tu escuela (<a href="../doc/calendario_toma_de_carga_2014_01.pdf" target="_blank">AQUI</a>).<br>Todas las Sedes: 07-04-2014 --> 27-04-2014.-</strong></li><br>
														                                                    </font></td>
															</tr>
														</table>
														</td>
