...
'Activacion de ocultos para un IP especifica
activar_ocultos = false
activar_ocultos2 = false
if ip_usuario = "172.16.11.67" or ip_usuario = "172.16.100.83" or ip_usuario = "172.16.100.1"then
...
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
'habilitar encuesta docente alumno cambiando las fechas correspondientes
c_encuesta = " select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'03/11/2015',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'15/11/2015',103) "&_
              " then 'S' else 'N' end "
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
'-------------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
'habilitar toma de ramos cambiando las fechas correspondientes (rango de fechas debe contemplar todas las sedes (Las Condes, Melipilla, La Araucana)
 pasa_fecha2 = conexion.consultaUno("select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'13/07/2015',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'09/08/2015',103) then 'S' else 'N' end")
'--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
'response.Write("<pre>"&pasa_fecha2&"</pre>")
 ...
 if pasa_fecha2 = "N" then 
	 ...
	 grabo_promedio  = conexion.consultaUno("select count(*) from PROMEDIOS_ALUMNOS_CARRERA where peri_ccod=236")
	 if grabo_promedio = "0" then
		c_graba_promedio = "insert into PROMEDIOS_ALUMNOS_CARRERA "& vbCrLf &_
						   ...
						   " and b.peri_ccod=236 and a.alum_nmatricula <> 7777 "& vbCrLf &_
...
function parpadear(){ $('#parp').fadeIn(500).delay(250).fadeOut(250, parpadear) }
...
<table width="552" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
      <td width="552" colspan="2" align="center">
	    <table width="552" cellpadding="0" cellspacing="0">
			<tr valign="top">
				...
				<td width="6" height="135" bgcolor="#84a6d3" align="left"><!--<img width="33" height="135" src="../informacion_alumno_2008/imagenes/frame_portada_2.jpg"> --></td>
			</tr>
            <tr> 
    <td width="95%"><div id="parp"><span id="controlversion"> </span></div></td>
  </tr>  
			<tr valign="top">
								...
								<td width="100%" align="center">
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
									  ...
									  <tr> 
										...
										<td width="28%" height="10" align="center"><div align="left">
										<% 
										response.Write("")
										if usuario = "4" then
										...
										botonera.dibujaboton "aceptar"%></div></td>
                                      ...
                                      <% 'response.Write(activar_ocultos)
                                    ...
                                    <td align="center" width="25%" background="../imagenes/degradado.jpg"><font size="2" color="#990000"><strong>Encuesta 
                                      Docente 2015-02</strong></font></td>
														<td colspan="3">&nbsp;</td>
													</tr>
													<tr>
                                          ...
                                          <td width="75%" align="left">
										            <font color="#0033FF" size="2">Período encuesta docente 2015-02:<br>
                                                      <!-- <li><strong>Las Condes  : 05-01-2015 -> 27-03-2015.</strong></li>-->
													   <!--<li><strong>Melipilla   : 05-01-2015 -> 27-03-2015.</strong></li>-->
													   <li><strong> 03-11-2015 --> 15-11-2015.</strong></li></font>
													...
													<tr>
														<td align="center" colspan="4"  background="../imagenes/degradado.jpg"><input type="button" name="evaluacion" value="Contestar Encuesta" onClick="_Guardar(this, document.forms['valida'], 'proc_portada_alumno_evaluacion.asp','', '', '', 'FALSE');"></td>
													</tr>
													<tr>
									  ...
									  <tr>
									      <td height="20" colspan="4" align="center">
										  		<table width="90%" cellpadding="0" cellspacing="0" border="0">
													<tr>
														<td align="center" width="25%" background="../imagenes/degradado.jpg"><font size="2" color="#006600"><strong>Toma de Carga "2015-02"</strong></font></td>
													...
													<tr>
														...
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																<td width="25%" align="center"><img width="85" height="59" src="../imagenes/megafonos.png"></td>
																<td width="75%" align="left"><font color="#006600" size="2">Estimado(a) alumno(a):<br> Ya se encuentra disponible el acceso a toma de carga online, no olvides consultar el calendario de esta actividad para tu escuela (<a href="../doc/calendario_toma_de_carga_2015_02.pdf" target="_blank">AQUI</a>).<br>
															    <!--Sedes Las Condes y Melipilla: 17-07-2015 -> 26-07-2015.-<br>-->
															    <!--La Araucana: 27-07-2015 -> 09-08-2015.</strong></li><br>-->
														                                                    </font></td>
															</tr>
														</table>
														</td>
										  		...
										  		<table width="291" height="81" cellpadding="0" cellspacing="0">
													<tr>
													   <!--<td width="95" height="81">
														...
														<td width="3">&nbsp;</td>
														<td width="95" height="81"><a href="http://empleos.upacifico.cl/" target="_blank"><img src="portada/img/alumni1.jpg" onmouseover="javascript:this.src='portada/img/alumni2.jpg';" onmouseout="javascript:this.src='portada/img/alumni1.jpg';"/></a></td>
													</tr>
												</table>
										  </td>
									  </tr>
				...
				<td width="6" bgcolor="#84a6d3" align="left">&nbsp;</td>
			</tr>
			<tr>
