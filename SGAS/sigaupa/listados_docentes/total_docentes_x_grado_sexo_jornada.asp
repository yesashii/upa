...
q_tido_ccod=Request.QueryString("b[0][tido_ccod]")
...
f_busqueda.AgregaCampoCons "tido_ccod", q_tido_ccod
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>&nbsp;</td>
				...
				<form name="buscador" >
				  <table cellspacing=0 cellpadding=0 align="left" width="27%" border=0 >
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td width="84%">Tipo 
                          Docente</td> 
                        <td width="16%">
                           <%f_busqueda.DibujaCampo("tido_ccod")%></td> 
			...
			<tr>
                            <td width="44%" height=40 align=middle valign=top>
                              <div align="center"><strong><font size="2">Debe Selecionar el Periodo Académico y el Tipo de Carrera y el Tipo de Docente</font></strong><br> </div></td>
                      </tr>
			</table>
				</form>
                </td>
          ...
          <tr>
            <td><div align="left"><br>
              <%pagina.DibujarTituloPagina%><br>
				...
				<% if cint(q_peri_ccod) >0 and cint(q_tcar_ccod) >0 and cint(q_tido_ccod) >0 then%>
				  <tr>
							<td>
							 <div align="center">
							  <%botonera.AgregaBotonParam "excel", "url", "total_docentes_x_grado_sexo_jornada_excel.asp?peri_ccod="&q_peri_ccod&"&tcar_ccod="&q_tcar_ccod&"&tido_ccod="&q_tido_ccod&""
