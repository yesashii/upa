...
profesores="select   pers_nrut,pers_xdv,pers_tape_paterno,pers_tape_materno,pers_tnombre, "& vbCrLf &_
			...
			"(select pais_tdesc from paises where pais_ccod=aa.pais_ccod)as nacionalidad, "& vbCrLf &_
			"(select top 1 ((datepart(yyyy,getdate())+1)-isnull(prof_ingreso_uas,0))from profesores where pers_ncorr=aa.pers_ncorr)as numero_de_años_en_la_institucion, "& vbCrLf &_
			"isnull((select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,1,226)),'')as Unidad_academica, "& vbCrLf &_
			"(select  case when sss is null then ' ' else '15' end  from (select (select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,1,226))as sss)aaaa)  as region_unidad_academica,  "& vbCrLf &_
			"isnull((select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,2,226)),'')as Segunda_Unidad_academica "& vbCrLf &_
			",(select  case when sss is null then ' ' else '15' end  from (select (select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,2,226))as sss)aaaa) as region_segunda_academica, "& vbCrLf &_
			"isnull((select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,3,226)),'')as Tercera_Unidad_academica "& vbCrLf &_
			",(select  case when sss is null then ' ' else '15' end  from (select (select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,3,226))as sss)aaaa) as region_tercera_academica, "& vbCrLf &_
			"isnull((select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,4,226)),'')as Cuarta_Unidad_academica "& vbCrLf &_
			",(select  case when sss is null then ' ' else '15' end  from (select (select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,4,226))as sss)aaaa) as region_cuarta_academica, "& vbCrLf &_
			"isnull((select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,5,226)),'')as Quinta_Unidad_academica "& vbCrLf &_
			",(select  case when sss is null then ' ' else '15' end  from (select (select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,5,226))as sss)aaaa) as region_quinta_academica, "& vbCrLf &_
			"isnull((select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,6,226)),'')as Sexta_Unidad_academica "& vbCrLf &_
			",(select  case when sss is null then ' ' else '15' end  from (select (select protic.obtener_carrera_con_mas_horas(aa.pers_ncorr,6,226))as sss)aaaa) as region_sexta_academica,  "& vbCrLf &_
			"(select  protic.obtener_grado_docente_completados(aa.pers_ncorr,'D'))as titulo_grado_obtenido, "& vbCrLf &_
			"(select case when protic.obtener_grado_docente_completados(aa.pers_ncorr,'G')='DOCTORADO'then 1 when protic.obtener_grado_docente_completados(aa.pers_ncorr,'G')='MAGISTER'then 2 "& vbCrLf &_
			"when protic.obtener_grado_docente_completados(aa.pers_ncorr,'G')='MAESTRIA'then 2 "& vbCrLf &_
			"when protic.obtener_grado_docente_completados(aa.pers_ncorr,'G')='PROFESIONAL'then 4 when protic.obtener_grado_docente_completados(aa.pers_ncorr,'G')='LICENCIADO'then 5 "& vbCrLf &_
			...
			"(select  protic.obtener_grado_docente_completados(aa.pers_ncorr,'P'))as pais_en_que_lo_obtuvo, "& vbCrLf &_
			"protic.trunc((select protic.obtener_grado_docente_completados(aa.pers_ncorr,'F')))as fecha_que_lo_obtuvo "& vbCrLf &_
			",isnull((select protic.obtener_horas_academicas_x_contrato(aa.pers_ncorr,2,226)),0)as horas_academicas_indefinido "& vbCrLf &_
			",isnull((select protic.obtener_horas_academicas_x_contrato(aa.pers_ncorr,3,226)),0)as horas_academicas_plazo "& vbCrLf &_
			",isnull((select protic.obtener_horas_academicas_x_contrato(aa.pers_ncorr,1,226)),0)as horas_academicas_honorarios "& vbCrLf &_
			",isnull((select protic.obtener_horas_administrativas(aa.pers_ncorr,2,226)),0)as horas_administrativas_indefinido "& vbCrLf &_
			",isnull((select protic.obtener_horas_administrativas(aa.pers_ncorr,3,226)),0)as horas_administrativas_Planta_fijo "& vbCrLf &_
			",isnull((select protic.obtener_horas_administrativas(aa.pers_ncorr,1,226)),0)as horas_administrativas_Planta_honorario "& vbCrLf &_
			"from  personas aa "& vbCrLf &_
			"where aa.pers_ncorr in ( "& vbCrLf &_
			"    select distinct a.pers_ncorr "& vbCrLf &_
			"    from profesores a, bloques_profesores b,bloques_horarios c,secciones d,carreras e,anos_tipo_docente f,contratos_docentes_upa g,anexos h,detalle_anexos i,personas j "& vbCrLf &_
