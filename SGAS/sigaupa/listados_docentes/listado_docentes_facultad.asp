...
consulta =	" select distinct a.pers_ncorr,cast(b.pers_nrut as varchar)+'-'+b.pers_xdv as rut, b.pers_tape_paterno + ' ' + b.pers_tape_materno + ' ' + b.pers_tnombre as docente,datediff(year,b.pers_fnacimiento,getDate()) as edad     " & vbCrLf &_
			...
			" and a.peri_ccod= pa.peri_ccod and cast(pa.anos_ccod as varchar)='"&ano_consulta&"'	and a.carr_ccod=e.carr_ccod and e.tcar_ccod=1 and cast(a.carr_ccod as varchar)='"&carr_ccod&"' " & vbCrLf &_
			" union all	 " & vbCrLf &_
			" select distinct c.pers_ncorr 	 " & vbCrLf &_
			...
			" where a.secc_ccod = b.secc_ccod and b.bloq_ccod=c.bloq_ccod and a.asig_ccod=g.asig_ccod and g.duas_ccod in (1,2,3) " & vbCrLf &_
			" and c.pers_ncorr = d.pers_ncorr and tpro_ccod=1 and cast(a.carr_ccod as varchar)='"&carr_ccod&"' " & vbCrLf &_
...
facultad = conectar.consultaUno("Select protic.initcap(facu_tdesc) from  facultades where cast(facu_ccod as varchar)='"&facu_ccod&"'")
            ...
            <td><div align="center">
                    ...
                    <form name="edicion">
                      ...
                      <table width="98%" align="center">
					    <tr>
                          <td width="10%"><strong>Facultad</strong></td>
            ...
            <td width="15%" height="20"><div align="center">
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center">
                            <% 
							botonera.agregabotonparam "anterior","url","docentes_facultad_carrera.ASP?busqueda[0][facu_ccod]="&facu_ccod
