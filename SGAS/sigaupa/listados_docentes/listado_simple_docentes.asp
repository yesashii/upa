...
Response.AddHeader "Content-Disposition", "attachment;filename=listado_particular_docentes.xls"
...
set f_docentes = new CFormulario
 ...
 consulta = " select distinct cast(g.pers_nrut as varchar)+'-'+g.pers_xdv as rut, " & vbCrLf &_
			...
			" g.pers_tfono as fono, g.pers_tcelular as celular,g.pers_temail as email,protic.obtener_direccion(g.pers_ncorr,1,'CNPB') as direccion,protic.obtener_direccion(g.pers_ncorr,1,'C-C') as ciudad" & vbCrLf &_
			" from secciones a, periodos_Academicos b,bloques_horarios e, bloques_profesores f, personas g " & vbCrLf &_
			...
			" and f.tpro_ccod=1 and f.pers_ncorr = g.pers_ncorr  " & vbCrLf &_
...
<p>&nbsp;</p><table width="100%" border="1">
  ...
  <tr> 
	...
	<td><div align="left"><%=f_docentes.ObtenerValor("fono")%></div></td>
	<td><div align="left"><%=f_docentes.ObtenerValor("celular")%></div></td>
	<td><div align="left"><%=f_docentes.ObtenerValor("email")%></div></td>
	<td><div align="left"><%=f_docentes.ObtenerValor("direccion")%></div></td>
	<td><div align="left"><%=f_docentes.ObtenerValor("ciudad")%></div></td>
