...
//alert(contestada2)
  ...
  {
  aviso=aviso+"preg 1 debes seleccionar 3 \r"; 
  }
} 
 //----------------------------
{ 
...
//alert(contestada2)
  ...
  {
  aviso=aviso+"preg 3 debes seleccionar 3\r"; 
  }
} 
 //----------------------------
...
//alert(contestada2)
  ...
  {
  aviso=aviso+"preg 4 debes seleccionar 3\r"; 
  }
}
  //----------------------------
		  ...
		  <tr>
			...
			<td width="723" align="left">
			   <table width="90%" border="0" bgcolor="#FFFFFF">
                  ...
                  <tr>
                    <td class="Estilo31"><p>Estimado(a) Ex Alumno:
Agradeceremos puedas contestar la siguiente encuesta la cual no te tomará mas de 5 minutos en responderla. Tu respuesta  nos permitirá fortalecer las redes de comunicación y vinculación entre los egresados y la Corporación de Profesionales del  la Universidad del Pacífico.
</p>
<p>Hemos querido incentivar tu respuesta, para lo cual si lo deseas podrás participar en el sorteo 4 Gift Card de Almacenes París con $20.000 c/u que se sortearán entre los que la hayan contestado hasta el día lunes 6 de diciembre de 2010.</p>

<p>Los datos recogidos son confidenciales y sólo para lograr los objetivos del estudio.</p> 
</td>
                   </tr>
				   </table>
				  <br />
				  <table>
				  <tr><td class="Estilo31">1.- Se&ntilde;ala cu&aacute;les &nbsp;son las 3 principales redes sociales de  Internet que utilizas con mayor frecuencia.</p></td>
				  </tr>
				  </table>
				  <table>
				  	<tr>
				  ...
				  <table width="391">
					...
					<tr>
						...
						<td>Personalidades como m&uacute;sicos, pol&iacute;ticos, escritores  u otros.</td>
					</tr>
					<tr>
						<td>
				  ...
				  <table>
				  <tr>
				    <td>5.-&iquest;Cu&aacute;l fue tu principal motivaci&oacute;n en aceptar &ldquo;como  amigo&rdquo; a la comunidad virtual de la Corporaci&oacute;n de Profesionales del Pac&iacute;fico?</td>
				  </tr>
				  </table>
				  <br />
				  <table width="452">
				  	<tr>
						<td>
							<input type="radio" name="encu[0][preg_5]" value="1" />
						</td>
				...
				<br />
				  ...
				  <table>
				  <tr>
				    <td>8.-&iquest;Tu situaci&oacute;n laboral es?				      </p></td>
				  </tr>
				  </table>
				  <table>
					 <tr>
				  ...
				  <table>
				  <tr>
				    <td>9.-Si est&aacute;s trabajando, lo haces:</td>
				  </tr>
				  </table>
				  <table>
					 <tr>
				...
				<br />
				  <table>
				  	<tr>
						<td colspan="2">
							Ingresa tu Rut e email para participar en las cuatro Gift Card con $20.000 c/u que se sortearán entre los que hayan contestado la encuesta hasta el día lunes 6 de diciembre de 2010.
						</td>
					</tr>
					<tr>
						<td width="56">
							Rut						</td>
						<td width="655">
							<input type="text" name="encu[0][pers_nrut]" maxlength="8"  size="9" id="NU-N"/>-<input type="text" name="encu[0][pers_xdv]" maxlength="1"  size="2" id="TO-N" onblur="validarRut();"/> 
						</td>
					</tr>
					<tr>
						<td>
			  ...
			  <table width="100%">
			   ...
			   <td width="36%" align="rigth" valign="top" class="Estilo31"></td>
					<td width="11%" align="center" valign="top" class="Estilo31">
						<img src="Images/guardar1.png" border="0" width="55" height="55" style="cursor: pointer" alt="¿Cómo funciona?" onclick="_Guardar(this, document.forms['edicion'], 'encuesta_proc.asp','', 'ValidarMarcados()', 'Recuerde que una vez guardada la encuesta usted no podra hacer cambios', 'FALSE');"></td>
