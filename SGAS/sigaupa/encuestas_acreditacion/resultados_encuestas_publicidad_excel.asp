...
Response.AddHeader "Content-Disposition", "attachment;filename=encuestas_acreditacion_publicidad.xls"
...
consulta = " select distinct b.carr_tdesc as carrera,nombre_empresa,case tamano_empresa when 1 then 'Grande (100 funcionarios o más)'  when 2 then 'Mediana (entre 31 y 99 funcionarios)' when 3 then 'Pequeña (30 funcionarios o menos)' end as tamano, "& vbCrLf &_
		   ...
		   " preg_18,preg_19,preg_20,preg_21,preg_22,preg_23,preg_24,preg_25,preg_26, "& vbCrLf &_
		   " case preg_27 when 4 then 'Muy de acuerdo' when 3 then 'De acuerdo' when 2 then 'En desacuerdo' when 1 then 'Muy en desacuerdo' when 0 then 'No cuento con información'  else 'no contestada' end as preg_27, "& vbCrLf &_
		   ...
		   " from encuesta_publicidad_empleadores a, carreras b  where isnull(antiguos,'N')='N' and a.carr_ccod = b.carr_ccod"
...
consulta = " select distinct d.carr_tdesc as carrera, cast(b.pers_nrut as varchar)+'-'+b.pers_xdv as rut, b.pers_tnombre + ' ' +  b.pers_tape_paterno + ' ' + b.pers_tape_materno as nombre, "& vbCrLf &_
		   ...
		   " case preg_27 when 4 then 'Muy de acuerdo' when 3 then 'De acuerdo' when 2 then 'En desacuerdo' when 1 then 'Muy en desacuerdo' when 0 then 'No cuento con información'  else 'no contestada' end as preg_27, "& vbCrLf &_
		   " case preg_28 when 4 then 'Muy de acuerdo' when 3 then 'De acuerdo' when 2 then 'En desacuerdo' when 1 then 'Muy en desacuerdo'   else 'no contestada' end as preg_6, "& vbCrLf &_
		   " case preg_31 when 4 then 'Muy de acuerdo' when 3 then 'De acuerdo' when 2 then 'En desacuerdo' when 1 then 'Muy en desacuerdo'   else 'no contestada' end as preg_31, "& vbCrLf &_
		   " case preg_32 when 4 then 'Muy de acuerdo' when 3 then 'De acuerdo' when 2 then 'En desacuerdo' when 1 then 'Muy en desacuerdo'   else 'no contestada' end as preg_32, "& vbCrLf &_
		   " case preg_33 when 4 then 'Muy de acuerdo' when 3 then 'De acuerdo' when 2 then 'En desacuerdo' when 1 then 'Muy en desacuerdo'   else 'no contestada' end as preg_33, "& vbCrLf &_
...
consulta = " select  distinct c.carr_tdesc as carrera,cast(b.pers_nrut as varchar)+'-'+b.pers_xdv as rut,b.pers_tnombre + ' ' +  b.pers_tape_paterno + ' ' + b.pers_tape_materno as nombre, "& vbCrLf &_
		   ...
		   " case preg_59 when 4 then 'Muy de acuerdo' when 3 then 'De acuerdo' when 2 then 'En desacuerdo' when 1 then 'Muy en desacuerdo'   else 'no contestada' end as preg_59, "& vbCrLf &_
		   " case preg_60 when 4 then 'Muy de acuerdo' when 3 then 'De acuerdo' when 2 then 'En desacuerdo' when 1 then 'Muy en desacuerdo'   else 'no contestada' end as preg_60, "& vbCrLf &_
		   " contenidos_faltantes,sugerencias_autoridades"& vbCrLf &_
		   " from encuesta_publicidad_egresados a, personas b,carreras c "& vbCrLf &_
		   " where a.pers_ncorr = b.pers_ncorr and isnull(antiguos,'N')='N' and a.carr_ccod=c.carr_ccod and isnull(a.pers_ncorr,0)<>0"
...
<html>
<head>
<title>Resultados Parciales Encuesta Acreditación Publicidad</title>
<meta http-equiv="Content-Type" content="text/html;">
</head>
<body >
<table width="100%" border="0">
 <tr> 
    <td colspan="4"><div align="center"><font size="+2" face="Arial, Helvetica, sans-serif">Resultados Parciales Encuesta de Acreditación Publicidad</font></div>
	</td>
 </tr>
  <tr> 
    <td colspan="4">&nbsp;</td>
 ...
 <table width="100%" border="1">
  <tr><td colspan="3" bgcolor="#CCFFCC"><font size="+1"><strong>Encuesta Empleadores</strong></font></td>
      <td colspan="45" bgcolor="#CCFFCC">&nbsp;</td>
  </tr>
  <tr> 
	...
	<td><div align="left"><strong>35. Señale a continuación las deficiencias y limitaciones profesionales que usted observa en los egresados de Publicidad de la Universidad del Pacífico y que le parece importante que la carrera enfrente.</strong></div></td>
	<td><div align="left"><strong>36. Señale las características que UD. reconoce en el egresado de Publicidad de la Universidad del Pacífico.</strong></div></td>
	<td><div align="left"><strong>37. Señale a continuación las características y capacidades que debería tener un profesional de la carrera de Publicidad para que le resultara útil a su organización.</strong></div></td>
  </tr>
  <% fila = 1  
...
<p>&nbsp;</p>
 <table width="100%" border="1">
  <tr><td colspan="9" bgcolor="#CCFFCC"><font size="+1"><strong>Encuesta Alumnos Egresados</strong></font></td>
      <td colspan="72" bgcolor="#CCFFCC">&nbsp;</td>
  </tr>
  <tr> 
    <td><div align="center"><strong>fila</strong></div></td>
	<td><div align="center"><strong>Carrera</strong></div></td>
