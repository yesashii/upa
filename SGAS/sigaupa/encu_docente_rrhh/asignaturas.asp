...
peri=conexion.ConsultaUno("select peri_tdesc from periodos_academicos where peri_ccod="&peri_ccod2&"") 
...
'if v_mes_actual = 6 and v_dia_actual >= 2 and v_dia_actual <= 8 then
'  sedes_filtro = "1,4"
'elseif v_mes_actual = 6 and v_dia_actual >= 9 and v_dia_actual <= 14 then
'  sedes_filtro = "1,4,9"  
'elseif v_mes_actual = 6 and v_dia_actual = 15 then
'  sedes_filtro = "1,4"  
'end if
'fin del filtro sedes	   

if v_mes_actual = 10 and v_dia_actual >= 6 and v_dia_actual <= 31 then
	sedes_filtro = "1,4,9"  
end if
if v_mes_actual = 11 and v_dia_actual >= 1 and v_dia_actual <= 17 then
	sedes_filtro = "1,4,9"  
end if
...
{
window.location=("encuesta.asp?secc="+valor+"&pers_ncorr="+valor2+"")
		  ...
		  <tr>
			...
			<td width="723" align="left">
				...
				<table width="654">
					<tr>
						<td align="center">
							<p class="Estilo35"><strong>CUESTIONARIO DE AUTO  EVALUACI&Oacute;N DOCENTE</strong></p>
						</td>
					</tr>
				</table>
					<br /> 
			  ...
			  <hr align="left" width="100%" size="1" noshade="noshade" />
				...
				<p class="Estilo31"><strong>Seleccione la Sección a Evaluar</strong> </p>
				
				<table width="100%" >
				<%while f_asignatura.Siguiente %>
			   <tr>
			    <td colspan="2"><strong>ASIGNATURA: <%=f_asignatura.ObtenerValor("asig_tdesc")%></strong></td>
				</tr>
				...
				seccion=f_secciones.ObtenerValor("secc_ccod")
					evaluada=conexion.ConsultaUno("select case count(*)when 0 then 'No'else 'Si'end from auto_encuesta_docente_hhrr where pers_ncorr="&pers_ncorr&" and secc_ccod="&seccion&"")
				...
				if evaluada="No" then
				btn2="<a href="&""&"javascript:ir('"&f_secciones.ObtenerValor("secc_ccod")&"','"&pers_ncorr&"');"&""&">"& vbCrLf &_
				"<img src="&""&"Images/evaluar3.png"&""&" border="&""&"0"&""&" width="&""&"65"&""&" height="&""&"65"&""&" alt="&""&"VOLVER AL HOME"&""&">"
				else
				btn2="<img src="&""&"Images/listo3.png"&""&" border="&""&"0"&""&" width="&""&"80"&""&" height="&""&"70"&""&" alt="&""&"VOLVER AL HOME"&""&">"
				end if	
				%>
				 ...
				 <%end if%>
					 ...
					 <table align="center" width="100%">
						<tr>
							<td width="150"><%=f_secciones.ObtenerValor("carr_tdesc")%> Sección <%=f_secciones.ObtenerValor("secc_tdesc")%></td>
							<td width="374" align="left"><%=btn2%></td>
						</tr>
					 </table>
					</td>
