...
datos.Carga_Parametros "genera_informe.xml", "busqueda_upa"
...
function verifica_periodos(valor,nombre)
{
	...
	anos_1=document.excel.elements['c[0][anos_ccod]'].value
	anos_2=document.excel.elements['c[0][anos_ccod_fin]'].value
	...
	if (anos_1 != "" || anos_2 != ""){
		document.excel.elements['c[0][peri_ccod]'].disabled = true
	}else{
		document.excel.elements['c[0][peri_ccod]'].disabled = false			
	}
}

function bloquearcampo(valor,nombre){
	//alert(valor+" nombre "+ nombre )
	carr=document.excel.elements['c[0][carr_ccod]'].value
	facu=document.excel.elements['c[0][facu_ccod]'].value
	
	if (carr != ""){
		document.excel.elements['c[0][facu_ccod]'].disabled = true
	}else{
		document.excel.elements['c[0][facu_ccod]'].disabled = false			
	}
	
	if (facu != ""){
		document.excel.elements['c[0][carr_ccod]'].disabled = true
	}else{
		document.excel.elements['c[0][carr_ccod]'].disabled = false			
	}
}
      ...
      <tr>
        ...
        <td>
			<table width="100%"  border="0" cellspacing="0" cellpadding="0">
				  <tr>
					<td><%pagina.DibujarLenguetas Array("Estadisticas Postulantes UPA al Extranjero"), 1 %></td>
				  </tr>
				  <tr>
					...
					<td>
						...
						<form name="excel">
							...
							<table align="center" width="100%">
								...
								<tr>
								  <td><strong>Universidad de Destino :</strong></td>
								  <td><%datos.DibujaCampo("univ_ccod")%></td>
							  </tr>
								<tr>
								  <td><strong>Pais de Destino:</strong></td>
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				 <td><div align="center"><%f_botonera.DibujaBoton("salir")%></div></td>	
                  <td><div align="center">
					<%f_botonera.DibujaBoton"imprimir_upa"%></div></td>
                  </tr>
              </table>
            </div></td>
