...
existe=conexion.ConsultaUno(consulta_tiene_matricula)
	...
	sql_descuentos="select e.paiu_ncorr,a.pers_ncorr,pers_tnombre,pers_tape_paterno,tdin_ccod,pers_tfono,pers_tcelular,pers_tape_materno,carr_tdesc"& vbCrLf &_
