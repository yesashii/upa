...
sql_descuentos="select a.paiu_ncorr,unci_ncorr,peri_ccod,tdin_ccod,"& vbCrLf &_
								...
								<%f_proceso.DibujaCampo("paiu_ncorr")%>
								  ...
								  <table width="98%"  border="0" align="center">
									  <tr>
									    ...
									    <td width="12%" valign="top">
												<select name="a[0][respuesta_cons_esc]">
								  ...
								  <table width="98%"  border="0" align="center">
									  <tr>
							            ...
							            <td width="18%"valign="top"><%f_proceso.DibujaCampo("diau_fenvio_ramos_esc")%></td>
										  <td width="13%" align="left" valign="top">Comentario  </td>
								  ...
								  <table width="98%"  border="0" align="center">
									  <tr>
										 <td width="11%" align="left"valign="top">Fecha Recepci&oacute;n </td>
							            <td width="19%"valign="top"><%f_proceso.DibujaCampo("diau_frecepcion_acuerdo_preconva")%></td>
										 <td width="14%" align="left" valign="top">Comentario </td>
								  ...
								  <table width="98%"  border="0" align="center">
									  <tr>
										 <td width="11%" align="left" valign="top">Fecha Env&iacute;o </td>
							            <td width="18%" valign="top"><%f_proceso.DibujaCampo("diau_fenvio_doctos_extranjero")%></td>
										<td width="12%" align="right" valign="top">Comentario  </td>
									    <td width="59%" valign="top"><textarea name="a[0][diau_comen_envio_doctos_extranjero]" rows="5" style="width:250"><%=f_proceso.ObtenerValor("diau_comen_envio_doctos_extranjero")%></textarea></td>
									 </tr>
								  </table>
								  <br/><hr/>
								    ...
								    <table width="98%"  border="0" align="center">
									  <tr>
										 <td width="10%" align="left" valign="top">Fecha de Recepci&oacute;n </td>
						                 <td width="19%" valign="top"><%f_proceso.DibujaCampo("diau_frecepcion_carta_acepta")%></td>
										  <td width="12%" align="left" valign="top">Comentario </td>
										<td width="59%"><textarea name="a[0][diau_comen_recepcion_carta_acepta]" rows="5" style="width:250"><%=f_proceso.ObtenerValor("diau_comen_recepcion_carta_acepta")%></textarea></td>
									 </tr>
								  </table>
								  <br/><hr/>
								    ...
								    <table width="98%"  border="0" align="center">
									  <tr>
										 <td width="10%" align="left" valign="top">Fecha de Firma de Compromiso Alumno </td>
					                    <td width="19%" valign="top"><%f_proceso.DibujaCampo("diau_ffirma")%></td>
										 <td width="13%" align="left" valign="top">Comentario </td>
										<td width="58%"><textarea name="a[0][diau_comen_firma]" rows="5" style="width:250"><%=f_proceso.ObtenerValor("diau_comen_firma")%></textarea></td>
									 </tr>
								  </table>
								  <br/><hr/>								
								</td>
