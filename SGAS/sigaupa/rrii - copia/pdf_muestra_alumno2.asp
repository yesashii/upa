...
pdf.ln(10)
pdf.SetFont "Arial","B",10
pdf.Cell 57,1,"Máximo de Asignaturas a Cursar:","","","L"
pdf.SetFont "Arial","",10
pdf.MultiCell 130,5,f_datos_convenio.obtenervalor("daco_tramos_cursar"),"","","L"
...
pdf.SetFont "Arial","",10
pdf.Cell 25,1,f_datos_convenio.obtenervalor("daco_flimite_pos_sem1_upa"),"","","L"
pdf.SetFont "Arial","B",10
pdf.Cell 23,1,"Inicio Clases:","","","L"
pdf.SetFont "Arial","",10
pdf.Cell 24,1,f_datos_convenio.obtenervalor("daco_fini_clase_sem1"),"","","L"
pdf.SetFont "Arial","B",10
...
pdf.Cell 45,1,"Fecha Limite Postulación:","","","L"
pdf.SetFont "Arial","",10
pdf.Cell 25,1,f_datos_convenio.obtenervalor("daco_flimite_pos_sem2_upa"),"","","L"
pdf.SetFont "Arial","B",10
pdf.Cell 23,1,"Inicio Clases:","","","L"
pdf.SetFont "Arial","",10
pdf.Cell 24,1,f_datos_convenio.obtenervalor("daco_fini_clase_sem2"),"","","L"
pdf.SetFont "Arial","B",10
pdf.Cell 28,1,"Termino Clases:","","","L"
pdf.SetFont "Arial","",10
...
pdf.SetFont "Arial","",10
pdf.SetX(50)
pdf.MultiCell 140,5,f_datos_convenio.obtenervalor("daco_ttest_idioma"),"0","","L"
...
pdf.SetFont "Arial","",10
pdf.MultiCell 150,5,f_costo.obtenervalor("covi_comentario"),"0","L",""
