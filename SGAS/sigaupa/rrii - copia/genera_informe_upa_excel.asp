...
"pais_tdesc,ciex_tdesc,univ_tdesc,e.univ_ccod,c.peri_ccod,f.pais_ccod,pa.PERI_TDESC,"& vbCrLf &_
...
"(select top 1 carr_tdesc from alumnos aa (nolock), detalle_postulantes bb, ofertas_academicas cc, especialidades dd,carreras ee "& vbCrLf &_
...
<table width="100%" border="1">
  ...
  <tr>
	...
	<td width="19%" bgcolor="#99CC33"><div align="center"><strong>Pais Destino</strong></div></td>			    <td width="15%" bgcolor="#99CC33"><div align="center"><strong>Periodo Academico</strong></div></td>  
  </tr>
