...
f_contactos.Carga_Parametros "convenios_rrii.xml", "contactos"
f_contactos.Inicializar conexion

sql_descuentos="select daco_ncorr,euco_ncorr,euco_tnombre as nombre from encargado_universidad_convenio where cast(daco_ncorr as varchar)='"&daco_ncorr&"'" 				
            ...
            <td>
				 ...
				 <input type="hidden" name="b[0][daco_ncorr]" value="<%=daco_ncorr%>">
					...
					<table width="100%">
						<tr>
							<td width="12%">&nbsp;</td>
							<td width="88%"><%f_botonera.DibujaBoton("agregar_contactos")%></td>
						</tr>
					</table>
					</form>
					<br>
					...
					<table width="100%">
						<tr>
							...
							<td width="50%" align="center"><strong>Contactos Ingresados</strong></td>
							<td width="25%" align="center"></td>
						...
						<tr>
							<td width="25%" align="center"></td>
							<td width="50%" align="left"><%f_botonera.DibujaBoton"eliminar_encargado"  %></td>
							<td width="25%" align="center"></td>
						</tr>
					</table>	
				  </form>
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				 <td><div align="center"><%f_botonera.DibujaBoton("salir")%></div></td>	
                  <td><div align="center">
					<%f_botonera.DibujaBoton"guardar_contactos"  %></div></td>
                  </tr>
              </table>
            </div></td>
