...
'response.Write(pers_nrut)
 ...
 if request.Form("fmpapa[0][pers_nrut]") = ""  then 
	...
	p_insert="insert into personas(pers_ncorr,pers_nrut,pers_xdv,pers_tnombre,pers_tape_paterno,pers_tape_materno,pers_tcelular,pers_temail,nedu_ccod,sicupadre_ccod,sitocup_ccod) values("&pers_ncorr&","&pers_nrut&",'"&pers_xdv&"','"&pers_tnombre&"','"&pers_tape_paterno&"','"&pers_tape_materno&"','"&pers_tcelular&"','"&pers_temail&"','"&nedu_ccod&"','"&sicupadre_ccod&"','"&sitocup_ccod&"')"		  
	...
	response.Write ("<pre>"&d_insert&"</pre>")
...
'conectar.ejecutaS (m_insert)
 ...
 'conectar.ejecutaS (gfm_insert)
	...
	d_insert = "insert into direcciones (tdir_ccod,pers_ncorr,dire_tcalle, dire_tblock, dire_tpoblacion, dire_tnro,ciud_ccod) values('1',"&pers_ncorr&",'"&dire_tcalle&"','"&dire_tblock&"','"&dire_tpoblacion&"','"&dire_tnro&"',"&ciud_ccod&")"
	'conectar.ejecutaS (d_insert)
	response.Write ("<pre>"&d_insert&"</pre>")
	...
	response.Write (persona_gr)
	m_update="update personas set nedu_ccod='"&nedu_ccod&"', sicupadre_ccod='"&sicupadre_ccod&"', sitocup_ccod='"&sitocup_ccod&"',eciv_ccod='"&eciv_ccod&"' where pers_ncorr="&pers_ncorr&""
