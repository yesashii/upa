...
<tr>
	...
	<td bgcolor="#FFFFFF" aling="left" width="646">
		<table width="646" border="0" align="left" cellpadding="10" cellspacing="10" bgcolor="#FFFFFF">
		  <tr>
			<td align="left">
			<center><p class="Estilo27">Bienvenido(a) <%=alumno%> a la Universidad del Pacífico</p></center>
				<p class="Estilo31">El proyecto educativo de la Universidad centra su atención en el estudiante, y al efecto confiere relevancia a conocer sus características en general. Por ello, es importante que contestes a los  cuestionarios con total sinceridad y transparencia.</p>
               <center>
			     <table width="300" border="0" cellpadding="0" cellspacing="0">
				  <tr>
					<td width="33%" align="center" valign="top" class="Estilo31"><%f_botonera.dibujaBoton "evaluacion"%></td>
