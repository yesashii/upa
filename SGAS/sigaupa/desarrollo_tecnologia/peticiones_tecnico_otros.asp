...
f_solicitudes.Carga_Parametros "solicita_soporte.xml", "solicitudes_tecnico_otros"
...
sql_descuentos="select a.inci_ccod," & vbCrLf &_
			 ...
			 "tpus_tdesc ,(select pers_tnombre+' '+pers_tape_paterno from personas aaa where aaa.pers_ncorr=pers_ncorr_responsable) as tomada_por,"& vbCrLf &_
			 "sede_tdesc as sede,peso_tcargo,peso_tdepto,peso_tubicacion"& vbCrLf &_
			 ...
			 "where  a.inci_ccod=b.inci_ccod and  a.sede_ccod in ("&sedes&") "&filtro3&" "&filtro&" "&filtro4&" "&filtro5&""& vbCrLf &_
...
function filtrar()
{
	document.forms['filtrado'].action = "peticiones_tecnico_otros.asp";
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  <tr>
				<td><%lenguetas=Array(Array("Mis Peticiones","peticiones_tecnico.asp"),Array("Peticiones Tomadas por otro","peticiones_tecnico_otros.asp"))
						pagina.DibujarLenguetas lenguetas, 2 %>
				</td>
		  </tr>
          <tr>
