...
inci= request.querystring("b[0][inci]")
EINC_CCOD= request.querystring("b[0][EINC_CCOD]")
...
pagina.Titulo = "Mis Solicitudes de Soporte"
...
sedes=conexion.consultaUno("select protic.obtener_sedes_sistema_usuario(protic.obtener_pers_ncorr("&usuario&"))")

 
 set f_solicitudes = new CFormulario
f_solicitudes.Carga_Parametros "solicita_soporte.xml", "solicitudes_tecnico"
...
if usuario ="11592558" then
filtro2="and pers_ncorr_responsable in (24180,165483,182069,177313,177377,192286,197514 ,125592 ,184858)"
else
filtro2="and pers_ncorr_responsable = "&pers_ncorr&""
end if
...
if inci <>"" then
filtro4="and a.inci_ccod='"&inci&"'"
else
filtro4=""
end if

if EINC_CCOD <>"" then
filtro5="and b.EINC_CCOD='"&EINC_CCOD&"'"
else
filtro5=""
end if

sql_descuentos="select a.inci_ccod," & vbCrLf &_
			 "(select pers_tnombre+' '+pers_tape_paterno from personas aa where aa.pers_ncorr=a.pers_ncorr )as persona_solicitante,peso_tdescripcion as solicitud,(select EINC_tdesc from estados_incidentes aaa where aaa.EINC_CCOD=b.EINC_CCOD)as EINC_CCOD,"& vbCrLf &_
			 "tpus_tdesc ,"& vbCrLf &_
			 "sede_tdesc as sede,peso_tcargo,peso_tdepto,peso_tubicacion,peso_tfono"& vbCrLf &_
			 ...
			 "where  a.inci_ccod=b.inci_ccod and  a.sede_ccod in ("&sedes&") "&filtro2&" "&filtro&" "&filtro3&" "&filtro4&" "&filtro5&""& vbCrLf &_
...
formulario_filtro.AgregaCampoCons "inci", inci
formulario_filtro.AgregaCampoCons "EINC_CCOD", EINC_CCOD
%>
...
function filtrar()
{
	document.forms['filtrado'].action = "peticiones_tecnico.asp";
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
		 <tr>
				<td><%lenguetas=Array(Array("Mis Peticiones","peticiones_tecnico.asp"),Array("Peticiones Tomadas por otro","peticiones_tecnico_otros.asp"))
          ...
          <tr>
            <td>
				...
				<table align="center">
					...
					<tr>
						<td>Estados</td>
						<td><%formulario_filtro.dibujaCampo("EINC_CCOD")%></td>
						
					</tr>
					<tr>
						<td>Codigo</td>
						<td><%formulario_filtro.dibujaCampo("inci")%></td>
						
					</tr>
					<tr>
						<td colspan="2" align="right"><%botonera.DibujaBoton("filtrar")%></td>
					</tr>
				</table>
				</form>
				<br/>
