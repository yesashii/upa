...
'ENTRADA		:NA
'SALIDA			:NA
'MODULO QUE ES UTILIZADO: GESTION DE DOCUMENTOS
'
'--ACTUALIZACION--
'
...
if not cajero.tienecajaabierta then
  session("mensajeerror")= "No puede conciliar documentos sin tener una caja abierta"
...
botonera.Carga_Parametros "Conciliacion.xml", "botonera"
'-------------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "conciliacion.xml", "busqueda_cheques"
...
f_cheques.Carga_Parametros "conciliacion.xml", "f_cheques"
...
'		"        sum(a.ding_mdocto) as ding_mdocto, a.ding_bpacta_cuota, " & vbCrLf &_ 
...
'		"	    b.banc_tdesc, d.fedi_ccod, protic.obtener_nombre_completo(max(c.pers_ncorr),'n') as alumno," & vbCrLf &_ 
'		"        protic.obtener_rut(a.pers_ncorr_codeudor) as rut_apoderado " & vbCrLf &_ 
'		"from detalle_ingresos a, bancos b, ingresos c, estados_detalle_ingresos d" & vbCrLf &_ 
'		"where a.banc_ccod *= b.banc_ccod" & vbCrLf &_ 
'		"  and a.ingr_ncorr = c.ingr_ncorr" & vbCrLf &_ 
'		"  and a.edin_ccod = d.edin_ccod" & vbCrLf &_ 
'		"  and a.edin_ccod  not in (6,11) " & vbCrLf &_ 
'		"  and cast(a.ding_ndocto as varchar) = '" & num_doc & "'" & vbCrLf
...
consulta = "select a.ding_ndocto as c_ding_ndocto, a.ding_ndocto, a.ting_ccod, a.ting_ccod as c_ting_ccod," & vbCrLf &_ 
		...
		"	    b.banc_tdesc, d.fedi_ccod, protic.obtener_nombre_completo(max(c.pers_ncorr),'n') as alumno," & vbCrLf &_ 
		"        protic.obtener_rut(a.pers_ncorr_codeudor) as rut_apoderado " & vbCrLf &_ 
		"from detalle_ingresos a LEFT OUTER JOIN bancos b " & vbCrLf &_ 
		"  ON a.banc_ccod = b.banc_ccod " & vbCrLf &_ 
		"  INNER JOIN ingresos c " & vbCrLf &_ 
		"  ON a.ingr_ncorr = c.ingr_ncorr " & vbCrLf &_ 
		"  INNER JOIN estados_detalle_ingresos d " & vbCrLf &_ 
		"  ON a.edin_ccod = d.edin_ccod " & vbCrLf &_ 
 		" WHERE a.edin_ccod  not in (6,11) " & vbCrLf &_ 
		"  and cast(a.ding_ndocto as varchar) = '" & num_doc & "'" & vbCrLf
...
consulta = consulta & "group by a.ding_ndocto, a.ting_ccod, a.ding_ncorrelativo, a.banc_ccod, a.ding_fdocto, a.ding_tcuenta_corriente, a.ding_bpacta_cuota," & vbCrLf &_
			"         b.banc_tdesc, d.fedi_ccod, a.pers_ncorr_codeudor, d.edin_tdesc " & vbCrLf &_
			"having a.ding_ncorrelativo = 1" & vbCrLf &_
