...
<%
Response.AddHeader "Content-Disposition", "attachment;filename=reporte_cheques_avisos.xls"
...
consulta = 	" Select  b.mcaj_ncorr,protic.obtener_envio(a.ingr_ncorr) as envi_ncorr,a.banc_ccod, a.ding_ndocto, convert(varchar,b.ingr_fpago,103) as ingr_fpago, " & vbCrLf &_
				...
				"       convert(varchar,a.ding_fdocto,103) as ding_fdocto, a.ding_mdocto as ding_mdocto, " & vbCrLf &_
				"       protic.obtener_rut(b.pers_ncorr) as rut_alumno, protic.obtener_rut(a.pers_ncorr_codeudor) as rut_apoderado, " & vbCrLf &_
				"       k.ciud_tdesc as ciud_tdesc, k.ciud_tcomuna as ciud_tcomuna, g.pers_tnombre as nombre_apoderado, " & vbCrLf &_
				" 		g.pers_tape_paterno as pers_tape_paterno , g.pers_tape_materno as pers_tape_materno, "& vbCrLf &_
				" 		protic.obtener_direccion_letra(a.pers_ncorr_codeudor,1,'CNPB') as direccion, g.pers_tfono as pers_tfono, "& vbCrLf &_
				" 		protic.total_recepcionar_cuota(h.tcom_ccod,h.inst_ccod,h.comp_ndocto,h.dcom_ncompromiso) as saldo_cheque,  "& vbCrLf &_
				...
				"    and a.ting_ccod in (3,38,14)    " & vbCrLf &_
				"    and a.ding_ncorrelativo = 1    " & vbCrLf &_
				"    and a.ding_bpacta_cuota='S'    " & vbCrLf &_
				"    and b.eing_ccod <> 3  " 
...
<html>
<head>
<title> Reporte Cheques Avisos </title>
...
<table width="75%" border="1">
  ...
  <tr>
    ...
    <td><div align="left"><%=f_letras.ObtenerValor("saldo_cheque")%></div></td>
