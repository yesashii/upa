...
formulario.Carga_Parametros "Envios_Banco.xml", "f_detalle_envio"
...
for fila = 0 to formulario.CuentaPost - 1
   ...
   if envio <> "" then
     consulta = "UPDATE detalle_ingresos SET envi_ncorr = NULL, edin_ccod=1 "& vbCrLf &_
	     "WHERE  ting_ccod='" & t_ingreso & "' "& vbCrLf &_
		   "AND  ding_ndocto='" & documento & "' "& vbCrLf &_
