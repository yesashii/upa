...
pagina.Titulo = "Depósitos de cuotas Transbank"
...
'---------------------------------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "depositos_transbank.xml", "busqueda_envios"
...
f_envios.Carga_Parametros "depositos_transbank.xml", "f_envios"
                  ...
                  <tr>
                    ...
                    <td width="208" valign="bottom" background="../imagenes/fondo1.gif">
                      <div align="left"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Buscador 
                          dep&oacute;sitos Transbank</font></div></td>
                  ...
                  <tr>
                    ...
                    <td width="209" valign="middle" background="../imagenes/fondo1.gif">
                      <div align="left"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Listado 
                          dep&oacute;sitos Transbank</font></div>
                    </td>
              ...
              <tr>
                ...
                <td width="195" bgcolor="#D8D8DE"><table width="41%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="9%">
                        <%   botonera.agregabotonparam "eliminar", "url", "depositos_transbank_eliminar.asp"
                      ...
                      <td width="12%"> <div align="left">
                          <%
						   ...
						   botonera.agregabotonparam "enviar_folio", "url", "proc_conciliacion_deposito_transbank.asp"
