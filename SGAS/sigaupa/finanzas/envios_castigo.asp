...
pagina.Titulo = "Documentos en Castigo"
...
'---------------------------------------------------------------------------------------------------
 ...
 ccte_ccod	= request.querystring("busqueda[0][ccte_ccod]")

  
 set f_busqueda = new CFormulario
 f_busqueda.Carga_Parametros "castigos_documentos.xml", "busqueda_envios"
 ...
 f_busqueda.AgregaCampoCons "ccte_ccod", ccte_ccod
'----------------------------------------------------------------------------------
set f_envios = new CFormulario
f_envios.Carga_Parametros "castigos_documentos.xml", "f_envios"
...
consulta = "select a.envi_ncorr, a.envi_ncorr as c_envi_ncorr, a.envi_ncorr as c2_envi_ncorr, "& vbCrLf &_
			...
			" max(a.envi_tdescripcion) as envi_tdescripcion,protic.total_valor_envio_pagare(a.envi_ncorr) as total "& vbCrLf &_
			" from "& vbCrLf &_
...
'" and b.TINE_CCOD = 4"			
				  ...
				  if ccte_ccod  <> "" then 
				  	consulta = consulta & "and a.ccte_ccod  ='" & ccte_ccod & "' "
				  end if
...
v_mensaje="Castigar";
	if (v_valida==true) {
		v_check=verifica_check(form,v_mensaje);
		if (v_check==true){
			return true;	
		}else{
			return false;
...
function valida_envios(form){
	   ...
	   for( i = 0; i < nro; i++ ) {
		  ...
		  //	alert(str);
   		...
   		if( num > 0 ) {
			alert('Ud. ha seleccionado '+ num +' registros que ya fueron CASTIGADOS. \nSeleccione solo los envios en estado PENDIENTES');
			return false;
		}
		else{
			return true;
              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="208" valign="bottom" background="../imagenes/fondo1.gif">
                      <div align="left"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Buscador Castigos</font></div></td>
                    ...
                    <tr>
                      <td width="81%"><table border="0" width="100%">
                              ...
                              <tr>
                                ...
                                <td><strong>Cuenta Castigo</strong> </td>
                                <td><strong>:</strong></td>
                                <td><% f_busqueda.dibujaCampo ("ccte_ccod")%></td>
                              </tr>
                            </table></td>
              ...
              <tr>
                ...
                <td width="195" bgcolor="#D8D8DE"><table width="41%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="9%">
                        <%   botonera.agregabotonparam "eliminar", "url", "castigos_eliminar.asp"
                      ...
                      <td width="12%"> <div align="left">
                          <%
						   ...
						   botonera.agregabotonparam "enviar_folio", "url", "proc_marcar_castigo.asp"
