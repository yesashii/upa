...
if folio_envio = "NUEVO" then
  consulta = "select '1' as eenv_ccod, '3' as tenv_ccod"
end if
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="168" valign="middle" background="../imagenes/fondo1.gif">
                      <div align="left"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Nuevo 
                          Envio Pagare a Notar&iacute;a</font></div></td>
                      <td width="223" bgcolor="#D8D8DE"><img src="../imagenes/derech1.gif" width="6" height="17"></td>
                    </tr>
                </table></td>
                  ...
                  <td bgcolor="#D8D8DE">
				    ...
				    <table width="386" border="0">
				      ...
				      <tr>
				        ...
				        <td>
                          <%response.Write(date())%>
                          <%formulario.DibujaCampo("envi_fenvio") %>
                        </td>
			          </tr>
				      </table>
			        </form>
