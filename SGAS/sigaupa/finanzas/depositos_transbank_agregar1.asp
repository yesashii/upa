...
pagina.Titulo = "Detalle de cuotas transbank"
'---------------------------------------------------------------------------------------------------
...
f_envio.Carga_Parametros "depositos_transbank.xml", "f_envios"
...
f_detalle_envio.Carga_Parametros "depositos_transbank.xml", "f_detalle_envio"
...
consulta = "select a.envi_ncorr, " & vbCrLf &_
			...
			"	ab.inst_ccod,ab.comp_ndocto, " & vbCrLf &_
			"	ab.dcom_ncompromiso) as ding_mdocto, " & vbCrLf &_
                  ...
                  <td width="126" bgcolor="#D8D8DE"><table width="97%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="14%"> <div align="left"> 
                          <%  botonera.agregabotonparam "anterior", "url", "depositos_transbank.asp?envi_ncorr="& folio_envio
                      ...
                      <td width="14%"> <%    if estado_envio = "2" then
						         botonera.agregabotonparam "agregar_letras", "deshabilitado" ,"TRUE"
					              ...
					              botonera.agregabotonparam "agregar_letras", "url" ,"depositos_transbank_buscar.asp?folio_envio="& folio_envio 
					              botonera.DibujaBoton "agregar_letras"
					   %> </td>
                      <td width="14%"><% if estado_envio = "2" then
					                        botonera.agregabotonparam "eliminar", "deshabilitado" ,"TRUE"
										 end if 
					                       botonera.agregabotonparam "eliminar", "url", "depositos_transbank_eliminar_cuota.asp"
						                   botonera.dibujaboton "eliminar"
										 %> </td>
                      <td width="15%">
                        <% botonera.AgregaBotonParam "excel","url","depositos_transbank_excel.asp?folio_envio=" & folio_envio
