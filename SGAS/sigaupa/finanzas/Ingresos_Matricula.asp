...
'-----------------------------------------------------------------------
 ...
 sql = "SELECT a.cont_ncorr, trunc(a.cont_fcontrato) as cont_fcontrato, "&_
			   "c.pers_nrut || '-' || c.pers_xdv as rut_alumno,  "&_
			   "c.pers_tape_paterno || ' ' || c.pers_tape_materno || ' ' || c.pers_tnombre as nombre_alumno, "&_
			   "g.INGR_NFOLIO_REFERENCIA, trunc(g.INGR_FPAGO) AS ingr_fpago "&_
		"FROM contratos a, postulantes b, personas_postulante c, compromisos d, "&_
			 "detalle_compromisos e, abonos f,ingresos g, ofertas_academicas h "&_
		"WHERE a.post_ncorr = b.post_ncorr "&_
		  "and b.pers_ncorr = c.pers_ncorr "&_
		  "and d.tcom_ccod in (1,2) "&_
		  "and a.cont_ncorr = d.comp_ndocto "&_
		  "and d.tcom_ccod = e.tcom_ccod "&_
		  "and d.inst_ccod = e.inst_ccod "&_
		  "and d.comp_ndocto = e.comp_ndocto "&_
		  "and e.tcom_ccod = f.tcom_ccod "&_
		  "and e.inst_ccod = f.inst_ccod "&_
		  "and e.comp_ndocto = f.comp_ndocto "&_
		  "and e.dcom_ncompromiso = f.dcom_ncompromiso "&_
		  "and f.ingr_ncorr = g.ingr_ncorr "&_
		  "and b.ofer_ncorr = h.ofer_ncorr "&_ 
		  "and g.EING_CCOD = 4  "&_
		  "and a.peri_ccod ='" & Periodo & "' "&_ 
		  "and h.sede_ccod = nvl('" & sede_ccod & "',h.sede_ccod) "&_ 
		  "and trunc(a.cont_fcontrato) BETWEEN  nvl('" & inicio & "',a.cont_fcontrato) and nvl('" & termino & "',a.cont_fcontrato) "&_
		"GROUP BY a.cont_ncorr, cont_fcontrato, c.pers_nrut , c.pers_xdv , "&_
		   "c.pers_tape_paterno , c.pers_tape_materno , c.pers_tnombre, "&_
		   "g.INGR_NFOLIO_REFERENCIA, ingr_fpago "&_ 
		"ORDER BY cont_fcontrato DESC, a.cont_ncorr"
