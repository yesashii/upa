...
pagina.Titulo = "Arqueo de Letras"
'---------------------------------------------------------------------------------------------------
...
'-----------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "arqueo_documentos.xml", "busqueda_letras"
...
'----------------------------------------------------------------------------
 ...
 f_letras.Carga_Parametros "arqueo_documentos.xml", "f_letras"
              ...
              <tr>
                ...
                <td width="250" bgcolor="#D8D8DE"><table width="90%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="49%"><% 
                					  if Request.QueryString = "" then 
					                     botonera.agregabotonparam "excel_letras", "deshabilitado" ,"TRUE"
  									  end if
									     botonera.DibujaBoton ("excel_letras")  
