...
pagina.Titulo = "Agregar Letras al Envio a Notaría"
'-----------------------------------------------------------------------
...
'-----------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "Envios_Notaria.xml", "busqueda_letras"
...
'---------------------------------
 ...
 f_letras.Carga_Parametros "Envios_Notaria.xml", "f_letras"
 ...
 'letras que no estan en algun folio pendiente y que estan en UAS	
	...
	consulta = "select z.*  "& vbCrLf &_
					"from ( "& vbCrLf &_
					"	 select " & folio_envio & " as envi_ncorr,  a.ding_ndocto as c_ding_ndocto, a.ding_ndocto, h.edin_tdesc,  "& vbCrLf &_
					...
					"	   and a.ding_ncorrelativo in (1, 8)  "& vbCrLf &_
					"      and h.fedi_ccod in (1, 3, 8) "
                  ...
                  <td width="79" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="17%"><div align="center">
                          <% 
						  botonera.AgregaBotonParam "guardar_letras","url","Proc_Envios_Notaria_Buscar.asp?folio_envio=" & folio_envio
