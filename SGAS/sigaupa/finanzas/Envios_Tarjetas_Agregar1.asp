...
pagina.Titulo = "Detalle de pagos recibidos por Tarjetas"
'---------------------------------------------------------------------------------------------------
...
f_envio.Carga_Parametros "Envios_Tarjetas.xml", "f_envios"
...
f_detalle_envio.Carga_Parametros "Envios_Tarjetas.xml", "f_detalle_envio"
...
'			"    b.ding_ndocto,  cast(cast(c.ding_mdetalle as numeric)as varchar) as ding_mdocto, convert(varchar,d.ingr_fpago,103) as ingr_fpago,  " & vbCrLf &_
...
'			"    case when len(isnull(c.ding_ndocto,0))<=3 then Right(substring(c.ding_tcuenta_corriente,1,12),4) else cast(c.ding_ndocto as varchar) end as num_tarjeta, " & vbCrLf &_
...
consulta = "SELECT a.envi_ncorr, b.ting_ccod, b.ding_ndocto as c_ding_ndocto, b.ingr_ncorr ," & vbCrLf &_
			...
			"ON b.ting_ccod = c.ting_ccod and b.ding_ndocto = c.ding_ndocto and b.ingr_ncorr = c.ingr_ncorr and c.DING_NCORRELATIVO > 0 " & vbCrLf &_
                ...
                <td bgcolor="#D8D8DE"> <div align="center"><BR>
                  ...
                  <table width="100%" border="0">
                    <tr> 
                      ...
                      <td width="8%"><strong>Instituci&oacute;n</strong></td>
                      <td width="2%">:</td>
                  ...
                  <td width="126" bgcolor="#D8D8DE"><table width="97%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="14%"> <div align="left"> 
                          <%  botonera.agregabotonparam "anterior", "url", "Depositos_Tarjetas.asp?envi_ncorr="& folio_envio
                      ...
                      <td width="14%"> <%    if estado_envio = "2" or estado_envio = "4" then
						         botonera.agregabotonparam "agregar_letras", "deshabilitado" ,"TRUE"
					              ...
					              botonera.agregabotonparam "agregar_letras", "url" ,"Envios_Tarjetas_Buscar.asp?folio_envio="& folio_envio 
					              botonera.DibujaBoton "agregar_letras"
					   %> </td>
                      <td width="14%"><% if estado_envio = "2" or estado_envio = "4" then
					                        botonera.agregabotonparam "eliminar", "deshabilitado" ,"TRUE"
										 end if 
					                       botonera.agregabotonparam "eliminar", "url", "Envios_Tarjetas_Eliminar_Cuota.asp"
						                   botonera.dibujaboton "eliminar"
										 %> </td>
                      <td width="15%">
                        <% botonera.AgregaBotonParam "excel","url","Envios_Tarjetas_Excel.asp?folio_envio=" & folio_envio
