...
pagina.Titulo = "Agregar documentos para recepcionar"
'-----------------------------------------------------------------------
...
'---------------------------------
 ...
 f_letras.Carga_Parametros "envios_sedes.xml", "f_letras_recibidas"
 ...
 'letras que no estan en algun folio pendiente y que estan en UAS	
	...
	consulta = "select z.*  "& vbCrLf &_
					"from ( "& vbCrLf &_
					"	 select a.ting_ccod as tipo_doc, a.ding_ndocto as c_ding_ndocto, a.ding_ndocto, h.edin_tdesc,  "& vbCrLf &_
					...
					"		   protic.obtener_rut(b.pers_ncorr) as rut_alumno, protic.obtener_rut(a.pers_ncorr_codeudor) as rut_apoderado, isnull(a.sede_actual,1) as sede_actual "& vbCrLf &_
					...
					"	 where a.ding_ncorrelativo in (1)  "
                  ...
                  <td width="79" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="17%"><div align="center">
                          <% 
						  botonera.AgregaBotonParam "guardar_doctos","url","proc_recibir_docto_no_enviado.asp"
