...
'ENTRADA					: NA
'SALIDA						: NA
'MODULO QUE ES UTILIZADO	: GESTIÓN FINANCIERA
'
'--ACTUALIZACION--
'
...
consulta =	"select a.*, " & vbCrLf &_
			"	a.ingr_mtotal AS monto_nota, " & vbCrLf &_ 
			"	isnull(b.ding_mdetalle,0) AS monto_utilizado, " & vbCrLf &_
			"	a.ingr_mtotal - isnull(b.ding_mdetalle,0) AS saldo_nota " & vbCrLf &_
			"from ( " & vbCrLf &_
			"		select a.ingr_ncorr, " & vbCrLf &_
			"				a.ingr_fpago, " & vbCrLf &_
			"				a.ingr_nfolio_referencia, " & vbCrLf &_
			"				a.ting_ccod, " & vbCrLf &_
			"				a.inst_ccod, " & vbCrLf &_
			"				a.ingr_mtotal, " & vbCrLf &_
			"				d.ting_tdesc " & vbCrLf &_
			"		from ingresos a, " & vbCrLf &_
			"				notascreditos_documentos b, " & vbCrLf &_
			"				personas c, " & vbCrLf &_
			"				tipos_ingresos d " & vbCrLf &_
			...
			"			and a.eing_ccod = 1 " & vbCrLf &_
			"			and d.ting_brebaje = 'S' " & vbCrLf &_
			"			and a.ting_ccod not in (4,15) " & vbCrLf &_
			"			and cast(c.pers_nrut as varchar)= '" & v_pers_nrut & "' " & vbCrLf &_
			"	) a " & vbCrLf &_
			"left outer join " & vbCrLf &_
			"	( " & vbCrLf &_
			"		select b.ding_ndocto, " & vbCrLf &_
			"				sum(b.ding_mdetalle) as ding_mdetalle " & vbCrLf &_
			"		from ingresos a, detalle_ingresos b, personas c " & vbCrLf &_
			"		where a.ingr_ncorr = b.ingr_ncorr and " & vbCrLf &_
			"	         a.pers_ncorr = c.pers_ncorr and " & vbCrLf &_
			"			 a.eing_ccod = 1 and " & vbCrLf &_
			"			 b.ting_ccod = 52 and " & vbCrLf &_
			"			 cast(c.pers_nrut as varchar)= '" & v_pers_nrut & "'" & vbCrLf &_
			"		group by b.ding_ndocto " & vbCrLf &_
			"	) b " & vbCrLf &_
			"on a.ingr_nfolio_referencia = b.ding_ndocto "
