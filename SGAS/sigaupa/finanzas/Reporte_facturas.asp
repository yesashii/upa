...
pagina.Titulo = "Reporte de Facturas"
'---------------------------------------------------------------------------------------------------
...
botonera.Carga_Parametros "reporte_facturas.xml", "botonera"
'-----------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "reporte_facturas.xml", "busqueda_facturas"
 ...
 f_busqueda.AgregaCampoCons "ting_ccod", v_ting_ccod
...
'----------------------------------------------------------------------------
 ...
 f_facturas.Carga_Parametros "reporte_facturas.xml", "f_facturas"
 f_facturas.Inicializar conexion
 
				   

consulta ="select  substring(j.ting_tdesc,12,7) as ting_tdesc,a.envi_ncorr, d.edin_tdesc, convert(varchar,b.ingr_fpago,103) as ingr_fpago, " & vbCrLf &_
			...
			"    and a.ding_ncorrelativo > 0    " 
					...
					if v_ting_ccod <> "" then
						...
						consulta = consulta &  " AND a.ting_ccod in (49,50) "& vbCrLf
					end if					
