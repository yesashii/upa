...
pagina.Titulo = "Envíos a Notaría"
...
'---------------------------------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "Envios_Notaria.xml", "busqueda_envios"
...
f_envios.Carga_Parametros "Envios_Notaria.xml", "f_envios"
...
'					   "b.inen_tdesc,a.envi_fenvio, d.eenv_tdesc, "& vbCrLf &_
'					   "cantidad_documentos_envio(a.envi_ncorr) as cant_doc "& vbCrLf &_
'				"from envios a, instituciones_envio b, estados_envio d, detalle_envios f, "& vbCrLf &_
'					 "detalle_ingresos g, ingresos h, personas i, personas j "& vbCrLf &_
'				"where a.tenv_ccod = 1 "& vbCrLf &_
'				  "and b.TINE_CCOD = 2 "& vbCrLf &_
'				  "and a.inen_ccod = b.inen_ccod "& vbCrLf &_
'				  "and a.eenv_ccod = d.eenv_ccod "& vbCrLf &_
'				  "and a.envi_ncorr = f.envi_ncorr  (+) "& vbCrLf &_
'				  "and f.ting_ccod = g.ting_ccod (+) "& vbCrLf &_
...
'				  "and g.PERS_NCORR_CODEUDOR = j.pers_ncorr (+) "
...
consulta = "select a.envi_ncorr, a.envi_ncorr as c_envi_ncorr, a.envi_ncorr as c2_envi_ncorr, "& vbCrLf &_
			...
			" and b.TINE_CCOD = 2"
			  if  rut_alumno <> ""  then 
				 ...
				 if notaria <> "" then
 				     consulta = consulta & "and a.inen_ccod = '" & notaria &  "' "
				  end if
				  				
			 	consulta = consulta & "group by a.envi_ncorr,  b.inen_tdesc, a.envi_fenvio, d.eenv_tdesc "& vbCrLf &_
                  ...
                  <tr>
                    ...
                    <td width="208" valign="bottom" background="../imagenes/fondo1.gif">
                      <div align="left"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Buscador
                          de Env&iacute;os a Notar&iacute;a</font></div></td>
                    ...
                    <tr>
                      <td width="81%"><table width="524" border="0">
                        <tr>
                          ...
                          <td width="17">:</td>
                          <td width="151"><% f_busqueda.DibujaCampo("envi_ncorr") %></td>
                          <td width="93">Fecha</td>
                          <td width="12">:</td>
                          <td width="139"><% f_busqueda.dibujaCampo ("envi_fenvio")%>
                        ...
                        <tr>
                          ...
                          <td>:</td>
                          <td><% f_busqueda.dibujaCampo ("inen_ccod") %>
                          </td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td width="195" bgcolor="#D8D8DE"><table width="41%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="9%">
                        <%   botonera.agregabotonparam "eliminar", "url", "Envios_Notaria_Eliminar.asp"
