...
pagina.Titulo = "Detalle de documentos enviados entre Sedes"
'---------------------------------------------------------------------------------------------------
...
consulta = " SELECT a.esed_ncorr, b.ting_ccod,b.ting_ccod as tipo_doc, b.ding_ndocto as c_ding_ndocto, b.ingr_ncorr ," & vbCrLf &_
			...
			"ON a.esed_ncorr = b.esed_ncorr " & vbCrLf &_
			...
			"WHERE a.esed_ncorr = '" & folio_envio & "' " & vbCrLf &_
			"ORDER BY  nombre_apoderado, b.ding_ndocto"
                  ...
                  <td width="126" bgcolor="#D8D8DE"><table width="97%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="14%"> <div align="left"> 
                          <%  botonera.agregabotonparam "anterior", "url", "envios_sedes.asp?esed_ncorr="& folio_envio
						      botonera.DibujaBoton "anterior"  %>
                        </div></td>
                      <td width="14%"> <%    if estado_envio <> "1" then
						         botonera.agregabotonparam "agregar_letras", "deshabilitado" ,"TRUE"
							  end if
					              botonera.agregabotonparam "agregar_letras", "url" ,"envios_sede_buscar.asp?folio_envio="& folio_envio 
					              botonera.DibujaBoton "agregar_letras"
					   %> </td>
                      <td width="14%"><% if estado_envio <> "1" then
					                        botonera.agregabotonparam "eliminar", "deshabilitado" ,"TRUE"
										 end if 
					                       botonera.agregabotonparam "eliminar", "url", "envios_sede_eliminar_doc.asp"
						                   botonera.dibujaboton "eliminar"
										 %> </td>
                      <td width="15%">
                        <% botonera.AgregaBotonParam "excel","url","envios_sede_excel.asp?folio_envio=" & folio_envio
					                    botonera.DibujaBoton ("excel") %>
                      </td>
                      <td width="43%"><div align="left"></div>
                        <div align="left">
                          <% botonera.AgregaBotonParam "imprimir","url","envios_sede_imprimir.asp?folio_envio="&folio_envio 
