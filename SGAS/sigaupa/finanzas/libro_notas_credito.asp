...
pagina.Titulo = "Libro Notas de Credito"
'---------------------------------------------------------------------------------------------------
...
botonera.Carga_Parametros "libro_notas_credito.xml", "botonera"
'-----------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "libro_notas_credito.xml", "busqueda_notas_credito"
 ...
 f_busqueda.AgregaCampoCons "ndcr_nnota_credito", num_doc
 f_busqueda.AgregaCampoCons "encr_ccod", estado_factura
...
'----------------------------------------------------------------------------
 ...
 f_boletas.Carga_Parametros "libro_notas_credito.xml", "f_notas_credito"
				...
				<form name="buscador" method="post">                
                      <table width="660" border="0" align="left">
                        <tr> 
                          ...
                          <td width="5">&nbsp;</td>
                          <td>Estado Nota Credito </td>
                          <td>:</td>
                          <td><% f_busqueda.DibujaCampo ("encr_ccod") %>                          </td>
                        ...
                        <tr>
                          <td>N&deg; Nota Credito </td>
                          <td>:</td>
                          <td><% f_busqueda.DibujaCampo ("ndcr_nnota_credito") %></td> 
                          <td></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td width="250" bgcolor="#D8D8DE"><table width="90%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="49%"><% 
                					  if Request.QueryString = "" then 
					                     botonera.agregabotonparam "excel_notas_credito", "deshabilitado" ,"TRUE"
  									  end if
									     botonera.DibujaBoton ("excel_notas_credito")  
