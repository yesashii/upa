...
'		"and b.ingr_ncorr = " & ingr_ncorr& ""
	...
	sql = "select a.reca_ncorr, b.ding_ndocto,d.ting_tdesc, x.vencimiento_original, b.ding_mdocto, ding_tcuenta_corriente, c.banc_tdesc,  "& vbCrLf &_ 
		...
		"			from detalle_ingresos_log "& vbCrLf &_ 
		"			) x "& vbCrLf &_ 
		"ON a.reca_ncorr = x.dilg_ncorr "& vbCrLf &_ 
		"INNER JOIN detalle_ingresos b "& vbCrLf &_ 
		"ON b.ting_ccod = a.ting_ccod and b.ding_ndocto = a.ding_ndocto and b.ingr_ncorr = a.ingr_ncorr "& vbCrLf &_ 
		"and b.ting_ccod = " & ting_ccod & " "& vbCrLf &_ 
		"and b.ding_ndocto = " & ding_ndocto & " "& vbCrLf &_ 
		"and b.ingr_ncorr = " & ingr_ncorr& " "& vbCrLf &_ 
		"LEFT OUTER JOIN bancos c "& vbCrLf &_ 
		"ON b.banc_ccod = c.banc_ccod "& vbCrLf &_ 
		"INNER JOIN tipos_ingresos d "& vbCrLf &_ 
		"ON b.ting_ccod = d.ting_ccod "& vbCrLf &_ 
		"INNER JOIN ingresos e "& vbCrLf &_ 
		"ON b.ingr_ncorr = e.ingr_ncorr   "
