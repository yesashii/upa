                    ...
                    <tr>
					  ...
					  <table>
						  <tr>
							<td>
							 <div align="center">
							  <%botonera.AgregaBotonParam "excel", "url", "documentos_por_vencer_excel.asp"
							  botonera.AgregaBotonParam "excel", "texto", "Listado Completo"
							  botonera.dibujaboton "excel"%><br></div>	
							  </td>
						  </tr>
						  <tr>
							<td><% 
							botonera.AgregaBotonParam "excel", "url", "documentos_por_vencer_desglose_como_recupera_excel.asp"
							 botonera.AgregaBotonParam "excel", "texto", "Desglose por vencer"
					  	     botonera.dibujaboton "excel"%></td>
						  </tr>
						   <tr>
							<td><% 
							botonera.AgregaBotonParam "excel", "url", "documentos_por_vencer_desglose_vencimiento_deuda_excel.asp"
							 botonera.AgregaBotonParam "excel", "texto", "Desglose vencidos"
					  	     botonera.dibujaboton "excel"%></td>
						  </tr>
						  <tr>
							<td><% 
							botonera.AgregaBotonParam "excel", "url", "documentos_por_vencer_desglose_estado_dcto_excel.asp"
							 botonera.AgregaBotonParam "excel", "texto", "Desglose estado documento"
					  	     botonera.dibujaboton "excel"%></td>
						  </tr>
						  <tr>
							<td><% 
							botonera.AgregaBotonParam "excel", "url", "documentos_por_vencer_desglose_x_ano_excel.asp"
