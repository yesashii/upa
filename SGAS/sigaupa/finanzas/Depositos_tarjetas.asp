...
pagina.Titulo = "Depósitos de Tarjetas "
...
'---------------------------------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "Envios_Tarjetas.xml", "busqueda_envios"
...
f_envios.Carga_Parametros "Envios_Tarjetas.xml", "f_envios"
...
consulta = "select a.envi_ncorr, a.envi_ncorr as c_envi_ncorr, a.envi_ncorr as c2_envi_ncorr, "& vbCrLf &_
			...
			" max(a.envi_tdescripcion) as envi_tdescripcion,protic.total_valor_envio_tarjetas(a.envi_ncorr) as total "& vbCrLf &_
			" from "& vbCrLf &_
                  ...
                  <tr>
                    ...
                    <td width="208" valign="bottom" background="../imagenes/fondo1.gif">
                      <div align="left"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Buscador 
                          dep&oacute;sitos Tarjetas</font></div></td>
				...
				<form name="buscador">
                  <table width="98%"  border="0">
                    <tr>
                      ...
                      <td width="19%"><div align="center"><%botonera.DibujaBoton "buscar_envios" %></div></td>
                    </tr>
                  </table>
				</form>
                </div></td>
                  ...
                  <tr>
                    ...
                    <td width="209" valign="middle" background="../imagenes/fondo1.gif">
                      <div align="left"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Listado 
                          de dep&oacute;sitos de tarjetas</font></div>
                    </td>
              ...
              <tr>
                ...
                <td width="195" bgcolor="#D8D8DE"><table width="41%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="9%">
                        <%   botonera.agregabotonparam "eliminar", "url", "Envios_Tarjetas_Eliminar.asp"
                      ...
                      <td width="12%"> <div align="left">
                          <%
						   ...
						   botonera.agregabotonparam "enviar_folio", "url", "Proc_conciliacion_deposito_tarjetas.asp"
