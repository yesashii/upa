...
consulta = "SELECT a.envi_ncorr, b.ting_ccod, b.ding_ndocto as c_ding_ndocto, b.ingr_ncorr ," & vbCrLf &_
			...
			"    case when len(isnull(c.ding_ndocto,0))<=1 then Right(substring(c.ding_tcuenta_corriente,0,12),4) else cast(c.ding_ndocto as varchar) end as num_tarjeta, " & vbCrLf &_
