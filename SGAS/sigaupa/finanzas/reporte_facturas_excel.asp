...
consulta = 	"select    substring(j.ting_tdesc,12,7) as ting_tdesc,b.mcaj_ncorr, a.envi_ncorr, d.edin_tdesc,  " & vbCrLf &_
				" 		a.ding_ndocto as numero_factura,convert(varchar,b.ingr_fpago,103) as ingr_fpago, " & vbCrLf &_
...
<table width="75%" border="1">
  ...
  <tr> 
	...
	<td><font><%=f_letras.ObtenerValor("numero_factura")%>&nbsp;</font></td>
