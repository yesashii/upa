...
consulta = "select a.tcom_ccod, a.ting_ccod, a.ting_ccod AS c_ting_ccod, b.repa_ncorr," & vbCrLf &_
	...
	while f_consulta.Siguiente
		...
		if f_consulta.ObtenerValor("ting_ccod") <> "3" and f_consulta.ObtenerValor("ting_ccod") <> "13" and f_consulta.ObtenerValor("ting_ccod") <> "51" and  f_consulta.ObtenerValor("ting_ccod") <> "52" and  f_consulta.ObtenerValor("ting_ccod") <> "59" then
		...
		if f_consulta.ObtenerValor("ting_ccod") ="13" or f_consulta.ObtenerValor("ting_ccod") ="51" or f_consulta.ObtenerValor("ting_ccod") = "52" or f_consulta.ObtenerValor("ting_ccod") = "59" then
...
if 	EsVacio(total_det_pag) then
	...
	while f_consulta.Siguiente
		...
		if f_consulta.ObtenerValor("ting_ccod") = "4" or f_consulta.ObtenerValor("ting_ccod") = "3"  or f_consulta.ObtenerValor("ting_ccod") = "52" or f_consulta.ObtenerValor("ting_ccod") = "59" then
...
//alert("entro a validar:"+i);
		if ((formulario.elements["detalles_repactacion[" +i + "][c_ting_ccod]"].value==3) || (formulario.elements["detalles_repactacion[" +i + "][c_ting_ccod]"].value==4) || (formulario.elements["detalles_repactacion[" +i + "][c_ting_ccod]"].value==52)) 
			{
