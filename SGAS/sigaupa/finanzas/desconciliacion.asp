...
consulta = " select a.ding_ndocto as c_ding_ndocto, a.ding_ndocto, a.ting_ccod, a.ting_ccod as c_ting_ccod, " & vbCrLf &_ 
	    ...
	    " b.banc_tdesc, protic.obtener_nombre_completo(max(c.pers_ncorr),'n') as alumno, " & vbCrLf &_ 
        " protic.obtener_rut(max(a.pers_ncorr_codeudor)) as rut_apoderado " & vbCrLf &_ 
		" from ingresos c INNER JOIN detalle_ingresos a " & vbCrLf &_
		" ON a.ingr_ncorr = c.ingr_ncorr and  a.ting_ccod in ('3','14','38','88') and a.edin_ccod = '6' and c.eing_ccod not in (3, 6) " & vbCrLf &_
		" and cast(a.ding_ndocto as varchar) = '" & num_doc & "' " & vbCrLf &_
		" LEFT OUTER JOIN bancos b " & vbCrLf &_
		" ON a.banc_ccod = b.banc_ccod " & vbCrLf &_
		" INNER JOIN estados_detalle_ingresos d " & vbCrLf &_
		" ON a.edin_ccod = d.edin_ccod  " & vbCrLf 
