...
pagina.Titulo = "Agregar cuotas al envio de multidebito"
'-----------------------------------------------------------------------
...
'-----------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "depositos_multidebito.xml", "busqueda_letras"
...
'---------------------------------
 ...
 f_letras.Carga_Parametros "depositos_multidebito.xml", "f_letras"
 ...
 'letras que no estan en algun folio pendiente y que estan en UAS	
	...
	consulta = "select z.*  "& vbCrLf &_
					...
					"     cast(a.ding_ndocto as varchar) as numero_pagare, "& vbCrLf &_
...
'"      and h.fedi_ccod in (1,15) "& vbCrLf &_and a.ding_bpacta_cuota='N'
					...
					if numero_pagare <> "" then					
					  consulta = consulta & "	 and cast(a.ding_ndocto as varchar) = '" & numero_pagare & "' "& vbCrLf
					end if
                  ...
                  <td width="79" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="17%"><div align="center">
                          <% 
						  botonera.AgregaBotonParam "guardar_letras","url","proc_depositos_multidebito_buscar.asp?folio_envio=" & folio_envio
