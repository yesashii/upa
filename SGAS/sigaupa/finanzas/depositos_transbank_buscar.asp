...
pagina.Titulo = "Agregar Cuotas al Envio de Transbank"
'-----------------------------------------------------------------------
...
'-----------------------------------------------------------------------
 ...
 numero_pagare 		= request.querystring("busqueda[0][ding_ndocto]")
 ...
 f_busqueda.Carga_Parametros "depositos_transbank.xml", "busqueda_letras"
 ...
 f_busqueda.AgregaCampoCons "ding_ndocto", numero_pagare
...
'---------------------------------
 ...
 f_letras.Carga_Parametros "depositos_transbank.xml", "f_letras"
 ...
 'letras que no estan en algun folio pendiente y que estan en UAS	
	...
	consulta = "select z.*  "& vbCrLf &_
					...
					"		    h.edin_tdesc, a.ding_tcuenta_corriente as num_tarjeta,  protic.obtener_nombre_completo(a.pers_ncorr_codeudor,'n') as nombre_apoderado,  "& vbCrLf &_
...
'"      and h.fedi_ccod in (1,15) "& vbCrLf &_and a.ding_bpacta_cuota='N'
					...
					if numero_pagare <> "" then					
					  consulta = consulta & "	 and   case when len(isnull(a.ding_ndocto,0))<=4 then protic.obtener_numero_pagare_pagado(a.ingr_ncorr) else cast(a.ding_ndocto as varchar) end = '" & numero_pagare & "' "& vbCrLf
					end if
					
					if num_doc <> "" then					
					  consulta = consulta & " and  a.ding_tcuenta_corriente  = '" & num_doc & "' "& vbCrLf
					end if
					...
					" order by numero_pagare asc,num_tarjeta desc,ding_ndocto asc "
                  ...
                  <td width="79" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="17%"><div align="center">
                          <% 
						  botonera.AgregaBotonParam "guardar_letras","url","proc_depositos_transbank_buscar.asp?folio_envio=" & folio_envio
