...
q_mes_ccod = Request.QueryString("b[0][mes_ccod]")
if q_anos_ccod =""  then
q_anos_ccod =0
...
'**********************************************
 ...
 f_busqueda.Carga_Parametros "documentos_por_vencer.xml", "busqueda"
 f_busqueda.Inicializar conexion
 f_busqueda.Consultar "select ''"
 f_busqueda.Siguiente
 
 f_busqueda.AgregaCampoCons "mes_ccod", q_mes_ccod
    ...
    <td>&nbsp;</td>
				...
				<form name="buscador" >
				  <table cellspacing=0 cellpadding=0 align="left" width="24%" border=0 >
                    <tbody>
                      <tr>
                        <td width="5%"><div align="left">Año</div>
                      ...
                      <tr>
                        <td width="5%"><div align="left">Mes</div>
                        <td width="95%"><div align="left">
                          <%f_busqueda.DibujaCampo("mes_ccod")%>
                        </div>                        </tr>
                    </tbody>
                  </table>
			...
			<tr>
                            <td width="44%" height=40 align=middle valign=top>
                              <div align="center"><strong><font size="2">Debe Selecionar el Año y el Mes de Corte </font></strong><br>
                             </div></td>
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
           ...
           <% if cint(q_mes_ccod) >0  then%>
                <table width="30%"  border="0" align="left" cellpadding="0" cellspacing="0">
				
				  <tr>
							<td>
							 <div align="left">
							  <%botonera.AgregaBotonParam "excel", "url", "documentos_por_vencer_excel.asp?anos_ccod="&q_anos_ccod&"&mes_ccod="&q_mes_ccod&""
							  botonera.AgregaBotonParam "excel", "texto", "Listado Completo"
							  botonera.dibujaboton "excel"%><br></div>							  </td>
						  </tr>
						  <tr>
							<td><% 
							botonera.AgregaBotonParam "excel", "url", "documentos_por_vencer_desglose_como_recupera_excel.asp?anos_ccod="&q_anos_ccod&"&mes_ccod="&q_mes_ccod
							 botonera.AgregaBotonParam "excel", "texto", "Desglose por vencer"
					  	     botonera.dibujaboton "excel"%></td>
						  </tr>
						   <tr>
							<td><% 
							botonera.AgregaBotonParam "excel", "url", "documentos_por_vencer_desglose_vencimiento_deuda_excel.asp?anos_ccod="&q_anos_ccod&"&mes_ccod="&q_mes_ccod
							 botonera.AgregaBotonParam "excel", "texto", "Desglose vencidos"
					  	     botonera.dibujaboton "excel"%></td>
						  </tr>
						  <tr>
							<td><% 
							botonera.AgregaBotonParam "excel", "url", "documentos_por_vencer_desglose_estado_dcto_excel.asp?anos_ccod="&q_anos_ccod&"&mes_ccod="&q_mes_ccod
							 botonera.AgregaBotonParam "excel", "texto", "Desglose estado documento"
					  	     botonera.dibujaboton "excel"%></td>
						  </tr>
						  <tr>
							<td><% 
							botonera.AgregaBotonParam "excel", "url", "documentos_por_vencer_desglose_x_ano_excel.asp?anos_ccod="&q_anos_ccod&"&mes_ccod="&q_mes_ccod
							 botonera.AgregaBotonParam "excel", "texto", "Desglose vencidos x año"
					  	     botonera.dibujaboton "excel"%></td>
						  </tr>
			...
			<tr>
                            <td width="44%" height=40 align=middle valign=top>
                              <div align="center"><strong><font size="3">Listado
                                    de Documentos por vencer</font></strong><br>
