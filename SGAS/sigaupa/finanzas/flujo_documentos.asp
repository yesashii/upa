...
formulario.carga_parametros "flujos.xml", "flujos"
                  ...
                  <table width="98%"  border="0">
                    <tr>
                      <td width="81%"><table cellspacing=0 cellpadding=0 width="100%" border=0>
                        <tbody>
                          <tr>
                            <td width="88%" height=40 align=middle valign=top>
                              <div align="center"><strong><font size="3">Generar reporte de flujos </font></strong><br>
                                  Presione bot&oacute;n para generar archivo</div>
								  </td>
                            </tr>
							<tr>
                            <td colspan="2" align="center"><strong>Ingrese fecha :</strong><%formulario.DibujaCampo("fecha_corte")%>
                             (dd/mm/aaaa)</td>
                          </tr>
                        </tbody>
                      </table>
