...
if folio_envio = "NUEVO" then
  consulta = "select '1' as eenv_ccod, '1' as tenv_ccod, '1' as tins_ccod,'1' as tcob_ccod"
end if
...
<html>
<head>
<title>Nuevo Envio a Banco</title>
...
function valida_cobranza(formu){

	cobranza=formu.elements["envio[0][tcob_ccod]"].value;
	instrumento=formu.elements["envio[0][tins_ccod]"].value;

	if ((instrumento==1)||(instrumento==3)){
		if (cobranza!=1){
			alert("No puede elegir la opcion 'Sin protesto ' o 'Protesto por falta de aceptacion y Pago' \nsi el metodo de cobranza elegido no es 'Simple'")
			return false;
		}
		return true;
	}
                  ...
                  <td bgcolor="#D8D8DE">
				    ...
				    <table width="386" border="0">
                      ...
                      <tr> 
                        ...
                        <td>Plaza</td>
                        <td>:</td>
                        <td><%formulario.DibujaCampo("plaz_ccod") %></td>
                      </tr>
                      <tr> 
                        <td>&nbsp;</td>
                        <td>Tipo Cobranza</td>
                        <td>:</td>
                        <td>
                          <%formulario.DibujaCampo("tcob_ccod") %>
                        </td>
                      </tr>
                      <tr> 
                        <td>&nbsp;</td>
                        <td>Instrumento</td>
                        <td>:</td>
                        <td> <%formulario.DibujaCampo("tins_ccod") %> </td>
                      </tr>
                      <tr> 
                        <td>&nbsp;</td>
                        <td>Fecha</td>
                ...
                <tr>
                  ...
                  <td width="133" bgcolor="#D8D8DE"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="21%"><% botonera.dibujaboton "guardar_nuevo_envio"%>
</td>
