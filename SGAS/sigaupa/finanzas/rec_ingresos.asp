...
pagina.Titulo = "Recepción de Ingresos (Finanzas)"
...
'response.Write("numbre"&f_datos.obtenerValor("rut"))
'--------------------------------------------------------------------------------------
				...
				<input type="hidden" name="nombre" value="<%=nombre%>">
                  ...
                  <tr>
                    <td><%pagina.DibujarSubtitulo "Compromisos pendientes"%>
                      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><div align="center"><%cuenta_corriente.DibujaCompromisosPorRegularizar%>
						  <script language="javascript">
