...
pagina.Titulo = "Recepción de documentos enviados entre Sedes"
...
sede_destino=negocio.ObtenerSede()
''response.Write("sesion : "&sede_destino)
f_busqueda.AgregaCampoParam "sede_destino","filtro", "sede_ccod in ("&sede_destino&")"
...
f_envios.Carga_Parametros "envios_sedes.xml", "f_recibir_envios"
f_envios.Inicializar conexion

 
consulta =  " select a.esed_ncorr, d.eenv_tdesc,a.esed_ncorr as c_esed_ncorr, a.esed_ncorr as c2_esed_ncorr, "& vbCrLf &_
			...
			" where a.eenv_ccod=2 "
			 	...
			 	consulta = consulta & " group by a.esed_ncorr,  b.sede_tdesc, z.sede_tdesc, a.esed_fenvio,d.eenv_tdesc  "& vbCrLf &_
                    ...
                    <tr> 
                      <td width="12%"> <div align="left">
                          <%
						   ...
						   botonera.agregabotonparam "recibir_folio", "url", "proc_recibir_envios_sede.asp"
						   if cint(cantidad)=0 then
						        botonera.agregabotonparam "recibir_folio", "deshabilitado" ,"TRUE"
						   end if
						   botonera.dibujaboton "recibir_folio" %>
                        </div></td>
