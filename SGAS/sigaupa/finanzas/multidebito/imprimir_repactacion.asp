...
Function SqlDocumentos(p_ting_ccod)
	'SqlDocumentos = "select f.ting_ccod, f.ding_ndocto, f.ingr_ncorr, f.ting_ccod as c_ting_ccod, f.ding_ndocto as c_ding_ndocto, f.ingr_ncorr as c_ingr_ncorr, f.plaz_ccod, f.banc_ccod, f.ding_fdocto, f.ding_mdetalle, f.ding_tcuenta_corriente, a.repa_frepactacion, " & vbCrLf &_
	'	           "       nvl(nvl(g.post_ncorr, (select max(post_ncorr) from postulantes where pers_ncorr = b.pers_ncorr)), 0) as post_ncorr " & vbCrLf &_
	'			   "from repactaciones a, compromisos b, detalle_compromisos c, abonos d, ingresos e, detalle_ingresos f, contratos g  " & vbCrLf &_
	...
	'			   "  and contrato_origen_repactacion(a.repa_ncorr) = g.cont_ncorr (+) " & vbCrLf &_
	'			   "  and e.eing_ccod = 4  " & vbCrLf &_
	'			   "  and b.tcom_ccod = 3  " & vbCrLf &_
	'			   "  and b.ecom_ccod <> 3  " & vbCrLf &_
	'			   "  and f.ting_ccod = '" & p_ting_ccod & "'  " & vbCrLf &_
	'			   "  and a.repa_ncorr = '" & q_repa_ncorr & "'"
...
'---------------------------------------------------------------------------------------------------
url_leng_1 = "imprimir_repactacion.asp?repa_ncorr=" & q_repa_ncorr & "&leng=1"
url_leng_2 = "imprimir_repactacion.asp?repa_ncorr=" & q_repa_ncorr & "&leng=2"
url_leng_3 = "imprimir_repactacion.asp?repa_ncorr=" & q_repa_ncorr & "&leng=3"
url_leng_4 = "imprimir_repactacion.asp?repa_ncorr=" & q_repa_ncorr & "&leng=4"
url_leng_5 = "imprimir_repactacion.asp?repa_ncorr=" & q_repa_ncorr & "&leng=5"
                          ...
                          <td><div align="center">
                            <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EDEDEF">
                              ...
                              <tr>
                                ...
                                <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td><%pagina.DibujarLenguetasFClaro Array(Array("Documento Repactación", url_leng_1), Array("Cheques", url_leng_2), Array("Letras", url_leng_3), Array("Pagare", url_leng_4), Array("Comprobante de Ingreso", url_leng_5)), CInt(q_leng) %></td>
                                    </tr>
                                    <tr>
                                      <td height="2" background="../imagenes/top_r3_c2.gif"></td>
                                    </tr>
