...
if 	EsVacio(total_det_pag) then
	...
	while f_consulta.Siguiente
		...
		if f_consulta.ObtenerValor("ting_ccod") = "4" or f_consulta.ObtenerValor("ting_ccod") = "3"  or f_consulta.ObtenerValor("ting_ccod") = "52" then
