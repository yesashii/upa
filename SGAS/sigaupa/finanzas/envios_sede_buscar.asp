...
pagina.Titulo = "Agregar documentos al envio entre Sedes"
'-----------------------------------------------------------------------
...
'-----------------------------------------------------------------------
 ...
 tipo_docto = request.querystring("busqueda[0][tipo_docto]")
 

v_sede=conexion.consultaUno("select sede_origen from envios_sedes where esed_ncorr="&folio_envio)

 set f_busqueda = new CFormulario
 f_busqueda.Carga_Parametros "envios_sedes.xml", "busqueda_letras"
 ...
 f_busqueda.AgregaCampoCons "tipo_docto", tipo_docto

'---------------------------------
 set f_letras = new CFormulario
 f_letras.Carga_Parametros "envios_sedes.xml", "f_letras"
 ...
 'letras que no estan en algun folio pendiente y que estan en UAS	
	...
	consulta = "select z.*  "& vbCrLf &_
					"from ( "& vbCrLf &_
					"	 select " & folio_envio & " as esed_ncorr,a.ting_ccod as tipo_doc, a.ding_ndocto as c_ding_ndocto, a.ding_ndocto, h.edin_tdesc,  "& vbCrLf &_
					"		   a.ding_tcuenta_corriente,  protic.obtener_nombre_completo(a.pers_ncorr_codeudor,'n') as nombre_apoderado,  "& vbCrLf &_
					"		   a.ding_mdocto, a.ting_ccod, b.ingr_ncorr, 0 as enviar, a.edin_ccod,  convert(varchar,b.ingr_fpago,103) as ingr_fpago,   "& vbCrLf &_
					"		   convert(varchar,a.ding_fdocto,103) as ding_fdocto, i.ting_tdesc,  "& vbCrLf &_
					...
					"	 where a.ding_ncorrelativo in (1)  "& vbCrLf &_
					"      and h.fedi_ccod in (1, 3, 8,9) "& vbCrLf &_
					"      and isnull(a.sede_actual,case when b.ingr_fpago < '03/12/2006' then 1 else m.sede_ccod end)="&v_sede&" "			

					if tipo_docto <> "" then
					    consulta = consulta & "	   and a.ting_ccod = '" & tipo_docto & "' "& vbCrLf
					else
						consulta = consulta & "	   and a.ting_ccod in (3,4,52) "& vbCrLf
					end if
					...
					"				   from detalle_envios_sedes x, envios_sedes y   "& vbCrLf &_
					"				   where x.esed_ncorr = y.esed_ncorr   "& vbCrLf &_
					"					 and x.ding_ndocto = z.ding_ndocto   "& vbCrLf &_
					"					 and x.ting_ccod = z.ting_ccod   "& vbCrLf &_
					"					 and x.ingr_ncorr = z.ingr_ncorr   "& vbCrLf &_
					"					 and y.eenv_ccod in (1,2))  "& vbCrLf &_ 
              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="143" valign="bottom" background="../imagenes/fondo1.gif">
                      <div align="left"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Buscar
                           documentos </font></div></td>
                  ...
                  <BR>
                      <table width="660" border="0" align="left">
                        ...
                        <tr> 
                          ...
                          <td>&nbsp;</td>
                          <td><div align="left">Tipo Documento</div></td>
                          <td>:</td>
                          <td><font face="Verdana, Arial, Helvetica, sans-serif" size="1">
                            <% f_busqueda.DibujaCampo ("tipo_docto") %> 
                            </font></td>
                        </tr>
                        <tr> 
                          <td><font face="Verdana, Arial, Helvetica, sans-serif" size="1">N&ordm; Docto</font></td>
                          <td>:</td>
                          <td>                            <font face="Verdana, Arial, Helvetica, sans-serif" size="1">
                  ...
                  <td width="79" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="17%"><div align="center">
                          <% 
						  botonera.AgregaBotonParam "guardar_doctos","url","proc_envios_sede_buscar.asp?folio_envio=" & folio_envio
						  if cint(cantidad)=0 then
						     botonera.agregabotonparam "guardar_doctos", "deshabilitado" ,"TRUE"
						  end if
						  botonera.DibujaBoton "guardar_doctos"%>
                        </div></td>
