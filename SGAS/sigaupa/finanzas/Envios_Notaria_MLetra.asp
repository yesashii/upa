...
f_datos.Carga_Parametros "Envios_Notaria.xml", "f_detalle_agrupado"
f_datos.Inicializar conexion
  
	consulta =  "select protic.obtener_nombre_completo(a.pers_ncorr,'n') as nombre_apoderado , protic.obtener_rut(a.pers_ncorr) as rut_apoderado "&_ 
				"from personas a "&_ 
...
f_letras.Carga_Parametros "Envios_Notaria.xml", "f_detalle_letras"
...
'				  "and cast(a.envi_ncorr as varchar)='" & folio_envio & "'"
	...
	consulta =  "SELECT b.ding_ndocto,c1.edin_tdesc, d.ingr_fpago as ingr_fpago, c.ding_fdocto as ding_fdocto,  cast(c.ding_mdocto as integer) as ding_mdocto  "&_ 
				...
				"ON b.ting_ccod = c.ting_ccod "&_ 
				"and b.ding_ndocto = c.ding_ndocto and b.ingr_ncorr = c.ingr_ncorr AND c.DING_NCORRELATIVO = 1 "&_
                   ...
                   <form name="edicion">
                    ...
                    <table width="513" border="0">
                      <tr> 
                        ...
                        <td width="31">:</td>
                        <td width="309"><% f_datos.DibujaCampo ("rut_apoderado")  %> </td>
                      </tr>
                      <tr> 
                        <td>&nbsp;</td>
