...
{
	url = "cambiar_codeudor_repactacion.asp?pers_nrut=" + document.edicion.elements['codeudor[0][pers_nrut]'].value;
	window.location(url);
}
...
function Validar()
{
	rut=document.edicion.elements['codeudor[0][pers_nrut]'].value+'-'+document.edicion.elements['codeudor[0][pers_xdv]'].value
	
	if (!valida_rut(rut)) {
		alert('Ingrese un rut válido');		
		document.edicion.elements['codeudor[0][pers_nrut]'].focus()
		document.edicion.elements['codeudor[0][pers_nrut]'].select()
		return false;
	}
