...
Response.AddHeader "Content-Disposition", "attachment;filename=detalle_envios_multidebito.xls"
...
consulta = "select a.envi_ncorr, " & vbCrLf &_ 
			...
			"	ab.inst_ccod, " & vbCrLf &_
			"	ab.comp_ndocto,ab.dcom_ncompromiso) as ding_mdocto, " & vbCrLf &_
