...
pagina.Titulo = "Reporte de Pagare UPA"
'---------------------------------------------------------------------------------------------------
...
botonera.Carga_Parametros "Reporte_pagare_upa.xml", "botonera"
'-----------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "reporte_pagare_upa.xml", "busqueda_pagare_upa"
...
'----------------------------------------------------------------------------
 ...
 f_letras.Carga_Parametros "Reporte_pagare_upa.xml", "f_pagare_upa"
                ...
                <td width="250" bgcolor="#D8D8DE"><table width="100%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width=""><% 
									...
									<% 	
										if Request.QueryString = "" then 
					                    	botonera.agregabotonparam "reporte_txt", "deshabilitado" ,"TRUE"
  									  	end if
										botonera.DibujaBoton ("reporte_txt")
									%> 
									</td>
									<td>
									<% 	
										'if Request.QueryString = "" then 
					                    	'botonera.agregabotonparam "reporte_excel", "deshabilitado" ,"TRUE"
  									  	'end if
										'botonera.DibujaBoton ("reporte_excel")
									%> 
									</td>																			
                    </tr>
                  </table>
