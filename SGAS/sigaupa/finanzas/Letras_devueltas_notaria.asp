...
pagina.Titulo = "Ingreso de Letras Devueltas por Notaría"
'-------------------------------------------------------------------------------
...
botonera.Carga_Parametros "Letras_devueltas_notaria.xml", "botonera"
'-------------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "Letras_devueltas_notaria.xml", "busqueda_letras"
...
'----------------------------------------------------------------------------
 ...
 f_letras.Carga_Parametros "Letras_devueltas_notaria.xml", "f_letras"
...
consulta = "SELECT a.envi_ncorr, a.envi_ncorr as c_envi_ncorr, a.ting_ccod ,a.ding_ndocto, a.ding_ndocto as c_ding_ndocto," & vbCrLf &_
		" b.ingr_ncorr, a1.edin_ccod, a1.edin_tdesc, x.inen_ccod, x.inen_tdesc, protic.trunc(b.ingr_fpago) as ingr_fpago," & vbCrLf &_
		" d.pers_nrut, d.pers_xdv , cast(d.pers_nrut as varchar) + '-' + cast(d.pers_xdv as varchar) as rut_alumno, " & vbCrLf &_
		" i.pers_nrut as code_nrut, i.pers_xdv as code_xdv, " & vbCrLf &_
		" cast(i.pers_nrut as varchar) + '-' + cast(i.pers_xdv as varchar) as rut_apoderado,a.ding_mdocto " & vbCrLf &_
		"FROM " & vbCrLf &_
