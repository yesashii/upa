...
formulario.Carga_Parametros "castigos_documentos.xml", "f_nuevo"
formulario.Inicializar conexion
if folio_envio = "NUEVO" then
  consulta = "select '1' as eenv_ccod, '7' as tenv_ccod"
end if
...
function CargarEspecialidades(formulario, inen_ccod)
{
	...
	op.value = "-1";
	op.text = "Seleccione Cuenta Castigo";
