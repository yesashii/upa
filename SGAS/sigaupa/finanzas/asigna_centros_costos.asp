...
<%
v_ccos_ccod = 	Request.QueryString("busqueda_cc[0][ccos_ccod]")
...
tdet_ccod 	= 	Request.QueryString("busqueda[0][tdet_ccod]")
v_opcion 	= 	Request.QueryString("opcion")
paso		=	Request.QueryString("paso")

'response.Write("Opcion: "&v_opcion&"paso:"&paso)
...
' centros de costos asociados por carreras
if v_opcion= 1 then


	sql_centros_asociados=  " Select *,b.ccos_ccod as v_ccos_ccod, isnull(a.tdet_ccod,0) as v_tdet_ccod, isnull(a.cenc_ccod_carrera,0) as v_carr_ccod, "& vbCrLf &_ 
	                        " isnull(a.cenc_ccod_sede,0 ) as v_sede_ccod, isnull(a.cenc_ccod_jornada,0) as v_jorn_ccod "& vbCrLf &_ 
							" From centros_costos_asignados a , centros_costo b "& vbCrLf &_ 
	 						" Where a.ccos_ccod=b.ccos_ccod "

if sede_ccod <>"" then
	sql_centros_asociados= sql_centros_asociados &  "and cast(a.cenc_ccod_sede as varchar)		=	'"&sede_ccod&"'"

end if	

if carr_ccod<>"" and carr_ccod >"0" then
	sql_centros_asociados= sql_centros_asociados & " and cast(a.cenc_ccod_carrera as varchar)	=	'"&carr_ccod&"'" 
end if

if jorn_ccod <>"" and jorn_ccod > "0" then
	sql_centros_asociados= sql_centros_asociados &  " and cast(a.cenc_ccod_jornada as varchar)	=	'"&jorn_ccod&"'"
end if
						
	'response.Write("centro costo:<pre>"&sql_centros_asociados&"</pre>")
	v_checked_carrera="checked"

elseif v_opcion= 2 then

	sql_centros_asociados=  " Select *,b.ccos_ccod as v_ccos_ccod, isnull(a.tdet_ccod,0) as v_tdet_ccod, isnull(a.cenc_ccod_carrera,0) as v_carr_ccod, "& vbCrLf &_ 
	                        " isnull(a.cenc_ccod_sede,0 ) as v_sede_ccod, isnull(a.cenc_ccod_jornada,0) as v_jorn_ccod "& vbCrLf &_ 
							" From centros_costos_asignados a , centros_costo b "& vbCrLf &_ 
	 						" Where a.ccos_ccod=b.ccos_ccod "& vbCrLf &_ 
							" and cast(a.tdet_ccod  as varchar)='"&tdet_ccod&"'"
							
	v_checked_detalle="checked"

else
	sql_centros_asociados=" Select '' where 1=2 "
end if

'response.Write("<pre>"&sql_centros_asociados&"</pre>")

set f_lista_union = new CFormulario
	f_lista_union.Carga_Parametros "asigna_centros_costos.xml", "listado_uniones"
	f_lista_union.Inicializar conexion
	f_lista_union.Consultar sql_centros_asociados
...
'set f_centros = new CFormulario
'f_centros.Carga_Parametros "busca_examen_postulante.xml", "busqueda2"
'f_centros.Inicializar conexion
'f_centros.Consultar "Select ''"
...
'--------------------------------------------agregamos filtros a los select que mostraran la sede, carrera, jornada
 if cad_sedes<>"" then
...
consulta_jornadas = "select distinct d.jorn_tdesc,d.jorn_ccod,b.carr_ccod" & vbCrLf &_  
                    ...
                    " and a.jorn_ccod=d.jorn_ccod" & vbCrLf &_ 
                    " and cast(a.peri_ccod as varchar)='"&v_peri_ccod&"'"
'response.Write("<pre>"&consulta_jornadas&"</pre>")
...
function nuevo_centro_costo(){
	v_url="asigna_centros_costos_agregar.asp";	
	window.open(v_url,"asigan_nuevo_cc","resizable,width=800,height=400");
	//return false;
}
                    ...
                    <td>
                          <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor='#999999' >
                            <tr bgcolor='#C4D7FF' bordercolor='#999999'> 
                              <td width="51%" > 
                                <div align="center"><input type="radio" name="opcion" value="1" onClick="DeshabilitaDetalle();" <%=v_checked_carrera%> >
                                  <strong>Por Carrera</strong></div></td>
                              <td width="49%"> 
                                <div align="center"><input type="radio" name="opcion" value="2" onClick="DeshabilitaEscuela();" <%=v_checked_detalle%>>
          ...
          <tr>
            <td><div align="center"><br>
			  ...
			  <table width="99%"  border="0" cellspacing="0" cellpadding="0" >
				  ...
				  <tr>
				  		<td><br/><%f_lista_union.DibujaTabla%><br/></td>
				  </tr>
				  <tr>
				  <td><p><br></p></td>
				  </tr>
