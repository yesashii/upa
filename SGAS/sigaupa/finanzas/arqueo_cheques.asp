...
pagina.Titulo = "Arqueo de Cheques"
'---------------------------------------------------------------------------------------------------
...
botonera.Carga_Parametros "arqueo_documentos.xml", "botonera"
'-----------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "arqueo_documentos.xml", "busqueda_cheques"
 f_busqueda.Inicializar conexion
 f_busqueda.Consultar "select ''"
 f_busqueda.Siguiente
 
 f_busqueda.AgregaCampoCons "sede_ccod", sede
 f_busqueda.AgregaCampoCons "sede_caja", sede_caja
...
'----------------------------------------------------------------------------
 ...
 f_letras.Carga_Parametros "arqueo_documentos.xml", "f_cheques"
...
consulta = " Select  a.envi_ncorr, a.ding_ndocto,a.banc_ccod, d.edin_tdesc, convert(varchar,b.ingr_fpago,103) as ingr_fpago, " & vbCrLf &_
			"        convert(varchar,a.ding_fdocto,103) as ding_fdocto, h.abon_mabono as ding_mdocto, " & vbCrLf &_
...
if inicio <> "" and esvacio(termino) then
	consulta= consulta + " and  protic.trunc(a.ding_fdocto)='"&inicio&"' "& vbCrLf
end if

if EsVacio(inicio) and termino<>"" then
...
if inicio <> "" and termino <> "" then
	consulta= consulta + " and convert(datetime,a.ding_fdocto,103) BETWEEN  convert(datetime,'"&inicio&"',103) and convert(datetime,'"&termino&"',103)"& vbCrLf 
					...
					if estado_letra <> "" then
					 ...
					 consulta = consulta & "order by a.edin_ccod,a.banc_ccod,a.ding_ndocto asc, a.ding_fdocto asc, b.ingr_fpago asc"
				...
				<form name="buscador" method="post">                
                      <table width="660" border="0" align="left">
                        <tr> 
                          ...
                          <td>
                            <div align="left">Sede Caja </div></td>
                          <td>:</td>
                          <td>
                            <% f_busqueda.DibujaCampo ("sede_caja") %>
                          </td>
              ...
              <tr>
                ...
                <td width="250" bgcolor="#D8D8DE"><table width="90%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="49%"><% 
                					  if Request.QueryString = "" then 
					                     botonera.agregabotonparam "excel_cheques", "deshabilitado" ,"TRUE"
  									  end if
									     botonera.DibujaBoton ("excel_cheques")  
