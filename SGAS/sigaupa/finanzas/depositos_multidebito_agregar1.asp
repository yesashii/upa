...
pagina.Titulo = "Detalle de cuotas multidebito"
'---------------------------------------------------------------------------------------------------
...
f_envio.Carga_Parametros "depositos_multidebito.xml", "f_envios"
...
f_detalle_envio.Carga_Parametros "depositos_multidebito.xml", "f_detalle_envio"
...
'			"     cast(c.ding_ndocto as varchar) as numero_pagare, "& vbCrLf &_
...
consulta = "SELECT a.envi_ncorr, " & vbCrLf &_
			...
			"	protic.total_recepcionar_cuota (ab.tcom_ccod , " & vbCrLf &_
			"	ab.inst_ccod,ab.comp_ndocto,ab.dcom_ncompromiso) as ding_mdocto, " & vbCrLf &_
			"	convert(varchar,d.ingr_fpago,103) as ingr_fpago, " & vbCrLf &_ 
			"	convert(varchar,c.ding_fdocto,103)  as ding_fdocto, " & vbCrLf &_
			"	c1.edin_ccod, c1.edin_tdesc, " & vbCrLf &_
                  ...
                  <td width="126" bgcolor="#D8D8DE"><table width="97%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="14%"> <div align="left"> 
                          <%  botonera.agregabotonparam "anterior", "url", "depositos_multidebito.asp?envi_ncorr="& folio_envio
                      ...
                      <td width="14%"> <%    if estado_envio = "2" then
						         botonera.agregabotonparam "agregar_letras", "deshabilitado" ,"TRUE"
					              ...
					              botonera.agregabotonparam "agregar_letras", "url" ,"depositos_multidebito_buscar.asp?folio_envio="& folio_envio 
					              botonera.DibujaBoton "agregar_letras"
					   %> </td>
                      <td width="14%"><% if estado_envio = "2" then
					                        botonera.agregabotonparam "eliminar", "deshabilitado" ,"TRUE"
										 end if 
					                       botonera.agregabotonparam "eliminar", "url", "depositos_multidebito_eliminar_cuota.asp"
						                   botonera.dibujaboton "eliminar"
										 %> </td>
                      <td width="15%">
                        <% botonera.AgregaBotonParam "excel","url","depositos_multidebito_excel.asp?folio_envio=" & folio_envio
