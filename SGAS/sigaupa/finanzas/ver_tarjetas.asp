...
consulta_tarjetas = "select case isnull(a.ding_bpacta_cuota,2) when 'S' then 1 else 2 end as pacta_cuota,a.ting_ccod, a.ting_ccod as ting_ccod_ant,a.ding_tcuenta_corriente," & vbCrLf &_
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td bgcolor="#D8D8DE">
				...
				<%if v_pacta="1" then%>
                	<p>(<font color="#FF0000">*</font>) <font color="#0033FF">La Tarjeta es parte de una pactacion, por lo que  la fecha del compromiso asociado tambien se modificará si corresponde. </font></p>
            	 	<p></p>
				<%end if%>
                <br>
              </td>
