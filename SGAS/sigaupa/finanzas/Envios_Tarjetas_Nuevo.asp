...
formulario.Carga_Parametros "Envios_Tarjetas.xml", "f_nuevo"
formulario.Inicializar conexion
if folio_envio = "NUEVO" then
  consulta = "select '1' as eenv_ccod, '5' as tenv_ccod"
end if
...
<html>
<head>
<title>Nuevo depósito de Tarjetas</title>
                  ...
                  <td bgcolor="#D8D8DE">
				    ...
				    <table width="386" border="0">
                      ...
                      <tr> 
                        ...
                        <td><div align="center">:</div></td>
                        <td> 
                          <% formulario.DibujaCampo("envi_fenvio")%>  (dd/mm/aaaa) </td>
                      </tr>
                      <tr> 
                        <td></td>
                        <td>Descripcion depósito</td>
                        <td><div align="center">:</div></td>
                        <td><input type="text" name="envio[0][envi_tdescripcion]" value="" size="50" maxlength="50"  ></td>
                      </tr>
                    </table>
			        </form>
				  <br>				  </td>
