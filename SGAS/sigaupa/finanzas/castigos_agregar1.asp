...
'ENTRADA		:NA
'SALIDA			:NA
'MODULO QUE ES UTILIZADO: GESTION DE DOCUMENTO
'
'--ACTUALIZACION--
'
...
pagina.Titulo = "Detalle de documentos en castigos"
'--------------------------------------------------------------------------------------------
...
f_envio.Carga_Parametros "castigos_documentos.xml", "f_envios"
...
f_detalle_envio.Carga_Parametros "castigos_documentos.xml", "f_detalle_envio"
f_detalle_envio.Inicializar conexion

'consulta = "SELECT a.envi_ncorr, b.ting_ccod, b.ding_ndocto as c_ding_ndocto, b.ingr_ncorr ,b.ting_ccod as c_ting_ccod," & vbCrLf &_
...
'			"    c.ding_ndocto numero_pagare, "& vbCrLf &_
...
'			" and c.ting_ccod in (3,4,14,38) "& vbCrLf &_
'			" and ab.ingr_ncorr=d.ingr_ncorr "& vbCrLf &_
'			"ORDER BY  numero_pagare,nombre_apoderado"
                ...
                <td bgcolor="#D8D8DE"> <div align="center"><BR>
                  ...
                  <table width="100%" border="0">
                    <tr> 
                      ...
                      <td width="10%"><strong>Instituci&oacute;n</strong></td>
                      <td width="2%">:</td>
                  ...
                  <td width="126" bgcolor="#D8D8DE"><table width="97%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="14%"> <div align="left"> 
                          <%  botonera.agregabotonparam "anterior", "url", "envios_castigo.asp?envi_ncorr="& folio_envio
						      botonera.DibujaBoton "anterior"  %>
                        </div></td>
                      <td width="14%"> <%    if estado_envio = "5" then
						         botonera.agregabotonparam "agregar_letras", "deshabilitado" ,"TRUE"
							  end if
					              botonera.agregabotonparam "agregar_letras", "url" ,"castigos_buscar.asp?folio_envio="& folio_envio 
					              botonera.DibujaBoton "agregar_letras"
					   %> </td>
                      <td width="14%"><% if estado_envio = "5" then
					                        botonera.agregabotonparam "eliminar", "deshabilitado" ,"TRUE"
										 end if 
					                       botonera.agregabotonparam "eliminar", "url", "envios_castigos_eliminar_cuota.asp"
						                   botonera.dibujaboton "eliminar"
										 %> </td>
                      <td width="15%">
                        <% botonera.AgregaBotonParam "excel","url","envios_castigos_excel.asp?folio_envio=" & folio_envio
