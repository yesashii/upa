...
Response.AddHeader "Content-Disposition", "attachment;filename=reporte_tarjetas_avanzado.xls"
...
consulta = 	" Select   substring(m.ting_tdesc,12,7) as ting_tdesc,b.mcaj_ncorr, a.envi_ncorr, d.edin_tdesc, isnull(a.ding_mdocto,a.ding_mdetalle) as ding_mdocto,a.DING_MDETALLE," & vbCrLf &_
				"        convert(varchar,b.ingr_fpago,103) as ingr_fpago, convert(varchar,a.ding_fdocto,103) as ding_fdocto, "& vbCrLf &_
				"        case when len(isnull(a.ding_ndocto,0))<=3 then Right(substring(a.ding_tcuenta_corriente,1,12),4) else cast(a.ding_ndocto as varchar) end as numero_tarjeta, " & vbCrLf &_
				...
				"    and a.ding_ncorrelativo > 0 " 
					...
					if estado_letra <> "" then
					 ...
					 consulta = consulta & "order by ting_tdesc, numero_tarjeta asc, a.ding_fdocto asc, b.ingr_fpago asc"
...
<table width="75%" border="1">
  <tr> 
    ...
    <td width="8%"><div align="center"><strong>Detalle ($)</strong></div></td>
  ...
  <tr> 
	...
	<td><%=f_letras.ObtenerValor("numero_tarjeta")%></td>
    ...
    <td><div align="left"><%=f_letras.ObtenerValor("ding_mdetalle")%></div></td>
