...
if v_cajero="" then
	conexion.MensajeError "No existe una caja abierta para procesar las cuotas Multidebito"
...
f_formulario.Carga_Parametros "depositos_multidebito.xml", "f_enviar"
...
Function TablaAArchivoSoftland(envi_ncorr, p_conexion)
	...
	archivo_salida 		= fecha_envio&"_deposito_multi_"&envi_ncorr&".txt"
	set fso = Server.CreateObject("Scripting.FileSystemObject")
	set o_texto_archivo = fso.CreateTextFile(RUTA_ARCHIVOS_SALIDA_TARJETA & "\" & archivo_salida)

'response.Write("<br>"&archivo_salida&"<br>")

'response.Write("<br>"&RUTA_ARCHIVOS_SALIDA_TARJETA&"<br>")
   ...
   '	o_texto_archivo.WriteLine(linea)	
	...
	while f_consulta.Siguiente
		...
		linea = ""
		linea = linea & "1-10-050-80-" &f_consulta.ObtenerValor("moch_cenc_ccod_softland")& ",," & f_consulta.ObtenerValor("moch_mdocto") 
