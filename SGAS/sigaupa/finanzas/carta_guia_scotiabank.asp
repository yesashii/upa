...
consulta = "select '0003235' as Convenio,'000' as moneda,STUFF(d.pers_nrut, 1, 0,REPLICATE('0',cast(9-len(d.pers_nrut) as numeric))) as rut_aceptante," & vbCrLf &_
		...
		" replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(substring(protic.obtener_nombre_completo(c.pers_ncorr_codeudor,'a'), 0, 50),'ñ','N'),'á','A'),'é','E'),'í','I'),'ó','O'),'ú','U'),'.',' '),',',' '),'-',' '),'#',' '),'/',' ') as nombre_aceptante," & vbCrLf &_
		" replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(substring(protic.obtener_direccion_letra(c.pers_ncorr_codeudor, 1,'CNPB'),0,50),'ñ','N'),'á','A'),'é','E'),'í','I'),'ó','O'),'ú','U'),'.',' '),',',' '),'-',' '),'#',' '),'/',' ') as direccion_aceptante, " & vbCrLf &_
		" replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(replace(substring(f.ciud_tdesc,0,30),'ñ','N'),'á','A'),'é','E'),'í','I'),'ó','O'),'ú','U'),'.',' '),',',' '),'-',' '),'#',' '),'/',' ') as comuna," & vbCrLf &_
