...
<table width="114%" border="1">
  <tr>
	<td width="9%"><div align="center"><strong>Tipo Docto</strong></div></td> 
    <td width="9%"><div align="center"><strong>N&ordm; Docto</strong></div></td>
    ...
    <td width="19%"><div align="center"><strong>Monto Docto</strong></div></td>
  </tr>
  <%  while f_detalle_envio.Siguiente %>
  <tr>
    <td><div align="center"><%=f_detalle_envio.ObtenerValor("tipo_docto")%></div></td> 
