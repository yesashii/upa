...
pagina.Titulo = "Arqueo de Pagarés"
'---------------------------------------------------------------------------------------------------
...
'-----------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "arqueo_documentos.xml", "busqueda_pagares"
...
'----------------------------------------------------------------------------
 ...
 f_letras.Carga_Parametros "arqueo_documentos.xml", "f_pagares"
 f_letras.Inicializar conexion
 

consulta = " Select  a.envi_ncorr, a.banc_ccod, d.edin_tdesc, convert(varchar,b.ingr_fpago,103) as ingr_fpago, " & vbCrLf &_
              ...
              <tr>
                ...
                <td width="250" bgcolor="#D8D8DE"><table width="90%"  border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="49%"><% 
                					  if Request.QueryString = "" then 
					                     botonera.agregabotonparam "excel_pagares", "deshabilitado" ,"TRUE"
  									  end if
									     botonera.DibujaBoton ("excel_pagares")  
