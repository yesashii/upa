...
Response.AddHeader "Content-Disposition", "attachment;filename=Reporte_pagare_upa.xls"
...
f_letras.Carga_Parametros "Reporte_pagare_upa.xml", "f_pagare_upa_excel"
f_letras.Inicializar conexion

					
consulta = 	"select   b.mcaj_ncorr, a.envi_ncorr, cast(a.ding_tcuenta_corriente as varchar) as ding_tcuenta_corriente ," & vbCrLf &_
				...
				" cast(a.ding_ndocto as varchar) as ding_ndocto, "& vbCrLf &_
				"   protic.obtener_numero_pagare_upa_softland(a.ingr_ncorr)  as cuota_pagare, "& vbCrLf &_
				...
				"lower(f.PERS_TEMAIL) as email_personal,(select top 1 lower(email_nuevo) from cuentas_email_upa tt where tt.pers_ncorr=f.pers_ncorr) as email_upa," & vbCrLf &_
				...
				"    and b.eing_ccod <> 3  "
					...
					if estado_letra <> "" then
					 ...
					 consulta = consulta & "order by ding_ndocto asc, a.ding_fdocto asc, b.ingr_fpago asc"
...
<table width="75%" border="1">
  <tr>
    ...
    <td width="11%"><div align="center"><strong>N&ordm; Pagare</strong></div></td>
	 <td width="11%"><div align="center"><strong>N&ordm; Cuota</strong></div></td>
  ...
  <tr> 
	...
	<td><%=f_letras.ObtenerValor("cuota_pagare")%></td>
    ...
    <td><div align="center"><%=f_letras.ObtenerValor("email_personal")%></div></td>
    <td><div align="center"><%=f_letras.ObtenerValor("email_upa")%></div></td>
