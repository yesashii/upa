...
Response.AddHeader "Content-Disposition", "attachment;filename=reporte_pagare_upa_avanzado.xls"
...
consulta = 	" Select   s.sede_tdesc as sede,b.mcaj_ncorr, a.envi_ncorr, a.ding_mdocto,cast(a.ding_tcuenta_corriente as varchar) as ding_tcuenta_corriente," & vbCrLf &_
				...
				"    left outer join   sedes s " & vbCrLf &_
				"        on i.sede_ccod = s.sede_ccod  " & vbCrLf &_
...
<table width="75%" border="1">
  ...
  <tr> 
	...
	<td><div align="right"><%=f_letras.ObtenerValor("sede")%></div></td>
  </tr>
