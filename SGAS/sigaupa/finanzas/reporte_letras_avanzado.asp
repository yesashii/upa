...
Response.AddHeader "Content-Disposition", "attachment;filename=reporte_letras_avanzado.xls"
...
consulta = 	" Select  b.mcaj_ncorr,a.envi_ncorr, a.ding_ndocto, convert(varchar,b.ingr_fpago,103) as ingr_fpago, " & vbCrLf &_
				...
				" 		 protic.obtener_direccion_letra(a.pers_ncorr_codeudor,1,'CNPB') as direccion, g.pers_tfono,LOWER(g.pers_temail) as email, "& vbCrLf &_
				...
				"    and b.eing_ccod not in (2,3)  " & vbCrLf &_
				" 	 and j.tdir_ccod=1 "
...
<table width="75%" border="1">
  ...
  <tr>
	...
	<td><div align="left"><%=f_letras.ObtenerValor("saldo_letra")%></div></td>
	<td><div align="left"><%=f_letras.ObtenerValor("monto_protesto")%></div></td>
	...
	<td><%=f_letras.ObtenerValor("email")%></td>
