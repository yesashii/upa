...
'			   "and cast(e.ingr_ncorr as varchar) ='" & num_ingreso& "'"
  consulta = "select a.comp_ndocto,a1.tcom_tdesc, "& vbCrLf &_
			"		e.ding_ndocto," & vbCrLf &_
			"		e.ding_ndocto as c_ding_ndocto, " & vbCrLf &_
			"		e.ingr_ncorr, " & vbCrLf &_
			"		e.ting_ccod, " & vbCrLf &_
			"		f.ting_tdesc, " & vbCrLf &_
			"		e.ding_mdetalle, " & vbCrLf &_
			"		e.edin_ccod, " & vbCrLf &_
			"		g.edin_tdesc as estado, " & vbCrLf &_
			"		e.repa_ncorr "	& vbCrLf &_
			"from contratos z " & vbCrLf &_
			"right outer join compromisos a	" & vbCrLf &_	
			"on z.cont_ncorr = a.comp_ndocto " & vbCrLf &_
			"join tipos_compromisos a1 " & vbCrLf &_
			"on a.tcom_ccod = a1.tcom_ccod " & vbCrLf &_
			"join detalle_compromisos b " & vbCrLf &_
			"on a.tcom_ccod = b.tcom_ccod " & vbCrLf &_
			"and a.inst_ccod = b.inst_ccod " & vbCrLf &_
			"and a.comp_ndocto = b.comp_ndocto " & vbCrLf &_
			"join abonos c " & vbCrLf &_
			"on b.tcom_ccod = c.tcom_ccod " & vbCrLf &_
			"and b.inst_ccod = c.inst_ccod " & vbCrLf &_
			"and b.comp_ndocto = c.comp_ndocto " & vbCrLf &_
			"and b.dcom_ncompromiso = c.dcom_ncompromiso " & vbCrLf &_
			"join ingresos d " & vbCrLf &_
			"on c.ingr_ncorr = d.ingr_ncorr " & vbCrLf &_
			"join detalle_ingresos e " & vbCrLf &_
			"on d.ingr_ncorr = e.ingr_ncorr " & vbCrLf &_
			"join tipos_ingresos f " & vbCrLf &_
			"on e.ting_ccod = f.ting_ccod " & vbCrLf &_
			"join estados_detalle_ingresos g " & vbCrLf &_
			"on e.edin_ccod = g.edin_ccod " & vbCrLf &_
			"where cast(e.ding_ndocto as varchar) ='" & num_doc  & " '" & vbCrLf &_
			"and cast(e.ingr_ncorr as varchar) ='" & num_ingreso& "'"
	'response.Write("<pre>"&consulta&"</pre>")
