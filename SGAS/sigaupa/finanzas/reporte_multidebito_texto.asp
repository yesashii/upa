...
<%
'---------------------------------------------------------------------------------------------------------------------------------
Response.AddHeader "Content-Disposition", "attachment;filename=reporte_multidebito_texto.txt"
...
while f_multidebito.Siguiente
	Response.Write(Ac(f_multidebito.ObtenerValor("rut_apoderado"),10,"D"))
	Response.Write(Ac(f_multidebito.ObtenerValor("nombre_apoderado"),50,"D"))
	Response.Write(Ac(f_multidebito.ObtenerValor("cod_banco"),15,"D"))
	Response.Write(Ac(f_multidebito.ObtenerValor("rut_alumno"),11,"D"))
	Response.Write(Ac(f_multidebito.ObtenerValor("saldo_pagare"),16,"D"))
	Response.Write(Ac(f_multidebito.ObtenerValor("fecha_docto"),8,"D"))
