...
lengueta_detalle1 = "adm_titulados_agregar_2.asp?plan_ccod=" & q_plan_ccod & "&peri_ccod=" & q_peri_ccod & "&pers_nrut=" & q_pers_nrut & "&pers_xdv=" & q_pers_xdv
...
SQL = " select f.sede_ccod, a.pers_ncorr, b.plan_ccod, c.espe_ccod, e.peri_ccod, d.carr_tdesc, c.espe_tdesc, "& vbCrLf & _
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%if lengueta_detalle = "" then
			      	pagina.DibujarLenguetas Array(Array("Datos Personales", url_leng1), Array("Datos de Titulación", lengueta_detalle1),"Cert. Emitidos"), 3 
				  else
				  	pagina.DibujarLenguetas Array(Array("Datos Personales", url_leng1), Array("Datos de Titulación", lengueta_detalle1),Array("Datos adicionales Egreso y Titulación", lengueta_detalle),"Cert. Emitidos"), 4 
				  end if
				  %></td>
          </tr>
          <tr>
