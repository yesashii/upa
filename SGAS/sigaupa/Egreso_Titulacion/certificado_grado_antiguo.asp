...
SQL = "  select top 1 a.salu_ncorr, a.pers_ncorr, protic.obtener_rut(a.pers_ncorr) as rut, protic.obtener_nombre_completo(a.pers_ncorr, 'N') as nombre,"& vbCrLf &_
      ...
      "         cast(a.salu_nfolio as varchar) as folio_reg, grado_academico as titulo_grado, "& vbCrLf &_
	  " '( ' + "& vbCrLf &_
      ...
      "       tipos_salidas_plan d, licenciaturas_carrera e"& vbCrLf &_
      "  where a.sapl_ncorr = b.sapl_ncorr "& vbCrLf &_
      "    and a.pers_ncorr = c.pers_ncorr "& vbCrLf &_
      "    and b.tspl_ccod = d.tspl_ccod and a.cod_registro=e.cod_registro "& vbCrLf &_
  ...
  <tr> 
	...
	<td width="77%">
		<table width="100%">
			  ...
			  <tr><td colspan="3">&nbsp;</td></tr>
			  <tr valign="bottom"><td colspan="3"><div align="right"><font size="2" face="Times New Roman, Times, serif">N° Céd. de Identidad: <%=rut%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></div></td></tr>
			  <tr> 
			  ...
			  <tr><td colspan="3">&nbsp;</td></tr>
			  <tr valign="top"> 
				<td colspan="3" align="left"><font size="4" face="Times New Roman, Times, serif"><span class="noprint">se otorg&oacute; el Grado Académico de </span>&nbsp;&nbsp;<%=titulo1%></font></td>
			  </tr>
			  <tr><td colspan="3">&nbsp;</td></tr>
			  <tr><td colspan="3">&nbsp;</td></tr>
			  <tr><td colspan="3">&nbsp;</td></tr>
			  ...
			  <tr><td colspan="3">&nbsp;</td></tr>
			  <tr valign="top"> 
				<td colspan="3" align="center"><font size="4" face="Times New Roman, Times, serif">&nbsp;&nbsp;&nbsp;<%=mencion%></font></td>
			  </tr>
			  <%else%>
			  <tr> 
				<td colspan="3" align="left"><font size="4" face="Times New Roman, Times, serif">&nbsp;&nbsp;&nbsp;</font></td>
			  </tr>
			  <%end if%>
			  <tr><td colspan="3">&nbsp;</td></tr>
			  <tr><td colspan="3">&nbsp;</td></tr>
