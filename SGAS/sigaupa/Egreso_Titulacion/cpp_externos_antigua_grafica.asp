...
if rut <> "" then 
		 ...
		 if titulado <> "0" then 
				...
				mensaje_no_titulado = "Lo Sentimos pero este rut no presenta asociada una matrícula de egresado o titulado en nuestros sistemas. Le solicitamos comunicarse con la dirección de CPP para solucionar dicho problema."
			end if
else
		mensaje_no_titulado=""
	    ...
	    <td width="836" bgcolor="#FFFFFF">
			...
			<td width="539" height="86">
			      <!-----------inicio cuadro con rut de busqueda------->
					    ...
					    <!------------Fin de cuadro con rut de búsqueda--->
					</td>
				</tr>
			    <tr>
						...
						<tr valign="top">
							...
							<td bgcolor="#FFFFFF" width="600">
								<table width="100%" cellpadding="0" cellspacing="0" border="0">
								  ...
								  <tr> 
									  <td width="100%"><font size="2">La información que solicitamos será de uso exclusivo y protegido de nuestra Universidad y sus egresados. Rogamos completar todos los campos de consulta.</font></td>
								  </tr>
								  <tr><td width="100%"><font size="2" face="Times New Roman, Times, serif">&nbsp;</font></td></tr>
								  ...
								  <tr><td width="100%" align="center">
                                      ...
                                      <td width="17%" align="right"><font size="2"><font color="#CC0000">*</font>A.Materno</font></td>
												...
												<tr><td colspan="6" align="left"><font size="2"><strong>Dirección Personal</strong></font></td></tr>
												<tr valign="middle">
													<td width="17%" align="right"><font size="2"><font color="#CC0000">*</font>País</font></td>
													<td width="2%" align="center"><font size="2">:</font></td>
													<td colspan="4" align="left"><%f_datos_personales.dibujaCampo("pais_ccod")%></td>
												</tr>
												<tr valign="middle">
													<td colspan="6" align="center"><font size="2" color="#000099">Ubicación en el Extranjero</font></td>
												</tr>
												<tr valign="middle">
													...
													<tr valign="middle"><td width="100%">
														<table width="100%" cellpadding="0" cellspacing="0" border="0">
															...
															<tr valign="middle">
																<td width="15%" align="right"><input type="text" name="ext2" size="1" maxlength="1" value="<%=asterisco2%>" style="border:none; color:red"><font size="2">Dirección</font></td>
																<td width="2%" align="center"><font size="2">:</font></td>
												...
												<tr valign="top">
													<td colspan="6" align="center"><font size="2" color="#000099">Ubicación dentro de Chile</font></td>
												</tr>
												<tr valign="top">
													<td colspan="6" align="center">
													<table width="95%" cellpadding="0" cellspacing="0" border="1" bordercolor="#000099">
													<tr valign="top"><td width="100%">
														<table width="100%" cellpadding="0" cellspacing="0" border="0">
															...
															<tr valign="top">
																<td width="17%" align="right"><input type="text" name="nac2" size="1" maxlength="1" value="<%=asterisco4%>" style="border:none; color:red"><font size="2">Dirección</font></td>
																<td width="2%" align="center"><font size="2">:</font></td>
												...
												<%if tipo = 2 then %>
												<tr><td colspan="6" align="left"><font size="2"><strong>Dirección Comercial</strong></font></td></tr>
												<tr valign="middle">
													<td width="17%" align="right"><font size="2"><font color="#CC0000">*</font>País</font></td>
												...
												<tr valign="middle">
													<td width="17%" align="right"><font size="2"><strong>Dueño de Empresa</strong></font></td>
													<td width="2%" align="center"><font size="2">:</font></td>
													<td width="30%" colspan="4" align="left">
                                      ...
                                      <td width="100%" colspan="6" align="left"><font size="2">Preferencia 
                                        de contacto:</font></td>
												...
												<tr><td width="100%" colspan="6" align="left"><font size="2">¿Desea recibir información permanente sobre charlas, seminarios y eventos que se realicen en la Universidad?:</font></td></tr>
												<tr> <td width="17" align="center">&nbsp;</td>
													 <td width="100%" colspan="5" align="left">
													              <font size="2">
																		<table width='40%'>
