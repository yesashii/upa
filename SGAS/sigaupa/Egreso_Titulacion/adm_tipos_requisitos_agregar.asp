...
<%
q_treq_ccod = Request.QueryString("treq_ccod")
...
SQL = " select a.treq_ccod, a.treq_tdesc, a.teva_ccod"
SQL = SQL &  " from tipos_requisitos_titulo a"
SQL = SQL &  " where cast(a.treq_ccod as varchar)= '" & q_treq_ccod & "'"

f_tipo.Consultar SQL
f_tipo.SiguienteF
f_tipo.AgregaCampoCons "x", "x"


if EsVacio(q_treq_ccod) then
	str_accion = "Agregar"
else
	str_accion = "Editar"
end if
            ...
            <td><br>
              <form name="edicion">
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><%pagina.DibujarSubtitulo "Tipo requisito"%>
                      <table width="98%"  border="0" align="center">
                        <tr>
                          <td><%f_tipo.DibujaRegistro%></td>
                        </tr>
                      </table></td>
                  </tr>
                </table>
