...
tablas= "select distinct b.nive_ccod as nivel, " & vbCrLf & _
		"	b.mall_ccod, " & vbCrLf & _
		"	b.plan_ccod as plan_ccod, " & vbCrLf & _
		"	c.espe_ccod as espe_ccod, " & vbCrLf & _
		"	a.asig_ccod as asig_ccod, " & vbCrLf & _
		"	a.asig_tdesc as asignatura, " & vbCrLf & _
		"	a.asig_nhoras as asig_nhoras, " & vbCrLf & _
		"	e.carr_ccod as carr_ccod, " & vbCrLf & _
		"	f.duas_tdesc as regimen, " & vbCrLf & _
		"case cpla_nporcentaje when null then '' else cast(cpla_nporcentaje as varchar) end as porcentaje, " & vbCrLf & _
		"case isnull(cpla_pertenece_certificado,0) when 0 then 'Sí' else 'No' end as en_certificado " & vbCrLf & _
		"from asignaturas a " & vbCrLf & _
		"join malla_curricular b " & vbCrLf & _	
		...
		"left outer join configuracion_planes g	" & vbCrLf & _
		"	on b.mall_ccod = g.mall_ccod " & vbCrLf & _
		"	and b.asig_ccod = g.asig_ccod " & vbCrLf & _	 
		"order by b.nive_ccod, " & vbCrLf & _
		"	a.asig_ccod "
