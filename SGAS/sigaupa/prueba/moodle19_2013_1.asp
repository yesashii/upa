...
ultima_categoria = 560 '551
ultimo_curso = 20630  '20620
ultima_seccion = 117050 '116988
ultimo_contexto = 355700  '355646
ultimo_cache_flacs = 280199  '280119
ultimo_log = 10303598 '10303548
path_contexto = "/1"

id_forum = 27669  '27659
course_modules = 149153 '149103
course_display = 237650 '237589
block_instance = 136955 '136905
...
consulta = "  select distinct protic.initCap(facu_tdesc) as facu_tdesc, f.facu_ccod " & vbCrLf &_
		   ...
		   "  where a.ofer_ncorr=b.ofer_ncorr and b.peri_ccod in (230) " & vbCrLf &_
		   ...
		   "  and exists(select 1 from secciones aa where peri_ccod in (230) and aa.sede_ccod=b.sede_ccod " & vbCrLf &_
...
consulta_cursos =   "  select facu_ccod,sede_ccod,carr_ccod,jorn_ccod,asig_ccod,seccion,asig_tdesc + ' ('+seccion+')' as nombre_largo, " & vbCrLf &_
					...
					"  where a.peri_ccod=b.peri_ccod and cast(b.peri_ccod as varchar)='230' " & vbCrLf &_
