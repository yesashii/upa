...
ultima_categoria = 576	'556
ultimo_curso = 23795	'23695
ultima_seccion = 130893	'130793
ultimo_contexto = 393893	'393793
ultimo_cache_flacs = 10
ultimo_log = 11831084	'11830984
path_contexto = "/1"

id_forum = 31419	'31319
course_modules = 173743	'173643
course_display = 264492	'264392
block_instance = 150644	'150544
...
consulta = "  select distinct protic.initCap(facu_tdesc) as facu_tdesc, f.facu_ccod " & vbCrLf &_
		   ...
		   "  where a.ofer_ncorr=b.ofer_ncorr and b.peri_ccod in (232) " & vbCrLf &_
		   ...
		   "  and exists(select 1 from secciones aa where peri_ccod in (232) and aa.sede_ccod=b.sede_ccod " & vbCrLf &_
...
consulta_cursos =   "  select facu_ccod,sede_ccod,carr_ccod,jorn_ccod,asig_ccod,seccion,asig_tdesc + ' ('+seccion+')' as nombre_largo, " & vbCrLf &_
					...
					"  where a.peri_ccod=b.peri_ccod and cast(b.peri_ccod as varchar)='232' " & vbCrLf &_
