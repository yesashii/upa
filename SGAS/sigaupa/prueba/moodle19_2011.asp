...
ultima_categoria = 420
ultimo_curso = 13396
ultima_seccion = 73739
ultimo_contexto = 242186
ultimo_cache_flacs = 1
ultimo_log = 6692281'5434893
path_contexto = "/1"

id_forum = 16220
course_modules = 85949
course_display = 157462
block_instance = 89418
...
consulta = "  select distinct protic.initCap(facu_tdesc) as facu_tdesc, f.facu_ccod " & vbCrLf &_
		   ...
		   "  where a.ofer_ncorr=b.ofer_ncorr and b.peri_ccod in (224) " & vbCrLf &_
		   ...
		   "  and exists(select 1 from secciones aa where peri_ccod in (224) and aa.sede_ccod=b.sede_ccod " & vbCrLf &_
...
consulta_cursos =   "  select facu_ccod,sede_ccod,carr_ccod,jorn_ccod,asig_ccod,seccion,asig_tdesc + ' ('+seccion+')' as nombre_largo, " & vbCrLf &_
					...
					"  where a.peri_ccod=b.peri_ccod and cast(b.peri_ccod as varchar)='224' " & vbCrLf &_
					"  and a.asig_ccod=c.asig_ccod and a.carr_ccod=d.carr_ccod " & vbCrLf &_
					"  and d.area_ccod=e.area_ccod and e.facu_ccod=f.facu_ccod and a.carr_ccod not in ('7') " & vbCrLf &_
					"  and exists (select 1 from moodle_course_categories bb where bb.facu_ccod=f.facu_ccod) " & vbCrLf &_
					...
					"  and c.asig_tdesc not like '%seleccion%' and c.asig_tdesc not like '%reserva%' " &vbCrLf &_
					"  )table1 " & vbCrLf &_
