...
ultima_categoria = 611	'591
ultimo_curso = 29767	'29667
ultima_seccion = 158176	'158076
ultimo_contexto = 468436	'468336
ultimo_cache_flacs = 455400	'455300
ultimo_log = 14237429	'14237329
path_contexto = "/1"

id_forum = 38189	'38089
course_modules = 219852	'219752
course_display = 314279	'314179
block_instance = 178137	'178037
...
consulta = "  select distinct protic.initCap(facu_tdesc) as facu_tdesc, f.facu_ccod " & vbCrLf &_
		   ...
		   "  where a.ofer_ncorr=b.ofer_ncorr and b.peri_ccod in (236) " & vbCrLf &_
		   ...
		   "  and exists(select 1 from secciones aa where peri_ccod in (236) and aa.sede_ccod=b.sede_ccod " & vbCrLf &_
...
consulta_cursos =   "  select facu_ccod,sede_ccod,carr_ccod,jorn_ccod,asig_ccod,seccion,asig_tdesc + ' ('+seccion+')' as nombre_largo, " & vbCrLf &_
					...
					"  where a.peri_ccod=b.peri_ccod and cast(b.peri_ccod as varchar)='236' " & vbCrLf &_
