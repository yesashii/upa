...
ultima_categoria = 600 '514
ultimo_curso = 18685  '18675
ultima_seccion = 103081 '103031
ultimo_contexto = 315493  '315393
ultimo_cache_flacs = 100  '100
ultimo_log = 8957290 '8957190
path_contexto = "/1"

id_forum = 25150  '25130
course_modules = 128150 '128100
course_display = 210983 '210943
block_instance = 120285 '120225
...
consulta = "  select distinct protic.initCap(facu_tdesc) as facu_tdesc, f.facu_ccod " & vbCrLf &_
		   ...
		   "  where a.ofer_ncorr=b.ofer_ncorr and b.peri_ccod in (228) " & vbCrLf &_
		   ...
		   "  and exists(select 1 from secciones aa where peri_ccod in (228) and aa.sede_ccod=b.sede_ccod " & vbCrLf &_
...
consulta_cursos =   "  select facu_ccod,sede_ccod,carr_ccod,jorn_ccod,asig_ccod,seccion,asig_tdesc + ' ('+seccion+')' as nombre_largo, " & vbCrLf &_
					...
					"  where a.peri_ccod=b.peri_ccod and cast(b.peri_ccod as varchar)='228' " & vbCrLf &_
