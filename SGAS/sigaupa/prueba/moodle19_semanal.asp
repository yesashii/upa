...
ultima_categoria = 597'617	'597
ultimo_curso = 37329'36207	'36207
ultima_seccion = 190875'187206	'187106
ultimo_contexto = 559237'549119 '549019
ultimo_cache_flacs = 579071'575725	'575625
ultimo_log = 16696528'16648936 ' 16648836
path_contexto = "/1"

id_forum = 46752'45616	'45516
course_modules = 265491'263738	'263638
course_display = 359981'358552	'358452
block_instance = 222736 '514332
...
consulta = "  select distinct protic.initCap(facu_tdesc) as facu_tdesc, f.facu_ccod " & vbCrLf &_
		   ...
		   "  where a.ofer_ncorr=b.ofer_ncorr and b.peri_ccod in (240) " & vbCrLf &_
		   ...
		   "  and exists(select 1 from secciones aa where peri_ccod in (240) and aa.sede_ccod=b.sede_ccod " & vbCrLf &_
...
consulta_cursos =   "  select facu_ccod,sede_ccod,carr_ccod,jorn_ccod,asig_ccod,seccion,asig_tdesc + ' ('+seccion+')' as nombre_largo, " & vbCrLf &_
					...
					"  where a.peri_ccod=b.peri_ccod and cast(b.peri_ccod as varchar)='240' " & vbCrLf &_
