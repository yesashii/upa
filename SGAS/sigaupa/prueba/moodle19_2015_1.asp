...
ultima_categoria = 617 '614	'594
ultimo_curso = 36311 '34066	'33966
ultima_seccion = 187440 '176839	'176739
ultimo_contexto =549858 '523304	'523204
ultimo_cache_flacs = 529092	'528992
ultimo_log = 16682939 '15905609	'15905509
path_contexto = "/1"

id_forum = 45733 '43049	'42949
course_modules =  264323 '249754	'249654
course_display =  358835'339734	'339634
block_instance =  214592'202669	'202569
...
consulta = "  select distinct protic.initCap(facu_tdesc) as facu_tdesc, f.facu_ccod " & vbCrLf &_
		   ...
		   "  where a.ofer_ncorr=b.ofer_ncorr and b.peri_ccod in (238) " & vbCrLf &_
		   ...
		   "  and exists(select 1 from secciones aa where peri_ccod in (238) and aa.sede_ccod=b.sede_ccod " & vbCrLf &_
...
consulta_cursos =   "  select facu_ccod,sede_ccod,carr_ccod,jorn_ccod,asig_ccod,seccion,asig_tdesc + ' ('+seccion+')' as nombre_largo, " & vbCrLf &_
					...
					"  where a.peri_ccod=b.peri_ccod and cast(b.peri_ccod as varchar)='238' " & vbCrLf &_
