...
ultima_categoria = 610	'590
ultimo_curso = 26997	'26897
ultima_seccion = 145597	'145497
ultimo_contexto = 436247	'436147
ultimo_cache_flacs = 396679	'396579
ultimo_log = 13109292	'13109192
path_contexto = "/1"

id_forum = 35097	'34997
course_modules = 199988	'199888
course_display = 291956	'291856
block_instance = 165899	'165799
...
consulta = "  select distinct protic.initCap(facu_tdesc) as facu_tdesc, f.facu_ccod " & vbCrLf &_
		   ...
		   "  where a.ofer_ncorr=b.ofer_ncorr and b.peri_ccod in (234) " & vbCrLf &_
		   ...
		   "  and exists(select 1 from secciones aa where peri_ccod in (234) and aa.sede_ccod=b.sede_ccod " & vbCrLf &_
...
consulta_cursos =   "  select facu_ccod,sede_ccod,carr_ccod,jorn_ccod,asig_ccod,seccion,asig_tdesc + ' ('+seccion+')' as nombre_largo, " & vbCrLf &_
					...
					"  where a.peri_ccod=b.peri_ccod and cast(b.peri_ccod as varchar)='234' " & vbCrLf &_
