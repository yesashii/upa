...
if cInt(topones) > 0  or cInt(cupo_disponible) < 1 then
	...
	consulta_insercion = " insert into cargas_Academicas (matr_ncorr,secc_ccod,acse_ncorr, audi_tusuario, audi_fmodificacion)"&_
	                     " values ("&matr_ncorr&","&seccion&",2,'"&v_usuario&" (Online)',getdate())"
