...
if oferta_academica = "" or esVacio(oferta_academica) then
oferta_academica = conexion.consultaUno("select ofer_ncorr from postulantes where cast(post_ncorr as varchar)='"&session("post_ncorr_alumno")&"'")
end if

f_becas.AgregaCampoFilaPost 0, "pobe_ncorr" ,cint(pobe_ncorr)

if request.Form("pobe_nfolio") <> "" then 
