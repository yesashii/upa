                      ...
                      <table width="100%"  border="0" align="center">
						...
						<tr>
							...
							<table width="100%" border="0">
								  <tr> 
									<td width="18%" align="left"><strong>Carrera</strong> </td>
									<td width="1%"><strong>:</strong></td>
									<td width="38%" align="left"><font color="#CC0000"><%=carrera%></font></td>
									<td width="14%" align="right"><strong>Sección</strong></td>
									...
									<td width="14%" align="right"><strong>Año de Ingreso</strong></td>
									<td width="2%"><strong>:</strong></td>
						...
						<tr>  
						  <td colspan="3">
						  		<table width="100%" border="0">
									<tr>
										<td width="55%" align="left"><strong>Usted espera obtener en esta asignatura un promedio de : </strong></td>
										<td align="left"><input type="text" name="p[0][promedio_esperado]" value="<%=nota_esperada%>" size="10" maxlength="3" id="NT-N">(ejem: 5.0)</td>
									</tr>
									<tr>
										<td width="55%" align="left"><strong>Aproximadamente su porcentaje de asistencia es de : </strong></td>
									...
									<tr>
										<td colspan="2" align="center" bgcolor="#990000">
										  <font color="#FFFFFF" size="2"><strong>Para evitar problemas al momento de grabar, no olvidar que la nota esperada debe ser separada por un punto ".", y que la asistencia corresponde a un número entero SIN el símbolo "%".</strong></font>
										</td>
									</tr>
								</table>
						  </td>
