...
'ENTRADA		:NA
'SALIDA			:NA
'MODULO QUE ES UTILIZADO: CTA. CORRIENTE
'
'--ACTUALIZACION--
'
...
'consulta = "select to_number(decode(d.ting_brebaje, 'S', -a.abon_mabono, a.abon_mabono)) as abon_mabono, a.abon_fabono, b.eing_ccod, b.ingr_fpago, b.ingr_mefectivo, b.ingr_mdocto, b.ting_ccod, b.ingr_nfolio_referencia, c.ting_ccod as ting_ccod_documento, c.ding_ndocto, c.ding_mdocto, c.ding_fdocto  " & vbCrLf &_
'           "from abonos a, ingresos b, detalle_ingresos c, tipos_ingresos d, " & vbCrLf &_
'		   "     notascreditos_documentos e, ingresos f  " & vbCrLf &_
'		   "where a.ingr_ncorr = b.ingr_ncorr  " & vbCrLf &_
'		   "  and b.ingr_ncorr = c.ingr_ncorr (+) " & vbCrLf &_
'		   "  and b.ting_ccod = d.ting_ccod " & vbCrLf &_
'		   "  and b.ingr_ncorr = e.ingr_ncorr_notacredito (+) " & vbCrLf &_
'		   "  and e.ingr_ncorr_documento = f.ingr_ncorr (+) " & vbCrLf &_
'		   "  and b.eing_ccod in (1, 5) " & vbCrLf &_
'		   "  and nvl(f.eing_ccod, b.eing_ccod) in (1, 5)  " & vbCrLf &_
'		   "  and a.tcom_ccod = '" & q_tcom_ccod & "' " & vbCrLf &_
'		   "  and a.inst_ccod = '" & q_inst_ccod & "' " & vbCrLf &_
'		   "  and a.comp_ndocto = '" & q_comp_ndocto & "' " & vbCrLf &_
'		   "  and a.dcom_ncompromiso = '" & q_dcom_ncompromiso & "'"
...
'		   "  and b.ingr_ncorr = c.ingr_ncorr (+) " & vbCrLf &_
'		   "  and b.ting_ccod = d.ting_ccod " & vbCrLf &_
'		   "  and nvl(c.ding_bpacta_cuota, 'N') = 'N' " & vbCrLf &_
'		   "  and estado_origen_ingreso(a.ingr_ncorr) in (1, 5) " & vbCrLf &_
'		   "  and a.tcom_ccod = '" & q_tcom_ccod & "' " & vbCrLf &_
'		   "  and a.inst_ccod = '" & q_inst_ccod & "' " & vbCrLf &_
'		   "  and a.comp_ndocto = '" & q_comp_ndocto & "' " & vbCrLf &_
'		   "  and a.dcom_ncompromiso = '" & q_dcom_ncompromiso & "'"
...
'		   "  and b.ingr_ncorr = e.ingr_ncorr_notacredito (+) " & vbCrLf &_
'		   "  and e.ingr_ncorr_documento = f.ingr_ncorr (+)   " & vbCrLf &_
'		   "  and nvl(f.eing_ccod, b.eing_ccod) = 4  " & vbCrLf &_
'		   "  and nvl(c.ding_bpacta_cuota, 'N') = 'N' " & vbCrLf &_
'		   "  and a.tcom_ccod = '" & q_tcom_ccod & "' " & vbCrLf &_
'		   "  and a.inst_ccod = '" & q_inst_ccod & "' " & vbCrLf &_
'		   "  and a.comp_ndocto = '" & q_comp_ndocto & "' " & vbCrLf &_
...
'consulta = "select to_number(decode(d.ting_brebaje, 'S', -a.abon_mabono, a.abon_mabono)) as abon_mabono, a.abon_fabono, b.eing_ccod, b.ingr_fpago, b.ingr_mefectivo, b.ingr_mdocto, b.ting_ccod, b.ingr_nfolio_referencia, c.ting_ccod as ting_ccod_documento, c.ding_ndocto, c.ding_mdocto, c.ding_fdocto, c.edin_ccod  " & vbCrLf &_
'           "from abonos a, ingresos b, detalle_ingresos c, tipos_ingresos d  " & vbCrLf &_
'		   "where a.ingr_ncorr = b.ingr_ncorr  " & vbCrLf &_
'		   "  and b.ingr_ncorr = c.ingr_ncorr (+) " & vbCrLf &_
'		   "  and b.ting_ccod = d.ting_ccod " & vbCrLf &_
'		   "  and nvl(c.ding_bpacta_cuota, 'N') = 'N' " & vbCrLf &_
'		   "  and estado_origen_ingreso(a.ingr_ncorr) = 4 " & vbCrLf &_
'		   "  --and nvl(c.edin_ccod, 0) not in (6, 11) " & vbCrLf &_
'		   "  and a.tcom_ccod = '" & q_tcom_ccod & "' " & vbCrLf &_
'		   "  and a.inst_ccod = '" & q_inst_ccod & "' " & vbCrLf &_
'		   "  and a.comp_ndocto = '" & q_comp_ndocto & "' " & vbCrLf &_
'		   "  and a.dcom_ncompromiso = '" & q_dcom_ncompromiso & "'"
...
'			"        and a.dcom_ncompromiso = '" & q_dcom_ncompromiso & "'"
			...
			"    from abonos a " & vbCrLf &_
			"    INNER JOIN ingresos b " & vbCrLf &_
			"    ON a.ingr_ncorr = b.ingr_ncorr and protic.estado_origen_ingreso(a.ingr_ncorr) = 4 " & vbCrLf &_ 
			"    and a.tcom_ccod = '" & q_tcom_ccod & "'  " & vbCrLf &_
			"    and a.inst_ccod = '" & q_inst_ccod & "'  " & vbCrLf &_
			"    and a.comp_ndocto = '" & q_comp_ndocto & "' " & vbCrLf &_ 
			"    and a.dcom_ncompromiso = '" & q_dcom_ncompromiso & "' " & vbCrLf &_
...
'           "       decode(grouping(d.tdet_tdesc), 1, 2, 1) as orden2, " & vbCrLf &_
'		   "       decode(max(d.tdet_bdescuento), 'S', 2, 1) as orden3,	    " & vbCrLf &_
'		   "       decode(grouping(d.tdet_tdesc), 1, '<b><div align=right>TOTAL COMPROMISO</div></b>', d.tdet_tdesc) as tdet_tdesc, " & vbCrLf &_
...
'		   "  and a.comp_ndocto = '" & q_comp_ndocto & "' " & vbCrLf &_
'		   "  and a.dcom_ncompromiso = '" & q_dcom_ncompromiso & "' " & vbCrLf &_
'		   "group by rollup(d.tdet_tdesc) " & vbCrLf &_
'		   "union " & vbCrLf &_
