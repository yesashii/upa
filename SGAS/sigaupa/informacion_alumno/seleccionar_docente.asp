...
consulta2 = "  select distinct * from ( " & vbCrLf &_
		    ...
		    "  --(Select case count(*) when 0 then 'No' else 'Sí' end  from evaluacion_docente re where re.secc_ccod=a.secc_ccod and re.pers_ncorr_encuestado=e.pers_ncorr and re.pers_ncorr_destino=h.pers_ncorr) as encuestado " & vbCrLf &_
