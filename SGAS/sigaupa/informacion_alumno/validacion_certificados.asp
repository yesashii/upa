...
certificado_dae="N"
			...
			consulta_matricula = "select count(*) from alumnos a, ofertas_Academicas b where cast(a.pers_ncorr as varchar)='"&pers_ncorr&"' and a.ofer_ncorr=b.ofer_ncorr and cast(b.peri_ccod as varchar)='"&q_peri_ccod&"' and a.emat_ccod = 1 "
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  ...
							  <tr> 
								...
								<!--<td width="50%" align="center"><font size="2"><strong>ELENA ORTUZAR MU&Ntilde;OZ</strong></font></td>-->
								    <td width="56%" align="center"><font size="2"><strong>MARÍA 
                                      TERESA MERINO GAMÉ</strong></font></td>
							  </tr>
								<tr> 
								<td width="34%" align="center">&nbsp;</td>
								<td width="10%" align="center">&nbsp;</td>
								<!--<td width="50%" align="center"><font size="2"><strong>Secretaria General</strong></font></td>-->
								    <td width="56%" align="center"><font size="2"><strong>JEFE 
                                      REGISTRO CURRICULAR</strong></font></td>
							  </tr>
								<tr> 
								<td width="34%" align="center">&nbsp;</td>
								<td width="10%" align="center">&nbsp;</td>
							  ...
							  <tr> 
								<td colspan="3" align="center"><font size="-2"><strong>Santiago: </strong>Casa central: Las Condes 11.121 - Sede Baquedano: Av. Ramón Carnicer 65. <br> <strong>Melipilla : </strong>Sede Melipilla : Av. José Massoud 533. <br> <strong>Concepción: </strong>Oficina Concepción: Víctor Lamas 917, Edificio Horizonte.</font></td>
							  </tr>
							  <tr> 
								<td colspan="3" align="center">&nbsp;</td>
							  </tr>
