			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <tr><td colspan="3">
			       <%if sin_definir = false then%>
					 ...
					 <tr>
							<td><font size="2" color="#4b7fc6"><strong>1.- Seleccione los optativos deportivos que desee cursar en el semestre.</strong></font></td>
					 </tr>
					 <tr>
							<td>&nbsp;</td>
					 </tr>
                      <tr>
                        <td width="81%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr> 
								...
								<td width="87%"><% fbusqueda.dibujaCampoLista "lBusqueda", "asig_ccod"%></td>
                              </tr>
							  <tr>
							  ...
							  <tr> 
                                <td width="9%">&nbsp;</td>
								<td width="4%"><input type="hidden" name="matr_ncorr" value="<%=matr_ncorr%>">&nbsp;</td>
								<td width="87%" align="right"><%if cint(suma_creditos) < 27 then %>
								                  <a href="javascript:_Guardar(this, document.forms['edicion'], 'guardar_curso_dae.asp','', 'validar()', '', 'TRUE');" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('guardar_carga','','../imagenes/boton_guardar_activo.gif',1)"><img src="../imagenes/boton_guardar_pasivo.gif" width="119" height="31" border="0" name="guardar_carga">
												<%end if%></td>
							  </tr>
							  <tr>
            ...
            <form name="edicion2">
			  <input type="hidden" name="matr_ncorr" value="<%=matr_ncorr%>">
					<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
					  <tr>
							<td><font size="2" color="#4b7fc6"><strong>2.- Listado de cursos Artístico-Culturales, que ya pertenecen a su carga académica.</strong></font>
							</td>
					  </tr>
					  </table>
				     <table width="100%" border="0">
