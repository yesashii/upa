...
datos_extras.carga_parametros "encuesta_disenio.xml","datos_adicionales"
datos_extras.inicializar conectar
Query_datos = " select isnull(b.sexo_ccod,a.sexo_ccod) as sexo_ccod,isnull(edad,datediff(year,pers_fnacimiento,getDate())) as edad, "&_
			  " isnull(anio_ingreso,cast(protic.ano_ingreso_carrera(pers_ncorr,'16') as varchar)) as anio_ingreso, "&_
...
{ var cantidad;
  ...
  {//alert(cant_radios);
   //alert(contestada);
  if ((contestada-1)==((cant_radios - 2)/divisor))
  { 
     ...
     { document.edicion.method = "POST";
	   document.edicion.action = "encuesta_disenio_proc.asp";
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<input name="p[0][tipo]" type="hidden" value="ALUMNO">
                      ...
                      <table width="100%"  border="0" align="center">
						...
						<tr>
							...
							<table width="100%" border="0">
								  ...
								  <tr> 
									<td width="18%" align="left"><strong>Edad</strong> </td>
									<td width="1%"><strong>:</strong></td>
									<td colspan="6" align="left"><strong><font color="#000000"><%datos_extras.dibujaCampo("edad")%> Años</font></strong></td>
								  </tr>
  								  <tr> 
									<td width="18%" align="left"><strong>Año de Ingreso</strong> </td>
									<td width="1%"><strong>:</strong></td>
									<td align="left"><font color="#CC0000"><%datos_extras.dibujaCampo("anio_ingreso")%></font></td>
    							  </tr>
