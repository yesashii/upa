...
"       else cc.pers_ncorr " & vbCrLf &_
"     end as pers_ncorr " & vbCrLf &_
"   from postulantes aa LEFT OUTER JOIN grupo_familiar cc " & vbCrLf &_
"   ON aa.post_ncorr = cc.post_ncorr AND cc.pare_ccod = isnull(" & v_pare_ccod & ",cc.pare_ccod) " & vbCrLf &_
"   LEFT OUTER JOIN codeudor_postulacion bb " & vbCrLf &_
"   ON aa.post_ncorr = bb.post_ncorr " & vbCrLf &_
"   WHERE aa.post_ncorr ='" & v_post_ncorr & "') b " & vbCrLf &_
" where a.post_ncorr = b.post_ncorr " & vbCrLf &_
" and a.post_ncorr =  '" & v_post_ncorr & "' and "&filtro&""
