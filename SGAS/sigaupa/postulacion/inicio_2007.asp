...
session("periodo_postulacion") = "208"
%>
<html>
<head>
<title>Bienvenidos al proceso de admisión 2007</title>
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <object type="application/x-shockwave-flash" data="../imagenes/test.swf" width="750" height="100">
	<param name="movie" value="../imagenes/test.swf" />
	<param name="quality" value="high" />
	<img src="../images/vineta2_r1_c1_2007.gif" width="750" height="100" alt="Admisión 2007" />
    </object>
	</td>
  </tr>
  <tr>
    ...
    <td width="55%" rowspan="2" align="justify" valign="bottom" bgcolor="#FFFFFF"><img src="../imagenes/derecha_superior_2007.jpg" width="422" height="242" border="0"></td> 
  </tr>
  <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <td bgcolor="#CCCCCC" width="55%" align="center">
		<table width="98%">
			<tr>
				...
				<td width="21%"><%f_botonera.DibujaBoton("aceptar")%></td>
			</tr>
			<tr>
	...
	<tr>
		<td colspan="3" valign="top" bgcolor="003366"><img src="../imagenes/BARRA.gif" width="750" height="10" ></td>
	</tr>
  <tr>
    <td  colspan="3" valign="top" bgcolor="#FFFFFF"><div align="center" class="Estilo2"><font size="2" face="Times New Roman, Times, serif">Resolución Óptima 800x600 - Derechos Reservados Universidad del Pacífico Chile</font></div></td>
  </tr>
</table>
</td>
</tr>
