...
if v_existe=0 then
	...
	Response.Redirect("postulacion_5.asp")
end if
'########################################################################################################
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%				
				pagina.DibujarLenguetas Array("Informaci&oacute;n general", "Datos Personales", "Ant. Acad&eacute;micos", "Ant. Familiares", "Apoderado Sostenedor", "Env&iacute;o de Postulaci&oacute;n"), 6
				%></td>
          </tr>
          <tr>
