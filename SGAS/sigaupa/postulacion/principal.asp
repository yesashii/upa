...
f_botonera.Carga_Parametros "matricula-inicio.xml", "botonera_principal"
        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td bgcolor="#D8D8DE"><%pagina.DibujarLenguetas Array("Principal"), 1%></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td bgcolor="#D8D8DE">				   
					...
					<br>
				      <ul>
				        <li><a href="postulacion_1.asp">Actualizaci&oacute;n de Antecedentes
				        </a>				  
				        </li>
			          </ul>
				      <br>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="103" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><div align="center"><%f_botonera.DibujaBoton("salir")%></div></td>
                    </tr>
                  </table>                    
                  </td>
                  <td width="253" rowspan="2" background="../imagenes/abajo_r1_c4.gif"><img src="../imagenes/abajo_r1_c3.gif" width="12" height="28"></td>
