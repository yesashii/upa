...
f_botonera.Carga_Parametros "matricula-pre_registrarse.xml", "botonera"
	...
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <div align="left"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Ficha de Creaci&oacute;n de Claves </font></div></td>
                ...
                <tr>
                  ...
                  <td bgcolor="#D8D8DE">
					...
					<blockquote>
				      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td valign="top"><p><br><font size="2">Antes de continuar, debes especificar si eres chileno o extranjero.</font></p>
                              <p align="justify">
                            </p></td>
                        </tr>
                        <tr>
            ...
            Soy chileno </td>
                                <td width="2%">&nbsp;</td>
                                <td><div id="capa_rut"  style= "visibility:hidden">Ingrese su RUT :
                                        <input name="rut" type="text" id="rut" size="10" maxlength="8">
              -
              <input name="dv" type="text" id="dv" size="2" maxlength="1">
                                </div></td>
                              </tr>
                              <tr>
                                <td width="25%">
                                  <input type="radio" name="radio" value="2" onClick="javascript:habilita(this.form,2,capa_rut.style);">
            Soy extranjero</td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                              </tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="182" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                  ...
                  <td width="174" rowspan="2" background="../imagenes/abajo_r1_c4.gif"><img src="../imagenes/abajo_r1_c3.gif" width="12" height="28"></td>
