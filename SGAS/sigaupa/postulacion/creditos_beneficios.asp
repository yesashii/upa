...
consulta = ""
consulta = consulta & "select protic.obtener_nombre_completo(a.pers_ncorr, 'n') as nombre_completo, " & vbCrLf
consulta = consulta & "       protic.obtener_rut(a.pers_ncorr)                  as rut_persona, " & vbCrLf
consulta = consulta & "       protic.obtener_nombre_carrera(b.ofer_ncorr, 'CE') as nombre_carrera, " & vbCrLf
consulta = consulta & "       protic.obtener_direccion(a.pers_ncorr, 1, 'CN-C') as direccion, " & vbCrLf
consulta = consulta & "       d.cont_ncorr, " & vbCrLf
consulta = consulta & "       e.ciud_ccod, " & vbCrLf
consulta = consulta & "       a.pers_tfono " & vbCrLf
consulta = consulta & "from   personas as a " & vbCrLf
consulta = consulta & "       inner join alumnos as b " & vbCrLf
consulta = consulta & "               on a.pers_ncorr = b.pers_ncorr " & vbCrLf
consulta = consulta & "                  and b.emat_ccod = 1 " & vbCrLf
consulta = consulta & "       inner join ofertas_academicas as c " & vbCrLf
consulta = consulta & "               on b.ofer_ncorr = c.ofer_ncorr " & vbCrLf
consulta = consulta & "                  and c.peri_ccod = '" & v_peri_ccod & "' " & vbCrLf
consulta = consulta & "       inner join contratos as d " & vbCrLf
consulta = consulta & "               on b.matr_ncorr = d.matr_ncorr " & vbCrLf
consulta = consulta & "       left outer join direcciones as e " & vbCrLf
consulta = consulta & "                    on a.pers_ncorr = e.pers_ncorr " & vbCrLf
consulta = consulta & "                       and e.tdir_ccod = 1 " & vbCrLf
consulta = consulta & "where  cast(a.pers_nrut as varchar) = '" & q_pers_nrut & "' "
'---------------------------------------------------------------------------------------ACTUALIZACIÓN 17/04/2013 LUIS HERRERA
