...
consulta =	" Select a.post_ncorr, b.sede_ccod, b.sede_ccod as c_sede_ccod, b.peri_ccod, b.jorn_ccod, " & vbCrLf &_
		 	" b.jorn_ccod as c_jorn_ccod, b.espe_ccod, c.carr_ccod, c.carr_ccod as c_carr_ccod, " & vbCrLf &_
...
if b_antiguo then
	...
	f_oferta_academica.AgregaCampoParam "jorn_ccod", "permiso", "LECTURA"
	f_oferta_academica.AgregaCampoParam "c_jorn_ccod", "permiso", "LECTURA"
                    ...
                    <td><p>
                      ...
                      <table width="90%" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="185" height="25"><%f_oferta_academica.DibujaCampo("sede_ccod")%> <%f_oferta_academica.DibujaCampo("c_sede_ccod")%></td>
                        ...
                        <tr>
                          ...
                          <td><div align="left"><strong>:</strong></div></td>
                          <td height="25"><%f_oferta_academica.DibujaCampo("jorn_ccod")%>
                                <%f_oferta_academica.DibujaCampo("c_jorn_ccod")%> 
                              </td>
