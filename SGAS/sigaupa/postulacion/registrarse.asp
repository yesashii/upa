...
'--ACTUALIZACION--
'
'FECHA ACTUALIZACION 	:10/01/2013
...
'	   & " and a.pers_ncorr *= b.pers_ncorr "
 ...
 cons1 = " select  a.pers_ncorr,a.pers_nrut, a.pers_xdv, a.pers_tape_paterno, " _
	   ...
	   & " a.pers_fvencimiento_pas,tvis_ccod, a.pers_ftermino_visa,b.usua_tpregunta, " _
	   & " b.usua_trespuesta, b.usua_tusuario, b.usua_tclave " _
	   & " from personas_postulante a LEFT OUTER JOIN usuarios b " _
	   & " ON a.pers_ncorr = b.pers_ncorr " _
	   & " WHERE a.pers_ncorr = "& correlativo &" " 
...
'	   & " and a.pers_ncorr *= b.pers_ncorr "
 	...
 	cons1 = " select  a.pers_ncorr,a.pers_nrut, a.pers_xdv, a.pers_tape_paterno, " _
	   ...
	   & " a.pers_fvencimiento_pas,tvis_ccod, a.pers_ftermino_visa,b.usua_tpregunta, " _
	   & " b.usua_trespuesta, b.usua_tusuario, b.usua_tclave " _
	   & " from personas a LEFT OUTER JOIN usuarios b " _
	   & " ON a.pers_ncorr = b.pers_ncorr " _
	   & " WHERE a.pers_ncorr = "& correlativo &" " 
 end if
 'response.Write("<br>"&cons1&"<br>")
 ...
 '==========================================================
 Es_extranjero="'"&cStr(session("ses_extranjero"))&"'"
 ...
 if session("ses_extranjero") = "V" then
	...
	rut_ext    = "Este <b>RUT</b> ha sido creado por el sistema; por lo tanto, recuérdelo para seguir con su proceso de postulación. Si posee un <b>Rut nacional</b> reemplace el asignado"
    apellido_1 = "Primer Apellido"
	apellido_2 = "Segundo Apellido"
	'------------------------------cambio 09-11-2004--------------------------------------------------------
	formulario.agregaCampoParam "pers_nrut","script",""
	formulario.agregaCampoParam "pers_xdv","script",""
	'-------------------------------------------------------------------------------------------------------
 else
  ...
  if( preValidaFormulario(form)){
	    ...
	    if(password.value != form.confirma_password.value){
		   ...
		   if((password.value.length < 4) || (password.value.length > 8)){
			   ...
			   if (dato=='V'){
			   		if((form.elements("a[0][pers_nrut]").value == '') || (form.elements("a[0][pers_xdv]").value == '')){
	      				alert('Si Ud. es una persona chilena, debe ingresar su número de RUT.')
		  				form.elements("a[0][pers_nrut]").focus();
	   		        }
	   				else{
	     				if(!(valida_rut(form.elements("a[0][pers_nrut]").value + '-' + form.elements("a[0][pers_xdv]").value))){
		    				alert('ERROR.\nEl RUT que Ud. ha ingresado no es válido.Por favor, ingréselo nuevamente.');
							form.elements("a[0][pers_nrut]").focus();
							form.elements("a[0][pers_nrut]").select();
		 				}
		 		    	else{
	            	    	form.submit();
	     		            }
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="3" valign="top" bgcolor="#003366" width="750" align="center" height="100">
		<img src="../imagenes/vineta2_r1_c1_2009.jpg" width="750" height="100" alt="Admisión 2009" />
	</td>
  </tr>
                              ...
                              <tr>
                                ...
                                <td height="22" colspan="3"><table width="99%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                      ...
                                      <td> :
                                          <input type="password" name="confirma_password" id="TO-N" size="23" maxlength="8">
                                      </td>
                                    </tr>
                                    <tr>
                                      <td width="20%" height="22">&nbsp;</td>
                                      <td width="2%" height="22">&nbsp;</td>
                                      <td colspan="3" height="22">(M&iacute;nimo 4 y M&aacute;ximo 8 caracteres alfanum&eacute;ricos; sin espacios) </td>
                                    </tr>
                                </table></td>
                              </tr>
                              <tr>
