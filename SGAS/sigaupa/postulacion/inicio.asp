...
session("periodo_postulacion") = "242"
%>
<html>
<head>
<title>Bienvenidos al proceso de admisión <%=ano_muestra%></title>
...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">  
  <tr>
    ...
    <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
	  <tr>
		<td colspan="3" valign="top" width="750" height="162" align="center" background="img/postulacion-arriba.png">&nbsp;</td>
	  </tr>
	  <tr valign="top">
	  	<td colspan="3" width="750" height="353" background="img/ventana_postulacion_02010.png">&nbsp;
				<table width="750" height="353" border="0" align="center" cellpadding="0" cellspacing="0">
				 	<tr>
						<td width="100%">&nbsp;</td>
					</tr>
                    <tr>
                ...
                <td width="100%" height="20" align="center"> <span class="pie"><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF" size="1">Sede 
                  Las Condes 2 28625315 &#8226; Sede Melipilla 2 23524900 <!--&#8226; Campus 
