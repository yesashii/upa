...
'saca la sede de la primera carrera que postulo.
sede_ccod = conexion.consultauno("select top 1 b.sede_ccod from detalle_postulantes a,ofertas_academicas b where a.ofer_ncorr=b.ofer_ncorr and post_ncorr='"&v_post_ncorr&"'")
...
if  variable = "nada"  then 
	...
	sentencia_compromisos = " Insert into " & vbcrlf & _
							...
							" values(15,1,"&comp_ndocto_seq&",1,"&pers_ncorr&",getdate(),1,"&v_monto_examen&",0,0,0,0,"&v_monto_examen&",'"&negocio2.ObtenerUsuario&"',getdate(),'"&sede_ccod&"') " 
