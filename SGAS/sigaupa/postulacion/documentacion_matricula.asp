...
'----------------------------------------------------------------------------ACTUALIZACIÓN 25/04/2013 LUIS HERRERA
consulta = 	"select a.pers_ncorr, " & vbCrLf & _
			"       a.doma_ccod, " & vbCrLf & _
			"       a.doma_entregado, " & vbCrLf & _
			"       a.doma_tdesc, " & vbCrLf & _
			"       case a.doma_entregado " & vbCrLf & _
			"         when 0 then 'N' " & vbCrLf & _
			"         else 'S' " & vbCrLf & _
			"       end as bentregado " & vbCrLf & _
			"from   (select '""&v_pers_ncorr&""'     as pers_ncorr, " & vbCrLf & _
			"               a.doma_ccod, " & vbCrLf & _
			"               isnull(b.doma_ccod, 0) as doma_entregado, " & vbCrLf & _
			"               a.doma_tdesc " & vbCrLf & _
			"        from   documentos_matricula as a " & vbCrLf & _
			"               left outer join documentos_postulantes as b " & vbCrLf & _
			"                            on a.doma_ccod = b.doma_ccod " & vbCrLf & _
			"                               and cast(b.pers_ncorr as varchar) = '""&v_pers_ncorr&""') as a "
'----------------------------------------------------------------------------ACTUALIZACIÓN 25/04/2013 LUIS HERRERA
