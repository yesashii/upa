		  ...
		  <tr>
			  <td width="601" colspan="2" align="center">
				<table width="585" cellpadding="0" cellspacing="0">
					<tr valign="top">
						<td width="552" height="136" bgcolor="#4b73a6" align="right"><img width="552" height="136" src="imagenes/frame_portada_1_1.jpg">
						</td>
						<td width="33" height="135" bgcolor="#84a6d3" align="left"><img width="33" height="135" src="../informacion_alumno_2008/imagenes/frame_portada_2.jpg">
						</td>
					</tr>
					<tr valign="top">
										...
										<td width="100%" align="center">
											<table width="100%" border="0" cellpadding="0" cellspacing="0">
											  ...
											  <tr> 
												...
												<td width="29%" height="10" align="left"><div align="right">&nbsp;</td>
											  ...
											  <tr>
												...
												<center>
													<p>Sistema desarrollado para Internet Explorer 6.0 y versiones superiores
														<br/>Resolución óptima: 1280 x 1024 pixeles
													</p>
												</center>
												</td>
											</tr>
