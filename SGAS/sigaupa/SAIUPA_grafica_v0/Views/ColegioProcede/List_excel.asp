      <%
	    Response.AddHeader "Content-Disposition", "attachment;filename=total_colegio_procedencia.xls"
      ...
      <html>
      <head>
      <title>Indicador de colegios de procedencia</title>
      ...
      <table width="100%">
       	<tr>
                      ...
                      <th align="center" bgcolor="#99CC00">Procedencia</th>
        ...
        <tr>
                      ...
                      <td align="left"><%=Html.Encode(obj.procedencia) %></td>
					  <%if chequeo_2005 <> "" then%>
       ...
       <tr>
                      ...
                      <th align="center" bgcolor="#CC9900">Procedencia</th>
                      <%if chequeo_2005 <> "" then%>
        ...
        <tr>
					  ...
					  <td align="left"><%=Html.Encode(obj2.procedencia) %></td>                      
                      <%if chequeo_2005 <> "" then%>
        ...
        <tr>
         ...
         <tr>  
                      ...
                      <th align="center" bgcolor="#3399CC">Procedencia</th>
                      <%if chequeo_2005 <> "" then%>
         ...
         <tr>
                      ...
                      <td align="left"><%=Html.Encode(obj3.procedencia) %></td>
                      <%if chequeo_2005 <> "" then%>
         ...
         <tr>
                      ...
                      <th align="center" bgcolor="#CC6600">Procedencia</th>
                      <%if chequeo_2005 <> "" then%>
           ...
           <tr>
                      ...
                      <td align="left"><%=Html.Encode(obj4.procedencia) %></td>
                      <%if chequeo_2005 <> "" then%>
