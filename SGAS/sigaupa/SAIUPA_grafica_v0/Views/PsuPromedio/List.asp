     ...
     <div id="cuadro0">
     <br />
	<h1>Puntaje PSU promedio lenguaje y matemática</h1>
	<p><i>"Puntaje PSU promedio obtenido en las pruebas de lenguaje y matemática por los alumnos en el año anterior al proceso de matrícula".</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="9" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","PsuPromedio","List_excel", "partial=excel"&complemento_url)%>
                        </td>	
                    </tr>
