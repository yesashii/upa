      ...
      <script type="text/javascript">
          ...
          var Controller ='CostoTitulacion';
          var Action = 'List';
      </script>
      <%
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Periodo','Sede','Costo titulación UF']
	  ...
	  var data_Facultad = google.visualization.arrayToDataTable([
          ['Periodo','Facultad','Costo titulación UF']
		       <%Dim obj_f
			      cadena = ""
				  facu_seleccionada = ""
	  ...
	  var data_Jornada = google.visualization.arrayToDataTable([
          ['Periodo','Jornada','Costo titulación UF']
		       <%Dim obj_j
			      cadena = ""
				  jorn_seleccionada = ""
	  ...
	  var data_Carrera = google.visualization.arrayToDataTable([
          ['Periodo','Carrera','Costo titulación UF']
		       <%Dim obj_c
			      cadena = ""
				  carr_seleccionada = ""
     ...
     <div id="cuadro0">
     <br />
     <h1>Costo proceso de titulación (UF)</h1>
     <p><i>"Valor en unidad de fomento del proceso de titulación de la carrera para este período".</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="9" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","CostoTitulacion","List_excel", "partial=excel"&complemento_url)%>
                        </td>	
                    </tr>
