...
<%
                    Dim objt
                    For each objt in ModelTotalSede.Items
					%>
                    <tr align="right">
                      <th><b><div align="left"><%=Html.Encode(objt.cabecera) %></div></b></th>
                      <%if chequeo_2005 <> "" then%>
                      <th><%=Html.Encode(objt.a2005) %></th>
                      <%end if%>
                      <%if chequeo_2006 <> "" then%>
                      <th><%=Html.Encode(objt.a2006) %></th>
                      <%end if%>
                      <%if chequeo_2007 <> "" then%>
                      <th><%=Html.Encode(objt.a2007) %></th>
                      <%end if%>
                      <%if chequeo_2008 <> "" then%>
                      <th><%=Html.Encode(objt.a2008) %></th>
                      <%end if%>
                      <%if chequeo_2009 <> "" then%>
                      <th><%=Html.Encode(objt.a2009) %></th>
                      <%end if%>
                      <%if chequeo_2010 <> "" then%>
                      <th><%=Html.Encode(objt.a2010) %></th>
                      <%end if%>
                      <%if chequeo_2011 <> "" then%>
                      <th><%=Html.Encode(objt.a2011) %></th>
                      <%end if%>
                      <%if chequeo_2012 <> "" then%>
                      <th><%=Html.Encode(objt.a2012) %></th>
                      <%end if%>
                      <%if chequeo_2013 <> "" then%>
                      <th><%=Html.Encode(objt.a2013) %></th>
                      <%end if%>
                    </tr>
                    <%
					Next
