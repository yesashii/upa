      <%
	    Response.AddHeader "Content-Disposition", "attachment;filename=Porcentaje_titulacion_cohortes.xls"
        Response.ContentType = "application/vnd.ms-excel"
	  %>
      <script type="text/javascript">
          //two variables Controller and Action have to be initialized in the View HTML code
          var Controller ='PorcentajeTitulacionCohorte';
      ...
      <html>
      <head>
      <title>Indicador de Porcnetaje titulaci&oacute;n de cohortes</title>
      ...
      <table width="100%">
       	<tr>
                      ...
                      <th align="center" bgcolor="#99CC00">Titulados Cohorte</th>
       ...
       <tr>
                      ...
                      <th align="center" bgcolor="#CC9900">Titulados cohorte</th>
                      <%if maximo_anio + 1 <=  v_anio_actual then%>
        ...
        <tr>
         ...
         <tr>  
                      ...
                      <th align="center" bgcolor="#3399CC">Titulados cohorte</th>
                      <%if maximo_anio + 1 <=  v_anio_actual then%>
         ...
         <tr>
                      ...
                      <th align="center" bgcolor="#CC6600">Titulados cohorte</th>
                      <%if maximo_anio + 1 <=  v_anio_actual then%>
