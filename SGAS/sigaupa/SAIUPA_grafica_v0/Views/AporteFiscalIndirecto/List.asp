      ...
      <script type="text/javascript">
          ...
          var Controller ='AporteFiscalIndirecto';
          var Action = 'List';
      </script>
      <%
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Periodo','Sede','Matriculados con AFI']
	  ...
	  var data_Facultad = google.visualization.arrayToDataTable([
          ['Periodo','Facultad','Matriculados con AFI']
		       <%Dim obj_f
			      cadena = ""
				  facu_seleccionada = ""
	  ...
	  var data_Jornada = google.visualization.arrayToDataTable([
          ['Periodo','Jornada','Matriculados con AFI']
		       <%Dim obj_j
			      cadena = ""
				  jorn_seleccionada = ""
	  ...
	  var data_Carrera = google.visualization.arrayToDataTable([
          ['Periodo','Carrera','Matriculados con AFI']
		       <%Dim obj_c
			      cadena = ""
				  carr_seleccionada = ""
     ...
     <div id="cuadro0">
     <br />
     <h1>N° de alumnos con aporte fiscal indirecto</h1>
     <p><i>"Cantidad de alumnos matriculados en la carrera, que obtuvieron un puntaje PSU igual o superior al establecido por el Ministerio de Educación, obteniendo el Aporte Fiscal Indirecto".</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="9" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","AporteFiscalIndirecto","List_excel", "partial=excel"&complemento_url)%>
                        </td>	
                    </tr>
