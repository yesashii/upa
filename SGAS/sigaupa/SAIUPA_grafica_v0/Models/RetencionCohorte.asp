...
class RetencionCohorteHelper
      ...
      private sub Class_Initialize()
          selectSQL = " select [tr].a_anos, [tr].Cabecera,100.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_1,  " + _
 	   ...
 	   sqlTotalSede = " select [tr].a_anos, 'Totales' as Cabecera,100.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_1,  " + _
		              " cast(([tr].a_anos_2 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_2, cast(([tr].a_anos_3 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_3, " + _
					  "	cast(([tr].a_anos_4 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_4, cast(([tr].a_anos_5 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_5, " + _
					  "	cast(([tr].a_anos_6 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_6, cast(([tr].a_anos_7 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_7,  " + _
		              " cast(([tr].a_anos_8 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_8, cast(([tr].a_anos_9 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_9,  " + _
  ...
  selectSQLFacultad = " select [tr].a_anos, [tr].Cabecera,100.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_1,  " + _
		              " cast(([tr].a_anos_2 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_2, cast(([tr].a_anos_3 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_3, " + _
					  "	cast(([tr].a_anos_4 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_4, cast(([tr].a_anos_5 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_5, " + _
					  "	cast(([tr].a_anos_6 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_6, cast(([tr].a_anos_7 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_7,  " + _
		              " cast(([tr].a_anos_8 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_8, cast(([tr].a_anos_9 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_9,  " + _
   ...
   selectSQLJornada = " select [tr].a_anos, [tr].Cabecera,100.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_1,  " + _
		              " cast(([tr].a_anos_2 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_2, cast(([tr].a_anos_3 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_3, " + _
					  "	cast(([tr].a_anos_4 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_4, cast(([tr].a_anos_5 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_5, " + _
					  "	cast(([tr].a_anos_6 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_6, cast(([tr].a_anos_7 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_7,  " + _
		              " cast(([tr].a_anos_8 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_8, cast(([tr].a_anos_9 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_9,  " + _
   ...
   selectSQLCarrera = " select [tr].a_anos, [tr].Cabecera,100.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_1,  " + _
		              " cast(([tr].a_anos_2 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_2, cast(([tr].a_anos_3 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_3, " + _
					  "	cast(([tr].a_anos_4 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_4, cast(([tr].a_anos_5 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_5, " + _
					  "	cast(([tr].a_anos_6 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_6, cast(([tr].a_anos_7 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_7,  " + _
		              " cast(([tr].a_anos_8 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_8, cast(([tr].a_anos_9 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_9,  " + _
					  ...
					  "     sum(desc_anos_6) as a_anos_6,sum(desc_anos_7) as a_anos_7,sum(desc_anos_8) as a_anos_8,sum(desc_anos_9) as a_anos_9,sum(desc_anos_10) as a_anos_10, " + _
					  "     sum(desc_anos_11) as a_anos_11,sum(desc_anos_12) as a_anos_12, sum(desc_anos_13) as a_anos_13 " + _
					  "		from ANI_MATR_COHORTE_CARRERA  " + _
