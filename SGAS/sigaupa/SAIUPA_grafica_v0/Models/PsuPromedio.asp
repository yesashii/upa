      ...
      '
      ' This files defines the PsuPromedio model
      '
class PsuPromedio
      ...
      end class 'PsuPromedio


      '======================
class PsuPromedioHelper
	  ...
	  if session("_pers_ncorr_") = "0" then
          ...
          selectSQL = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013  " + _
					  ...
					  "			   isnull(cast([2005] as numeric(4,0)),0) as a2005,isnull(cast([2006] as numeric(4,0)),0) as a2006,isnull(cast([2007] as numeric(4,0)),0) as a2007, " + _
					  "			   isnull(cast([2008] as numeric(4,0)),0) as a2008,isnull(cast([2009] as numeric(4,0)),0) as a2009,isnull(cast([2010] as numeric(4,0)),0) as a2010, " + _
					  "			   isnull(cast([2011] as numeric(4,0)),0) as a2011,isnull(cast([2012] as numeric(4,0)),0) as a2012,isnull(cast([2013] as numeric(4,0)),0) as a2013   " + _
					  "		from    " + _
					  "		 (    " + _
      ...
      ' Select all PsuPromedio into a Dictionary
      ' return a Dictionary of PsuPromedio objects - if successful, Nothing otherwise
