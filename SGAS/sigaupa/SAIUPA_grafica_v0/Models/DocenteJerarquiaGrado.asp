...
class DocenteJerarquiaGradoHelper
	  ...
	  if session("_pers_ncorr_") = "0" then
          ...
          selectSQL = " select [tr].Cabecera,[tr].Grado,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
					  "	From "     + _
					  "	(     "    + _
					  "		select asg_jerarquia as Cabecera,asg_grado as Grado,[2009] as a2009,[2010] as a2010,[2011] as a2011,[2012] as a2012,[2013] as a2013  " + _
					  "		from   " + _
					  "		 (   "   + _
  	       ...
  	       sqlTotal = " select 'TOTALES' as Cabecera,'N/A' as Grado, [tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
					  "	From "     + _
					  "	(     "    + _
     ...
     selectSQLHoras = " select [tr].Cabecera,[tr].Grado,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
					  "	From  "    + _
					  "	(     "    + _
					  "		select asg_jerarquia as Cabecera,asg_grado as Grado,[2009] as a2009,[2010] as a2010,[2011] as a2011,[2012] as a2012,[2013] as a2013 "    + _
					  "		from "    + _
	  ...
	  sqlTotalHoras = " select 'TOTALES' as Cabecera,'N/A' as Grado,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
					  "	From  "    + _
					  "	(     "    + _
					  "		select [2009] as a2009,[2010] as a2010,[2011] as a2011,[2012] as a2012,[2013] as a2013 "    + _
					  "		from "    + _
