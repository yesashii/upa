      ...
      '
      ' This files defines the MatriculaCredito model
      '
class MatriculaCredito
      ...
      end class 'MatriculaCredito


      '======================
class MatriculaCreditoHelper
	  ...
	  if session("_pers_ncorr_") = "0" then
          ...
          selectSQL = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
					  "	From "     + _
					  "	(     "    + _
					  "		select sede_tdesc as Cabecera,[2005] as a2005,[2006] as a2006,[2007] as a2007,[2008] as a2008,[2009] as a2009,[2010] as a2010,[2011] as a2011,[2012] as a2012,[2013] as a2013  " + _
					  "		from   " + _
					  "		 (   "   + _
					  "			select anos_ccod,sede_tdesc,mat_rut from [ASG_CREDITO_NUEVOS_SEDE]   " + _
					  "		 )p   "    + _
					  "		 PIVOT   " + _
					  "		 (   "     + _
					  "		  COUNT(mat_rut)  " + _
 	   ...
 	   sqlTotalSede = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
					  ...
					  "		from   " + _
					  "		 (   "   + _
					  "			select anos_ccod,mat_rut from [ASG_CREDITO_NUEVOS_SEDE]   " + _
					  "		 )p   "    + _
					  "		 PIVOT   " + _
					  "		 (   "     + _
					  "		  COUNT(mat_rut)  " + _
		  ...
		  selectSQLFacultad = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  "	From  "    + _
							  "	(     "    + _
							  "		select facu_tdesc as Cabecera,[2005] as a2005,[2006] as a2006,[2007] as a2007,[2008] as a2008,[2009] as a2009,[2010] as a2010,[2011] as a2011,[2012] as a2012,[2013] as a2013 "    + _
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,facu_tdesc,mat_rut from  [ASG_CREDITO_NUEVOS_FACULTAD] "    + _
							  "		)p "    + _
							  "		PIVOT "    + _
							  "		 ( "    + _
							  "		  COUNT(mat_rut) "    + _
		   ...
		   sqlTotalFacultad = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod, mat_rut from  [ASG_CREDITO_NUEVOS_FACULTAD] "    + _
							  "		)p "    + _
							  "		PIVOT "    + _
							  "		 ( "    + _
							  "		  COUNT(mat_rut) "    + _
		   ...
		   selectSQLJornada = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  "	From  "    + _
							  "	(     "    + _
							  "		select jorn_tdesc as Cabecera,[2005] as a2005,[2006] as a2006,[2007] as a2007,[2008] as a2008,[2009] as a2009,[2010] as a2010,[2011] as a2011,[2012] as a2012,[2013] as a2013 "    + _
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,jorn_tdesc,mat_rut from  [ASG_CREDITO_NUEVOS_JORNADA] "    + _
							  "		 )p "    + _
							  "		 PIVOT "    + _
							  "		 ( "    + _
							  "		  COUNT(mat_rut) "    + _
		   ...
		   sqlTotalJornada = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod, mat_rut from  [ASG_CREDITO_NUEVOS_JORNADA] "    + _
							  "		 )p "    + _
							  "		 PIVOT "    + _
							  "		 ( "    + _
							  "		  COUNT(mat_rut) "    + _
		   ...
		   selectSQLCarrera = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "     mat_rut from [ASG_CREDITO_NUEVOS_CARRERA] "+ filtroCarrera  + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     COUNT(mat_rut) "    + _
		   ...
		   sqlTotalCarrera = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "	from "    + _
							  "	( "    + _
							  "		select anos_ccod, mat_rut from [ASG_CREDITO_NUEVOS_CARRERA] "+ filtroCarrera  + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     COUNT(mat_rut) "    + _
      ...
      ' Select all MatriculaCredito into a Dictionary
      ' return a Dictionary of MatriculaCredito objects - if successful, Nothing otherwise
...
end class 'MatriculaCreditoHelper
%>
