      ...
      '
      ' This files defines the PsuDesviacion model
      '
class PsuDesviacion
      ...
      end class 'PsuDesviacion


      '======================
class PsuDesviacionHelper
	  ...
	  if session("_pers_ncorr_") = "0" then
          ...
          selectSQL = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013  " + _
					  ...
					  "		from    " + _
					  "		 (    " + _
					  "			select anos_ccod,sede_tdesc,ASG_PSU from [ASG_PSU_NUEVOS_SEDE] where ASG_PSU > 0   " + _
					  "		 )p    " + _
					  "		 PIVOT    " + _
					  "		 (    " + _
					  "		  STDEVP(ASG_PSU) " + _
       ...
       sqlTotalSede = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013  " + _
					 ...
					 "			   isnull(cast([2005] as numeric(5,2)),0) as a2005,isnull(cast([2006] as numeric(5,2)),0) as a2006,isnull(cast([2007] as numeric(5,2)),0) as a2007, " + _
					  ...
					  "		from    " + _
					  "		 (    " + _
					  "			select anos_ccod,ASG_PSU from [ASG_PSU_NUEVOS_SEDE] where ASG_PSU > 0   " + _
					  "		 )p    " + _
					  "		 PIVOT    " + _
					  "		 (    " + _
					  "		  STDEVP(ASG_PSU) " + _
		  ...
		  selectSQLFacultad = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,facu_tdesc,ASG_PSU from  [ASG_PSU_NUEVOS_FACULTAD] where ASG_PSU > 0 "    + _
							  "		)p "    + _
							  "		PIVOT "    + _
							  "		 ( "    + _
							  "		  STDEVP(ASG_PSU) "    + _
		   ...
		   sqlTotalFacultad = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,ASG_PSU from  [ASG_PSU_NUEVOS_FACULTAD] where ASG_PSU > 0 "    + _
							  "		)p "    + _
							  "		PIVOT "    + _
							  "		 ( "    + _
							  "		  STDEVP(ASG_PSU) "    + _
		   ...
		   selectSQLJornada = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,jorn_tdesc,ASG_PSU from  [ASG_PSU_NUEVOS_JORNADA] where ASG_PSU > 0 "    + _
							  "		 )p "    + _
							  "		 PIVOT "    + _
							  "		 ( "    + _
							  "		  STDEVP(ASG_PSU) "    + _
		   ...
		   sqlTotalJornada  = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,ASG_PSU from  [ASG_PSU_NUEVOS_JORNADA] where ASG_PSU > 0 "    + _
							  "		 )p "    + _
							  "		 PIVOT "    + _
							  "		 ( "    + _
							  "		  STDEVP(ASG_PSU) "    + _
		   ...
		   selectSQLCarrera = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "     ASG_PSU from [ASG_PSU_NUEVOS_CARRERA] where ASG_PSU > 0 " + filtroCarrera     + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     STDEVP(ASG_PSU) "    + _
		   ...
		   sqlTotalCarrera  = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "	from "    + _
							  "	( "    + _
							  "		select anos_ccod,ASG_PSU from [ASG_PSU_NUEVOS_CARRERA] where ASG_PSU > 0 " + filtroCarrera     + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     STDEVP(ASG_PSU) "    + _
      ...
      ' Select all PsuDesviacion into a Dictionary
      ' return a Dictionary of PsuDesviacion objects - if successful, Nothing otherwise
