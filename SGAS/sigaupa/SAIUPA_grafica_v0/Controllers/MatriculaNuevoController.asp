      <%
      class MatriculaNuevoController
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new MatriculaNuevoHelper
            ...
            %>   <!--#include file="../views/MatriculaNuevo/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/MatriculaNuevo/List_excel.asp" --> <%
        End Sub
