      <%
      class DocenteJornadaController
      Dim Model
	  Dim ModelTotal
	  Dim ModelHoras
	  Dim ModelTotalHoras
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new DocenteJornadaHelper
            ...
            %>   <!--#include file="../views/DocenteJornada/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/DocenteJornada/List_excel.asp" --> <%
        End Sub
