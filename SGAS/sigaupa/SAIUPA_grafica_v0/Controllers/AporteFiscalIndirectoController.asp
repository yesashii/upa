      <%
      class AporteFiscalIndirectoController
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new AporteFiscalIndirectoHelper
            ...
            %>   <!--#include file="../views/AporteFiscalIndirecto/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/AporteFiscalIndirecto/List_excel.asp" --> <%
        End Sub
