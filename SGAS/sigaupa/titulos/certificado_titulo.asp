...
SQL = "  select top 1 a.asca_ncorr, a.pers_ncorr, protic.obtener_rut(a.pers_ncorr) as rut, protic.obtener_nombre_completo(a.pers_ncorr, 'N') as nombre, "& vbCrLf &_
      ...
      "  cast(a.asca_nfolio as varchar) as folio_reg, linea_1_certificado as titulo_grado,CASE WHEN linea_2_certificado IS NULL THEN '*                             *                                   *' ELSE linea_2_certificado END as mencion,linea_3_certificado as mencion2,  "& vbCrLf &_
      "  '' + "& vbCrLf &_
