...
pagina.Titulo = "Datos complementarios a proceso de titulación"
'---------------------------------------------------------------------------------------------------
...
f_busqueda.Carga_Parametros "datos_titulados.xml", "busqueda_usuarios"
...
botonera.Carga_Parametros "datos_titulados.xml", "botonera"
'--------------------------------------------------------------------------
...
c_plan_ccod = "select top 1 plan_ccod from alumnos a, ofertas_academicas b where a.ofer_ncorr=b.ofer_ncorr and cast(a.pers_ncorr as varchar)='"&codigo&"' order by b.peri_ccod desc, a.alum_fmatricula desc"
