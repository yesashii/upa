...
if not esvacio(pers_ncorr) then
    es_moroso = conexion.consultaUno("select protic.es_moroso('"&q_pers_ncorr&"', getDate())")
	if es_moroso="N" then
		moroso = "No"
	else
		moroso = "Sí"		
                  ...
                  <tr>
                    <td>
                      ...
                      <table width="98%"  border="0" align="center">
						...
						<tr>
                          <td><div align="left"><strong>Moroso: </strong><%=moroso%></div></td>
                        </tr>
                      </table>
					</td>
                  </tr>
            ...
            <td width="16%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><div align="center"><%if mensaje_faltante = "" and moroso <> "Sí" then
				                               f_botonera.DibujaBoton "imprimir_titulado"
											 end if%></div></td>
                  <td><div align="center"><%if moroso <> "Sí" then
