...
'LINEA			:97,99,102,104,106,109,111,113,116,118,122,124,126,130,132,135,137,140,142,147,149,152,154,156,158
'********************************************************************
...
'Se retira esta opción para evitar lentitud en carga de página, si desea ver asignaturas faltantes puede hacerlo de la pantalla principal
'c_asignaturas_faltantes = " select count(*) from asignaturas_salidas_carrera a, malla_curricular b "& vbCrLf &_
'						  " where a.mall_ccod=b.mall_ccod and cast(a.saca_ncorr as varchar)='"&q_saca_ncorr&"' "& vbCrLf &_
'						  " and protic.es_ramo_aprobado_version_nueva('"&q_pers_ncorr&"',b.asig_ccod,'"&carr_ccod&"',"&plan_ccod&") = 0" 
'response.Write("<pre>"&c_asignaturas_faltantes&"</pre>")
'response.Write("1")

'asignaturas_faltantes =  conexion.consultaUno(c_asignaturas_faltantes)
'response.End()						  
...
'response.Write(mensaje_as_faltantes)
f_salida.primero
...
'response.End()
	...
	licenciaturas.carga_parametros	"adm_salidas_alumnos.xml","licenciaturas"
...
'---------------------------------------------------------------------------------------------------
url_leng_1 = "adm_salidas_alumnos_agregar.asp?saca_ncorr=" & q_saca_ncorr & "&pers_ncorr=" & q_pers_ncorr
url_leng_2 = "adm_salidas_alumnos_agregar_dp.asp?saca_ncorr=" & q_saca_ncorr & "&pers_ncorr=" & q_pers_ncorr
url_leng_3 = "adm_salidas_alumnos_agregar_de.asp?saca_ncorr=" & q_saca_ncorr & "&pers_ncorr=" & q_pers_ncorr
url_leng_4 = "adm_salidas_alumnos_agregar_dt.asp?saca_ncorr=" & q_saca_ncorr & "&pers_ncorr=" & q_pers_ncorr
url_leng_5 = "adm_salidas_alumnos_agregar_cn.asp?saca_ncorr=" & q_saca_ncorr & "&pers_ncorr=" & q_pers_ncorr
'---------------------------------------------------------------------------------------------------
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td><%pagina.DibujarLenguetasFClaro Array(Array(str_accion, url_leng_1), Array("Datos Personales", url_leng_2), Array("Información Egreso", url_leng_3), Array("Información Titulación", url_leng_4), Array("Conc. Notas", url_leng_5)), 1%></td>
          </tr>
          <tr>
          ...
          <tr>
            <td width="38%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center"><% 'if mensaje_bloqueo <> "" then
