...
f_botonera_etiqueta.Carga_Parametros "expediente_titulacion.xml", "botonera_etiqueta"
...
f_practica.Carga_Parametros "expediente_titulacion.xml", "detalle_datos_practica_tg"
...
f_etiqueta.Carga_Parametros "expediente_titulacion.xml", "impresion_etiqueta"
...
de_tiulos = conexion.consultaUno("select count(*) from sis_roles_usuarios where cast(pers_ncorr as varchar)='"&q_pers_ncorr&"' and srol_ncorr in (49,95)")
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
                <td> <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr> 
                      <td>
                        <%pagina.DibujarSubtitulo "Antecedentes de egreso."%>
                        <form name="practica">
                          ...
                          <table width="100%"  border="0" align="center">
                            <tr> 
                              <td align="center"> <table border="0" width="98%">
								  ...
								  <tr> 
                                    <td width="14%" align="left"><strong>Fecha de Egreso</strong></td>
                                    <td width="1%" align="left"><strong>:</strong></td>
                                    <td width="35%" align="left">
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				  <td><div align="center"><%if permiso_escuela = "0" then
				                                f_botonera.AgregaBotonParam "guardar_egreso" , "deshabilitado" , "true"
											end if
				                            f_botonera.DibujaBoton "guardar_egreso"%></div></td>
