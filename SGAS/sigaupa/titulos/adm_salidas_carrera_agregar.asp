...
pagina.Titulo = "Agregar salida carrera"
...
SQL = " select a.saca_ncorr, a.saca_tdesc, a.plan_ccod, a.tsca_ccod, a.saca_npond_asignaturas, linea_1_certificado, linea_2_certificado, linea_3_certificado "
SQL = SQL &  " from salidas_carrera a"
SQL = SQL &  " where cast(a.saca_ncorr as varchar)= '" & q_saca_ncorr & "'"
'response.write SQL
...
'-------------------------------------------------------------------
if EsVacio(q_saca_ncorr) then
	str_accion = "Agregar"
	
	SQL = " select distinct a.tsca_ccod"
	SQL = SQL &  " from salidas_carrera a"
	SQL = SQL &  " where a.tsca_ccod in (1)"
	SQL = SQL &  "   and cast(a.plan_ccod as varchar)= '" & q_plan_ccod & "'"
	
	'f_salida.AgregaCampoParam "tsca_ccod", "filtro", "tsca_ccod not in (" & SQL & ")"
	
else
	str_accion = "Editar"
	f_salida.AgregaCampoParam "tsca_ccod", "permiso", "LECTURA"
end if
%>
            ...
            <td><br>
              ...
              <form name="edicion">
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><%pagina.DibujarSubtitulo "Creación/Edición de Salidas Carrera"%>
                      <br>
                      <table width="98%"  border="0" align="center">
                        <tr>
                        ...
                        <tr>
                          <td bgcolor="#CC6600" align="center">
                          	<font color="#FFFFFF">
							  <strong>Utilice el campo Mención cuando el título sea demasiado extenso, de igual modo puede registrar una o dos menciones para el certificado, no olvide comenzar en estos casos con la palabra "Mención".</strong>	                            
                             </font>
                          </td>
                        </tr>
                      </table></td>
