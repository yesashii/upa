...
consulta_plan =  " select nive_ccod, ltrim(rtrim(b.asig_ccod))+' -- '+ b.asig_tdesc as asignatura, "& vbCrLf &_
				 ...
				 " from malla_curricular a, asignaturas b,asignaturas_salidas_carrera c "& vbCrLf &_
				 " where a.asig_ccod=b.asig_ccod and a.mall_ccod=c.mall_ccod"& vbCrLf &_
				 " and cast(c.saca_ncorr as varchar)='"&saca_ncorr&"' and isnull(mall_npermiso,0) <> 1 "& vbCrLf &_
				 " order by nive_ccod "
...
lenguetas_detalle = Array(Array("Solicitud de egreso", "predictivo_tit_grados_especiales.asp?pers_ncorr=" & pers_ncorr&"&carr_ccod="& carr_ccod & "&plan_ccod="&plan_ccod),Array("Avance Curricular", "alumnos_x_anio_galeria_detalle.asp?pers_ncorr="&pers_ncorr&"&carr_ccod="&carr_ccod&"&anos_ccod="&anos_ccod))
