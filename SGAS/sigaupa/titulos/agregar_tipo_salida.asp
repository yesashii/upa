...
pagina.Titulo = "Mantenedor De Tipos Salidas "
set botonera =  new CFormulario
botonera.carga_parametros "adm_tipos_Salidas.xml", "btn_agregar_salida"
...
consulta=" select tsca_ccod,tsca_tdesc "&_
		 " from tipos_salidas_carrera where cast(tsca_ccod as varchar) = '"&tsca_ccod&"'"

set formulario 		= 		new cFormulario
formulario.carga_parametros	"adm_tipos_salidas.xml",	"tabla_valores"
...
function agregar(formulario){
	formulario.action = 'proc_agregar_tipo_salida.asp';
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas Array("Mantenedor De Tipos de salida"), 1 %></td>
          </tr>
          <tr>
            ...
            <td>
               <form name="editar" method="post">
                <table width="90%" border="0" align="center">
                  <tr>
                    <td>Nombre Salida</td>
                    <td>:<%formulario.dibujacampo("tsca_tdesc")%></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
				...
				<input type="hidden" name="em[0][tsca_ccod]" value="<%=tsca_ccod%>">
