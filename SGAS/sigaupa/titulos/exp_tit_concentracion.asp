...
pagina.Titulo = "Resumen de notas para concentración"
'---------------------------------------------------------------------------------------------------
...
f_param_impresion.Carga_Parametros "expediente_titulacion.xml", "param_impresion"
...
f_param_impresion.AgregaCampoCons "plan_ccod", cint(plan_consulta)
...
function guarda_notas()
{
   ...
   if (valor != "")
   		{   
			window.open('exp_tit_guardar_certificado_proc.asp?carr_ccod=<%=codigo_carrera%>&tipo=1&pers_nrut=<%=q_pers_nrut%>&tdes_ccod='+ valor,'guardar','width=700px, height=550px, scrollbars=yes, resizable=yes')
		}
   else
   	    { 
                          ...
                          <td align="center">
								...
								<tr>
								    <td colspan="7" align="right"><%if permiso_escuela = "0" then
																		f_botonera.AgregaBotonParam "guardar_concentracion" , "deshabilitado" , "true"
																	end if
									                                f_botonera.DibujaBoton "guardar_concentracion"%></td>
    							</tr>
								</table>
						  </td>
                        </tr>
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><div align="center"><%if mensaje_faltante = "" then
				                               if es_moroso = "S" or permiso_escuela = "0" then
                  ...
                  <td><div align="center"><%if permiso_escuela = "0" then
				                            ...
				                            f_botonera.DibujaBoton "guardar_notas"%></div></td>
