...
'LINEA			:112,114,117,119,121,124,126,128,131,133,137,139,141,145,147,150,152,155,157,162,164,167,169,171,173
'********************************************************************
...
ip_de_prueba = "172.16.100.212"
'----------------------------------

if ip_usuario = ip_de_prueba then
'response.Write("saca_ncorr = "&saca_ncorr&"</br>") 
'response.Write("pers_ncorr = "&pers_ncorr&"</br>") 
'response.Write("session = "&session("msjOk")&"</br>") 
end if
...
'---------------------------------------------------------------------------------------------------
'---------- Se rescatan datos de la carrera ----------
...
'response.Write("session = "&session("msjOk")&"</br>") 
'response.Write("SQL = "&SQL&"</br>") 
response.Write("plan_ccod = "&plan_ccod&"</br>")
response.Write("egresado = "&egresado&"</br>") 
response.Write("titulado = "&titulado&"</br>") 
response.Write("carr_ccod = "&carr_ccod&"</br>") 
response.Write("tsca_ccod = "&tsca_ccod&"</br>") 
response.Write("asca_ncorr = "&asca_ncorr&"</br>") 
response.Write("asca_nregistro = "&asca_nregistro&"</br>") 
response.Write("asca_nfolio = "&asca_nfolio&"</br>") 
response.Write("folio = "&folio&"</br>") 
response.Write("ultimo_periodo = "&ultimo_periodo&"</br>") 
response.Write("carr_ccod_informar = "&carr_ccod_informar&"</br>") 
end if
...
set f_botonera_etiqueta = new CFormulario
f_botonera_etiqueta.Carga_Parametros "adm_salidas_alumnos.xml", "botonera_etiqueta"
...
if tiene_grabado = "S" then
	 consulta = " select pers_ncorr,plan_ccod,nombre_empresa,ubicacion_empresa,telefono_empresa,email_empresa,nombre_encargado,asca_nregistro,asca_nfolio,protic.trunc(fecha_proceso) as fecha_proceso, "& vbCrLf &_
				...
				" where tt.asig_ccod=t2.asig_ccod and tt.plan_ccod = a.plan_ccod and t2.asig_tdesc like '%PR%CTICA PROFESIONAL') ) as horas_practica, "& vbCrLf &_
				...
				" isnull((Select top 1 t3.asig_ccod from alumnos tt, cargas_academicas t2, secciones t3, asignaturas t4 "& vbCrLf &_
 				" where tt.matr_ncorr=t2.matr_ncorr and t2.secc_ccod=t3.secc_ccod and t3.asig_ccod=t4.asig_ccod and t4.asig_tdesc like '%PR%CTICA profesional%'  "& vbCrLf &_
				"  and tt.pers_ncorr=a.pers_ncorr and t3.carr_ccod=a.carr_ccod ORDER BY peri_ccod DESC),(select t2.asig_ccod from malla_curricular tt, asignaturas t2 "& vbCrLf &_
				"  where tt.asig_ccod=t2.asig_ccod and tt.plan_ccod = a.plan_ccod and t2.asig_tdesc like '%PR%CTICA PROFESIONAL')) as asig_ccod,  "& vbCrLf &_
				" (Select top 1 t3.peri_ccod from alumnos tt, cargas_academicas t2, secciones t3, asignaturas t4 "& vbCrLf &_
				"  where tt.matr_ncorr=t2.matr_ncorr and t2.secc_ccod=t3.secc_ccod and t3.asig_ccod=t4.asig_ccod and t4.asig_tdesc like '%PR%CTICA profesional%' "& vbCrLf &_
				"  and tt.pers_ncorr=a.pers_ncorr --and t3.carr_ccod=a.carr_ccod SE SACA LA CARRERA PARA QUE APAREZCA PERIODO ACADEMICOs  "& vbCrLf &_ 
				"  ORDER BY peri_ccod DESC) as peri_ccod,isnull(informar_cae,0) as informar_cae,observaciones_cae, isnull(protic.trunc(fecha_cae),protic.trunc(getDate())) as fecha_cae"& vbCrLf &_
     ...
     consulta = " select '"&plan_consulta&"' as plan_ccod, '"&q_pers_ncorr&"' as pers_ncorr, '"&registro&"' as salu_nregistro, '"&folio&"' as salu_nfolio,'"&carr_ccod_informar&"' as carr_ccod, "& vbCrLf &_
				...
				"  where tt.matr_ncorr=t2.matr_ncorr and t2.secc_ccod=t3.secc_ccod and t3.asig_ccod=t4.asig_ccod and t4.asig_tdesc like '%PR%CTICA profesional%' "& vbCrLf &_
				"  and cast(tt.pers_ncorr as varchar)='"&q_pers_ncorr&"' and t3.carr_ccod='"&carr_ccod_informar&"' ORDER BY peri_ccod DESC) as calificacion_practica,  "& vbCrLf &_
				" isnull( (Select top 1 t3.asig_ccod from alumnos tt, cargas_academicas t2, secciones t3, asignaturas t4 "& vbCrLf &_
				"  where tt.matr_ncorr=t2.matr_ncorr and t2.secc_ccod=t3.secc_ccod and t3.asig_ccod=t4.asig_ccod and t4.asig_tdesc like '%PR%CTICA profesional%' "& vbCrLf &_
				"  and cast(tt.pers_ncorr as varchar)='"&q_pers_ncorr&"' and t3.carr_ccod='"&carr_ccod_informar&"' ORDER BY peri_ccod DESC),(select t2.asig_ccod from malla_curricular tt, asignaturas t2 "& vbCrLf &_
 				"  where tt.asig_ccod=t2.asig_ccod and cast(tt.plan_ccod as varchar) = '"&q_plan_ccod&"' and t2.asig_tdesc like '%PR%CTICA PROFESIONAL') ) as asig_ccod,  "& vbCrLf &_
				"  (Select top 1 t3.peri_ccod from alumnos tt, cargas_academicas t2, secciones t3, asignaturas t4 "& vbCrLf &_
				"  where tt.matr_ncorr=t2.matr_ncorr and t2.secc_ccod=t3.secc_ccod and t3.asig_ccod=t4.asig_ccod and t4.asig_tdesc like '%PR%CTICA profesional%' "& vbCrLf &_
				"  and cast(tt.pers_ncorr as varchar)='"&q_pers_ncorr&"' and t3.carr_ccod='"&carr_ccod_informar&"'  ORDER BY peri_ccod DESC) as peri_ccod,"& vbCrLf &_
				"  (Select top 1 t2.sitf_ccod from alumnos tt, cargas_academicas t2, secciones t3, asignaturas t4 "& vbCrLf &_
				"  where tt.matr_ncorr=t2.matr_ncorr and t2.secc_ccod=t3.secc_ccod and t3.asig_ccod=t4.asig_ccod and t4.asig_tdesc like '%PR%CTICA profesional%' "& vbCrLf &_
				"  and cast(tt.pers_ncorr as varchar)='"&q_pers_ncorr&"' and t3.carr_ccod='"&carr_ccod_informar&"'  ORDER BY peri_ccod DESC) as sitf_ccod, "& vbCrLf &_
				"  isnull( (Select top 1 t4.asig_nhoras from alumnos tt, cargas_academicas t2, secciones t3, asignaturas t4 "& vbCrLf &_
 				"  where tt.matr_ncorr=t2.matr_ncorr and t2.secc_ccod=t3.secc_ccod and t3.asig_ccod=t4.asig_ccod and t4.asig_tdesc like '%PR%CTICA profesional%' "& vbCrLf &_
				"  and cast(tt.pers_ncorr as varchar)='"&q_pers_ncorr&"' and t3.carr_ccod='"&carr_ccod_informar&"'  ORDER BY peri_ccod DESC),(select t2.asig_nhoras from malla_curricular tt, asignaturas t2 "& vbCrLf &_
				"  where tt.asig_ccod=t2.asig_ccod and cast(tt.plan_ccod as varchar) = '"&q_plan_ccod&"' and t2.asig_tdesc like '%PR%CTICA PROFESIONAL') )as horas_practica, protic.trunc(getDate()) as fecha_cae "
end if
'---------------------------------------------------------------------------------------------------
...
f_etiqueta.Carga_Parametros "adm_salidas_alumnos.xml", "impresion_etiqueta"
...
'---------------------------------------------------------------------------------------------------
if tiene_grabado = "S" then
	 consulta = " select pers_ncorr,plan_ccod,'"&carr_ccod_informar&"' as carr_ccod, isnull(imprimir_etiqueta,0) as imprimir_etiqueta,protic.trunc(fecha_impresion_etiqueta) as fecha_impresion_etiqueta "& vbCrLf &_
			   	" from detalles_titulacion_carrera "& vbCrLf &_
				" where cast(plan_ccod as varchar)='"&plan_consulta&"' "& vbCrLf &_
				" and cast(pers_ncorr as varchar)='"&q_pers_ncorr&"'"
else
	 consulta = " select '"&q_pers_ncorr&"' as pers_ncorr,'"&plan_consulta&"' as plan_ccod,'"&carr_ccod_informar&"' as carr_ccod, 0 as imprimir_etiqueta "
...
'---------------------------------------------------------------------------------------------------
f_etiqueta.Consultar consulta
f_etiqueta.Siguiente
imprimir_etiqueta = f_etiqueta.obtenerValor("imprimir_etiqueta")
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
                <td> <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
					...
					<tr>
					  	<td align="center">
						  <table width="50%" border="1" bordercolor="#666666">
						  <tr>
						  		<td>
								  <form name="etiqueta">
								    <input type="hidden" name="saca_ncorr" value="<%=saca_ncorr%>">
									<input type="hidden" name="egreso[0][pers_ncorr]" value="<%=q_pers_ncorr%>">
									<input type="hidden" name="egreso[0][plan_ccod]" value="<%=plan_consulta%>">
								    <table width="100%" cellpadding="0" cellspacing="0">
										<tr>
											<td colspan="2" height="22" align="center" bgcolor="#666666"><font color="#FFFFFF" size="2"><strong>Impresión de Etiquetas</strong></font></td>
										</tr>
										<tr valign="top">
											<td width="80%">
												<table width="100%">
													<tr>
														<td width="49%" align="left"><strong>Asignar Etiqueta</strong></td>
														<td width="1%" align="center"><strong>:</strong></td>
														<td width="50%" align="left"><%f_etiqueta.dibujaCampo("imprimir_etiqueta")%></td>
													</tr>
													<tr>
														<td width="49%" align="left"><strong>Fecha Impresión</strong></td>
														<td width="1%" align="center"><strong>:</strong></td>
														<td width="50%" align="left"><%f_etiqueta.dibujaCampo("fecha_impresion_etiqueta")%></td>
													</tr>
												</table>
											</td>
											<td>
												<table width="100%">
													<tr>
														<td align="right"><%f_botonera_etiqueta.DibujaBoton "guardar_etiqueta"%></td>
													</tr>
													<tr>
														<td align="right"><%if imprimir_etiqueta = "1" then
														                      f_botonera_etiqueta.DibujaBoton "imprimir"
																			end if%></td>
													</tr>
												</table>
											</td>
										</tr>
										<%if imprimir_etiqueta = "1" then%>
										<tr>
											<td colspan="2" height="20">
												<table width="100%" cellpadding="0" cellspacing="0">
												    
													<tr>
														<td width="33%" align="center"><%f_botonera_etiqueta.DibujaBoton "enviar_email_finanzas"%></td>
														<td width="34%" align="center"><%f_botonera_etiqueta.DibujaBoton "enviar_email_audiovisual"%></td>
														<td width="33%" align="center"><%f_botonera_etiqueta.DibujaBoton "enviar_email_biblioteca"%></td>
													</tr>
												</table>
											</td>
										</tr>
								  ...
								  <form name="edicion_email" method="post">
													...
													<input type="hidden" name="dato_1_rut" value="<%=rut_email%>">
													<input type="hidden" name="dato_1_nombre" value="<%=nombre_email%>">
													<input type="hidden" name="dato_1_sede" value="<%=sede_email%>">
													<input type="hidden" name="dato_1_carrera" value="<%=carrera_email%>">
													<input type="hidden" name="total_carrera" value="1">
								  </form>	
							  </td>
						    </tr>
						  </table>
