...
'LINEA			:98,100,103,105,107,110,112,114,117,119,123,125,127,131,133,136,138,141,143,148,150,153,155,157,159
'********************************************************************
...
f_comision.Carga_Parametros "adm_salidas_alumnos.xml", "comision_tesis"
...
f_lista_comision.Carga_Parametros "adm_salidas_alumnos.xml", "lista_comision_tesis"
...
f_tesis.Carga_Parametros "adm_salidas_alumnos.xml", "datos_tesis"
f_tesis.Inicializar conexion
'-------------------------------consulta que saca la fecha de examen->>>
' Utiliza dos tablas "salidas_carreras" y "alumnos_salidas_carrera", de salidas_carreras(plan_ccod, carr_ccod) y de  alumnos_salidas_carrera(pers_ncorr)
' para obtener alumnos_salidas_carrera->asca_fsalida
consulta_fecha =  	""& vbCrLf &_
					"select protic.trunc(b.asca_fsalida)                           "& vbCrLf &_
					"from   salidas_carrera a,                                     "& vbCrLf &_
					"       alumnos_salidas_carrera b                              "& vbCrLf &_
					"where  Cast(a.plan_ccod as varchar) = '"&plan_consulta&"'     "& vbCrLf &_
					"       and a.carr_ccod = '"&carr_ccod&"'                      "& vbCrLf &_
					"       and a.saca_ncorr = b.saca_ncorr                        "& vbCrLf &_
					"       and Cast(b.pers_ncorr as varchar) = '"&q_pers_ncorr&"' "& vbCrLf &_
					"       and a.tsca_ccod in ( 1, 4 )                            "
'-------------------------------consulta que saca la fecha de examen-<<<
...
'-----------------------------------------------------------
'pruebaFecha = f_tesis.ObtenerValor("fecha_titulacion")
'response.Write("pruebaFecha="&pruebaFecha)
'-----------------------------------------------------------
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetasFClaro Array(Array("Editar salida de alumno", url_leng_1), Array("Datos Personales", url_leng_2), Array("Información Egreso", url_leng_3), Array("Información Titulación", url_leng_4), Array("Conc. Notas", url_leng_5)),4%></td>
          </tr>
          <tr>
