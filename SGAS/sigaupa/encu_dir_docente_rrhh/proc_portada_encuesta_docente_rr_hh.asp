...
fecha_corte="15-11-2015" '-------> Fecha Cierra	
fecha_corte2="03-11-2015" '-------> Fecha Apertura		 
'
...
'end if
if  rut="13919051" then
session("rut_usuario") = "11949949"	
 response.Write("<br/>"&"1")
response.Redirect("docentes.asp")
end if

'accesos a directores en forma permanente Excepcionalmente.....
if rut = "15783024" or rut = "12558863" or rut = "8053780" then
