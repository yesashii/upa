...
function checkVersion()
{
   ...
   if (ver <= -1)
   {
		$("#controlversion").append("<h2><P style='BACKGROUND-COLOR: orange'align=center><FONT color=# ff0000>&iexcl;ATENCI&Oacute;N!<br/><br/>El sistema SGA, est&aacute; desarrollado para funcionar con Internet Explorer.<br/>Por favor, utilice el navegador mencionado.<br/><br/></FONT></P></h2>");
