...
if q_pers_nrut = 11404850 then
	'response.Write("hola")
	consulta_sec ="select a.pers_ncorr,a.pers_tape_paterno+' '+a.pers_tnombre as nombre "& vbCrLf &_
"from PERSONAS a where PERS_NRUT in "& vbCrLf &_
"(16291319,15623705,16291749,14543984,7699351,11632071,16741288,11845606,7037083,10783996,10349785,10536399,15737398,17986689)"
end if
