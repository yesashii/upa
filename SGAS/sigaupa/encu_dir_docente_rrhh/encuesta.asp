...
La escala de opciones está graduada en forma creciente desde el número 1 al 6. Si piensa que no puede opinar, marque en la columna, señalada  “No se aplica”.</td>
			...
			<br />
			  ...
			  <table width="100%">
			   ...
			   <tr>
			      <td width="95%" align="center"><textarea name="encu[0][III_a]" cols="145" rows="4" class="Estilo25" id="TO-S"></textarea>
				</tr>
				</table>
			  <br />
			   <table width="100%">
			   ...
			   <tr>
			      <td width="95%" align="center"><textarea name="encu[0][III_b]" cols="145" rows="4" class="Estilo25" id="TO-S"></textarea>
				</tr>
				</table>
				<br />
				<table width="100%">
			   ...
			   <tr>
			      <td width="95%" align="center"><textarea name="encu[0][III_c]" cols="145" rows="4" class="Estilo25" id="TO-S"></textarea>
				</tr>
				</table>
				<br />
		  <hr align="left" width="100%" size="1" noshade="noshade" />
			  ...
			  <table width="100%">
			   ...
			   <td width="36%" align="rigth" valign="top" class="Estilo31"></td>
					...
					<td width="10%" align="center" valign="top" class="Estilo31">
						...
						<img src="Images/vovler1.png" border="0" width="55" height="55" alt="¿Cómo funciona?">					
					</td>
					
					<td width="11%" align="center" valign="top" class="Estilo31">
					 
						<a href="javascript:_Guardar(this, document.forms['edicion'], 'encuesta_proc.asp','', 'ValidarMarcados()', 'Desea guardar la encuesta', 'FALSE');">
												
						<img src="Images/guardar1.png" border="0" width="55" height="55" alt="¿Cómo funciona?">
					 </td>
