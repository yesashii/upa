...
fecha=Date()
fecha_corte="17-11-2013" '-------> Fecha Cierra	
fecha_corte2="04-11-2013" '-------> Fecha Apertura		 
...
session("mensajeerror")= "La Encuesta estará activa a partir del 04 de Noviembre 2013 hasta 17 de noviembre"
 response.Redirect("portada_encuesta.asp")		
end if
 'session("mensajeerror")= "La Encuesta Ha sido Cerrada"
 'response.Redirect("portada_encuesta.asp")
