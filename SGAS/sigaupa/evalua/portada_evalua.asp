...
'------------------------------------------------------  
 ...
 botonera.carga_parametros "portada_evalua.xml", "btn_portada"
'------------------------------------------------------

'---------------------------------------------------------------------
 set f_datos = new CFormulario
 f_datos.Carga_Parametros "portada_evalua.xml", "f_datos"
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="#dae4fa" onLoad="EncuadraVentana();">
          ...
          <tr> 
             <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr> 
				  ...
				  <td align="left"> <% botonera.dibujaboton "aceptar"%>
                </tr>
              </table></td>
          </tr>
          <tr> 
