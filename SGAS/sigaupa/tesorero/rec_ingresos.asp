            ...
            <tr>
              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="171" valign="bottom" background="../imagenes/fondo1.gif">
                    ...
                    <td width="484" bgcolor="#D8D8DE"><font color="#D8D8DE" size="1">.</font></td>
                  </tr>
              </table></td>
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <div align="left"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Recepci&oacute;n
                          de Ingresos</font></div></td>
                ...
                <tr> 
                  <td valign="middle"> 
                      <table width="95%" align="center" cellpadding="0" cellspacing="0">
                        <tr> 
                          <form name="edicion" method="post"><td align="left"> <%if rut <>"" and dv <> "" then %> <table width="50%" cellspacing="0" cellpadding="0">
                              <tr> 
					  ...
					  response.Write(texto)
                            ...
                            <table width="3%" align="right" cellpadding="0" cellspacing="0">
                              <tr> 
                                <td align="right" nowrap>&nbsp;</td>
                                <td width="42%" align="center" nowrap> <input type="text" readonly="true" name="nro_docto" id="NU-N" value="1" size="2" maxlength="1">
                                   </td>
                            ...
                            <!--******************************* TERMINO NUEVO************************** -->
                            <br> <br> <br> <br> <br> <table width="97%" align="center" cellpadding="0" cellspacing="0">
                              <tr> 
                                <td></td>
                              </tr>
                              <tr> 
                              ...
                              <tr> 
                                <td align="center"> <%else%> <table width="100%" border="1" align="center" cellpadding=0 cellspacing=0 bordercolor="#FFFFFF" bgcolor="#6581AB">
                                    <tr align="center"> 
                                    ...
                                    <tr align="center" bordercolor="#FFFFFF"> 
                                      <td colspan="7" bgcolor="#AEC7E3">Debe 
                            ...
                            <p>- Debe seleccionar el (los) compromiso(s) que desea 
                              pagar y presionar el botón pagar.<br>
                              ...
                              <tr> 
                                <td> <input type="hidden" name="mcaj_ncorr" value="<%=mcaj_ncorr%>"> 
                                  ...
                                  <table width="10%" align="right" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr> 
                                      <td align="right" nowrap>&nbsp;</td>
                                      <td colspan="3" align="center" nowrap><!--<a href="javascript:abrir2();"><img src="../images/pagar_p.gif" width="66" height="20" border="0"></a> --></td>
                                      <td align="right">&nbsp;</td>
                                    </tr>
                                  </table></td>
                              </tr>
