...
pagina.Titulo = "Anulación de Ingresos"
...
f_busqueda.Carga_Parametros "anulacion_ingresos.xml", "busqueda"
                ...
                <tr>
                  <td width="81%"><div align="center">
                    <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td>Folio : <br>
                          <%f_busqueda.DibujaCampo("ingr_nfolio_referencia")%></td>
                        <td>&nbsp;</td>
                        <td>Tipo : <br>
                          <%f_busqueda.DibujaCampo("ting_ccod")%></td>
                      </tr>
                    </table>
                  </div></td>
