...
pagina.Titulo = "Cierre de Cajas - Anulación de Ingresos"
...
if not cajero.TieneCajaAbierta then
	conexion.MensajeError "No tiene ninguna caja abierta de este tipo para cerrar."
...
consulta = "select protic.obtener_rut(b.pers_ncorr) as rut, protic.obtener_nombre_completo(b.pers_ncorr,'n') as nombre_completo," & vbCrLf &_
			"    a.mcaj_ncorr, a.mcaj_ncorr as c_mcaj_ncorr, a.mcaj_finicio, getdate() as fecha_emision, a.mcaj_mrendicion" & vbCrLf &_
			"    from movimientos_cajas a,cajeros b" & vbCrLf &_
			"    where a.sede_ccod = b.sede_ccod" & vbCrLf &_
			"        and a.caje_ccod = b.caje_ccod " & vbCrLf &_
			"        and a.mcaj_ncorr = '" & v_mcaj_ncorr & "'"
...
f_movimiento_caja.AgregaCampoParam "mcaj_mrendicion", "permiso", "OCULTO"
'-------------------------------------------------------------------------------------------
v_inst_ccod = "1"
...
consulta = "select a.mcaj_ncorr, a.inst_ccod, a.tdoc_ccod, a.tdoc_tdesc," & vbCrLf &_
			...
			"        isnull(b.mcaj_mexento, 0) as mcaj_mexento, isnull(b.mcaj_miva, 0) as mcaj_miva, isnull(b.mcaj_ncantidad, 0) as mcaj_ncantidad, " & vbCrLf &_
			"	    b.mcaj_desde, b.mcaj_hasta" & vbCrLf &_
			"from" & vbCrLf &_
...
'--------------------------------------------------------------------------------------------------
'f_botonera.AgregaBotonUrlParam "guardar", "tcaj_ccod", "1001"
%>
