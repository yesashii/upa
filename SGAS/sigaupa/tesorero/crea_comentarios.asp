...
pagina.Titulo = "Creacion Comentarios"
...
botonera.Carga_Parametros "cuenta_corriente.xml", "botonera"
...
'rut_usuario="10536373"
'----------------------------------------------------
c_permiso = "select case count(*) when 0 then 'N' else 'S' end from sis_roles_usuarios rus, sis_roles rol where rus.srol_ncorr = rol.srol_ncorr and rol.srol_ncorr = 321 and rus.pers_ncorr = protic.obtener_pers_ncorr("&rut_usuario&")"
permiso = conexion.consultaUno(c_permiso)


'if rut_usuario="16098659" or rut_usuario="13981588" or rut_usuario="13482435" or rut_usuario="12671036" or rut_usuario="10536373" or rut_usuario="11533590" or rut_usuario="13721634" or rut_usuario="14412292" or rut_usuario="11592558" or rut_usuario="9242221" or rut_usuario="13373873" or rut_usuario="8876413" or rut_usuario="9158297" or rut_usuario="13582834" or rut_usuario="9251062" or rut_usuario="8533344" or rut_usuario="6629316" or rut_usuario="15785003"  or rut_usuario="14205430" or rut_usuario="15964262" or rut_usuario="6060624" or rut_usuario="12671036" or rut_usuario="8409343" or rut_usuario="10773253"  or rut_usuario="16082518" or rut_usuario="11646306" or rut_usuario="15357022" then
...
%>
	<script language="JavaScript">
		alert("No tiene permisos para crear comentarios");
		window.close();
	</script>
	<%	
end if
          ...
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td>
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td width="205" valign="middle" background="../imagenes/fondo1.gif"><font color="white">crear 
                        nuevo comentario</font> </td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td bgcolor="#D8D8DE"> <div align="center">&nbsp; <BR>
                  ...
                  <form name="edicion">
					<input  type="hidden" name="comen[0][pers_ncorr]" value="<%=v_pers_ncorr%>">
