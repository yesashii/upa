...
pagina.Titulo = "Apertura de Cajas (Anulación de ingresos)"
...
if cajero.TieneAlgunaCajaAbierta then
	...
	apertura_cons = "select '" & _
					cajero.ObtenerCajeCCod & "' as caje_ccod, 1 as eren_ccod, 1001 as tcaj_ccod, " & sede & " as sede_ccod, getdate() as mcaj_finicio, 0 as mcaj_mrendicion " & _ 
					", 1 as eren_ccod_p, 1001 as tcaj_ccod_p, " & sede & " as sede_ccod_p, getdate() as mcaj_finicio_p"
		'response.Write("<pre>"&apertura_cons&"</pre>")
		'response.End()
	formulario.consultar apertura_cons
	
	formulario.AgregaCampoParam "mcaj_mrendicion", "permiso", "OCULTO"
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><div align="center"><br>
              ...
              <form name="edicion" action="apertura_cajas_proc.asp?tcaj_ccod=1001" method="post">
