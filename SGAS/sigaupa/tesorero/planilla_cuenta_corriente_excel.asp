...
Response.AddHeader "Content-Disposition", "attachment;filename=planilla_cuenta_corriente_excel.xls"
...
sql_datos=	"	select top 1 protic.obtener_nombre_completo(a.pers_ncorr,'n') as nombre," & vbCrLf &_
...
'						"    protic.trunc(a.comp_fdocto) as fecha_emision, protic.trunc(b.dcom_fcompromiso) as fecha_vencimiento, b.dcom_mcompromiso," & vbCrLf &_
...
'						"    order by b.dcom_fcompromiso desc"
		...
		sql_consolidado="select b.inst_ccod, b.comp_ndocto,b.tcom_ccod,b.dcom_ncompromiso, case when b.tcom_ccod in (1,2) then cast(b.comp_ndocto as varchar)+ ' ('+protic.numero_contrato(b.comp_ndocto)+')'else cast(b.comp_ndocto as varchar) end as ncompromiso, " & vbCrLf &_
						...
						"			from tipos_detalle a1 INNER JOIN " & vbCrLf &_
						"			detalles a2 " & vbCrLf &_
...
<table width="100%" border="0">
  ...
  <% fila = 1 
	 ...
	 %>
  <tr>
	<td><div align="center"><%=consolidado.ObtenerValor("anio_ingreso")%></div></td> 
...
'							"        and a.dcom_ncompromiso = '" & q_dcom_ncompromiso & "'"
		...
		consulta_abonos = "select cast(case d.ting_brebaje when 'S' then -a.abon_mabono else a.abon_mabono end as numeric) as abon_mabono" & vbCrLf &_
			...
			%>
					  <tr bgcolor="#CCCCCC">
						<td colspan="13"><div align="left"><strong>Abonos activos</strong></td>
...
'					"        and a.dcom_ncompromiso = '" & q_dcom_ncompromiso & "'"
		...
		consulta_documentado = "select cast(case d.ting_brebaje when 'S' then -a.abon_mabono else  a.abon_mabono end as numeric) as abon_mabono, " & vbCrLf &_
			...
			%>
					  <tr bgcolor="#CCCCCC">
						<td colspan="13"><div align="left"><strong>Documentado</strong></div></td>
