...
'-----------------------------------------------------------------------------------
'Fechas de cierre de ingresos de notas pareciales para el año en curso
'-----------------------------------------------------------------------------------
if anos_ccod = "2015" then
	if secc_ccod <> "" and periodo <> "" then
		'selecionamos los parametros de comparacion
		...
		'Fechas de cierre poe sedes
		if sede_ccod <> "9" then
			'Para todas las sedes menos LA ARAUCANA
            ...
            <td><div align="center"><br>
              ...
              <form name="lista" method="post">
			   ...
			   %>
						...
						<%
'response.write("bloqueado_cambio: "&bloqueado_cambio&"<br/> autorizar: "&autorizar&"<br/> bloquear_todo: "&bloquear_todo)
