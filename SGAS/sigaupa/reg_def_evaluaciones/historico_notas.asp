...
combo_b.agregacampoparam	"plan_ccod","destino","(SELECT  distinct e.pers_nrut,c.carr_ccod,  " & vbcrlf &_
								"						cast(d.espe_ccod as varchar)+ ' ' + c.carr_tdesc + ' ' + d.espe_tdesc +' Plan '+ cast(f.plan_ncorrelativo as varchar) AS salida,    " & vbcrlf &_
          ...
          <tr>
            <td><form name="buscador">
              ...
              <table width="98%"  border="0" align="center">
                <tr>
                  <td width="81%"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Rut&nbsp;<strong>
                  <input type="text" name="busqueda[0][pers_nrut]" size="10" maxlength="8" id="NU-N" value="<%=rut%>">
-
<input type="text" name="busqueda[0][pers_xdv]" size="2" maxlength="1" value="<%=dv%>" id="LN-N" 			onKeyUp="this.value=this.value.toUpperCase();">
<a href="javascript:buscar_persona('busqueda[0][pers_nrut]', 'busqueda[0][pers_xdv]');"><img src="../imagenes/lupa_f2.gif" width="16" height="15" border="0"></a><%'pagina.DibujarBuscaPersonas "busqueda[0][rut]", "busqueda[0][dv]"%>
...
<br>
                      ...
                      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td align="center"><strong>RESUMEN EQUIVALENCIAS - HOMOLOGACIONES </strong></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        </tr>
                      ...
                      <br>
* Esta asignatura la est&aacute; cursando el alumno en este periodo. </td>
                  </tr>
                </table>
                          <br>
            </form></td></tr>
