...
function BloquearNotaExamen(p_fila)
{
	...
	var v_asistencia = parseFloat(formulario.elements["not[" + p_fila + "][carg_nasistencia]"].value);//valor asistencia
	var o_eexa_ccod = MM_findObj('not[' + p_fila + '][eexa_ccod]');//situacion final	
	var v_eexa_ccod = 'SD';//o_eexa_ccod.value;		
	var b_habilitado;
	var str_nota;	
...
function carg_nasistencia_blur(p_objeto)
{
	...
	v_asistencia = p_objeto.value;//acá se captura el valor del porcentaje
