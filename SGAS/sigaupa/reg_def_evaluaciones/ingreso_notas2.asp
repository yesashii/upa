	...
	if ('<%=cali_ncorr%>'!=''){
		for (I=0;I<<%=registros%>;I++){
			if(formulario.elements["not["+I+"][estado_cierre_ccod]"].value!="1" ){
			   ...
			   formulario.elements["not["+I+"][cala_nnota]"].setAttribute("disabled",true)

			}	
		}	

		for (J=0;J<<%=registros_peec%>;J++){
			if(formulario.elements["np["+J+"][estado_cierre_ccod]"].value!="1" ){
 		       formulario.elements["np["+J+"][cala_nnota]"].setAttribute("disabled",true)
...
<table width="750" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<br>
      ...
      <br>
      <table width="87%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
        <tr>
	...
	<table width="88%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td>
                  <%pagina.DibujarLenguetas Array("Ingreso Notas"), 1 %>
                </td>
              </tr>
              <tr> 
                <td height="2" background="../imagenes/top_r3_c2.gif"></td>
                ...
                <td> <p>
                  <form name="busca_alumnos" method="get">
                    ...
                    <table width="100%" border="0">
                      <tr> 
                        <td colspan="2" nowrap>Resultado de La b&uacute;squeda 
                        </td>
                      </tr>
                      <tr> 
                        <td width="21%">Sede </td>
