...
'------------------------------------------------------
 ...
 clave_email = conexion.consultaUno("select top 1 lower(clave_email) from cuentas_email_upa where rut like '"&usuario&"%'")
%>
	...
	<tr valign="top">
		<td width="100%" height="529" align="center" background="../imagenes/fondo_aviso_mail.png">
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr valign="top">
					<td width="3%">&nbsp;</td>
					<td width="94%"><div align="center"><font color="#333333" size="2"><strong>Queremos ofrecerte un mejor servicio de correo electrónico.<br>Para ello, necesitamos que antes del 03 de Diciembre respaldes toda la información que encuentras pertinente desde tu correo alumnosupacifico.cl o docentesupacifico.cl.<br>Tu nueva cuenta ( <font color="#0066CC"><%=email_alumno%> :Clave= <%=clave_email%> </font> ) estará disponible a partir del día Jueves 26 de Noviembre en el Pacifico Online.<br>El acceso a tu nuevo email es: <font color="#0066CC">http://docentes.upacifico.cl</font>.</strong></font></div></td>
					<td width="3%">&nbsp;</td>
				</tr>
				<tr><td colspan="3">&nbsp;</td></tr>
