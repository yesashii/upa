...
sql_boletas_pendientes="select count(*) from boletas where mcaj_ncorr="&v_mcaj_ncorr&" and ebol_ccod=1"
v_boletas_pendientes=conexion.ConsultaUno(sql_boletas_pendientes)
'Response.Write("Boletas Pendientes: "&v_boletas_pendientes)
...
consulta = "select a.mcaj_ncorr, a.inst_ccod, a.tdoc_ccod, a.tdoc_tdesc, " & vbCrLf &_
			...
			"	) a LEFT OUTER JOIN detalle_mov_cajas b " & vbCrLf &_
...
function imprimir_docto(){
	window.open("imprimir_docto_pagados.asp?mcaj_ncorr=<%=v_mcaj_ncorr%>","<%=v_mcaj_ncorr%>");
}

function imprimir_letras(){
	window.open("imprimir_letras_pagados.asp?mcaj_ncorr=<%=v_mcaj_ncorr%>","<%=v_mcaj_ncorr%>");
}
function imprimir_cheques(){
	window.open("imprimir_cheques_pagados.asp?mcaj_ncorr=<%=v_mcaj_ncorr%>","<%=v_mcaj_ncorr%>");
}
function imprimir_pagares(){
	window.open("imprimir_pagare_pagados.asp?mcaj_ncorr=<%=v_mcaj_ncorr%>","<%=v_mcaj_ncorr%>");
}
...
<p><font color="#FF0000" size="2">(*)</font><font color="#0033FF" size="2"> No puede cerrar caja mientras tenga boletas en estado pendiente (hay <b><%=v_boletas_pendientes%></b> boletas pendientes)</font></p>
<%end if%>
            </form></td></tr>
        </table></td>
	   ...
	   <tr>
		  ...
		  <td>
			  <table width="100%">
				  <tr>
				  	<td>&nbsp;</td>
					<td><%f_botonera.DibujaBoton("imprimir_letras")%></td>
					<td><%f_botonera.DibujaBoton("imprimir_cheques")%></td>
					<td><%f_botonera.DibujaBoton("imprimir_pagares")%></td>
				  </tr>
			  </table>
		  </td>
		  <td width="7" background="../imagenes/der.gif">&nbsp;</td>
            ...
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <td><div align="center"><%f_botonera.DibujaBoton("imprimir_docto")%></div></td>
				  <td><div align="center"><%f_botonera.DibujaBoton("imprimir_tarjetas")%></div></td>
                  </tr>
              </table>
