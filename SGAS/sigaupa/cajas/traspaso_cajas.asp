...
SQL = " select a.mcaj_ncorr as c_mcaj_ncorr, a.mcaj_ncorr, a.mcaj_finicio, protic.obtener_nombre_completo(b.pers_ncorr, 'PM,N') as cajero, c.ecua_tdesc, d.eren_tdesc ,a.sede_ccod "
SQL = SQL &  " from movimientos_cajas a, cajeros b, estados_cuadre c, estados_rendicion d "
SQL = SQL &  " where a.caje_ccod = b.caje_ccod "
SQL = SQL &  "   and a.sede_ccod = b.sede_ccod "
SQL = SQL &  "   and a.ecua_ccod = c.ecua_ccod "
SQL = SQL &  "   and a.eren_ccod = d.eren_ccod  "
SQL = SQL &  "   and a.ecua_ccod = 1 "
SQL = SQL &  "   and a.eren_ccod = 3 "
SQL = SQL &  "   and a.tcaj_ccod not in (1002,1005) "
SQL = SQL &  "   and isnull(a.mcaj_btraspasada, 'N') = 'N' "
SQL = SQL &  " order by mcaj_finicio asc "
                    ...
                    <td>
                     <form name="edicion">
							...
							<table width="98%"  border="0" align="center">
							  <tr>
								<td><div align="right">
									<%f_botonera.DibujaBoton "traspasar"%>
								</div></td>
							  </tr>
							</table>
                      </td>
