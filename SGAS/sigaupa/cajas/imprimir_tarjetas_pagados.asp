...
'consulta2= "Select ii.ingr_nfolio_referencia, protic.obtener_nombre_completo((select pers_ncorr_codeudor from detalle_ingresos where ingr_ncorr=protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr')),'a') as deudor," & vbCrLf &_
...
'				"			 and ti.ting_ccod in (13,51) "& vbCrLf &_
...
f_documentos_caja.Consultar consulta2
            ...
            <td><div align="center"><br>
              ...
              <br>
                ...
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
					<b><font color="#666677" size="2">Detalle de Tarjetas pagadas </font></b>
                      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
