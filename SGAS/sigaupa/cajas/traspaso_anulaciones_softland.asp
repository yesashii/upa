...
pagina.Titulo = "Traspaso Anulaciones de Cajas"
'---------------------------------------------------------------------------------------------
...
SQL = " select a.mcaj_ncorr as c_mcaj_ncorr, a.mcaj_ncorr, a.mcaj_finicio,a.tcaj_ccod, "& vbCrLf &_
	" protic.obtener_nombre_completo(b.pers_ncorr, 'PM,N') as cajero, c.ecua_tdesc, d.eren_tdesc ,a.sede_ccod "& vbCrLf &_
  ...
  "   and a.ecua_ccod = 1 "& vbCrLf &_
  "   --and a.eren_ccod in(3,4) "& vbCrLf &_
  "   --and isnull(a.mcaj_btraspasada_softland, 'N') = 'N' "& vbCrLf &_
  "   and a.tcaj_ccod in (1001,1002,1005) "& vbCrLf &_
  "   and a.mcaj_ncorr in (577,620,800) "& vbCrLf &_
                    ...
                    <td>
                     <form name="edicion">
							...
							<table width="98%"  border="0" align="center">
							  <tr>
								<td><div align="right">
									<%'f_botonera.DibujaBoton "traspasar_softland_anula"%>
								</div></td>
							  </tr>
							</table>
                      </td>
