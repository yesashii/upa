...
consulta=" select  distinct i.ingr_nfolio_referencia as nfolio,aa.total, isnull("&periodo&",a.peri_ccod) as peri_ccod,"& vbCrlf &_
         " i.ingr_fpago,protic.trunc(i.ingr_fpago) as fecha_pago,t_i.ting_tdesc as tipo_ingreso, i.ting_ccod as nro_ting_ccod,i.pers_ncorr,e_i.eing_tdesc, "& vbCrlf &_
         " '<a href=""javascript:imprimir('+ cast(i.ingr_nfolio_referencia as varchar)+ ','+ cast(i.ting_ccod as varchar)+','+cast(i.pers_ncorr as varchar) +','+ cast(aa.total as varchar)+','+ cast(isnull("&periodo&",a.peri_ccod) as varchar)+')"">'+ 'Reimprimir' + '</a>' as imprimir, " & vbCrlf & _
		 " '<a href=  javascript:imprimir_acuse('+ cast(i.ingr_nfolio_referencia as varchar)+ ','+ cast(i.ting_ccod as varchar)+')  >'+ 'ver acuse' + '</a>' as imprimir_acuse "& vbCrlf & _         
		 " from ingresos i,tipos_ingresos t_i,abonos a,estados_ingresos e_i,"& vbCrlf &_
         ...
         " and t_i.ting_ccod in (15,16,17,34,47,48,49,50)"& vbCrlf &_
         ...
         " and i.ting_ccod=t_i.ting_ccod"& vbCrlf &_
		 " --and cast(i.eing_ccod as varchar)<>'3'"&vbCrlf &_
		 "  and i.eing_ccod=e_i.eing_ccod "&vbCrlf &_
         " and t_i.ting_ccod in (15,16,17,34,47,48,49,50)"& vbCrlf &_ 
         " order by i.ingr_fpago DESC,i.ingr_nfolio_referencia desc "
...
{var url;
    if ((tipo_doc=='16')||(tipo_doc=='34')||(tipo_doc=='17')){
	     ...
	     url="../reportesnet/imprimir_repactacion.aspx?repa_ncorr="+ nfolio + " ";
	   }	
	 else if(tipo_doc=='47'){
...
function imprimir_acuse(nfolio,tipo_doc)
{
	var url;
    if (tipo_doc==15){tipo_doc=9;}
	url="acuse_recibo.asp?nfolio="+nfolio+"&ting_ccod="+tipo_doc+" ";
	irA(url, "1", 700, 500)
}
