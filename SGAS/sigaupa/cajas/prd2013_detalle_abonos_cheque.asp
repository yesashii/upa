...
pagina.Titulo = "Detalle de abonos del documento"
...
if 	q_ding_tcuenta_corriente = "0" then
	q_ding_tcuenta_corriente = ""
end if

if 	q_ting_ccod = "4" then
	filtro = "  and isnull(a.ding_bpacta_cuota, 'S') = 'S' " & vbCrLf 
else
	filtro = "  --and isnull(a.ding_bpacta_cuota, 'N') = 'N' " & vbCrLf &_
			 "  and a.banc_ccod = '" & q_banc_ccod & "' " & vbCrLf &_
			"  and a.ding_tcuenta_corriente = isnull('" & q_ding_tcuenta_corriente & "', ' ') " & vbCrLf
end if
...
consulta = "select b.ting_ccod, b.ingr_nfolio_referencia, b.ingr_fpago, c.abon_mabono,e.pers_ncorr," & vbCrLf &_
			...
			"        a.ting_ccod as ting_ccod_documento, a.ding_ndocto" & vbCrLf &_
			"  from detalle_ingresos a,ingresos b,abonos c,detalle_compromisos d,compromisos e, detalle_ingresos f " & vbCrLf &_
			"  where a.ingr_ncorr = b.ingr_ncorr" & vbCrLf &_
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas Array("Documento"), 1 %></td>
          </tr>
          <tr>
            ...
            <td><div align="center"><br><%f_encabezado.DibujaRegistro%>
              ...
              <form name="edicion">
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><%pagina.DibujarSubtitulo "Pagos del documento"%>
