...
pagina.Titulo = "Reimpresion de contratos"
'-----------------------------------------------------------------------
...
'-----------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "Activar_Contrato.xml", "busqueda_imprimir"
...
'consulta = "select a.cont_ncorr, a.cont_ncorr as c_cont_ncorr, trunc(a.cont_fcontrato) as cont_fcontrato, a.post_ncorr, b.pers_ncorr, c.pers_nrut, c.pers_xdv, " & vbCrLf &_
...
'			  "and a.econ_ccod <> 3 "&_  
'			  "and c.pers_nrut = nvl('" & rut_alumno & "', '0')"

if v_folio <> "" then
	consulta="select b.comp_ndocto as cont_ncorr,b.comp_ndocto as c_cont_ncorr, c.pers_nrut, c.pers_xdv, " & vbCrLf &_
		" cast(c.pers_nrut as varchar) + '-' +  c.pers_xdv as rut_alumno, " & vbCrLf &_
		" convert(varchar,a.ingr_fpago,103) as cont_fcontrato, "& vbCrLf &_
		" c.PERS_TAPE_PATERNO + ' ' + c.PERS_TAPE_MATERNO  + ' ' + c.pers_tnombre as nombre_alumno, " & vbCrLf &_
		"  d.econ_ccod, e.econ_tdesc "& vbCrLf &_
		" from ingresos a , abonos b,personas_postulante c,contratos d,estados_contrato e " & vbCrLf &_
		" where cast(a.ingr_nfolio_referencia as varchar) ='"&v_folio&"' " & vbCrLf &_
		" and a.ingr_ncorr=b.ingr_ncorr " & vbCrLf &_
		" and a.pers_ncorr = c.pers_ncorr " & vbCrLf &_
		" and b.comp_ndocto=d.cont_ncorr " & vbCrLf &_
		" and d.econ_ccod = e.econ_ccod " & vbCrLf &_
		" and a.ting_ccod=7" & vbCrLf &_
		" group by b.comp_ndocto,c.pers_nrut, c.pers_xdv,c.pers_tnombre,c.PERS_TAPE_PATERNO,c.PERS_TAPE_MATERNO ,a.ingr_fpago,d.econ_ccod, e.econ_tdesc  "
else

consulta = "select a.cont_ncorr, a.cont_ncorr as c_cont_ncorr," & vbCrLf &_
                          ...
                          <tr>
                            <td width="103" >R.U.T. Alumno : </td>
                                  <td width="198" > 
									...
									<td width="79"></td>
									<td width="72">Nº Folio:</td>
									<td width="65"><% f_busqueda.DibujaCampo ("folio") %></td>
                          </tr>
                        </table>
                      </div></td>
