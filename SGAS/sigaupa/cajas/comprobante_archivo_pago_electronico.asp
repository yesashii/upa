...
sql_subido=" select tcom_ccod,comp_ndocto, dcom_ncompromiso,protic.obtener_nombre_completo(b.pers_ncorr,'n') as nombre,protic.trunc(pele_fvencimiento) as  fvencimiento, "&_
			...
			" isnull('<a href=""javascript:imprimir('+ cast(a.ingr_nfolio_referencia as varchar)+ ',16,'+cast(b.pers_ncorr as varchar) +','+ cast(a.pele_mmonto_recaudado as varchar)+','+ cast("&peri_ccod&" as varchar)+')"">'+ 'Imprimir' + '</a>',' <font color=red>No generó pago</font>') as imprimir " & vbCrlf & _
			...
			" where cast(pele_ccod as varchar)='"&pele_ccod&"' "&_
			" and d.eing_ccod=4 "
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0" >
          <tr>
            <td>
             <%pagina.DibujarLenguetasFClaro Array(array("Carga Archivo","cargar_archivo_pago_electronico.asp"), array("Revision Archivo","revisar_archivo_pago_electronico.asp?q_leng=2"), array("Pago Letras","pagar_archivo_pago_electronico.asp?q_leng=3"), array("Impresion de comprobantes","comprobante_archivo_pago_electronico.asp?q_leng=4")), q_leng %>
			</td>
          </tr>
          <tr>
