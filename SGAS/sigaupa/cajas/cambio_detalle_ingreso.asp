...
pagina.Titulo = "Cambio de Estado Documento"
...
f_botonera.Carga_Parametros "cambio_detalle_ingreso.xml", "botonera"

'---------------------------------------------------------------------------------------------------
set f_busqueda = new CFormulario
f_busqueda.Carga_Parametros "cambio_detalle_ingreso.xml", "buscador"
...
formulario.Carga_Parametros "cambio_detalle_ingreso.xml", "datos_alumno"
...
datos.Carga_Parametros "cambio_detalle_ingreso.xml", "detalle_ingreso"
datos.Inicializar conexion
consulta_documento ="select ingr_ncorr,ingr_ncorr as ingr_ncorr2,b.inst_ccod, b.comp_ndocto,b.tcom_ccod, case when b.tcom_ccod in (1,2) then cast(b.comp_ndocto as varchar)+ ' ('+protic.numero_contrato(b.comp_ndocto)+')'else cast(b.comp_ndocto as varchar) end as ncompromiso, " & vbCrLf &_
								"     case " & vbCrLf &_
								...
								"    protic.trunc(a.comp_fdocto) as comp_fdocto , protic.trunc(b.dcom_fcompromiso) as dcom_fcompromiso, b.dcom_mcompromiso," & vbCrLf &_
								...
								"	 and c.EDIN_CCOD in (4,10,100)" &_
								"    order by b.dcom_fcompromiso desc"
								
comentario_desarrolladores "172.16.100.128", consulta_documento, 0

'response.write "<pre>"&consulta_documento&"</pre>"							
datos.Consultar consulta_documento
'response.write datos.nroFilas
'formulario.Siguiente
