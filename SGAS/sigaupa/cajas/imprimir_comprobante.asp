...
v_pele_ccod= request.querystring("pele_ccod")

set pagina = new CPagina
pagina.Titulo = "Comprobante ingresos pago electronico de letras N° "&v_pele_ccod
'**********************************************************
...
f_letras.Inicializar conectar
	if v_pele_ccod<>"" then
		...
		sql_pago_letras =" select tcom_ccod,comp_ndocto, dcom_ncompromiso,protic.obtener_nombre_completo(b.pers_ncorr,'n') as nombre,protic.trunc(pele_fvencimiento) as  fvencimiento, "&_
							...
							" where pele_ccod="&v_pele_ccod&" "&_
							" and d.eing_ccod=4 "&_
							" and a.ingr_nfolio_referencia is not null"
	else
...
sql_datos_caja=" select top 1 protic.obtener_rut(d.pers_ncorr) as rut_cajero, protic.obtener_nombre_completo(d.pers_ncorr,'n') as nombre_completo, "&_
				...
				"	(select count(*) from pago_electronico_letras where pele_ccod="&v_pele_ccod&") as cantidad_doc, "&_
				"	(select sum(pele_mvalor_cuota) from pago_electronico_letras where pele_ccod="&v_pele_ccod&") as monto_total "&_
				"	from pago_electronico_letras a "&_
				"	join ingresos b  "&_
				...
				"	where a.pele_ccod="&v_pele_ccod&" "&_
				"	and b.ting_ccod=16 "
				...
				<tr>
                  ...
                  <tr> 
                    <td>
						...
						<p><strong>Detalle pago Letras </strong></p>
								<table width="100%" border='0' cellpadding='1' cellspacing='1' >
									<tr>
										<th width="50%">Rut alumno </th>
										<th width="12%">N&deg; Letra </th>
