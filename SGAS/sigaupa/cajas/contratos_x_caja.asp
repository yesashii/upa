...
consulta = " Select isnull(a.mcaj_ncorr,0) as mcaj_ncorr,d.econ_ccod,d.cont_ncorr as n_contrato,g.sede_tdesc, "& vbCrLf &_
			...
			" protic.obtener_nombre_completo(k.pers_ncorr,'n') as cajero"& vbCrLf &_
			" From  "& vbCrLf &_
			" ingresos a  "& vbCrLf &_
			...
			" " &filtro&" "& vbCrLf &_
			" group by k.pers_ncorr,d.cont_fcontrato,i.econ_tdesc,a.mcaj_ncorr,d.econ_ccod,d.cont_ncorr,g.sede_tdesc,h.jorn_tdesc,protic.obtener_nombre_carrera(f.ofer_ncorr,'C'),protic.obtener_nombre_completo(e.pers_ncorr,'n')"
