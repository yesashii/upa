...
f_documentos_caja.Carga_Parametros "rendicion_cajas.xml", "docto_pagado"
f_documentos_caja.Inicializar conexion

		   
'consulta= "Select " & vbCrLf &_
'			 " protic.obtener_ultimo_estado(4, " & vbCrLf &_
'			 "     isnull(cast(protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ding_ndocto') as varchar),''),  " & vbCrLf &_    
'			 " 	 (select b.edin_ccod from detalle_ingresos a, estados_detalle_ingresos b where a.ingr_ncorr=protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr') and a.edin_ccod=b.edin_ccod) " & vbCrLf &_
'			 "  )+protic.obtener_institucion_letra(protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr')) +' '+( select isnull(e.sede_tdesc,case" & vbCrLf &_
'            "when a.ingr_fpago < '03/12/2006' then (select sede_tdesc from sedes where sede_ccod=1)" & vbCrLf &_
'           " else c.sede_tdesc end )"& vbCrLf &_
'        "from ingresos a, movimientos_cajas b, sedes c, detalle_ingresos d, sedes e"& vbCrLf &_
'        "where a.mcaj_ncorr=b.mcaj_ncorr"& vbCrLf &_
'        "and b.sede_ccod=c.sede_ccod"& vbCrLf &_
'        "and a.ingr_ncorr=d.ingr_ncorr"& vbCrLf &_
'        "and d.sede_actual*=e.sede_ccod"& vbCrLf &_
'        "and a.ingr_ncorr=(protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr')) "& vbCrLf &_
'        "and d.ting_ccod in (3,4,52)) as ultimo_estado," & vbCrLf &_
'			 " ii.ingr_nfolio_referencia, protic.obtener_nombre_completo((select pers_ncorr_codeudor from detalle_ingresos where ingr_ncorr=protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr')),'a') as deudor," & vbCrLf &_
...
'			 "	 (select b.edin_tdesc+protic.obtener_institucion(a.ingr_ncorr) from detalle_ingresos a, estados_detalle_ingresos b where a.ingr_ncorr=protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr') and a.edin_ccod=b.edin_ccod)  as estado_letra "& vbCrLf &_
...
'				"			 and ti.ting_ccod in (4) "& vbCrLf &_
...
consulta= "Select " & vbCrLf &_
			 ...
			 "     isnull(cast(protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ding_ndocto') as varchar),''),  " & vbCrLf &_    
			 " 	( " & vbCrLf &_
			 "	select b.edin_ccod " & vbCrLf &_
			 "	from detalle_ingresos a " & vbCrLf &_
			 "	INNER JOIN estados_detalle_ingresos b " & vbCrLf &_
			 "	ON a.ingr_ncorr = protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr') " & vbCrLf &_
			 "	and a.edin_ccod = b.edin_ccod " & vbCrLf &_
			 "	) " & vbCrLf &_
			 "  )+protic.obtener_institucion_letra(protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr')) +' '+ " & vbCrLf &_
			 "	( select isnull(e.sede_tdesc,case when a.ingr_fpago < '03/12/2006' then (select sede_tdesc from sedes where sede_ccod = 1) else c.sede_tdesc end ) " & vbCrLf &_
			 "	from ingresos a " & vbCrLf &_
			 "	INNER JOIN movimientos_cajas b " & vbCrLf &_
			 "	ON a.mcaj_ncorr = b.mcaj_ncorr and a.ingr_ncorr = (protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr')) " & vbCrLf &_
			 "	INNER JOIN sedes c " & vbCrLf &_
			 "	ON b.sede_ccod = c.sede_ccod " & vbCrLf &_
			 "	INNER JOIN detalle_ingresos d " & vbCrLf &_
			 "	ON a.ingr_ncorr = d.ingr_ncorr and d.ting_ccod in (3,4,52) " & vbCrLf &_
			 "	LEFT OUTER JOIN sedes e " & vbCrLf &_
			 "	ON d.sede_actual = e.sede_ccod ) as ultimo_estado," & vbCrLf &_
			 " ii.ingr_nfolio_referencia, protic.obtener_nombre_completo((select pers_ncorr_codeudor from detalle_ingresos where ingr_ncorr=protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr')),'a') as deudor," & vbCrLf &_
			 "   protic.obtener_rut(ii.pers_ncorr) as rut_alumno, " & vbCrLf &_
			 "   protic.obtener_rut((select pers_ncorr_codeudor from detalle_ingresos where ingr_ncorr=protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr')) ) as rut_apoderado, " & vbCrLf &_
			 "   isnull(cast(protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ding_ndocto') as varchar),'') as numero_docto,   " & vbCrLf &_
			 ...
			 "	 protic.total_recepcionar_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso)  as saldo_docto," & vbCrLf &_
			 "   (select ting_tdesc from tipos_ingresos where ting_ccod=isnull(b.ting_ccod,6)) as pagado_con,    " & vbCrLf &_
			 "	 (	select b.edin_tdesc+protic.obtener_institucion(a.ingr_ncorr) " & vbCrLf &_
			 "	from detalle_ingresos a " & vbCrLf &_
			 "	INNER JOIN estados_detalle_ingresos b " & vbCrLf &_
			 "	ON a.ingr_ncorr = protic.documento_asociado_cuota(ab.tcom_ccod, ab.inst_ccod, ab.comp_ndocto, ab.dcom_ncompromiso, 'ingr_ncorr') " & vbCrLf &_
			 "	and a.edin_ccod = b.edin_ccod)  as estado_letra "& vbCrLf &_
            ...
            <td><div align="center"><br>
              ...
              <br>
                ...
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
					<b><font color="#666677" size="2">Detalle de Letras pagadas </font></b>
                      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
