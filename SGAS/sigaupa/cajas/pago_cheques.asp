...
pagina.Titulo = "Pago de documentos"
...
if 	opcion = "1" then
	filtro = " and a.ting_ccod in (3,14) --and isnull(a.ding_bpacta_cuota, 'N') = 'N' "
else
	filtro = " and a.ting_ccod = 4 "
end if
		   
consulta = "select  a.ding_fdocto as fecha,a.ting_ccod as c_ting_ccod, a.ding_ndocto as c_ding_ndocto," & vbCrLf &_
			"        isnull(a.banc_ccod,'0') as c_banc_ccod, isnull(a.ding_tcuenta_corriente,'0') as c_ding_tcuenta_corriente," & vbCrLf &_
			"        a.ting_ccod, a.ding_ndocto,isnull(a.banc_ccod,'0') as banc_ccod, a.ding_tcuenta_corriente,a.ding_tcuenta_corriente as cc_ding_tcuenta_corriente," & vbCrLf &_
			"        a.ding_mdocto, a.edin_ccod, a.ding_bpacta_cuota, " & vbCrLf &_
			"        a.ding_mdocto as total --,sum(c.abon_mabono) as total" & vbCrLf &_
			"from detalle_ingresos a,ingresos b,abonos c,detalle_compromisos d" & vbCrLf &_
			"where a.ingr_ncorr = b.ingr_ncorr" & vbCrLf &_
			"    and a.ingr_ncorr = c.ingr_ncorr" & vbCrLf &_
			"    and c.tcom_ccod = d.tcom_ccod" & vbCrLf &_
			...
			"    group by a.ding_fdocto,a.ting_ccod, a.ding_ndocto, a.banc_ccod, a.ding_tcuenta_corriente, a.ding_mdocto, a.edin_ccod, a.ding_bpacta_cuota " & vbCrLf &_
			"    --having a.ding_mdocto = sum(c.abon_mabono) " & vbCrLf &_
			"    order by a.ding_ndocto asc"
          ...
          <tr>
            <td><form name="buscador">
              ...
              <table width="98%"  border="0" align="center">
                <tr>
                  <td width="50%"><div align="center"><%f_busqueda.DibujaRegistro%></div></td>
				  <td width="31%"><div align="left">
				  <input type="radio" name="opcion" value="1" checked>

				  Cheque o Vale Vista</input></div>
				...
				<tr>
				  ...
				  <%if opcion_2 <> "" then%>
				  <input type="radio" name="opcion" value="2" checked>
				  <%else%>
                ...
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><%pagina.DibujarSubtitulo "Documentos"%>
                      ...
                      <table width="98%"  border="0" align="center">
                        <tr>
                          <td><p>- Para ver el detalle de pagos del documento haga clic sobre &eacute;l.<br>
                            <br>
                            - Para transformar el valor del documento en un cargo que pueda ser recepcionado en caja, selecci&oacute;nelo y presione el bot&oacute;n &quot;Guardar&quot;. Una vez hecho esto, aparecer&aacute; un cargo en la cuenta corriente del alumno(s) por el valor correspondiente. <br>
                            </p>
                            </td>
                        </tr>
                      </table></td>
