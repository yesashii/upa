...
Function SqlPersona(p_tipo)
	...
	select case p_tipo
		case "ALUMNO" :
			str_select = "select top 1 b.post_ncorr, " & vbCrLf &_
	...
	consulta = str_select & vbCrLf &_
			  ...
			  "       left outer join postulantes b " & vbCrLf &_
			  ...
			  "       left outer join codeudor_postulacion c" & vbCrLf &_
			  ...
			  "       left outer join  direcciones f " & vbCrLf &_
			  "          on d.pers_ncorr = f.pers_ncorr " & vbCrLf &_
...
'v_rute=f_codeudor.obtenervalor("pers_nrut")
'response.Write(v_rute)
...
function CopiarInformacion()
{
	...
	//if(t_codeudor.ObtenerValor(0, "pers_nrut")){
...
//alert();
		t_rut_codeudor.AsignarValor(0, "pers_nrut", t_alumno.ObtenerValor(0, "pers_nrut"));
		t_rut_codeudor.AsignarValor(0, "pers_xdv", t_alumno.ObtenerValor(0, "pers_xdv"));
		t_codeudor.AsignarValor(1, "pers_tape_paterno", t_alumno.ObtenerValor(0, "pers_tape_paterno"));
		t_codeudor.AsignarValor(1, "pers_tape_materno", t_alumno.ObtenerValor(0, "pers_tape_materno"));
		t_codeudor.AsignarValor(1, "pers_tnombre", t_alumno.ObtenerValor(0, "pers_tnombre"));
		t_codeudor.AsignarValor(1, "pers_tnombre", t_alumno.ObtenerValor(0, "pers_tnombre"));
		t_codeudor.AsignarValor(1, "dire_tcalle", t_alumno.ObtenerValor(0, "dire_tcalle"));
		t_codeudor.AsignarValor(1, "dire_tnro", t_alumno.ObtenerValor(0, "dire_tnro"));
		t_codeudor.AsignarValor(1, "ciud_ccod", t_alumno.ObtenerValor(0, "ciud_ccod"));
		t_codeudor.AsignarValor(1, "pers_tfono", t_alumno.ObtenerValor(0, "pers_tfono"));
	}	*/
}
