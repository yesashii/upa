...
"where a.dcur_ncorr="&dcur_ncorr&""& vbCrLf &_
...
'"select c.mote_ccod, mote_tdesc "& vbCrLf &_
'"from diplomados_cursos a,"& vbCrLf &_
...
valor2=<%=dcur_ncorr%>;
window.location=("tipo_encuestas.asp?dcur_ncorr="+valor2+"")
}
</script>
</head>
			  ...
			  <hr align="left" width="100%" size="1" noshade="noshade" />
			   ...
			   <tr>
				...
				<%
					...
					seot_finicio=f_modulos.ObtenerValor("seot_finicio")
					seot_ftermino=f_modulos.ObtenerValor("seot_ftermino")
					...
					consulta_sec ="select b.mote_ccod,c.seot_ncorr,f.pers_ncorr,mote_tdesc,a.dcur_ncorr,pers_tape_paterno+' '+pers_tape_materno+' '+pers_tnombre as nombre"& vbCrLf &_
							...
							"group by  e.pers_ncorr,b.mote_ccod,c.seot_ncorr,f.pers_ncorr,mote_tdesc,a.dcur_ncorr,pers_tape_paterno,pers_tape_materno,pers_tnombre"
				...
				seccion=f_relatores.ObtenerValor("seot_ncorr")
...
'response.Write("<pre>"&pers_ncorr_alums&"</pre>")
				'response.Write("<br>pers_ncorr_alumno= "&pers_ncorr_alumno)
					...
					'response.Write("<br>evaluada "&evaluada)


				if evaluada="0" then
				btn2="<a href="&""&"javascript:ir("&dcur_ncorr&","&f_relatores.ObtenerValor("pers_ncorr")&","&f_relatores.ObtenerValor("seot_ncorr")&");"&""&">"& vbCrLf &_
