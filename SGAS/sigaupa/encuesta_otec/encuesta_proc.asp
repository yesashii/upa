...
enrp_ncorr=conectar.ConsultaUno("exec obtenerSecuencia 'ENCU_RELATOR_OTEC'")
		strInser="insert into ENCU_RELATOR_OTEC (enrp_ncorr,pers_ncorr_alumno,pers_ncorr_relator,dcur_ncorr,seot_ncorr,enrp_1,enrp_2,enrp_3,enrp_4,enrp_5,enrp_6,enrp_7,enrp_8,enrp_9,enrp_10,enrp_11,enrp_12,enrp_13,enrp_sug,audi_fmodificacion)   values("&enrp_ncorr&","&pers_ncorr_alumno&","&pers_ncorr_relator&","&dcur_ncorr&","&seot_ncorr&","&I_preg_1&","&I_preg_2&","&I_preg_3&","&I_preg_4&","&I_preg_5&","&I_preg_6&","&I_preg_7&","&I_preg_8&","&I_preg_9&","&I_preg_10&","&I_preg_11&","&I_preg_12&","&I_preg_13&",'"&sug&"',getDate())"
