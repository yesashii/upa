...
peri=conexion.ConsultaUno("select peri_tdesc from periodos_academicos where peri_ccod=214") 
...
'pers_ncorr=23921
consulta ="select protic.obtener_codigo_carreras_con_clases("&pers_ncorr&",214)" 

carr_ccod=conexion.ConsultaUno(consulta)
'response.Write("<pre>pers_ncorr= "&pers_ncorr&"</pre>")
if pers_ncorr="23983" then
carr_ccod="51,920"
end if
		  ...
		  <tr>
			...
			<td width="723" align="left">
			    ...
			    <table width="90%" border="0" bgcolor="#FFFFFF" align="center">
                  <tr>
                    <td class="Estilo31" width="20%">Nombre </td>
                    <td class="Estilo31" width="2%">:</td>
                    <td width="78%" align="left" class="Estilo31"><strong><%=nombre%></strong></td>
                  </tr>
                  <tr>
                    <td class="Estilo31" width="20%">Periodo Academico</td>
                    <td class="Estilo31" width="2%">:</td>
			  ...
			  <hr align="left" width="100%" size="1" noshade="noshade" />
			   ...
			   <tr>
				...
				btn2="<a href="&""&"javascript:ir('"&pers_ncorr_do&"','"&carr_ccod&"');"&""&">"& vbCrLf &_
				"<img src="&""&"Images/ver.png"&""&" border="&""&"0"&""&" width="&""&"65"&""&" height="&""&"65"&""&" alt="&""&"VOLVER AL HOME"&""&">"
				else
				 ...
				 <%end if%>
					 ...
					 <table align="center" width="100%">
						<tr>
							...
							<td width="50%" align="left"><%=btn2%></td>
						</tr>
					 </table>
					</td>
