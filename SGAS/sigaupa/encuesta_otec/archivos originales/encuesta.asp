...
consulta = "select dcur_tdesc,mote_tdesc,d.seot_ncorr,pers_tnombre+' '+pers_tape_paterno+' '+pers_tape_materno as nombre,g.pers_ncorr"& vbCrLf &_
		  ...
		  <tr>
			...
			<td width="723" align="left"><table width="654">
				  ...
				  <tr>
                    ...
                    <td width="2%">:</td>
                    <td align="left"><%f_encabezado.DibujaCampo("mote_tdesc")%> 
                    </td>
                  </tr>
                  <tr>
                    <td width="12%">Relator</td>
                    <td width="2%">:</td>
                    <td align="left"><%f_encabezado.DibujaCampo("nombre")%></td>
                  </tr>
