...
class cHistoricoNotas
	...
	cons_historico="select a.nive_ccod,a.asig_ccod,asig.asig_tdesc, " & vbCrLf  & _
				   ...
				   "	 b.sitf_ccod,b.peri_ccod, " & vbCrLf  & _
				   "	 case ('('+ cast(pa.anos_ccod as varchar) + '/' + case plec_ccod  when 1 then 'O' when 2 then 'I' when 3 then 'P' when 4 then 'V' end +'/'+ cast(b.sitf_ccod as varchar)+')') " & vbCrLf  & _
				   "     when ('('+ cast(pa.anos_ccod as varchar) + '/' + case plec_ccod  when 1 then 'O' when 2 then 'I' when 3 then 'P' when 4 then 'V' end +'/)') then ' ' " & vbCrLf  & _
				   "     when '(//)' then ' '" & vbCrLf  & _
				   "     else ('('+ cast(pa.anos_ccod as varchar) + '/' + case plec_ccod  when 1 then 'O' when 2 then 'I' when 3 then 'P' when 4 then 'V' end +'/'+ cast(b.sitf_ccod as varchar)+')') end as anos_ccod  " & vbCrLf  & _
				   "	 from (  " & vbCrLf  & _
				   "	 select ma.nive_ccod, asig_ccod,esp.carr_ccod  " & vbCrLf  & _
			  	   "	 from especialidades esp, planes_estudio pl, malla_curricular ma  " & vbCrLf  & _
				   "	 where esp.espe_ccod=pl.espe_ccod  " & vbCrLf  & _
				   ...
				   "		union   " & vbCrLf  & _
				   "		select  " & vbCrLf  & _
				   "			 a.asig_ccod,sitf_ccod,case a.sitf_ccod when 'CC' then 0 when 'AC' then a.conv_nnota else 0 end as nota,e.peri_ccod " & vbCrLf  & _
				   "		from  " & vbCrLf  & _
				   "			 convalidaciones a " & vbCrLf  & _
				   "			 , alumnos b " & vbCrLf  & _
				   "			 ,personas c " & vbCrLf  & _
				   ...
				   "					and cast(a.espe_ccod as varchar) <> '"&especialidad&"' " & vbCrLf  & _
				   "				)a, " & vbCrLf  & _
				   "				( " & vbCrLf  & _
				   "				select " & vbCrLf  & _
				   "					  d.asig_ccod, g.carr_ccod,f.plan_ccod, g.espe_ccod, a.carg_nnota_final , a.sitf_ccod,d.secc_ccod, a.matr_ncorr " & vbCrLf  & _
				   ...
				   "					,ofertas_academicas e, planes_estudio f, especialidades g   " & vbCrLf  & _
				   "				where b.pers_ncorr=c.pers_ncorr  " & vbCrLf  & _
				   "					and cast(b.pers_nrut as varchar)='"&rut&"'  " & vbCrLf  & _
				   "					and a.matr_ncorr=c.matr_ncorr  " & vbCrLf  & _
				   "					and a.secc_ccod=d.secc_ccod " & vbCrLf  & _
				   "					and c.ofer_ncorr=e.ofer_ncorr " & vbCrLf  & _
				   "					and c.plan_ccod=f.plan_ccod " & vbCrLf  & _
				   ...
				   "					and cast(g.carr_ccod as varchar)='"&carrera&"' " & vbCrLf  & _
				   "					and cast(f.plan_ccod as varchar)<>'"&plan&"' " & vbCrLf  & _
				   "					and cast(g.espe_ccod as varchar)<> '"&especialidad&"' " & vbCrLf  & _
				   "				) b " & vbCrLf  & _
				   "				where  " & vbCrLf  & _
				   "					a.plan_ccod = b.plan_ccod and " & vbCrLf  & _
				   "					a.espe_ccod = b.espe_ccod and " & vbCrLf  & _
				   ...
				   "				and h.THOM_CCOD = 1  " & vbCrLf  & _
				   "				and cast(pers.pers_nrut as varchar)='"&rut&"'  " & vbCrLf  & _
