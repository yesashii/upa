...
sql_todas_asignaturas= " select distinct asig.asig_ccod,asig.asig_tdesc, " & vbcrlf &_
						...
						"    when '(-)' then ' '" & vbcrlf &_
						"    else ('('+ cast(d.anos_ccod as varchar) + '-' + case cast(b.sitf_ccod as varchar) when 'A' then 'Apr' when 'R' then 'Repr' when 'C' then 'Conv' when 'S.P' then 'S.P' end +')') end as anos_ccod,  " & vbcrlf &_
...
<br>
					 ...
					 <br>
					&nbsp;&nbsp;&nbsp;Presione sobre la asignatura a para hacer la equivalencia con la que corresponde por malla curricular.
					<br>
					- Conv : Asignatura convalidada. 
					<br>
					- Apr  &nbsp;&nbsp;: Si la nota es vacia, la asignatura fue aprobada por Homologaci&oacute;n o conocimientos relevantes.</td>
