...
consulta = "select  " & vbCrlf & _
					...
					"	where   --b.emat_ccod in (1,2) and " & vbCrlf & _
...
<table width="100%" border="0">
 <tr> 
    <td colspan="4"><div align="center"><font size="+2" face="Arial, Helvetica, sans-serif">Listado de alumnos evaluados<br>(Cambio Notas)</font></div>
