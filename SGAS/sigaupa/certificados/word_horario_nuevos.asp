...
<%
'Response.AddHeader "Content-Disposition", "attachment;filename=horarios.doc"
...
consulta = 	"select a.matr_ncorr, cast(d.pers_nrut as varchar)+'-'+d.pers_xdv as rut, " & vbCrLf &_
			...
			"and b.peri_ccod=214 and b.post_bnuevo='S' " & vbCrLf &_
			"and ltrim(rtrim(c.carr_ccod))='45' and a.emat_ccod=1 " & vbCrLf &_
 ...
 <table width="672" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr><td align="left" width="672">
  			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr valign="top">
					<td width="33" align="right"><img src="imagenes_certificado/izquierda_lado.jpg" width="33" height="800"></td>
				  <td bgcolor="#FFFFFF" width="600">
						<table width="100%" cellpadding="0" cellspacing="0">
						  <tr><td width="100%" align="center"><font size="4" face="Times New Roman, Times, serif"><strong>HORARIO PRIMER SEMESTRE 2008</strong></font></td></tr>
					...
					<td width="39" align="left"><img src="imagenes_certificado/derecha_lado.jpg" width="35" height="800"></td>
				</tr>
				<tr valign="top">
