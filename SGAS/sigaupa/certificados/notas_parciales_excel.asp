...
"		CALI_NEVALUACION,CALI_NPONDERACION,"& vbCrLf &_
"		max(CALA_NNOTA) nota"& vbCrLf &_
"		from alumnos a INNER JOIN calificaciones_alumnos ca "& vbCrLf &_
"		ON a.matr_ncorr = ca.matr_ncorr "& vbCrLf &_
"		INNER JOIN cargas_academicas cas "& vbCrLf &_
"		ON cas.matr_ncorr = ca.matr_ncorr and cas.secc_ccod = ca.secc_ccod "& vbCrLf &_
"		LEFT OUTER JOIN calificaciones_seccion cs "& vbCrLf &_
"		ON cs.cali_ncorr = ca.cali_ncorr and cs.secc_ccod = ca.secc_ccod "& vbCrLf &_
"		WHERE cast(cs.secc_ccod as varchar)='" & q_secc_ccod & "'"& vbCrLf &_
"		group by pers_ncorr, "& vbCrLf &_
"		cas.CARG_NNOTA_PRESENTACION, "& vbCrLf &_
"		cas.CARG_NNOTA_EXAMEN , "& vbCrLf &_
"		cas.CARG_NNOTA_REPETICION , "& vbCrLf &_
