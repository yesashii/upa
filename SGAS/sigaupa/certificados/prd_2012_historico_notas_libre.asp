...
sql_todas_asignaturas= " select distinct asig.asig_ccod,asig.asig_tdesc, " & vbcrlf &_
						...
						"    case cast(b.sitf_ccod as varchar) when 'A' then 'Apr' when 'R' then 'Repr' when 'C' then 'Conv' when 'SP' then 'S.P' when 'H' then 'Hom' when 'S' then 'Suf' when 'RS' then 'RS' when 'RC' then 'RC' when 'RI' then 'RI' end as sitf_ccod,  " & vbcrlf &_
						...
						" case cast(a.sitf_ccod as varchar) when 'A' then 'Apr' when 'R' then 'Repr' when 'C' then 'Conv' when 'SP' then 'S.P' when 'H' then 'Hom' when 'S' then 'Suf' when 'RS' then 'RS' when 'RC' then 'RC' end as sitf_ccod,  " & vbcrlf &_
