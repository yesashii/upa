...
<table width="672" border="0" cellspacing="0" cellpadding="0">
  <TR>
	  <TD colspan="3" align="left">
	  		<table width="100%">
				<tr valign="top">
					<td width="52" height="56" align="right"><img src="imagenes_certificado/logo_upa.jpg" width="52" height="56"></td>
					<td width="162" height="56"><img src="imagenes_certificado/membrete_upa.jpg" width="162" height="56"></td>
					<td>&nbsp;</td>
				</tr>
				<tr valign="top">
					<td width="65">&nbsp;</td>
				...
				<tr valign="top">
					<td width="65">&nbsp;</td>
					<td width="202" align="center"><font size="2">VICERRECTORÍA ACADÉMICA</font><br><font size="1">REGISTRO CURRICULAR</font></td>
  ...
  <tr><td colspan="3" align="center">
        ...
        <TD colspan="3" align="center"><font size="1">Sede Las Condes: Av. Las 
          Condes 11.121 Fono:862 5300 - Campus Lyon: Av. Ricardo Lyon 227 Fono 
          330 6400</font></TD>
				</TR>
				<TR>
					<TD colspan="3" align="center"><font size="1">Campus Baquedano: Av. Ramón Carnicer 65 Fonos 352 6900--352 6901 - Sede Melipilla:  Av. José Massoud 533 Fono 352 4900</font></TD>
				</TR>
			</table>
      </td>
  </tr>
