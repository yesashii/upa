...
<%
'response.End()
Response.AddHeader "Content-Disposition", "attachment;filename=inscritos_cursos_letras.xls"
...
sql_cursos = " Select g.ingr_nfolio_referencia as comprobante,protic.trunc(max(g.ingr_fpago)) as fecha_inscrito, "& vbCrLf &_
				...
				" Group by g.ingr_nfolio_referencia,b.pers_ncorr,c.tdet_ccod,d.tdet_tdesc,e.pers_tfono,i.ciud_tdesc,i.ciud_tcomuna"
else
