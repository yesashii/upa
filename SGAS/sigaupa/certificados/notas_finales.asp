...
if parametro <> "N" then
	alumnos.carga_parametros		"notas.xml","alumnos_f_cambio"
else

botonera.agregabotonurlparam "Planilla_notas_excel","parametro",parametro

alumnos.carga_parametros		"notas.xml","alumnos_sin_examen_cambio"
...
consulta_alumnos="select distinct " & vbCrlf & _
				 ...
				 " replace(isnull(cast(carg_nnota_final as decimal(2,1)),0.0),',','.') as carg_nnota_final_respaldo," & vbCrlf & _
				 ...
				 "		--and b.emat_ccod in (1,2,4)  " & vbCrlf & _
				 ...
				 "		--and isnull(c.sitf_ccod,'SP') = 'SP' " & vbCrlf & _
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
                <td>
                  <%pagina.DibujarLenguetas lenguetas_evaluacion, 3%>
                </td>
          </tr>
          <tr>
                        ...
                        <td><p> 
                          ...
                          <table width="99%"  border="0">
							...
							<tr>
                              ...
                              <td width="4%">SD</td>
                              <td width="23%">: SIN DERECHO A EXAMEN</td>
                            </tr>
                            <tr>
                              <td>Asignatura</td>
                            ...
                            <tr>
                              ...
                              <td><font color="#FF0000">SP</font></td>
                              <td><font color="#FF0000">: SITUACI&Oacute;N PENDIENTE</font></td>
                            </tr>
                          </table>
                          <br>
                          <br>
                          ...
                          <table width="75%" align="right">
                            <tr> 
                              <td> <div align="right"><%
								   ...
								   if ((examen = TRUE) and (parametro <> "N") )  then %>
                                  <% 
                    ...
                    <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        ...
                        <td><div align="center">
						  ...
						  <td><div align="center"><%botonera.dibujaBoton "cerrar_asignatura"%></div></td>
						<td><div align="center">
