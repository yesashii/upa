...
pers_ncorr 		= request.Form("dp[0][pers_ncorr]")
FDEFUNCION		= request.Form("fdefuncion")
response.write("FDEFUNCION = "&FDEFUNCION)
set f_personas = new CFormulario
f_personas.Carga_Parametros "m_profesionales_upa.xml", "datos_personales"
f_personas.Inicializar conexion
f_personas.ProcesaForm
f_personas.AgregaCampoFilaPost 0, "pers_fdefuncion", FDEFUNCION
...
if pais_ccod = "" or pais_ccod = "1" then
	...
	f_direcciones.Carga_Parametros "m_profesionales_upa.xml", "direcciones"
