...
<html>
<head>
<title>detalle personas excel</title>
...
while f_personas_UPGH.siguiente
	...
	'--------------------<<CapturaVariablea
	insertarCampo num,rut,nombre,sexo,nacimiento,institu,sede,facultad,carrera,gradoAcademico,especialidad,jornada,egresado,fecha_egreso,titulado,fecha_titulo,pregrado,postgrado,ano_ingreso,email,fono_p,celular,facebook,twitter,lindkedin,pais,region,ciudad,comuna,calle,nro,depto,condominio,villa,localidad,ciudad_ext,region_ext,empresa,rubro,depto_2,cargo,email_laboral,web,usuario,fecha_modificacion,tipo_contacto,recibir_info
	contador = contador + 1
	num = Cstr(contador)	
wend							
			'--------------------------------------------------------------------consulta<<
