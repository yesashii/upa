...
<table width="100%" border="1">
		...
		<tr>
			<td width="30%" ><strong>Total general Casa Central</strong></td>
...
<table width="100%" border="1">
		...
		<tr>
			<td width="30%" ><strong>Total general Providencia</strong></td>
			<td width="10%" bgcolor="#FFFFCC"><div align="center"><strong>Arancel</strong></div></td>
			<td width="10%" bgcolor="#FFFFCC"><div align="center"><strong>Titulacion</strong></div></td>
			<td width="10%" bgcolor="#FFFFCC"><div align="center"><strong>Total</strong></div></td>
			<td></td>
...
v_total_arancel		=	arancel_central		+	arancel_providencia		+	arancel_melipilla
v_total_titulacion	=	titulacion_central	+	titulacion_providencia	+	titulacion_melipilla
v_total_total		=	total_central		+	total_providencia		+	total_melipilla
v_presc_total_arancel		=	presc_arancel_central		+	presc_arancel_providencia		+	presc_arancel_melipilla
v_presc_total_titulacion	=	presc_titulacion_central	+	presc_titulacion_providencia	+	presc_titulacion_melipilla
v_presc_total_total			=	presc_total_central			+	presc_total_providencia			+	presc_total_melipilla
