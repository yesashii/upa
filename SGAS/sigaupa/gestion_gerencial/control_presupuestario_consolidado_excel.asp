...
<table width="100%" border="1">
  ...
  <tr> 
    ...
    <td><div align="center"><%=FormatCurrency(Ccur(consolidado.ObtenerValor("arancel")),0)%></div></td>
	<td><div align="center"><%=FormatCurrency(Ccur(consolidado.ObtenerValor("titulacion")),0)%></div></td>
	<td><div align="center"><%=FormatCurrency(Ccur(consolidado.ObtenerValor("total")),0)%></div></td>
	<td></td>
	<td><div align="center"><%=FormatCurrency(Ccur(consolidado.ObtenerValor("presc_aranceles")),0)%></div></td>
	<td><div align="center"><%=FormatCurrency(Ccur(consolidado.ObtenerValor("presc_titulaciones")),0)%></div></td>
	<td><div align="center"><%=FormatCurrency(Ccur(consolidado.ObtenerValor("presc_totales")),0)%></div></td>
