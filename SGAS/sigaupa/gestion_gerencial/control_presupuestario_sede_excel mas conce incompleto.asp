...
<font color="#0000FF" size="+1"><strong>Sede Concepcion</strong></font>
  ...
  <%  
      facu_ccod=0
	  fila = 1
	  contador_concepcion=0 
	while bustamante.Siguiente 

	 if Cint(facu_ccod)=Cint(concepcion.ObtenerValor("presc_facultad")) or Cint(facu_ccod)=0 then
		 contador_concepcion=contador_concepcion+1
	 else
	 	contador_concepcion=0
			if contador_concepcion=0 then
				  %>
					  <TR>
					  <TH >Sub Total :</TH>
					  <TH><b><%=FormatCurrency(arancel_concepcion,0)%></b></TH>
					  <TH><b><%=FormatCurrency(titulacion_concepcion,0)%></b></TH>
					  <TH><b><%=FormatCurrency(total_concepcion,0)%></b></TH>
					  <td></td>
					  <TH><b><%=FormatCurrency(presc_arancel_concepcion,0)%></b></TH>
					  <TH><b><%=FormatCurrency(presc_titulacion_concepcion,0)%></b></TH>
					  <TH><b><%=FormatCurrency(presc_total_concepcion,0)%></b></TH>
					  	<%
						'** DESVIACION POR FACULTAD EN PESOS $
						v_dif_facu_arancel_concepcion	=	arancel_concepcion		-	presc_arancel_concepcion
						v_dif_facu_titulacion_concepcion	=	titulacion_concepcion	-	presc_titulacion_concepcion
						v_dif_facu_total_concepcion	=	total_concepcion			-	presc_total_concepcion
						
						'** DESVIACION POR FACULTAD EN PORCENTAJES %
						v_porc_facu_arancel_concepcion	=	FormatPercent(arancel_concepcion		/	ReemplazaCero(presc_arancel_concepcion),2)
						v_porc_facu_titulacion_concepcion=	FormatPercent(titulacion_concepcion	/	ReemplazaCero(presc_titulacion_concepcion),2)
						v_porc_facu_total_concepcion		=	FormatPercent(total_concepcion		/	ReemplazaCero(presc_total_concepcion),2)

						%>
					  <td></td>
					  <TH><b><%=FormatCurrency(v_dif_facu_arancel_concepcion,0)%></b></TH>
					  <TH><b><%=FormatCurrency(v_dif_facu_titulacion_concepcion,0)%></b></TH>
					  <TH><b><%=FormatCurrency(v_dif_facu_total_concepcion,0)%></b></TH>
					  <td></td>
					  <TH><b><%=v_porc_facu_arancel_concepcion%></b></TH>
					  <TH><b><%=v_porc_facu_titulacion_concepcion%></b></TH>
					  <TH><b><%=v_porc_facu_total_concepcion%></b></TH>
			...
			<%
				  '***	INICIALIZA MONTOS	**********************
				  arancel_concepcion		=	0
				  titulacion_concepcion	=	0
				  total_concepcion			=	0
				  presc_arancel_concepcion	=	0
				  presc_titulacion_concepcion	=	0
				  presc_total_concepcion		=	0			
			end if
		facu_ccod=concepcion.ObtenerValor("presc_facultad")
		contador_concepcion=contador_concepcion+1
	 end if
	   facu_ccod=concepcion.ObtenerValor("presc_facultad")	 

	 if  contador_concepcion=1 then ' dibuja el encabezado por cada facultad
	 %>		
	 <table width="100%" border="1">
	   	<tr> 
			<td bgcolor=""><font color="#0033FF" size="+1"><strong><%=concepcion.ObtenerValor("facultad")%></strong></font></td>
			<td bgcolor="#66CC99" colspan="3"><div align="center"><strong>Ingresos Reales</strong></div></td>
			<td></td>
			<td bgcolor="#66CC99" colspan="3"><div align="center"><strong>Ingresos Presupuestado</strong></div></td>
			<td></td>
	...
	<%end if%> 
  <tr> 
	<td><div align="left"><%=concepcion.ObtenerValor("carrera")%></div></td>
	<td><div align="center"><%=FormatCurrency(concepcion.ObtenerValor("arancel"),0)%></div></td>
    <td><div align="center"><%=FormatCurrency(concepcion.ObtenerValor("titulacion"),0)%></div></td>
	<td><div align="center"><%=FormatCurrency(concepcion.ObtenerValor("total"),0)%></div></td>
	<td></td>
	<td><div align="center"><%=FormatCurrency(concepcion.ObtenerValor("presc_aranceles"),0)%></div></td>
    <td><div align="center"><%=FormatCurrency(concepcion.ObtenerValor("presc_titulaciones"),0)%></div></td>
	<td><div align="center"><%=FormatCurrency(concepcion.ObtenerValor("presc_total"),0)%></div></td>
	<%
	'** DESVIACION POR CARRERAS
	v_dif_arancel_concepcion	=	Ccur(concepcion.ObtenerValor("arancel"))	-	Ccur(concepcion.ObtenerValor("presc_aranceles"))
	v_dif_titulacion_concepcion	=	Ccur(concepcion.ObtenerValor("titulacion"))	-	Ccur(concepcion.ObtenerValor("presc_titulaciones"))
	v_dif_total_concepcion		=	Ccur(concepcion.ObtenerValor("total"))		-	Ccur(concepcion.ObtenerValor("presc_total"))

	v_porc_arancel_concepcion		=	FormatPercent(Ccur(concepcion.ObtenerValor("arancel"))		/	ReemplazaCero(Ccur(concepcion.ObtenerValor("presc_aranceles"))),2)
	v_porc_titulacion_concepcion	=	FormatPercent(Ccur(concepcion.ObtenerValor("titulacion"))	/	ReemplazaCero(Ccur(concepcion.ObtenerValor("presc_titulaciones"))),2)
	v_porc_total_concepcion			=	FormatPercent(Ccur(concepcion.ObtenerValor("total"))		/	ReemplazaCero(Ccur(concepcion.ObtenerValor("presc_total"))),2)

	
	%>
	<td></td>
	<td><div align="center"><%=FormatCurrency(v_dif_arancel_concepcion,0)%></div></td>
    <td><div align="center"><%=FormatCurrency(v_dif_titulacion_concepcion,0)%></div></td>
	<td><div align="center"><%=FormatCurrency(v_dif_total_concepcion,0)%></div></td>
	<td></td>
	<td><div align="center"><%=v_porc_arancel_concepcion%></div></td>
    <td><div align="center"><%=v_porc_titulacion_concepcion%></div></td>
	<td><div align="center"><%=v_porc_total_concepcion%></div></td>
  </tr>
  <% 
  '***	TOTALIZA MONTOS	**********************
  arancel_concepcion	=	Ccur(concepcion.ObtenerValor("arancel"))	+	Ccur(arancel_concepcion)
  titulacion_concepcion	=	Ccur(concepcion.ObtenerValor("titulacion"))	+	Ccur(titulacion_concepcion)
  total_concepcion		=	Ccur(concepcion.ObtenerValor("total"))		+	Ccur(total_concepcion)
  presc_arancel_concepcion		=	Ccur(concepcion.ObtenerValor("presc_aranceles"))	+	Ccur(presc_arancel_concepcion)
  presc_titulacion_concepcion	=	Ccur(concepcion.ObtenerValor("presc_titulaciones"))	+	Ccur(presc_titulacion_concepcion)
  presc_total_concepcion		=	Ccur(concepcion.ObtenerValor("presc_total"))		+	Ccur(presc_total_concepcion)


 '*** Total por Sede
	  arancel_sede_concepcion		=	arancel_sede_concepcion		+	Ccur(concepcion.ObtenerValor("arancel"))
	  titulacion_sede_concepcion	=	titulacion_sede_concepcion	+	Ccur(concepcion.ObtenerValor("titulacion"))
	  total_sede_concepcion			=	total_sede_concepcion		+	Ccur(concepcion.ObtenerValor("total"))	
	  presc_arancel_sede_concepcion		=	presc_arancel_sede_concepcion		+	Ccur(concepcion.ObtenerValor("presc_aranceles"))
	  presc_titulacion_sede_concepcion	=	presc_titulacion_sede_concepcion	+	Ccur(concepcion.ObtenerValor("presc_titulaciones"))
	  presc_total_sede_concepcion		=	presc_total_sede_concepcion			+	Ccur(concepcion.ObtenerValor("presc_total"))
...
<table width="100%" border="1">
		...
		<tr>
			<td width="23%" ><strong>Total general Concepcion</strong></td>
			<td width="16%" bgcolor="#FFFFCC"><div align="center"><strong>Arancel</strong></div></td>
			<td width="10%" bgcolor="#FFFFCC"><div align="center"><strong>Titulacion</strong></div></td>
			<td width="9%" bgcolor="#FFFFCC"><div align="center"><strong>Total</strong></div></td>
			<td></td>
