...
existe_pp=conexion.ConsultaUno("select case count(pers_ncorr) when 0 then 'n' else 's' end from personas_postulante where cast(pers_nrut as varchar)='"&pers_nrut&"'")
	...
	if existe="s" and existe_pp = "n" then
			...
			update_persona 	 = "update personas set pers_tape_paterno='"&pers_tape_paterno&"', pers_tape_materno='"&pers_tape_materno&"', pers_tnombre='"&pers_tnombre&"', eciv_ccod="&eciv_ccod&", pers_fnacimiento=convert(datetime,'"&pers_fnacimiento&"',103) where cast(pers_nrut as varchar)='"&pers_nrut&"'" 
...
for filai = 0 to f_direcciones.CuentaPost - 1
	...
	if dir_p >0 then
		update_dire2="update direcciones set ciud_ccod="&ciud_ccod&",dire_tcalle='"&dire_tcalle&"',dire_tnro='"&dire_tnro&"' where cast(pers_ncorr as varchar)='"&pers_ncorr&"' and tdir_ccod=1 "
...
'			insert_dire="insert into direcciones_publica (tdir_ccod,pers_ncorr,ciud_ccod,dire_tcalle,dire_tnro) values (1,"&pers_ncorr&","&ciud_ccod&",'"&dire_tcalle&"','"&dire_tnro&"')"
'			conexion.ejecutaS (insert_dire)		
'	update_dire="update direcciones set ciud_ccod="&ciud_ccod&",dire_tcalle='"&dire_tcalle&"',dire_tnro='"&dire_tnro&"' where cast(pers_ncorr as varchar)='"&pers_ncorr&"' and tdir_ccod=1 "
'		conexion.ejecutaS (update_dire)
'	end if
'	if existe ="n" and existe_pp="s" then
'	
