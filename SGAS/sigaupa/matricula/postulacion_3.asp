...
"  LEFT JOIN colegios d " & vbCrLf &_
"  ON b.cole_ccod = d.cole_ccod " & vbCrLf &_
"  LEFT JOIN direcciones_publica e " & vbCrLf &_
"  ON b.pers_ncorr = e.pers_ncorr and e.tdir_ccod = 3" & vbCrLf &_
"  WHERE cast(a.post_ncorr as varchar)= '" & v_post_ncorr & "'" 
...
'RESPONSE.End() 
	...
	f_antecedentes.AgregaCampoParam "cole_ccod", "filtro", "ciud_ccod = '" & q_ciud_ccod_colegio & "' and isnull(cole_trbd,'') <> ''"
else
...
"    else 'S' " & vbCrLf &_
" end as     actividad_realizada " & vbCrLf &_
" from actividades_realizadas a LEFT JOIN actividades_postulantes b  " & vbCrLf &_
...
consulta =" select a.tacp_ccod, a.tacp_tdesc,   " & vbCrLf &_
			...
			"     else 'S'  " & vbCrLf &_
			" end as    bparticipar   " & vbCrLf &_
			" from tipos_actividades_participar a LEFT JOIN actividades_participar_post b   " & vbCrLf &_
...
function ties_ccod_Click()
{
	...
	// borrado por que el campo post_ttipo_institucion_ant fue comentado
//	if (v_ties_ccod == "0") {
                  ...
                  <tr>
                    <td>                    <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          ...
                          <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="50%">Otro Colegio <%f_antecedentes.DibujaCampo("otro_colegio")%>
 </td>
                      ...
                      <br>                      
					   <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td colspan="2" align="left"><font size="2" color="#000000"><strong>Tipo de Colegio</strong></font></td>
                        </tr>
						<tr>
