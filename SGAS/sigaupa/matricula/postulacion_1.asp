...
consulta_especialidades = "select distinct b.sede_ccod, c.carr_ccod, c.espe_ccod, c.espe_tdesc " & vbCrLf &_
	...
	'response.Write("<pre>"&consulta_especialidades&"</pre>")									  
                  ...
                  <tr>
                    <td><p>
                      ...
                      <table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="24%" height="20"><strong>Nombre Postulante </strong></td>
                          <td width="2%" height="20"><strong>:</strong></td>
						...
						<tr>
                          ...
                          <td height="20"><strong>:</strong></td>
                          <td height="20"><font size="+1"><b><%=peri_tdesc%></b></font></td>
                        </tr>
                      </table>                      <p><br>
