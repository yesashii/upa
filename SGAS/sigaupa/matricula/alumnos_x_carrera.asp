...
f_botonera.Carga_Parametros "alumnos_x_carrera.xml", "botonera"

'---------------------------------------------------------------------------------------------------
set f_busqueda = new CFormulario
f_busqueda.Carga_Parametros "alumnos_x_carrera.xml", "busqueda"
...
f_cheques.Carga_Parametros "alumnos_x_carrera.xml", "cheques"
f_cheques.Inicializar conexion


		
  if q_carr_ccod ="" and q_peri_ccod = "" then
  ...
  <tr>
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
              ...
              <table width="67%"  border="0" align="center">
                <tr>
					...
					<td width="12%"><strong>Carreras :</strong></td>
				  	<td width="28%"><div align="left"><%f_busqueda.DibujaCampo("carr_ccod")%></div>
					</div></td>
					<td width="19%"></div></td>
					...
					<table width="67%"  border="0" align="rigth">
					  <td width="16%"><strong>Periodo :</strong></td>
				  	    <td width="26%"><div align="left"><%f_busqueda.DibujaCampo("peri_ccod")%></div>
					<td width="46%" > </td>
					<td width="12%"></td>
                </tr>
              </table>
        ...
        <td width="7" background="file://///Sga/sistema/imagenes/der.gif"></td>
      </tr>
      <tr>
        <td width="9" height="13"><img src="file://///Sga/sistema/imagenes/base1.gif" width="9" height="13"></td>
        <td height="13" background="file://///Sga/sistema/imagenes/base2.gif"></td>
        <td width="7" height="13"><img src="file://///Sga/sistema/imagenes/base3.gif" width="7" height="13"></td>
      </tr>
    </table>
	<br>
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      <tr>
        <td width="9" height="8"><img name="top_r1_c1" src="file://///Sga/sistema/imagenes/top_r1_c1.gif" width="9" height="8" border="0" alt=""></td>
        <td height="8" background="file://///Sga/sistema/imagenes/top_r1_c2.gif"></td>
        <td width="7" height="8"><img name="top_r1_c3" src="file://///Sga/sistema/imagenes/top_r1_c3.gif" width="7" height="8" border="0" alt=""></td>
      </tr>
      <tr>
        <td width="9" background="file://///Sga/sistema/imagenes/izq.gif">&nbsp;</td>
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas Array("Resultados de la búsqueda"), 1 %></td>
          </tr>
          <tr>
            <td height="2" background="file://///Sga/sistema/imagenes/top_r3_c2.gif"></td>
          </tr>
		  <tr>
		  <td><div align="center">
                    <br>
      ...
      <tr>
        <td width="9" height="28"><img src="file://///Sga/sistema/imagenes/abajo_r1_c1.gif" width="9" height="28"></td>
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center">
					...
					<%f_botonera.AgregaBotonParam "excel", "url", "alumnos_x_carrera_excel.asp?carr_ccod="&q_carr_ccod&"&peri_ccod="&q_peri_ccod
