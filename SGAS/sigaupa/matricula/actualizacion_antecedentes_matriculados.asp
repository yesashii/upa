...
pagina.Titulo = "Actualización de antecedentes Alumnos"
...
f_botonera.Carga_Parametros "actualizacion_antecedentes_matriculados.xml", "botonera"


'---------------------------------------------------------------------------------------------------
set f_busqueda = new CFormulario
f_busqueda.Carga_Parametros "actualizacion_antecedentes_matriculados.xml", "busqueda"
...
f_alumno.Carga_Parametros "actualizacion_antecedentes_matriculados.xml", "alumno"
f_alumno.Inicializar conexion

v_peri_ccod = negocio.ObtenerPeriodoAcademico("POSTULACION")

if  q_pers_nrut<>"" then
s_es_alumno="select case count(*) when 0 then 'N' else 'S' end from alumnos a, postulantes b" & vbCrLf &_
			"where a.PERS_NCORR=b.PERS_NCORR"& vbCrLf &_
			"and a.POST_NCORR=b.POST_NCORR"& vbCrLf &_
			"and b.PERI_CCOD="&v_peri_ccod&""& vbCrLf &_
			"and a.pers_ncorr=protic.obtener_pers_ncorr('"&q_pers_nrut&"')"
es_alumno=conexion.ConsultaUno(s_es_alumno)		
end if
...
if f_alumno.NroFilas = 0 then	
	...
	sql_post_ncorr = "select top 1 b.post_ncorr " & vbCrLf &_
				   "from personas_postulante a, postulantes b  " & vbCrLf &_
				   "where a.pers_ncorr = b.pers_ncorr  " & vbCrLf &_
				   "  and b.peri_ccod = " & v_peri_ccod & "  " & vbCrLf &_
				   "  and cast(a.pers_nrut as varchar)='" & q_pers_nrut & "' "
	post_ncorr=conexion.consultaUno(sql_post_ncorr)
else
     sql_post_ncorr="select top 1 b.post_ncorr" & vbCrLf &_
           "from personas a, alumnos b " & vbCrLf &_
		   "where a.pers_ncorr = b.pers_ncorr " & vbCrLf &_
            ...
            <td width="29%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <td><div align="center">
				  		<%
				  			f_botonera.agregabotonparam "imprimir_alumno", "url", "../REPORTESNET/ficha_alumno.aspx?post_ncorr="&post_ncorr  
						 	f_botonera.dibujaboton "imprimir_alumno"
						 %> </div>
				  </td>
				<%end if%>
                  </tr>
