...
'/***************************************************/
'// INICIO VERIFICAR UN MÁXIMO DE TRES POSTULACIONES
'/************************************************/
function tiene3postulaciones(f_post_ncorr)

  retorno             = "0" 'false
  consultaAux         = "select protic.numero_postulaciones('"&f_post_ncorr&"');"
  numPostulaciones    = cint( conexion.ConsultaUno(consultaAux) )

  if(numPostulaciones > 2) then
    retorno = "1" ' true
  end if

  tiene3postulaciones = retorno

end function

'prueba de la function
'  tieneMasDeTres  = tiene3postulaciones(v_post_ncorr)
'  if(tieneMasDeTres = "1") then
'    %><script>//alert("ya tiene 3 carreras");</script><%
'  end if

'/************************************************/
'// FIN VERIFICAR UN MÁXIMO DE TRES POSTULACIONES
'/*********************************************/
                    ...
                    <td><p>
                      ...
                      <p><br>
                          ...
                          <table width="90%" align="center" cellpadding="0" cellspacing="0">
                            <%
                            'Inicio condicion tres postulaciones
                            tieneMasDeTres  = tiene3postulaciones(v_post_ncorr) ' llamado a la función 0 falso 1 verdadero
                            if(tieneMasDeTres = "1") then
                            %>
                                                      <tr><td height="20"><font size="2" color="#0066FF"><b>Ya complet&oacute; sus tres postulaciones.</b></font></td></tr>
                            <%else%>
                                                      <tr>
                          ...
                          ' fin condicion tiene mas de tres postulaciones.
                          %>
                          </table>
                          <p>
