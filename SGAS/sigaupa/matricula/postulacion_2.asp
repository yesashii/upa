...
v_post_antiguo = Session("v_post_antiguo")
v_matriculado = Session("ses_matriculado")
...
"   b.pers_femision_pas, b.pers_fvencimiento_pas, isnull(b.pers_bdoble_nacionalidad,'N') as pers_bdoble_nacionalidad, " & vbCrLf &_
...
function CopiarDireccionParticular()
{
	...
	t_datos_personales.AsignarValor(0, "dire_tblock_academico", t_datos_personales.ObtenerValor(0, "dire_tblock_particular"));*/
	
	
	
v_ciudad	=	document.edicion.elements["dp[0][ciud_ccod_particular]"].value;
v_region	=   document.edicion.elements["dp[0][regi_ccod_particular]"].value;
	...
	_FiltrarCombobox(document.edicion.elements["dp[0][ciud_ccod_academico]"], 
		...
		calle = document.edicion.elements['dp[0][dire_tcalle_particular]'].value;
		nro   = document.edicion.elements['dp[0][dire_tnro_particular]'].value;
		pobla = document.edicion.elements['dp[0][dire_tpoblacion_particular]'].value;
		block = document.edicion.elements['dp[0][dire_tblock_particular]'].value;
		fono = document.edicion.elements['dp[0][pers_tfono]'].value;
		
		document.edicion.elements['dp[0][ciud_ccod_academico]'].value = v_ciudad;
		document.edicion.elements['dp[0][regi_ccod_academico]'].value = v_region;
		
		document.edicion.elements['dp[0][dire_tcalle_academico]'].value = calle;
		document.edicion.elements['dp[0][dire_tnro_academico]'].value = nro;
		document.edicion.elements['dp[0][dire_tblock_academico]'].value = block;
		document.edicion.elements['dp[0][dire_tpoblacion_academico]'].value= pobla;
		document.edicion.elements['dp[0][dire_tfono_academico]'].value = fono;
...
{  var pais;
    ...
    pais=<%=cint(pais)%>
	//alert("pais "+pais);
	if	(document.edicion.elements["dp[0][tvis_ccod]"].value==3)
		document.edicion.elements["dp[0][pers_fvencimiento_pas]"].id="FE-S";
	else
		document.edicion.elements["dp[0][pers_fvencimiento_pas]"].id="FE-S";	
		//document.edicion.elements["dp[0][pers_fvencimiento_pas]"].id="FE-N";	
	//tvis_ccod
	if (pais == 1){
...
function cambiar_obligatorio(valor)
{
if 	(valor==3)
	document.edicion.elements["dp[0][pers_fvencimiento_pas]"].id="FE-S";
else
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas lenguetas_postulacion, 2				  
				%></td>
          </tr>
          <tr>
                    ...
                    <td><%pagina.DibujarSubtitulo "Postulaciones"%><br>
                      ...
                      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr> 
                              ...
                              <td><%if cint(pais)=1 then %>
							  <span class="style3">(*)</span> <strong>CIUDAD DE NACIMIENTO </strong><br> 
                                <%
								  ...
								  <%
								   		...
								   		f_datos_personales.AgregaCampoParam "ciud_nacimiento","id","TO-S"
                      ...
                      <br>
					  <br>
                      <%pagina.DibujarSubtitulo("3. Domicilio en el período académico")%> 
                      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><strong>
                            <%if cint(pais)=1 then
                      ...
                      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr> 
                              ...
                              <td width="14%">&nbsp;<strong>DEPTO<br><strong> 
                      ...
                      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="50%"><span class="style3">(*)</span><strong>CORREO ELECTR&Oacute;NICO </strong><br>
                              <strong>
