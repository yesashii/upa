...
' si no se ha generado pago y existe al menos una carrera ke cobra de las que ha postulado y el alumno no esta exento
if(v_existe_compromiso = 0) and (v_carrera_pagan > 0) And (v_paga=0) then
