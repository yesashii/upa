...
pagina.Titulo = "Administración de Funcionarios"
'---------------------------------------------------------------------------------------------------
...
'--------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "cambio_clave.xml", "busqueda_usuarios_nuevo"
...
botonera.Carga_Parametros "cambio_clave.xml", "botonera"
'--------------------------------------------------------------------------
...
if es_usuario = "S" then
 ...
 f_datos.Carga_Parametros "cambio_clave.xml", "f1_edicion"
 f_datos.Inicializar conexion
 f_datos.Consultar "select top 1 a.pers_ncorr, b.susu_tlogin,b.susu_tclave,'Badilla' as actualizado_por from   personas a, sis_usuarios b where cast(a.pers_nrut as varchar)= '"&rut&"' and a.pers_ncorr=b.pers_ncorr"
 f_datos.Siguiente
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" aling="center">
                ...
                <td bgcolor="#D8D8DE"> <div align="center">&nbsp; 
				  ...
				  <table width="100%" border="0">
					...
					<%if es_usuario = "S" then%>
					<tr> 
                      <td align="left" width="15%"><strong>Login</strong></td>
					  <td align="left" width="2%"><strong>:<%f_datos.dibujaCampo("pers_ncorr")%></strong></td>
					  <td align="left"><%f_datos.dibujaCampo("susu_tlogin")%></td>
					</tr>
					<tr> 
