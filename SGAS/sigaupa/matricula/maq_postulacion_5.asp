        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td><%				
				pagina.DibujarLenguetas Array("Informaci&oacute;n general", "Datos Personales", "Ant. Acad&eacute;micos", "Ant. Familiares", "Apoderado Sostenedor"), 5
				%></td>
      ...
      <input name="textfield22" type="text" size="1"></td>
                            ...
                            <table width="98%"  border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td><input name="r2" type="radio" value="radiobutton">
                                  OTRO
    <input type="text" name="textfield6"></td></tr>
                            </table>
                            <br>
                            <br>
                            <table width="98%"  border="0" cellspacing="0" cellpadding="0">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="237" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><div align="center"><%pagina.DibujarBoton "Anterior" , "NAVEGAR", "maq_postulacion_4.asp"%></div></td>
                      <td><div align="center">
                        <%pagina.DibujarBoton "Siguiente" , "NAVEGAR", "maq_postulacion_6.asp"%>
                      </div></td>
                      <td><div align="center">
