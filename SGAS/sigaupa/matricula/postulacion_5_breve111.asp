...
v_pariente_grupofamiliar=conexion.ConsultaUno("select case count(*) when 0 then 'No' else 'sí' end as está"& vbCrLf &_
...
'response.End()
 ...
 if (Cstr(q_pare_ccod) <> Cstr(v_pare_ccod_codeudor))  or v_pare_ccod_codeudor="0" then
