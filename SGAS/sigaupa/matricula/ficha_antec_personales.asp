...
'-------------------------------------------------------------------------
 ...
 if q_npag = 1 then
  ...
  if q_npag = 1 then
 	f_botonera.AgregaBotonParam "pagina2", "texto", "Ir a página 2"
 	dir_JS = "ficha_antec_personales.asp?busqueda[0][pers_nrut]="&q_pers_nrut&"&busqueda[0][pers_xdv]="&q_pers_xdv&"&npag=2&traspaso=1"
 else
 	dir_JS = "ficha_antec_personales.asp?busqueda[0][pers_nrut]="&q_pers_nrut&"&busqueda[0][pers_xdv]="&q_pers_xdv&"&npag=1&traspaso=1"
	f_botonera.AgregaBotonParam "pagina2", "texto", "Ir a página 1"
 end if
 end if
%>
...
function imprimir() 
  {
  var q_pers_nrut='<%=q_pers_nrut%>';
  var q_pers_xdv='<%=q_pers_xdv%>';
  var npag='<%=q_npag%>'; 
  var direccion;
  
  direccion="impresion_ficha_antecedentes.asp?busqueda[0][pers_nrut]="+q_pers_nrut+"&busqueda[0][pers_xdv]="+q_pers_xdv+"&npag="+npag;
  window.open(direccion ,"ventana1","width=755,heigt=455,left=200,top=200,scrollbars=yes");
  //scrollbars=yes,
  }
//-------------------------------------------------------------
function mensaje()
...
<table width="750" height="50%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<%end if%>
	<% if q_pers_nrut <>"" and fc_datos.nrofilas > 0  then %>
      <br>
				...
				<form name="edicion">
                    ...
                    <table width="100%" border="0" cellpadding="1" cellspacing="3" bgcolor="#D8D8DE">
					  ...
					  <tr><td colspan="4" height="20"><table width="80%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
														<tr> 
														  <td height="20" bordercolor="#CCCCCC" bgcolor="#F0F0F0"><%=fDatosPer.dibujaCampo("email_alumno")%></td>
														</tr>
													  </table>
						 </td>
					  </tr>
					  ...
					  <tr><td colspan="4" height="20"><table width="80%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
														<tr> 
														  <td height="20" bordercolor="#CCCCCC" bgcolor="#F0F0F0"><%=fDatosPer.dibujaCampo("email_sost")%></td>
														</tr>
													  </table>
						 </td>
					  </tr>
                    ...
                    <table width="100%" border="0" cellpadding="1" cellspacing="3" bgcolor="#D8D8DE">
                      ...
                      <tr> 
                        <td height="10"><font size="2"><strong> </strong></font> 
                          <table width="56%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
                            <tr> 
                      ...
                      <tr> 
                        ...
                        <td height="10"><table width="50%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
                            <tr> 
                              <td height="20" align="right" bordercolor="#CCCCCC" bgcolor="#F0F0F0">
							  	<% puntaje_PSU= fDatosPer2.obtenerValor("pje_prom_PAA") 
								    if esVacio(puntaje_PSU) or puntaje_PSU < "475" then
