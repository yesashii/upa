                      ...
                      <td bgcolor="#D8D8DE"><div align="center"> 
                          <form name="buscador">
                            <table width="98%"  border="0">
							  ...
							  <%if negocio.obtenerUsuario = "13813352" or negocio.obtenerUsuario = "11592558" then%>
							  <tr>
				  ...
				  <table width="100%" border="0">
					...
					<tr>
					   <td colspan="3" height="30" align="center" bgcolor="#d8d8de">
					                 <%botonera.agregaBotonParam "autorizar","url","guardar_asistencia_laboratorio.asp?rut="&rut&"&digito="&digito
									   botonera.DibujaBoton "autorizar" %>
				      </td>
					</tr>
