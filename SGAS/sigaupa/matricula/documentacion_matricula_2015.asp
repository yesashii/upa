...
q_tfma_ccod = Request.QueryString("documentos[0][tfma_ccod]")

'response.Write(q_tfma_ccod)
'---------------------------------------------------------------------------------------------------
...
'response.Write("q_pers_nrut: "&q_pers_nrut)
...
'response.Write("2")
'	consulta = "select distinct dpos.PERS_NCORR,dpos.DOMA_CCOD,doma_entregado,doc.DOMA_TDESC," & vbcrlf & _
'"case doma_entregado when 0 then 'N' else 'S' end as entregado," & vbcrlf & _
'"case doma_retirado when 0 then 'N' else 'S' end as retirado,protic.trunc(dpos.fecha_retiro) as fecha_retiro" & vbcrlf & _
'"from DOCUMENTOS_MATRICULA_TIPO_GRADO_CARRERA   con," & vbcrlf & _
'"     TIPOS_FORMA_MATRICULA                     fma," & vbcrlf & _
'"     TIPOS_CARRERA                             tip," & vbcrlf & _
'"     TIPOS_GRADOS_CARRERAS                     tca," & vbcrlf & _
'"     DOCUMENTOS_MATRICULA                      doc," & vbcrlf & _
'"     DOCUMENTOS_POSTULANTES					   dpos," & vbcrlf & _
'"(select '"&v_pers_ncorr&"' as pers_ncorr,a.*, " & vbcrlf & _
'"    (select count(*) from documentos_postulantes b " & vbcrlf & _
'"    where a.doma_ccod=b.doma_ccod and cast(b.pers_ncorr as varchar)='"&v_pers_ncorr&"' " & vbcrlf & _
'" and isnull(b.entregado,'S') <> 'N') as doma_entregado, " & vbcrlf & _  
'"    (select count(*) from documentos_postulantes b " & vbcrlf & _
'"    where a.doma_ccod=b.doma_ccod and cast(b.pers_ncorr as varchar)='"&v_pers_ncorr&"' " & vbcrlf & _
'"and isnull(b.retirado,'N') = 'S') as doma_retirado,   " & vbcrlf & _
'"    (select ltrim(rtrim(fecha_retiro)) from documentos_postulantes b " & vbcrlf & _
'"    where a.doma_ccod=b.doma_ccod and cast(b.pers_ncorr as varchar)='"&v_pers_ncorr&"' " & vbcrlf & _
'") as fecha_retiro   " & vbcrlf & _
'"    from documentos_matricula a where a.doma_ccod not in (4,8) " & vbcrlf & _
'" )table_1      " & vbcrlf & _
'"where con.TFMA_CCOD = fma.TFMA_CCOD" & vbcrlf & _
'"and   con.TCAR_CCOD = tip.TCAR_CCOD" & vbcrlf & _
'"and   con.TGRA_CCOD = tca.TGRA_CCOD" & vbcrlf & _
'"and   con.DOMA_CCOD = doc.DOMA_CCOD" & vbcrlf & _
'"and   con.doma_ccod=dpos.doma_ccod " & vbcrlf & _
'"and table_1.doma_ccod=con.DOMA_CCOD" & vbcrlf & _
'"and	  con.TFMA_CCOD="&q_tfma_ccod & vbcrlf & _
'"and cast(dpos.pers_ncorr as varchar)='"&v_pers_ncorr&"'"			

consulta = "select distinct table_1.PERS_NCORR, " & vbcrlf & _
               " doc.DOMA_CCOD, " & vbcrlf & _
               " doma_entregado," & vbcrlf & _
               " doc.DOMA_TDESC," & vbcrlf & _
               " case doma_entregado when 0 then 'N' else 'S' end as entregado," & vbcrlf & _
               " case doma_retirado when 0 then 'N' else 'S' end as " & vbcrlf & _ 
			   " retirado,protic.trunc(table_1.fecha_retiro) as fecha_retiro " & vbcrlf & _
" from DOCUMENTOS_MATRICULA_TIPO_GRADO_CARRERA   con, " & vbcrlf & _
"     TIPOS_FORMA_MATRICULA                     fma, " & vbcrlf & _
"     TIPOS_CARRERA                             tip, " & vbcrlf & _
"     TIPOS_GRADOS_CARRERAS                     tca, " & vbcrlf & _
"     DOCUMENTOS_MATRICULA                      doc, " & vbcrlf & _
"    (select '"&v_pers_ncorr&"' as pers_ncorr, a.*,  " & vbcrlf & _
"            (select count(*) from documentos_postulantes b where a.doma_ccod=b.doma_ccod and " & vbcrlf & _
" cast(b.pers_ncorr as varchar)='"&v_pers_ncorr&"' and isnull(b.entregado,'S') <> 'N') as doma_entregado, " & vbcrlf & _
"           (select count(*) from documentos_postulantes b where a.doma_ccod=b.doma_ccod and " & vbcrlf & _
"cast(b.pers_ncorr as varchar)='"&v_pers_ncorr&"' and isnull(b.retirado,'N') = 'S') as doma_retirado,   " & vbcrlf & _
" (select ltrim(rtrim(fecha_retiro)) from documentos_postulantes b where a.doma_ccod=b.doma_ccod " & vbcrlf & _ 
"and cast(b.pers_ncorr as varchar)='"&v_pers_ncorr&"' ) as fecha_retiro   " & vbcrlf & _
"   from documentos_matricula a where a.doma_ccod not in (4,8) " & vbcrlf & _
"     ) as table_1 " & vbcrlf & _
" where con.TFMA_CCOD = fma.TFMA_CCOD " & vbcrlf & _
" and   con.TCAR_CCOD = tip.TCAR_CCOD " & vbcrlf & _
...
" and table_1.doma_ccod=con.DOMA_CCOD " & vbcrlf & _
" and     con.TFMA_CCOD="&q_tfma_ccod  & vbcrlf & _
" and cast(table_1.pers_ncorr as varchar)='"&v_pers_ncorr&"'"
end if	
...
f_forma.Carga_Parametros "documentacion_matricula.xml", "f_forma_mat"
 ...
 f_forma.AgregaCampoCons "tfma_ccod", q_tfma_ccod
 f_forma.Siguiente

'response.Write("select tfma_ccod from ALUMNOS_FORMA_MATRICULA where cast(pers_ncorr as varchar)='"&v_pers_ncorr&"' order by audi_fmodificacion desc")
'--------------------------------------------------------------------------------------------------
...
function imprimir() {
  ...
  var direccion;
  rut=<%=q_pers_nrut%>
  q_tfma_ccod=<%=q_tfma_ccod%>
  direccion="impr_doc_matricula_2015.asp?pers_nrut="+rut+"&q_tfma_ccod="+q_tfma_ccod;
