...
pagina.Titulo = "Ingreso de presupuesto 2015"
'---------------------------------------------------------------------------------------------------
...
'				end if
		...
		case 2:
			...
			if codcaja = "" then
				filtro_codcaja = "where area_ccod='"&area_ccod&"' "
			else
			    filtro_codcaja = "where cod_pre = '"&codcaja&"' "
			end if
...
'			if codcaja <> "" then
'			 
'				sql_presupuestado	=" SELECT eje_ccod, prog_ccod, foco_ccod, proye_ccod,concepto, detalle, cod_pre,isnull(total,0) as total, "& vbCrLf &_
...
'									"  and cod_anio=year(getdate())+1"
'			end if
'			'RESPONSE.WRITE(sql_presupuestado)
'			f_presupuestado.consultar sql_presupuestado
			

'-----------------------------------------
'--		PESTAÑA SOLICITUD CENTRALIZADA	--
'------------------------------------------------------------------------------------------------>>			
case 3:
				  ...
				  <table width="632"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EDEDEF">
                    ...
                    <tr> 
                      ...
                      <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td> 
                              <%pagina.DibujarLenguetasFClaro Array(array("Ingreso De Presupuesto","ingreso_presupuesto_directo_2014.asp?area_ccod="&area_ccod&"&codcaja="& codcaja &"&nro_t=1"),array("Presupuesto","ingreso_presupuesto_directo_2014.asp?area_ccod="&area_ccod&"&codcaja="& codcaja &"&nro_t=2"),array("Solicitud Centralizada","ingreso_presupuesto_directo_2014.asp?area_ccod="&area_ccod&"&codcaja="& codcaja &"&nro_t=3")), nro_t %>
                            </td>
                          </tr>
                          <tr> 
...
<form name="busca_codigo" id="busca_codigo" method="get">
...
<tr>
	<td><span id="estado_1"></span></td>
									...
									<tr>
										<td align="center"><a href="./BASES_PRESUPUESTARIA_2015_DEF.pdf" target="_new"><img src="../imagenes/bases_presupuesto.png" border="0" alt="Descargar Bases" align="middle" /></a></td>
									...
									<tr>
										<th>Bases Presupuesto 2015</th>
										<!--<th>Manual Instrucciones Planificacion</th>-->
									</tr>
									</table>
									</td>
								<td width="70%"><span id="tablaTotal"></span></td></tr>
</form>								
							<tr><td colspan="2">  
								  <%if mes_venc<>"" then%>
								  <form name="edicion" >
								...
								<form name="presupuesto" method="post">
									...
									<table width="100%" border="1" align="center" >
										<tr  bgcolor='#C4D7FF' bordercolor='#999999'> 
                                          ...
                                          <th width="25%">TIPO</th>
										  <th width="25%"><%=traeNombre("eje")%></th>
										  <th width="25%"><%=traeNombre("foco")%></th>
										  <th width="25%"><%=traeNombre("programa")%></th>
										  <th width="25%"><%=traeNombre("proyecto")%></th>
										  <th width="25%">Objetivo Del PDEI</th>
...
'-------------------------------------
	case else:%>	 
		...
		<center><font size="2" color="#FF0000">Su área presupuestaria, no centraliza solicitudes de presupuesto</font></center>
	<%End Select%>											 
<%End Select%>
						<br/>
						</td></tr></table>
