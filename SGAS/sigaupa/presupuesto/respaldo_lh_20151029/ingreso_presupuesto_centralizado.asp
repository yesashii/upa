				  ...
				  <table width="632"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EDEDEF">
                    ...
                    <tr> 
                      ...
                      <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td> 
                              <%pagina.DibujarLenguetasFClaro Array(array("Audiovisual","ingreso_presupuesto_centralizado.asp?area_ccod="&area_ccod&"&nro_t=1"),array("Biblioteca","ingreso_presupuesto_centralizado.asp?area_ccod="&area_ccod&"&nro_t=2"),array("TIC","ingreso_presupuesto_centralizado.asp?area_ccod="&area_ccod&"&nro_t=3"),array("Operaciones","ingreso_presupuesto_centralizado.asp?area_ccod="&area_ccod&"&nro_t=4"),array("Recursos Humanos","ingreso_presupuesto_centralizado.asp?area_ccod="&area_ccod&"&nro_t=5"),array("Recursos de apoyo a la docencia","ingreso_presupuesto_centralizado.asp?area_ccod="&area_ccod&"&nro_t=6")), nro_t %>
                            </td>
                          </tr>
                          <tr> 
							...
							%>
								...
								<table width="95%" border="1" align="center"  >
									<tr  bgcolor='#C4D7FF' bordercolor='#999999'> 
									  ...
									  <th width="51%"><%=traeNombre("eje")%></th>
									  <th width="9%"><%=traeNombre("foco")%></th>
									  <th width="9%"><%=traeNombre("programa")%></th>
									  <th width="51%"><%=traeNombre("proyecto")%></th>
									  <th width="9%"><%=traeNombre("objetivo")%></th>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td><%=cadenaTabla(v_eje)%></td>
									  <td><%=cadenaTabla(v_foco)%></td>
									  <td><%=cadenaTabla(v_programa)%></td>
									  <td><%=cadenaTabla(v_proyecto)%></td>									  
									  <td><%=cadenaTabla(v_objetivo)%></td>
