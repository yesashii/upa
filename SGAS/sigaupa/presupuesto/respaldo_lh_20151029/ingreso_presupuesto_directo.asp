...
<%
sin_bloqueo=false '(bloquea las nuevas solicitudes)
...
'				end if
				...
				sql_meses= "	select  upper(nombremes) as mes,indice as mes_venc,sum(cast(isnull(solicitado,0) as numeric)) as solicitado,   "& vbCrLf &_ 
							...
							"				from presupuesto_upa.protic.vis_ejecucion_presupuesto_aprobado     "& vbCrLf &_
...
-->
									...
									<div align="center"><b>Descargar las bases presupuestarias 2011</b><br/>
								  <a href="BASES FOR PRESUPUESTARIA 2011.pdf" target="_new"><img src="../imagenes/descargar.png" width="75" height="75" border="0" alt="Descargar Bases" align="middle" /></a></div></td>
								<td width="70%">
