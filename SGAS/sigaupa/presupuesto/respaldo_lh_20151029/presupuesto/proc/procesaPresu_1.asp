...
ene 			= request.Form("test[0][solicitado]")
feb 			= request.Form("test[1][solicitado]")
mar 			= request.Form("test[2][solicitado]")
abr 			= request.Form("test[3][solicitado]")
may 			= request.Form("test[4][solicitado]")
jun 			= request.Form("test[5][solicitado]")
jul 			= request.Form("test[6][solicitado]")
ago 			= request.Form("test[7][solicitado]")
sep 			= request.Form("test[8][solicitado]")
octu	 		= request.Form("test[9][solicitado]")
nov		 		= request.Form("test[10][solicitado]")
dic		 		= request.Form("test[11][solicitado]")
total			= request.Form("total_solicitud_") 
cpre_ncorr		= detalle
