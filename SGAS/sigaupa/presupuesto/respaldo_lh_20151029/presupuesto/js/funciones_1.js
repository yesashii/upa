...
//alert("prueba="+cod_pre);// +"&eje_ccod="+eje_ccod
	urlAux="presupuesto/trozosHtml/tablaMeses.asp?valor="+cod_pre+"&eje_ccod="+eje_ccod+"&foco_ccod="+foco_ccod+"&prog_ccod="+prog_ccod+"&proye_ccod="+proye_ccod+"&obje_ccod="+obje_ccod+"&area_ccod="+area_ccod+"&cpre_ncorr="+cpre_ncorr;
	$.ajax({
			async:true,
			type: "GET",			  
			url: urlAux,
