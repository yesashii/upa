...
case 6:
	...
	case 7:
			v_ccau_ncorr = conexion2.ConsultaUno("exec presupuesto_upa.dbo.obtenersecuencia 'audiovisual'")						
			sql_ingreso_solicitud= ""& vbCrLf &_
									"insert into presupuesto_upa.protic.centralizar_solicitud_vicerectoriaAcademica "& vbCrLf &_
									"            (mes_ccod,                                               "& vbCrLf &_
									"             tpre_ccod,                                              "& vbCrLf &_
									"             ccau_ncorr,                                             "& vbCrLf &_
									"             ccau_tdesc,                                             "& vbCrLf &_
	...
	case 8:
			v_ccau_ncorr = conexion2.ConsultaUno("exec presupuesto_upa.dbo.obtenersecuencia 'audiovisual'")						
			sql_ingreso_solicitud= ""& vbCrLf &_
									"insert into presupuesto_upa.protic.centralizar_solicitud_dae "& vbCrLf &_
									"            (mes_ccod,                                               "& vbCrLf &_
									"             tpre_ccod,                                              "& vbCrLf &_
									"             ccau_ncorr,                                             "& vbCrLf &_
									"             ccau_tdesc,                                             "& vbCrLf &_
	...
	case 9:
			v_ccau_ncorr = conexion2.ConsultaUno("exec presupuesto_upa.dbo.obtenersecuencia 'audiovisual'")						
			sql_ingreso_solicitud= ""& vbCrLf &_
									"insert into presupuesto_upa.protic.centralizar_solicitud_aceguraCalidad "& vbCrLf &_
									"            (mes_ccod,                                               "& vbCrLf &_
									"             tpre_ccod,                                              "& vbCrLf &_
									"             ccau_ncorr,                                             "& vbCrLf &_
									"             ccau_tdesc,                                             "& vbCrLf &_
