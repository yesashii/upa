...
if v_usuario= "13493596" or v_usuario="9251062" or v_usuario="11843248" or v_usuario="8043252" then
	sin_bloqueo=true
end if
				  ...
				  <table width="632"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EDEDEF">
                    ...
                    <tr> 
                      ...
                      <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td> 
                              <%pagina.DibujarLenguetasFClaro Array(array("Ingreso De Presupuesto","ingreso_presupuesto_directo_2015.asp?area_ccod="&area_ccod&"&codcaja="&codcaja&"&nro_t=1"),array("Presupuesto","ingreso_presupuesto_directo_2015.asp?area_ccod="&area_ccod&"&codcaja="& codcaja &"&nro_t=2"),array("Solicitud Centralizada","ingreso_presupuesto_directo_2015.asp?area_ccod="&area_ccod&"&codcaja="& codcaja &"&nro_t=3")), nro_t %>
                            </td>
                          </tr>
                          <tr> 
