...
<strong><%=nombre_1%></strong><hr/>
 <table width="95%" border="1" valign="top"  >
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[0][solicitado]' name='_test[0][solicitado]' value=' <%=ene%>' onFocus='totalAnual(this)' onblur='sumaEnCambio()' size='12'  maxlength=''>
 <input type='HIDDEN' name='test[0][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[1][solicitado]' name='_test[1][solicitado]' value=' <%=feb%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()" size='12'  maxlength=''   >
 <input type='HIDDEN' name='test[1][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[2][solicitado]' name='_test[2][solicitado]' value=' <%=mar%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()"  size='12'  maxlength=''  >
 <input type='HIDDEN' name='test[2][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[3][solicitado]' name='_test[3][solicitado]' value=' <%=abr%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()"  size='12'  maxlength=''   >
 <input type='HIDDEN' name='test[3][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[4][solicitado]' name='_test[4][solicitado]' value=' <%=may%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()"  size='12'  maxlength=''   >
 <input type='HIDDEN' name='test[4][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[5][solicitado]' name='_test[5][solicitado]' value=' <%=jun%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()"  size='12'  maxlength=''   >
 <input type='HIDDEN' name='test[5][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[6][solicitado]' name='_test[6][solicitado]' value=' <%=jul%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()"  size='12'  maxlength=''   >
 <input type='HIDDEN' name='test[6][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[7][solicitado]' name='_test[7][solicitado]' value=' <%=ago%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()"  size='12'  maxlength=''   >
 <input type='HIDDEN' name='test[7][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[8][solicitado]' name='_test[8][solicitado]' value=' <%=sep%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()"  size='12'  maxlength=''  >
 <input type='HIDDEN' name='test[8][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[9][solicitado]' name='_test[9][solicitado]' value=' <%=octu%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()"  size='12'  maxlength=''  >
 <input type='HIDDEN' name='test[9][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[10][solicitado]' name='_test[10][solicitado]' value=' <%=nov%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()"  size='12'  maxlength=''   >
 <input type='HIDDEN' name='test[10][solicitado]' value='0'>
									...
									<tr bordercolor='#999999'>	
									  ...
									  <td> <input type='text' class="derecha" id='_test[11][solicitado]' name='_test[11][solicitado]' value=' <%=dic%>' onFocus='totalAnual(this)' onblur="sumaEnCambio()"  size='12'  maxlength=''   >
 <input type='HIDDEN' name='test[11][solicitado]' value='0'>
									 ...
									 <tr bordercolor='#999999'>
										...
										<td align="left"><input type='text' size='12'  maxlength='' id='total_solicitud' name='total_solicitud' value=' <%=total%>' readonly style="background-color:#EDEDEF;border: 1px #EDEDEF solid;">
