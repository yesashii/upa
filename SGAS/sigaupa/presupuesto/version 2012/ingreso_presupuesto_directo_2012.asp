...
pagina.Titulo = "Solicitud Presupuestaria 2012"
'---------------------------------------------------------------------------------------------------
				  ...
				  <table width="632"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EDEDEF">
                    ...
                    <tr> 
                      ...
                      <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td> 
                              <%pagina.DibujarLenguetasFClaro Array(array("Carga","ingreso_presupuesto_directo_2012.asp?area_ccod="&area_ccod&"&codcaja="& codcaja &"&nro_t=1"),array("Solicitud Presupuestado","ingreso_presupuesto_directo_2012.asp?area_ccod="&area_ccod&"&codcaja="& codcaja &"&nro_t=2"),array("Solicitud Centralizada","ingreso_presupuesto_directo_2012.asp?area_ccod="&area_ccod&"&codcaja="& codcaja &"&nro_t=3")), nro_t %>
                            </td>
                          </tr>
                          <tr> 
