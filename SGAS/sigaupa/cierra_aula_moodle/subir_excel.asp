...
function explica(){
	//window.location = 'explica.ppt';
	window.open("explica.ppt","ventana1","width=1024,height=768,Toolbar=NO,Scrollbars=YES,Location=NO,Resizable=YES,Directories=NO") 
}
</script>
              ...
              <table width="90%"  border="0" align="center">
                ...
                <tr>
					...
					<span class="Estilo2"></span><strong>Archivo</strong><br>
					  <input name="subir" size=30 type="file"/>					</td>
					</tr>
					<tr>
					
					<td>
					<span class="Estilo2"></span><strong>Pestaña</strong><br>
					<%f_subida.DibujaCampo("pestana")%>					</td>
				</tr>
					<tr> 
					
					<td align=left>
					<INPUT type="button" value="¿Como Funciona?" onClick="explica()">
					 <br/>
					<br/>
					<input name="button" type="button" onClick="limitar_archivo(this.form,this.form.subir.value);" value="Cerrar Aulas"></td>
			   </tr>
			   <tr>
			   	<td width="78%" align=left><INPUT type="button" value="Salir" onClick="irPagina2()"></td>
			   </tr>
			</table>
            </form>
			</td>
