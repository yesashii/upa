...
consulta= "select a.ting_ccod, a.ingr_nfolio_referencia, a.pers_ncorr, " & vbCrLf &_
          ...
          " and b.sede_ccod = '1' " & vbCrLf &_
          " and cast(a.ingr_nfolio_referencia as varchar) = isnull('"&q_ingr_nfolio_referencia&"', cast(a.ingr_nfolio_referencia as varchar))" & vbCrLf &_
          " and cast(c.pers_nrut as varchar)= isnull('"&q_pers_nrut&"', cast(c.pers_nrut as varchar))" & vbCrLf &_
          " group by a.ting_ccod, a.ingr_nfolio_referencia, a.pers_ncorr " & vbCrLf &_
...
if f_comprobantes.NroFilas > 0 then
	f_comprobantes.AgregaCampoCons "peri_ccod", negocio.ObtenerPeriodoAcademico("POSTULACION")
end if
