...
if cajero.TieneAlgunaCajaAbierta then
	...
	apertura_cons = "select '"&cajero.ObtenerCajeCCod&"' as caje_ccod, " & vbCrLf &_
					" 1 as eren_ccod, 1002 as tcaj_ccod, " & sede & " as sede_ccod, getdate() as mcaj_finicio, 0 as mcaj_mrendicion " & vbCrLf &_
					", 1 as eren_ccod_p, 1002 as tcaj_ccod_p, " & sede & " as sede_ccod_p, getdate() as mcaj_finicio_p"
	'response.Write("lala"&apertura_cons)				
	'apertura_cons = "select '" & _
	'				cajero.ObtenerCajeCCod & "' as caje_ccod, 1 as eren_ccod, 1000 as tcaj_ccod, " & sede & " as sede_ccod, sysdate as mcaj_finicio, 0 as mcaj_mrendicion " & vbCrLf &_
	'				", 1 as eren_ccod_p, 1000 as tcaj_ccod_p, " & sede & " as sede_ccod_p, sysdate as mcaj_finicio_p" & vbCrLf &_
	'				" from dual"					
					'response.End 
