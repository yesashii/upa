...
cuenta_corriente.Inicializar conexion, q_pers_nrut
...
"      (b.dcom_mcompromiso - NVL(SUM (decode(c.ting_brebaje, 'S',-c.abon_mabono,c.abon_mabono)),0)) AS dcom_mcompromiso_oculto, " & vbCrLf &_
"       nvl(SUM (decode(c.ting_brebaje, 'S',-c.abon_mabono,c.abon_mabono)),0) AS abono, b.dcom_fcompromiso, " & vbCrLf &_
...
"       (b.dcom_mcompromiso - NVL(SUM (decode(c.ting_brebaje, 'S',-c.abon_mabono,c.abon_mabono)),0)) AS saldo " & vbCrLf &_
...
"   AND e.pers_nrut = '"& q_pers_nrut &"' " & vbCrLf &_
"   AND a.inst_ccod = '"& inst &"' "&filtro&"" & vbCrLf &_
" HAVING nvl((b.dcom_mcompromiso - nvl(SUM (decode(c.ting_brebaje, 'S',-c.abon_mabono,c.abon_mabono)),0)),0) > 0 " & vbCrLf &_
...
"        from ingresos a, abonos b, personas c, tipos_ingresos d " & vbCrLf &_
"        where a.ingr_ncorr = b.ingr_ncorr AND a.ting_ccod = d.ting_ccod " & vbCrLf &_
"          AND c.pers_ncorr = b.pers_ncorr and c.pers_nrut = '"& q_pers_nrut & "' " & vbCrLf &_
"          AND a.eing_ccod = 1 and b.inst_ccod = '"& inst & "') c, " & vbCrLf &_
"       tipos_compromisos d, " & vbCrLf &_
"      personas e " & vbCrLf &_
" WHERE a.tcom_ccod = b.tcom_ccod " & vbCrLf &_
"   AND a.inst_ccod = b.inst_ccod " & vbCrLf &_
...
function valida_pagos(miformulario) {
	...
	if ( tabla_c.CuentaSeleccionados('dcom_ncompromiso') > 0 ){
		...
		resultado = window.open('','ventana','rezisable, menubar = no, width=820,height=500, top = 0, left = 0, scrollbars= yes')
		return true
	}
