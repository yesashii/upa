...
Function SqlDocumentos(p_ting_ccod)
	SqlDocumentos = "select /*g.post_ncorr,*/ f.ting_ccod, f.ding_ndocto, f.ingr_ncorr, f.ting_ccod as c_ting_ccod, f.ding_ndocto as c_ding_ndocto, f.ingr_ncorr as c_ingr_ncorr, f.banc_ccod, f.plaz_ccod, f.ding_fdocto, f.ding_mdocto, f.ding_mdetalle, f.ding_tcuenta_corriente, b.comp_fdocto " & vbCrLf &_
                    ...
                    <td>                      <br>
                      <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EDEDEF">
                        ...
                        <tr>
                          ...
                          <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td><%pagina.DibujarLenguetasFClaro Array(Array("Comprobante de ingreso", url_leng_1), Array("Cheques", url_leng_2), Array("Letras", url_leng_3)), CInt(q_leng) %></td>
                              </tr>
                              <tr>
                                <td height="2" background="../imagenes/top_r3_c2.gif"></td>
                              </tr>
