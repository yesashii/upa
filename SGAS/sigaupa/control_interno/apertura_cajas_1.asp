...
'response.Write(mcaj_ncorr_cons)
...
if false then
	...
	apertura_cons = "select '" & _
					cajero & "' as caje_ccod, 1 as eren_ccod, 1000 as tcaj_ccod, " & sede & " as sede_ccod, sysdate as mcaj_finicio, 0 as mcaj_mrendicion " & _ 
					", 1 as eren_ccod_p, 1000 as tcaj_ccod_p, " & sede & " as sede_ccod_p, sysdate as mcaj_finicio_p" & _ 
					" from dual"
...
//	formulario.action ="busca_secciones.asp";
	formulario.submit();
}
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="209" valign="middle" background="../imagenes/fondo1.gif">
                        <div align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#FFFFFF" size="2">Abrir
                                Caja</font></font></div></td>
