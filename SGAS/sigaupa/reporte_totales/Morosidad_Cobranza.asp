...
pagina.Titulo = "Reporte Resumen Morosidad - cobranza"
...
botonera.Carga_Parametros "Morosidad_Cobranza.xml", "botonera"
'-----------------------------------------------------------------------
 'sede = request.querystring("busqueda[0][sede_ccod]")
 'fin = request.querystring("busqueda[0][fin]")

set f_busqueda = new CFormulario
 f_busqueda.Carga_Parametros "Morosidad_Cobranza.xml", "filtros"
 f_busqueda.Inicializar conexion
 f_busqueda.Consultar "select '' as sede_ccod, convert(varchar,getdate(),103) as fin"
   ...
   if (preValidaFormulario(document.buscador))
    {
        ...
        URL = "../REPORTESNET/MorosidadCobranza.aspx?sede=" + sede + "&fin=" + fin + "&tipodoc=" + tipodoc;      
        window.open(URL,"","");		
	}
}
</script>
<%
	...
	calendario.MuestraFecha "busqueda[0][fin]","1","buscador","fecha_oculta_fin"
                    ...
                    <td><%pagina.DibujarSubtitulo "Filtros de la Búsqueda"%>
                      <br>
                          ...
                          <tr> 
                              ...
                              <td>
                                <%f_busqueda.DibujaCampo "fin"%>
								<%calendario.DibujaImagen "fecha_oculta_fin","1","buscador" %>(dd/mm/aaaa)
                              </td>
                              <td width="1%">&nbsp;</td>
                            </tr>
                          </table></td>
