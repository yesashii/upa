...
'-----------------------------------------------------------------------
pagina.Titulo = "Presupuesto de Ingreso v/s Real"
...
{
	//alert("En desarrollo ...");
	// checkear porque no funciona
	url= "../REPORTESNET/Presupuesto_Ingreso_Real.aspx?periodo="+periodo_j+"&sede="+sede_j+"&fecha_inicio="+fecha_inicio_j+"&fecha_termino="+fecha_termino_j+"&tipo_informe="+tipo_informe_j;
	window.open(url);
}
                    ...
                    <tr> 
                      ...
                      <td width="282" valign="bottom" background="../imagenes/fondo1.gif"> 
                        <div align="left"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif">Presupuesto 
                          de Ingreso V/S Real</font></div></td>
                        ...
                        <tr> 
                          <td width="81%"><table width="524" border="0">
                              <tr> 
                                ...
                                <td width="17">:</td>
                                <td width="151"> <% f_busqueda.DibujaCampo("sede") %> </td>
                                <td width="93">&nbsp;</td>
                                <td width="12">&nbsp;</td>
                                <td width="139">&nbsp;</td>
                              </tr>
