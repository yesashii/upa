...
'-----------------------------------------------------------------------
pagina.Titulo = "Presupuesto de Ingreso"
...
var morosidad=document.buscador.elements["busqueda[0][morosidad]"].value;
...
if (document.buscador.elements["busqueda[0][morosidad]"].value == "" )
   {
	alert("Ingrese Morosidad");
	document.buscador.elements["busqueda[0][morosidad]"].focus();
    return false;
  }
...
if( !isEnteroPositivoCero(morosidad) ) {
...
if	(morosidad > 100)  {
	alert("El porcentaje de morosidad no debe exceder el 100%");
	document.buscador.elements["busqueda[0][morosidad]"].focus();
	return false;
}
return true;
...
morosidad_j = document.buscador.elements["busqueda[0][morosidad]"].value;
...
if (chequear_fecha())
{
	url= "../REPORTESNET/Presupuesto_Ingreso.aspx?periodo="+periodo_j+"&sede="+sede_j+"&fecha_inicio="+fecha_inicio_j+"&fecha_termino="+fecha_termino_j+"&ano_actual="+ano_actual_j+"&tipo_informe="+tipo_informe_j+"&morosidad="+morosidad_j;
	window.open(url);
}
