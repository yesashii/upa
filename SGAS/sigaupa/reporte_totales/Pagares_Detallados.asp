...
pagina.Titulo = "Reporte Pagaré Crédito Universitario Detallado"
...
botonera.Carga_Parametros "Pagares_Detallados.xml", "botonera"
'-----------------------------------------------------------------------

 'sede = request.querystring("busqueda[0][sede_ccod]")
 'fin = request.querystring("busqueda[0][fin]")

set f_busqueda = new CFormulario
 f_busqueda.Carga_Parametros "Pagares_Detallados.xml", "filtros"
 f_busqueda.Inicializar conexion
 f_busqueda.Consultar "select '' as sede_ccod, '' as anos_ccod  from dual"
 f_busqueda.Siguiente
 
 'f_busqueda.AgregaCampoCons "sede_ccod", sede
 'f_busqueda.AgregaCampoCons "fin", fin
'----------------------------------------------------------------------------
...
function abrir(tipodoc, formulario)
{

   if (preValidaFormulario(document.buscador))
    {
        sede =  buscador.elements["busqueda[0][sede_ccod]"].value;
		//inicio = buscador.elements["busqueda[0][inicio]"].value;
	    //fin = buscador.elements["busqueda[0][fin]"].value;
		periodo =  buscador.elements["busqueda[0][anos_ccod]"].value;
        //URL = "/REPORTESNET/Pagares.aspx?sede=" + sede + "&inicio=" + inicio + "&fin=" + fin + "&tipodoc=" + tipodoc;      		
        URL = "../REPORTESNET/Pagares.aspx?sede=" + sede + "&periodo=" + periodo + "&tipodoc=" + tipodoc;      		
		window.open(URL,"","");
	}
}
</script>
                      ...
                      <br>
                          <table width="100%" border="0">
                            <tr> 
                              ...
                              <td colspan="4"><%f_busqueda.DibujaCampo "sede_ccod"%></td>
                              <td width="3%" rowspan="2">&nbsp;</td>
                            </tr>
                            <tr> 
                              <td><strong>Periodo Acad&eacute;mico</strong></td>
                              <td><div align="center"><strong>:</strong></div></td>
                              <td width="29%"> <%f_busqueda.DibujaCampo "anos_ccod"%> </td>
                              <td width="3%">&nbsp;</td>
                              <td width="6%">&nbsp;</td>
                              <td width="17%"> <%'f_busqueda.DibujaCampo "fin"%> </td>
                              <td width="15%">&nbsp;</td>
                            </tr>
                          </table></td>
                  </tr>
