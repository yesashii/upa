...
pagina.Titulo = "Reporte de Alumnos Morosos"
...
botonera.Carga_Parametros "Lista_Morosos.xml", "botonera"
'-----------------------------------------------------------------------
 'sede = request.querystring("busqueda[0][sede_ccod]")
 'fin = request.querystring("busqueda[0][fin]")

set f_busqueda = new CFormulario
 f_busqueda.Carga_Parametros "Lista_Morosos.xml", "filtros"
   ...
   if (preValidaFormulario(document.buscador))
    {
        ...
        URL = "../REPORTESNET/ListaMorosos.aspx?sede=" + sede + "&fin=" + fin + "&tipodoc=" + tipodoc;      
        window.open(URL,"","");
	}
}
</script>
