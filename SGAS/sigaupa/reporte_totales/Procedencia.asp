...
pagina.Titulo = "Procedencia Alumnos Nuevos"
...
botonera.Carga_Parametros "Procedencia.xml", "botonera"
'-----------------------------------------------------------------------
...
set f_busqueda = new CFormulario
 f_busqueda.Carga_Parametros "Procedencia.xml", "filtros"
...
consulta = "SELECT pers_ncorr FROM personas WHERE cast(pers_nrut as varchar) ='" & Usuario & "'"
   ...
   if (ano != "")
    {
      ...
      if (sede != "") 
	  {
	    carrera = buscador.elements["busqueda[0][carr_ccod]"].value;
	    ano = buscador.elements["busqueda[0][anos_ccod]"].value;
        URL = "../REPORTESNET/procedencia.aspx?sede_ccod=" + sede + "&carr_ccod=" + carrera + "&ano=" + ano + "&tipodoc=" + tipodoc;      
        window.open(URL,"","");
	  }
	  else
	  {
                      ...
                      <br>
                          <table width="100%" border="0">
                            <tr> 
                              ...
                              <td width="64%"><%f_busqueda.DibujaCampo "sede_ccod"%></td>
            ...
            <td width="32%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><div align="center">
				  <%
				    botonera.agregaBotonParam "excel", "url", "http://www.ufro.cl"
