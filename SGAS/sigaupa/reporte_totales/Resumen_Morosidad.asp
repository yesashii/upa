...
pagina.Titulo = "Reporte Resumen Morosidad"
...
botonera.Carga_Parametros "Resumen_Morosidad.xml", "botonera"
'-----------------------------------------------------------------------
 'sede = request.querystring("busqueda[0][sede_ccod]")
 'fin = request.querystring("busqueda[0][fin]")

set f_busqueda = new CFormulario
 f_busqueda.Carga_Parametros "Resumen_Morosidad.xml", "filtros"
   ...
   if (preValidaFormulario(document.buscador))
    {
        ...
        URL = "../REPORTESNET/Res_Morosidad.aspx?sede=" + sede + "&fin=" + fin + "&tipodoc=" + tipodoc;      
        window.open(URL,"","");
	}
}
</script>
