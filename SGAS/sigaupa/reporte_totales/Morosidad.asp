...
pagina.Titulo = "Reporte Morosidad Finanzas"
...
botonera.Carga_Parametros "Morosidad.xml", "botonera"
'-----------------------------------------------------------------------
 'sede = request.querystring("busqueda[0][sede_ccod]")
 'fin = request.querystring("busqueda[0][fin]")
 
set f_busqueda = new CFormulario
 f_busqueda.Carga_Parametros "Morosidad.xml", "filtros"
   ...
   if (preValidaFormulario(document.buscador))
    {
        ...
        URL = "../REPORTESNET/Morosidad.aspx?sede=" + sede + "&fin=" + fin + "&tipodoc=" + tipodoc;      
		window.open(URL,"","");
	}
}
</script>
