...
'------------------------------------------------------  
 ...
 botonera.carga_parametros "encuesta_satifaccion.xml", "botonera"
'------------------------------------------------------

'---------------------------------------------------------------------
 set f_datos = new CFormulario
 f_datos.Carga_Parametros "encuesta_satifaccion.xml", "encabezado"
          ...
          <tr> 
             <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr> 
				  ...
				  <td align="center"> <% botonera.dibujaboton "ir1"%>
                </tr>
              </table></td>
          </tr>
          <tr> 
