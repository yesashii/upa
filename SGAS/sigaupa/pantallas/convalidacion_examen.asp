...
fc_datos.Siguiente
carrera=fc_datos.obtenerValor("carr_ccod")
'response.Write(carrera&"<br>")
fc_datos.AgregaCampoParam "carr_ccod", "filtro", "carr_ccod in ("&carrera&")"
            ...
            <td><div align="center"><br>
              <%pagina.DibujarTituloPagina%><br>              
				...
				<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="27%" height="25"><strong>Rut Alumno</strong></td>
                      <td width="2%"><strong>:</strong></td>
                      <td width="71%"><%=fc_datos.DibujaCampo("rut")%></td>
                    </tr>
                    <tr> 
                      <td width="27%" height="25"><strong>Nombre</strong></td>
                      <td width="2%"><strong>:</strong></td>
                      <td width="71%"><%=fc_datos.DibujaCampo("alumno")%></td>
                    </tr>
                    <tr> 
                      <td width="27%" height="25"><strong>Carrera Matriculado</strong></td>
                      <td width="2%"><strong>:</strong></td>
                      <td width="71%"><%=fc_datos.DibujaCampo("carr_ccod")%></td>
                    </tr>
                    <tr> 
                      <td width="27%" height="25"><strong>Postulando</strong></td>
                      <td width="2%"><strong>:</strong></td>
                      <td width="71%"><select>
                    ...
                    <tr>
                      <td><strong>Cantidad de convalidaciones solicitadas</strong></td>
                      <td>:</td>
                      <td>
					  <select>
