...
botonera.carga_parametros "adm_ofertas.xml", "btn_adm_ofertas"
...
f_busqueda.Carga_Parametros "adm_ofertas.xml", "f_busqueda"
f_busqueda.Inicializar conexion

set f_especialidades = new CFormulario
f_especialidades.Carga_Parametros "adm_ofertas.xml", "especialidades"
...
consulta ="select a.ofer_ncorr, " & vbCrLf &_
		  ...
		  " case WHEN c.AUDI_TUSUARIO LIKE '%aju%' THEN 'AJUSTE' ELSE 'Normal' END AS tipo_mat," & vbCrLf &_		  
		  " d.peri_tdesc" & vbCrLf &_
		  "from ofertas_academicas a, jornadas b, aranceles c, PERIODOS_ACADEMICOS d, especialidades e  " & vbCrLf &_
		  "where a.jorn_ccod = b.jorn_ccod and" & vbCrLf &_
		   "a.aran_NCORR = c.aran_NCORR and" & vbCrLf &_
		   " a.PERI_CCOD=d.PERI_CCOD and "& vbCrLf &_
		  ...
		  "order by tipo_mat DESC, aran_nano_ingreso desc, tipo_alumnos desc"

	'response.Write("<pre>"&consulta&"</pre>")

	set f_tabla = new CFormulario
	f_tabla.Carga_Parametros "adm_ofertas.xml", "f_tabla"
	f_tabla.Inicializar conexion
	f_tabla.Consultar consulta
	'f_tabla.AgregaCampoParam "a.aran_NCORR"
end if
        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td bgcolor="#D8D8DE"> 
                  <form action="adm_ofertas.asp" method="get" name="busqueda" id="busqueda" onSubmit="if (!ValidarBusqueda(this)) return false">
			  <%
			  if buscando then
			  %>
			  <br>
