...
sql = "select '" & plan & "'as plan, '3.0' as mall_nota_presentacion, '5.5' as mall_nota_eximicion, '60' as mall_porcentaje_presentacion, '2' as mall_nevaluacion_minima, '50' as mall_porcentaje_asistencia from dual"
            ...
            <td><div align="center"><br>
                  ...
                  <form name="editar">
                    <table width="90%" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td height="21" align="right"><div align="left">Nota Eximisi&oacute;n </div></td>
                        <td width="23" align="right"><div align="center">:</div></td>
                        <td align="right"><div align="left">
                            <%f_consulta.DibujaCampo ("mall_nota_eximicion")%>
                        </div></td>
                        <td align="right">&nbsp;</td>
                        <td align="right">&nbsp;</td>
                        <td align="right">&nbsp;</td>
