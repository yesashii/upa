...
consulta = " SELECT  M.MALL_CCOD as mall_ccod, M.PLAN_CCOD as plan_ccod, M.NIVE_CCOD as nive_ccod, M.ASIG_CCOD as asig_ccod," & _
		   ...
		   " M.MALL_NEVALUACION_MINIMA, trim(to_char(M.MALL_NOTA_PRESENTACION,'9.0')) as MALL_NOTA_PRESENTACION, M.MALL_PORCENTAJE_ASISTENCIA, M.MALL_PORCENTAJE_PRESENTACION "&_ 
