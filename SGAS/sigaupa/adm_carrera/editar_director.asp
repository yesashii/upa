...
consulta = "select a.pers_ncorr, a.pers_nrut, a.pers_xdv, a.pers_tape_paterno, a.pers_tape_materno, a.pers_tnombre, protic.obtener_nombre_completo(a.pers_ncorr,'n') as nombre_director " & vbCrLf &_
           "from personas a " & vbCrLf &_
...
f_director.AgregaCampoCons "tcar_ccod", "1"
                      ...
                      <table width="98%"  border="0" align="center">
					   <tr>
						...
						<tr>
						  ...
						  <td width="2%"><div align="center"><strong>:</strong></div></td>
						  <td width="88%"><div align="left"><%f_director.dibujaCampo("pers_nrut")%>-<%f_director.dibujaCampo("pers_xdv")%>
						  <a href="javascript:buscar_persona('d[0][pers_nrut]', 'd[0][pers_xdv]');"><img src="../imagenes/lupa_f2.gif" width="16" height="15" border="0"></a></div></td>
                        </tr>
						<tr>
