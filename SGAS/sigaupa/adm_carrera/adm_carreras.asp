...
'---------------------------------------------------------------------------------------------------
consulta ="  select a.carr_ccod,a.carr_tdesc,area_tdesc,inst_trazon_social,d.ecar_tdesc  " &_
			" from carreras a,areas_academicas b, instituciones c,estados_de_carreras d " &_
			" where a.area_ccod = b.area_ccod  " &_
			" and a.inst_ccod = c.inst_ccod " &_
			" and a.ecar_ccod = d.ecar_ccod " &_
			" and a.carr_tdesc like '%"&carr_tdesc&"%' " & _
			" order  by carr_tdesc" 
