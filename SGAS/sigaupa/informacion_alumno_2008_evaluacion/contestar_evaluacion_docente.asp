									     ...
									     <td height="20" align="left">
										 	<table width="100%"  border="0" align="center">
												<tr> 
										 		...
										 		<tr valign="bottom"> 
												  <td colspan="3"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>INSTRUCCIONES : </strong>Estimado Alumno (a):</font>
												                  <%if ya_grabada = "S" then%>
																  <font size="4" face="Courier New, Courier, mono" color="#FF0000"><strong> GRABACIÓN EXITOSA</strong></font>
																  <%end if%></td>
												</tr>
												<tr>  
															...
															<table width="20%" border="0">
																<tr valign="middle"> 
																  ...
																  <td width="50%" align="center"><% if contestada = 0  then
																		...
																		<a href="javascript: alert('La evaluación docente se encuentra cerrada hasta el 16 de agosto');"
