...
function validar_ingreso()
{
  ...
  if (contestada==(cant_radios/divisor))
   {
		if (confirm("Está seguro que desea cerrar la evaluación de este docente?,\nsi continua no podrá realizar nuevos cambios en ella"))
										...
										<td width="100%" align="left">
											<div align="justify">
												<font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">
													<strong>5º Dimensión Compromiso con la Asignatura:</strong> En esta dimensión se busca que el estudiante se pronuncie respecto de su grado de 
										...
										<td width="100%" align="center">
											...
											<tr>
												<td width="50%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">
												                    <div align="justify">
																		1. Mi nivel de asistencia a clases, en relación al número de sesiones realizadas efectivamente, fue…
																	</div>
																</font>
												</td>
											...
											<tr>
												<td width="50%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">
												                    <div align="justify">
																		2. ¿Cumplí con los requerimientos académicos del curso, tales como leer los documentos propuestos, realizar los talleres, trabajos grupales, entre otros? 
																	</div>
																</font>
												</td>
												<td width="10%" align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">Sólo cumplí con una mínima parte</font></td>
												...
												<td width="10%" align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">Cumplí con la mayor parte de los requerimientos</font></td>
												<td width="6%" align="center"><input type="radio" name="parte_6_2" value="0" <%=parte_6_2g%>></td>
											</tr>
											<tr>
												<td width="50%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">
												                    <div align="justify">
																		3. ¿En qué grado participé en el desarrollo de las clases, por ejemplo, emitiendo opiniones, haciendo preguntas, 
																		aportando ejemplos, materiales adicionales, entre otros? 
																	</div>
																</font>
												</td>
												<td width="10%" align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">Participé muy poco</font></td>
												...
												<td width="10%" align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">Participé activamente</font></td>
												<td width="6%" align="center"><input type="radio" name="parte_6_3" value="0" <%=parte_6_3g%>></td>
											</tr>
											<tr>
												<td width="50%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">
												                    <div align="justify">
																		4. ¿Utilicé las instancias de participación en la asignatura que otorgó el profesor, por ejemplo: preguntas en clases,  ayudantías, etc.? 
																	</div>
																</font>
												</td>
												<td width="10%" align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">No las utilicé</font></td>
												...
												<td width="10%"align="center"><font size="1" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">Siempre las utilicé</font></td>
                                  ...
                                  <div align="justify"> 5. Regularmente llego 
                                    a la hora de inicio y termino de la clase. 
											...
											<tr>
												<td width="50%"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#4b73a6">
												                    <div align="justify">
																		6. ¿Qué cantidad de tiempo (horas) fuera del horario de clases le dedique a esta asignatura?
																	</div>
																</font>
												</td>
