...
consulta2 = "  select distinct e.asig_ccod,f.asig_tdesc,protic.initcap(i.pers_tnombre + ' ' + i.pers_tape_paterno) as docente,e.secc_ccod,i.pers_ncorr, " & vbCrLf &_
			...
			"  and b.peri_ccod = c.peri_ccod and cast(c.anos_ccod as varchar)='"&anos_ccod&"' " & vbCrLf &_
									...
									<table width="95%" border="0" cellpadding="0" cellspacing="0">
									  ...
									  <tr><td colspan="4" align="center">
									          <table width="85%" height="60" cellpadding="0" cellspacing="0" border="1" bordercolor="#496da6">
											    <tr>
													<td align="center">
														<strong><font color="#e41712">ATENCIÓN: </font><font color="#496da6">No olvides completar tu evaluación docente antes del <font color="#e41712">16 de noviembre de 2008</font>, recuerda que es requisito necesario para poder tomar asignaturas en semestres posteriores.</font></strong>
													</td>
												</tr>
											  </table>
										  </td>
									  ...
									  <tr><td colspan="4">
												...
												<table width='100%' border='0' cellpadding='0' cellspacing='0' bgcolor='#ADADAD' id='tb_ramos'>
													...
													<%f_ramos.primero
													  ...
													  cuadro5 = ""
													  if  antigua <> "0" then
													  	cuadro1 = "bgcolor='#48da02'"
														cuadro2 = "bgcolor='#48da02'"
														cuadro3 = "bgcolor='#48da02'"
														cuadro4 = "bgcolor='#48da02'"
														cuadro5 = "bgcolor='#48da02'"
													  else
													  	if fase_1 <> "0" then
															cuadro1 = "bgcolor='#48da02'"
														end if
