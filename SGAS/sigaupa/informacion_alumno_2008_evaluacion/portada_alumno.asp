...
' pasa_fecha = conexion.consultaUno("select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'25/04/2011',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'22/05/2011',103) then 'S' else 'N' end")
 c_encuesta = " select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'01/05/2015',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'30/05/2015',103) "&_
              " then 'S' else 'N' end "
 ...
 pasa_fecha2 = conexion.consultaUno("select case when convert(datetime,protic.trunc(getDate()),103) >= convert(datetime,'13/01/2014',103) and convert(datetime,protic.trunc(getDate()),103) <= convert(datetime,'28/03/2014',103) then 'S' else 'N' end")
 ...
 c_mensaje = " select case when getDate() >= '20/06/2015 23:30:00' and getDate() <= '21/06/2015 22:00:00' "&_
              " then 'S' else 'N' end "
								...
								<td width="100%" align="center">
                                       ...
                                       <%if activar_ocultos3 then 'para evaluación docente%>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    Entre 20-06-2015 23:30 hrs. hasta 21-06-2015 22:00 hrs.
                                    ...
                                    <td align="center" width="25%" background="../imagenes/degradado.jpg"><font size="2" color="#990000"><strong>Encuesta 
                                      Docente 2015</strong></font></td>
                                          ...
                                          <td width="75%" align="left"><font color="#0033FF" size="2">Período 
                                            encuesta docente 2015-01:<br>
                                            (todas las Sedes y Campus)<br>
                                            <li><strong>01-05-2015 --> <font color="#FF0000">30-05-2015</font>.</strong></li>
