...
'----------------------------------------------------------------------------------------------------------------
 ...
 consulta = " select c.regi_ccod,c.regi_tdesc,b.ciud_ccod,b.ciud_tdesc,a.cole_ccod,replace(a.cole_tdesc,'''',' ')  as cole_tdesc " & vbCrLf & _
			...
			" where a.ciud_ccod=b.ciud_ccod and b.regi_ccod=c.regi_ccod " & vbCrLf & _
...
<table width="750" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="3" valign="top" bgcolor="#cb1b1b" width="750" align="center" height="100">
    <img src="../imagenes/banner_postulacion.gif" width="750" height="100" alt="Admisión 2009" />
	</td>
  </tr>
