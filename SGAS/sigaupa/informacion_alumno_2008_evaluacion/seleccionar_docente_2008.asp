...
sql_sede_ccod = "SELECT sede_ccod FROM alumnos a, ofertas_academicas b WHERE a.ofer_ncorr=b.ofer_ncorr and cast(a.pers_ncorr as varchar)='"&pers_ncorr_temporal&"' and b.peri_ccod in (236) and a.emat_ccod=1"
sede_ccod = conexion.consultaUno(sql_sede_ccod)
