                    ...
                    <td align="center">
						    <table width="650" class="v1" border="1" cellpadding="0" cellspacing="0" borderColor="#999999" bgColor="#adadad">
							  ...
							  <tr bgcolor="#FFFFFF">
                                		...
                                		<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=5&jornada=1&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_doctor_c%></div></td>
                                		<td  onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=horas_doctor_c%></div></td>
										<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=4&jornada=1&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_magister_c%></div></td>
                                		<td  onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=horas_magister_c%></div></td>
										<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=3&jornada=1&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_licenciado_c%></div></td>
                                		<td  onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=horas_licenciado_c%></div></td>
										<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=0&jornada=1&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_sin_c%></div></td>
							   ...
							   <tr bgcolor="#FFFFFF">
                                		...
                                		<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=5&jornada=2&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_doctor_m%></div></td>
                                		<td  onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=horas_doctor_m%></div></td>
										<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=4&jornada=2&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_magister_m%></div></td>
                                		<td  onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=horas_magister_m%></div></td>
										<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=3&jornada=2&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_licenciado_m%></div></td>
                                		<td  onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=horas_licenciado_m%></div></td>
										<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=0&jornada=2&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_sin_m%></div></td>
							   ...
							   <tr bgcolor="#FFFFFF">
                                		...
                                		<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=5&jornada=3&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_doctor_h%></div></td>
                                		<td  onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=horas_doctor_h%></div></td>
										<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=4&jornada=3&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_magister_h%></div></td>
                                		<td  onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=horas_magister_h%></div></td>
										<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=3&jornada=3&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_licenciado_h%></div></td>
                                		<td  onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=horas_licenciado_h%></div></td>
										<td class='click' onClick='irA("detalle_docentes_grados_nuevos.asp?tipo=0&jornada=3&carr_ccod=<%=carr_ccod%>&jorn_ccod=<%=jorn_ccod%>&sede=<%=sede_ccod%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="center"><%=Cant_sin_h%></div></td>
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				   ...
				   <td width="14%"> <div align="center">  <%
					                       botonera.agregabotonparam "excel", "url", "grados_jornada_nuevo_excel.asp?carr_ccod="&carr_ccod&"&jorn_ccod="&jorn_ccod&"&sede_ccod="&sede_ccod
