...
'		   " where cast(a1.carr_ccod as varchar)='"&carr_ccod&"'"& vbCrLf &_
...
'		   "         where hdc.carr_ccod=a1.carr_ccod and hdc.pers_ncorr=a1.pers_ncorr "& vbCrLf &_
...
url_excel="detalle_docentes_grados_excel.asp?tipo="&tipo&"&jornada="&jornada&"&carr_ccod="&carr_ccod&"&jorn_ccod="&jorn_ccod&"&sede="&sede
            ...
            <td width="38%" height="20"><div align="center">
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center">
                            <% 
							botonera.agregabotonparam "anterior","url","GRADOS_JORNADA.ASP?busqueda[0][carr_ccod]="&carr_ccod&"&busqueda[0][jorn_ccod]="&jorn_ccod&"&busqueda[0][sede_ccod]="&sede
