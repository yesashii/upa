...
consulta_nuevos = " select distinct d.pers_nrut as RUT,d.pers_xdv as DV,d.pers_tnombre as nombre, d.pers_tape_paterno as ap_paterno,d.pers_tape_materno as ap_materno,  "& vbCrLf &_
		   "  (select top 1 cudo_titulo from curriculum_docente where pers_ncorr = a.pers_ncorr and grac_ccod in(1,2) order by grac_ccod desc) as profesion,  "& vbCrLf &_
		   ...
		   "     and b.carr_ccod     =   i.carr_ccod  and n.peri_ccod=pea.peri_ccod and n.jorn_ccod = jor.jorn_ccod "& vbCrLf &_
		   "     and c.asig_ccod     =   j.asig_ccod  "& vbCrLf &_
		   "     and c.duas_ccod     =   k.duas_ccod  "& vbCrLf &_
		   "     and l.INST_CCOD     =   1  "& vbCrLf &_
		   "     and M.PAIS_CCOD     =   d.PAIS_CCOD  "& vbCrLf &_
...
<p>&nbsp;</p><table width="100%" border="1">
  ...
  <tr> 
	...
	<td><div align="left"><%=f_listado_nuevos.ObtenerValor("rut")%>-<%=f_listado.ObtenerValor("dv")%></div></td>
