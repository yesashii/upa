				...
				<form name="buscador" method="get">
                  <table width="98%"  border="0">
                    <tr>
                          ...
                          <tr>
                            <td valign=top align=middle height=40>
                              <div align="center"><strong><font size="3">Listado
                                    de profesores (valor cuota x Escuela)</font></strong><br>
                      ...
                      <td width="19%"><div align="center"><%    botonera.AgregaBotonParam "excel", "url", "reporte_cuota_prof_carrera_softland_excel.asp"
