...
nombre_periodo = conexion.consultaUno("select protic.initcap(peri_tdesc) from periodos_Academicos where cast(peri_ccod as varchar)='"&peri&"'")

set f_listado = new CFormulario
f_listado.Carga_Parametros "parametros.xml", "tabla"
f_listado.Inicializar conexion

consulta = " select distinct g.sede_tdesc as sede,d.carr_tdesc as carrera, cast(f.pers_nrut as varchar)+'-'+f.pers_xdv as rut ,"& vbCrLf &_
		   ...
		   " from secciones a,bloques_horarios b, bloques_profesores c,carreras d, personas f,sedes g,tipos_profesores h,personas pp, asignaturas asig "& vbCrLf &_
		   " where cast(a.peri_ccod as varchar)= case asig.duas_ccod when 3 then '"&periodo&"' else '"&peri&"' end "& vbCrLf &_
...
<table width="100%" border="0">
  ...
  <tr> 
    ...
    <td width="90%" colspan="3"><strong>:</strong> <%=nombre_periodo%></td>
  </tr>
</table>
...
<p>&nbsp;</p><table width="100%" border="1">
  <tr> 
    ...
    <td width="35%" bgcolor="#FFFFCC" colspan="3"><div align="center"><strong>CARRERA</strong></div></td>
