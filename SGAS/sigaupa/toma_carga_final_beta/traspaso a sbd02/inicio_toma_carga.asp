...
if not EsVacio(q_pers_nrut) and pers_ncorr_temporal <> "" then
	...
	bloquear_toma_diurnos = conexion.consultaUno("select case when convert(varchar,getDate(),103) < convert(datetime,'02/01/2008',103) or convert(varchar,getDate(),103) > convert(datetime,'27/01/2008',103) then 'S' else 'N' end ")
end if
...
c_encuestas = "select cantidad_carga_2007 - con_evaluacion_docente as diferencia "& vbCrLf &_
			  ...
			  if  pers_ncorr_temporal = "101816" or pers_ncorr_temporal= "101597" or pers_ncorr_temporal="107381" or pers_ncorr_temporal="27757" or pers_ncorr_temporal="102680" or pers_ncorr_temporal="102665" or pers_ncorr_temporal="103442" or pers_ncorr_temporal="107093" or pers_ncorr_temporal="101924" or pers_ncorr_temporal="106139" or pers_ncorr_temporal="102850" or pers_ncorr_temporal="106379" or pers_ncorr_temporal="102244" or pers_ncorr_temporal="124378" or pers_ncorr_temporal="110818" or pers_ncorr_temporal="102479" or pers_ncorr_temporal="117500" or pers_ncorr_temporal="21513" or pers_ncorr_temporal= "112289" or pers_ncorr_temporal="23213" or pers_ncorr_temporal="22652" or pers_ncorr_temporal="98132" or pers_ncorr_temporal="113850" or pers_ncorr_temporal="98383" or pers_ncorr_temporal="102495" or pers_ncorr_temporal="110426" or pers_ncorr_temporal="96971" or pers_ncorr_temporal="23218"  or pers_ncorr_temporal="117125" or pers_ncorr_temporal="97186" then 
			  	mensaje_encuesta = ""
			  end if
			  ...
			  if carr_ccod ="830" or carr_ccod ="850" or carr_ccod ="880" or carr_ccod ="870" or carr_ccod ="940" or carr_ccod ="950" or carr_ccod = "860" then
			  	mensaje_convocatoria = "La toma de carga para alumnos de tu escuela comienza el día 21 de enero."
			  end if
