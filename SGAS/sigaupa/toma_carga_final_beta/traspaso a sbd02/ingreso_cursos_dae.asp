...
pagina.Titulo = "Ingreso de Cursos Artístico - Culturales"
...
consulta = "  select a.secc_ccod, a.secc_tdesc +'--> '+ protic.horario(a.secc_ccod)  + ' (' + cast((a.secc_ncupo - (select count(*) from cargas_academicas ca where a.secc_ccod=ca.secc_ccod))as varchar) + ') ' " & vbCrLf & _
		   ...
		   " and aaa.hora_ccod_optativos=bbb.hora_ccod_optativos) as secc_tdesc, " & vbCrLf & _
...
if tipo_plan = "0" then
	lenguetas_carga = Array(Array("Toma de Carga", "toma_carga_nuevo.asp"), Array("Equivalencias", "equivalencias.asp"), Array("Optativos Deportivos", "ingreso_optativos.asp"), Array("Artísticos-Culturales", "ingreso_cursos_dae.asp"),Array("Carga Extraordinaria Créditos", "toma_carga_extraordinaria.asp?tipo=1"))
else
	lenguetas_carga = Array(Array("Toma de Carga", "toma_carga_nuevo.asp"), Array("Equivalencias", "equivalencias.asp"), Array("Optativos Deportivos", "ingreso_optativos.asp"), Array("Artísticos-Culturales", "ingreso_cursos_dae.asp"),Array("Carga Extraordinaria Sesiones", "toma_carga_extraordinaria.asp?tipo=2"))
end if
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas lenguetas_carga, 4 %></td>
          </tr>
          <tr>
                      ...
                      <tr>
                        <td width="81%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
							  ...
							  <tr> 
                                <td width="26%">&nbsp;</td>
								<td width="2%">&nbsp;</td>
								<td width="62%"><input type="hidden" name="matr_ncorr" value="<%=matr_ncorr%>"></td>
                              	<td width="10%"><%
							  ...
							  <%if tipo_plan <> "0" and cint(suma_creditos) >= 27 then%>
								<tr>
								   <td colspan="4" align="center"><font  size="2" color="#0000FF"><strong>Atención el total de Cr&eacute;ditos Asignados (<%=suma_creditos%>) esta fuera del rango permitido (9-27).<br> Elimine parte de la carga para tomar el curso Artistico-Cultural.</strong></font>
								   </td>
								</tr>
							  <%end if%>
                            </table></td>
            ...
            <form name="edicion2">
			  <input type="hidden" name="matr_ncorr" value="<%=matr_ncorr%>">
					<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
					  <tr>
						<td><%pagina.DibujarSubtitulo "Listado de asignaturas Artistico-Culturales asignados al alumno"%>
						  <br></td>
					  </tr>
					  </table>
          ...
          <tr>
            <td width="13%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center">
                    <% f_botonera.agregaBotonParam "anterior", "url", "ingreso_optativos.asp"
