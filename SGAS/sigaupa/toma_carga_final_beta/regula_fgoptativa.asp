...
set errores = new CErrores
 ...
 f_busqueda.Carga_Parametros "regula_fgoptativa.xml", "busqueda_usuarios_nuevo"
...
botonera.Carga_Parametros "regula_fgoptativa.xml", "botonera"
'--------------------------------------------------------------------------
...
datos_asignaturas.Carga_Parametros "regula_fgoptativa.xml", "formulario_asignaturas"
...
consulta_asignaturas = " select d.matr_ncorr,d.secc_ccod,f.asig_ccod,f.asig_tdesc as asignatura,e.secc_tdesc as seccion, "& vbCrLf &_
					   ...
					   "            where aa.mall_ccod = e.mall_ccod and aa.asig_ccod = e.asig_ccod "& vbCrLf &_
					   "            and aa.plan_ccod = bb.plan_ccod and bb.espe_ccod = cc.espe_ccod "& vbCrLf &_
					   "            and cc.carr_ccod = '820' and bb.plan_ccod in (378,527) ) "& vbCrLf &_
					   " order by asig_tdesc"
...
c_formacion = "( "&_
			  ...
			  "  where a.asig_ccod=b.asig_ccod and b.asig_tdesc like '%form%general optativa%' "& vbCrLf &_
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" aling="center">
                ...
                <td bgcolor="#D8D8DE"> <div align="center">&nbsp; 
				  ...
				  <table width="100%" border="0">
					...
					<tr> 
                      <td align="left"><strong>Asignaturas de Formación general optativa</strong></td>
                    </tr>
					<form name="edicion">
					...
					<tr> 
                      <td align="left"><strong>Ponga especial atención en la columna 'Equivalente a', en el código de la asignatura ya que este debe ser único por asignatura de formación general optativa.</strong></td>
                    </tr>
				  </table> 
                  <br>
				  </td>
