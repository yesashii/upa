...
pagina.Titulo = "TOMA DE CARGA <br>" & peri_tdesc
'---------------------------------------------------------------------------------------------------
...
if v_plec_ccod = "2" and matr_ncorr <> "" then
    pers_ncorr_temporal= conexion.consultaUno("select pers_ncorr from alumnos a where cast(a.matr_ncorr as varchar)='"&matr_ncorr&"'")
...
if not esVacio(max_periodo_matricula) and max_periodo_matricula <> "" then
	...
	cod_carrera = conexion.consultaUno("select carr_ccod from alumnos a, ofertas_academicas b,especialidades c where a.ofer_ncorr=b.ofer_ncorr and cast(a.matr_ncorr as varchar)='"&matr_ncorr&"' and b.espe_ccod = c.espe_ccod")
	...
	sede_ccod = conexion.consultaUno("select sede_ccod from alumnos a, ofertas_academicas b where a.ofer_ncorr=b.ofer_ncorr and cast(a.matr_ncorr as varchar)='"&matr_ncorr&"'")
	
	sede = conexion.consultaUno("select protic.initCap(sede_tdesc) from sedes where cast(sede_ccod as varchar)='"&sede_ccod&"'")	

	jornada = conexion.consultaUno("select case b.jorn_ccod when 1 then 'Diurna' else 'Vespertina' end from alumnos a, ofertas_academicas b where a.ofer_ncorr=b.ofer_ncorr and cast(a.matr_ncorr as varchar)='"&matr_ncorr&"'")
end if
	...
	<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas Array("Toma de carga Alumno"), 1 %></td>
          </tr>
          <tr>
            <td height="2"></td>
          </tr>
            ...
            <td><div align="center"><br>
              ...
              <form name="edicion">
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td colspan="2">
                          <%pagina.DibujarSubtitulo "Carga Académica"%>                          
