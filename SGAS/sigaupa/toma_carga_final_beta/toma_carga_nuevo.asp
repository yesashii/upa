...
pers_ncorr= session("pers_ncorr_alumno")
 ...
 if matr_ncorr <>"" then 
	   ...
	   if primer_periodo ="" or isnull(primer_periodo)then
...
asignaturas_disponibles_cons = asignaturas_disponibles_cons & " and not ( exists (select 1                                                            " & vbCrLf &_
