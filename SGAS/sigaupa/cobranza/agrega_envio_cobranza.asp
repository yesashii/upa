...
if folio_envio = "NUEVO" then
 'consulta = "select envi_ncorr_seq.nextval as envi_ncorr, envi_ncorr_seq.nextval as c_envi_ncorr,'1' as eenv_ccod, '1' as tenv_ccod from dual"
  consulta = "select '1' as eenv_ccod, '1' as tenv_ccod"
end if
...
'if folio_envio = "NUEVO" then
' 'consulta = "select envi_ncorr_seq.nextval as envi_ncorr, envi_ncorr_seq.nextval as c_envi_ncorr,'1' as eenv_ccod, '1' as tenv_ccod from dual"
'  consulta = "select '1' as eenv_ccod, '1' as tenv_ccod from dual"
'end if
'formulario.Consultar consulta
'formulario.AgregaCampoCons "envi_fenvio", date()
'formulario.Siguiente
...
<html>
<head>
<title>Nuevo Envio a Cobranza</title>
				    ...
				    <table width="386" border="0">
                      ...
                      <tr> 
                        ...
                        <td><%response.Write(date())%>
                          <%formulario.DibujaCampo("envi_fenvio") %></td>
                      </tr>
                    </table>
			        </form>
				  <br>				  </td>
