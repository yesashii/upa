...
botonera.Carga_Parametros "Devueltas_cobranza.xml", "btn_cedente_cobranza"
f_busqueda.Carga_Parametros "Devueltas_cobranza.xml", "fbusqueda"
...
f_listado.Carga_Parametros "Devueltas_cobranza.xml", "f_listado"
...
"     join  detalle_envios de "& vbCrLf &_
"             on ee.envi_ncorr = de.envi_ncorr  "& vbCrLf &_
"     join  detalle_ingresos a "& vbCrLf &_
"             on de.ting_ccod = a.ting_ccod   "& vbCrLf &_
...
"            on l.tcom_ccod = m.tcom_ccod    "& vbCrLf &_
...
"     join  instituciones_envio hh  "& vbCrLf &_
"         on ee.inen_ccod = hh.inen_ccod  "& vbCrLf &_
"	 where   "& vbCrLf &_
"       a.ding_ncorrelativo = 1    "& vbCrLf &_
...
<html>
<head>
<title>Devolucion Cobranza</title>
