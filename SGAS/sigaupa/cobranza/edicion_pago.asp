...
f_efec.AgregaCampoParam "ting_ccod", "filtro", "ting_ccod in (16, 34)"
...
//v_indice=0;
	...
	/*if	(valor==13 || valor==51){// se valida el maxlength del nro de docto
		alert("validando maxlength "+document.buscador.elements["d["+v_indice+"][ting_ccod]"].maxlength)

		document.buscador.elements["d["+v_indice+"][ting_ccod]"].maxlength='4';
		//plaz_ccod='d['+a+'][plaz_ccod]';
		//elemento=objeto.form.elements[i].name;
		
	}
	else{
		document.buscador.elements["d["+v_indice+"][ting_ccod]"].maxlength='12';
	}*/
}
