                  ...
                  <td bgcolor="#D8D8DE">
				    ...
				    <table width="386" border="0">
				      <tr>
				        ...
				        <td width="294"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">
				          <select name="select">
                            ...
                            <option selected>Empresa 2</option>
				      ...
				      <tr>
				        ...
				        <td>Fecha</td>
				        <td>:</td>
				        <td><input name="textfield2" type="text" value="25/01/2003" size="15" maxlength="10" disabled>
			            </td>
				      </tr>
				      </table>
			        </form>
                ...
                <tr>
                  ...
                  <td width="287" bgcolor="#D8D8DE"> 
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="46%"><%pagina.DibujarBoton "Aceptar", "CERRAR", "" %>
                        </td>
                        <td width="54%"><%pagina.DibujarBoton "Salir", "CERRAR", "" %>
                        </td>
                      </tr>
                    </table>
</td>
