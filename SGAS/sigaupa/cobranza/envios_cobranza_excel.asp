...
consulta = 	" Select a.envi_ncorr, c.ting_ccod, d.ting_tdesc, c.ding_ndocto as c_ding_ndocto, c.ingr_ncorr, c.ding_ndocto, c.ding_mdocto,  "& vbCrLf &_
			...
			"       convert(datetime,e.ingr_fpago, 103) as fecha_envio, protic.tiene_multa_protesto(c.ting_ccod, c.ding_ndocto, c.ingr_ncorr) as multa_protesto, "& vbCrLf &_
		   	...
		   	" ON b.ting_ccod = c.ting_ccod and b.ingr_ncorr = c.ingr_ncorr and b.ding_ndocto = c.ding_ndocto "& vbCrLf &_
		   	...
		   	" ON e.ingr_ncorr=j.ingr_ncorr "& vbCrLf &_
		   	" INNER JOIN estados_detalle_ingresos f "& vbCrLf &_
		   	" ON c.edin_ccod = f.edin_ccod "& vbCrLf &_
		   	" INNER JOIN personas g "& vbCrLf &_
		   	" ON isnull(c.pers_ncorr_codeudor, protic.ultimo_aval(e.pers_ncorr))=g.pers_ncorr "& vbCrLf &_
		   	" left outer JOIN direcciones_publica h "& vbCrLf &_
		   	" ON h.pers_ncorr = g.pers_ncorr "& vbCrLf &_
			" and h.tdir_ccod = 1 "& vbCrLf &_
		   	" LEFT OUTER JOIN ciudades i "& vbCrLf &_
		   	" ON h.ciud_ccod = i.ciud_ccod "& vbCrLf &_
		   	" WHERE cast(a.envi_ncorr as varchar) = '" & folio_envio & "'"
