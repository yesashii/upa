...
'response.Write(total)
  ...
  promedio_semestral = conexion.consultaUno("select cast(promedio as varchar) + ' Al día ' + protic.trunc(audi_fmodificacion) from PROMEDIOS_ALUMNOS_CARRERA where cast(pers_ncorr as varchar)='"&pers_ncorr&"' and carr_ccod='"&carr_ccod&"' and peri_ccod=238")
			...
			<table width="75%" cellpadding="0" cellspacing="0">
			  <tr bgcolor="#FF6600">
			  		<td width="100%" height="40" align="center">
						<font color="#0033CC" face="Geneva, Arial, Helvetica, sans-serif" size="2"><strong>Promedio 1er Semestre 2015: <%=promedio_semestral%></strong></font>
					</td>
			  </tr>
			</table>
		</td>
