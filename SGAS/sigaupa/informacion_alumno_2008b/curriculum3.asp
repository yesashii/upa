...
<% 
'------------------------------------------------------
response.Redirect("curriculum_mantencion.asp")
...
"order  by exal_fini desc "
 ...
 f_muestra_habilidades_programa.Inicializar conexion
				...
				MuestraHabilidadesPrograma=	"select pers_ncorr,cdpa_ncorr,cdpa_tprograma,nidi_ccod from curriculum_dominio_programa_alumno where pers_ncorr="&pers_ncorr&" order by cdpa_tprograma" 
