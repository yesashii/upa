...
'conexión a servidor de producción consultas que requieran actualización al minuto
 ...
 ' end if
  ...
  if tiene_foto="S" then 
    	nombre_foto = conexion.consultaUno("Select ltrim(rtrim(imagen)) from rut_fotos_2010 where cast(rut as varchar)='"&usuario&"'")
...
function muestra (dia, mes,anio,codigo)
{
	...
	window.open(direccion,"ventana1","width=350, height=400, scrollbars=no, menubar=no, location=no, resizable=no"); 
							...
							<tr>
								...
								<td width="60%" align="center">
									<table width="100%">
                                        ...
                                        <tr>
                                           <td align="center">
                                           		<table width="90" height="37" cellpadding="0" cellspacing="0">
                                                	<tr>
                                                    	<td width="50" height="36" align="center">
                                                        	<a href="redireccionar.asp?pers_ncorr=<%=pers_ncorr%>&tipo=1" title="Acceder a Aula Virtual" target="_blank"><img width="48" height="36" src="imagenes/moodle.png" border="0"></a>
                                                        </td>
                                                        <td width="40" height="36" align="center">
                                                        	<a href="redireccionar.asp?pers_ncorr=<%=pers_ncorr%>&tipo=2" title="Acceder a Correo Electrónico" target="_blank"><img width="37" height="37" src="imagenes/email.png" border="0"></a>
                                                        </td>
                                                    </tr>
                                                </table>
                                           </td>
