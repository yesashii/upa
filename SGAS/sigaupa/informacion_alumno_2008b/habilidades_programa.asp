...
'------------------------------------------------------
	...
	cdpa_ncorr	= Request.QueryString("cdpa_ncorr")
    q_pers_nrut = Request.QueryString("pers_nrut")
	'response.write("cdpa_ncorr="&cdpa_ncorr)
...
'---------------------------------------------------------------------------------------------------
 ...
 set habilidades_programas = new CFormulario
 habilidades_programas.Carga_Parametros "curriculum_alumno.xml", "habilidades_programas"
 habilidades_programas.Inicializar conexion

	if cdpa_ncorr ="" then
	selec_habilidades_programas="select '' "
	else				
 selec_habilidades_programas="select cdpa_ncorr,cdpa_tprograma,nidi_ccod from curriculum_dominio_programa_alumno where cdpa_ncorr="&cdpa_ncorr&""
 
 ''response.Write(selec_habilidades_programas)
 end if
 habilidades_programas.Consultar selec_habilidades_programas
 habilidades_programas.Siguiente
...
<table align="center" width="700">
	<form name="habilidades_programa">
	<input type="hidden" name="hapr[0][cdpa_ncorr]" value="<%=cdpa_ncorr%>">
	<input type="hidden" name="hapr[0][pers_nrut]" value="<%=q_pers_nrut%>">
	<tr>
						...
						<table width="98%" border="0" bgcolor="#f7faff">
							<tr>
								<td width="100%" align="center">
									<table width="100%">
										<tr>
										    <td width="37%" height="23"><strong><font color="#496da6" size="3" face="Georgia, Times New Roman, Times, serif">Dominio de Programas Informaticos </font></strong></td>
										    <td width="52%"><hr></td>
										   <TD width="11%">
										   		<%POS_IMAGEN = 0%>
								...
								<td width="100%" align="center" colspan="2">
									<table width="100%" border="0" cellpadding="1" cellspacing="3">
									  <tr> 
										...
										<td colspan="2"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Software</strong></font></td>
										<td colspan="2"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Nivel de Conocimiento </strong></font></td>
									  </tr>
									  <tr valign="top" > 
											<td colspan="2"> 
												 <table width="100%" border="0" cellpadding="0" cellspacing="0">
													<tr> 
													 <td ><%habilidades_programas.dibujaCampo("cdpa_tprograma")%></td>
													</tr>
											  </table>											</td>
											<td colspan="2">
												 <table width="80%" border="0" cellpadding="0" cellspacing="0" >
													<tr>
													<td ><%habilidades_programas.dibujaCampo("nidi_ccod")%></td></tr>
									    </table>										</td>
									  </tr><tr valign="top" > 
									  ...
									  <td width="17%"></td>
										...
										<a href="javascript:_Guardar(this, document.forms['habilidades_programa'], 'proc_habilidades_programa.asp','', '', '', 'FALSE');"
											...
											<td width="29%" height="10" align="left"><%POS_IMAGEN = POS_IMAGEN + 2%>
