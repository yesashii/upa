						...
						<table width="98%" border="0" bgcolor="#f7faff">
							<tr>
								<td width="100%" align="center">
									<table width="100%">
										<tr>
										   <td width="45%"><font size="3" face="Georgia, Times New Roman, Times, serif" color="#496da6"><strong>Identificaci&oacute;n del sostenedor acad&eacute;mico</strong></font></td>
										   <td><hr></td>
										</tr>
									</table>
								</td>
							...
							<tr>
								<td width="100%" align="center">
									<table width="100%" border="0" cellpadding="1" cellspacing="3">
									  <tr> 
										<td height="20"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Nombre :</strong></font></td>
										<td><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>RUT :</strong></font></td>
										<td><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Fecha Nacimiento :</strong></font></td>
										<td><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Edad :</strong></font></td>
									  </tr>
									  <tr valign="top"> 
											<td height="20"> 
												 <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
