   		...
   		if (verifica_check(document.edicion2))
			{
				if (confirm("¿Está seguro que desea eliminar el optativo deportivo de la carga del alumno?"))
				{
					...
					document.edicion2.action="eliminar_optativo_deportivo.asp";
...
<table align="center" width="700">
	...
	<tr>
		<td width="100%" align="left">
			<table width="700" cellpadding="0" cellspacing="0" border="0" bgcolor="#c95100">
				<tr><td bgcolor="#84a6d3">
						...
						<TR valign="bottom">
							...
							<TD width="75" height="90"><img width="75" height="90" border="0" src="imagenes/LENGUETA4b.png" ></TD>
							<TD height="90">&nbsp;</TD>
						</TR>
						</table>
				    </td>
						...
						<table width="98%" border="0" bgcolor="#f7faff">
							<tr>
								<td width="100%" align="center">
									<table width="100%">
										<tr>
										   <td width="22%"><font size="3" face="Georgia, Times New Roman, Times, serif" color="#496da6"><strong>Asignaturas Deportivas</strong></font></td>
										   <td width="68%"><hr></td>
										   <TD width="10%">
										   		<%POS_IMAGEN = 4%>
									   ...
									   <tr><td colspan="4">
										   <%if sin_definir = false and cantidad_planificada <> "0" then%>
											<table width="100%"  border="0">
											 <tr>
													<td><font size="2" face="Georgia, Times New Roman, Times, serif" color="#496da6"><strong>1.- Seleccione los optativos deportivos que desee cursar en el semestre.</strong></font></td>
											 </tr>
											 <tr>
											  ...
											  <tr>
												<td width="81%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
													  ...
													  <%if tipo_plan <> "0" and cint(suma_creditos) >= 27 then%>
														<tr>
														   <td colspan="4" align="center"><font  size="2" color="#496da6"><strong>Atención el total de Cr&eacute;ditos Asignados (<%=suma_creditos%>) esta fuera del rango permitido (9-27).<br> Elimine parte de la carga para tomar el curso optativo.</strong></font>
														   </td>
														</tr>
													  <%end if%>
													</table></td>
											...
											<form name="edicion2">
											  <input type="hidden" name="matr_ncorr" value="<%=matr_ncorr%>">
													<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
													  <tr>
															<td><font size="2" face="Georgia, Times New Roman, Times, serif" color="#496da6"><strong>2.- Listado de Optativos Deportivos que ya pertenecen a su carga académica.</strong></font>
															</td>
													  </tr>
													  </table>
													 <table width="100%" border="0">
