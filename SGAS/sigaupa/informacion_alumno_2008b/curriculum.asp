...
'------------------------------------------------------------------------------------------ 
 ...
 f_muestra_trabajo.Inicializar conexion
				 ...
				 trabajomuestra=	"select top 1 a.dlpr_ncorr,exal_ncorr ,dlpr_nombre_empresa,dlpr_rubro_empresa,dlpr_cargo_empresa,dlpr_web_empresa from direccion_laboral_profesionales a,experiencia_alumno b where a.dlpr_ncorr=b.dlpr_ncorr and tiea_ccod=1 and a.pers_ncorr="&pers_ncorr&" and exal_ffin ='' order  by exal_fini desc"
...
"and a.dlpr_ncorr not in(select top 1 a.dlpr_ncorr  from direccion_laboral_profesionales a,experiencia_alumno b where a.dlpr_ncorr=b.dlpr_ncorr and tiea_ccod=1 and a.pers_ncorr="&pers_ncorr&" and exal_ffin ='' order  by exal_fini desc)"& vbCrLf &_
...
'response.write(MuestraHabilidades)
 ...
 f_muestra_habilidades_programa.Inicializar conexion
				...
				MuestraHabilidadesPrograma=	"select pers_ncorr,cdpa_ncorr,(select soft_tdesc from software where soft_ncorr=cdpa_tprograma )as cdpa_tprograma,nidi_ccod from curriculum_dominio_programa_alumno where pers_ncorr="&pers_ncorr&" order by cdpa_tprograma" 

'response.write(MuestraHabilidadesPrograma)
...
<table align="center" width="700">
							...
							<tr>
							  <td width="100%" align="center">
									<table width="100%" border="0" cellpadding="1" cellspacing="3">
									  ...
									  <td width="55%" height="10" align="right">
									  <%POS_IMAGEN = POS_IMAGEN + 1%>
										<a href="javascript:irA('curriculum_pdf.asp?pers_nrut=<%=q_pers_nrut%>', '1', 1240, 768)"
										onMouseOver="window.status='botón pulsado';document.images[<%=POS_IMAGEN%>].src='imagenes/IMPRIMIR2.png';return true "
																onMouseOut="window.status='';document.images[<%=POS_IMAGEN%>].src='imagenes/IMPRIMIR1.png';return true "> <img src="imagenes/IMPRIMIR1.png" border="0" width="70" height="70" alt="Imprimir"></a></td>
										...
										<a href="javascript:_Navegar(this, 'curso_diplomado.asp?pers_nrut=<%=q_pers_nrut%>', 'FALSE');"
																...
																onMouseOut="window.status='';document.images[<%=POS_IMAGEN%>].src='imagenes/AGREGAR1.png';return true ">       <img src="imagenes/AGREGAR1.png" border="0" width="70" height="70" alt="Agregar"></a></td>
										...
										<a href="javascript:_Eliminar(this, document.forms['formacion_extra_academica'], 'proc_elimima_curso_diplomado.asp', '', 'TRUE');"
																...
																onMouseOut="window.status='';document.images[<%=POS_IMAGEN%>].src='imagenes/ELIMINAR1.png';return true ">       <img src="imagenes/ELIMINAR1.png" border="0" width="70" height="70" alt="Eliminar"></a></td>
										<td width="11%" height="10" align="right"><%POS_IMAGEN = POS_IMAGEN + 1%>
    ...
    <td width="11%" height="10" align="left"><%POS_IMAGEN = POS_IMAGEN + 1%>
      <a href="javascript:_Navegar(this, 'mensajes.asp', 'FALSE');"
												onMouseOver="window.status='botón pulsado';document.images[<%=POS_IMAGEN%>].src='imagenes/SALIR2.png';return true "
	...
	<tr>
		<td width="100%" height="319" align="left">
						...
						<table width="98%" border="0" bgcolor="#f7faff">
							<tr>
								<td width="100%" align="center">
									<table width="100%">
										<tr>
										   <td width="90%"><font size="3" face="Georgia, Times New Roman, Times, serif" color="#496da6"><strong>Experiencia Laboral</strong></font></td>
										   
										</tr>
                                        <tr>
                                         <td width="90%"><p>(considere este  apartado como cualquier actividad remunerada de m&aacute;s de 
                                          10 horas semanales)</p></td>
                                        </tr>
							...
							<tr>
							  <td width="100%" align="center">
									...
									<table width="100%" border="0" cellpadding="1" cellspacing="3">
                                	  ...
                                	  <tr>
                                  		 <td colspan="6"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Trabajo Actual</strong></font></td>
                                	  </tr>
								  </table>							  
								 </td>
							</tr>
							<tr>
							 <td width="100%" ><%f_muestra_trabajo.DibujaTabla()%></td>
							</tr>
							<tr>
                        <td colspan="6" >&nbsp;</td>
                      </tr>
	...
	<tr>
		<td width="100%" height="400" align="left"><table width="700" cellpadding="0" cellspacing="0" border="0" bgcolor="#4b73a6">
          <tr>
            ...
            <td width="100%" align="center"><table width="98%" border="0" bgcolor="#f7faff">
                ...
                <tr>
                  <td width="100%" align="center"><table width="100%" border="0" cellpadding="1" cellspacing="3">
                      ...
                      <tr>
                        <td colspan="6"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Trabajos Anteriores : </strong></font></td>
                      </tr>
                      <tr valign="top">
                        <td height="20" colspan="6">
						<table width="101%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
                            <tr>
                      ...
                      <tr>
                      <tr>
                       <td width="54%" height="10" align="right">
									  <%POS_IMAGEN = POS_IMAGEN + 1%>
						  <a href="javascript:irA('curriculum_pdf.asp?pers_nrut=<%=q_pers_nrut%>', '1', 1240, 768)"
										onMouseOver="window.status='botón pulsado';document.images[<%=POS_IMAGEN%>].src='imagenes/IMPRIMIR2.png';return true "
																onMouseOut="window.status='';document.images[<%=POS_IMAGEN%>].src='imagenes/IMPRIMIR1.png';return true "> <img src="imagenes/IMPRIMIR1.png" border="0" width="70" height="70" alt="Imprimir"></a></td>
                  ...
                  <td width="100%" align="center"><table width="100%" border="0" cellpadding="1" cellspacing="3">
                    <tr>
                      <td colspan="6" height="20">&nbsp;</td>
                          ...
                          <td colspan="6"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Pr&aacute;cticas </strong></font></td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr>
                    <tr>
                      <td width="53%" height="10" align="right">
									  <%POS_IMAGEN = POS_IMAGEN + 1%>
						  <a href="javascript:irA('curriculum_pdf.asp?pers_nrut=<%=q_pers_nrut%>', '1', 1240, 768)"
										onMouseOver="window.status='botón pulsado';document.images[<%=POS_IMAGEN%>].src='imagenes/IMPRIMIR2.png';return true "
																onMouseOut="window.status='';document.images[<%=POS_IMAGEN%>].src='imagenes/IMPRIMIR1.png';return true "> <img src="imagenes/IMPRIMIR1.png" border="0" width="70" height="70" alt="Imprimir"></a></td>
                      ...
                      <td width="11%" height="10" align="right"><%POS_IMAGEN = POS_IMAGEN + 1%>
                        <a href="javascript:_Navegar(this, 'javascript:irPagina2();', 'FALSE');"
												onMouseOver="window.status='botón pulsado';document.images[<%=POS_IMAGEN%>].src='imagenes/IR_A_PAGINA_12.png';return true "
												onMouseOut="window.status='';document.images[<%=POS_IMAGEN%>].src='imagenes/IR_A_PAGINA_11.png';return true "><img src="imagenes/IR_A_PAGINA_11.png" border="0" width="70" height="70" alt="VER INFORMACIÓN DE LA PÁGINA 1"></a></td>
                      <td width="14%" height="10" align="left"><%POS_IMAGEN = POS_IMAGEN + 1%>
                        <a href="javascript:_Navegar(this, 'mensajes.asp', 'FALSE');"
												onMouseOver="window.status='botón pulsado';document.images[<%=POS_IMAGEN%>].src='imagenes/SALIR2.png';return true "
												onMouseOut="window.status='';document.images[<%=POS_IMAGEN%>].src='imagenes/SALIR1.png';return true "> <img src="imagenes/SALIR1.png" border="0" width="70" height="70" alt="VOLVER AL HOME"> </a> </td>
                    </tr>
          ...
          <tr valign="middle">
            <td width="100%" align="center"><table width="98%" border="0" bgcolor="#f7faff">
                <tr>
                  <td width="100%" align="center"><table width="100%">
                      <tr>
                        <td width="90%"><font size="3" face="Georgia, Times New Roman, Times, serif" color="#496da6"><strong>Actividades Tempranas de Formación en la Profesión</strong></font></td>
                      </tr>
                        <td width="90%"><p>(considera  actividades relacionadas a&nbsp; tu carrera de  estudio de menos de 10 horas mensuales as&iacute; como actividades  previas como salidas a terreno, campos cl&iacute;nicos, seminarios u otras actividades  relacionadas con la malla de tu carrera)&#13;</p></td>
                       </tr>                      
                  </table></td>
                </tr>
                <tr>
                  <td width="100%" align="center"><table width="100%" border="0" cellpadding="1" cellspacing="3">
                    <tr>
                      <td colspan="6" height="20">&nbsp;</td>
                        ...
                        <td colspan="6"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Pasant&iacute;as </strong></font></td>
                    </tr>
                    <tr valign="top">
                      <td height="20" colspan="6"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
                          <tr>
										...
										onMouseOver="window.status='botón pulsado';document.images[<%=POS_IMAGEN%>].src='imagenes/IMPRIMIR2.png';return true "
											...
											<td width="12%" height="10" align="right">
															...
															<a href="javascript:_Navegar(this, 'idioma.asp?pers_nrut=<%=q_pers_nrut%>', 'FALSE');"
																...
																<img src="imagenes/AGREGAR1.png" border="0" width="70" height="70" alt="Agregar">															</a>										</td>
										<td width="11%" height="10" align="right">
										<%POS_IMAGEN = POS_IMAGEN + 1%>
								...
								<td width="100%" align="center">
									<table width="100%" border="0" cellpadding="1" cellspacing="3">
									  ...
									  <%POS_IMAGEN = POS_IMAGEN + 1%>
										...
										onMouseOver="window.status='botón pulsado';document.images[<%=POS_IMAGEN%>].src='imagenes/IMPRIMIR2.png';return true "
																onMouseOut="window.status='';document.images[<%=POS_IMAGEN%>].src='imagenes/IMPRIMIR1.png';return true "> <img src="imagenes/IMPRIMIR1.png" border="0" width="70" height="70" alt="Imprimir"></a></td>
										<td width="14%" height="10" align="right">
															<%POS_IMAGEN = POS_IMAGEN + 1%>
						...
						<table width="98%" border="0" bgcolor="#f7faff">
							...
							<tr>
								<td width="100%" align="center">
									<table width="100%" border="0" cellpadding="1" cellspacing="3">
									  <tr> 
									<td colspan="4"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Habilidades Profesionales </strong></font>(tienen relaci&oacute;n con las asignaturas de tu carrera y lo que has aprendido de  ellas)</td>
									  </tr>
									  <tr> 
									   ...
									   <tr> 
										<td colspan="4"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Habilidades Tecnicas</strong></font> (manejo  de programas inform&aacute;ticos u otras herramientas)</td>
									  </tr>
									  <tr> 
									  ...
									  <tr> 
										<td colspan="4"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Habilidades Personales </strong></font>(relacionadas  con tu inteligencia emocional (valores, comunicacionales, etc.)</td>
									  </tr>
									  <tr> 
									  ...
									  <%POS_IMAGEN = POS_IMAGEN + 1%>
										...
										<img src="imagenes/GUARDAR1.png" border="0" width="70" height="70" alt="Agregar">															</a>										</td>
										<td width="11%" height="10" align="right">
											    <%POS_IMAGEN = POS_IMAGEN + 1%>
										   		<a href="javascript:_Navegar(this, 'javascript:irPagina2();', 'FALSE');"
												onmouseover="window.status='botón pulsado';document.images[<%=POS_IMAGEN%>].src='imagenes/IR_A_PAGINA_12.png';return true "
