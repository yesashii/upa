						...
						<table width="100%" border="1" bordercolor="#666666" bgcolor="#FFFFFF">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  ...
							  <tr> 
								...
								<td width="50%" align="center"><font size="2"><strong>JEFE OFICINA</strong></font></td>
							  </tr>
								<tr> 
								<td width="34%" align="center">&nbsp;</td>
								<td width="16%" align="center">&nbsp;</td>
								<!--<td width="50%" align="center"><font size="2"><strong>Secretaria General</strong></font></td>-->
								<td width="50%" align="center"><font size="2"><strong>REGISTRO CURRICULAR</strong></font></td>
							  </tr>
								<tr> 
								<td width="34%" align="center">&nbsp;</td>
								<td width="16%" align="center">&nbsp;</td>
