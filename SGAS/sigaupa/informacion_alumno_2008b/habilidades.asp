...
'	next
	...
	chal_ncorr	= Request.QueryString("chal_ncorr")
...
MuestraHabilidades=	"select '' "
					...
					MuestraHabilidades=	"select chal_ncorr,chal_tarea_trabajo,chal_thabilidades_tecnica,chal_thabilidades_personales,chal_thabilidades_profesionales from curriculum_habilidades_alumno where chal_ncorr="&chal_ncorr&"" 
...
<table align="center" width="700">
	...
	<input type="hidden" name="habi[0][chal_ncorr]" value="<%=chal_ncorr%>">
								...
								<td width="100%" align="center" colspan="2">
									<table width="100%" border="0" cellpadding="1" cellspacing="3">
									  <tr> 
										...
										<td colspan="2"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Habilidades Profesionales</strong></font></td>
										<td colspan="2"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Habilidades Tecnicas</strong></font></td>
									  ...
									  <tr valign="top" > 
											<td colspan="2"> 
												 <table width="100%" border="0" cellpadding="0" cellspacing="0">
													<tr> 
													 <td ><%f_habilidades.dibujaCampo("chal_thabilidades_profesionales")%></td>
													</tr>
											  </table>											</td>
											<td colspan="2">
												 <table width="80%" border="0" cellpadding="0" cellspacing="0" >
													<tr>
													<td ><%f_habilidades.dibujaCampo("chal_thabilidades_tecnica")%></td></tr>
									    </table>										</td>
									  ...
									  <tr valign="top" > 
										<td height="20" colspan="2"> <table width="100%" border="0" cellpadding="0" cellspacing="0" >
											<tr><td width="36%"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Habilidades Personales</strong></font></td></tr>
									    </table>									    </td>
										 <td colspan="2"> <table width="100%" border="0" cellpadding="0" cellspacing="0" >
											<tr>
											  <td width="36%"><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>Areas en las que deseas trabajar </strong></font></td>
											</tr>
										  </table>									    </td>
									  ...
									  <td colspan="2"> 
												 <table width="100%" border="0" cellpadding="0" cellspacing="0" >
													<tr> 
													  <td ><%f_habilidades.dibujaCampo("chal_thabilidades_personales")%></td>
													</tr>
											  </table>											</td>
											<td colspan="2">
												 <table width="80%" border="0" cellpadding="0" cellspacing="0" >
													<tr><td ><%f_habilidades.dibujaCampo("chal_tarea_trabajo")%></td></tr>
									    </table>										</td>
									  ...
									  <td width="17%"></td>
										...
										<a href="javascript:_Guardar(this, document.forms['curso_diplomado'], 'proc_habilidades.asp','', '', '', 'FALSE');"
																onMouseOver="window.status='botón pulsado';document.images[<%=POS_IMAGEN%>].src='imagenes/GUARDAR2.png';return true "
																onMouseOut="window.status='';document.images[<%=POS_IMAGEN%>].src='imagenes/GUARDAR1.png';return true "><img src="imagenes/GUARDAR1.png" border="0" width="70" height="70" alt="Guardar nueva Clave"></a></td>
