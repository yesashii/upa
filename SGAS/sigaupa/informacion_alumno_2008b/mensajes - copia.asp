...
'response.Write(total)
  ...
  promedio_semestral = conexion.consultaUno("select cast(promedio as varchar) + ' Al día ' + protic.trunc(audi_fmodificacion) from PROMEDIOS_ALUMNOS_CARRERA where cast(pers_ncorr as varchar)='"&pers_ncorr&"' and carr_ccod='"&carr_ccod&"' and peri_ccod=230")
...
<table align="center" width="730">
			...
			<table width="75%" cellpadding="0" cellspacing="0">
			  <tr bgcolor="#FF6600">
			  		<td width="100%" height="40" align="center">
						<font color="#0033CC" face="Geneva, Arial, Helvetica, sans-serif" size="2"><strong>Promedio 1er Semestre 2014: <%=promedio_semestral%></strong></font>
					</td>
			  </tr>
			</table>
		</td>
	...
	<tr>
	    <td width="100%" align="center">
			<table width="70%" cellpadding="0" cellspacing="2">
				<tr>
				...
				<tr>
					...
					<td colspan="3" align="left"><a href="../Doc/Presentación_Bienvenida_Alumnos_2010_intranet.ppt" target="_blank">Presentación Bienvenida alumnos nuevos</a></td>
				</tr>
				<tr>
					<td colspan="4">&nbsp;</td>
				</tr>
				...
				<!--<tr>
					<td colspan="4" bgcolor="#FFCC33" align="left"> <font size="2"><strong><a href="../Doc/NORMATIVA_INTERNA_PARA_ALUMNOS_CURSO_SUPERIOR_CAE_2011.PDF" target="_blank">NORMATIVA INTERNA PARA ALUMNOS CURSO SUPERIOR CAE 2011</a></strong></font></td>
				</tr>
				<tr>
					<td colspan="4" bgcolor="#FFCC33" align="left"> <font size="2"><strong><a href="../Doc/NORMATIVA_INTERNA_PARA_ALUMNOS_RENOVANTES_DEL_CAE_2011.PDF" target="_blank">NORMATIVA INTERNA PARA ALUMNOS RENOVANTES DEL CAE 2011</a></strong></font></td>
				</tr>
				<tr>
					<td colspan="4" bgcolor="#FFCC33" align="left"> <font size="2"><strong><a href="../Doc/NORMATIVA_INTERNA_BECAS_MINEDUC_2011.PDF" target="_blank">NORMATIVA INTERNA BECAS MINEDUC 2011</a></strong></font></td>
				</tr>
				<tr>
					<td colspan="4" bgcolor="#FFFF99" align="left"> <font size="2"><strong><a href="../Doc/FORMULARIO_WEB_ALUMNO_2012.PDF" target="_blank">POSTULACIÓN AYUDAS ESTUDIANTILES 2012</a></strong></font></td>
				</tr>
				<tr>
					<td colspan="4" bgcolor="#FFFF99" align="left"> <font size="2"><strong><a href="../Doc/INSTRUCTIVO_WEB_2012.PDF" target="_blank">INSTRUCCIONES PARA LLENAR EL FORMULARIO</a></strong></font></td>
				</tr>
				<tr>
					<td colspan="4" bgcolor="#FFFF99" align="left"> <font size="2"><strong><a href="../Doc/REGLAMENTO_INTERNO_BECA_COPAGO_ARANCEL_CAE_17_10_11_GGA.DOC" target="_blank">REGLAMENTO INTERNO BECA COPAGO ARANCEL CAE 2012</a></strong></font></td>
				</tr>
				<tr>
					<td colspan="4" bgcolor="#FFFF99" align="left"> <font size="2"><strong><a href="../Doc/REGLAMENTO_DE_BECAS_FOTOCOPIAS_2012.DOC" target="_blank">REGLAMENTO DE BECAS FOTOCOPIAS 2012</a></strong></font></td>
				</tr>
				<tr>
					<td colspan="4" bgcolor="#FFFF99" align="left"> <font size="2"><strong><a href="../Doc/REGLAMENTO_DE_BECAS_ALIMENTICIAS_2012.DOC" target="_blank">REGLAMENTO DE BECAS ALIMENTICIAS 2012</a></strong></font></td>
				</tr>-->
				<tr>
					<td colspan="4" bgcolor="#FFFF99" align="left"> <font size="2"><strong><a href="../Doc/Formulario_web_2014.pdf" target="_blank">POSTULACIÓN BECAS ESTUDIANTILES DAE 2014</a></strong></font></td>
				</tr>
				<tr>
					<td colspan="4" bgcolor="#FFFF99" align="left"> <font size="2"><strong><a href="../Doc/Instructivo_web_2014.pdf" target="_blank">INSTRUCCIONES POSTULACIÓN BECAS DAE 2014</a></strong></font></td>
				</tr>
			</table>
		</td>
	</tr>
									...
									<table width="100%">
										<tr>
										   ...
										   <td width="38" height="38">
												...
												onmouseover="window.status='botón pulsado';document.images['ayuda'].src='imagenes/ayuda2.png';return true "
												onmouseout="window.status='';document.images['ayuda'].src='imagenes/ayuda1.png';return true ">
												
												<img name="ayuda" src="imagenes/ayuda1.png" border="0" width="38" height="38" alt="¿Cómo funciona?"> 
												</a>
													...
													<tr valign="middle">
														<td width="33%" align="center">
															<a href="javascript:mensaje_companero(document.edicion);"
																onmouseover="window.status='botón pulsado';document.images['companero'].src='imagenes/ENVIAR_COMPA2.png';return true "
																onmouseout="window.status='';document.images['companero'].src='imagenes/ENVIAR_COMPA1.png';return true ">
																<img name="companero" src="imagenes/ENVIAR_COMPA1.png" border="0" width="70" height="70" alt="Enviar Mensaje a compañero"> 
															</a>
														</td>
														<td width="34%" align="center">
															<a href="javascript:mensaje_profesor(document.edicion);"
																onmouseover="window.status='botón pulsado';document.images['profesor'].src='imagenes/ENVIAR_PROFE2.png';return true "
																onmouseout="window.status='';document.images['profesor'].src='imagenes/ENVIAR_PROFE1.png';return true ">
																<img name="profesor" src="imagenes/ENVIAR_PROFE1.png" border="0" width="70" height="70" alt="Enviar Mensaje a profesor"> 
															</a>
														</td>
														<td width="33%" align="center">
															<a href="javascript:_Eliminar(this, document.forms['edicion'], 'eliminar_mensajes_proc.asp', '', 'TRUE');"
																onmouseover="window.status='botón pulsado';document.images['borrar'].src='imagenes/Eliminar2.png';return true "
																onmouseout="window.status='';document.images['borrar'].src='imagenes/Eliminar1.png';return true ">
																<img name="borrar" src="imagenes/Eliminar1.png" border="0" width="70" height="70" alt="Eliminar mensajes seleccionados"> 
															</a>
														</td>
													</tr>
												</table>
