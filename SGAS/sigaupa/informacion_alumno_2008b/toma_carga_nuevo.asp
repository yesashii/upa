...
pagina.Titulo = "Asignaturas del plan de estudios"
...
"                                                                                            and sf.sitf_baprueba = 'S'                               " & vbCrLf &_
"                                                                          where  carr_ccod = '"&v_carr_ccod&"') as apro                              " & vbCrLf &_
...
"                                              on mc.asig_ccod = prueba.asig_ccod_destino --se agrega prueba.(13-03-2013)                             " & vbCrLf &_
...
"                                          and d.emat_ccod in ( 1, 6, 11 )                                                                            " & vbCrLf &_
"                                          and cast(d.pers_ncorr as varchar) = '" & pers_ncorr & "'                                                   " & vbCrLf &_
"                        where  cast(sitf_baprueba as varchar) = 'N'                                                                                  " & vbCrLf &_
"                        union all                                                                                                                    " & vbCrLf &_
...
"         when '"&v_carr_ccod&"' then '(*)'                                                                                                             " & vbCrLf &_
"                                     + substring(cast(a.secc_tdesc as varchar), 1, 1)                                                                  " & vbCrLf &_
"                                     + ' -> '                                                                                                          " & vbCrLf &_
...
"                                     + ' CUPOS)- '                                                                                                     " & vbCrLf &_
"         else substring(cast(a.secc_tdesc as varchar), 1, 1)                                                                                           " & vbCrLf &_
"              + ' -> '                                                                                                                                 " & vbCrLf &_
"              + cast(protic.horario(a.secc_ccod) as varchar)                                                                                           " & vbCrLf &_
"              + ' -('                                                                                                                                  " & vbCrLf &_
"              + cast((a.secc_ncupo - (select count(*) from cargas_academicas ca where ca.secc_ccod = a.secc_ccod) ) as varchar)                        " & vbCrLf &_
...
"       and cast(a.asig_ccod as varchar) in ( "&arr_asignatura&" )                                                                                      " & vbCrLf &_
"       and cast(a.carr_ccod as varchar) = '"&v_carr_ccod&"'                                                                                            " & vbCrLf &_
"       and ( a.secc_ncupo - (select count(*)                                                                                                           " & vbCrLf &_
"                             from   cargas_academicas ca                                                                                               " & vbCrLf &_
"                             where  ca.secc_ccod = a.secc_ccod) ) > 0                                                                                  " & vbCrLf &_
...
<table align="center" width="700">
	...
	<tr>
		<td width="100%" align="left">
			<table width="700" cellpadding="0" cellspacing="0" border="0" bgcolor="#26508a">
				<tr><td bgcolor="#84a6d3">
						<table width="100%" height="90" align="left" cellpadding="0" cellspacing="0" bgcolor="#84a6d3">
						<TR valign="bottom">
							<TD width="75" height="90"><img width="75" height="90" border="0" src="imagenes/LENGUETA1b.png"></TD>
						...
						<table width="98%" border="0" bgcolor="#f7faff">
							<tr>
								<td width="100%" align="center">
									<table width="100%">
										<tr>
										   <td width="33%"><font size="3" face="Georgia, Times New Roman, Times, serif" color="#496da6"><strong>Asignaturas del plan</strong></font></td>
										   <td><hr></td>
										   <TD width="10%">
										   		<%POS_IMAGEN = 4%>
											...
											<td align="center" colspan="4">
												<table align="center" class=v1 width='98%' border='1' cellpadding='0' cellspacing='0' bordercolor='#999999' bgcolor='#ADADAD' id='tb_toma_carga'>
													...
													<%wend
													  if contador = 0 then%>
														<tr bgcolor="#FFFFFF"> 
															<td class='noclick'align='center' colspan="4" onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'>No existen asignaturas planificadas en tu plan de estudios, debes tomar carga directamente en tu escuela.</td>
														</tr>
													  <%end if%>
												</table>
											</td>
