...
f_agrega.Carga_Parametros "curriculum_alumno.xml", "trabajo_antiguo_muestra"
...
exal_ncorr =f_agrega.ObtenerValorPost (filai, "exal_ncorr")
dlpr_ncorr =f_agrega.ObtenerValorPost (filai, "dlpr_ncorr")

if exal_ncorr <> "" then
	p_exaldelete="delete from experiencia_alumno where exal_ncorr="&exal_ncorr&""
