...
nombre = conexion.consultaUno("select pers_tnombre + ' ' + pers_tape_paterno from personas_postulante where cast(pers_nrut as varchar)='"&rut_antiguo&"'")
                  ...
                  <tr>
                    <td bgcolor="#CCCCCC">
                      <div align="center"><font size="2" color="#FFFFFF" face="Times New Roman, Times, serif">
					                      <strong>&iquest;OLVIDASTE TU NOMBRE DE USUARIO O LA CLAVE?</strong></font></div></td>
                  </tr>
				  <tr>
                    <td bgcolor="#CCCCCC"><hr></tr>
                  <tr>
                    <td bgcolor="#CCCCCC">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="17%" height="20"><font size="2" color="#FFFFFF" face="Times New Roman, Times, serif">RUT</font></td>
                          <td width="83%"><font size="2" color="#FFFFFF" face="Times New Roman, Times, serif"> :<b> <%=rut%></b></font></td>
                        </tr>
						<tr>
                          <td width="17%" height="20"><font size="2" color="#FFFFFF" face="Times New Roman, Times, serif">Nombre</font></td>
                          <td width="83%"><font size="2" color="#FFFFFF" face="Times New Roman, Times, serif"> :<b> <%=nombre%></b></font></td>
                        </tr>
						<tr><td colspan="2">&nbsp;</td></tr>
                        <tr>
                          <td width="17%" height="20" bgcolor="#003366"><font size="2" color="#FFFFFF" face="Times New Roman, Times, serif">Pregunta </font></td>
                          <td width="83%" bgcolor="#003366"><font size="2" color="#FFFFFF" face="Times New Roman, Times, serif"> : <b><%=pregunta%></b></font></td>
                        </tr>
                        <tr>
                          <td width="17%" height="15"bgcolor="#003366"><font size="2" color="#FFFFFF" face="Times New Roman, Times, serif">Respuesta</font></td>
                          <td width="83%" bgcolor="#003366"><font size="2" color="#FFFFFF" face="Times New Roman, Times, serif">:
                              <input type="text" name="respuesta" size="40" maxlength="40" ></font></td>
                        </tr>
						<tr>
                            <td height="30" bgcolor="#CCCCCC"><div align="center"><%f_botonera.DibujaBoton("aceptar")%></div></td>
                            <td height="30" bgcolor="#CCCCCC"><div align="left"><%f_botonera.DibujaBoton("cancelar")%></div></td>
                        </tr>
						<tr>
                            <td colspan="2">&nbsp;</td>
                        </tr>
