...
existe_pp=conexion.ConsultaUno("select case count(pers_ncorr) when 0 then 'n' else 's' end from personas_postulante where cast(pers_nrut as varchar)='"&pers_nrut&"'")
	if existe ="s" or existe_pp = "s" then
		...
		update_persona 	 = "update personas_postulante set pers_tape_paterno='"&pers_tape_paterno&"', pers_tape_materno='"&pers_tape_materno&"', pers_tnombre='"&pers_tnombre&"', eciv_ccod="&eciv_ccod&" where cast(pers_nrut as varchar)='"&pers_nrut&"'" 
