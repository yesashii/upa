...
consulta = " select opcion, sum(interna) as interna, sum(externa) as externa  " & vbCrLf &_
		   "	from  " & vbCrLf &_
		   "	(  " & vbCrLf &_
		   "	select distinct b.pers_ncorr,  " & vbCrLf &_
		   "		   (select top 1 opcion from postulantes tt (nolock), ip_postulaciones t2 (nolock)  " & vbCrLf &_
		   "			where tt.pers_ncorr=b.pers_ncorr and tt.peri_ccod=b.peri_ccod  " & vbCrLf &_
		   "			and tt.post_ncorr=t2.post_ncorr order by t2.AUDI_FMODIFICACION desc ) as opcion,   " & vbCrLf &_
		   "		   (select top 1   " & vbCrLf &_
		   "			case when t2.IP_GENERAL like '10.%'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL like '172.%'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL like '192.168.%'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.27.186.129'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.27.186.130'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.27.186.131'   or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.27.186.132'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.27.186.133'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.27.186.134'  or   " & vbCrLf &_  
		   "					  t2.IP_GENERAL = '200.113.180.112'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.113.180.113'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.113.180.114'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.113.180.115'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.113.180.116'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.113.180.117'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.113.180.118'  or   " & vbCrLf &_
		   "					  t2.IP_GENERAL = '200.113.180.119'  " & vbCrLf &_
		   "				 then 1  " & vbCrLf &_
		   "				 else 0 end  " & vbCrLf &_
		   "			from postulantes tt (nolock), ip_postulaciones t2 (nolock)  " & vbCrLf &_
		   "			where tt.pers_ncorr=b.pers_ncorr and tt.peri_ccod=b.peri_ccod  " & vbCrLf &_
		   "			and tt.post_ncorr=t2.post_ncorr order by t2.AUDI_FMODIFICACION desc ) as interna,  " & vbCrLf &_
		   "			(select top 1   " & vbCrLf &_
		   "			case when t2.IP_GENERAL not like '10.%'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL not like '172.%'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL not like '192.168.%'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.27.186.129'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.27.186.130'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.27.186.131'  and  " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.27.186.132'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.27.186.133'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.27.186.134'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.113.180.112'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.113.180.113'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.113.180.114'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.113.180.115'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.113.180.116'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.113.180.117'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.113.180.118'  and   " & vbCrLf &_
		   "					  t2.IP_GENERAL <> '200.113.180.119'  " & vbCrLf &_
		   "				 then 1  " & vbCrLf &_
		   "				 else 0 end  " & vbCrLf &_
		   "			from postulantes tt (nolock), ip_postulaciones t2 (nolock)  " & vbCrLf &_
		   "			where tt.pers_ncorr=b.pers_ncorr and tt.peri_ccod=b.peri_ccod  " & vbCrLf &_
		   "			and tt.post_ncorr=t2.post_ncorr order by t2.AUDI_FMODIFICACION desc ) as externa  " & vbCrLf &_
		   ...
		   "				from ofertas_academicas tt (nolock), aranceles t2 (nolock)   " & vbCrLf &_
		   "				where tt.aran_ncorr=t2.aran_ncorr   and tt.ofer_ncorr=a.ofer_ncorr  " & vbCrLf &_
		   "				and isnull(t2.aran_mcolegiatura,0) > 1 )   " & vbCrLf &_
		   "	) ttt  " & vbCrLf &_
		   "	group by ttt.opcion  " & vbCrLf &_
		   "	order by opcion asc  " 
...
while lista.siguiente
	externos_general = externos_general + cint(lista.obtenerValor("externa"))
	internos_general = internos_general + cint(lista.obtenerValor("interna"))
wend
lista.primero
...
consulta = " select sede, sum(interna) as interna, sum(externa) as externa  " & vbCrLf &_
		   " from  " & vbCrLf &_
		   " (  " & vbCrLf &_
		   " select distinct b.pers_ncorr,  " & vbCrLf &_
		   "       (select top 1 sede_tdesc   " & vbCrLf &_
		   "        from postulantes tt (nolock), ip_postulaciones t2 (nolock),   " & vbCrLf &_
		   "             ofertas_academicas t3, sedes t4  " & vbCrLf &_
		   "        where tt.pers_ncorr=b.pers_ncorr and tt.peri_ccod=b.peri_ccod  " & vbCrLf &_
		   "        and tt.post_ncorr=t2.post_ncorr   " & vbCrLf &_
		   "        and t2.ofer_ncorr=t3.ofer_ncorr and t3.sede_ccod=t4.sede_ccod   " & vbCrLf &_
		   "        order by t2.AUDI_FMODIFICACION desc ) as sede,   " & vbCrLf &_
		   "       (select top 1   " & vbCrLf &_
		   "        case when t2.IP_GENERAL like '10.%'  or   " & vbCrLf &_
		   "                  t2.IP_GENERAL like '172.%'  or   " & vbCrLf &_
		   "                  t2.IP_GENERAL like '192.168.%'  or   " & vbCrLf &_
...
consulta =  " select carrera, sum(interna) as interna, sum(externa) as externa  " & vbCrLf &_
		   " from  " & vbCrLf &_
		   " (  " & vbCrLf &_
		   " select distinct b.pers_ncorr,  " & vbCrLf &_
		   "       (select top 1 carr_tdesc   " & vbCrLf &_
		   "        from postulantes tt (nolock), ip_postulaciones t2 (nolock),   " & vbCrLf &_
		   "             ofertas_academicas t3, especialidades t4, carreras t5  " & vbCrLf &_
		   "        where tt.pers_ncorr=b.pers_ncorr and tt.peri_ccod=b.peri_ccod  " & vbCrLf &_
		   "        and tt.post_ncorr=t2.post_ncorr   " & vbCrLf &_
		   "        and t2.ofer_ncorr=t3.ofer_ncorr and t3.espe_ccod=t4.espe_ccod and t4.carr_ccod=t5.carr_ccod  " & vbCrLf &_
		   "        order by t2.AUDI_FMODIFICACION desc ) as carrera,   " & vbCrLf &_
		   "       (select top 1   " & vbCrLf &_
		   "        case when t2.IP_GENERAL like '10.%'  or   " & vbCrLf &_
		   "                  t2.IP_GENERAL like '172.%'  or   " & vbCrLf &_
		   "                  t2.IP_GENERAL like '192.168.%'  or   " & vbCrLf &_
	...
	<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr><td>&nbsp;</td></tr>
		  <tr><td align="left"><font face="Georgia, Times New Roman, Times, serif" size="2" color="#0066FF">DISTRIBUCIÓN GENERAL DE POSTULANTES</font></td></tr>
		  <form name="edicion">
		  <tr>
		      <td>
			      <table width="100%" cellpadding="0" cellspacing="0" border="0">
					...
					<tr><td align="left"><font face="Georgia, Times New Roman, Times, serif" size="2" color="#0066FF">POSTULANTES DISTRIBUÍDOS POR PÁGINA DE ACCESO</font></td></tr>
					<tr>
						<td width="50%" align="center">
							<table width="98%" cellpadding="2" cellspacing="2" border="1">
							   <tr>
							   ...
							   <% total_general_1 = 0
							      while lista.siguiente 
							      total_t =  cdbl(lista.obtenerValor("interna")) + cdbl(lista.obtenerValor("externa")) 
								  total_general_1 = total_general_1 + total_t%>
							   <tr>
							   		<td width="50%"><%=lista.obtenerValor("opcion")%></td>
									<td width="20%" align="center"><%=lista.obtenerValor("interna")%></td>
									<td width="20%" align="center"><%=lista.obtenerValor("externa")%></td>
									<td width="10%" align="center"><%=total_t%></td>
							   </tr>
							   <% wend
							      lista.primero%>
							   <tr>
							   		<td colspan="3" align="right"><strong>Total...:</strong></td>
									<td align="center"><%=total_general_1%></td>
							   </tr>
							</table>
						</td>
						<td width="50%" bgcolor="#FFFFFF">
							<table id='myTable1_2' align="center">
								...
								<tr>
									<th>Post.Internas</th>
									<% while lista.siguiente %>
										<td><%=lista.obtenerValor("interna")%></td>
								    <% wend
									  lista.primero%>
								</tr>
								<tr>
									<th>Post.Externas</th>
									<% while lista.siguiente %>
										<td><%=lista.obtenerValor("externa")%></td>
								    <% wend
									  lista.primero%>
								</tr>
							</tbody>
					...
					<tr><td align="left"><font face="Georgia, Times New Roman, Times, serif" size="2" color="#0066FF">POSTULANTES DISTRIBUIDOS POR SEDE</font></td></tr>
					<tr>
						<td width="50%" align="center">
							<table width="98%" cellpadding="2" cellspacing="2" border="1">
							   <tr>
							   ...
							   <% total_general_2 = 0
							      ...
							      total_tt =  cdbl(lista2.obtenerValor("interna")) + cdbl(lista2.obtenerValor("externa"))
								  total_general_2 = total_general_2 + total_tt 
							   %>
							   <tr>
							   		<td width="50%"><%=lista2.obtenerValor("sede")%></td>
									<td width="20%" align="center"><%=lista2.obtenerValor("interna")%></td>
									<td width="20%" align="center"><%=lista2.obtenerValor("externa")%></td>
									<td width="10%" align="center"><%=total_tt%></td>
							   </tr>
							   <% wend
							      lista2.primero%>
							   <tr>
							   		<td colspan="3" align="right"><strong>Total...:</strong></td>
									<td align="center"><%=total_general_2%></td>
							   </tr>
							</table>
						</td>
						<td width="50%" bgcolor="#FFFFFF">
							<table id='myTable1_3' align="center">
								...
								<tr>
									<th></th>
									<% while lista2.siguiente %>
										<th><%=lista2.obtenerValor("sede")%></th>
								    <% wend
									  lista2.primero%>
								</tr>
							   </thead>
								...
								<tr>
									<th>Post.Internas</th>
									<% while lista2.siguiente %>
										<td><%=lista2.obtenerValor("interna")%></td>
								    <% wend
									  lista2.primero%>
								</tr>
								<tr>
									<th>Post.Externas</th>
									<% while lista2.siguiente %>
										<td><%=lista2.obtenerValor("externa")%></td>
								    <% wend
									  lista2.primero%>
								</tr>
							</tbody>
					...
					<tr><td align="left"><font face="Georgia, Times New Roman, Times, serif" size="2" color="#0066FF">POSTULANTES DISTRIBUIDOS POR CARRERA</font></td></tr>
					<tr valign="top">
						<td width="50%" align="center">
							<table width="98%" cellpadding="2" cellspacing="2" border="1">
							   <tr>
							   ...
							   <% total_general_3 = 0
							      ...
							      total_ttt =  cdbl(lista3.obtenerValor("interna")) + cdbl(lista3.obtenerValor("externa")) 
								  total_general_3 = total_general_3 + total_ttt %>
							   <tr>
							   		<td width="50%"><%=lista3.obtenerValor("carrera")%></td>
									<td width="20%" align="center"><%=lista3.obtenerValor("interna")%></td>
									<td width="20%" align="center"><%=lista3.obtenerValor("externa")%></td>
									<td width="10%" align="center"><%=total_ttt%></td>
							   </tr>
							   <% wend
							      lista3.primero%>
							   <tr>
							   		<td colspan="3" align="right"><strong>Total...:</strong></td>
									<td align="center"><%=total_general_3%></td>
							   </tr>
							</table>
						</td>
						<td width="50%" bgcolor="#FFFFFF">
							<table id='myTable1_4' align="center">
								...
								<tr>
									<th></th>
									<% while lista3.siguiente %>
										<th><%=lista3.obtenerValor("carrera")%></th>
								    <% wend
									  lista3.primero%>
								</tr>
							   </thead>
								...
								<tr>
									<th>Post.Internas</th>
									<% while lista3.siguiente %>
										<td><%=lista3.obtenerValor("interna")%></td>
								    <% wend
									  lista3.primero%>
								</tr>
								<tr>
									<th>Post.Externas</th>
									<% while lista3.siguiente %>
										<td><%=lista3.obtenerValor("externa")%></td>
								    <% wend
									  lista3.primero%>
								</tr>
							</tbody>
					...
					<tr><td align="left"><font face="Georgia, Times New Roman, Times, serif" size="2" color="#0066FF">DISTRIBUCIÓN DE POSTULANTES EN EL TERRITORIO NACIONAL</font></td></tr>
					<tr valign="bottom">
					...
					<tr><td align="left"><font face="Georgia, Times New Roman, Times, serif" size="2" color="#0066FF">DISTRIBUCIÓN DE POSTULANTES EN EL MUNDO</font></td></tr>
					<tr>
