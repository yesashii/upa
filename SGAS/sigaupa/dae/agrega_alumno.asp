...
botonera.carga_parametros "agrega_alumno.xml", "botonera"
'---------------------------------------------------------------------------------------------------
set f_botonera = new CFormulario
f_botonera.Carga_Parametros "agrega_alumno.xml", "botonera"

'---------------------------------------------------------------------------------------------------
set f_busqueda = new CFormulario
f_busqueda.Carga_Parametros "agrega_alumno.xml", "busqueda"
...
f_cheques.Carga_Parametros "agrega_alumno.xml", "cheques"
                    ...
                    <td>
                      ...
                      <table width="98%"  border="0" align="center">
						  ...
						  <tr>						
						   ...
						   <td width="20%"><span class="Estilo2"></span><strong>Credito</strong><br> <%f_cheques.DibujaCampo("tdet_ccod")%></td>
                        </tr>
					  ...
					  <table height="103">
					  <tr>
					   <td width="20%" align="up"><span class="Estilo2"></span><strong> Monto Asignado </strong><br> 
					     <%f_cheques.DibujaCampo("monto")%></td>
					   </tr>
					    <td width="50%" align="up"><span class="Estilo2"></span><strong> Observación </strong><br> <%f_cheques.DibujaCampo("observacion")%></td>
					  </table>
					  </td>
                      <br>
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><div align="center">
					...
					<%f_botonera.AgregaBotonParam "guardar", "url", "agrega_alumno_proc.asp?pers_nrut="&q_pers_nrut&"&pers_xdv="&q_pers_xdv&"&anos_ccod="&q_anos_ccod&"&tdet_ccod="&q_tdet_ccod
