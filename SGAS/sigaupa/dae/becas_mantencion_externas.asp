...
botonera.carga_parametros "becas_mantencion_externas.xml", "botonera"
'---------------------------------------------------------------------------------------------------
set f_botonera = new CFormulario
f_botonera.Carga_Parametros "becas_mantencion_externas.xml", "botonera"

'---------------------------------------------------------------------------------------------------
set f_busqueda = new CFormulario
f_busqueda.Carga_Parametros "becas_mantencion_externas.xml", "busqueda"
...
f_cheques.Carga_Parametros "becas_mantencion_externas.xml", "cheques"
            ...
            <td><div align="center"><br>
              ...
              <form name="edicion">
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><%pagina.DibujarSubtitulo "Datos Becas Mantención Externas"%>
            ...
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
				...
				<td><div align="center">
					...
					<%f_botonera.AgregaBotonParam "crear", "url", "agrega_becas_mantencion_externas.asp"
				   f_botonera.DibujaBoton"crear"  %></div></td>
                  <td><div align="center">
                    
					<%f_botonera.AgregaBotonParam "excel", "url", "becas_mantencion_externas_excel.asp?pers_nrut="&q_pers_nrut&"&pers_xdv="&q_pers_xdv&"&tdet_ccod="&q_tdet_ccod&"&sede_ccod="&q_sede_ccod&"&anos_ccod="&q_anos_ccod
