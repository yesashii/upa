...
'response.Write("<br>fecha_consulta_r='"&fecha_consulta_r&"'<br>")
	p_insert="delete from  bloqueo_hora_dia  where blsi_ncorr="&blsi_ncorr&" and  fecha_hora='"&fecha_hora&"'"		  
...
session("mensajeerror")= "La fecha fue desbloqeada"

else
  session("mensajeerror")= "Error al desbloquear"
