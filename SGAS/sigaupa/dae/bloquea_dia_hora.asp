...
if q_sede_ccod<>"" then  
	...
	sql_hora="select hora_ini+' - '+hora_fin as hora ,"& vbcrlf & _
					"case when  protic.verificar_hora_sicologo(a.blsi_ncorr,0,'"&fecha_trabajo(1)&"',1)='N' and protic.ES_BLOQUE_ACTIVO_SICOLOGO(a.blsi_ncorr,1)='S' and (select case count(*) when 0 then 'N' else 'S' end from bloqueo_hora_dia fff where fff.blsi_ncorr=a.blsi_ncorr and fecha_hora='"&fecha_trabajo(1)&" ')='N' and (select  case when convert(datetime,getdate(),103)< convert(datetime,'"&fecha_trabajo(1)&" '+rtrim(ltrim(hora_fin)),103) then  'S' else 'N' end)='S' then '<input type="&CHR(034)&"button"&CHR(034)&" value="&CHR(034)&"Bloquear Hora"&CHR(034)&" onclick="&CHR(034)&"selec(''"&fecha_trabajo(1)&"'','+cast(blsi_ncorr as varchar)+',''Bloquear'');"&CHR(034)&"/>'" & vbcrlf & _
					 "when  protic.verificar_hora_sicologo(a.blsi_ncorr,0,'"&fecha_trabajo(1)&"',1)='N' and protic.ES_BLOQUE_ACTIVO_SICOLOGO(a.blsi_ncorr,1)='S' and (select case count(*) when 0 then 'N' else 'S' end from bloqueo_hora_dia fff where fff.blsi_ncorr=a.blsi_ncorr and fecha_hora='"&fecha_trabajo(1)&" ')='S' and (select  case when convert(datetime,getdate(),103)< convert(datetime,'"&fecha_trabajo(1)&" '+rtrim(ltrim(hora_fin)),103) then  'S' else 'N' end)='S' then '<input type="&CHR(034)&"button"&CHR(034)&" value="&CHR(034)&"Desbloquear Hora"&CHR(034)&" onclick="&CHR(034)&"selec(''"&fecha_trabajo(1)&"'','+cast(blsi_ncorr as varchar)+',''Desbloquear'');"&CHR(034)&"/>'" & vbcrlf & _
					 "else '_' end as eslunes,"& vbcrlf & _
					
					"case when protic.verificar_hora_sicologo(a.blsi_ncorr,0,'"&fecha_trabajo(2)&"',2)='N'  and protic.ES_BLOQUE_ACTIVO_SICOLOGO(a.blsi_ncorr,2)='S' and (select case count(*) when 0 then 'N' else 'S' end from bloqueo_hora_dia fff where fff.blsi_ncorr=a.blsi_ncorr and fecha_hora='"&fecha_trabajo(2)&" ')='N' and  (select  case when convert(datetime,getdate(),103)< convert(datetime,'"&fecha_trabajo(2)&" '+rtrim(ltrim(hora_fin)),103) then  'S' else 'N' end)='S' then '<input type="&CHR(034)&"button"&CHR(034)&" value="&CHR(034)&"Bloquear Hora"&CHR(034)&" onclick="&CHR(034)&"selec(''"&fecha_trabajo(2)&"'','+cast(blsi_ncorr as varchar)+',''Bloquear'');"&CHR(034)&"/>'"& vbcrlf & _
					 "when protic.verificar_hora_sicologo(a.blsi_ncorr,0,'"&fecha_trabajo(2)&"',2)='N'  and protic.ES_BLOQUE_ACTIVO_SICOLOGO(a.blsi_ncorr,2)='S' and (select case count(*) when 0 then 'N' else 'S' end from bloqueo_hora_dia fff where fff.blsi_ncorr=a.blsi_ncorr and fecha_hora='"&fecha_trabajo(2)&" ')='S' and  (select  case when convert(datetime,getdate(),103)< convert(datetime,'"&fecha_trabajo(2)&" '+rtrim(ltrim(hora_fin)),103) then  'S' else 'N' end)='S' then '<input type="&CHR(034)&"button"&CHR(034)&" value="&CHR(034)&"Desbloquear Hora"&CHR(034)&" onclick="&CHR(034)&"selec(''"&fecha_trabajo(2)&"'','+cast(blsi_ncorr as varchar)+',''Desbloquear'');"&CHR(034)&"/>'"& vbcrlf & _
					 "else  '_' end as esmartes,"& vbcrlf & _
					
					"case when  protic.verificar_hora_sicologo(a.blsi_ncorr,0,'"&fecha_trabajo(3)&"',3)='N' and  protic.ES_BLOQUE_ACTIVO_SICOLOGO(a.blsi_ncorr,3)='S' and (select case count(*) when 0 then 'N' else 'S' end from bloqueo_hora_dia fff where fff.blsi_ncorr=a.blsi_ncorr and fecha_hora='"&fecha_trabajo(3)&" ')='N' and  (select  case when convert(datetime,getdate(),103)< convert(datetime,'"&fecha_trabajo(3)&" '+rtrim(ltrim(hora_fin)),103) then  'S' else 'N' end)='S' then '<input type="&CHR(034)&"button"&CHR(034)&" value="&CHR(034)&"Bloquear Hora"&CHR(034)&" onclick="&CHR(034)&"selec(''"&fecha_trabajo(3)&"'','+cast(blsi_ncorr as varchar)+',''Bloquear'');"&CHR(034)&"/>'"& vbcrlf & _ 
					"when  protic.verificar_hora_sicologo(a.blsi_ncorr,0,'"&fecha_trabajo(3)&"',3)='N' and  protic.ES_BLOQUE_ACTIVO_SICOLOGO(a.blsi_ncorr,3)='S' and (select case count(*) when 0 then 'N' else 'S' end from bloqueo_hora_dia fff where fff.blsi_ncorr=a.blsi_ncorr and fecha_hora='"&fecha_trabajo(3)&" ')='S' and  (select  case when convert(datetime,getdate(),103)< convert(datetime,'"&fecha_trabajo(3)&" '+rtrim(ltrim(hora_fin)),103) then  'S' else 'N' end)='S' then '<input type="&CHR(034)&"button"&CHR(034)&" value="&CHR(034)&"Desbloquear Hora"&CHR(034)&" onclick="&CHR(034)&"selec(''"&fecha_trabajo(3)&"'','+cast(blsi_ncorr as varchar)+',''Desbloquear'');"&CHR(034)&"/>'"& vbcrlf & _ 
					"else  '_' end as esmiercoles,"& vbcrlf & _
					
					"case when  protic.verificar_hora_sicologo(a.blsi_ncorr,0,'"&fecha_trabajo(4)&"',4)='N' and protic.ES_BLOQUE_ACTIVO_SICOLOGO(a.blsi_ncorr,4)='S' and (select case count(*) when 0 then 'N' else 'S' end from bloqueo_hora_dia fff where fff.blsi_ncorr=a.blsi_ncorr and fecha_hora='"&fecha_trabajo(4)&" ')='N' and  (select  case when convert(datetime,getdate(),103)< convert(datetime,'"&fecha_trabajo(4)&" '+rtrim(ltrim(hora_fin)),103) then  'S' else 'N' end)='S' then '<input type="&CHR(034)&"button"&CHR(034)&" value="&CHR(034)&"Bloquear Hora"&CHR(034)&" onclick="&CHR(034)&"selec(''"&fecha_trabajo(4)&"'','+cast(blsi_ncorr as varchar)+',''Bloquear'');"&CHR(034)&"/>'"& vbcrlf & _
					"when  protic.verificar_hora_sicologo(a.blsi_ncorr,0,'"&fecha_trabajo(4)&"',4)='N' and protic.ES_BLOQUE_ACTIVO_SICOLOGO(a.blsi_ncorr,4)='S' and (select case count(*) when 0 then 'N' else 'S' end from bloqueo_hora_dia fff where fff.blsi_ncorr=a.blsi_ncorr and fecha_hora='"&fecha_trabajo(4)&" ')='S' and  (select  case when convert(datetime,getdate(),103)< convert(datetime,'"&fecha_trabajo(4)&" '+rtrim(ltrim(hora_fin)),103) then  'S' else 'N' end)='S' then '<input type="&CHR(034)&"button"&CHR(034)&" value="&CHR(034)&"Desbloquear Hora"&CHR(034)&" onclick="&CHR(034)&"selec(''"&fecha_trabajo(4)&"'','+cast(blsi_ncorr as varchar)+',''Desbloquear'');"&CHR(034)&"/>'"& vbcrlf & _
					" else  '_' end as esjueves,"& vbcrlf & _
					 
					"case when protic.verificar_hora_sicologo(a.blsi_ncorr,0,'"&fecha_trabajo(5)&"',5)='N' and protic.ES_BLOQUE_ACTIVO_SICOLOGO(a.blsi_ncorr,5)='S' and (select case count(*) when 0 then 'N' else 'S' end from bloqueo_hora_dia fff where fff.blsi_ncorr=a.blsi_ncorr and fecha_hora='"&fecha_trabajo(5)&" ')='N' and  (select  case when convert(datetime,getdate(),103)< convert(datetime,'"&fecha_trabajo(5)&" '+rtrim(ltrim(hora_fin)),103) then  'S' else 'N' end)='S' then '<input type="&CHR(034)&"button"&CHR(034)&" value="&CHR(034)&"Bloquear Hora"&CHR(034)&" onclick="&CHR(034)&"selec(''"&fecha_trabajo(5)&"'','+cast(blsi_ncorr as varchar)+',''Bloquear'');"&CHR(034)&"/>'"& vbcrlf & _
				    "when protic.verificar_hora_sicologo(a.blsi_ncorr,0,'"&fecha_trabajo(5)&"',5)='N' and protic.ES_BLOQUE_ACTIVO_SICOLOGO(a.blsi_ncorr,5)='S' and (select case count(*) when 0 then 'N' else 'S' end from bloqueo_hora_dia fff where fff.blsi_ncorr=a.blsi_ncorr and fecha_hora='"&fecha_trabajo(5)&" ')='S' and  (select  case when convert(datetime,getdate(),103)< convert(datetime,'"&fecha_trabajo(5)&" '+rtrim(ltrim(hora_fin)),103) then  'S' else 'N' end)='S' then '<input type="&CHR(034)&"button"&CHR(034)&" value="&CHR(034)&"Desbloquear Hora"&CHR(034)&" onclick="&CHR(034)&"selec(''"&fecha_trabajo(5)&"'','+cast(blsi_ncorr as varchar)+',''Desbloquear'');"&CHR(034)&"/>'"& vbcrlf & _
...
function selec(fecha_hora,blsi_ncorr,accion)
{

if(confirm("¿Quiere "+accion+" esta hora?")) {
...
sede=<%=q_sede_ccod%>
fecha_b='<%=REPLACE(fecha_consulta_r,"/","%2F") %>'
peri=<%=peri_ccod%>

	if (accion=='Bloquear')
		{
		pagina='bloquea_dia_hora_proc.asp?blsi_ncorr='+blsi_ncorr+'&fecha_hora='+fecha_hora+'&sede='+sede+'&fecha_b='+fecha_b+'&peri='+peri+''
		location.href=pagina
		}
	if (accion=='Desbloquear')
		{
		pagina='desbloquea_dia_hora_proc.asp?blsi_ncorr='+blsi_ncorr+'&fecha_hora='+fecha_hora+'&sede='+sede+'&fecha_b='+fecha_b+'&peri='+peri+''
		location.href=pagina
		}
} 
