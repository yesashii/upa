...
q_monto= request.QueryString("a[0][monto]")
q_observacion= request.QueryString("a[0][observacion]")
...
botonera.carga_parametros "agrega_becas_mantencion_externas.xml", "botonera"
'---------------------------------------------------------------------------------------------------
set f_botonera = new CFormulario
f_botonera.Carga_Parametros "agrega_becas_mantencion_externas.xml", "botonera"

'---------------------------------------------------------------------------------------------------

'---------------------------------------------------------------------------------------------------
set f_cheques = new CFormulario
f_cheques.Carga_Parametros "agrega_becas_mantencion_externas.xml", "cheques"
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><div align="center">
					...
					<%f_botonera.AgregaBotonParam "guardar", "url", "agrega_becas_mantencion_externas_proc.asp"
