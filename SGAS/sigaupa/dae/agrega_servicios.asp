...
botonera.carga_parametros "agrega_becas_servicios.xml", "botonera"
'---------------------------------------------------------------------------------------------------
set f_botonera = new CFormulario
f_botonera.Carga_Parametros "agrega_becas_servicios.xml", "botonera"

'---------------------------------------------------------------------------------------------------

'---------------------------------------------------------------------------------------------------
set f_cheques = new CFormulario
f_cheques.Carga_Parametros "agrega_becas_servicios.xml", "cheques"
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><div align="center">
					...
					<%f_botonera.AgregaBotonParam "guardar", "url", "agrega_servicios_proc.asp?pers_nrut="&q_pers_nrut&"&pers_xdv="&q_pers_xdv&"&anos_ccod="&q_anos_ccod&"&tdet_ccod="&q_tdet_ccod
