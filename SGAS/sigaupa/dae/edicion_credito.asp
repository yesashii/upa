...
botonera.carga_parametros "edicion_credito.xml", "botonera"
'---------------------------------------------------------------------------------------------------
set f_botonera = new CFormulario
f_botonera.Carga_Parametros "edicion_credito.xml", "botonera"

'---------------------------------------------------------------------------------------------------
set f_busqueda = new CFormulario
f_busqueda.Carga_Parametros "edicion_credito.xml", "busqueda"
...
f_cheques.Carga_Parametros "edicion_credito.xml", "cheques"
...
if q_acre_ncorr = 0 then
sql_descuentos= "select post_ncorr, pers_tape_paterno+' '+pers_tape_materno+' '+pers_tnombre as nombre,cast(pers_nrut as varchar)+'-'+pers_xdv as rut,carr_tdesc as carrera,(select sede_tdesc from sedes where sede_ccod=d.sede_ccod)sede,'' as monto_bene,'' as observacion "& vbCrLf &_
"from alumnos b,personas c,ofertas_academicas d,especialidades e,carreras f"& vbCrLf &_
...
" and post_ncorr= "&q_post_ncorr&""& vbCrLf &_
"order by carrera,nombre"

else 
sql_descuentos= "select acre_ncorr,a.post_ncorr, pers_tape_paterno+' '+pers_tape_materno+' '+pers_tnombre as nombre,cast(pers_nrut as varchar)+'-'+pers_xdv as rut,carr_tdesc as carrera,(select sede_tdesc from sedes where sede_ccod=d.sede_ccod)sede,monto_bene,observacion"& vbCrLf &_
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><div align="center"><br>
              ...
              <form name="edicion">
			  <input type="hidden" name="a[0][post_ncorr]" value="<%=q_post_ncorr%>">
			  <input type="hidden" name="a[0][tdet_ccod]" value="<%=q_tdet_ccod%>">
