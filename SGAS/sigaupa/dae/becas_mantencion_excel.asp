...
Response.AddHeader "Content-Disposition", "attachment;filename=listado_Becas_mantención_internas.xls"
...
sql_descuentos= "select a.post_ncorr, pers_tape_paterno+' '+pers_tape_materno+' '+pers_tnombre as nombre,cast(pers_nrut as varchar)+'-'+pers_xdv as rut,carr_tdesc as carrera,(select sede_tdesc from sedes where sede_ccod=d.sede_ccod)sede,monto_bene,observacion"& vbCrLf &_
...
<tr align="center"> 
  ...
  <td width="29%"><div align="center"><strong>Monto Bnenficio</strong></div></td>
  <td width="29%"><div align="center"><strong>Observación</strong></div></td>
