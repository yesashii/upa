...
f_cheques.Carga_Parametros "agrega_taller.xml", "cheques"
                    ...
                    <td width="50%">
                      ...
                      <table width="98%"  border="0" align="center">
						 ...
						 <tr>						
						   ...
						   <td width="20%"><span class="Estilo2"></span><strong>Taller</strong><br> <%f_cheques.DibujaCampo("tasi_ncorr")%></td>
                        </tr>
					  ...
					  <table width="51%" >
					  <tr>
					   <td width="20%" align="up"></td>
					   </tr>
					   <tr>
					      <td width="50%" align="up"><span class="Estilo2"></span><strong> Sede </strong><br> <%f_cheques.DibujaCampo("sede_ccod")%></td>
						  </tr>
						   <tr>
					   <td width="20%" align="up"><span class="Estilo2"></span><strong> Fecha de Realización </strong><br><%f_cheques.DibujaCampo("fecha")%><strong> dd/mm/aaaa</strong></td>
					   </tr>
					  </table>
					  </td>
                      <br>
