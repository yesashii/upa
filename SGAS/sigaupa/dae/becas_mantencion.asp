...
pagina.Titulo = "Becas Mantencion"
...
botonera.carga_parametros "becas_mantencion.xml", "botonera"
'---------------------------------------------------------------------------------------------------
set f_botonera = new CFormulario
f_botonera.Carga_Parametros "becas_mantencion.xml", "botonera"

'---------------------------------------------------------------------------------------------------
set f_busqueda = new CFormulario
f_busqueda.Carga_Parametros "becas_mantencion.xml", "busqueda"
...
f_cheques.Carga_Parametros "becas_mantencion.xml", "cheques"
              ...
              <table width="74%"  border="0" align="center">
                <tr>
					...
					<tr>
				  	...
				  	<td width="15%"><p><strong>Becas:</strong></td>
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center">
					...
					<%f_botonera.AgregaBotonParam "crear", "url", "agrega_becas_mantencion_internas.asp"
				   f_botonera.DibujaBoton"crear"  %></div></td>
				   
				  <td><div align="center">
                    
					<%f_botonera.AgregaBotonParam "excel", "url", "becas_mantencion_excel.asp?pers_nrut="&q_pers_nrut&"&pers_xdv="&q_pers_xdv&"&tdet_ccod="&q_tdet_ccod&"&sede_ccod="&q_sede_ccod&"&anos_ccod="&q_anos_ccod
