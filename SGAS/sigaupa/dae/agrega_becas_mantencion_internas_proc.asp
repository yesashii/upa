...
f_agrega.Carga_Parametros "agrega_becas_mantencion_internas.xml", "cheques"
...
response.Write("<pre>monto= "&monto&"</pre>")
response.Write("<pre>observacion= "&observacion&"</pre>")
end if
...
if tiene_beca="S" then
 session("mensajeerror")= "El alumno ya registra esta Beca para el periodo academico seleccionado "
end if
end if
'response.Redirect(request.ServerVariables("HTTP_REFERER"))
response.Redirect("agrega_becas_mantencion_internas.asp")
