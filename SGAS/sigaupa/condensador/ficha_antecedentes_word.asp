...
<%
Response.AddHeader "Content-Disposition", "attachment;filename=antecedentes_alumno.doc"
...
<html>
<head>
<title>Antecedentes Alumno</title>
...
<table width="714" height="" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
	...
	<table width="100%">
	<tr>
	<td width="21%" align="center"><img  width="150" height="50 "src="http://fangorn.upacifico.cl/sigaupa/imagenes/logo_upa_rojo_2011.png"><br clear=all> UNIVERSIDAD DEL PACIFICO</td>
	      <td width="64%"><p align="center"><font face="Times New Roman, Times, serif" size="4" color="#085fbc"><strong>Ficha de Antecedentes Personales</strong></font></p>
	  </td>
	<td width="15%"></td>
	</tr>
	</table>
      ...
      <table width="680"   border="1" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td valign="top"> <form name="edicion">
              <p align="left"> 
                <font face="Times New Roman, Times, serif" size="3" color="#085fbc"><strong>Identificaci&oacute;n del Alumno</strong></font>
              </p>
              <table width="676" height="596" border="0" cellpadding="1" cellspacing="3" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
                ...
                <tr> 
                  <td height="20" colspan="4"><font size="2"><strong> 
                    <font face="Times New Roman, Times, serif" size="3" color="#085fbc"><strong>Antecedentes Educacionales</strong></font>
                    </strong></font></td>
                </tr>
                <tr> 
                  <td height="21">&nbsp;</td>
                ...
                <tr> 
                  <td height="20" colspan="4"><font size="2"><strong> 
                    <font face="Times New Roman, Times, serif" size="3" color="#085fbc"><strong>Identificaci&oacute;n del sostenedor acad&eacute;mico</strong></font>
                    </strong></font></td>
                </tr>
                <tr> 
              ...
              <table width="100%" border="0" cellpadding="1" cellspacing="3" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
                <tr> 
                  <td height="10" colspan="4"><font size="2"><strong> 
                    <font face="Times New Roman, Times, serif" size="3" color="#085fbc"><strong>Antecedentes del Padre</strong></font>
                    </strong></font></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td height="10" colspan="4">
                    <font face="Times New Roman, Times, serif" size="3" color="#085fbc"><strong>Antecedentes de la madre</strong></font></td>
                </tr>
                <tr> 
