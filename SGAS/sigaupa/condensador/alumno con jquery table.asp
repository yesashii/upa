...
if plec_ccod <> "1" then
	filtro_matriculas = " and cast(d.matr_ncorr as varchar) in ('"&matr_ncorr&"', '"&carr_ccod2&"') "
...
f_cta_cte.Inicializar conexion
 ...
 consulta_cta_corriente = "select (select peri_tdesc from periodos_academicos tt where tt.peri_ccod=b.peri_ccod) as periodo, " & vbCrLf &_
						  ...
						  "		and a.ecom_ccod = '1' --and b.peri_ccod='222' " & vbCrLf &_
...
c_matriculas = " select anos_ccod,periodo,sede,carrera,jornada,emat_ccod,estado,cargas,aprobados, "& vbCrLf &_
			   ...
			   " and b.peri_ccod=g.peri_ccod and a.emat_ccod=h.emat_ccod "& vbCrLf &_
			   " and cast(a.pers_ncorr as varchar)='"&pers_ncorr&"' "& vbCrLf &_
			   " )table1  "& vbCrLf &_
...
<head>
  <title>Datos Alumno</title>
	...
	#autoTabs, #center1, #center2, #center3, #center4, #center5, #center6, #center7, #west, #west2, #west3, #west4 
	{
	    padding:10px;
	}
	#north, #south{
...
<div id="west" class="x-layout-inactive-content">
										...
										if pasada = 0 or asignatura <> asignatura2 then
										   ...
										   <tr borderColor="#999999" bgColor="#c4d7ff">
											...
											<tr borderColor="#999999" bgColor="#ffffff">
												...
												<TD align="center"><%=nota_parcial%></TD>
											</tr>	   
							    <%wend%>
								        <tr>
										  <td colspan="5" align="right" bgcolor="#FFFFFF"><font face="Times New Roman, Times, serif" size="2" color="#085fbc"><strong><%=mensaje_final%></strong></font></td>
							...
							<td colspan="3">
								<table class="v1" width="98%" border="1" bordercolor="#999999" bgcolor="#adadad" cellspacing="0" cellpadding="0">
									<tr borderColor="#999999" bgColor="#c4d7ff">
										...
										<TH><FONT color=#333333>Instituci&oacute;n</FONT></TH>
										<TH align="center"><FONT color=#333333>Año</FONT></TH>
									</tr>
									<%if f_muestra_seminario.nroFilas > 0 then
									   ...
									   %>
									     <tr borderColor="#999999" bgColor="#ffffff">
											<TD bgcolor="#FFFFFF"><%=tipo3%></TD>
											<TD bgcolor="#FFFFFF"><%=nombre3%></TD>
											<TD bgcolor="#FFFFFF"><%=institucion3%></TD>
											<TD align="center" bgcolor="#FFFFFF"><%=anio3%></TD>
										</tr>
									   <%wend
									  else%>
					  ...
					  <table width="100%" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							<td colspan="3">
								<table class="v1" width="98%" border="1" bordercolor="#999999" bgcolor="#adadad" cellspacing="0" cellpadding="0">
									<tr borderColor="#999999" bgColor="#c4d7ff">
										<TH><FONT color=#333333>Empresa</FONT></TH>
										<TH><FONT color=#333333>Rubro</FONT></TH>
										<TH><FONT color=#333333>Cargo</FONT></TH>
										<TH><FONT color=#333333>Web</FONT></TH>
									</tr>
									<%if f_muestra_trabajo.nroFilas > 0 then
									   ...
									   %>
									     <tr borderColor="#999999" bgColor="#ffffff">
											<TD bgcolor="#FFFFFF"><%=nombre_empresa3%></TD>
											<TD bgcolor="#FFFFFF"><%=rubro_empresa3%></TD>
											<TD bgcolor="#FFFFFF"><%=cargo_empresa3%></TD>
											<TD bgcolor="#FFFFFF"><%=web_empresa3%></TD>
										</tr>
									   <%wend
									  else%>
							...
							<td colspan="3">
								<table class="v1" width="98%" border="1" bordercolor="#999999" bgcolor="#adadad" cellspacing="0" cellpadding="0">
									...
									<%if f_muestra_practica.nroFilas > 0 then
									   ...
									   %>
									     <tr borderColor="#999999" bgColor="#ffffff">
											<TD bgcolor="#FFFFFF"><%=nombre_empresa4%></TD>
											<TD bgcolor="#FFFFFF"><%=rubro_empresa4%></TD>
											<TD bgcolor="#FFFFFF"><%=cargo_empresa4%></TD>
											<TD bgcolor="#FFFFFF"><%=web_empresa4%></TD>
										</tr>
									   <%wend
									  else%>
							...
							<td colspan="3">
								<table class="v1" width="98%" border="1" bordercolor="#999999" bgcolor="#adadad" cellspacing="0" cellpadding="0">
									...
									<%if f_muestra_pasantia.nroFilas > 0 then
									   ...
									   %>
									     <tr borderColor="#999999" bgColor="#ffffff">
											<TD bgcolor="#FFFFFF"><%=nombre_empresa5%></TD>
											<TD bgcolor="#FFFFFF"><%=rubro_empresa5%></TD>
											<TD bgcolor="#FFFFFF"><%=cargo_empresa5%></TD>
											<TD bgcolor="#FFFFFF"><%=web_empresa5%></TD>
										</tr>
									   <%wend
									  else%>
					  ...
					  <table width="100%" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							<td colspan="3">
								<table class="v1" width="98%" border="1" bordercolor="#999999" bgcolor="#adadad" cellspacing="0" cellpadding="0">
									<tr borderColor="#999999" bgColor="#c4d7ff">
										<TH><FONT color=#333333>Idioma</FONT></TH>
										<TH><FONT color=#333333>Nivel</FONT></TH>
										<TH><FONT color=#333333>Habla</FONT></TH>
										<TH><FONT color=#333333>Lee</FONT></TH>
										<TH><FONT color=#333333>Escribe</FONT></TH>
									</tr>
									<%if f_muestra_idioma.nroFilas > 0 then
									   while f_muestra_idioma.siguiente
										 ...
										 habla1 = f_muestra_idioma.obtenerValor("habla")
										 lee1 = f_muestra_idioma.obtenerValor("lee")
										 escribe1 = f_muestra_idioma.obtenerValor("escribe")
									   %>
									     <tr borderColor="#999999" bgColor="#ffffff">
											<TD bgcolor="#FFFFFF"><%=idioma1%></TD>
											<TD bgcolor="#FFFFFF"><%=nivel1%></TD>
											<TD bgcolor="#FFFFFF" align="center"><%=habla1%></TD>
											<TD bgcolor="#FFFFFF" align="center"><%=lee1%></TD>
											<TD bgcolor="#FFFFFF" align="center"><%=escribe1%></TD>
										</tr>
									   <%wend
									  else%>
					  ...
					  <table width="100%" cellpadding="0" cellspacing="0">
						  ...
						  <tr>
							<td colspan="3">
								<table class="v1" width="98%" border="1" bordercolor="#999999" bgcolor="#adadad" cellspacing="0" cellpadding="0">
									<tr borderColor="#999999" bgColor="#c4d7ff">
										<TH><FONT color=#333333>Nombre del Software</FONT></TH>
										<TH><FONT color=#333333>Nivel de conocimiento</FONT></TH>
									</tr>
									<%if f_muestra_habilidades_programa.nroFilas > 0 then
									   ...
									   %>
									     <tr borderColor="#999999" bgColor="#ffffff">
											<TD bgcolor="#FFFFFF"><%=software1%></TD>
											<TD bgcolor="#FFFFFF"><%=nivel1%></TD>
										 </tr>
									   <%wend
									  else%>
				  ...
				  <tr>
					...
					<td align="left" valign="top" class="t05f">
					  <table width="100%" cellpadding="0" cellspacing="0">
						 ...
						 <tr>
							<td width="10%"><font face="Times New Roman, Times, serif" size="2" color="#085fbc"><strong>Carrera</strong></font></td>
							<td width="2%" align="center"><font face="Times New Roman, Times, serif" size="2" color="#085fbc"><s?????|?trong>:</strong></font></td>
							<td width="88%"><font face="Times New Roman, Times, serif" size="2" color="#404040"><%=carrera%></font></td>
						 </tr>
						 <tr>
							<td width="10%"><font face="Times New Roman, Times, serif" size="2" color="#085fbc"><strong>Estado</strong></font></td>
					  ...
					  <table width="100%" cellpadding="0" cellspacing="0">
					      ...
					      <tr>
							<td colspan="3">
							  <table class="v1" width="98%" border="1" bordercolor="#999999" bgcolor="#adadad" cellspacing="0" cellpadding="0">
									<tr borderColor="#999999" bgColor="#c4d7ff">
										<TH><FONT color=#333333>Per&iacute;odo</FONT></TH>
										<TH><FONT color=#333333>Sede</FONT></TH>
										<TH><FONT color=#333333>Tipo</FONT></TH>
										<TH><FONT color=#333333>Estado</FONT></TH>
										<TH><FONT color=#333333>Fecha Bloqueo</FONT></TH>
										<TH><FONT color=#333333>Fecha Desbloqueo</FONT></TH>
										<TH><FONT color=#333333>Observación</FONT></TH>
									</tr>
									<%if f_bloqueos.nroFilas > 0 then
									   ...
									   %>
									     <tr borderColor="#999999" bgColor="#ffffff">
											<TD bgcolor="#FFFFFF"><%=periodo7%></TD>
											<TD bgcolor="#FFFFFF"><%=sede7%></TD>
											<TD bgcolor="#FFFFFF"><%=tipo7%></TD>
											<TD bgcolor="#FFFFFF"><%=estado7%></TD>
											<TD bgcolor="#FFFFFF"><%=fecha_bloqueo7%></TD>
											<TD bgcolor="#FFFFFF"><%=fecha_desbloqueo7%></TD>
											<TD bgcolor="#FFFFFF"><%=observacion7%></TD>
										</tr>
									   <%wend
									  else%>
			    ...
			    <form name="buscador">
					<table width="100%" cellpadding="0" cellspacing="0">
					  ...
					  <tr>
						...
						<td align="left"><input type="submit" value="Buscar" class="boton" title="Buscar Alumno por período"></td>
                      </tr>
					</table>
				</form>
			</td>
				...
				<td align="left" valign="top" class="t05v">
				  <table width="100%" align="left" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td width="3%" align="center"><font face="Times New Roman, Times, serif" size="2" color="#085fbc"><strong>:</strong></font></td>
						<td width="80%"><font face="Times New Roman, Times, serif" size="2" color="#404040"><%=email_u%></font></td>
					</tr>
					<tr>
			  ...
			  <table width="98%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					...
					<td align="left" valign="top" class="t05i">
					  <table width="100%" cellpadding="0" cellspacing="0">
						  <tr>
							<td colspan="3" align="left"><font face="Times New Roman, Times, serif" size="3" color="#777777"><strong>EVALUACION DOCENTE</strong></font></td>
						  </tr>
					      <tr>
							<td width="10%"><font face="Times New Roman, Times, serif" size="2" color="#085fbc"><strong>RUT</strong></font></td>
							<td width="2%" align="center"><font face="Times New Roman, Times, serif" size="2" color="#085fbc"><strong>:</strong></font></td>
			  ...
			  <table width="98%" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					...
					<td align="left" valign="top" class="t05f">
					  <table width="100%" cellpadding="0" cellspacing="0">
						  <tr>
							<td colspan="3" align="left"><font face="Times New Roman, Times, serif" size="3" color="#777777"><strong>FICHA ACADEMICA ALUMNO(A)</strong></font></td>
						  </tr>
					      <tr>
							<td width="10%"><font face="Times New Roman, Times, serif" size="2" color="#085fbc"><strong>RUT</strong></font></td>
							<td width="2%" align="center"><font face="Times New Roman, Times, serif" size="2" color="#085fbc"><strong>:</strong></font></td>
								...
								<div id="example_3">
									...
									<table width="95%" id="example_3_table" cellpadding="0" cellspacing="0" border="1">
										...
										<script type="text/javascript">
										  ...
										  new SortingTable( 'example_3_table', {
  ...
  <div id="south" class="x-layout-inactive-content">
    <table width="98%" align="left" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td width="10%" height="38" align="center"><img width="38" height="38" src="images/31.png" border="0"></td>
			<td width="10%" height="38" align="center"><img width="38" height="38" src="images/38.png" border="0"></td>
			<td width="10%" height="38" align="center"><img width="38" height="38" src="images/14.png" border="0"></td>
			<td width="10%" height="38" align="center"><img width="38" height="38" src="images/128.png" border="0"></td>
			<td width="60%" height="38" align="center">&nbsp;</td>
		</tr>
		<tr valign="top">
			<td width="10%" align="center"><a href="#" onclick="Example.toggleWest(this);return false;"><font face="Times New Roman, Times, serif" size="1" color="#666666"><strong>Hist&oacute;rico de Notas</strong></font></a></td>
			<td width="10%" align="center"><a href="#" onclick="Example.toggleWest(this);return false;"><font face="Times New Roman, Times, serif" size="1" color="#666666"><strong>Notas Parciales</strong></font></a></td>
			<td width="10%" align="center"><a href="#" onclick="Example.toggleWest(this);return false;"><font face="Times New Roman, Times, serif" size="1" color="#666666"><strong>Curriculum Alumno</strong></font></a></td>
			<td width="10%" align="center"><a href="#" onclick="Example.toggleWest(this);return false;"><font face="Times New Roman, Times, serif" size="1" color="#666666"><strong>Historial Bloqueos</strong></font></a></td>
