...
<p>&nbsp;</p><table width="100%" border="1">
  <tr> 
	...
	<td><div align="center"><strong>Cod Ing</strong></div></td>
    <td><div align="center"><strong>Cod Min</strong></div></td>
  </tr>
  <%  
  fila=1  
  ...
  <tr> 
    ...
    <td><div align="left"><%=tabla.ObtenerValor("cod_carrera_ing")%></div></td>
