...
pagina.Titulo = "Homologador de Ciudades UPA"

set botonera =  new CFormulario
botonera.carga_parametros "adm_homologaciones_ciud.xml", "btn_adm_homologaciones_ciud"
'---------------------------------------------------------------------------------------------------
...
consulta =  "select a.ciudh_ccod,a.ciudh_ccod as eliminar , a.uhciu_ccod,a.ciud_ccod,(b.nombre_comuna+' / '+b.nombre_ciudad) as DireccionA," & vbCrlf & _ 
			...
			"and ( (b.nombre_comuna+' '+b.nombre_ciudad)like '%"& direccion & "%' " & vbCrlf & _
        	"or (c.ciud_tcomuna+' '+c.ciud_tdesc) like '%"& direccion & "%') order by DireccionB "
					
'response.write "<pre>"&consulta&"</pre>"
'response.End()			
set formulario 		= 		new cFormulario
formulario.carga_parametros	"adm_homologaciones_ciud.xml",	"tabla"
...
function agrega_carrera_antiguo(formulario){
	...
	direccion="agregar_homologaciones_ciud.asp?ciudh_ccod ="
...
function agrega_carrera(formulario) {
	direccion = "agregar_homologaciones_ciud.asp";
            ...
            <td><form name="buscador" method="get">
              <table width="100%" border="0">
                <tr>
                  ...
                  <td width="39%">
                        <div align="center">
                          <input type="text" name="direccion" size="30" maxlength="50" onKeyDown="return bloquearTeclas(event.keyCode,this)" onKeyUp="this.value=this.value.toUpperCase()" ID="TO-S" >
                          <br>
  Nombre Ciudades                        </div></td>
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <td width="14%"> <div align="center">  <%
				                           botonera.agregabotonparam "excel_general", "url", "ciudades_homologadas_excel.asp"
