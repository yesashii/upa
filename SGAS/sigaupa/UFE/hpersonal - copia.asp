...
pagina.Titulo = "Homologacion Datos Personales"
...
consulta= "SELECT    rut,dv, nombres, paterno, materno, fono, celular, email, direccion, nombre_comuna, region FROM ufe_reporte_licitados_ingresa"

'response.write "<pre>"&consulta&"</pre>"
'response.end() 			
			
set formulario 		= 		new cFormulario
formulario.carga_parametros	"homologaciones_listado.xml",	"hpersonas"
