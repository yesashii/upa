...
botonera.carga_parametros "adm_carreras.xml", "btn_adm_carreras"
'---------------------------------------------------------------------------------------------------
...
"       area_tdesc, " & vbCrlf & _ 
"       inst_trazon_social, " & vbCrlf & _ 
"       d.ecar_tdesc, " & vbCrlf & _ 
"       e.facu_tdesc, " & vbCrlf & _ 
"       f.tcar_tdesc " & vbCrlf & _ 
"from   carreras as a " & vbCrlf & _ 
"       join areas_academicas as b " & vbCrlf & _ 
"         on a.area_ccod = b.area_ccod " & vbCrlf & _ 
"       join instituciones as c " & vbCrlf & _ 
"         on a.inst_ccod = c.inst_ccod " & vbCrlf & _ 
"       join estados_de_carreras as d " & vbCrlf & _ 
"         on a.ecar_ccod = d.ecar_ccod " & vbCrlf & _ 
"       join facultades as e " & vbCrlf & _ 
"         on a.inst_ccod = e.inst_ccod " & vbCrlf & _ 
"            and b.facu_ccod = e.facu_ccod " & vbCrlf & _ 
"       left outer join tipos_carrera as f " & vbCrlf & _ 
...
formulario.carga_parametros	"adm_carreras.xml",	"tabla"
                ...
                <tr>
                  ...
                  <td><div align="center">
				   ...
				   <td width="14%"> <div align="center">  <%
				                           botonera.agregabotonparam "excel", "url", "adm_carreras_excel.asp?carr_tdesc="&carr_tdesc
										   botonera.dibujaboton "excel"
										%>
					 </div>
                  </td>
				  <td width="14%"> <div align="center">  <%
				                           botonera.agregabotonparam "excel_general", "url", "carrera_espe_plan_excel.asp"
