...
botonera.carga_parametros "adm_carreras_ing.xml", "btn_agregar_carrera"
...
consulta ="  select car_ing_ncorr, cod_carrera_ing, nom_carrera_ing  " & vbCrlf & _
			" from  ufe_carreras_ingresa" & vbCrlf & _
			" where car_ing_ncorr ="&car_ing_ncorr& vbCrlf & _	
...
formulario.carga_parametros	"adm_carreras_ing.xml",	"tabla_valores"
...
'---------------------------------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "adm_carreras_ing.xml", "datos_extras"
...
function agregar(formulario){
	formulario.action = 'proc_agrega_carrera_ing.asp';
  ...
  <form name="editar" method="post">
                <table width="90%" border="0" align="center">
                  <tr>
                    ...
                    <td width="79%">:<%formulario.dibujacampo("cod_carrera_ing")%></td>
                  </tr>
                  <tr>
                    <td><font color="#CC3300">*</font> Descripci&oacute;n</td>
                    <td>:<%formulario.dibujacampo("nom_carrera_ing")%></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
				...
				<input type="hidden" name="em[0][car_ing_ncorr]" value="<%=car_ing_ncorr%>">
