...
pagina.Titulo = "Mantenedor De Aranceles Referenciales"

set botonera =  new CFormulario
botonera.carga_parametros "adm_aranceles_ext.xml", "btn_adm_carreras"
'---------------------------------------------------------------------------------------------------
...
consulta= 	"select a.aran_ccor,a.aran_ccor as eliminar ,c.carr_tdesc, b.jorn_tdesc, a.anos_ccod, a.arancel_ext " & vbCrlf & _	
			...
			" and c.carr_tdesc like '%"&nom_carrera&"%' " 

'response.write "<pre>"&consulta&"</pre>"
'response.End()			
set formulario 		= 		new cFormulario
formulario.carga_parametros	"adm_aranceles_ext.xml",	"tabla"
...
function agrega_carrera_antiguo(formulario){
	...
	direccion="agregar_aranceles_ext.asp?aran_ccor ="
...
function agrega_carrera(formulario) {
	direccion = "agregar_aranceles_ext.asp";
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <td width="14%"> <div align="center">  <%
				                           botonera.agregabotonparam "excel_general", "url", "aranceles_ext_excel.asp"
