...
botonera.carga_parametros "adm_ofer_academica.xml", "btn_adm_carreras"
'---------------------------------------------------------------------------------------------------
...
f_busqueda.carga_parametros	"adm_ofer_academica.xml",	"busqueda"
...
if q_carr_ccod<>"" then
filtro1=filtro1&"and f.carr_ccod="&q_carr_ccod&""
end if
...
formulario.carga_parametros	"adm_ofer_academica.xml",	"tabla"
...
function agrega_carrera_antiguo(formulario){
	...
	direccion="agregar_ofer_academica.asp?ofai_ncorr ="
...
function agrega_carrera(formulario) {
	direccion = "agregar_ofer_academica.asp";
