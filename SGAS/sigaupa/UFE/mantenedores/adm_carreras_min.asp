...
pagina.Titulo = "Mantenedor De Carreras Mineduc"

set botonera =  new CFormulario
botonera.carga_parametros "adm_carreras_min.xml", "btn_adm_carreras"
'---------------------------------------------------------------------------------------------------
...
consulta ="  select car_min_ncorr,car_min_ncorr as eliminar, cod_carrera_min, nom_carrera_min  " & vbCrlf & _
			" from  ufe_carreras_mineduc" & vbCrlf & _
			" where nom_carrera_min like '%"&nom_carrera_min&"%'"& vbCrlf & _	
			" order  by nom_carrera_min"  
'response.write "<pre>"&consulta&"</pre>"
'response.End()			
set formulario 		= 		new cFormulario
formulario.carga_parametros	"adm_carreras_min.xml",	"tabla"
...
function agrega_carrera_antiguo(formulario){
	...
	direccion="agregar_carrera_min.asp?car_min_ncorr ="
...
function agrega_carrera(formulario) {
	direccion = "agregar_carrera_min.asp";
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <td width="14%"> <div align="center">  <%
				                           botonera.agregabotonparam "excel_general", "url", "carreras_mineduc_excel.asp"
