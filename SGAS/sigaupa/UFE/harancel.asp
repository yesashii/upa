...
pagina.Titulo = " Mantenedor de Aranceles"
...
consulta= "select sede,carrera,jornada, cast(aran_mcolegiatura as numeric) as aran_mcolegiatura ,'' as arancel_referencia from matriculas_totales_ufe  " & vbCrlf & _
		  "where periodo_aca=222 and  ano_ingreso = 2011  " & vbCrlf & _
		  "group by sede,carrera,jornada, aran_mcolegiatura" 

'response.write "<pre>"&consulta&"</pre>"
'response.end() 			
			
set formulario 		= 		new cFormulario
formulario.carga_parametros	"homologaciones_listado.xml",	"harancel"
          ...
          <tr>
            <td width="38%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="14%"> <div align="center">   <%botonera.dibujaboton "AGREGAR"%>
					 </div>
                  </td>
				  <td><div align="center">
