	...
	else
	{
		...
		for (var i = 0; i < extArray.length; i++) 
		{
			...
			if (permitir_archivo)
			{
				...
				formulario.elements["a[0][descrip]"].focus();
				formulario.elements["a[0][descrip]"].select();
				}
				else
				{
				formulario.submit();
			...
			{
			alert("Solo archivos Excel o CVS" 
            ...
            <td><FORM enctype="multipart/form-data" ACTION="sube_archivo_proc.asp" METHOD="POST" id="form1" name="subida" >
              ...
              <table width="90%"  border="0" align="center">
                ...
                <tr>
					...
					<td>
					<span class="Estilo2"></span><strong>Descripci&oacute;n</strong><br>
					<%f_subida.DibujaCampo("descrip")%>
					</td>
				</tr>
				<tr> 
