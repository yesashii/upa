	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%lenguetas=Array(Array("Comparador","index.asp"),Array("Subir Archivo","subir_excel.asp"))
              ...
              <table width="90%"  border="0" align="center">
                ...
                <tr>
					...
					<span class="Estilo2"></span><strong>Archivo</strong><br>
					  <%f_subida.DibujaCampo("ufco_tdescripcion")%>
					</td>
				</tr>
					...
					<span class="Estilo2"></span><strong>Por periodo</strong><br>
					  <%f_subida.DibujaCampo("peri_solo")%>
					</td>
					</tr>
					<tr> 
					  <td>
					    <table>
							<tr>
								...
								<span class="Estilo2"></span><strong>Desde</strong><br>
								  <%f_subida.DibujaCampo("desde")%>
								</td>
								<td align="left"> 
								<span class="Estilo2"></span><strong>Hasta</strong><br>
								  <%f_subida.DibujaCampo("hasta")%>
								</td>
							</tr>
						</table>
						</td>
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><div align="center">
					...
					<%botonera.DibujaBoton"comparar"%></div></td>
				  
							 
                  <td><div align="center"><% botonera.AgregaBotonParam "salir", "url", "../lanzadera/lanzadera.asp"
