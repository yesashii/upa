...
class CConexion
    ...
    sub Inicializar(sistema)
		...
		objXMLDoc.load("E:\Sitios\SIGAUPA\ufe\biblioteca\conexion.xml") 
		...
		for each node in root.childNodes
			...
			if atributo = sistema then
                ...
                dsn="sql_2008":usuario="protic":clave="fgt7685uy7"
...
class CFormulario
	...
	sub Carga_Parametros(nombre, idFormulario)
	    Set objXMLDoc = CreateObject("Microsoft.XMLDOM") 
		objXMLDoc.async = False 
		objXMLDoc.load("E:\Sitios\SIGAUPA\ufe\biblioteca\" & nombre ) 
