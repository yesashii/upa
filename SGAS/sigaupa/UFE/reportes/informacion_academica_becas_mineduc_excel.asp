...
consulta =  "	select pers_nrut,pers_xdv,NOMBRE,SEDE,CARRERA,   "& vbCrLf &_
			...
			"	from     "& vbCrLf &_
			"	( "& vbCrLf &_
			"		select distinct b.pers_nrut,b.pers_xdv,(b.pers_tape_paterno + ' ' + b.pers_tape_materno + ' ' + b.pers_tnombre) as NOMBRE,dd.sede_ccod as sede,ca.carr_tdesc as carrera,   "& vbCrLf &_
			...
			"		 from alumno_credito al  "& vbCrLf &_
			...
			"		where al.tdet_ccod in (910,1390,1446,1537,1538,1539,1912)	 "& vbCrLf &_
			"   ) vs   "& vbCrLf &_
...
<table width="100%" border="0">
 <tr> 
    <td colspan="4"><div align="center"><font size="+2" face="Arial, Helvetica, sans-serif">Alumnos UPA con becas Mineduc <%=v_ano_actual%></font></div></td>
 </tr>
 <tr> 
    <td colspan="4">&nbsp;</td>
 </tr>
