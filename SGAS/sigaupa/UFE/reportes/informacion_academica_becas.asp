...
pagina.Titulo = "INFORMACION ACADÉMICA DEL ALUMNO CON BENEFICIO"
'---------------------------------------------------------------------------------------------------
...
function cargar()
{
  buscador.action="informacion_academica_becas.asp?busqueda[0][ufco_ncorr]=" + document.buscador.elements["busqueda[0][ufco_ncorr]"].value;
  buscador.method="POST";
  buscador.submit();
}
function enviar(formulario){
            document.getElementById("texto_alerta").style.visibility="visible";
			formulario.action ="informacion_academica_becas.asp";
			formulario.submit();
}
</script>
          ...
          <tr>
            <td width="38%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                 <%if negocio.obtenerusuario() <> "4" then%>
                  <td><div align="center"> 
                          ...
                          <td><div align="center"> 
                            <% botonera.AgregaBotonParam "excel", "url", "informacion_academica_becas_mineduc_excel.asp?usuario="&negocio.obtenerusuario()&""
							   botonera.AgregaBotonParam "excel","texto","Resumen Mineduc "
							   botonera.DibujaBoton "excel"
							%>
                          </div></td>
                          <td><div align="center"> 
                            <% botonera.AgregaBotonParam "excel", "url", "informacion_academica_becas_internas_excel.asp?usuario="&negocio.obtenerusuario()&""
							   botonera.AgregaBotonParam "excel","texto","Resumen Internas "
							   botonera.DibujaBoton "excel"
							%>
                          </div></td>
                           <td><div align="center"> 
