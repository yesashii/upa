            ...
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td><div align="center">
					<%f_botonera.AgregaBotonParam "excel", "url", "becas_mineduc_excel_admision.asp"
				   f_botonera.DibujaBoton"excel"  %></div></td>
				  
							 
                  <td><div align="center"><%f_botonera.AgregaBotonParam "salir","url","../../lanzadera/lanzadera.asp"
