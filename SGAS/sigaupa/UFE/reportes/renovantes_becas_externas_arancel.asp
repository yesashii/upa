...
f_busqueda.Carga_Parametros "becas_externas_arancel_ufe.xml", "busqueda2"
...
f_cheques.Carga_Parametros "becas_externas_arancel_ufe.xml", "muestra_renovantes_becas"
...
'response.End()
 ...
 'response.Write("<pre>"&request.QueryString&"</pre>")
'response.End()
if  (request.QueryString) = "" then
sql_descuentos= "select ''"

else 
sql_descuentos= "select  pers_tape_paterno+' '+pers_tape_materno+' '+pers_tnombre as nombre,cast(pers_nrut as varchar)+'-'+pers_xdv as rut,carr_tdesc as carrera,(select sede_tdesc from sedes where sede_ccod=d.sede_ccod)sede,monto_beca_2011,ano_adjudicacion_beca,beca_otorgada"& vbCrLf &_
				...
				numero_total=conexion.ConsultaUno("select count(pers_nrut) from(select pers_nrut"& vbCrLf &_
 				"from ufe_t_asignacion_f_b_arancel a,alumnos b,personas c,ofertas_academicas d,especialidades e,carreras f"& vbCrLf &_
				"where a.rut=c.pers_nrut"& vbCrLf &_
				"and b.pers_ncorr=c.pers_ncorr"& vbCrLf &_
				"and b.ofer_ncorr=d.ofer_ncorr"& vbCrLf &_
              ...
              <table width="74%"  border="0" align="center">
                <tr>
					...
					<tr>
				  	...
				  	<td width="11%"><p><strong>Becas:</strong></p></td>
            ...
            <td><div align="center"><br>
              ...
              <form name="edicion">
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><%pagina.DibujarSubtitulo "Becas Mineduc"%>
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
				...
				<td><div align="center">
                  ...
                  <td><div align="center">
					...
					<%f_botonera.AgregaBotonParam "excel", "url", "renovantes_becas_externas_arancel_excel.asp?pers_nrut="&q_pers_nrut&"&pers_xdv="&q_pers_xdv&"&tdet_ccod="&q_tdet_ccod&"&sede_ccod="&q_sede_ccod&"&anos_ccod="&q_anos_ccod
				   f_botonera.DibujaBoton"excel"  %></div></td>
				  
							 
                  <td><div align="center"><% f_botonera.AgregaBotonParam "salir", "url", "lanzadera.asp"
