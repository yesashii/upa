              ...
              <form name="valida" action="" method="post">
                <tr>
                  <td width="100%" align="center"><table width="100%">
                      <tr>
                        <td width="63%"><font size="3" face="Georgia, Times New Roman, Times, serif" color="#496da6"><strong>Bienvenido a la Intranet de Apoderados </strong></font></td>
                        <td width="37%"><hr></td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td width="100%" align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="100%" height="20" align="center">Seleccione el alumno avalado del cual desea obtener informaci&oacute;n</td>
                      </tr>
                      <tr>
                                  ...
                                  <tr>
									...
									<tr><th colspan="4"><font size="2" face="Courier New"><b>Listado de alumnos</b></font></th></tr>
										...
										<tr valign="bottom">
										  ...
										  <td width="15%" align="center"> &nbsp;<a href="reenvia.asp?codigo=<%f_datos_alu.dibujaCampo "pers_nrut"%>"><font size="2">Ver informacion</font></a></td>
									    </tr>
										<%wend%>
                                    </table></td>
                                  </tr>
