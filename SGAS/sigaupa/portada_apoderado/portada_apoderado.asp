...
'------------------------------------------------------  
 ...
 botonera.carga_parametros "portada_apoderado.xml", "btn_portada"
'------------------------------------------------------

'---------------------------------------------------------------------
 set f_datos = new CFormulario
 f_datos.Carga_Parametros "portada_apoderado.xml", "f_datos"
						...
						<form name="valida" action="" method="post">
							<tr>
								<td width="100%" align="center">
									<table width="100%">
										<tr>
										   <td width="54%"><font size="3" face="Georgia, Times New Roman, Times, serif" color="#496da6"><strong>Ingreso a Intranet de Apoderados </strong></font></td>
									      <td width="46%"><hr></td>
										</tr>
									</table>
								</td>
								...
								<td width="100%" align="center">
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
									       ...
									       <td height="20" colspan="4" align="center">
									  			<table width="100%" border="1" bordercolor="#496da6">
													<tr><td align="center">
																		 ...
																		 <tr>
																		    <td align="center" width="85"><img width="80" height="80" src="../informacion_alumno_2008/imagenes/llaves.gif" border="0"></td>
																		    <td width="430" align="left">
																				<table width="100%" cellpadding="0" cellspacing="0" border="0">
																					<tr>
																						...
																						<td width="79%" align="left"><%f_datos.dibujaCampo "login"%> (rut sin puntos y con guion ej: 3333333-3) </td>
																					</tr>
																					<tr>
									  ...
									  <tr> 
										...
										<td width="29%" height="10" align="left"><div align="right"><a href="portada_apoderado.asp" onClick="clave();">¿Has olvidado tu clave..?</a></div></td>
...
<br/>Resolución óptima: 1280 x 1024 pixeles</p></center></td></tr>
