...
<%
Response.AddHeader "Content-Disposition", "attachment;filename=horario_sala_periodo.xls"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td width="10%" widt="10"><font size="2"><strong>Fecha</strong></font></td>
    <td width="47%"><font size="2">: <%=fecha2%></font></td>
  </tr>
  <tr> 
