...
Sqlpersfeccionamiento = " Select '"&pers_ncorr&"' as pers_ncorr,cudo_ncorr,cudo_tinstitucion, " & _
						" case grac_ccod when 1 then ' TÉCNICO ' when 2 then ' PROFESIONAL ' else '' end + '""' + CUDO_TITULO + '""' as CUDO_TITULO,PAIS_TDESC,cudo_ano_egreso,protic.trunc(cudo_fecha_egreso)as cudo_fecha_egreso " & _
...
F_Perfeccionamiento.carga_parametros "perfeccionamiento.xml", "perfeccionamiento"
