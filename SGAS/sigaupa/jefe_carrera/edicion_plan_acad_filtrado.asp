...
botonera.carga_parametros "edicion_plan_acad_filtrado.xml", "btn_edicion_plan_acad"
...
tipo_permiso=conec_resul.consultaUno("select isnull(b.srol_npermiso,0) from sis_roles_usuarios a, sis_roles b where cast(a.pers_ncorr as varchar)='"&pers_ncorr_temporal&"' and a.srol_ncorr=b.srol_ncorr")
'------------------------------------------------------------------------------------------------------------------------------------------
'------------------------------------------------------------------------------------------------------------------------------------------
...
formu_resul.carga_parametros "edicion_plan_acad_filtrado.xml", "edicion_bloque"
...
formu_prof.carga_parametros "edicion_plan_acad_filtrado.xml", "profesores"
...
consulta = "select pers_ncorr, bloq_ccod, protic.obtener_nombre_completo(pers_ncorr, 'PM,N') as nombre_profesor, sede_ccod, tpro_ccod,bloq_anexo," & vbCrLf &_
		   ...
		   "where cast(bloq_ccod as varchar) = '" & a & "'"
'else
...
f_botonera_profesor.Carga_Parametros "edicion_plan_acad_filtrado.xml", "botonera"
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
					  ...
					  <tr> 
                        <td align="right">&nbsp;</td>
                        <td height="25" align="right"><font size="1"><strong>Bloque Ayudant&iacute;a ?</strong></font></td>
                        <td><div align="center">:</div></td>
					  ...
					  <%end if%>
                      <tr> 
                        <td height="25" colspan="7" align="right"><div align="left"> 
                          </div>
