...
botonera.carga_parametros "paulo.xml", "btn_plan_acedemica_seccion"
...
'end if
'response.Write(consulta_busqueda)
'formu_resul.carga_parametros "paulo.xml", "pl_academica_seccion"
...
'response.Write("usuario_paso = "&usuario_paso&" , autorizada = "&autorizada&" , actividad = "&actividad)
'response.End
'--usuario_paso = 15740666 , autorizada = 1 , actividad = 6
...
'consulta = " select '1' as posicion, a.* from sub_secciones a where a.secc_ccod=" & secc_ccod

'---------------------------------Lo que viene lo cometo Luis Torres, porque esta demas.---------------------------------
...
'response.End
'posicion	ssec_ncorr	secc_ccod	sede_ccod	carr_ccod	peri_ccod	asig_ccod	jorn_ccod	moda_ccod	ssec_tdesc
'1			60255		63208		4			850			240			FPOMV056    NULL		NULL		NULL
...
f_tabla.carga_parametros "paulo.xml", "pl_academica_seccion"
f_tabla.agregaCampoParam "Asignatura_Seccion","consulta", filtro
f_tabla.inicializar conexion
f_tabla.consultar consulta

'response.Write("secc_ccod = "&secc_ccod&" , periodo = "&periodo)
'response.End
'--secc_ccod = 63208 , periodo = 240
...
'response.Write("consulta = "&consulta)
'response.End
'--Listado de carrera ha Seleccionar con la cual se comparte esta planificación de la asignatura.
'---------------------------------------------------------------------------------------------------------------------------------------------------------
...
'response.Write("sql_seccion_completa = "&sql_seccion_completa)
'response.End
'--N
                  ...
                  <td bgcolor="#D8D8DE">
				    &nbsp;
                      ...
                      <table width="98%" cellspacing="0" cellpadding="0">
						...
						<%end if%>
                        <tr> 
                          <td>* Indica que el bloque horario no cuenta con un docente asignado</td>
                        </tr>
						<tr> 
                          <td>&nbsp;</td>
                        </tr>
