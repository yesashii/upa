...
'response.Write("==> "&v_carr_ccod)
 ...
 '/************************************buscamos la cadena de planes de estudios para alumnos antiguos*************************************************
  if alumno_nuevo=0 and not esVacio(v_carr_ccod) then
...
" WHERE cast(b.plan_ccod as varchar) in " & cadena_planes & ""
...
"   and b.asig_ccod=secc.asig_ccod and b.mall_ccod=secc.mall_ccod and secc.secc_ncupo > 0 and secc.secc_ccod=bl.secc_ccod and cast(secc.jorn_ccod as varchar)='"&jorn_ccod&"'" & vbCrlf & _
"   AND NOT (  " & vbCrlf & _
