...
botonera.carga_parametros "plan_academica_filtrado.xml", "btn_plan_acedemica_seccion"
...
f_tabla.carga_parametros "plan_academica_filtrado.xml", "pl_academica_seccion"
                  ...
                  <td bgcolor="#D8D8DE">
				    &nbsp;
                      ...
                      <table width="98%" cellspacing="0" cellpadding="0">
                        ...
                        <tr> 
                          <td align="right"><strong> <input type="hidden" name="Carrera_ocul"  value="<%=request.QueryString("Carrera_ocul")%>">P&aacute;ginas</strong> <%f_tabla.accesoPagina%> </td>
                        </tr>
                        <tr> 
                          <td>&nbsp;</td>
                        </tr>
