...
pagina.Titulo = "Documentos Del Docente"
...
SqlExLaboral = " Select '" & pers_ncorr & "' as pers_ncorr,publ_ccod,protic.trunc(publ_fpublicacion) as publ_fpublicacion,tpub_ccod, " & _
			   " publ_tdesc,publ_tmedio,pais_ccod,publ_tautoria " & _
			   " from publicacion_docente " & _
			   " where cast(pers_ncorr as varchar)='" & pers_ncorr & "'" & _
			   " and tpub_ccod in (1,2) " & _
			   " order by publ_fpublicacion asc"
			   

set F_ExLaboral = new cformulario			   
F_ExLaboral.carga_parametros "publicacion_docente.xml", "publicacion_docente"
...
f_botonera.AgregaBotonParam "agregar", "url", "agregar_publicacion_docente.asp?pers_ncorr=" & pers_ncorr
