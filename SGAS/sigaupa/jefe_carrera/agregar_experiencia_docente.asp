...
SqlExperiencia=" Select pers_ncorr,cudo_ncorr,cudo_tinstitucion, " & _
			   " cudo_asig_tdesc,cudo_nsemestre,cudo_carr_tdesc,cudo_area,"& _
			   " protic.trunc(cudo_finicio) as cudo_finicio,protic.trunc(cudo_ftermino) as cudo_ftermino,cudo_tactividad,cudo_anos_experiencia " & _
			   " from curriculum_docente " & _
			   " where cast(cudo_ncorr as varchar)='"&cudo_ncorr&"'"

set F_ExLaboral = new cformulario			   
F_ExLaboral.carga_parametros "experiancia_docente.xml", "agregar_experiancia_docente"
...
f_botonera.Carga_Parametros "experiancia_docente.xml", "botonera"
	...
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <div align="left"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Agregar experiencia docente </font></div></td>
			...
			<input type="hidden" name="m[0][tiex_ccod]" value="2">
			<input type="hidden" name="cudo_ncorr" value="<%=cudo_ncorr%>">
              ...
              <table width="100%" border="0">
                <tr>
                  <td width="3%" align="right"><font color="#CC3300">*</font> </td>
                  <td width="29%" align="right"><div align="left"><strong>Asignatura Impartida </strong></div></td>
                  <td width="68%" align="left"> :  <%F_ExLaboral.dibujacampo("cudo_asig_tdesc")%>                    </td>
                </tr>
                <tr>
                  <td align="right"><font color="#CC3300">*</font></td>
                  <td align="right"><div align="left"><strong>Cargo</strong></div></td>
                  <td align="left"> : 
                ...
                <tr>
                  ...
                  <td align="left"> : 
                    <%F_ExLaboral.dibujacampo("cudo_tinstitucion")%> </td>
                </tr>
				<tr>
                  <td align="right">&nbsp;</td>
                  <td align="right"><div align="left"><strong>Carrera</strong></div></td>
                  <td align="left"> :                    
                    <%F_ExLaboral.dibujacampo("cudo_carr_tdesc")%></td>
                </tr>
				<tr> 
                  <td align="right">&nbsp;</td>
                  <td align="right"><div align="left"><strong>A&ntilde;os De Experiencia</strong></div></td>
                  <td align="left">:   
                    <%F_ExLaboral.dibujacampo("cudo_anos_experiencia")%>                    </td>
                </tr>
                <tr>
                  <td align="right">&nbsp;</td>
                  <td align="right"><div align="left"><strong>Nro. Semestres</strong></div></td>
                  <td> : 
                    <%F_ExLaboral.dibujacampo("cudo_nsemestre")%></td>
                </tr>
                <tr>
                  <td align="right"><font color="#CC3300">&nbsp;</font></td>
                  <td align="right"><div align="left"><strong>&Aacute;rea Disciplinaria </strong></div></td>
                  <td>:
                    <%F_ExLaboral.dibujacampo("cudo_area")%></td>
                </tr>
				<tr>
                  <td align="right"><font color="#CC3300">*</font></td>
                  <td align="right"><div align="left"><strong>Fecha Inicio</strong></div></td>
                  <td align="left"> :
				...
				<tr>
                  <td align="right"><font color="#CC3300">*</font></td>
                  <td align="right"><div align="left"><strong>Fecha Termino </strong></div></td>
                  <td align="left"> :
