...
pagina.Titulo = "CARGA ANUAL ALUMNOS ACTIVOS "
...
consulta = 	" select * "& vbCrLf &_
			...
			"   a.pers_tape_paterno  as AP_Paterno, a.pers_tape_materno  as AP_Materno, a.pers_tnombre as nombre,  "& vbCrLf &_
            "   facu.facu_ccod,facu.facu_tdesc as facultad,h.sede_ccod,h.sede_tdesc as sede,e.carr_ccod ,f.carr_tdesc as Carrera,g.jorn_ccod, g.jorn_tdesc as jornada ,  "& vbCrLf &_
			...
			"   where emat.emat_ccod in (select top 1 emat_ccod from alumnos a1 (nolock), ofertas_academicas o1 where a1.pers_ncorr=d.pers_ncorr and a1.ofer_ncorr=o1.ofer_ncorr and o1.espe_ccod = c.espe_ccod and a1.emat_ccod <> 9 order by o1.peri_ccod desc, convert(datetime,a1.audi_fmodificacion) desc))   "& vbCrLf &_
			"   as estado_academico,protic.trunc(cont.cont_fcontrato) as fecha_matricula, "& vbCrLf &_
            "   (select count(*) "& vbCrLf &_
            "       from alumnos aa (nolock), ofertas_academicas bb, especialidades cc, "& vbCrLf &_
            "            cargas_academicas dd (nolock), secciones ee, asignaturas ff "& vbCrLf &_
            ...
            "       and ff.duas_ccod <> 3 and cast(bb.peri_ccod as varchar)='"&p_semestre&"' and cc.carr_ccod=e.carr_ccod "& vbCrLf &_
            "       ) as total_carga_1er_semestre, "& vbCrLf &_
            "   (select count(*) "& vbCrLf &_
            "       from alumnos aa (nolock), ofertas_academicas bb, especialidades cc, "& vbCrLf &_
            "            cargas_academicas dd (nolock), secciones ee, asignaturas ff "& vbCrLf &_
            "       where aa.pers_ncorr=a.pers_ncorr and aa.ofer_ncorr=bb.ofer_ncorr and bb.espe_ccod=cc.espe_ccod "& vbCrLf &_
            "       and aa.matr_ncorr=dd.matr_ncorr and dd.secc_ccod=ee.secc_ccod and ee.asig_ccod=ff.asig_ccod "& vbCrLf &_
            "       and ff.duas_ccod <> 3 and cast(bb.peri_ccod as varchar)='"&s_semestre&"' and  cc.carr_ccod=e.carr_ccod "& vbCrLf &_
            "       ) as total_carga_2do_semestre,  "& vbCrLf &_
...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td bgcolor="#FF9900"><div align="center"><strong>Total carga 1er Semestre</strong></div></td>
	<td bgcolor="#FF9900"><div align="center"><strong>Total carga 2do Semestre</strong></div></td>
	<td bgcolor="#FF9900"><div align="center"><strong>Es moroso</strong></div></td>
  ...
  <tr>
	...
	<td align="left"><%=f_listado.ObtenerValor("total_carga_1er_semestre")%></td>
	<td align="left"><%=f_listado.ObtenerValor("total_carga_2do_semestre")%></td>
	<td align="left"><%=f_listado.ObtenerValor("moroso")%></td>
