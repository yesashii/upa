...
SqlExperiencia=" Select CUDO_TITULO,GRAC_CCOD,cudo_tinstitucion,protic.trunc(CUDO_FECHA_EGRESO) as CUDO_FECHA_EGRESO,CUDO_ANO_EGRESO,PAIS_CCOD from curriculum_docente " & _
			   " where cast(cudo_ncorr as varchar)='"&cudo_ncorr&"'"



set F_ExLaboral = new cformulario			   
F_ExLaboral.carga_parametros "perfeccionamiento.xml", "agregar_perfeccionamiento"
...
f_botonera.Carga_Parametros "perfeccionamiento.xml", "botonera"
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <div align="left"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">Agregar Titulo Profesional </font></div></td>
			...
			<input type="hidden" name="cudo_ncorr" value="<%=cudo_ncorr%>">
              ...
              <table width="100%" border="0">
                <tr>
                  ...
                  <td width="40%" align="right"><div align="left"><strong>Titulo Profesional</strong></div></td>
                  <td width="55%" align="left"> :
<%F_ExLaboral.dibujacampo("CUDO_TITULO")%></td>
                </tr>
				<tr>
                  <td width="5%" align="right"><font color="#CC3300">*</font> </td>
                  <td width="40%" align="right"><div align="left"><strong>Tipo T&iacute;tulo</strong></div></td>
                  <td width="55%" align="left"> :
<%F_ExLaboral.dibujacampo("GRAC_CCOD")%></td>
                </tr>
                <tr>
...
<%F_ExLaboral.dibujacampo("cudo_tinstitucion")%></td>
				  ...
				  <tr>
                  <td align="right"> </td>
                  <td align="right"><div align="left"><strong>Fecha de Egreso </strong></div></td>
                  <td align="left">: <%F_ExLaboral.dibujacampo("CUDO_FECHA_EGRESO")%>                      </td>
                </tr>
                <tr>
                  <td align="right"> </td>
                  <td align="right"><div align="left"><strong>A&ntilde;o Egreso </strong></div></td>
                  <td align="left">: <%F_ExLaboral.dibujacampo("CUDO_ANO_EGRESO")%>                      </td>
                </tr>
                <tr>
                  <td align="right">&nbsp;</td>
