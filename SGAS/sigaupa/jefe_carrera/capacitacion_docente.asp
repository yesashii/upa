...
pagina.Titulo = "Capacitación Docente"
...
Sqlpersfeccionamiento = " select "&pers_ncorr&" as pers_ncorr, a.cpro_ncorr,cast(b.grac_tdesc as varchar)+' '+ cast(a.cpro_nombre_curso as varchar) as nombre_curso, "&_
						" a.empr_razon_social,protic.trunc(cpro_fecha_inicio) as fecha_inicio,protic.trunc(a.cpro_fecha_termino)as fecha_termino,d.egra_tdesc "&_
...
F_Perfeccionamiento.carga_parametros "capacitacion_docente.xml", "capacitacion_docente"
...
f_botonera.AgregaBotonParam "agregar", "url", "agregar_capacitacion.asp?pers_ncorr=" & pers_ncorr
	...
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
                <td><img name="top_r2_c1" src="../imagenes/top_r2_c1.gif" width="9" height="17" border="0" alt=""></td>
                <td><%pagina.DibujarLenguetas lenguetas_masignaturas01, 3%></td>
                <td><img name="top_r2_c3" src="../imagenes/top_r2_c3.gif" width="7" height="17" border="0" alt=""></td>
              </tr>
              <tr>
                <td><img name="top_r3_c1" src="../imagenes/top_r3_c1.gif" width="9" height="2" border="0" alt=""></td>
