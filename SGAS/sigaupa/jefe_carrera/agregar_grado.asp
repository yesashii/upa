...
'---------------------------------------------------------------------------------------------------
gpro_ncorr=request.QueryString("gpro_ncorr")
pers_ncorr=request.QueryString("pers_ncorr")
set conectar = new CConexion
conectar.Inicializar "upacifico"


SqlExperiencia= "select c.GRAC_CCOD,gpro_tdescripcion,EGRA_CCOD,gpro_tinstitucion,GPRO_ANO_EGRESO,protic.trunc(GPRO_FECHA_EGRESO)as GPRO_FECHA_EGRESO,PAIS_CCOD  " & _
				" from profesores a,grados_profesor b, " & _
				" grados_academicos c " & _
				" where a.pers_ncorr = b.pers_ncorr " & _
				" and b.grac_ccod = c.grac_ccod " & _
				" and cast(b.gpro_ncorr as varchar) = '"&gpro_ncorr&"' "
					


set F_ExLaboral = new cformulario			   
F_ExLaboral.carga_parametros "grado_academico.xml", "agregar_grado"
...
f_botonera.Carga_Parametros "grado_academico.xml", "botonera"
...
function habilita(formulario){
	valor =	formulario.elements["m[0][EGRA_CCOD]"].value
	if ( valor ==1 ){
		formulario.elements["m[0][GPRO_ANO_EGRESO]"].readOnly=false;	
	}
	else{
		formulario.elements["m[0][GPRO_ANO_EGRESO]"].value="";
	...
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<input type="hidden" name="m[0][tiex_ccod]" value="3">
			<input type="hidden" name="gpro_ncorr" value="<%=gpro_ncorr%>">
              <table width="100%" border="0">
               ...
               <table width="100%" border="0">
                <tr>
                  <td width="5%" align="right"><font color="#CC3300">*</font> </td>
                  <td width="29%" align="right"><div align="left"><strong>Grado Acad&eacute;mico  </strong></div></td>
                  <td width="66%" align="left"> : <%F_ExLaboral.dibujacampo("GRAC_CCOD")%></td>
                </tr>
                <tr>
                  <td align="right"><font color="#CC3300">*</font></td>
                  <td align="right"><div align="left"><strong>Descripci&oacute;n Del Grado</strong></div></td>
                  <td align="left"> : <%F_ExLaboral.dibujacampo("gpro_tdescripcion")%></td>
                </tr>
                <tr>
                  <td align="right"><font color="#CC3300">*</font></td>
                  <td align="right"><div align="left"><strong>Estado Del Grado </strong></div></td>
                  <td align="left">: <%F_ExLaboral.dibujacampo("EGRA_CCOD")%> </td>
                </tr>
                <tr>
                  <td align="right"><font color="#CC3300">*</font></td>
                  <td align="right"><div align="left"><strong>Instituci&oacute;n</strong></div></td>
                  <td align="left">:   <%F_ExLaboral.dibujacampo("gpro_tinstitucion")%>                    </td>
                </tr>
                <tr>
                  <td align="right">&nbsp;</td>
                  <td align="right"><div align="left"><strong>A&ntilde;o Egreso </strong></div></td>
                  <td align="left">:  
                    <%F_ExLaboral.dibujacampo("GPRO_ANO_EGRESO")%></td>
                </tr>
				<tr>
                  <td align="right">&nbsp;</td>
                  <td align="right"><div align="left"><strong>Fecha Egreso </strong></div></td>
                  <td align="left">:  <%F_ExLaboral.dibujacampo("GPRO_FECHA_EGRESO")%></td>
                </tr>
                <tr>
                  <td align="right">&nbsp;</td>
                  <td align="right"><div align="left"><strong>Pais</strong></div></td>
                  <td>:  <%F_ExLaboral.dibujacampo("PAIS_CCOD")%>                     </td>
                </tr>
              </table>
                    </form>
				  <br>				  </td>
