...
pagina.Titulo = "Otras Actividades que Desarrolla Actualmente"
...
SqlOtrasAct = " Select '" & pers_ncorr & "' as pers_ncorr,publ_totrasactividades,publ_ccod " & _
			   " from publicacion_docente " & _
			   " where cast(pers_ncorr as varchar)='" & pers_ncorr & "'" & _
			   " and tpub_ccod=3"
   

set F_OtrasActividades = new cformulario			   
F_OtrasActividades.carga_parametros "otras_actividades.xml", "otras_actividades"
F_OtrasActividades.inicializar conectar


F_OtrasActividades.consultar SqlOtrasAct

'---------------------------------------------------------------------------------------------------
set f_botonera = new CFormulario
f_botonera.Carga_Parametros "otras_actividades.xml", "botonera"

f_botonera.AgregaBotonParam "agregar", "url", "agregar_otras_actividades.asp?pers_ncorr=" & pers_ncorr
f_botonera.AgregaBotonParam "anterior", "url", "publicacion_docente.asp?pers_ncorr=" & pers_ncorr
...
lenguetas_masignaturas01 = Array(Array("Documentos Docente", "publicacion_docente.asp?pers_ncorr="&pers_ncorr),Array("Otras Actividades Docente", "otras_actividades.asp?pers_ncorr="&pers_ncorr),Array("Capacitación Docente", "capacitacion_docente.asp?pers_ncorr="&pers_ncorr))
%>


<html>
<head>
<title>Otras Actividades que Desarrolla Actualmente</title>
...
function agregar(formulario){
	...
	direccion = "agregar_otras_actividades.asp?pers_ncorr="+pers_ncorr
...
function enviar(formulario,pagina){
			pers_ncorr=formulario.pers_ncorr.value	
			if (pagina==0){
				window.navigate('publicacion_docente.asp?pers_ncorr='+pers_ncorr+'&rut='+"<%=rut%>"+'&dv='+"<%=dv%>");
        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td><%pagina.DibujarLenguetas lenguetas_masignaturas, 0%></td>
			  ...
			  <tr>
                <td><img name="top_r2_c1" src="../imagenes/top_r2_c1.gif" width="9" height="17" border="0" alt=""></td>
                <td><%pagina.DibujarLenguetas lenguetas_masignaturas01, 2%></td>
                <td><img name="top_r2_c3" src="../imagenes/top_r2_c3.gif" width="7" height="17" border="0" alt=""></td>
              </tr>
              <tr>
                <td><img name="top_r3_c1" src="../imagenes/top_r3_c1.gif" width="9" height="2" border="0" alt=""></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td bgcolor="#D8D8DE">
				    ...
				    <div align="center">
			          <%F_OtrasActividades.dibujatabla()%>
					  <br>
					  <br>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  ...
                  <td width="241" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><div align="center"><%f_botonera.DibujaBoton("anterior")%>
					    </div></td>
                      <td><div align="center">
                  ...
                  <td width="127" rowspan="2" background="../imagenes/abajo_r1_c4.gif"><img src="../imagenes/abajo_r1_c3.gif" width="12" height="28"></td>
                  <td width="332" rowspan="2" align="right" background="../imagenes/abajo_r1_c4.gif"><img src="../imagenes/abajo_r1_c5.gif" width="7" height="28"></td>
                </tr>
                <tr>
