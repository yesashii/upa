...
pagina.Titulo = "Experiencia Docente"
...
SqlExdocente = " Select '"&pers_ncorr&"' as pers_ncorr,cudo_ncorr,cudo_tinstitucion, " & _
			   " cudo_asig_tdesc,cudo_nsemestre,cudo_carr_tdesc,cudo_area,"& _
			   " protic.trunc(cudo_finicio) as cudo_finicio,protic.trunc(cudo_ftermino) as cudo_ftermino,cudo_tactividad " & _
			   " from curriculum_docente" & _
			   " where cast(pers_ncorr as varchar)='"&pers_ncorr&"'" & _
			   " and tiex_ccod=2" &_
			   "order by cudo_finicio asc"

set F_ExDocente = new cformulario			   
F_ExDocente.carga_parametros "experiancia_docente.xml", "experiancia_laboral"
F_ExDocente.inicializar conectar

F_ExDocente.consultar SqlExdocente

'---------------------------------------------------------------------------------------------------
set f_botonera = new CFormulario
f_botonera.Carga_Parametros "experiancia_docente.xml", "botonera"

f_botonera.AgregaBotonParam "agregar", "url", "agregar_experiencia_docente.asp?pers_ncorr=" & pers_ncorr
...
{ var pers_ncorr=document.editar.elements["pers_ncorr"].value;
  ruta="publicacion_docente.asp?pers_ncorr="+pers_ncorr;
        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td><%pagina.DibujarLenguetas lenguetas_masignaturas, 5%></td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td bgcolor="#D8D8DE">
				    ...
				    <div align="center">
			          <%F_ExDocente.dibujatabla()%>
					  <br>
					  <br>
                      <table width="28%"  border="0" align="right" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><div align="center">						  <%f_botonera.DibujaBoton "agregar" %>
						  </div></td>
                          <td><div align="center">
                ...
                <tr>
                  ...
                  <td width="237" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td><div align="center"><%'pagina.DibujarBoton "Continuar", "", "enviar(document.editar, 2);" %></div></td>
