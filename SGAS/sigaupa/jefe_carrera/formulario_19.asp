...
Sqlcapacitacion       = " select "&pers_ncorr&" as pers_ncorr, a.cpro_ncorr,cast(b.grac_tdesc as varchar)+' '+ cast(a.cpro_nombre_curso as varchar) as nombre_curso, "&_
						" a.empr_razon_social as institucion,protic.trunc(cpro_fecha_inicio) as fecha_inicio,protic.trunc(a.cpro_fecha_termino)as fecha_termino,d.egra_tdesc as estado"&_
						" from capacitacion_profesor a,grados_academicos b,estados_grados_academicos d "&_
						" where a.grac_ccod = b.grac_ccod "&_
						" and a.egra_ccod=d.egra_ccod "&_
						" and cast(a.pers_ncorr as varchar) = '"&pers_ncorr&"'"

set F_capacitacion = new cformulario			   
F_capacitacion.carga_parametros "tabla_vacia.xml", "tabla"
F_capacitacion.inicializar conexion

F_capacitacion.consultar Sqlcapacitacion
          ...
          <th nowrap> <table width="100%" border="0" cellpadding="0">
              <tr> 
                <th nowrap> <table width="100%" border="0" cellpadding="2" cellspacing="0">
                    ...
                    <tr> 
                      <td height="59" colspan="3"> 
					  <font size="2" ><strong>CAPACITACIÓN DOCENTE</strong></font>
					  <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
                          
                          <tr> 
                            <td><strong><font size="2">Nombre Capacitación</font></strong></td>
                            <td><strong><font size="2">Instituci&oacute;n</font></strong></td>
                            <td><strong><font size="2">Fecha inicio</font></strong></td>
                            <td><strong><font size="2">Fecha t&eacute;rmino</font></strong></td>
                            <td><strong><font size="2">Estado</font></strong></td>
                            
                          <tr> 
                            <% while F_capacitacion.Siguiente%>
                          <tr> 
                            <td><font size="1"><%=F_capacitacion.ObtenerValor("nombre_curso")%></font></td>
                            <td><font size="1"><%=F_capacitacion.ObtenerValor("institucion")%></font></td>
                            <td><font size="1"><%=F_capacitacion.ObtenerValor("fecha_inicio")%></font></td>
                            <td><font size="1"><%=F_capacitacion.ObtenerValor("fecha_termino")%></font></td>
                            <td><font size="1"><%=F_capacitacion.ObtenerValor("estado")%></font></td>
