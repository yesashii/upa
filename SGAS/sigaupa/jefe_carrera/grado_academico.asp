...
pagina.Titulo = "Grados Academicos"
...
Sqlpersfeccionamiento = " select '"&pers_ncorr&"' as pers_ncorr, a.gpro_ncorr,cast(b.grac_tdesc as varchar)+' "" '+ cast(a.gpro_tdescripcion as varchar)+'""' as GPRO_TDESCRIPCION, " & _
						" a.gpro_tinstitucion,a.gpro_ano_egreso,protic.trunc(a.gpro_fecha_egreso)as gpro_fecha_egreso,c.pais_tdesc,d.egra_tdesc " & _
						" from grados_profesor a,grados_academicos b,paises c,estados_grados_academicos d " & _
						" where a.grac_ccod = b.grac_ccod " & _
						" and a.pais_ccod = c.pais_ccod " & _
						" and a.egra_ccod=d.egra_ccod " &_
						" and cast(a.pers_ncorr as varchar) = '"&pers_ncorr&"' "

set F_Perfeccionamiento = new cformulario			   
F_Perfeccionamiento.carga_parametros "grado_academico.xml", "grado_academico"
...
f_botonera.AgregaBotonParam "agregar", "url", "agregar_grado.asp?pers_ncorr=" & pers_ncorr
...
function enviar(formulario,pagina){
			...
			if (pagina==0){
				window.navigate('perfeccionamiento.asp?pers_ncorr='+pers_ncorr+'&rut='+"<%=rut%>"+'&dv='+"<%=dv%>");
...
{ var pers_ncorr=document.editar.elements["pers_ncorr"].value;
  ruta="experiencia_laboral.asp?pers_ncorr="+pers_ncorr;
        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td><%pagina.DibujarLenguetas lenguetas_masignaturas, 3%></td>
