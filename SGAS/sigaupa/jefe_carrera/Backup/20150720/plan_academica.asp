...
"       else 2                                                                                                                                                   " & vbCrLf &_
"       end as varchar) + ' ( ' + cast( isnull(round(cast(100/isnull(cast(case moda_ccod when 1 then case asig_nhoras when 0 then 1 else asig_nhoras end else secc_nhoras_pagar end as numeric),         " & vbCrLf &_
...
"       + ' ('                                                                                                                                                   " & vbCrLf &_
"       + cast(isnull(round(cast(100/isnull(cast(case moda_ccod when 1 then case asig_nhoras when 0 then 1 else asig_nhoras end else secc_nhoras_pagar end as int), 999999999)as decimal(5,              " & vbCrLf &_
