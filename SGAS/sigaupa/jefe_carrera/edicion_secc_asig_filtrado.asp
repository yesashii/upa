...
botonera.carga_parametros "adm_secciones_filtradas.xml", "btn_edicion_secc_asig"
set botonera_electivo = new CFormulario
botonera_electivo.carga_parametros "electivos.xml", "botonera"


conexion.inicializar "upacifico"
ftitulo.carga_parametros "adm_secciones_filtradas.xml", "4tt"
ftitulo.inicializar conexion
fsecc_asig.carga_parametros "adm_secciones_filtradas.xml", "4"
fsecc_asig.inicializar conexion

fsecc_asig_electivo.carga_parametros "adm_secciones_filtradas.xml", "planificacion_elec"
...
'response.Write("sql_electiva "&sql_electiva)
...
electiva = conexion.consultauno(sql_electiva)
	...
	sql_malla = "select mall_ccod " & _
			...
			" and cast(plan_ccod as varchar) ='"&plan_ccod&"' " 
...
if crea_seccion = TRUE then
			consulta = " select  isnull(b.secc_ccod,0) as secc_ccod_paso,a.asig_ccod,a.asig_tdesc, c.ssec_ncorr, 'Editar' as subsecciones ,b.* "& vbCrLf & _
					   ...
					   " and secc_finicio_sec is not null and secc_ftermino_sec is not null " & vbCrLf & _
					   " --and cast(b.mall_ccod as varchar)='"&mall_ccod&"'" & vbCrLf & _
					   " order by b.secc_tdesc asc" 
...
<table width="628" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" bgcolor="#EAEAEA">
                        <form action="proc_secc_filtrado.asp" method="post" name="buscador" >
	<table width="82%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <% ftitulo.dibujaCampo("asig_tdesc") %>
                  ...
                  <table width="98%" height="200" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" valign="top"><%if crea_seccion = true then%><%fsecc_asig.dibujaTabla %><%else%><%fsecc_asig_electivo.dibujatabla()%><%end if%>
                          <br><br>
