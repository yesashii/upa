...
if carrera <> "" and nivel <> "" then
	filtro = " carr_ccod='" & carrera & "' and nive_ccod=" & nivel & "  and c.espe_ccod='" & especialidad & "' and b.plan_ccod=" & plan  
elseif carrera <> "" and nivel="" then
    filtro = " carr_ccod='" & carrera & "' and c.espe_ccod='" & especialidad & "' and b.plan_ccod=" & plan   	
else
	filtro = " 1=2 "
end if
