...
'FECHA ACTUALIZACION		: 04/04/2014
'ACTUALIZADO POR			: MARIO RIFFO.
'MOTIVO				        : Quitar opcion de ap. materno obligatorio.
'********************************************************************
...
if rut = "" then
	...
	perso = " select tjdo_ccod,jdoc_ccod,'"&sede&"' as sede_ccod,c.tpro_ccod,c.mcol_ncorr,c.prof_exprofesional,c.prof_exacademica,c.prof_ingreso_uas,c.prof_nporcentaje_colacion ," & vbCrLf &_ 
...
aaa=formulario.ObtenerValor("tido_ccod")
	if aaa="" then
	aaa="0"	
	else
	response.Write("2")	
...
function valida_vire_inicio()
{
var valor;

valor=document.editar.elements["m[0][tido_ccod]"].value
//alert("valor="+valor);
if (valor =='1')
	{
...
<body bgcolor="#D8D8DE" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="valida_vire_inicio();valida_cargo(<%=q_tido_ccod%>);valida_facu(<%=q_vire_ccod%>);""MM_preloadImages('../imagenes/botones/buscar_f2.gif','../images/bot_deshabilitar_f2.gif','../images/agregar2_f2_p.gif','im&amp;#225;genes/marco1_r3_c2_f2.gif');MM_preloadImages('im&amp;#225;genes/marco1_r3_c4_f2.gif');MM_preloadImages('im&amp;#225;genes/marco1_r3_c6_f2.gif');MM_preloadImages('im&amp;#225;genes/marco1_r3_c8_f2.gif');MM_preloadImages('../imagenes/botones/cargar_f2.gif','../imagenes/botones/continuar_f2.gif')" onBlur="revisaVentana();" >
				     ...
				     <form name="editar" method="post">
					  ...
					  <table width="85%" align="center">
                        ...
                        <tr>
                          ...
                          <td ><b>:</b> <%=formulario.dibujaCampo("tido_ccod")%></td>
						  	<td><font color="#CC3300">*</font></td>
							<td>Jornada Docente</td>
							<td><%=formulario.dibujaCampo("tjdo_ccod")%></td>
                        </tr>
