...
botonera.carga_parametros "plan_academica_laboratorio.xml", "btn_det_plan"
...
'------------------------------------------------------------------------------------------------------------------------------------------
f_asig.carga_parametros "plan_academica_laboratorio.xml", "asignatura"
'formu_conectar.carga_parametros "plan_academica_laboratorio.xml", "bloque_muestra"
formu_conectar.carga_parametros "plan_academica_laboratorio.xml", "bloque"
profesores.carga_parametros "plan_academica_laboratorio.xml", "bloque1"
...
sede = <%=sede%>;
	...
	direccion="edicion_plan_acad_laboratorio.asp?ssec_ncorr="+subseccion+"&pers_ncorr=" + docente+"&sede_ccod="+sede + "&accion=A";
...
function enviar2(formulario) {
	if (confirm('¿Está seguro que desea eliminar los bloques seleccionados?')) {
	   formulario.action = 'borrar_bloque_laboratorio.asp';
	   formulario.submit();
	}
 }
                ...
                <tr>
                  ...
                  <td bgcolor="#D8D8DE">
				    ...
				    <table width="98%" cellspacing="0" cellpadding="0">
                      ...
                      <td width="100%" align="center"><br><div align="left"><strong> 
                          ...
                          <form name="editar" method="post">
                            ...
                            <table width="7%" align="right" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td><%if usuario_iniciado = "8516097" or usuario_iniciado = "13483051" or usuario_iniciado = "13813352" or usuario_iniciado ="8474919" then
