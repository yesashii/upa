                  ...
                  <tr> 
					...
					<table width="100%" border="1">
					 ...
					 <tr> 
                        ...
                        <td><%f_area.dibujaCampo("area_ccod")%></td>
					 </tr>
                      <tr> 
					  ...
					  <tr valign="top">
								...
								<br/>
								<br/>
								Yo: <input type="text" name="funcionario" value="<%=f_busqueda.obtenerValor("pers_tnombre")%>" size="30" readonly="yes"> 
								Rut:<input name="pers_nrut" value="<%=f_busqueda.obtenerValor("pers_nrut")%>" size="10" readonly="yes">
								-
								<input type="text" name="pers_xdv" value="<%=f_busqueda.obtenerValor("pers_xdv")%>" size="2" readonly="yes">
								<br>
