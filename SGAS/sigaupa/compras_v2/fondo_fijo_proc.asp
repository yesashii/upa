...
'response.Write("<br>Todo bien")
	session("mensaje_error")="La solicitud de Fondo Fijo fue ingresada correctamente."
end if
if url_final ="" then
	url_final=request.ServerVariables("HTTP_REFERER")&"?busqueda[0][ffij_ncorr]="&v_ffij_ncorr
end if
