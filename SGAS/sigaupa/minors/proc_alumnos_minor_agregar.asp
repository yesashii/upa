...
'response.Write(periodo_tdesc) 
'response.End()

if tiene_matricula ="0" then
	msj_error = "ERROR : Inposible asignar el alumno al minor.\n No presenta matricula para el periodo solicitado ( "&periodo_tdesc&")."
	elseif esta_en_minor <> "0" then
	msj_error = "ERROR : Inposible asignar el alumno al minor.\n Este alumno ya fue asignado al minor previamente."
else
