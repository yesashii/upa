...
f_contrato.Carga_Parametros "numeros_facturas_venta.xml", "nuevo_rango"
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <form name="edicion">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
							<td width="27%" >Tipo Factura</td>
							<td width="73%" ><% f_contrato.DibujaCampo ("tfac_ccod") %></td>
					  </tr>
							<tr>
							<td >Sede</td>
					...
					<tr>
							  ...
							  <td><% f_contrato.DibujaCampo ("rfac_ninicio") %></td>
					  </tr>
							<tr>
							  <td>Factura Fin</td>
							  <td><% f_contrato.DibujaCampo ("rfac_nfin") %></td>
					  </tr>
                    </table>
