...
class CConexion
    ...
    sub Inicializar(sistema)
		...
		objXMLDoc.load("C:\Inetpub\wwwroot\SIGAUPA\otec\biblioteca\conexion.xml") 
		...
		for each node in root.childNodes
			...
			if atributo = sistema then
                ...
                'dsn="protic2":usuario="protic":clave="mrclave"
...
class CFormulario
	...
	sub Carga_Parametros(nombre, idFormulario)
	    Set objXMLDoc = CreateObject("Microsoft.XMLDOM") 
		objXMLDoc.async = False 
		objXMLDoc.load("C:\Inetpub\wwwroot\SIGAUPA\otec\biblioteca\" & nombre ) 
