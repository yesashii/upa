  ...
  if ucase(password) =  ucase(clave) then
	 ...
	 if RUT <> "" then
		...
		elseif tipo_usuario = "D.Extensión" then
			 c_permiso = "select case count(*) when 0 then 'N' else 'S' end from personas where cast(pers_ncorr as varchar)='"&v_pers_ncorr&"' and  pers_nrut in (7741733,9831249,13828975,7688542) "
		...
		elseif tipo_usuario = "Asistente" then
			 c_permiso = "select case count(*) when 0 then 'N' else 'S' end from personas where cast(pers_ncorr as varchar)='"&v_pers_ncorr&"' and  pers_nrut in (7762039) "	 
		...
		elseif tipo_usuario = "Escuela" then
			 c_permiso = "select case count(*) when 0 then 'N' else 'S' end from sis_roles_usuarios where srol_ncorr in (87,64,66,69,150) and cast(pers_ncorr as varchar)='"&v_pers_ncorr&"'"
		...
		elseif tipo_usuario = "Contabilidad" then
   			 c_permiso = "select case count(*) when 0 then 'N' else 'S' end from personas where cast(pers_ncorr as varchar)='"&v_pers_ncorr&"' and  pers_nrut in (13493596,8829456,12366148,9251062,6629316,8876413)"
