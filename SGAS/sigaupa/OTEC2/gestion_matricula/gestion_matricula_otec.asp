...
<form name="buscador" method="get" action="">
  ...
  <tr borderColor="#999999"> 
    ...
    <td bgcolor="#FFECC6"><div align="left"><%=lista.Obtenervalor("sede_tdesc")%></div></td>
	<td bgcolor="#FFECC6" class='click' onClick='irA("gestion_matricula_matriculados.asp?sede_ccod=<%=lista.obtenervalor("sede_ccod")%>&ano_ccod=<%=ano_ccod%>", "2", 600, 400)'><div align="right"><%=lista.Obtenervalor("pendiente")%></div></td>
	<td bgcolor="#FFECC6" class='click' onClick='irA("gestion_matricula_matriculados.asp?sede_ccod=<%=lista.obtenervalor("sede_ccod")%>&ano_ccod=<%=ano_ccod%>", "2", 600, 400)'><div align="right"><%=lista.Obtenervalor("aprobado")%></div></td>
	<td bgcolor="#FFECC6" class='click' onClick='irA("gestion_matricula_matriculados.asp?sede_ccod=<%=lista.obtenervalor("sede_ccod")%>&ano_ccod=<%=ano_ccod%>", "2", 600, 400)'><div align="right"><%=lista.Obtenervalor("matriculado")%></div></td>
	<td bgcolor="#FFECC6" class='click' onClick='irA("gestion_matricula_matriculados.asp?sede_ccod=<%=lista.obtenervalor("sede_ccod")%>&ano_ccod=<%=ano_ccod%>", "2", 600, 400)'><div align="right"><strong><%=lista.Obtenervalor("meta")%></strong></div></td>
  ...
  <tr borderColor="#999999"> 
	...
	<td bgcolor="#FFECC6" ><div align="right"><strong><%=total_pendiente%></strong></div></td>
	<td bgcolor="#FFECC6"><div align="right"><strong><%=total_aprobado%></strong></div></td>
	 <td bgcolor="#FFECC6"><div align="right"><strong><%=total_matriculado%></strong></div></td>
	  <td bgcolor="#FFECC6"><div align="right"><strong><%=total_meta%></strong></div></td>
  </tr>
