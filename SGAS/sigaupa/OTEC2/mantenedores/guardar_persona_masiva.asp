...
if fpot_ccod = "4" then
    ...
    c_postulacion_i = " insert into postulacion_otec "&_
				      ...
				      " values ("&pote_ncorr&","&pers_ncorr&",1,getDate(),"&dgso_ncorr&","&utiliza_sence&","&fpot_ccod&",'"&usuario&"',getDate(),"&nied_ccod&","&pers_ncorr_empresa&","&pers_ncorr_otic&","&nord_compra&","&tdet_ccod&",1,1,1)"
					  
	c_postulacion_u = " update postulacion_otec set fpot_ccod ="&fpot_ccod&","&_
    ...
    c_postulacion_i = " insert into postulacion_otec "&_
					  ...
					  "	 datos_persona_correctos,datos_empresa_correctos,datos_otic_correctos) "&_
				      " values ("&pote_ncorr&","&pers_ncorr&",1,getDate(),"&dgso_ncorr&","&utiliza_sence&","&fpot_ccod&",'"&usuario&"',getDate(),"&nied_ccod&","&pers_ncorr_empresa&","&nord_compra&","&tdet_ccod&",1,1,NULL)"
