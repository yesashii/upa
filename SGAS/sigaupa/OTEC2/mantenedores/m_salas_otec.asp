...
session("url_actual")="../mantenedores/m_salas_otec.asp?b[0][sede_ccod]="&sede_ccod
'response.Write("../mantenedores/m_modulos.asp?mote_tdesc="&mote_tdesc&"&mote_ccod="&mote_ccod)
set pagina = new CPagina
pagina.Titulo = "Administrador de Salas de Clases"

set botonera =  new CFormulario
botonera.carga_parametros "m_salas_otec.xml", "botonera"
'response.End()
'---------------------------------------------------------------------------------------------------
...
'----------------------------------------------------------------------- 
 ...
 f_busqueda.Carga_Parametros "m_salas_otec.xml", "f_busqueda"
...
formulario_salas.carga_parametros "m_salas_otec.xml", "f_salas"
formulario_salas.inicializar conexion


consulta =" select sala_ccod,sala_tdesc, sala_ncupo, tsal_tdesc,sala_ciso " & vbCrlf & _
		  " from salas a, tipos_sala b " & vbCrlf & _
		  " where a.tsal_ccod=b.tsal_ccod " & vbCrlf & _
                ...
                <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
                    <td align="center"><table width="60%" border="0">
										<tr valign="top">
										    <td width="50%" align="right"><%if formulario_salas.nroFilas > 0  then 
																			botonera.dibujaBoton "eliminar"
																		 end if%>
											</td>
											<td width="50%" align="right"><%if sede_ccod<>"" then 
																			botonera.dibujaBoton "agregar_sala"
																		 end if%>
											</td>
										</tr>											
					                   </table></td>
