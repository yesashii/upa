...
if dcur_ncorr <> "" then 
consulta= "SELECT dcur_ncorr, dcur_tdesc, tdcu_ccod,dcur_nsence,dcur_nombre_sence " & vbCrlf & _
	...
	<%end if%>
                    ...
                    <table width="98%" align="center">
                      <tr> 
                        ...
                        <td width="88%">:<%=formulario.dibujaCampo("dcur_tdesc")%><input type="hidden" name="modifica" value="<%=codigo%>"></td>
                      </tr>
					  <tr> 
                        <td width="12%"><strong>Cód. Sence</strong></td>
                        <td width="88%">:<%=formulario.dibujaCampo("dcur_nsence")%><%=formulario.dibujaCampo("dcur_ncorr")%></td>
                      </tr>
                      <tr bgcolor="#FFFFCC"> 
                        <td width="12%"><strong>Nombre Sence</strong></td>
                        <td width="88%">:<%=formulario.dibujaCampo("dcur_nombre_sence")%></td>
                      </tr>
					  <tr> 
