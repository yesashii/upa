...
consulta= " select a.dgso_ncorr,a.dcur_ncorr,a.sede_ccod,protic.trunc(dgso_finicio) as dgso_finicio,protic.trunc(dgso_ftermino) as dgso_ftermino,dgso_ncupo,dgso_nquorum,ofot_nmatricula,ofot_narancel, anio_admision " & vbCrlf & _
									   ...
									   <td align="center">
									     <table width="100%">
											   <tr>
												   ...
												   <td width="2%">:</td>
												   <td width="38%"><strong><%datos_generales.dibujaCampo("dgso_finicio")%></strong></td>
												   <td width="10%" align="right">Fecha Término</td>
												   <td width="2%">:</td>
												   <td width="38%"><strong><%datos_generales.dibujaCampo("dgso_ftermino")%></strong></td>
											   </tr>
											   <tr>
												   <td width="10%">Cupo Máximo</td>
												   <td width="2%">:</td>
												   <td width="38%"><strong><%datos_generales.dibujaCampo("dgso_ncupo")%></strong></td>
												   <td width="10%" align="right">Quorum</td>
												   <td width="2%">:</td>
												   <td width="38%"><strong><%datos_generales.dibujaCampo("dgso_nquorum")%></strong></td>
											   </tr>
											   <tr>
												   <td width="10%">Valor Matrícula</td>
												   <td width="2%">:</td>
												   <td width="38%"><strong><%datos_generales.dibujaCampo("ofot_nmatricula")%></strong> (*$)</td>
												   <td width="10%" align="right">Valor Arancel</td>
												   <td width="2%">:</td>
												   <td width="38%"><strong><%datos_generales.dibujaCampo("ofot_narancel")%></strong> ($)</td>
											   </tr>
											   <tr>
												   <td width="10%">Año Admisión</td>
												   <td width="2%">:</td>
												   <td width="38%"><strong><%datos_generales.dibujaCampo("anio_admision")%></strong> (Ej:2008)</td>
												   <td width="10%" align="right">&nbsp;</td>
												   <td width="2%">&nbsp;</td>
												   <td width="38%"><strong>&nbsp;</td>
											   </tr>
