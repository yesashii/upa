              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <input type="hidden"  name="d[0]dcur_ncorr" value="<%=f_dcur_ncorr%>">
				  	<table width="95%">
						<tr>
						  <td align="center"><strong><font size="3"><%=dcur_tdesc%></font></strong></td>
						</tr>
						<tr>
						  <td>
						  	<table align="">
								...
								<tr>
								  <td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
								  <td>Completa&nbsp;&nbsp;:</td>
								  <td ><img src="../gestion_encuesta/imagenes/accept.png"/></td>
								</tr>
								<tr>
								  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
								  <td>Incompleta:</td>
								  <td><img src="../gestion_encuesta/imagenes/cancel.png"/></td>
								</tr>
							</table>
						  </td>
						</tr>		
						  ...
						  <td width="62%" align="center">
						  		<table width="80%" border="1">
									<tr borderColor="#999999"> 
									  <td width="40%" bgColor="#c4d7ff"><div align="center"><strong>Nombre Alumno </strong></div></td>
									  <td width="11%" height="17" bgColor="#c4d7ff"><div align="center"><strong>Encuesta Relator</strong></div></td>
									  <td width="11%" height="17" bgColor="#c4d7ff"><div align="center"><strong>Encuesta Programa</strong></div></td>
									  <td width="11%" height="17" bgColor="#c4d7ff"><div align="center"><strong>Estado Post.</strong></div></td>
									</tr>
									<%  while f_busqueda.Siguiente 
								  'response.Write("<br>"&v_deuda)
								  cantidad_programas=f_busqueda.ObtenerValor("r_programa") 
								  cantidad_relatores=f_busqueda.ObtenerValor("relatores_pendientes")
								  
								  if cdbl(cantidad_relatores)>0 then
									img_completa="cancel.png"
								  else
									 img_completa="accept.png" 
								  end if
								  
								  if cdbl(cantidad_programas)=0 then
									img_completa2="cancel.png"
								  else
									img_completa2="accept.png"
								  end if
								  %>
								  <tr borderColor="#999999"> 
									 <td bgcolor="#FFECC6"><div align="center"><%=f_busqueda.Obtenervalor("nombre")%></div></td>
									 <td bgcolor="#FFECC6"><div align="center"><img src="../gestion_encuesta/imagenes/<%=img_completa%>"/></div></td>
									 <td bgcolor="#FFECC6"><div align="center"><img src="../gestion_encuesta/imagenes/<%=img_completa2%>"/></div></td>
									 <td bgcolor="#FFECC6"><div align="center"><%=f_busqueda.Obtenervalor("epot_tdesc")%></div></td>
								  </tr>
								   <%  wend %>
								 </table>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="125" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center"><%botonera.DibujaBoton"excel_estado"%></td>
