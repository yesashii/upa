...
"datepart(yyyy,cdot_finicio)anio_contrato,ccos_tcompuesto,dcur_tdesc,tcdo_tdesc,(select sede_tdesc from sedes yy where yy.sede_ccod=b.sede_ccod)as sede"& vbCrLf &_
