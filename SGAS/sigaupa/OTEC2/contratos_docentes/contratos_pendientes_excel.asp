...
sql= "select rut,pers_tape_paterno,pers_tape_materno,pers_tnombre,mote_tdesc,dcur_tdesc"& vbCrLf &_
...
<table width="100%" border="1">
  ...
  <tr>
    ...
    <td width="38%"><div align="center"><strong>Programa</strong></div></td>
