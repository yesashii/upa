...
'						
'						
													existe_pago_relatores=conexion.ConsultaUno("select count(monto_asignado) from pago_relatores_otec where seot_ncorr="&seot_ncorr&" and pers_ncorr="&v_persona&"")
													
													'response.write("<br>aaaa= "&aaaa)
...
'													
															...
															response.write("<br>existe_pago_relatores >0 <br>")
																...
																monto2=CDbl(tcat_valor)*(CDbl(horas_programa)
...
'																
																...
																monto3=CDbl(tcat_valor)*(CDbl(horas_programa)
