...
<table>
<tr>
	<td width="97"><strong>N° Factura</strong></td>
	<td width="60">

<input type="text" name="fact_n" value="<%=v_fact_nfactura%>" size="7" maxlength="6" readonly="">
<input type="hidden" name="tfac_ccod" value="<%=v_tipo_fact%>"></td>
	<td width="23">&nbsp;&nbsp;&nbsp;</td>
	<td width="80"><strong>Tipo Factura</strong></td>
	<td width="18"><font color="#0066FF" size="2"><b><%=tipo_factura%></b></font></td>
</tr>
<tr>
...
<tr>
<td colspan="5"><font color="#FF0000" size="1"><%=msg_alerta%></font></td>
</tr>
<tr>
