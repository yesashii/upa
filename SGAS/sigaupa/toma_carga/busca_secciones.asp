...
if asig_ccod<>"" then
asig_disponibles="select distinct c.asig_ccod,mall_ccod,cast(c.asig_ccod as varchar) + ' - ' + c.asig_tdesc as asignatura, asig_nhoras, b.secc_ccod, '" & matr_ncorr & "' as matr_ncorr " & _
"	  , a.nive_ccod, isnull(d.reprobado,0) as reprobado from (SELECT DISTINCT b.asig_ccod,b.mall_ccod, b.nive_ccod " & vbCrlf & _
...
"                     AND cast(s2b.pers_ncorr as varchar)= '" & pers_ncorr & "')" & vbCrlf & _
"        ) " & vbCrlf & _
...
"	   AND cast(c.pers_ncorr as varchar)= '" & pers_ncorr & "' union select null,null,null)  b, " & vbCrlf & _
...
"        and sitf_baprueba='N' union select null,null) d" & vbCrlf & _
"  where a.asig_ccod *= b.asig_ccod  " & vbCrlf & _
"    and a.asig_ccod *= d.asig_ccod  " & vbCrlf & _
"    and a.asig_ccod=c.asig_ccod " & vbCrLf & _
"    and b.secc_ccod is null "

destino=" select asig_ccod,secc_ccod,horario " & _
		" 		  from " & _
		"              (SELECT a.asig_ccod, a.secc_tdesc, a.secc_ccod, " & _
		...
		"               AND cast(a.sede_ccod as varchar) = '"&sede_ccod&"' " & _
		"               AND cast(a.peri_ccod  as varchar) = '"&peri_ccod&"' " & _
		"               and cast(asig_ccod as varchar) ='"&asig_ccod&"' " & _
