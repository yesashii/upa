...
'--------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "encuesta_egresados.xml", "busqueda_usuarios"
...
if rut <> "" then
	...
	consulta_carreras= " ( select distinct ltrim(rtrim(d.carr_ccod)) as carr_ccod, d.carr_tdesc from alumnos a, ofertas_academicas b, especialidades c, carreras d "&_
                   " where a.ofer_ncorr = b.ofer_ncorr and b.espe_ccod = c.espe_ccod and c.carr_ccod = d.carr_ccod"&_
				   " and cast(a.pers_ncorr as varchar)='"&pers_ncorr&"')a"

'response.Write("pers_ncorr "&pers_ncorr)
else
	consulta_carreras= " ( select carr_ccod, carr_tdesc from carreras where 1 = 2)a"

end if

f_busqueda.agregaCampoParam "carr_ccod","destino",consulta_carreras

cantidad_carreras = conexion.consultaUno("select count(*) from "&consulta_carreras&"")
...
f_botonera.Carga_Parametros "encuesta_egresados.xml", "botonera"

devuelto = request.QueryString("devuelto")

contestada = conexion.consultaUno("select count(*) from encuestas_egresados where cast(pers_ncorr as varchar)='"&pers_ncorr&"' and isnull(antiguos,'N')='N'")
...
cantidad_matriculas = conexion.consultaUno("select count(*) from alumnos a, ofertas_academicas b, especialidades c where cast(a.pers_ncorr as varchar)='"&pers_ncorr&"' and a.ofer_ncorr=b.ofer_ncorr and b.espe_ccod=c.espe_ccod  and emat_ccod in (1,2,4,8)")
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <td><%if rute = "" then %>
				...
				%>
				<div align="center"><br><font size="+1" face="Times New Roman, Times, serif">Lo sentimos pero no hemos encontrado ninguna matricula de usted para nuestra casa de estudios. Sólo alumnos de de la Universidad pueden contestar la encuesta.</font><br>
                </div><br>
				<%else%>
                  ...
                  <tr>
                    <td>
					   <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td><div align="justify">Esta encuesta está diseñada para optimizar los mecanismos de autoevaluación de las instituciones de educación superior chilenas. Su aporte, al responder este cuestionario, será muy valioso para la Universidad del Pacífico. La encuesta sólo será utilizada con fines de diagnóstico de la institución, como parte del proceso de autoevaluación en la que se encuentra.</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						<tr>
                          <td><div align="justify">Como egresado, se le solicita que evalúe distintos aspectos de la carrera y de la Universidad del Pacífico en la que usted estudió.</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">3. Indique la carrera que estudió en la Universidad del Pacífico :</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">4. Condición de egreso (marque la o las etapas de egreso cumplidas).</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">5. Período en el que estudió la carrera:</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">6. Actualmente, ¿está usted trabajando? (considere por trabajo cualquier actividad remunerada de por lo menos media jornada de dedicación).</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">7. Desde que comenzó a buscar trabajo, luego de egresar, ¿cuánto tiempo se demoró en encontrar su primer trabajo?.</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">8. Si está trabajando actualmente, señale la renta promedio (líquida) mensual que está obteniendo, de acuerdo a los rangos indicados:</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">9. Si está trabajando actualmente, escriba el nombre de la organización (empresa, institución, etc).</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">10. Tamaño de la organización en que trabaja:</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">11. Indique la principal característica del giro de la empresa (sector productivo al que pertenece u otra característica básica que defina el tipo de actividad de la organización).</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">12. el rol por usted cumplido en la organización donde trabaja es de:</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">13. Indique su cargo en la empresa.</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">3. "Los egresados de la carrera de la Universidad del Pacífico donde estudié, tenemos un perfil identificable".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">5. "El número de alumnos de la carrera, era adecuado para los recursos disponibles y el número de académicos".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left"><font size="2"><strong>Dimensión 3: RECURSOS HUMANOS: PERSONAL ACADÉMICO Y ADMINISTRATIVO.</strong></font></div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">14. "Existía una atmósfera de confianza entre alumnos, la escuela y los docentes, que permitía un ambiente de desarrollo intelectual en el ámbito de la carrera".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">15. "Los docentes con los que contó mi carrera, eran adecuados para entregar una buena formación".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">16. "La cantidad de docentes asignados a mi carrera, era la adecuada para la cantidad de alumnos que éramos en mi curso".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">17. "Los profesores estaban al día en el conocimiento teórico y práctico de la disciplina, y eso era evidente en sus clases".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">18. "El personal administrativo de la carrera y la institución (secretarias, departamento de computación, biblioteca, etc.), entregaban los servicios adecuados para un funcionamiento eficiente".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">19. "La cantidad de personal administrativo era la adecuada".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left"><font size="2"><strong>Dimensión 4: FUNCIONES INSTITUCIONALES: PROGRAMAS EDUCACIONALES.</strong></font></div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">20. "Si uno reprobaba un ramo, no había que esperar un año entero para poder cursarlo de nuevo, pues los cursos se impartían todos los semestres". (Pregunta válida sólo para casos de ramos semestrales; si no corresponde, omita la repuesta).</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">21. "Los contenidos de las asignaturas no se repetían en dos o más ramos de manera innecesaria".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">22. "La gran mayoría de los contenidos de las materias fueron útiles y/o relevantes para mi formación o para mi desempeño como profesional".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">23. "Las actividades de las asignaturas me permitieron conciliar el conocimiento teórico y práctico".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">24. "La carrera entrega una formación que permite afrontar el proceso de obtención del grado académico y del título profesional sin inconvenientes".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                           <td><div align="center">
						       <table width="98%" border="1" bordercolor="#333333">
								 ...
								 <tr>
								 	 <td width="65%"><div align="justify">25- <strong>Comunicación</strong>: Capacidad para comunicarse de manera efectiva a través del lenguaje oral y escrito, y del lenguaje técnico y computacional necesario para el ejercicio de la profesión.</div></td>
								 ...
								 <tr>
								 	 <td width="65%"><div align="justify">26- <strong>Pensamiento crítico</strong>: Capacidad para utilizar el conocimiento, la experiencia y el razonamiento para emitir juicios fundados.</div></td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">1</td></tr>
								  ...
								  <tr>
								 	 <td width="65%"><div align="justify">27- <strong>Solución de problemas</strong>: Capacidad para identificar problemas, planificar estrategias y enfrentarlos.</div></td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">1</td></tr>
								 ...
								 <tr>
								 	 <td width="65%"><div align="justify">28- <strong>Interacción social</strong>: Capacidad para formar parte de equipos de trabajo, y participar en proyectos grupales.</div></td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">1</td></tr>
								 ...
								 <tr>
								 	 <td width="65%"><div align="justify">29- <strong>Autoaprendizaje e iniciativa personal</strong>: Inquietud y búsqueda permanente de nuevos conocimientos y capacidad de aplicarlos y perfeccionar sus conocimientos anteriores.</div></td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">1</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_29]" value="1"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">2</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_29]" value="2"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">3</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_29]" value="3"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">4</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_29]" value="4"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">5</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_29]" value="5"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">6</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_29]" value="6"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">7</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_29]" value="7"></td></tr>
																		 </table></div>
									 </td>
								 </tr>
								 <tr>
								 	 <td width="65%"><div align="justify">30- <strong>Formación y consistencia ética</strong>: Capacidad para asumir principios éticos y respetar los principios del otro, como norma de convivencia social.</div></td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">1</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_30]" value="1"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">2</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_30]" value="2"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">3</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_30]" value="3"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">4</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_30]" value="4"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">5</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_30]" value="5"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">6</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_30]" value="6"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">7</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_30]" value="7"></td></tr>
																		 </table></div>
									 </td>
								 </tr>
								 <tr>
								 	 <td width="65%"><div align="justify">31- <strong>Pensamiento Globalizado</strong>: Capacidad para comprender los aspectos interdependientes del mundo globalizado.</div></td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">1</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_31]" value="1"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">2</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_31]" value="2"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">3</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_31]" value="3"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">4</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_31]" value="4"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">5</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_31]" value="5"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">6</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_31]" value="6"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">7</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_31]" value="7"></td></tr>
																		 </table></div>
									 </td>
								 </tr>
								 <tr>
								 	 <td width="65%"><div align="justify">32- <strong>Formación Ciudadana</strong>: Capacidad para integrarse a la comunidad y participar responsablemente en la vida ciudadana.</div></td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">1</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_32]" value="1"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">2</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_32]" value="2"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">3</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_32]" value="3"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">4</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_32]" value="4"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">5</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_32]" value="5"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">6</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_32]" value="6"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">7</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_32]" value="7"></td></tr>
																		 </table></div>
									 </td>
								 </tr>
								 <tr>
								 	 <td width="65%"><div align="justify">33- <strong>Sensibilidad estética</strong>: Capacidad de apreciar y valorar diversas formas artísticas y los contextos de donde provienen.</div></td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">1</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_33]" value="1"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">2</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_33]" value="2"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">3</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_33]" value="3"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">4</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_33]" value="4"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">5</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_33]" value="5"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">6</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_33]" value="6"></td></tr>
																		 </table></div>
									 </td>
									 <td width="5%"><div align="center"><table width="100%">
									                                       <tr><td align="center">7</td></tr>
																		   <tr><td align="center"><input type="radio" name="e[0][preg_33]" value="7"></td></tr>
																		 </table></div>
									 </td>
								 </tr>
							   </table>
						...
						<tr>
                          <td><div align="left"><font size="2"><strong>Dimensión 6: FUNCIONES INSTITUCIONALES: PROGRAMAS EDUCACIONALES.</strong></font></div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						<tr>
                          <td><div align="left">34. "Los criterios de admisión de alumnos para la carrera que estudié, eran claros".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">41. "La formación que recibí fue suficiente para desempeñar satisfactoriamente mi práctica profesional y para enfrentarme al mundo laboral".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">42. "La carrera donde estudié fomenta y facilita la participación de egresados en seminarios y/o charlas sobre la disciplina".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">43. "El plan de estudios contemplaba actividades de vinculación de los estudiantes con el medio profesional".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left"><font size="2"><strong>Dimensión 7: DESARROLLO INSTITUCIONAL.</strong></font></div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						<tr>
                          <td><div align="left">44. "La Universidad del Pacífico actualmente ofrece programas y mecanismos para el perfeccionamiento y/o actualización de los egresados".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">45. "Existe un proceso eficiente de seguimiento de los egresados".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">46. "La Universidad del Pacífico donde estudié, dispone de una buena política de colocación laboral".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">47. "En el mercado existe interés por contratar a los egresados de la carrera de la Universidad del Pacífico".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left"><font size="2"><strong>Dimensión 8: INFRAESTRUCTURA, APOYO TÉCNICO Y RECURSOS ACADÉMICOS.</strong></font></div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						<tr>
                          <td><div align="left">48. "Las salas de clases tenían instalaciones adecuadas a los requerimientos académicos y a la cantidad de alumnos".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">49. "Siempre encontraba los libros u otros materiales que necesitaba en la biblioteca".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">50. "El servicio de bibliotecas y salas de lectura era adecuado en términos de calidad de atención y extensión de horarios de uso".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">51. "Los medios audiovisuales de apoyo a la carrera eran suficientes".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">52. "Los laboratorios y/o talleres estaban correctamente implementados".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">53. "Los equipos computacionales eran suficientes para nuestras necesidades".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">54. "La institución se preocupaba permanentemente de mejorar la calidad de la infraestructura".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">55. La calidad de baños, áreas de esparcimiento y seguridad de las instalaciones, era la adecuada".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">56. "La carrera donde estudié siempre facilitó los medios necesarios para realizar actividades de apoyo a mi formación (festivales, concursos y seminarios de la disciplina)".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left"><font size="2"><strong>Dimensión 9: SATISFACCIÓN GENERAL.</strong></font></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						<tr>
                          <td><div align="left">57. "Si tuviera la oportunidad de elegir otra vez dónde estudiar la carrera, nuevamente optaría por la Universidad del Pacífico ".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">59. "Al egresar de la carrera, fui contratado(a) de acuerdo a mis expectativas profesionales y de renta".</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">2. ¿Qué sugerencias le haría a las autoridades de la carrera para mejorar la calidad de la formación?</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
						...
						<tr>
                          <td><div align="left">3. Señale a continuación, sugerencias o comentarios referidos a las fortalezas y/o debilidades de la carrera o institución, que le gustaría destacar:</div></td>
                        </tr>
						<tr>
                          <td><div align="center">&nbsp;</div></td>
                        </tr>
          ...
          <tr>
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center"><% if rute <> "" and contestada = "0" and cantidad_matriculas<> "0" and cantidad_carreras <> "0"  then
