...
metodologicos_x_c = conectar.consultaUno("select sum(metodologicos) from secciones a, evaluacion_docente b where cast(a.carr_ccod as varchar)= '"&carr_ccod&"' and  cast(a.peri_ccod as varchar)= '"&peri_ccod&"' and a.secc_ccod=b.secc_ccod")
interaccion_x_c = conectar.consultaUno("select sum(interaccion) from secciones a, evaluacion_docente b where cast(a.carr_ccod as varchar)= '"&carr_ccod&"' and  cast(a.peri_ccod as varchar)= '"&peri_ccod&"' and a.secc_ccod=b.secc_ccod")
administrativos_x_c = conectar.consultaUno("select sum(administrativos) from secciones a, evaluacion_docente b where cast(a.carr_ccod as varchar)= '"&carr_ccod&"' and  cast(a.peri_ccod as varchar)= '"&peri_ccod&"' and a.secc_ccod=b.secc_ccod")
...
metodologicos_x_f = conectar.consultaUno("select sum(metodologicos) from secciones a,evaluacion_docente b where carr_ccod in (select carr_ccod from carreras aa, areas_academicas ba where aa.area_ccod=ba.area_ccod and cast(ba.facu_ccod as varchar)='"&facu_ccod&"') and cast(a.peri_ccod as varchar)='"&peri_ccod&"' and a.secc_ccod=b.secc_ccod")
interaccion_x_f = conectar.consultaUno("select sum(interaccion) from secciones a,evaluacion_docente b where carr_ccod in (select carr_ccod from carreras aa, areas_academicas ba where aa.area_ccod=ba.area_ccod and cast(ba.facu_ccod as varchar)='"&facu_ccod&"') and cast(a.peri_ccod as varchar)='"&peri_ccod&"' and a.secc_ccod=b.secc_ccod")
administrativos_x_f = conectar.consultaUno("select sum(administrativos) from secciones a,evaluacion_docente b where carr_ccod in (select carr_ccod from carreras aa, areas_academicas ba where aa.area_ccod=ba.area_ccod and cast(ba.facu_ccod as varchar)='"&facu_ccod&"') and cast(a.peri_ccod as varchar)='"&peri_ccod&"' and a.secc_ccod=b.secc_ccod")
...
metodologicos_x_u = conectar.consultaUno("select sum(metodologicos) from evaluacion_docente where cast(peri_ccod as varchar)='"&peri_ccod&"'")
interaccion_x_u = conectar.consultaUno("select sum(interaccion) from evaluacion_docente where cast(peri_ccod as varchar)='"&peri_ccod&"'")
administrativos_x_u = conectar.consultaUno("select sum(administrativos) from evaluacion_docente where cast(peri_ccod as varchar)='"&peri_ccod&"'")
                  ...
                  <td bgcolor="#D8D8DE">			        <div align="center">
                   ...
                   <table width="100%" border="0">
                       ...
                       <%if cantid_criterios >"0" then
							...
							<tr>
								<td colspan="13" align="center"><img border="0" src="grafico_barras.asp?pers_ncorr=<%=pers_ncorr%>&secc_ccod=<%=secc_ccod%>" ></td>
							</tr>
					  </table> 
