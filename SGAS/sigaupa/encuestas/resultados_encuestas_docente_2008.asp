...
pagina.Titulo = "Resultados Evaluación docente<br>2do Sem. 2008 hasta 2do Sem. 2014"
'---------------------------------------------------------------------------------------------------
...
'response.Write("Select anos_ccod from periodos_academicos where cast(peri_ccod as varchar)='"&periodo&"'")
...
c_tiene_carga = " Select case count(*) when 0 then 'N' else 'S' end  from secciones a, periodos_academicos b, bloques_horarios c, bloques_profesores d"&_
				...
				" and exists (select 1 from cuestionario_opinion_alumnos aa where aa.secc_ccod=a.secc_ccod and aa.pers_ncorr_profesor=d.pers_ncorr)"
...
if es_administrativo = "S" or tiene_carga = "N" then 
 ...
 f_busqueda.Carga_Parametros "resultados_encuestas_docente_2008.xml", "busqueda_usuarios"
 f_busqueda.Inicializar conexion
 f_busqueda.Consultar "select '' "
 f_busqueda.Siguiente
 f_busqueda.AgregaCampoCons "pers_nrut", rut
 f_busqueda.AgregaCampoCons "pers_xdv", digito
 filtro_especialidad = " and f.carr_ccod in (Select distinct tt2.carr_ccod from sis_especialidades_usuario ttt, especialidades tt2 where pers_ncorr='"&pers_ncorr_encargado&"' and ttt.espe_ccod=tt2.espe_ccod)"
else
 rut = usuario
...
botonera.Carga_Parametros "resultados_encuestas_docente_2008.xml", "botonera"
'--------------------------------------------------------------------------
...
carga.Carga_Parametros "resultados_encuestas_docente_2008.xml", "formu_carga"
...
consulta_acceso =  " select pers_ncorr,secc_ccod,sede,carrera,jornada,asignatura,seccion,periodo, "& vbCrLf &_
				   " case evaluado2 when 0 then 'No' else 'Sí por ' +cast((evaluado2)as varchar) + ' de ' + cast(total_alumnos as varchar) + ' alumno(s)' end as evaluado, "& vbCrLf &_
				   ...
				   " 		sedes e,carreras f,jornadas g,asignaturas h "& vbCrLf &_
				   ...
				   " 		" & filtro_especialidad & vbCrLf &_
				   " 		and a.jorn_ccod=g.jorn_ccod --and b.plec_ccod <> 1"& vbCrLf &_
                      ...
                      <td bgcolor="#D8D8DE"><div align="center"> 
                          <form name="buscador">
                            <table width="98%"  border="0">
							  ...
							  <tr>
								<td align="center"><h3>RESULTADOS EVALUACIÓN DOCENTE<br>
2DO SEM. 2008 HASTA 2DO SEM. 2014</h3></td>
								</tr>
                            </table>
                          </form>
                        </div></td>
