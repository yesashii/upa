...
'response.Write("encu_ncorr "&encu_ncorr&" peri_ccod "&peri_ccod)
...
puntaje_metodologicos = conectar.consultaUno("select cast(avg(metodologicos) as decimal(6,2)) from evaluacion_docente bb where cast(bb.secc_ccod as varchar)='"&secc_ccod&"' and cast(bb.pers_ncorr_destino as varchar)= '"&pers_ncorr_profesor&"'")
puntaje_interaccion = conectar.consultaUno("select cast(avg(interaccion) as decimal(6,2)) from evaluacion_docente bb where cast(bb.secc_ccod as varchar)='"&secc_ccod&"' and cast(bb.pers_ncorr_destino as varchar)= '"&pers_ncorr_profesor&"'")
puntaje_administrativos = conectar.consultaUno("select cast(avg(administrativos) as decimal(6,2)) from evaluacion_docente bb where cast(bb.secc_ccod as varchar)='"&secc_ccod&"' and cast(bb.pers_ncorr_destino as varchar)= '"&pers_ncorr_profesor&"'")
...
function volver()
{
   location.href ="analisis_resultados_encuestas.asp?busqueda[0][sede_ccod]="+<%=sede%>+"&busqueda[0][carr_ccod]="+<%=carr%>+"&busqueda[0][jorn_ccod]="+<%=jorn%>+"&busqueda[0][todas]=S";
}
  ...
  <tr>
	...
	<form name="edicion">
		<% 'response.Write("Select Count(*) from resultados_encuestas where cast(pers_ncorr_encuestado as varchar)='"&pers_ncorr&"' and cast(secc_ccod as varchar)='"&secc_ccod&"' and cast(pers_ncorr_destino as varchar)='"&pers_ncorr_profesor&"'")
		  if secc_ccod <> "" then
		  	contestada = conectar.consultaUno("Select Count(*) from evaluacion_docente where cast(secc_ccod as varchar)='"&secc_ccod&"' and cast(pers_ncorr_destino as varchar)='"&pers_ncorr_profesor&"'")
		  else
		  	contestada = conectar.consultaUno("Select Count(*) from evaluacion_docente where cast(pers_ncorr_destino as varchar)='"&pers_ncorr_profesor&"'")
		  end if 
		%>
											 ...
											 <td width="20"><center>
											   <%if contestada <> 0 then
														if secc_ccod <> "" then 
															...
															respuesta = conectar.consultaUno("Select count(distinct pers_ncorr_encuestado) from evaluacion_docente where cast(pers_ncorr_destino as varchar)='"&pers_ncorr_profesor&"' and cast(preg_"&contador&" as varchar)='"&escala.obtenervalor("resp_ncorr")&"'")  
														end if%>
											 ...
											 <td width="20"><center>
											   <%if contestada <> 0 then
												    if secc_ccod <> "" then 
														...
														respuesta = conectar.consultaUno("Select count(distinct pers_ncorr_encuestado) from evaluacion_docente where cast(pers_ncorr_destino as varchar)='"&pers_ncorr_profesor&"' and cast(preg_"&orden&"resp_ncorr as varchar)='"&escala.obtenervalor("resp_ncorr")&"'")  
													end if%>
							...
							<tr> 
							   ...
							   <td align="left" colspan="10"><strong><%  if cdbl(cantidad_encuestas) <= 0 then 
																		 ...
																		 if encu_ncorr <> 23 then
																			  ...
																			  response.Write(puntaje_metodologicos)
																		 end if   
							                                          %></strong></td>
							</tr>
							<tr>
							...
							<tr> 
							   ...
							   <td align="left" colspan="10"><strong><%if cdbl(cantidad_encuestas) <= 0 then 
																		 ...
																		 if encu_ncorr <> 23 then
																			  ...
																			  response.Write(puntaje_interaccion)
																			end if  
							                                           %></strong></td>
							</tr>
							<tr>
							...
							<tr> 
							   ...
							   <td align="left" colspan="10"><strong><%if cdbl(cantidad_encuestas) <= 0 then 
																		 ...
																		 if encu_ncorr <> 23 then
																			  ...
																			  response.Write(puntaje_administrativos)
																			end if  
							                                             %></strong></td>
							</tr>
							<tr>
							   ...
							   <td colspan="13" align="center">
							   		<table width="70%" border="1">
										...
										<tr>
											...
											<%if encu_ncorr=23 then
											     response.Write("1,2,3,4,5,8,9,12,13,14,15,16,17,20,21,24,28,29,30")
											  else
											  	 response.Write("1,2,3,4,5,8,9,12,13,14,15,16,17,20,21,24,28,29")
											  end if
											 %> </td>
											...
											<%'total_d_1 = cdbl(total_dimension_1) * 0.40 
										...
										<tr>
											...
											<%'total_d_2 = cdbl(total_dimension_2) * 0.40 
										...
										<tr>
											...
											<%'total_d_3 = cdbl(total_dimension_3) * 0.20 
											  total_d_3 = formatnumber(cdbl(total_dimension_3 * 1.00 ),2,-1,0,0)
										...
										<tr>
											...
											<%total_docente = cdbl(total_d_1) + cdbl(total_d_2) + cdbl(total_d_3) + cdbl(total_d_4) + cdbl(total_d_5)
											  if cdbl(cantidad_encuestas) <= 0 then 
											    ...
											    if encu_ncorr = 23 then 
											  		total_docente_promedio = cdbl(puntaje_total)'cdbl(total_docente)' / cdbl(cantidad_encuestas)
											    else
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="101" nowrap bgcolor="#D8D8DE"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="50%"><%  botonera.agregaBotonParam "Volver","url","analisis_resultados_encuestas.asp"
					                      botonera.dibujaBoton "Volver" %></td>
					  <td width="50%"><%  botonera.agregaBotonParam "excel_otec","url","observaciones_excel.asp?secc_ccod="&secc_ccod&"&pers_ncorr="&pers_ncorr_profesor
