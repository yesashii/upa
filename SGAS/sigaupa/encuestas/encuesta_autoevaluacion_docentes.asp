...
consulta  = " select distinct a.asig_ccod,e.asig_tdesc,a.secc_ccod,d.pers_ncorr,a.secc_tdesc, " & vbCrLf &_
			...
			"		and a.asig_ccod=e.asig_ccod and cast(a.peri_ccod as varchar)='"&peri&"' "&filtro& vbCrLf &_
...
function enviar(formulario){
			...
			formulario.action ="encuesta_autoevaluacion_docentes.asp";
			formulario.submit();
}
</script>
<% f_busqueda.generaJS %>
                    ...
                    <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                      <tr> 
						...
						<td><div align="center"><%  if sede_ccod <> "" and carr_ccod <> "" and jorn_ccod <> "" then
														botonera.agregaBotonParam "observaciones_excel","url","encuesta_autoevaluacion_docentes_excel.asp?carr_ccod="&carr_ccod&"&sede_ccod="&sede_ccod&"&jorn_ccod="&jorn_ccod&"&todas="&todas
