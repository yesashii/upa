...
botonera.Carga_Parametros "analisis_resultados_encuestas_2014.xml", "botonera"
'-------------------------------------------------------------------------------
...
f_asignaturas.Carga_Parametros "analisis_resultados_encuestas_2014.xml", "formu_carga"
...
if jornadas = 1 then
 ...
 consulta = "    select asig_ccod,asig_tdesc,secc_ccod,pers_ncorr,secc_tdesc,docente,cantidad_alumnos, "& vbCrLf &_
			...
			"     and f.peri_ccod = "&periodo&" "& filtro_asignaturas & filtro_sede  & filtro_carrera & filtro_jornada &"  ) table1 "
...
Redim preserve arr_secc_ccod(i)
arr_secc_ccod(i) = f_asignaturas.obtenervalor("secc_ccod")
pers_ncorr = f_asignaturas.obtenervalor("pers_ncorr")
'response.Write("secc_ccod"&arr_secc_ccod(i)& " pers_ncorr: "&pers_ncorr)

i=i+1
wend
f_asignaturas.primero
cad_secc_ccod = join(arr_secc_ccod,"-")
...
function enviar(formulario){
			...
			//document.buscador.elements("pdf").value=1;

			//todas_sedes = toString(document.buscador.elements("todas_sede").checked.value);
			//alert(todas_sedes);
			
			formulario.action ="analisis_resultados_encuestas_2014.asp";
//?matr_ncorr="+matricula+"&pers_ncorr="+pers+"&sede_ccod="+sede+"&plan_ccod="+plan+"&peri_ccod="+periodo+"&asig_ccod="+asignatura;
			valida_check();
			formulario.submit();
}
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetasFClaro Array(Array("Alumnos", url_leng_1),Array("Director", url_leng_2), Array("Autoevaluación", url_leng_3)), 1 %></td>
          </tr>
          <tr>
