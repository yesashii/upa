...
datos_extras.carga_parametros "encuesta_disenio.xml","datos_adicionales_profesionales"
datos_extras.inicializar conectar
if codigo = "" then
Query_datos = " select '' as nombre_profesional,'' as apellidos_profesional, '' as empresa_profesional, "&_
			  " '' as profesion, 0 as espacios_escenograficos,0 as espacios_equipamiento,0 as espacios_efimeras, 0 as espacios_sustentable, 0 as espacios_comerciales, 0 as espacios_exposiciones, 0 as espacios_intervenciones, '' as espacios_otros "
else
Query_datos = " select isnull(nombre_profesional,'') as nombre_profesional,isnull(apellidos_profesional,'') as apellidos_profesional, isnull(empresa_profesional,'') as empresa_profesional, "&_
			  " isnull(profesion,'') as profesion, isnull(espacios_escenograficos,0) as espacios_escenograficos,isnull(espacios_equipamiento,0) as espacios_equipamiento,isnull(espacios_efimeras,0) as espacios_efimeras, isnull(espacios_sustentable,0) as espacios_sustentable, isnull(espacios_comerciales,0) as espacios_comerciales, isnull(espacios_exposiciones,0) as espacios_exposiciones, isnull(espacios_intervenciones,0) as espacios_intervenciones, isnull(espacios_otros,'') as espacios_otros "&_
			  " from encuestas_disenio where cast(edis_ncorr as varchar)='"&codigo&"'"
end if
...
{ var cantidad;
  ...
  { 
     ...
     { document.edicion.method = "POST";
	   document.edicion.action = "encuesta_disenio_profesionales_proc.asp";
  ...
  <tr>
	...
	<form name="edicion">
		<% 'response.Write("Select Count(*) from resultados_encuestas where cast(pers_ncorr_encuestado as varchar)='"&pers_ncorr&"' and cast(secc_ccod as varchar)='"&secc_ccod&"' and cast(pers_ncorr_destino as varchar)='"&pers_ncorr_profesor&"'")
		  contestada = conectar.consultaUno("select count(*) from encuestas_disenio where cast(edis_ncorr as varchar)='"&codigo&"'")
		  
		%>
	<input name="p[0][encu_ncorr]" type="hidden" value="<%=encu_ncorr%>">
	<input name="p[0][pers_ncorr_encuestado]" type="hidden" value="<%=pers_ncorr%>">
	<input name="p[0][tipo]" type="hidden" value="PROFESIONAL">
                  ...
                  <td bgcolor="#D8D8DE">
				     ...
				     <div align="center">
                      ...
                      <table width="100%"  border="0" align="center">
						...
						<tr>
							...
							<table width="100%" border="0">
								  <tr> 
									...
									<td align="left"><font color="#CC0000">&nbsp;<%datos_extras.dibujaCampo("nombre_profesional")%></font></td>
    							  </tr>
								  <tr> 
									<td width="18%" align="left"><strong>Apellidos</strong> </td>
									<td width="1%"><strong>:</strong></td>
									<td align="left"><font color="#CC0000">&nbsp;<%datos_extras.dibujaCampo("apellidos_profesional")%></font></td>
    							  </tr>
  								  <tr> 
								  ...
								  <tr> 
									<td width="18%" align="left"><strong>Empresa / Organización</strong> </td>
									<td width="1%"><strong>:</strong></td>
									<td align="left"><font color="#CC0000">&nbsp;<%datos_extras.dibujaCampo("empresa_profesional")%></font></td>
    							  </tr> 
								  <%if codigo <> "" then%>
								  <tr>
								  ...
								  <tr>
								  	<td colspan="3" bgcolor="#993333" align="center"><font color="#FFFFFF" size="2">La Encuesta fue grabada correctamente en el sistema, muchas gracias por su colaboración.</font></td>
								  </tr>
								  <%end if%>
						    </table>
							</td>
						...
						<tr> 
                          <td colspan="3"><strong>INSTRUCCIONES : </strong>Estimado Profesional:</td>
						</tr>
						<tr>  
                   ...
                   <table width="100%" border="0">
                       ...
                       <%if cantid_criterios >"0" then
											 ...
											 <td width="20"><center>
											   <%if contestada <> 0 then
											     'response.Write("Select preg_"&contador2&"_"&contador&" from encuestas_disenio where cast(pers_ncorr_encuestado as varchar)='"&pers_ncorr&"'")
												  respuesta = conectar.consultaUno("Select preg_"&contador2&"_"&contador&" from encuestas_disenio where cast(edis_ncorr as varchar)='"&codigo&"'")  
                           ...
                           <td colspan="5"><div align="center">
						                                <%respuesta = conectar.consultaUno("Select consideraciones from encuestas_disenio where cast(edis_ncorr as varchar)='"&codigo&"'")%>
						  ...
						  <tr>
						   ...
						   <tr>
                           <td colspan="5"><div align="center">
						                                <%respuesta = conectar.consultaUno("Select materias_complementarias from encuestas_disenio where cast(edis_ncorr as varchar)='"&codigo&"'")%>
