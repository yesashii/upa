...
function Volver()
{
   ...
   if (origen != '2')
   	    ...
   	    {location.href ="ANALISIS_RESULTADOS_ENCUESTAS_2014.ASP?busqueda[0][SEDE_CCOD]="+<%=sede%>+"&busqueda[0][JORN_CCOD]="+<%=jorn%>+"&busqueda[0][CARR_CCOD]="+'<%=carr_ccod%>';}		
}

function pdf(){
//alert("pdf");
window.open("pdfEncuesta.asp?cad_secc_ccod=<%=secc_ccod%>&pers_ncorr=<%=pers_ncorr%>&peri_ccod=<%=peri_ccod%>&carr_ccod=<%=carr_ccod%>","_blank"," width=750, height=570,scrollbars,  toolbar=false, resizable");
}
</script>
                ...
                <tr>
                  ...
                  <td width="101" nowrap bgcolor="#D8D8DE"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="50%"><% botonera.dibujaBoton "pdf" %></td>
