...
pagina.Titulo = "Resultados encuesta Directores/docentes"
'-------------------------------------------------------------------------------
...
function enviar(formulario){
			...
			formulario.action ="encuesta_directores_docentes_2014.asp";
			valida_check();
			formulario.submit();
}
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetasFClaro Array(Array("Alumnos", url_leng_1),Array("Director", url_leng_2), Array("Autoevaluación", url_leng_3)), 2 %></td>
          </tr>
          <tr>
            ...
            <td width="12%" height="20"><div align="center">
                    <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                      <tr> 
						...
						<td><div align="center"><% botonera.agregaBotonParam "observaciones_excel","url","encuesta_directores_docentes_excel.asp?carr_ccod="&carr_ccod&"&sede_ccod="&sede_ccod&"&jorn_ccod="&jorn_ccod&"&todas="&todas
