...
pagina.Titulo = "Resultados encuesta Autoevaluación Docente"
'-------------------------------------------------------------------------------
...
botonera.Carga_Parametros "encuesta_directores_docentes.xml", "botonera"
'-------------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "encuesta_directores_docentes.xml", "busqueda"
...
f_asignaturas.Carga_Parametros "encuesta_directores_docentes.xml", "formu_carga"
...
if carreras = 1 then
	...
	filtro_carrera = " and a.carr_ccod='"&carr_ccod&"'"	
end if

if jornadas = 1 then
	filtro_jornada = ""
else
	filtro_jornada = " and cast(a.jorn_ccod as varchar)='"&jorn_ccod&"'"	
end if
   
consulta  = " select distinct a.asig_ccod,e.asig_tdesc,a.secc_ccod,d.pers_ncorr,a.secc_tdesc, " & vbCrLf &_
		    "  d.pers_tnombre + ' ' + d.pers_tape_paterno + ' ' + d.pers_tape_materno as docente, " & vbCrLf &_
			...
			"		where a.secc_ccod=b.secc_ccod and b.bloq_ccod=c.bloq_ccod and c.pers_ncorr=d.pers_ncorr " & vbCrLf &_ 
			"		and a.asig_ccod=e.asig_ccod and cast(a.peri_ccod as varchar)='"&peri&"' "&filtro& filtro_sede  & filtro_carrera & filtro_jornada & " order by docente "
...
function enviar(formulario){
			...
			formulario.action ="encuesta_autoevaluacion_docentes_2014.asp";
			valida_check();
			formulario.submit();
}
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetasFClaro Array(Array("Alumnos", url_leng_1),Array("Director", url_leng_2), Array("Autoevaluación", url_leng_3)), 3 %></td>
          </tr>
          <tr>
                      ...
                      <tr>
                        <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr> 
								...
								<td width="4%"><% f_busqueda.dibujaCampoLista "lBusqueda", "sede_ccod"%></td>
							  ...
							  <tr> 
								...
								<td width="2%"> <!--<div align="center">:</div> --> </td>
								<td colspan="3"><%'f_busqueda.dibujaCampo("todas")%></td>
                              </tr>
							  <tr> 
            ...
            <td width="12%" height="20"><div align="center">
                    <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                      <tr> 
						...
						<td><div align="center"><% botonera.agregaBotonParam "observaciones_excel","url","encuesta_autoevaluacion_docentes_excel.asp?carr_ccod="&carr_ccod&"&sede_ccod="&sede_ccod&"&jorn_ccod="&jorn_ccod&"&todas="&todas
