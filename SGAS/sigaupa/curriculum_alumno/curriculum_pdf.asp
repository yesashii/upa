...
'---------------------------------------------obtengo los datos del los programas
 ...
 f_programa.Inicializar conexion
					...
					s_progra="select (select soft_tdesc from software zz where zz.soft_ncorr=a.cdpa_tprograma)as cdpa_tprograma,nidi_tdesc from curriculum_dominio_programa_alumno a, NIVELES_IDIOMA b where a.nidi_ccod=b.nidi_ccod and pers_ncorr=protic.obtener_pers_ncorr("&q_pers_nrut&") "
