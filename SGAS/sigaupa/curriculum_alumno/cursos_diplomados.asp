...
f_busqueda.AgregaCampoCons "pers_xdv", q_pers_xdv
 ...
 f_muestra_seminario.Carga_Parametros "curriculum_alumno.xml", "seminario_curso_muestra_sga"
  ...
  <tr>
	...
	<table width="90%" height="0" border="0" align="center" cellpadding="0" cellspacing="0" >
				...
				<tr>
				 ...
				 <td height="2" background="../imagenes/izq.gif"></td>
				 <td bgcolor="#D8D8DE"><strong>CURSOS DIPLOMADOS </strong></td>
				 <td height="2" background="../imagenes/der.gif"></td>
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
		 <tr>
            <td><%pagina.DibujarLenguetas Array("Cursos Diplomados"), 1 %></td>
          </tr>          <tr>
            <td height="2" background="../imagenes/top_r3_c2.gif"></td>
          </tr>
		  <tr>
                  ...
                  <tr>
                    <td><%'pagina.DibujarSubtitulo "Detalles Taller"%>
                      <table width="98%"  border="0" align="center">
                        ...
                        <tr>						
                          <td align="center"><%f_muestra_seminario.DibujaTabla()%></td>
                        </tr>
                        </table>
