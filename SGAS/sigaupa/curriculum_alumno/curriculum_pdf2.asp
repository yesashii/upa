...
'  response.Write("<br/>"&aaaaa)
 ...
 f_habilidades.Inicializar conexion
					...
					s_habilidades="select chal_tarea_trabajo,chal_thabilidades_tecnica,chal_thabilidades_personales,chal_thabilidades_profesionales from curriculum_habilidades_alumno a where  pers_ncorr=protic.obtener_pers_ncorr("&q_pers_nrut&") "
...
pdf.ln(3)
pdf.SetFont "Arial","B",10
pdf.Cell 100,10,""&espacio&"PROFESIONALES","","0","D"
pdf.ln(6)
pdf.SetFont "Arial","",10
pdf.SetX(48)  
pdf.MultiCell 100,5,""&f_habilidades.ObtenerValor("chal_thabilidades_profesionales")&"","","0","D" 
pdf.ln(6)
pdf.SetFont "Arial","B",10
pdf.Cell 100,10,""&espacio&"TECNICAS","","0","D"
pdf.ln(6)
pdf.SetFont "Arial","",10
pdf.SetX(48)  
pdf.MultiCell 100,5,""&f_habilidades.ObtenerValor("chal_thabilidades_tecnica")&"","","0","D"  
pdf.ln(6)
pdf.SetFont "Arial","B",10
pdf.Cell 100,10,""&espacio&"PERSONALES","","0","D"
pdf.ln(6)
pdf.SetFont "Arial","",10
pdf.SetX(48)  
pdf.MultiCell 100,5,""&f_habilidades.ObtenerValor("chal_thabilidades_personales")&"","","0","D" 
pdf.ln(6)
pdf.SetFont "Arial","B",10
pdf.Cell 100,10,""&espacio&"AREAS DEDESARROLLO","","0","D"
pdf.ln(6)
pdf.SetX(48) 
pdf.SetFont "Arial","",10
pdf.MultiCell 100,5,""&f_habilidades.ObtenerValor("chal_tarea_trabajo")&"","","0","D"  
 pdf.ln(6)
