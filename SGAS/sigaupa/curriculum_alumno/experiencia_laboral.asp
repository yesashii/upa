...
f_busqueda.AgregaCampoCons "pers_xdv", q_pers_xdv
 ...
 f_muestra_trabajo.Carga_Parametros "curriculum_alumno.xml", "trabajo_muestra_sga"
 f_muestra_trabajo.Inicializar conexion

					
				 trabajomuestra=	"select  a.dlpr_ncorr,exal_ncorr ,dlpr_nombre_empresa,dlpr_rubro_empresa,dlpr_cargo_empresa,dlpr_web_empresa from direccion_laboral_profesionales a,experiencia_alumno b where a.dlpr_ncorr=b.dlpr_ncorr and tiea_ccod=1 and a.pers_ncorr="&pers_ncorr&" order  by exal_fini desc"
  ...
  <tr>
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas Array("Experiencia Laboral"), 1 %></td>
          </tr>
          <tr>
            <td height="2" background="../imagenes/top_r3_c2.gif"></td>
          </tr>
                  ...
                  <tr>
                    <td><%'pagina.DibujarSubtitulo "Detalles Taller"%>
                      <table width="98%"  border="0" align="center">
                        ...
                        <tr>						
                          <td align="center"><%f_muestra_trabajo.DibujaTabla()%></td>
                        </tr>
                        </table>
