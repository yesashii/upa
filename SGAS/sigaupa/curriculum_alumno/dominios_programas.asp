...
f_busqueda.AgregaCampoCons "pers_xdv", q_pers_xdv
 ...
 f_muestra_habilidades_programa.Inicializar conexion
				...
				MuestraHabilidadesPrograma=	"select pers_ncorr,cdpa_ncorr,(select soft_tdesc from software zz where zz.soft_ncorr=a.cdpa_tprograma)as cdpa_tprograma,nidi_ccod from curriculum_dominio_programa_alumno a where pers_ncorr="&pers_ncorr&"" 
  ...
  <tr>
	...
	<table width="90%" height="0" border="0" align="center" cellpadding="0" cellspacing="0" >
		...
		<table width="90%" height="0" border="0" align="center" cellpadding="0" cellspacing="0" >
				...
				<tr>
				 ...
				 <td height="2" background="../imagenes/izq.gif"></td>
				 <td bgcolor="#D8D8DE"><strong>DOMINIO DE PROGRAMAS</strong></td>
				 <td height="2" background="../imagenes/der.gif"></td>
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas Array("Dominios de Programas"), 1 %></td>
          </tr>
          <tr>
            <td height="2" background="../imagenes/top_r3_c2.gif"></td>
          </tr>
                  ...
                  <tr>
                    <td><%'pagina.DibujarSubtitulo "Detalles Taller"%>
                      <table width="98%"  border="0" align="center">
                        ...
                        <tr>						
                          <td align="center"><%f_muestra_habilidades_programa.DibujaTabla()%></td>
                        </tr>
                        </table>
