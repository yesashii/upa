...
function PopCalInitCalendar()
{
	...
	if (PopCal)
	{
		if (PopCal.initialized==0)
		{
			...
			var sHTML1="<span id='popupSuperSpanLeft" + objPopCalendar.id +  "' style='border-style:solid;border-width:1;border-color:#3366FF;cursor:default;' onDrag='return(false)' onmouseover='PopCalSwapImage(\"popupSuperChangeLeft" + objPopCalendar.id +  "\",\"left2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+objPopCalendar.scrollLeftMessage+"\"' onmouseout='clearInterval(objPopCalendar.intervalID1);PopCalSwapImage(\"popupSuperChangeLeft" + objPopCalendar.id +  "\",\"left1.gif\");this.style.borderColor=\"#3366FF\";window.status=\"\"' onclick='PopCalDecMonth()' onmousedown='clearTimeout(objPopCalendar.timeoutID1);objPopCalendar.timeoutID1=setTimeout(\"PopCalStartDecMonth()\",100)' onmouseup='clearTimeout(objPopCalendar.timeoutID1);clearInterval(objPopCalendar.intervalID1)'>&nbsp<IMG id='popupSuperChangeLeft" + objPopCalendar.id +  "' SRC='"+objPopCalendar.imgDir+"left1.gif' width=10 height=11 border=0>&nbsp</span>&nbsp;"
			sHTML1+="<span id='popupSuperSpanRight" + objPopCalendar.id +  "' style='border-style:solid;border-width:1;border-color:#3366FF;cursor:default;' onDrag='return(false)' onmouseover='PopCalSwapImage(\"popupSuperChangeRight" + objPopCalendar.id +  "\",\"right2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+objPopCalendar.scrollRightMessage+"\"' onmouseout='clearInterval(objPopCalendar.intervalID1);PopCalSwapImage(\"popupSuperChangeRight" + objPopCalendar.id +  "\",\"right1.gif\");this.style.borderColor=\"#3366FF\";window.status=\"\"' onclick='PopCalIncMonth()' onmousedown='clearTimeout(objPopCalendar.timeoutID1);objPopCalendar.timeoutID1=setTimeout(\"PopCalStartIncMonth()\",100)' onmouseup='clearTimeout(objPopCalendar.timeoutID1);clearInterval(objPopCalendar.intervalID1)'>&nbsp<IMG id='popupSuperChangeRight" + objPopCalendar.id +  "' SRC='"+objPopCalendar.imgDir+"right1.gif' width=10 height=11 border=0>&nbsp</span>&nbsp"
			sHTML1+="<span id='popupSuperSpanMonth" + objPopCalendar.id +  "' style='border-style:solid;border-width:1;border-color:#3366FF;cursor:default;' onDrag='return(false)' onmouseover='PopCalSwapImage(\"popupSuperChangeMonth" + objPopCalendar.id +  "\",\"drop2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+objPopCalendar.selectMonthMessage+"\"' onmouseout='PopCalSwapImage(\"popupSuperChangeMonth" + objPopCalendar.id +  "\",\"drop1.gif\");this.style.borderColor=\"#3366FF\";window.status=\"\"' onclick='objPopCalendar.keepMonth=!PopCalIsVisible(objPopCalendar.crossMonthObj);PopCalUpMonth()'></span>&nbsp;"
			sHTML1+="<span id='popupSuperSpanYear" + objPopCalendar.id +  "' style='border-style:solid;border-width:1;border-color:#3366FF;cursor:default;' onDrag='return(false)' onmouseover='PopCalSwapImage(\"popupSuperChangeYear" + objPopCalendar.id +  "\",\"drop2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+objPopCalendar.selectYearMessage+"\"'	onmouseout='PopCalSwapImage(\"popupSuperChangeYear" + objPopCalendar.id +  "\",\"drop1.gif\");this.style.borderColor=\"#3366FF\";window.status=\"\"' onclick='objPopCalendar.keepYear=!PopCalIsVisible(objPopCalendar.crossYearObj);PopCalUpYear()' onMouseWheel='PopCalWheelYear()'></span>&nbsp;"
...
function obtener_fecha(objeto,formulario,elemento)
{
  var fecha = document.formulario.fecha_oculta.value;
  if (objeto == "1") 
	{
	  document.formulario.elements(elemento).value = fecha
    }
  else
    {
	  document.formulario.elements(elemento).value = fecha 
