...
directorio_botones_mvc = "../../imagenes/botones/";


function _OverBoton_MVC(p_tabla)
{
	nombreBoton = p_tabla.id;

	document.all[nombreBoton + "c11"].src = directorio_botones_mvc + "boton1_2.gif";
	document.all[nombreBoton + "c12"].src = directorio_botones_mvc + "boton2_2.gif";
	document.all[nombreBoton + "c13"].src = directorio_botones_mvc + "boton4_2.gif";	
	document.all[nombreBoton + "c21"].bgColor = "#52525F";
	document.all[nombreBoton + "f21"].color = "#FFFFFF";	
	document.all[nombreBoton + "c31"].src = directorio_botones_mvc + "boton3_2.gif";
}

function _OutBoton_MVC(p_tabla)
{
	nombreBoton = p_tabla.id;
	
	document.all[nombreBoton + "c11"].src = directorio_botones_mvc + "boton1.gif";
	document.all[nombreBoton + "c12"].src = directorio_botones_mvc + "boton2.gif";
	document.all[nombreBoton + "c13"].src = directorio_botones_mvc + "boton4.gif";	
	document.all[nombreBoton + "c21"].bgColor = "#EEEEF0";	
	document.all[nombreBoton + "f21"].color = "#333333";
	document.all[nombreBoton + "c31"].src = directorio_botones_mvc + "boton3.gif";
}
