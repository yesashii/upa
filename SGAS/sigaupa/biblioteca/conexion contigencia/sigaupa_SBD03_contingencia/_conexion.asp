...
class CConexion
    ...
    sub Inicializar(sistema)
		...
		objXMLDoc.load("E:\Sitios\SIGAUPA\biblioteca\conexion.xml") 
		...
		for each node in root.childNodes
			...
			if atributo = sistema then
                ...
                dsn="sql_2005_contigencia":usuario="protic":clave=",.protic"
...
class CFormulario
	...
	sub Carga_Parametros(nombre, idFormulario)
	    Set objXMLDoc = CreateObject("Microsoft.XMLDOM") 
		objXMLDoc.async = False 
		objXMLDoc.load("E:\Sitios\SIGAUPA\biblioteca\" & nombre ) 
