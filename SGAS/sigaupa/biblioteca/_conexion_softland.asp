    ...
    sub Inicializar(sistema)
		...
		for each node in root.childNodes
			...
			if atributo = sistema then
                ...
                'dsn="sbd010_softland_user":usuario="sis_sga":clave="rl17qzmj"
				dsn="acceso_softland":usuario="sis_sga":clave="fgy675tgh56w"
