...
class CConexion2
    ...
    sub Inicializar(sistema)
		...
		objXMLDoc.load("C:\Inetpub\wwwroot\SIGAUPAPRUEBA\biblioteca\conexion.xml") 
		...
		for each node in root.childNodes
			...
			if atributo = sistema then
                ...
                dsn="sbd010_softland":usuario="sa":clave="qwerty"
...
class CFormulario2
	...
	sub Carga_Parametros(nombre, idFormulario)
	    Set objXMLDoc = CreateObject("Microsoft.XMLDOM") 
		objXMLDoc.async = False 
		objXMLDoc.load("C:\Inetpub\wwwroot\SIGAUPAPRUEBA\biblioteca\" & nombre ) 
