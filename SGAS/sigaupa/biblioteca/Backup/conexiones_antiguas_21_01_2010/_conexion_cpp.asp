...
class CConexion2
    ...
    sub Inicializar(sistema)
		...
		objXMLDoc.load("C:\Inetpub\wwwroot\SGA_CPP\biblioteca\conexion.xml") 
		...
		for each node in root.childNodes
			...
			if atributo = sistema then
                ...
                dsn="sigaupa_cpp":usuario="protic":clave=",.protic"
...
class CFormulario2
	...
	sub Carga_Parametros(nombre, idFormulario)
	    Set objXMLDoc = CreateObject("Microsoft.XMLDOM") 
		objXMLDoc.async = False 
		objXMLDoc.load("C:\Inetpub\wwwroot\SGA_CPP\biblioteca\" & nombre ) 
...
'		next
	...
	sub inicializaListaDependiente(lista, consulta)
		set listaDep = new cListaDependiente2
