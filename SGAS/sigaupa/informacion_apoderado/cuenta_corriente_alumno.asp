...
url_leng_4 = "cuenta_corriente_alumno.asp?buscador[0][pers_nrut]=" & q_pers_nrut & "&buscador[0][pers_xdv]=" & q_pers_xdv & "&leng=4&v_peri_cta="&v_peri_cta
'---------------------------------------------------------------------------------------------------
							...
							<tr>
								<td width="100%" align="center">
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
									    <tr>
										  <td colspan="4"><%pagina.DibujarLenguetasFClaro Array(Array("Detalle de compromisos", url_leng_1), Array("Becas y descuentos", url_leng_2), Array("Comentarios", url_leng_3), Array("Morosidad", url_leng_4)),CInt(q_leng) %></td>
										</tr>
                            						...
                            						<div align="left"><br>
														...
														select case q_leng
															...
															<%case "3"%>
															    <table width="98%" cellpadding="0" cellspacing="0" align="center">
																<tr><td><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>
																	Comentarios</strong></font></td></tr>
																</table>																
															<%case "4"%>
																<table width="98%" cellpadding="0" cellspacing="0" align="center">
																<tr><td><font size="2" face="Courier New, Courier, mono" color="#496da6"><strong>
																	Morosidad</strong></font></td></tr>
																</table>	
														<%end select
														%>
                                                       </div>                            
                                                       <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
														...
														<tr><td><%
															if q_leng="4" then   
																f_botonera.DibujaBoton("imprimir_morosidad")
																%> 
																<br>
																<strong>
																	<font size="2" face="Courier New, Courier, mono">(<font color="#FF0000">*</font>)</font>
																	<font size="2" face="Courier New, Courier, mono" color="#496da6">Si registra morosidad contáctese con:</font>
																</strong>
																<table width="70%">
																	<tr>
																		<th width="20%">SEDE</th>
																...
																<%
																while f_agentes.Siguiente
																%>
																	<tr>
																		<td><%=f_agentes.Obtenervalor("sede_tdesc")%></td>
																		<td><%=f_agentes.Obtenervalor("ecse_tnombre")%></td>
																		<td><font color="#0000FF"><%=f_agentes.Obtenervalor("ecse_temail")%></font></td>
																	</tr>
																<%
																wend %>
																</table>
