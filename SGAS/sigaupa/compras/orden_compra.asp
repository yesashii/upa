...
"<td align=\"center\"><INPUT TYPE=\"checkbox\" name=\"detalle["+ contador +"][dorc_bafecta]\" value=\"1\" size=\"10\" checked=\"checked\" onClick=\"ChequeaValor(this);\" maxlength=\"10\"></td>"+
					...
					<%=ini_com%>
						<table width="100%" border="1">
						  ...
						  <tr> 
							...
							<td> Form. Pago (<font color="#FF0000">*</font>)</td>
						  ...
						  <tr>
						    ...
						    <td><input type="text" style="background-color:#D8D8DE;border: 1px #D8D8DE solid; font-size:10px; font-style:oblique; font:bold; "  name="total_presupuesto" value="0" size="12" id='total_presupuesto' readonly/></td>
						    </tr>
						  <tr>
						    <td colspan="4">
							
								<B>Detalle Presupuesto</B>
								<table width="100%" class="v1" border='1' bordercolor='#999999' bgcolor='#ADADAD' cellpadding='0' cellspacing='0' id="tb_presupuesto">
									...
									<tr>
										<td align="center"><input type="checkbox" class="remove2" name="presupuesto[0][check]" value=""></td>
										<td>
                      ...
                      <table width="100%" border="0">
						...
						<tr>
							<td>
								...
								<tr  align="center" >
									<td><input type="checkbox" class="remove" name="detalle[0][checkbox]" value=""></td>
									<td>
									...
									<td align="center"><input name="detalle[0][dorc_bafecta]" type="checkbox" onClick="ChequeaValor(this);" value="1" checked="checked"></td>
									...
									<td><input type="text" name="detalle[0][dorc_nprecio_neto]" value="0" size="10" id='NU-N' readonly/> </td>
          ...
          <tr>
            <td width="18%" height="20">
                    <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="45%">&nbsp;</td>
                        <td width="55%"><%botonera.dibujaboton "guardar"%></td>
