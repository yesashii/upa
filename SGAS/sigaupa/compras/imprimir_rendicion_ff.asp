...
pagina.Titulo = "Rendicion de Fondo a Fijo N° "&v_ffij_ncorr
'**********************************************************
...
f_busqueda.Inicializar conectar
	if v_ffij_ncorr<>"" then
		...
		sql_datos_solicitud	= " select protic.trunc(ffij_fpago) as ffij_fpago, a.* "&_
...
f_detalle.Carga_Parametros "rendicion_fondo_fijo.xml", "detalle_rendicion_impresion"
f_detalle.Inicializar conectar

if v_ffij_ncorr<>"" then
	sql_detalle_pago= 	" Select protic.trunc(rffi_fdocto) as rffi_fdocto, cast(a.pers_nrut as varchar)+'-'+a.pers_xdv as rut, * "&_
						" from ocag_rendicion_fondo_fijo a, personas b where ffij_ncorr ="&v_ffij_ncorr&" and a.pers_nrut=b.pers_nrut"
else
                    ...
                    <td>
						<table width="100%" border="0">
						  ...
						  <tr>
						    ...
						    <td style="border: 1px solid black"><%=formatnumber(f_busqueda.ObtenerValor("ffij_mmonto_pesos"),0)%></td> 
					  ...
					  <table align="center" width="98%" border="0"  cellspacing="5">
					    <tr>
					      <td colspan="7">Detalle Rendicion</td>
				        </tr>
					    <tr>
					      <th>Fecha Docto </th>
					      <th>Tipo Docto</th>
					    ...
					    <tr>
					      <td style="border: 1px solid black" align="center"><%=f_detalle.ObtenerValor("rffi_fdocto")%></td>
					      <td style="border: 1px solid black" align="center"><%f_detalle.DibujaCampo("tdoc_ccod")%></td>
					      <td style="border: 1px solid black" align="center"><%=f_detalle.ObtenerValor("rffi_ndocto")%></td>
					      <td style="border: 1px solid black" align="center"><%f_detalle.DibujaCampo("tgas_ccod")%></td>
					      <td style="border: 1px solid black" align="center"><%=f_detalle.ObtenerValor("rffi_tdesc")%></td>
					      <td style="border: 1px solid black" align="center"><%=f_detalle.ObtenerValor("rut")%></td>
					      <td style="border: 1px solid black" align="center"><%=f_detalle.ObtenerValor("rffi_mmonto")%></td>
				        </tr>
					    <%
									v_total_rendido=v_total_rendido+clng(f_detalle.ObtenerValor("rffi_mmonto"))
									ind=ind+1
									wend
								end if
								%>
					    ...
					    <tr>
					      <th colspan="5"></th>
					      <td align="right">Total Asignado</td>
					      <td style="border: 1px solid black">&nbsp;<%=f_busqueda.ObtenerValor("ffij_mmonto_pesos")%></td>
				        </tr>
				      </table>
					  <br/>
