...
'LINEA			:
'*******************************************************************
v_sovi_ncorr= request.querystring("sovi_ncorr")

set pagina = new CPagina
pagina.Titulo = "Autorizacion de giro para Viaticos N° "&v_sovi_ncorr
'**********************************************************
...
f_busqueda.Inicializar conectar
	if v_sovi_ncorr<>"" then
		...
		sql_viatico	=	"select 1 as tmon_ccod, protic.trunc(ocag_fingreso) as ocag_fingreso,protic.trunc(sovi_fllegada) as sovi_fllegada,protic.trunc(sovi_fsalida) as sovi_fsalida, "&_
                  ...
                  <tr> 
                    <td>
						<table width="100%" border="0">
						  ...
						  <tr>
						    <td>Monto a Girar </td>
						    <td align="right"  style="border: 1px solid black"><%=formatnumber(f_busqueda.ObtenerValor("sovi_mmonto_pesos"),0)%></td> 
                      ...
                      <table width="100%" border="0">
						...
						<tr>
							...
							<p><strong>Identificacion de gastos</strong></p>
								...
								<tr height="50">
								<td style="border: 1px solid black">							
								<%=f_busqueda.ObtenerValor("sovi_tmotivo")%></br>
								</td>
								</tr>	
								<tr>
						...
						<tr>
							<td>
								...
								<tr>
								<td style="border: 1px solid black">
								<% f_busqueda.AgregaCampoParam "orvi_ccod", "permiso", "ESCRITURA"							
								f_busqueda.DibujaCampo("orvi_ccod")%></br>
								</td>
								<td style="border: 1px solid black">							
								<% f_busqueda.AgregaCampoParam "devi_ccod", "permiso", "ESCRITURA"
								f_busqueda.DibujaCampo("devi_ccod")%></br>
								</td>
								<td style="border: 1px solid black">							
								<%=f_busqueda.ObtenerValor("sovi_fsalida")%></br>
								</td>
								<td style="border: 1px solid black">							
								<%=f_busqueda.ObtenerValor("sovi_fllegada")%></br>
								</td>
								<td style="border: 1px solid black">							
								<%=f_busqueda.ObtenerValor("sovi_hsalida")%></br>
								</td>
								<td style="border: 1px solid black">							
								<%=f_busqueda.ObtenerValor("sovi_hllegada")%></br>
								</td>																																								
								</tr>	
								<tr>
									<th colspan="2" align="right">&nbsp;</th>
