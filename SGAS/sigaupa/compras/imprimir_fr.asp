...
f_busqueda.Inicializar conectar
	if v_fren_ncorr<>"" then
		...
		sql_datos_solicitud	= " select protic.trunc(ocag_fingreso) as ocag_fingreso,protic.trunc(fren_factividad) as fren_factividad, a.* "&_
								...
								" ,c.pers_nrut, c.pers_xdv, d.pers_tnombre + ' ' + d.PERS_TAPE_PATERNO + ' ' + d.PERS_TAPE_MATERNO as pers_tnombre_aut, d.pers_xdv  as pers_xdv_aut "&_
...
'888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888
 ...
 set f_presupuesto = new CFormulario
	...
	sql_presupuesto="select * from ocag_presupuesto_solicitud where cast(cod_solicitud as varchar)='"&v_fren_ncorr&"' and tsol_ccod=3 and isnull(psol_brendicion,'N') ='N'"
          ...
          <td>
		  	...
		  	<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<tr><td align="left">Fecha actividad:</td><td style="border: 1px solid black">&nbsp;<%=f_busqueda.ObtenerValor("fren_factividad")%></td></tr>
                  ...
                  <tr> 
                    <td>
						<table width="100%" border="0">
						  ...
						  <tr>
						    <td>Monto a Girar </td>
						    <td align="right" style="border: 1px solid black"><%=formatnumber(f_busqueda.ObtenerValor("fren_mmonto"),0)%></td> 
                      ...
                      <table width="100%" border="0">
						...
						<tr>
							...
							<p><strong>Identificacion de gastos</strong></p>
								...
								<tr height="50">
								<td style="border: 1px solid black">							
								<%=f_busqueda.ObtenerValor("fren_tdescripcion_actividad")%></br>
								</td>
								</tr>	
								<tr>
								...
								<table border ="0" align="center" width="100%">
									<tr valign="top">
										<td style="border: 1px solid black">
										   &nbsp;&nbsp;Yo: &nbsp;&nbsp;<%=f_busqueda.obtenerValor("pers_tnombre_aut")%>
										<br>
										...
										la Universidad del Pacifico descuente el monto autorizado,<br> de mi remuneracion mensual o 
