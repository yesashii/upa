...
pagina.Titulo = "Traspasar Cheques en cartera a Vencidos"

set botonera = new CFormulario
botonera.carga_parametros "traspasar_cheques.xml", "botonera"
...
f_busqueda.Carga_Parametros "traspasar_cheques.xml", "buscador"
...
f_busqueda.AgregaCampoCons "banc_tcodigo", v_banc_tcodigo
 ...
 f_cheques.Carga_Parametros "traspasar_cheques.xml", "traspasar_cheques"
...
' 888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888
		...
		'	sql_cheques_vencidos	=	" select protic.obtener_nombre_completo(pers_ncorr,'n') as proveedor, "& vbcrlf &_
		'								" protic.trunc(eche_fdocto) as eche_fdocto, * "& vbcrlf &_
		'								" from ocag_entrega_cheques a join personas b  "& vbcrlf &_
		'								"	on a.pers_nrut=b.pers_nrut  "& vbcrlf &_
		'								"	left outer join ocag_bancos_softland c "& vbcrlf &_
		'								"		on a.banc_ccod=c.banc_tcodigo "& vbcrlf &_
		'								" where  eche_ccod in (4) "& vbcrlf &_
		'								" --and datediff(dd,eche_fdocto,getdate())>60 "& vbcrlf &_
		'								" and eche_ncorr in (select eche_ncorr from ocag_revalidacion_cheques) "& vbcrlf &_
		'								" "&filtro&" "

			sql_cheques_vencidos	=	" select protic.obtener_nombre_completo(b.pers_ncorr,'n') as proveedor "& vbcrlf &_
													...
													" and datediff(dd, a.eche_fdocto,getdate()) >= 91 "& vbcrlf &_
													" "&filtro&" "

		else
			sql_cheques_vencidos	=	"select '' where 1=2"												
		end if
...
' 888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888888
	...
	' CHEQUES NO ENTREGADOS
		...
		if request.QueryString()<>"" then
			...
			sql_cheques_vencidos	=	"  select codaux, proveedor, eche_fdocto, sum(eche_mmonto) as eche_mmonto, eche_ndocto, cpbnum, pers_nrut, eche_ncorr "& vbCrLf &_
									" from ( "& vbCrLf &_
...
'response.Write("<pre>"&sql_cheques_vencidos&"</pre>")
'response.End()

f_cheques.Consultar sql_cheques_vencidos
...
function ActivaObservacion(objeto){
	...
	if(objeto.checked){
		formulario.elements["datos["+v_indice+"][tche_tobservacion]"].value="";
		formulario.elements["datos["+v_indice+"][tche_tobservacion]"].disabled=false;
	}else{
		formulario.elements["datos["+v_indice+"][tche_tobservacion]"].value="seleccione cheque a vencer";
		formulario.elements["datos["+v_indice+"][tche_tobservacion]"].disabled=true;
	}
}
...
<!-- AQUI ESTA EL INICIO DEL FORM DE BUSQUEDA -->
								...
								<TABLE BORDER="0">
									<TR>
										<TD align="left">
											<%pagina.DibujarLenguetasFClaro Array(array("Cheques Entregados","traspasar_cheques.asp?OPCION=1"),array("Cheques No Entregados","traspasar_cheques.asp?OPCION=2")), OPCION %>
                  ...
                  <tr> 
						...
						<br/>
							...
							<table align="right" width="100%"><tr>
									<td width="85%" align="right"><strong>Fecha de Traspaso: </strong></td>
							...
							<p>&nbsp;</p>							
								<table width="98%"  border="0" align="center">
								  <tr bgcolor='#C4D7FF'>
	   							    <th width="1%"></th>
								 	<th width="10%">N° Cheque</th>
									<th width="23%">Proveedor</th>
									<th width="12%">Monto</th>
									<th width="13%">Fecha vencimiento </th>
									<th width="10%">Fecha traspaso </th>
									<th width="31%">Observacion</th>
								  </tr>
								  <%
								  ind=0
								  ...
								  <tr bgcolor='#FFFFFF'>
								   <td><div align="right"><input type="checkbox" name="datos[<%=ind%>][eche_ncorr]" value="<%=f_cheques.obtenerValor("eche_ncorr")%>" onClick="ActivaObservacion(this);"/></div></td>
									<td><div align="right"><%=UCase(f_cheques.obtenerValor("eche_ndocto"))%></div></td>
									...
									<td><div align="center"><input type="text" name="datos[<%=ind%>][tche_ftraspaso]" value="<%=v_fecha_actual%>" size="12" id="FE-N"/></div></td>
									<td><div align="right"><input type="text" name="datos[<%=ind%>][tche_tobservacion]" value="seleccione cheque a vencer" disabled="disabled" size="40" id="TO-N"/></div></td>
								  </tr>
								  <%
								  ind=ind+1
								  wend%>
							...
							<table width="98%"  border="0" align="center">
							  <tr>
								...
								<td  width="15%" >
									<div align="right">
										<%
											botonera.DibujaBoton "traspasar"
										%>
									</div>
								</td>
							  </tr>
