...
cons_modulos="select a.smod_tdesc as nombre_modulo,a.smod_ccod as codigo_modulo " _
			...
			& "c.srol_ncorr in (select srol_ncorr from sis_roles_usuarios where pers_ncorr = '" & pers_ncorr & "') " _
			& "and c.srol_ncorr not in (217,219)" _
			& "group by a.smod_tdesc, a.smod_ccod --ORDER BY nombre_modulo"
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="top">
    ...
    <td height="18">
				<table width="100%">
					<tr>
						<td align="left"  width="33%"><font color="#FF0000"><strong>:: </strong><a class=modulos href="http://intra-rrhh.upacifico.cl/" target="_new"><strong>Intranet</strong></a></font></td>
						...
						<td align="left"  width="34%" nowrap><font color="#FF0000"><strong>:: </strong><a class=modulos href="http://fangorn.upacifico.cl/sigaupa/saiupa_grafica/" target="_new"><strong>Indicadores</strong></a></font></td>
					</tr>
					<%if rut_usuario <> "13582834" and rut_usuario <> "33333333" and rut_usuario <> "8993446" and rut_usuario <> "2062309" and rut_usuario <> "3701550" and rut_usuario <> "9000077" and rut_usuario <> "8402801" and rut_usuario <> "7402945" and rut_usuario <> "8534295" and rut_usuario <> "9572426" and rut_usuario <> "5197775" and rut_usuario <> "12046894" and rut_usuario <> "3623551" and rut_usuario <> "8402799" and rut_usuario <> "7688542" and rut_usuario <> "9920087" and rut_usuario <> "6629316" and rut_usuario <> "6849242" and rut_usuario <> "10384996" then %>
					<tr>
					...
					<%else%>
					<tr>
						<!--<td align="left" colspan="2" nowrap><font color="#FF0000"><strong>:: </strong><a class=modulos href="http://fangorn.upacifico.cl/sigaupa/pde/pde.html" target="_new"><strong>Obj. Estratégicos</strong></a></font></td> -->
					    <td  colspan="3" align="center"><font color="#FFFFFF"><strong>:: </strong><a class=modulos href="cerrar_sesion.asp" target="_parent"><strong>Cerrar sesión</strong></a></font></td>
					</tr>
					<%end if%>
				</table>
