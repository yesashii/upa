	...
	<tr valign="top">
		...
		<td align="left">
			<table width="70%" align="left" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td width="95%"><font size="2" color="#003366" face="Georgia, Times New Roman, Times, serif"><div align="justify">A través de este sitio podrá ingresar la programación de controles y calificaciones para las diferentes asignaturas que dicte en el semestre, mantener comunicación con los alumnos, imprimir su horario semestral, ver resultados de evaluación docente, entre otras actividades.<br>Lo(a) invitamos a navegar por las diferentes opciones.</div></font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<a href="javascript:abrir_votacion();" title="Accede a la Votación Online presionando aquí"><img width="555" height="112" src="../web_votacion/boton_votacion.jpg" border="0"></a>
					</td>
				</tr>
				<tr>
					<td colspan="2" width="100%" align="center">&nbsp;</td>
											 ...
											 <form name="mensajes" action="../REG_DEF_EVALUACIONES/MENSAJES_PROFESOR.ASP" target="_top">
											  <table width="360" cellpadding="0" cellspacing="0">
											  	<tr>
													...
													<td width="40%" align="center"><input type="button" name="ver_mensajes" value="Enviar Mensaje" onClick="javascript:abrir_mensajeria();" title="Abrir aplicación de mensajería"></td>
												</tr>
											  </table>
											 </form>
											</td>
													   	  ...
													   	  <tr>
															    ...
															    <div align="justify">
																 <font size="2" face="Georgia, Times New Roman, Times, serif" color="#cc6600">
																  En esta sección aparecerán los mensajes internos enviados por las escuelas en las que imparta clases o bien los alumnos de sus asignaturas.<br>En este momento no presenta mensajes en su bandeja de entrada.<br>Cabe destacar que estos mensajes son independientes de los correos electrónicos que reciba.<br>Si desea enviar un mensaje a alguna sección o alumno en particular, presione el botón "Enviar Mensaje". 
																 </font>
																</div>
															  </td>	
														  </tr>	
						...
						<tr valign="top">
							...
							<table width="293" border="1">
								...
								<tr>
									...
									<td width="139" align="center"><input type="button" name="aula" value="Aula Virtual" onClick="javascript: redireccionar_mensaje(<%=pers_ncorr%>,1);" title="Acceder a aplicación Aula virtual (Moodle)"></td>
								</tr>
							</table>
							<br>
											...
											elseif CurrentDay > LastDay(MyMonth, MyYear) then
												...
												if coincide = 1 then
													response.write "<a href='javascript: muestra(" & CurrentDay _
																& "," & MyMonth & "," & MyYear & "," & pers_ncorr & ");' title='Presione en el día para ver las evaluaciones.'>" 
												end if
												if coincide = 1 then
