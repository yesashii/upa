...
f_matriculados.carga_parametros "gestion_matricula.xml","matriculados"
...
if periodo="238" then
	ultimo_periodo_matriculado="238"
	ultimo_periodo_matriculado2="238"
else
	ultimo_periodo_matriculado="protic.retorna_max_periodo_matricula(c.pers_ncorr,'" & periodo & "',d.carr_ccod)"
	ultimo_periodo_matriculado2="protic.retorna_max_periodo_matricula(a.pers_ncorr,'" & periodo & "',d.carr_ccod)" 		 		
end if  
'ultimo_periodo_matriculado="protic.retorna_max_periodo_matricula(c.pers_ncorr,'" & periodo & "',d.carr_ccod)" 	

		
'#######################################################################################################
'###############	CAMBIO REALIZADO INCLUYENDO TABLA detalle_postulantes 	############################
' para asi mostrar los nuevos y antiguos en proceso y enviados

consulta2=	" Select aa.sede_ccod,aa.sede_tdesc, " & vbCrLf  & _
			...
			"        from( select e.sede_ccod,sede_tdesc, a.epos_ccod,protic.es_nuevo_carrera(a.pers_ncorr,d.carr_ccod,a.peri_ccod) as nuevo,count(*) as total_pos  " & vbCrLf  & _
            " 					from postulantes a " & vbCrLf  & _
            " 					join detalle_postulantes b " & vbCrLf  & _
			...
			"                    where a.peri_ccod=" & ultimo_periodo_matriculado2 & " and d.carr_ccod not in ('107','109') " & vbCrLf  & _
			"                        and a.audi_tusuario not in ('AgregaNota2T','AgregaNota37','AgregaNota3Nuevo','AgregaNota41','AgregaNota42','AgregaNota43','AgregaNota45','AgregaNota46','AgregaNota49'," & vbCrLf &_
			...
			"                            group by e.sede_ccod,sede_tdesc, a.epos_ccod, protic.es_nuevo_carrera(a.pers_ncorr,d.carr_ccod,a.peri_ccod) " & vbCrLf  & _
			"            ) a " & vbCrLf  & _
			...
			"			and a.peri_ccod=" & ultimo_periodo_matriculado & "  and d.carr_ccod not in ('107','109') " & vbCrLf  & _
			...
			"		 and (select post_bnuevo from postulantes where post_ncorr=c.post_ncorr) = 'S' " & vbCrLf  & _
			...
			"            right outer join especialidades d " & vbCrLf  & _
			"                on a.espe_ccod = d.espe_ccod " & vbCrLf  & _
			"        where protic.afecta_estadistica(c.matr_ncorr) > 0 and c.audi_tusuario not like '%ajunte matricula%'" & vbCrLf  & _
			"			and a.peri_ccod=" & ultimo_periodo_matriculado & "  and d.carr_ccod not in ('107','109') " & vbCrLf  & _
			"			and isnull(c.alum_nmatricula,0) not in (7777) "& vbCrLf  & _
			"	        and c.audi_tusuario not in ('Agregabase_saenzBeta2','AgregaBaseSaenzBeta2','AgregaNota2T','AgregaNota37','AgregaNota3Nuevo','AgregaNota41','AgregaNota42'," & vbCrLf  & _
			"                   'AgregaNota43','AgregaNota45','AgregaNota46','AgregaNota49','AgregaNota491T','AgregaNota492T','AgregaNota4diu2003','AgregaNota4diurno', " & vbCrLf  & _
			...
			"                   'AgregaNotaProtix','AgregaNotaprotix1','Agreganotas_saenzBeta2','AgregaNotas46$','AgregaNotas46$Beta','AgregaNotas46$Beta2','AgregaNotasSaenzBeta2', " & vbCrLf  & _
			"                   'Agregaprotix_saenzBeta2','AgregaProtixSaenzBeta2') " & vbCrLf  & _
			"                and c.emat_ccod in (1,4,8,2,15,16)  " & vbCrLf  & _
			" 		 		And c.pers_ncorr > 0 " & vbCrLf &_
			"        --and protic.es_nuevo_carrera(c.pers_ncorr,d.carr_ccod,a.peri_ccod) = 'N' " & vbCrLf  & _
			"		 and (select post_bnuevo from postulantes where post_ncorr=c.post_ncorr) = 'N' " & vbCrLf  & _
			"        group by b.sede_ccod,sede_tdesc " & vbCrLf  & _
                    ...
                    <table width="100%" border="0">
                      ...
                      <tr> 
                        <td align="center"><strong>
                          <%pagina.DibujarSubtitulo "Gestión Matricula por Sede"%>
                          </strong></td>
                      </tr>
                    </table>
                    <form name="edicion">
                      ...
                      <table width="98%" align="center">
                        ...
                        <tr>
                          <td align="center"><table width="630" class="v1" border="1" cellpadding="0" cellspacing="0" borderColor="#999999" bgColor="#adadad">
							...
							%>							
							<tr bgcolor="#FFFFFF">
								<td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="left"><%=f_matriculados.obtenervalor("sede_tdesc")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right"><%=f_matriculados.obtenervalor("en_proceso_n")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right"><%=f_matriculados.obtenervalor("en_proceso_a")%></div></td>
                                <td bgcolor="#FFECC6" width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right"><%=f_matriculados.obtenervalor("en_proceso_t")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right"><%=f_matriculados.obtenervalor("enviados_n")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right"><%=f_matriculados.obtenervalor("enviados_a")%></div></td>
                                <td bgcolor="#FFECC6" width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right"><%=f_matriculados.obtenervalor("enviados_t")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right"><%=f_matriculados.obtenervalor("matriculados_n")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right"><%=f_matriculados.obtenervalor("matriculados_a")%></div></td>
                                <td bgcolor="#FFECC6" width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right"><%=f_matriculados.obtenervalor("matriculados_t")%></div></td>
                              </tr>
							<%
							next							
							%>
