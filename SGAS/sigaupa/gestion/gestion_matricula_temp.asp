            ...
            <td><div align="center">
                    ...
                    <form name="edicion">
                      ...
                      <table width="98%" align="center">
                        ...
                        <tr>
                          <td align="center"><table width="630" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bgcolor="#6581AB">
                              <!--DWLayoutTable-->
                              <tr>
                                <td width="150" rowspan="2" valign="bottom"><div align="left"><span class="tituloTabla"><strong>Sede</strong></span></div></td>
                                <td width="141" colspan="3" valign="top"><div align="center"><strong><span class="tituloTabla">EN PROCESO </span></strong></div></td>
                                <td width="141" colspan="3" valign="top"><div align="center"><strong><span class="tituloTabla">ENVIADOS</span></strong></div></td>
                                <td width="141" colspan="3" valign="top"><div align="center"><strong><span class="tituloTabla">MATRICULADOS</span></strong></div></td>
                              </tr>            
							  <tr>
                                <td width="47" height="14"><div align="center"><span class="tituloTabla">Nuevos</span></div></td>
                                <td width="47"><div align="center"><span class="tituloTabla">Antiguos</span></div></td>
                                <td width="47"><div align="center"><span class="tituloTabla Estilo3">Total</span></div></td>
							...
							%>							
							<tr bgcolor="#AEC7E3">
								<td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="left" class="Estilo2"><%=f_matriculados.obtenervalor("sede_tdesc")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right" class="Estilo2"><%=f_matriculados.obtenervalor("en_proceso_n")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right" class="Estilo2"><%=f_matriculados.obtenervalor("en_proceso_a")%></div></td>
                                <td bgcolor="#97AAC6" width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right" class="Estilo2"><%=f_matriculados.obtenervalor("en_proceso_t")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right" class="Estilo2"><%=f_matriculados.obtenervalor("enviados_n")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right" class="Estilo2"><%=f_matriculados.obtenervalor("enviados_a")%></div></td>
                                <td bgcolor="#97AAC6" width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right" class="Estilo2"><%=f_matriculados.obtenervalor("enviados_t")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right" class="Estilo2"><%=f_matriculados.obtenervalor("matriculados_n")%></div></td>
                                <td width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right" class="Estilo2"><%=f_matriculados.obtenervalor("matriculados_a")%></div></td>
                                <td bgcolor="#97AAC6" width="47" class='click' onClick='irA("gestion_matricula_1.asp?sede_ccod=<%=f_matriculados.obtenervalor("sede_ccod")%>", "2", 600, 400)' onMouseOver='resaltar(this)' onMouseOut='desResaltar(this)'><div align="right" class="Estilo2"><%=f_matriculados.obtenervalor("matriculados_t")%></div></td>
                              </tr>
							<%
							next							
							%>
