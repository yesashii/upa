...
if q_peri_ccod <> "" then
	...
	conc_matriculas = " select sede_tdesc as sede, carr_tdesc as carrera, jorn_tdesc as jornada, a.ofer_nvacantes as vacantes, "& vbCrLf &_
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" aling="center">
                ...
                <td bgcolor="#D8D8DE"> <div align="center">&nbsp; 
				  ...
				  <table width="100%" border="0">
					...
					<tr> 
                      <td align="left"><font size="2" color="#990000">Los valores indicados en la columna "anterior" y "admisión anterior", están directamente relacionados con los resultados obtenidos para la admisión del año anterior a igual fecha que hoy. Considerar dicha información sólo con fines comparativos.</font></td>
                    </tr>
					<form name="edicion_postulacion">
					<tr> 
						<td align="left">
							  <%
							     total_vacante=0
