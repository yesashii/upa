...
f_matriculados.carga_parametros "gestion_matricula_x_semestre.xml","matriculados_2"
...
elseif emat_ccod = "1" then
	...
	consulta =  " select a.pers_ncorr, e.carr_ccod, c.peri_ccod, cast(pers_nrut as varchar)+'-'+cast(pers_xdv as varchar) as rut," & vbCrLf &_
			...
			" from personas a, ofertas_academicas c, alumnos d,especialidades e,periodos_academicos f" & vbCrLf &_
...
url_excel="listado_gestion_matricula_x_semestre_2.asp?sede="&sede&"&espe_ccod="&espe_ccod&"&epos_ccod="&epos_ccod&"&emat_ccod="&emat_ccod&"&nuevo="&nuevo
            ...
            <td width="38%" height="20"><div align="center">
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center">
                            <% 
							botonera.agregabotonparam "anterior","url","gestion_matricula_x_semestre_1.asp?sede_ccod=" & sede'request.ServerVariables("HTTP_REFERER")
