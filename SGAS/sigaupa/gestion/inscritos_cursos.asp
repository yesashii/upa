...
f_botonera.Carga_Parametros "inscritos_cursos.xml", "botonera"

'f_botonera.AgregaBotonUrlParam "agregar", "tcom_ccod", q_tcom_ccod


 set f_busqueda = new CFormulario
 f_busqueda.Carga_Parametros "inscritos_cursos.xml", "busqueda_cursos"
...
f_lista_incritos.Carga_Parametros "inscritos_cursos.xml", "f_cursos"
...
sql_cursos = " Select g.ingr_nfolio_referencia as comprobante,protic.trunc(max(g.ingr_fpago)) as fecha_inscrito, "& vbCrLf &_
				...
				"		 and tdet_bvigente in ('S','N')"& vbCrLf &_
