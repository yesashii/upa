...
pagina.Titulo = "Alumnos Matriculados por Carrera y semestre"
...
f_matriculados.carga_parametros "gestion_matricula_x_semestre.xml","matriculados_1"
...
"	 Case cast(isnull(EN_PROCESO_n,0) as char) When '0' then '-' else '<a href=""gestion_matricula_x_semestre_2.asp?sede_ccod='+cast(aa.sede_ccod as varchar)+'&espe_ccod='+cast(aa.espe_ccod as varchar)+'&epos_ccod=1&nuevo=S"">'+cast(isnull(EN_PROCESO_n,0) as varchar)+'</a>' end as v_EN_PROCESO_n , " & vbCrLf &_
"     Case cast(isnull(EN_PROCESO_a,0)as char) When '0' then '-' else '<a href=""gestion_matricula_x_semestre_2.asp?sede_ccod='+cast(aa.sede_ccod as varchar)+'&espe_ccod='+cast(aa.espe_ccod as varchar)+'&epos_ccod=1&nuevo=N"">'+cast(isnull(EN_PROCESO_a,0) as varchar)+ '</a>' end as v_EN_PROCESO_a," & vbCrLf &_
"	 Case cast(isnull(EN_PROCESO_n,0) + isnull(EN_PROCESO_a,0)as char) When '0' then '-' else '<a href=""gestion_matricula_x_semestre_2.asp?sede_ccod='+cast(aa.sede_ccod as varchar)+'&espe_ccod='+cast(aa.espe_ccod as varchar)+'&epos_ccod=1&nuevo=T"">' + cast(isnull(EN_PROCESO_n,0)+isnull(EN_PROCESO_a,0) as varchar) +'</a>' end as v_EN_PROCESO_t," & vbCrLf &_
"	 Case cast(isnull(ENVIADOS_n,0) as char) When '0' then '-' else '<a href=""gestion_matricula_x_semestre_2.asp?sede_ccod='+cast(aa.sede_ccod as varchar)+'&espe_ccod='+cast(aa.espe_ccod as varchar)+'&epos_ccod=2&nuevo=S"">'+cast(isnull(ENVIADOS_n,0) as varchar)+'</a>' end as v_ENVIADOS_n," & vbCrLf &_
"	 Case cast(isnull(ENVIADOS_a,0) as char) When '0' then '-' else '<a href=""gestion_matricula_x_semestre_2.asp?sede_ccod='+cast(aa.sede_ccod as varchar)+'&espe_ccod='+cast(aa.espe_ccod as varchar)+'&epos_ccod=2&nuevo=N"">'+cast(isnull(ENVIADOS_a,0) as varchar)+'</a>' end as v_ENVIADOS_a," & vbCrLf &_
"	 Case cast(isnull(ENVIADOS_n,0)  + isnull(ENVIADOS_a,0) as char) When '0' then '-' else '<a href=""gestion_matricula_x_semestre_2.asp?sede_ccod=' +cast(aa.sede_ccod as varchar)+'&espe_ccod=' +cast(aa.espe_ccod as varchar)+'&epos_ccod=2&nuevo=T"">'+ cast(isnull(ENVIADOS_n,0)+isnull(ENVIADOS_a,0) as varchar)+'</a>' end as v_ENVIADOS_t," & vbCrLf &_
"	 Case cast(isnull(MATRICULADOS_n,0)as char) When '0' then '-' else '<a href=""gestion_matricula_x_semestre_2.asp?sede_ccod='+cast(aa.sede_ccod as varchar)+'&espe_ccod='+cast(aa.espe_ccod as varchar)+'&emat_ccod=1&nuevo=S"">'+cast(isnull(MATRICULADOS_N,0) as varchar)+'</a>' end as v_MATRICULADOS_n," & vbCrLf &_
"	 Case cast(isnull(MATRICULADOS_a,0)as char) When '0' then '-' else '<a href=""gestion_matricula_x_semestre_2.asp?sede_ccod='+cast(aa.sede_ccod as varchar)+'&espe_ccod='+cast(aa.espe_ccod as varchar)+'&emat_ccod=1&nuevo=N"">'+cast(isnull(MATRICULADOS_a,0) as varchar)+'</a>' end as v_MATRICULADOS_a," & vbCrLf &_
"	 Case cast(isnull(MATRICULADOS_n,0) + isnull(MATRICULADOS_a,0)as char ) When '0' then '-' else '<a href=""gestion_matricula_x_semestre_2.asp?sede_ccod=' +cast(aa.sede_ccod as varchar)+'&espe_ccod='+cast(aa.espe_ccod as varchar)+ '&epos_ccod=2&nuevo=T"">'+cast(isnull(MATRICULADOS_n,0)+isnull(MATRICULADOS_a,0) as varchar)+'</a>' end as v_MATRICULADOS_t " & vbCrLf &_
...
'response.Write("<br><pre>"&consulta2&"</pre>")
'response.end()
                    ...
                    <table width="100%" border="0">
                      ...
                      <tr> 
                        <td align="center"><strong>
                          <%pagina.DibujarSubtitulo "Gestión Matricula por Carrera y semestre"%>
                          </strong></td>
                      </tr>
					  <tr> 
                        <td align="left"><strong>Periodo : </strong><%=periodo_tdesc%></td>
                      </tr>
                    </table>
                    <form name="edicion">
                      <div align="left">
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="33%"><div align="center">
                            <% 
							botonera.agregabotonparam "anterior","url","gestion_matricula_x_semestre.asp"
