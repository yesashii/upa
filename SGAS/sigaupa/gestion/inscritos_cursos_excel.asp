...
<%
'response.End()
Response.AddHeader "Content-Disposition", "attachment;filename=inscritos_cursos.xls"
...
sql_cursos = " Select g.ingr_nfolio_referencia as comprobante,cast(sum(ingr_mtotal) as numeric) as monto,protic.trunc(max(g.ingr_fpago)) as fecha_inscrito, "& vbCrLf &_
				...
				" Group by g.ingr_nfolio_referencia,b.pers_ncorr,c.tdet_ccod,d.tdet_tdesc,e.pers_tfono,i.ciud_tdesc,i.ciud_tcomuna,e.pers_temail"
else
...
<table width="75%" border="1">
  ...
  <tr> 
   <td><div align="left"><%=f_lista_incritos.ObtenerValor("comprobante")%></div></td>
	<td><div align="left"><%=f_lista_incritos.ObtenerValor("monto")%></div></td>
