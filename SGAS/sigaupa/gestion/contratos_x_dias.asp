...
f_botonera.Carga_Parametros "contratos_x_dias.xml", "botonera"


set lista = new CFormulario
lista.carga_parametros "contratos_x_dias.xml", "list_alumnos"
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				  ...
				  <td width="49%"> <div align="center">  <% if cantidad_encontrados = 0 then
					                       ...
					                       f_botonera.agregabotonparam "excel", "url", "contratos_dia_anterior_excel.asp?inicio="&inicio
