...
if estado_ccod="1" then
	estado="TEST NO PAGADO"
elseif estado_ccod="2" then
	estado="TEST PAGADO SIN RENDIR"
elseif estado_ccod="3" then
    estado="TEST RENDIDO SIN MATRICULAR"
elseif estado_ccod="4" then
    estado="MATRICULA ACTIVA"
elseif estado_ccod="5" then
	estado="MATRICULA ANULADA"
elseif estado_ccod="6" then
	estado="POSTULACIÓN ENVIADA SIN RENDIR"
elseif estado_ccod="7" then
	estado="TEST RENDIDO"
elseif estado_ccod="8" then
	estado="MATRICULA ANTICIPADA ACTIVA"
elseif estado_ccod="9" then
	estado="POSTULACIÓN SIN ENVIAR"
end if
...
consulta=" select distinct " & vbCrLf &_
		 ...
		 consulta=consulta & " and c.eepo_ccod=1 "&vbCrlf &_
...
consulta=" select distinct " & vbCrLf &_
         ...
         consulta=consulta & "  " 
		 consulta=consulta & " and c.eepo_ccod=1 --and isnull(dpos_ncalificacion,0) = 0"&vbCrlf &_
         " and b.epos_ccod = 2 " & vbCrLf &_ 
		 " and b.audi_tusuario not in ('AgregaNota2T','AgregaNota3','AgregaNota37','AgregaNota41','AgregaNota42','AgregaNota43','AgregaNota45','AgregaNota46'," & vbCrLf  & _
         "            'AgregaNota49','AgregaNota491T','AgregaNota492T','AgregaNota4diu2003','AgregaNota4diurno','AgregaNota4T','AgregaNota4vesp'," & vbCrLf  & _
         "            'AgregaNota4vesp2003','AgregaNota52','AgregaNota60','AgregaNota61','AgregaNota64','AgregaNota65','AgregaNota69','AgregaNota80'," & vbCrLf  & _
...
consulta=" select distinct " & vbCrLf &_
		 ...
		 "        and bbb.espe_ccod=eee.espe_ccod and eee.carr_ccod=fff.carr_ccod  " & vbCrLf &_
		 "        ),'No') as matriculado,    " & vbCrLf &_
         " protic.FORMAT_RUT(cast(a.pers_nrut as varchar(10))) as rut,'"&fecha_matricula&"' as fecha," & vbCrLf &_ 
         " a.pers_tnombre + ' ' + a.pers_tape_paterno + ' ' + a.pers_tape_materno as nombre, f.carr_tdesc as carrera, h.sede_tdesc as sede,e.espe_tdesc," & vbCrLf &_ 
         " a.pers_tfono as fono,a.pers_tcelular as celular, case a.pers_temail when null then '' else '<A href=""mailto:'+a.pers_temail+'"">'+a.pers_temail+'</a>' end  as email,g.jorn_tdesc as jornada" & vbCrLf &_ 
         " from  " & vbCrLf &_ 
         " personas_postulante a,postulantes b,detalle_postulantes c, " & vbCrLf &_ 
...
<tr>
	<td align="center" width="100%" colspan="15"><font size="+2">Listado de Personas que estan en el estado <%=estado%></font>
	</td>
</tr>
<tr>
	<td align="center" width="100%" colspan="15"><font size="+2">&nbsp;</font>
	</td>
</tr>
<tr>
	<td align="left" width="100%" colspan="15"><font size="+1"><strong>Periodo   : </strong> <%=peri_tdesc%></font>
	</td>
</tr>
<tr>
	<td align="center" width="100%" colspan="15"><font size="+2">&nbsp;</font>
...
<tr> 
	...
	<%if estado_ccod="5" or estado_ccod="4" then%>
