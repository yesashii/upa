...
'--------------------------------------------------------------------------------------------
v_usuario_actual=negocio.obtenerUsuario()
...
consulta="select isnull(c.pers_nrut,0) as pers_nrut ,CASE c.pers_xdv WHEN 'k' THEN 10 WHEN 'N' THEN 11 ELSE 0 END as pers_xdv , c.pers_tnombre,"& vbCrLf &_
			...
			" --and b.audi_tusuario='" & v_usuario_actual & "'  "& vbCrLf &_
...
<script language="JavaScript">
  function agregar_alumno(v_evento,tipo){
  	if (tipo==1){
  		window.open("../eventos/ficha_alumno_casa_abierta.asp?evento="+v_evento,"agregar_alumno","");
	}else{
		window.open("../eventos/ficha_alumno_casa_abierta_sin_rut.asp?evento="+v_evento,"agregar_alumno","");
	}
  }
  ...
  function navega(v_evento,v_pers_ncorr_alumno,v_pers_nrut,v_pers_xdv){
	   ...
	   if 	(v_pers_nrut==0 ){
			v_url="ficha_alumno_casa_abierta_sin_rut.asp?evento="+v_evento+"&pers_ncorr_alumno="+v_pers_ncorr_alumno;
	   }else{
			v_url="ficha_alumno_casa_abierta.asp?evento="+v_evento+"&pers_ncorr_alumno="+v_pers_ncorr_alumno+"&rut_alumno="+v_pers_nrut+"&digito_v="+v_pers_xdv;
	   }
        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td>
                  <%pagina.dibujarLenguetas array (array("Alumnos Ingresados","ingreso_alumnos_casa_abierta.asp")),1 %>
                </td>
