...
'----------------------------------------------------------------------
  v_pers_ncorr_evento = conectar.ConsultaUno("execute obtenersecuencia 'personas_eventos'")  
'----------------------------------------------------------------------  
...
formulario.agregacampopost "pers_ncorr_alumno" , v_pers_ncorr_evento

'response.Write("<br>"&conectar.obtenerEstadoTransaccion)
...
<script language="JavaScript">
  opener.location.href = "ingreso_alumnos_eventos.asp?folio_envio=<%=v_even_ncorr%>";
  close(); 
</script>
