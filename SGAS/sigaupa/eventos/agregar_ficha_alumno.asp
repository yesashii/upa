...
'------------busqueda del alumno si es que esta en la BD-------------------
 ...
 f_busqueda.Carga_Parametros "ficha_evento_alumno.xml", "busqueda"
...
if consulta_pers_ncorr > 0 then
	...
	consulta_datos_alumno=	" select a.pers_ncorr_alumno,isnull(d.regi_ccod,0) as regi_ccod_colegio,isnull(c.ciud_ccod,0) as ciud_ccod_colegio, b.caev_ccod, c.cole_ccod, " & vbCrLf &_
							...
							" left outer join carreras_eventos f " & vbCrLf &_
							"    on b.carre_ccod_2=f.carre_ccod " & vbCrLf &_
							" left outer join carreras_eventos g " & vbCrLf &_
							"    on b.carre_ccod_3=g.carre_ccod " & vbCrLf &_								
...
sql_colegio_evento="Select cole_ccod from eventos_upa where even_ncorr="&v_evento
...
{	
	...
	navigate("agregar_ficha_alumno.asp?evento=<%=v_evento%>&busqueda[0][pers_nrut]=<%=q_pers_nrut%>&busqueda[0][pers_xdv]=<%=q_pers_xdv%>&da[0][regi_ccod_colegio]=" +document.edicion.elements["da[0][regi_ccod_colegio]"].value + "&da[0][ciud_ccod_colegio]=" + document.edicion.elements["da[0][ciud_ccod_colegio]"].value);
				  ...
				  <input type="hidden" name="evento" value="<%=v_evento%>" >
                      ...
                      <table width="98%"  border="0" align="center">
                        <tr> 
                          ...
                          <td width="19%"><div align="center"><%f_botonera.DibujaBoton("buscar")%><%calendario.ImprimeVariables%></div></td>
                        </tr>
                      </table>
                    </form></td>
                </tr>
                          ...
                          <td width="100%"> <div align="center"> 
                              ...
                              <table width="93%" border="0">
								...
								<tr> 
                                  ...
                                  <td colspan="3"><strong>:<%=f_datos_alumno.dibujaCampo("pers_nrut")%><%=f_datos_alumno.obtenerValor("pers_nrut")%> - <%=f_datos_alumno.dibujaCampo("pers_xdv")%><%=f_datos_alumno.obtenerValor("pers_xdv")%></strong></td>
                                </tr>
                                <tr> 
