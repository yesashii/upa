...
pagina.Titulo = "Tipo de Compromiso"
...
f_tipo.Consultar "select 'S' as tcom_bcargo"
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas Array("Nuevo Tipo de Compromiso"), 1 %></td>
          </tr>
          <tr>
            ...
            <td><br>
              <form name="edicion">
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><div align="center"><%f_tipo.DibujaRegistro%></div></td>
                  </tr>
                </table>
                          <br>
            </form></td></tr>
          ...
          <tr>
            <td width="29%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center">
                    <%f_botonera.DibujaBoton "crear_cargo"%>
                  </div></td>
