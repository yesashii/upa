...
f_tipos_detalle.Carga_Parametros "edicion_tipos_compromisos.xml", "agregar_tipos_beneficios"
...
if EsVacio(q_tdet_ccod) then
	...
	f_tipos_detalle.AgregaCampoCons "tben_ccod", q_tben_ccod
	...
	consulta = 	" Select a.tdet_ccod, a.tdet_tdesc, isnull(a.tdet_mvalor_unitario,0) as tdet_mvalor_unitario, " & vbCrLf &_  
				" isnull(a.tdet_bvigente,'N') as tdet_bvigente, a.tdet_cuenta_softland, a.tdet_detalle_softland," & vbCrLf &_  
			   	" isnull(tdet_nptjecolegiatura,0) as tdet_nptjecolegiatura, isnull(tdet_nptjematricula,0) as tdet_nptjematricula, "& vbCrLf &_
				" '"&q_tben_ccod&"' as tben_ccod " & vbCrLf &_
...
function VerificaPorcentajes(){
v_matricula	=	document.edicion.elements["tipos_detalle[0][tdet_nptjematricula]"].value;
v_arancel	=	document.edicion.elements["tipos_detalle[0][tdet_nptjecolegiatura]"].value;
	if ((v_matricula>100)||(v_arancel>100)){
		alert("Los porcentajes de arancel y matriculano pueden ser mayores a un 100 porciento.");
	return false;
	}else{
		return true;
	}
          ...
          <tr>
            <td width="29%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center"><%f_botonera.DibujaBoton("aceptar_beneficio")%></div></td>
                  <td><div align="center">
