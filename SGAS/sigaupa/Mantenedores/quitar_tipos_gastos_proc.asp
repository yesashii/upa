...
f_cc.carga_parametros "areas_gastos.xml", "gastos_asociados" 
...
for fila = 0 to f_cc.CuentaPost - 1
	...
	v_pare_ccod	= f_cc.ObtenerValorPost (fila, "pare_ccod")
	'response.Write("<br>aaaa: "&fila & ": "&tgas_ccod)
	if tgas_ccod<>"" then
	

		query="delete from ocag_tipo_gasto_perfil where tgas_ccod="&tgas_ccod&" and pare_ccod="&v_pare_ccod&" "
