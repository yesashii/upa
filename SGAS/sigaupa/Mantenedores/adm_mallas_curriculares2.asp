...
pl="select plan_ncorrelativo from planes_estudio where cast(plan_ccod as varchar)='"&plan&"'"
...
tablas=" select distinct " & vbCrlf & _
		...
		" ,a.asig_ccod as asig_ccod, a.asig_tdesc as asignatura ,a.asig_nhoras as asig_nhoras,e.carr_ccod as carr_ccod  " & vbCrlf & _
		...
		consulta = "select max(nivel) from (select distinct " & vbCrlf & _
		" b.nive_ccod as nivel, b.mall_ccod,b.plan_ccod as plan_ccod, c.espe_ccod as espe_ccod " & vbCrlf & _
		...
		" and c.espe_ccod = '"&especialidad&"' " & vbCrlf & _
		" order by b.nive_ccod )"
...
nro_niveles=conectar.consultauno("select   " & vbCrlf & _
								" max(b.nive_ccod) as nivel " & vbCrlf & _
								" from asignaturas a  " & vbCrlf & _
								" , malla_curricular b  " & vbCrlf & _
								" , planes_estudio c  " & vbCrlf & _
								" where a.asig_ccod = b.asig_ccod  " & vbCrlf & _
								" and b.plan_ccod=c.plan_ccod  " & vbCrlf & _
								" and cast(b.plan_ccod as varchar)= ''  " & vbCrlf & _
								" and cast(c.espe_ccod as varchar) = '' ")
...
for j=0 to asignatura.nroFilas-1
	requisito="SELECT distinct M1.ASIG_CCOD as asig_ccod, left(t.TREQ_TDESC,3) as tipo " & vbCrlf & _
		  ...
		  " and cast(m2.asig_ccod as varchar)= '" & asig_ccod(j) & "' " & vbCrlf & _
...
consulta = "SELECT a.carr_ccod, b.espe_ccod, c.plan_ccod, a.carr_tdesc, " & vbCrlf & _
...
'fAsignaturas.consultar consulta
 ...
 n_asig  = conectar.consultauno(" select count(*) " & vbCrlf & _
            ...
            <td><div align="center"><br>
              ...
              <form name="edicion">
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><%if carrera <> "" and especialidad  <> "" and plan <> "" then %><table>
					<tr>
                        <td colspan="2" nowrap>Resultado de la Búsqueda:</td>
                      </tr>
					<tr>
                        <td nowrap>Programa de Estudio</td>
                        <td>:<strong><%=rcarrera%></strong></td></tr>
					<tr>
                        <td>Especilidad</td>
                        <td>:<strong><%=respecilidad%></strong></td></tr>
					<tr>
                        <td>Plan</td>
                        <td>:<strong><%=rplan%></strong></td></tr>
					</table><%end if %><br><%pagina.DibujarSubtitulo "Asignaturas - Requisitos"%>
                      <br>
