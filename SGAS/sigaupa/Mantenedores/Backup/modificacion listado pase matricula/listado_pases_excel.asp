...
consulta="select protic.format_rut(d.pers_nrut)as rut,  d.pers_tape_paterno+' '+d.pers_tape_materno +' '+ d.pers_tnombre as nombre," & vbCrLf &_ 
		 ...
		 " case (select count(*)  from alumnos a, ofertas_academicas b, personas c where c.pers_nrut= d.pers_nrut  and c.pers_ncorr=a.pers_ncorr  and a.ofer_ncorr=b.ofer_ncorr  and a.emat_ccod=1  and b.peri_ccod="&v_peri_ccod&") when 0 then 'No Matriculado' else 'Matriculado' end as estado" & vbCrLf &_ 
		 " from pase_matricula a, ofertas_academicas b,especialidades c,personas d,carreras e, tipo_pase_matricula f " & vbCrLf &_ 
