...
function enviar(formu){
	if (formu.asig_ccod.value!='')
	{
		   window.opener.document.forms[0].asig_ccod.value = formu.asig_ccod.value ;
		   window.opener.document.forms[0].action = 'editar_asignatura.asp';
...
<p align="right"><strong></strong></p>
          <p><strong>Verificaci&oacute;n de Existencia de Asignatura<br>
            </strong></p>
          <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF">
            <tr> 
              <td><div align="center"><strong>C&oacute;digo Asignatura
                    <input name="asig_ccod" onkeyup="this.value=this.value.toUpperCase();" type="text" size="10" maxlength="8" value="<%=codigo%>">
                  </strong></div></td>
            </tr>
          </table>
