...
<%
q_rbol_ncorr = Request.QueryString("rbol_ncorr")
...
f_botonera.Carga_Parametros "numeros_boletas_venta.xml", "botonera"

'---------------------------------------------------------------------------------------------------
set f_contrato = new CFormulario
f_contrato.Carga_Parametros "numeros_boletas_venta.xml", "detalle_boleta"
f_contrato.Inicializar conexion

consulta	=	" Select * " & vbCrLf &_
				" from RANGOS_BOLETAS_SEDES " & vbCrLf &_
				" where rbol_ncorr="&q_rbol_ncorr
