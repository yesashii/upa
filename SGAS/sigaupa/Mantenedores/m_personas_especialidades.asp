...
pagina.Titulo = "Permisos de especialidades por Persona"
'---------------------------------------------------------------------------------------------------
...
'--------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "m_personas_especialidades.xml", "busqueda_usuarios"
...
botonera.agregabotonparam "agregar", "url", "m_personas_especialidades_agregar.asp"
'--------------------------------------------------------------------------
set formulario = new CFormulario
formulario.Carga_Parametros "m_personas_especialidades.xml", "f1"
formulario.Inicializar conexion

consulta = "select b.espe_tdesc,b.espe_ccod,a.jorn_ccod,a.pers_ncorr, " & vbcrlf & _
	       " case a.jorn_ccod " & vbcrlf & _
           " when 1 then 'DIURNO' " & vbcrlf & _
           " when 2 then 'VESPERTINO' " & vbcrlf & _
           " end as jorn_tdesc, " & vbcrlf & _
       	   " (select carr_tdesc from carreras where carr_ccod=b.carr_ccod) as carr_tdesc " & vbcrlf & _
		   " from sis_especialidades_usuario a,especialidades b " & vbcrlf & _
		   " where a.pers_ncorr = (select pers_ncorr from personas where cast(pers_nrut as varchar)='" & rut & "')" & vbcrlf & _
		   " and a.espe_ccod = b.espe_ccod order by carr_tdesc,b.espe_tdesc "
			'   if rut <> "" then
			 '     consulta = consulta & " and b.pers_nrut = "&rut&" "
				'ELSE
				'consulta = consulta & " and b.pers_nrut=12 "   
			   'end if  
			'consulta = consulta & "  ORDER BY a.susu_tlogin" 
                            ...
                            <table width="98%"  border="0">
							  ...
							  <tr>
                                    ...
                                    <tr> 
                                      ...
                                      <td width="23">:</td>
                                      <td width="389"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><%=nombre_persona %>
                                        </font></td>
                                    </tr>
                                  </table></td>
									<td>&nbsp;</td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="101" nowrap bgcolor="#D8D8DE"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="6%"><% if	formulario.NroFilas() = 0 then
                      ...
                      <td width="94%">
                        <%  if	EsVacio(rut) then
							...
							botonera.agregabotonparam "agregar", "url", "m_personas_especialidades_agregar.asp?rut=" & rut & "&amp;digito=" & digito
