...
f_consulta.inicializar conexion
	 ...
	 sql =  "select c.asig_ccod, a.secc_tdesc, b.peri_tdesc, c.asig_tdesc, d.sede_tdesc, e.jorn_tdesc ,protic.PROFESORES_SECCION_CON_RUT(a.secc_ccod) profesor"& vbCrLf &_
...
f_alumnos.Carga_Parametros "asignaturas_sedes.xml", "f_alumnos"
f_alumnos.inicializar conexion

	  sql = "select a.secc_ccod, b.matr_ncorr, b.alum_nmatricula, c.PERS_TAPE_PATERNO, c.PERS_TAPE_MATERNO, c.PERS_TNOMBRE,isnull(c.pers_temail,'--') as email, f.carr_ccod,  f.CARR_TDESC, e.ESPE_TDESC  "& vbCrLf &_
			...
			"  and b.emat_ccod in (1,2,4,16) "& vbCrLf &_
              ...
              <%pagina.DibujarTituloPagina%><br><BR><BR>
                    <table width="100%" border="0">
                      ...
                      <tr> 
                        ...
                        <td><div align="center"><strong>:</strong></div></td>
                        <td><%=f_consulta.obtenerValor("profesor")%></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
          ...
          <tr>
            <td width="18%" height="20"><div align="center">
                    <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td width="48%"> <% botonera.AgregaBotonParam "anterior", "url", "asignaturas_sede.asp?busqueda[0][asig_ccod]=" & asignatura &"&busqueda[0][carr_ccod]="&carrera&"&busqueda[0][jorn_ccod]="&jornada
						  botonera.dibujaBoton "anterior"
						  %> </td>
                        <td width="52%"> <% 'botonera.AgregaBotonParam "excel", "url", "alumnos_asignatura_excel.asp?secc_ccod=" & secc_ccod
							  if f_alumnos.nroFilas > 0 then
							   botonera.AgregaBotonParam "imprimir_1", "deshabilitado", "FALSE"
							  else
							    botonera.AgregaBotonParam "imprimir_1", "deshabilitado", "TRUE"
							  end if
							  
							  botonera.AgregaBotonParam "imprimir_1", "url", "controlEvaluacionesPdf.asp?secc_ccod=" & secc_ccod
							  botonera.dibujaBoton "imprimir_1"
							%> </td>
							<td width="52%"> <% 
							  if f_alumnos.nroFilas > 0 then
							   botonera.AgregaBotonParam "imprimir_2", "deshabilitado", "FALSE"
							  else
							    botonera.AgregaBotonParam "imprimir_2", "deshabilitado", "TRUE"
							  end if
							  
							  botonera.AgregaBotonParam "imprimir_2", "url", "controlAsistenciaPdf.asp?secc_ccod=" & secc_ccod
							  botonera.dibujaBoton "imprimir_2"
							%> </td>
                        <td width="52%"><% 
							  if f_alumnos.nroFilas > 0 then
							   botonera.AgregaBotonParam "imprimir_3", "deshabilitado", "FALSE"
							  else
							    botonera.AgregaBotonParam "imprimir_3", "deshabilitado", "TRUE"
							  end if
							  
							  botonera.AgregaBotonParam "imprimir_3", "url", "nominaAlumnosPdf.asp?secc_ccod=" & secc_ccod
							  botonera.dibujaBoton "imprimir_3"
							%></td>
                        <td width="52%"><div align="center">
                            <% 'botonera.AgregaBotonParam "excel", "url", "alumnos_asignatura_excel.asp?secc_ccod=" & secc_ccod
							  ...
							  botonera.AgregaBotonParam "excel", "url", "listado_excel.asp?secc_ccod=" & secc_ccod
