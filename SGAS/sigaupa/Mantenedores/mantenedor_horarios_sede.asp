...
pagina.Titulo = "Mantenedor De Horarios Sede"
...
f_botonera.Carga_Parametros "mantenedor_horarios_sedes.xml", "botonera"
'---------------------------------------------------------------------------------------------------

set f_horarios	 		=	new cformulario
f_horarios.carga_parametros 	"mantenedor_horarios_sedes.xml", "lista_horarios"
f_horarios.inicializar			conexion

sede_ccod = negocio.obtenersede

'Sql_horarios  = " select a.hora_ccod,b.hora_tdesc, "&vbCrlf & _
'				" to_char(a.hora_hinicio,'hh24:mi') as hora_hinicio, "&vbCrlf & _
'				" to_char(a.hora_htermino,'hh24:mi') as hora_htermino "&vbCrlf & _
'				" from  "&vbCrlf & _
...
SubTitulo = "Lista De Horarios De La Sede : "&conexion.consultauno("select sede_tdesc from sedes where cast(sede_ccod as varchar) = '"&sede_ccod&"'")
%>
	...
	<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D8D8DE">
      ...
      <tr>
        ...
        <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><%pagina.DibujarLenguetas Array(SubTitulo), 1 %></td>
          </tr>
          <tr>
                  ...
                  <tr>
                    <td><%pagina.DibujarSubtitulo SubTitulo %>
                      ...
                      <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td><div align="right">P&aacute;ginas :<%f_horarios.accesopagina%> </div></td>
                        </tr>
                        <tr>
                          <td><div align="center">
                          </div>
