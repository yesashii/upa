...
pers_ncorr= request.QueryString("pers")
...
docente			=	conexion.consultauno("select pers_tnombre + ' ' + pers_tape_paterno +' ' +pers_tape_materno  as docente from personas where cast(pers_ncorr as varchar)='"& pers_ncorr &"'")
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td valign="top"><font size="2">Periodo</font></td>
    <td valign="top"><font size="2">:</font> </td>
    <td><font size="2"><strong><%=ucase(peri_tdesc)%></strong></font></td>
  </tr>
  <tr> 
    <td width="6%" valign="top" widt="10"><font size="2"> <%if dsede.nrofilas > 1 then%> <font size="2"> Sedes</font> <%else%> <font size="2">Sede</font> <%end if%> </font></td>
    <td width="31%" valign="top"><font size="2">: </font>
		 <%if dsede.nrofilas > 0 then	%> <font size="2"><strong> 
		  <%
