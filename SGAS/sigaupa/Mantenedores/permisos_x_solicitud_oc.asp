...
pagina.Titulo = "Permisos solicitudes de Giro"
...
f_cc.Carga_Parametros "permisos_solicitudes_oc.xml", "permisos_usuarios"
f_cc.Inicializar conexion


sql_solicitudes= "select b.pers_nrut, c.tsol_tdesc, a.tsol_ccod, a.tsol_ccod as c_tsol_ccod from ocag_permisos_solicitudes_usuarios a, personas b,ocag_tipo_solicitud c "&_
				 " where a.pers_nrut=b.pers_nrut "&_
				 " and a.tsol_ccod=c.tsol_ccod "&_
				 " and cast(b.pers_nrut as varchar)='"&rut&"'"


f_cc.Consultar sql_solicitudes
'f_cc.siguiente'

 set f_busqueda = new CFormulario
 f_busqueda.Carga_Parametros "permisos_solicitudes_oc.xml", "busqueda_persona"
...
function ingresa_solicitud()
{
window.open("agregar_solicitud_usuarios.asp?r=<%=rut%>","","left=90,top=100,width=755,height=300");
}
function Validar()
{
              ...
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><div align="center">
					...
					<%if	EsVacio(rut) then
								botonera.agregabotonparam "agregar_permiso" , "deshabilitado" , "TRUE"
							end if
						botonera.DibujaBoton"agregar_permiso" %></div></td>
						<td><div align="center">
