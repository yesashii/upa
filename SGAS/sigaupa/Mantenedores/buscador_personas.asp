...
End Function
 ...
 'paterno= EliminarAcentos(request.QueryString("ap_pat"))
 'materno= EliminarAcentos(request.QueryString("ap_mat"))
 'nombre= EliminarAcentos(request.QueryString("nombre"))
 ...
 if paterno <>"" then
 	'consulta=consulta& " and protic.extrae_acentos(rtrim(ltrim(pers_tape_paterno))) like '%"&paterno&"%'"
	consulta=consulta& " and pers_tape_paterno like '"&paterno&"%'"
 end if
  if materno <>"" then
 	'consulta=consulta& " and protic.extrae_acentos(rtrim(ltrim(pers_tape_materno)))like '%"&materno&"%'"
	consulta=consulta& " and pers_tape_materno like '"&materno&"%'"
 end if
  if nombre <>"" then
 	'consulta=consulta& " and protic.extrae_acentos(rtrim(ltrim(pers_tnombre))) like '%"&nombre&"%'"
	consulta=consulta& " and pers_tnombre like '%"&nombre&"%'"
 end if
