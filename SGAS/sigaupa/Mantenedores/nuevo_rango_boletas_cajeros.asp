...
f_contrato.Carga_Parametros "numeros_boletas_cajeros.xml", "nuevo_rango"
                ...
                <tr>
				  ...
				  <form name="edicion">
					<table width="100%"  border="0" cellspacing="0" cellpadding="0">
					 ...
					 <tr>
							<td >Tipo Boleta</td>
						<td >						    <% f_contrato.DibujaCampo ("tbol_ccod") %></td>
                     </tr>
					 <tr>
							  <td>Boleta Inicio</td>
							  <td><% f_contrato.DibujaCampo ("rbca_ninicio") %></td>
					  </tr>
					  <tr>
							  <td>Boleta Fin</td>
							  <td><% f_contrato.DibujaCampo ("rbca_nfin") %></td>
					  </tr>
