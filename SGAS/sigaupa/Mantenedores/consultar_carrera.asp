...
function enviar(formu){
	if (formu.carr_ccod.value!='')
	{
			direccion="agregar_carrera.asp?carr_ccod="+formu.carr_ccod.value+"&viene=1"
...
<p align="right"><strong></strong></p>
          <p><strong>Verificaci&oacute;n de Existencia de Carrera <br>
            </strong></p>
          <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF">
            <tr> 
              <td><div align="center"><strong>C&oacute;digo Carrera 
                    <input name="carr_ccod" onkeyup="this.value=this.value.toUpperCase();" type="text" size="10" maxlength="3" >
                  </strong></div></td>
            </tr>
          </table>
