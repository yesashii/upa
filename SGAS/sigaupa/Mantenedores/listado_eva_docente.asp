...
consulta =  "  select *, case cantidad_carga_anual when 0 then 0 else cast(((cantidad_evaluada * 100.00) / cantidad_carga_anual) as decimal(5,2)) end as indicador" & vbCrLf &_
			...
			"    and aa3.ofer_ncorr=dd3.ofer_ncorr and dd3.peri_ccod in (206,208,209)) as cantidad_carga_anual, " & vbCrLf &_
			...
			"    and bb3.secc_ccod=cc3.secc_ccod and aa3.ofer_ncorr=dd3.ofer_ncorr and dd3.peri_ccod in (206,208,209) " & vbCrLf &_
			...
			"        on c.peri_ccod = pea.peri_ccod and pea.anos_ccod= datepart(year,getDate()) " & vbCrLf &_
...
<html>
<head>
<title>Listado alumnos activos 2007</title>
<meta http-equiv="Content-Type" content="text/html;">
</head>
<body >
<table width="100%" border="0">
 <tr> 
    <td colspan="4"><div align="center"><font size="+2" face="Arial, Helvetica, sans-serif">Listado alumnos activos 2007</font></div></td>
 </tr>
 <tr> 
    <td colspan="4">&nbsp;</td>
 </tr>
...
<table width="100%" border="0">
  <tr>
  	  <td colspan="16"><font color="#003399" size="3">Indicador de completación Evaluación Docente por Facultades</font></td>	
  </tr>
  <tr>
  ...
  while formulario_facultad.siguiente
   ...
   response.Write("<td colspal='11'>&nbsp;</td>")
   response.Write("</tr>")		 
...
formulario.primero
  ...
  <tr><td colspan="16">&nbsp;</td></tr>
  <tr>
  	  <td colspan="16"><font color="#003399" size="3">Indicador de completación Evaluación Docente por Sedes</font></td>	
  </tr>
  <tr>
      <td bgcolor="#9999FF"><div align="center"><strong>N°</strong></div></td>
...
%>
  ...
  <tr><td colspan="16">&nbsp;</td></tr>
  <tr>
  	  <td colspan="16"><font color="#003399" size="3">Indicador de completación Evaluación Docente por Escuelas y Alumnado</font></td>	
  </tr>
  <tr> 
    <td bgcolor="#9999FF"><div align="center"><strong>N°</strong></div></td>
    <td bgcolor="#9999FF"><div align="center"><strong>Facultad</strong></div></td>
