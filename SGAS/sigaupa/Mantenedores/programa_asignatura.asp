...
consulta=   " select upro_tdesc,upro_nnumero," & vbCrlf & _
"'"&codigo&"' as asig_ccod,upro_ccod,'"&pras_ccod&"' AS PRAS_CCOD,UPRO_NHORAS" & vbCrlf & _
" from " & vbCrlf & _
" programa_asignaturas a,unidades_programa b " & vbCrlf & _
" where a.pras_ccod = b.pras_ccod " & vbCrlf & _
"  and cast(a.pras_ccod as varchar)='"&pras_ccod&"' "

'" and a.pras_ccod ='"&pras_ccod&"' " 
'response.write("<pre>"&consulta&"</pre>")
'response.End()


consulta2=   " select * from " & vbCrlf & _
" programa_asignaturas a,unidades_programa b " & vbCrlf & _
" where a.pras_ccod = b.pras_ccod " & vbCrlf & _
...
<table width="750" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><div align="left"><font color="#CC3300">*</font> Campos Obligatorios</div></td>
  </tr>
</table>
<form name="edicion" method="post">
  ...
  <input type="hidden" name="upro_ccod" value="<%=upro_ccod%>">
                <table width="90%"  border="0" align="center">
                  <tr>
                    <td width="28%"><strong><font color="#CC3300">*</font>Nombre </strong></td>
                    <td width="72%">:<%=formulario.dibujaCampo("upro_tdesc")%></td>
                  </tr>
                  <tr>
                    <td><strong><font color="#CC3300">*</font>N&uacute;mero </strong></td>
                    <td>:<%=formulario.dibujaCampo("upro_nnumero")%></td>
                  </tr>
                  <tr>
                    <td><strong><font color="#CC3300">*</font>N&deg; De Horas </strong></td>
                  ...
                  <tr>
                    <td><strong>M&eacute;todos De Ense&ntilde;anza  </strong></td>
                    <td>:<%=formulario.dibujaCampo("upro_tmetodo")%></td>
                  </tr>
                  <tr>
                    <td><strong>Bibliograf&iacute;a  </strong></td>
