...
pagina.Titulo = "Mantenedor de cuentas de ingresos Softland"

set botonera =  new CFormulario
botonera.carga_parametros "adm_cuentas_ingresos.xml", "btn_adm_cuentas"
...
consulta ="  select * " & vbCrlf & _
			...
			" where ting_tdesc like '%"&v_nombre_cuenta&"%' " & vbCrlf & _
...
formulario.carga_parametros	"adm_cuentas_ingresos.xml",	"tabla"
            ...
            <td><form name="buscador" method="get">
              <table width="100%" border="0">
                <tr>
                  ...
                  <td width="39%">
                        <div align="center">
                          <input type="text" name="nombre_cuenta" size="30" maxlength="50" onKeyDown="return bloquearTeclas(event.keyCode,this)" onKeyUp="this.value=this.value.toUpperCase()" ID="TO-S" value="<%=v_nombre_cuenta%>" >
                          <br>
