...
pagina.Titulo = "Resumen general por docentes"
'---------------------------------------------------------------------------------------------------
...
'--------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "resumen_docentes.xml", "busqueda"
...
botonera.Carga_Parametros "resumen_docentes.xml", "botonera"
'--------------------------------------------------------------------------
set formulario = new CFormulario
formulario.Carga_Parametros "resumen_docentes.xml", "listado_asignaturas"
...
if (not esVacio(rut) and not esVacio(digito)) then
	...
	f_filtros.carga_parametros "resumen_docentes.xml", "buscador"
...
consulta = " select distinct d.carr_tdesc as carrera,e.asig_ccod +' --> ' + e.asig_tdesc as asignatura,pres.pres_fprestamo, " & vbcrlf & _
		   ...
		   "	and c.pers_ncorr=g.pers_ncorr" & vbcrlf & _
                  ...
                  <td width="65" nowrap bgcolor="#D8D8DE"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
					  ...
					  <td width="34%"> <div align="center">  <%
					                       if correcto = "S" and rut <> "" then 
											   botonera.agregabotonparam "excel", "url", "resumen_docentes_excel.asp?pers_ncorr="&pers_ncorr&"&carr_ccod="&carr_ccod&"&asig_ccod="&asig_ccod&"&inicio="&inicio&"&termino="&termino&"&estado_prestamo="&estado_prestamo
					  ...
					  <td width="33%"> <div align="center">  <%
					                       if correcto = "S" and rut <> "" then 
											   botonera.agregabotonparam "excel_buenos", "url", "resumen_docentes_correctos_excel.asp?pers_ncorr="&pers_ncorr&"&carr_ccod="&carr_ccod&"&asig_ccod="&asig_ccod&"&inicio="&inicio&"&termino="&termino&"&estado_prestamo="&estado_prestamo
											   botonera.dibujaboton "excel_buenos"
										   end if
										%>
					 </div>
                  </td>
