...
consulta_insercion = " Insert into prestamos_libros (pres_ncorr,libr_ncorr,bloq_ccod,pres_fprestamo,pres_estado_prestamo,"&_
                     " pres_tobservacion_prestamo,pres_nminutos_atraso,pres_fdevolucion,pres_estado_devolucion,pres_tobservacion_devolucion,pres_nminutos_adelanto,audi_tusuario,audi_fmodificacion,opli_ccod_prestamo) values "&_
					 " ("&pres_ncorr&","&libr_ncorr&","&bloq_ccod&",getDate(),"&estado_prestamo&",'"&opli_tdesc&"',"&diferencia_prestamo&",null,null,'',null,'prestado por "&usuario&"' ,getDate(),"&opli_ccod&") "
