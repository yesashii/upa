...
consulta = " select distinct k.espr_ccod as est,pres.pres_ncorr as codigo, ss.sede_tdesc as sede,d.carr_tdesc as carrera, jj.jorn_tdesc as jornada,e.asig_ccod +' --> ' + e.asig_tdesc as asignatura,pres.pres_fprestamo, " & vbcrlf & _
		   ...
		   " where datepart(year,pres.pres_fprestamo)='"&anos_ccod&"' " & vbcrlf & _
		   ...
		   "	and cast(a.peri_ccod as varchar)=case e.duas_ccod when 3 then '"&peri&"' else '"&periodo&"' end   " & vbcrlf & _ 
		   "	--and cast(c.pers_ncorr as varchar)='23804'   " & vbcrlf & _ 
...
<table width="100%" border="0">
  <tr> 
    <td colspan="4"><div align="center"><font size="+2" face="Arial, Helvetica, sans-serif">RESUMEN 
        GENERAL PRESTAMOS CORRECTOS TODAS LAS ESCUELAS</font></div>
...
<p>&nbsp;</p><table width="100%" border="1">
  ...
  <tr> 
	...
	<td bgcolor="<%=color%>"><div align="left"><%=f_listado.ObtenerValor("sede")%></div></td>
	<td bgcolor="<%=color%>"><div align="left"><%=f_listado.ObtenerValor("carrera")%></div></td>
	<td bgcolor="<%=color%>"><div align="left"><%=f_listado.ObtenerValor("jornada")%></div></td>
	...
	<td bgcolor="<%=color%>"><div align="center"><%=f_listado.ObtenerValor("rut")%></div></td>
	<td bgcolor="<%=color%>"><div align="center"><%=f_listado.ObtenerValor("docente")%></div></td>
