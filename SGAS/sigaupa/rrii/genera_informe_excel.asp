...
'**********************OK
if  peri_ccod <>""  then
filtro_doc=filtro_doc&" and tabla.peri_ccod ="&peri_ccod&""
end if
...
'filtro_doc&" and (select top 1 anos_ccod from ofertas_academicas cc,periodos_Academicos ff, alumnos aa where cast(aa.pers_ncorr as varchar)= a.pers_ncorr and aa.ofer_ncorr = cc.ofer_ncorr and cc.peri_ccod  = ff.peri_ccod) BETWEEN "&anos_perio_a&" AND "&anos_perio_b&""
end if
'**********************************************************************************
...
"e.univ_ccod,f.pais_ccod,c.carr_ccod,protic.obtener_nombre_carrera((select top 1 OFER_NCORR from alumnos x where x.pers_ncorr = a.pers_ncorr and x.EMAT_CCOD=1), 'C') as carrera,"& vbCrLf &_
...
<table width="100%" border="1">
  ...
  <tr>
    ...
    <td width="19%" bgcolor="#99CC33"><div align="center"><strong>Pais Procedencia</strong></div></td>	 
