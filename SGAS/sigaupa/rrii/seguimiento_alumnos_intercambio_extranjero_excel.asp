...
tici_ccod =Request.form("b[0][tici_ccod]")
...
if tici_ccod="" then
sql_descuentos="select j.tdin_tdesc as duracion,cast(pers_nrut as varchar)+'-'+pers_xdv as rut,pers_tpasaporte,c.paie_ncorr,pers_tnombre+' '+pers_tape_paterno+' '+pers_tape_materno as nombre,"& vbCrLf &_
"pais_tdesc,"& vbCrLf &_
"ciex_tdesc,"& vbCrLf &_
"univ_tdesc,"& vbCrLf &_
"espi_tdesc,"& vbCrLf &_
...
"doie_fdocument,	doie_tcomentario_document, doie_tcomentario_fbienvenida,"& vbCrLf &_		
 ...
 "'"&pais_ccod&"' as pais_ccod,'"&ciex_ccod&"'as ciex_ccod ,'"&univ_ccod&"' as univ_ccod,(select peri_tdesc from PERIODOS_ACADEMICOS where peri_ccod = '"&peri_ccod&"') as peri_ccod,'"&pers_nrut&"' as pers_nrut,'"&pers_xdv&"' as pers_xdv,'"&pasaporte&"' as pasaporte,protic.imagenes_estado_documen(c.paie_ncorr) as estados_doc,"& vbCrLf &_
    "(select top 1 lower(email_nuevo) from cuentas_email_upa tt where tt.pers_ncorr=a.pers_ncorr) as email,pers_temail as email_personal"& vbCrLf &_
"from personas_postulante a,rrii_postulacion_alumnos_intercambio_extranjero c,universidad_ciudad d,universidades e,ciudades_extranjeras g, paises f,ESTADO_POSTULACION_INTERCAMBIO h,rrii_documentacion_intercambio_extranjero i, rrii_tipos_duracion_intercambio j"& vbCrLf &_
...
"and isnull(c.tdin_ccod,1)=j.tdin_ccod"& vbCrLf &_
...
sql_descuentos="select cast(pers_nrut as varchar)+'-'+pers_xdv as rut,pers_tpasaporte,c.paie_ncorr,pers_tnombre+' '+pers_tape_paterno+' '+pers_tape_materno as nombre,a.pers_ncorr,"& vbCrLf &_
 ...
 "sa.univ_ccod as univ_tdesc,"& vbCrLf &_
   ...
   "doie_med_compania,	doie_med_poliza, doie_med_telefono,"& vbCrLf &_		
	...
	"protic.trunc(doie_fenvio_carta_acep)as doie_fenvio_carta_acep ,"& vbCrLf &_
	"protic.trunc(doie_frecepcion_carga_acad) as doie_frecepcion_carga_acad,"& vbCrLf &_
	"doie_fbienvenida, pers_temail as email_personal ,"& vbCrLf &_
 "'"&pais_ccod&"' as pais_ccod,'"&ciex_ccod&"'as ciex_ccod,(select peri_tdesc from PERIODOS_ACADEMICOS where peri_ccod = '"&peri_ccod&"') as peri_ccod,'"&pers_nrut&"' as pers_nrut,'"&pers_xdv&"' as pers_xdv,'"&pasaporte&"' as pasaporte,'"&tici_ccod&"' as tici_ccod ,protic.imagenes_estado_documen(c.paie_ncorr) as estados_doc, j.tdin_tdesc as duracion,"& vbCrLf &_
   "(select top 1 lower(email_nuevo) from cuentas_email_upa tt where tt.pers_ncorr=a.pers_ncorr) as email,"& vbCrLf &_
   "isnull((select CARR_TDESC from carreras ca where c.carr_ccod = ca.CARR_CCOD),'-- Sin datos --') as carrera"& vbCrLf &_
"from personas_postulante a,rrii_postulacion_alumnos_intercambio_extranjero c,ciudades_extranjeras g, paises f,ESTADO_POSTULACION_INTERCAMBIO h,rrii_documentacion_intercambio_extranjero i,rrii_datos_study_abroad sa, rrii_tipos_duracion_intercambio j"& vbCrLf &_
"where a.PERS_NCORR=c.PERS_NCORR"& vbCrLf &_
...
<table width="100%" border="1">
  ...
  <tr>
	...
	<td width="26%" bgcolor="#99CC33"><div align="center"><strong>Email</strong></div></td>
	...
	<td width="23%" bgcolor="#99CC33"><div align="center"><strong>Tipo postulacion</strong></div></td>
  ...
  <tr> 
    ...
    <td valign="top"><div align="center"><%=f_resumen_convenio.ObtenerValor("duracion")%></div></td>
