...
sql_descuentos="select a.paie_ncorr,tdin_ccod,doie_ncorr,unci_ncorr,pers_ncorr,carr_ccod,espi_ccod,peri_ccod,doie_med_compania,doie_med_poliza,doie_med_telefono,"& vbCrLf &_
				  ...
				  <tr>
					<td>
						 ...
						 <input type="hidden" name="buscar">
                            ...
                            <table>
                            	<tr> 
                                <td><% f_botonera.AgregaBotonParam "informacion_alumno_extranjero", "url", "impresion_ficha_antecedentes_extranjeros.asp?pers_ncorr="&pers_ncorr&"&univ_tdesc="&univ&""
								f_botonera.DibujaBoton("informacion_alumno_extranjero")%></td>
                                </tr>
                            </table>							
						 </form>
					</td>
