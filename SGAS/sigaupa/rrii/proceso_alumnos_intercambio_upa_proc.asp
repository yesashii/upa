...
for filai = 0 to f_agrega.CuentaPost - 1
				...
				diau_fficha_inscripcion		=	f_agrega.ObtenerValorPost (filai,"diau_fficha_inscripcion") 
				diau_fentrevista_apoderado	=	f_agrega.ObtenerValorPost (filai,"diau_fentrevista_apoderado") 
				diau_fseguro_salud			=	f_agrega.ObtenerValorPost (filai,"diau_fseguro_salud") 
				diau_tcomentario_ficha		=	f_agrega.ObtenerValorPost (filai,"diau_tcomentario_ficha") 
				diau_tcomentario_entrevista	=	f_agrega.ObtenerValorPost (filai,"diau_tcomentario_entrevista") 
				diau_tcomentario_seguro		=	f_agrega.ObtenerValorPost (filai,"diau_tcomentario_seguro") 

'**************************************************************************************
' ************ MODIFICADO POR MRIFFO (ACTUALIZACION DE SISTEMA)************************
				 if diau_fficha_inscripcion="" then
				 	diau_fficha_inscripcion="NULL"
				 else
				 	diau_fficha_inscripcion="'"&diau_fficha_inscripcion&"'"
				 end if
				 if diau_fentrevista_apoderado="" then
				 	diau_fentrevista_apoderado="NULL"
				 else
				 	diau_fentrevista_apoderado="'"&diau_fentrevista_apoderado&"'"
				 end if
				 if diau_fseguro_salud="" then
				 	diau_fseguro_salud="NULL"
				 else
				 	diau_fseguro_salud="'"&diau_fseguro_salud&"'"
				 end if
				 if diau_tcomentario_ficha="" then
				 	diau_tcomentario_ficha="NULL"
				 else
				 	diau_tcomentario_ficha="'"&diau_tcomentario_ficha&"'"
				 end if
				 if diau_tcomentario_entrevista="" then
				 	diau_tcomentario_entrevista="NULL"
				 else
				 	diau_tcomentario_entrevista="'"&diau_tcomentario_entrevista&"'"
				 end if
				 if diau_tcomentario_seguro="" then
				 	diau_tcomentario_seguro="NULL"
				 else
				 	diau_tcomentario_seguro="'"&diau_tcomentario_seguro&"'"
				 end if
