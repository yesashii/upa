...
sql_descuentos= "select protic.initcap(univ_tdesc)as univ_tdesc,"& vbCrLf &_
 ...
 "daco_tweb,isnull(protic.trunc(daco_fconvenio_ini),'') as daco_fconvenio_ini,isnull(protic.trunc(daco_fconvenio_fin),'') as daco_fconvenio_fin,"& vbCrLf &_
 ...
 "lower(daco_ttest_idioma) as daco_ttest_idioma,"& vbCrLf &_
 "idio_tdesc,"& vbCrLf &_
...
pdf.ln(10)
pdf.SetFont "Arial","B",10
pdf.Cell 28,1,"Inicio Convenio:","","","L"
pdf.SetFont "Arial","",10
pdf.Cell 25,1,f_datos_convenio.obtenervalor("daco_fconvenio_ini"),"","","L"
pdf.SetFont "Arial","B",10
pdf.Cell 30,1,"Termino Convenio:","","","L"
pdf.SetFont "Arial","",10
pdf.Cell 25,1,f_datos_convenio.obtenervalor("daco_fconvenio_fin"),"","","L"
...
pdf.ln(10)
pdf.SetFont "Arial","B",10
pdf.Cell 40,5,"Test Idioma Requerido:","","","L"
pdf.SetFont "Arial","",10
pdf.MultiCell 140,5,f_datos_convenio.obtenervalor("daco_ttest_idioma"),"","L",""
