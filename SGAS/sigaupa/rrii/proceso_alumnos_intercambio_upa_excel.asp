...
sql_descuentos="select cast(a.pers_nrut as varchar)+'-'+a.pers_xdv as rut,a.pers_temail, c.paiu_ncorr,pers_tnombre+' '+pers_tape_paterno+' '+pers_tape_materno as nombre, (select top 1 lower(email_nuevo) from cuentas_email_upa tt where tt.pers_ncorr=a.pers_ncorr) as email,"& vbCrLf &_
 "pais_tdesc,(select peri_tdesc from PERIODOS_ACADEMICOS where peri_ccod = '"&peri_ccod&"') as peri_ccod, "& vbCrLf &_
 "ciex_tdesc, j.tdin_tdesc as duracion,"& vbCrLf &_
 "univ_tdesc, (select distinct protic.initcap(ee.carr_tdesc) from postulantes aa, detalle_postulantes bb, ofertas_academicas cc, especialidades dd,carreras ee where aa.POST_NCORR = (select POST_NCORR from postulantes where pers_ncorr = a.pers_ncorr and peri_ccod = '"&peri_ccod&"')and aa.post_ncorr = bb.post_ncorr and bb.ofer_ncorr = cc.ofer_ncorr and cc.espe_ccod  = dd.espe_ccod and dd.carr_ccod  = ee.carr_ccod) as carrera, espi_tdesc,"& vbCrLf &_
...
"from personas a,rrii_postulacion_alumnos_intercambio_upa c,universidad_ciudad d,universidades e,ciudades_extranjeras g, paises f,ESTADO_POSTULACION_INTERCAMBIO h,rrii_documentacion_intercambio_alumnos_upa i,rrii_tipos_duracion_intercambio j"& vbCrLf &_
...
<table width="100%" border="1">
  ...
  <tr>
    ...
    <td width="26%" bgcolor="#99CC33"><div align="center"><strong>Email Universidad</strong></div></td>
    <td width="26%" bgcolor="#99CC33"><div align="center"><strong>Carrera</strong></div></td>
  ...
  <tr> 
	...
	<td valign="top"><div align="center"><%=f_resumen_convenio.ObtenerValor("pers_temail")%></div></td>
