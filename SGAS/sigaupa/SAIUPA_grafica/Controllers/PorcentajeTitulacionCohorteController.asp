      <%
      class PorcentajeTitulacionCohorteController
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new PorcentajeTitulacionCohorteHelper
            ...
            %>   <!--#include file="../views/PorcentajeTitulacionCohorte/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/PorcentajeTitulacionCohorte/List_excel.asp" --> <%
        End Sub
