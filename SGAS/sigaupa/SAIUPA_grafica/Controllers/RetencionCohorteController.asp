      <%
      class RetencionCohorteController
      Dim Model, ModelFacultad, ModelJornada, ModelCarrera, ModelCarreraDetalle
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new RetencionCohorteHelper
            If IsNothing(vars) Then
				 ...
				 set ModelCarreraDetalle = u.SelectAllCarreraDetalle
            ...
            %>   <!--#include file="../views/RetencionCohorte/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/RetencionCohorte/List_excel.asp" --> <%
        End Sub
