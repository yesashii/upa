      <%
      class MatriculaCreditoController
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new MatriculaCreditoHelper
            ...
            %>   <!--#include file="../views/MatriculaCredito/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/MatriculaCredito/List_excel.asp" --> <%
        End Sub
