      <%
      class TitulacionCohorteController
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new TitulacionCohorteHelper
            ...
            %>   <!--#include file="../views/TitulacionCohorte/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/TitulacionCohorte/List_excel.asp" --> <%
        End Sub
