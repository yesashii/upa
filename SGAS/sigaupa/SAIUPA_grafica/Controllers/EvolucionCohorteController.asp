<%
	class EvolucionCohorteController
        ...
        public Sub List(vars)
            Dim u
            set u = new EvolucionCohorteHelper
			...
			%>   <!--#include file="../views/EvolucionCohorte/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/EvolucionCohorte/List_excel.asp" --> <%
        End Sub
