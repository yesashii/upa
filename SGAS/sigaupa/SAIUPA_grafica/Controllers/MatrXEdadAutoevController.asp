      <%
      class MatrXEdadAutoevController
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new MatrXEdadAutoevHelper
            ...
            %>   <!--#include file="../views/MatrXEdadAutoev/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/MatrXEdadAutoev/List_excel.asp" --> <%
        End Sub
