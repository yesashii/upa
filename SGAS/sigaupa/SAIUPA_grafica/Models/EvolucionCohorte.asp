<%
	...
	'
    ' This files defines the EvolucionCohorte model
    '
	class EvolucionCohorte
	...
	end class 'EvolucionCohorte


    '======================
	class EvolucionCohorteHelper
		...
		private sub Class_Initialize()
			...
			selectSQL = " select [tr].a_anos, [tr].Cabecera,'' as Detalle,[tr].a_anos_0,[tr].a_anos_1,[tr].a_anos_2,[tr].a_anos_3,[tr].a_anos_4,[tr].a_anos_5,[tr].a_anos_6,  " + _
		              "                     [tr].a_anos_6,[tr].a_anos_7,[tr].a_anos_8,[tr].a_anos_9,[tr].a_anos_10,[tr].a_anos_11,[tr].a_anos_12,[tr].a_anos_13  " + _
					  "	From  " + _
					  "	(      " + _
			...
			sqlTotalSede = " select [tr].a_anos, 'Totales' as Cabecera,'' as Detalle,[tr].a_anos_0,[tr].a_anos_1,[tr].a_anos_2,[tr].a_anos_3,[tr].a_anos_4,[tr].a_anos_5," + _
	                  " [tr].a_anos_6,[tr].a_anos_6,[tr].a_anos_7,[tr].a_anos_8,[tr].a_anos_9,[tr].a_anos_10,[tr].a_anos_11,[tr].a_anos_12,[tr].a_anos_13  " + _
					  "	From  " + _
					  "	(      " + _
			...
			selectSQLFacultad = " select [tr].a_anos, [tr].Cabecera,'' as Detalle,[tr].a_anos_0,[tr].a_anos_1,[tr].a_anos_2,[tr].a_anos_3,[tr].a_anos_4,[tr].a_anos_5,[tr].a_anos_6,  " + _
							  "                     [tr].a_anos_6,[tr].a_anos_7,[tr].a_anos_8,[tr].a_anos_9,[tr].a_anos_10,[tr].a_anos_11,[tr].a_anos_12,[tr].a_anos_13  " + _
							  "	From  " + _
							  "	(      " + _
			...
			selectSQLJornada = " select [tr].a_anos, [tr].Cabecera,'' as Detalle,[tr].a_anos_0,[tr].a_anos_1,[tr].a_anos_2,[tr].a_anos_3,[tr].a_anos_4,[tr].a_anos_5,[tr].a_anos_6,  " + _
							  "                     [tr].a_anos_6,[tr].a_anos_7,[tr].a_anos_8,[tr].a_anos_9,[tr].a_anos_10,[tr].a_anos_11,[tr].a_anos_12,[tr].a_anos_13  " + _
							  "	From  " + _
							  "	(      " + _
			...
			selectSQLCarrera = " select [tr].a_anos, [tr].Cabecera,'' as Detalle,[tr].a_anos_0,[tr].a_anos_1,[tr].a_anos_2,[tr].a_anos_3,[tr].a_anos_4,[tr].a_anos_5,[tr].a_anos_6,  " + _
							  "                     [tr].a_anos_6,[tr].a_anos_7,[tr].a_anos_8,[tr].a_anos_9,[tr].a_anos_10,[tr].a_anos_11,[tr].a_anos_12,[tr].a_anos_13  " + _
							  "	From  " + _
							  "	(      " + _
							  ...
							  "	) tr " + _
							  " "
						'response.write 	 selectSQLCarrera 
			selectSQLCarreraDetalle =  " select [tr].a_anos, [tr].Cabecera, [tr].Detalle,[tr].a_anos_0,[tr].a_anos_1,[tr].a_anos_2,[tr].a_anos_3,[tr].a_anos_4,[tr].a_anos_5,  " + _
							  "                     [tr].a_anos_6,[tr].a_anos_7,[tr].a_anos_8,[tr].a_anos_9,[tr].a_anos_10,[tr].a_anos_11,[tr].a_anos_12,[tr].a_anos_13  " + _
							  "	From  " + _
							  "	(      " + _
							  "		select anos_ccod as a_anos, replace(replace(replace(replace(replace(replace(carr_tdesc,'Ñ','N'),'Á','A'),'É','E'),'Í','I'),'Ó','O'),'Ú','U') as Cabecera, " + _
							  ...
							  "     sum(desc_anos_6) as a_anos_6,sum(desc_anos_7) as a_anos_7,sum(desc_anos_8) as a_anos_8,sum(desc_anos_9) as a_anos_9,sum(desc_anos_10) as a_anos_10, " + _
							  "     sum(desc_anos_11) as a_anos_11,sum(desc_anos_12) as a_anos_12, sum(desc_anos_13) as a_anos_13 " + _
							  "		from ANI_MATR_COHORTE_CARRERA_DETALLE  " + filtroCarrera + _
							  "		group by anos_ccod, replace(replace(replace(replace(replace(replace(carr_tdesc,'Ñ','N'),'Á','A'),'É','E'),'Í','I'),'Ó','O'),'Ú','U'),  " + _
							  "		                    replace(replace(replace(replace(replace(replace(detalle,'Ñ','N'),'Á','A'),'É','E'),'Í','I'),'Ó','O'),'Ú','U')  " + _
							  "	) tr " + _
							  " "
							'response.write 	 selectSQLCarreraDetalle 
			sqlTotalCarrera   = " select [tr].a_anos, 'Totales' as Cabecera,'' as Detalle, " + _
							  ...
							  "	) tr " + _
							  " "	
						'response.write 	 sqlTotalCarrera 
      ...
      ' Select all EvolucionCohorte into a Dictionary
      ' return a Dictionary of EvolucionCohorte objects - if successful, Nothing otherwise
...
end class 'EvolucionCohorteHelper
%>
