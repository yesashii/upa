      ...
      '
      ' This files defines the PsuMaximo model
      '
class PsuMaximo
...
class PsuMaximoHelper
      ...
      ' Select all PsuMaximo into a Dictionary
      ' return a Dictionary of PsuMaximo objects - if successful, Nothing otherwise
