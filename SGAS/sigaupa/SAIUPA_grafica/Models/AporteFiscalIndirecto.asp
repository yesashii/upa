      ...
      '
      ' This files defines the AporteFiscalIndirecto model
      '
class AporteFiscalIndirecto
      ...
      end class 'AporteFiscalIndirecto


      '======================
class AporteFiscalIndirectoHelper
	  ...
	  if session("_pers_ncorr_") = "0" then
          ...
          selectSQL = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013  " + _
					  "	From  " + _
					  "	(      " + _
					  "		select sede_tdesc as Cabecera, [2005] as a2005, [2006] as a2006, [2007] as a2007, [2008] as a2008, [2009] as a2009, [2010] as a2010, " + _
					  "			                           [2011] as a2011, [2012] as a2012, [2013] as a2013   " + _
					  "		from    " + _
					  "		 (    " + _
					  "			select anos_ccod,sede_tdesc,mat_rut from [ASG_PSU_NUEVOS_SEDE]   " + _
					  "         where ASG_PSU >= case when anos_ccod = 2005 then 591.5    " + _
					  "                               when anos_ccod = 2006 then 591.0    " + _
					  "                               when anos_ccod = 2007 then 595.0    " + _
					  "                               when anos_ccod = 2008 then 610.5    " + _
					  "                               when anos_ccod = 2009 then 508.0    " + _
					  "                               when anos_ccod = 2010 then 516.5    " + _
					  "                               when anos_ccod = 2011 then 521.0    " + _
					  "                               when anos_ccod = 2012 then 535.5    " + _
					  "                               when anos_ccod = 2013 then 1000.0 end    " + _
					  "		 )p    " + _
					  "		 PIVOT    " + _
					  "		 (    " + _
					  "		  Count(mat_rut) " + _
  	   ...
  	   sqlTotalSede = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013  " + _
					  "	From  " + _
					  "	(      " + _
					  "		select [2005] as a2005, [2006] as a2006, [2007] as a2007, [2008] as a2008, [2009] as a2009, [2010] as a2010, " + _
					  "			                           [2011] as a2011, [2012] as a2012, [2013] as a2013   " + _
					  "		from    " + _
					  "		 (    " + _
					  "			select anos_ccod, mat_rut from [ASG_PSU_NUEVOS_SEDE]   " + _
					  "         where ASG_PSU >= case when anos_ccod = 2005 then 591.5    " + _
					  "                               when anos_ccod = 2006 then 591.0    " + _
					  "                               when anos_ccod = 2007 then 595.0    " + _
					  "                               when anos_ccod = 2008 then 610.5    " + _
		  ...
		  selectSQLFacultad = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  "	From  "    + _
							  "	(     "    + _
							  "		select facu_tdesc as Cabecera, [2005] as a2005, [2006] as a2006, [2007] as a2007, [2008] as a2008, [2009] as a2009, [2010] as a2010, " + _
					          "			                           [2011] as a2011, [2012] as a2012, [2013] as a2013   " + _
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,facu_tdesc,mat_rut from  [ASG_PSU_NUEVOS_FACULTAD] " + _
							  "         where ASG_PSU >= case when anos_ccod = 2005 then 591.5    " + _
							  "                               when anos_ccod = 2006 then 591.0    " + _
							  "                               when anos_ccod = 2007 then 595.0    " + _
							  "                               when anos_ccod = 2008 then 610.5    " + _
		  ...
		  sqlTotalFacultad  = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod, mat_rut from  [ASG_PSU_NUEVOS_FACULTAD] " + _
							  "         where ASG_PSU >= case when anos_ccod = 2005 then 591.5    " + _
							  "                               when anos_ccod = 2006 then 591.0    " + _
							  "                               when anos_ccod = 2007 then 595.0    " + _
							  "                               when anos_ccod = 2008 then 610.5    " + _
		   ...
		   selectSQLJornada = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  "	From  "    + _
							  "	(     "    + _
							  "		select jorn_tdesc as Cabecera, [2005] as a2005, [2006] as a2006, [2007] as a2007, [2008] as a2008, [2009] as a2009, [2010] as a2010, " + _
					          "			                           [2011] as a2011, [2012] as a2012, [2013] as a2013   " + _
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,jorn_tdesc,mat_rut from  [ASG_PSU_NUEVOS_JORNADA] " + _
							  "         where ASG_PSU >= case when anos_ccod = 2005 then 591.5    " + _
							  "                               when anos_ccod = 2006 then 591.0    " + _
							  "                               when anos_ccod = 2007 then 595.0    " + _
							  "                               when anos_ccod = 2008 then 610.5    " + _
		   ...
		   sqlTotalJornada  = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod, mat_rut from  [ASG_PSU_NUEVOS_JORNADA] " + _
							  "         where ASG_PSU >= case when anos_ccod = 2005 then 591.5    " + _
							  "                               when anos_ccod = 2006 then 591.0    " + _
							  "                               when anos_ccod = 2007 then 595.0    " + _
							  "                               when anos_ccod = 2008 then 610.5    " + _
		   ...
		   selectSQLCarrera = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  "	From  "    + _
							  "	(     "    + _
							  "		select carr_tdesc as Cabecera, [2005] as a2005, [2006] as a2006, [2007] as a2007, [2008] as a2008, [2009] as a2009, [2010] as a2010, " + _
					          "			                           [2011] as a2011, [2012] as a2012, [2013] as a2013   " + _
							  "	from "    + _
							  "	( "    + _
							  "		select anos_ccod,replace(replace(replace(replace(replace(replace(carr_tdesc,'Ñ','N'),'Á','A'),'É','E'),'Í','I'),'Ó','O'),'Ú','U') as carr_tdesc, "+_
							  "     mat_rut from [ASG_PSU_NUEVOS_CARRERA] " + _
							  "         where ASG_PSU >= case when anos_ccod = 2005 then 591.5    " + _
							  "                               when anos_ccod = 2006 then 591.0    " + _
							  "                               when anos_ccod = 2007 then 595.0    " + _
							  "                               when anos_ccod = 2008 then 610.5    " + _
							  ...
							  "                               when anos_ccod = 2011 then 521.0    " + _
							  "                               when anos_ccod = 2012 then 535.5    " + _
							  "                               when anos_ccod = 2013 then 1000.0 end    "  + filtroCarrera + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     Count(mat_rut) "    + _
         ...
         sqlTotalCarrera    = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013 " + _
							  ...
							  "	from "    + _
							  "	( "    + _
							  "		select anos_ccod, mat_rut from [ASG_PSU_NUEVOS_CARRERA] " + _
							  "         where ASG_PSU >= case when anos_ccod = 2005 then 591.5    " + _
							  "                               when anos_ccod = 2006 then 591.0    " + _
							  "                               when anos_ccod = 2007 then 595.0    " + _
							  "                               when anos_ccod = 2008 then 610.5    " + _
      ...
      ' Select all AporteFiscalIndirecto into a Dictionary
      ' return a Dictionary of AporteFiscalIndirecto objects - if successful, Nothing otherwise
      ...
      private function PopulateObjectFromRecord(record)
        if record.eof then
            ...
            Dim obj
            set obj = new AporteFiscalIndirecto
...
end class 'AporteFiscalIndirectoHelper
%>
