...
class MatriculaNuevoHelper
	  ...
	  if session("_pers_ncorr_") = "0" then
          ...
          selectSQL = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014,[tr].a2015  " + _
					  ...
					  "			   isnull(cast([2011] as numeric (5,2)),0) as a2011,isnull(cast([2012] as numeric (5,2)),0) as a2012,isnull(cast([2013] as numeric (5,2)),0) as a2013,isnull(cast([2014] as numeric (5,2)),0) as a2014,isnull(cast([2015] as numeric (5,2)),0) as a2015   " + _
					  "		from    " + _
					  "		 (    " + _
