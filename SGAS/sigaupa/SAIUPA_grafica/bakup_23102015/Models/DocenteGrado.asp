      ...
      '
      ' This files defines the DocenteGrado model
      '
class DocenteGrado
      ...
      end class 'DocenteGrado


      '======================
class DocenteGradoHelper
	  ...
	  if session("_pers_ncorr_") = "0" then
          ...
          selectSQL = " select [tr].Cabecera,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 "     + _
					  " From "     + _
					  "	(     "     + _
					  "		select ani_grado as Cabecera,[2009] as a2009,[2010] as a2010,[2011] as a2011,[2012] as a2012,[2013] as a2013,[2014] as a2014  "     + _
					  "		from   "     + _
					  "		 (   "     + _
					  "			select anos_ccod,prof_rut,ani_grado from [ANI_PROFESOR_GRADO]  a  "+ filtroCarrera      + _
					  "		 )p   "     + _
					  "		 PIVOT   "     + _
					  "		 (   "     + _
					  "		  COUNT(prof_rut)  "     + _
	      ...
	      sqlTotal =  " select 'TOTALES' as Cabecera,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 "     + _
					  ...
					  "		from   "     + _
					  "		 (   "     + _
					  "			select anos_ccod,prof_rut from [ANI_PROFESOR_GRADO]   a  "+ filtroCarrera      + _
					  "		 )p   "     + _
					  "		 PIVOT   "     + _
					  "		 (   "     + _
					  "		  COUNT(prof_rut)  "     + _
     ...
     selectSQLHoras = " select [tr].Cabecera,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 "     + _
					  ...
					  "		from   "     + _
					  "		 (   "     + _
					  "			select anos_ccod,isnull(ani_total_horas,0) as ani_total_horas,ani_grado from [ANI_PROFESOR_GRADO]  a  "+ filtroCarrera      + _
					  "		 )p   "     + _
					  "		 PIVOT   "     + _
					  "		 (   "     + _
     ...
     sqlTotalHoras =  " select 'TOTALES' as Cabecera,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 "     + _
					  ...
					  "		from   "     + _
					  "		 (   "     + _
					  "			select anos_ccod,isnull(ani_total_horas,0) as ani_total_horas from [ANI_PROFESOR_GRADO] a  "+ filtroCarrera       + _
					  "		 )p   "     + _
					  "		 PIVOT   "     + _
					  "		 (   "     + _
					  "		  sum(ani_total_horas)  "     + _
      ...
      ' Select all DocenteGrado into a Dictionary
      ' return a Dictionary of DocenteGrado objects - if successful, Nothing otherwise
