...
class DocentePromRentaHelper
	  ...
	  if session("_pers_ncorr_") = "0" then
          ...
          selectSQL = " select [tr].Cabecera,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 "     + _
					  " From "     + _
					  "	(     "     + _
					  "		select 'Promedio Renta en UF'  as Cabecera,cast(isnull([2009],0) as decimal (5,2)) as a2009,cast(isnull([2010],0) as decimal(5,2)) as a2010,cast(isnull([2011],0) as decimal (5,2)) as a2011,cast(isnull([2012],0) as decimal (5,2)) as a2012,cast(isnull([2013],0) as decimal (5,2)) as a2013,cast(isnull([2014],0) as decimal (5,2)) as a2014 "     + _
					  "		from   "     + _
					  "		 (   "     + _
     ...
     selectSQLHoras = " select [tr].Cabecera,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 "     + _
					  " From "     + _
					  "	(     "     + _
					  "		select 'Valor Hora x UF' as Cabecera,cast(isnull([2009],0) as decimal (5,2)) as a2009,cast(isnull([2010],0) as decimal(5,2)) as a2010,cast(isnull([2011],0) as decimal (5,2)) as a2011,cast(isnull([2012],0) as decimal (5,2)) as a2012,cast(isnull([2013],0) as decimal (5,2)) as a2013,cast(isnull([2014],0) as decimal (5,2)) as a2014  "     + _
					  "		from   "     + _
					  "		 (   "     + _
