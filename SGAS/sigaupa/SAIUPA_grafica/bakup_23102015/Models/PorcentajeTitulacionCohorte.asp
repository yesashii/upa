      ...
      '
      ' This files defines the PorcentajeTitulacionCohorte model
      '
class PorcentajeTitulacionCohorte
      ...
      end class 'PorcentajeTitulacionCohorte


      '======================
class PorcentajeTitulacionCohorteHelper
      ...
      private sub Class_Initialize()
	      if session("_pers_ncorr_") = "0" then
		    ...
		    filtroCarrera = " where carr_tdesc collate Modern_Spanish_CI_AS in (select distinct CARRTIT_NOMB_CARRERA from sga_carreras_usuario tt, ani_carreras_titulados t2 where tt.carr_ccod =t2.sga_carr_ccod collate Modern_Spanish_CI_AS and cast(pers_ncorr as varchar) = '"&session("_pers_ncorr_")&"') "
		  end if
		  
          selectSQL = " select [tr].a_anos, [tr].Cabecera,0.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_1,  " + _
 	   ...
 	   sqlTotalSede = " select [tr].a_anos, 'Totales' as Cabecera,0.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_1,  " + _
		              " cast(([tr].a_anos_2 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_2, cast(([tr].a_anos_3 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_3, " + _
					  "	cast(([tr].a_anos_4 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_4, cast(([tr].a_anos_5 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_5, " + _
					  "	cast(([tr].a_anos_6 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_6, cast(([tr].a_anos_7 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_7,  " + _
		              " cast(([tr].a_anos_8 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_8, cast(([tr].a_anos_9 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_9,  " + _
  ...
  selectSQLFacultad = " select [tr].a_anos, [tr].Cabecera,0.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_1,  " + _
		              " cast(([tr].a_anos_2 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_2, cast(([tr].a_anos_3 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_3, " + _
					  "	cast(([tr].a_anos_4 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_4, cast(([tr].a_anos_5 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_5, " + _
					  "	cast(([tr].a_anos_6 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_6, cast(([tr].a_anos_7 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_7,  " + _
		              " cast(([tr].a_anos_8 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_8, cast(([tr].a_anos_9 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_9,  " + _
   ...
   sqlTotalFacultad = " select [tr].a_anos, 'Totales' as Cabecera, " + _
	                  "        0.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_1,  " + _
		              " cast(([tr].a_anos_2 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_2, cast(([tr].a_anos_3 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_3, " + _
					  "	cast(([tr].a_anos_4 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_4, cast(([tr].a_anos_5 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_5, " + _
					  "	cast(([tr].a_anos_6 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_6, cast(([tr].a_anos_7 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_7,  " + _
		              " cast(([tr].a_anos_8 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_8, cast(([tr].a_anos_9 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_9,  " + _
   ...
   selectSQLJornada = " select [tr].a_anos, [tr].Cabecera,0.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_1,  " + _
		              " cast(([tr].a_anos_2 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_2, cast(([tr].a_anos_3 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_3, " + _
					  "	cast(([tr].a_anos_4 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_4, cast(([tr].a_anos_5 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_5, " + _
					  "	cast(([tr].a_anos_6 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_6, cast(([tr].a_anos_7 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_7,  " + _
		              " cast(([tr].a_anos_8 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_8, cast(([tr].a_anos_9 * 100) / [tr].a_anos_0 as numeric(5,2)) as a_anos_9,  " + _
   ...
   selectSQLCarrera = " select [tr].a_anos, [tr].Cabecera,0.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_1,  " + _
		              " cast(([tr].a_anos_2 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_2, cast(([tr].a_anos_3 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_3, " + _
					  "	cast(([tr].a_anos_4 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_4, cast(([tr].a_anos_5 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_5, " + _
					  "	cast(([tr].a_anos_6 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_6, cast(([tr].a_anos_7 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_7,  " + _
		              " cast(([tr].a_anos_8 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_8, cast(([tr].a_anos_9 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_9,  " + _
					  " cast(([tr].a_anos_10 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_10, cast(([tr].a_anos_11 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_11, " + _
					  "	cast(([tr].a_anos_12 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_12, cast(([tr].a_anos_13 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_13  " + _
					  "	From  " + _
					  "	(      " + _
					  ...
					  "     sum(desc_anos_6) as a_anos_6,sum(desc_anos_7) as a_anos_7,sum(desc_anos_8) as a_anos_8,sum(desc_anos_9) as a_anos_9,sum(desc_anos_10) as a_anos_10, " + _
					  "     sum(desc_anos_11) as a_anos_11,sum(desc_anos_12) as a_anos_12, sum(desc_anos_13) as a_anos_13 " + _
					  "		from ANI_TITULADO_COHORTE_CARRERA  " + filtroCarrera  + _
  ...
  sqlTotalCarrera   = " select [tr].a_anos, 'Totales' as Cabecera, " + _
                      " 0.00 as a_anos_0, cast(([tr].a_anos_1 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_1,  " + _
		              " cast(([tr].a_anos_2 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_2, cast(([tr].a_anos_3 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_3, " + _
					  "	cast(([tr].a_anos_4 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_4, cast(([tr].a_anos_5 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_5, " + _
					  "	cast(([tr].a_anos_6 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_6, cast(([tr].a_anos_7 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_7,  " + _
		              " cast(([tr].a_anos_8 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_8, cast(([tr].a_anos_9 * 100) / [tr].a_anos_0 as numeric(7,2)) as a_anos_9,  " + _
      ...
      ' Select all PorcentajeTitulacionCohorte into a Dictionary
      ' return a Dictionary of PorcentajeTitulacionCohorte objects - if successful, Nothing otherwise
      ...
      private function PopulateObjectFromRecord(record)
        if record.eof then
            ...
            Dim obj
            set obj = new PorcentajeTitulacionCohorte
...
end class 'PorcentajeTitulacionCohorteHelper
%>
