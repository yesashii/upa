      ...
      '
      ' This files defines the MatriculaNuevo model
      '
class MatriculaNuevo
      ...
      end class 'MatriculaNuevo


      '======================
class MatriculaNuevoHelper
	  ...
	  if session("_pers_ncorr_") = "0" then
          ...
          selectSQL = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014  " + _
					  ...
					  "			   isnull(cast([2005] as numeric (5,2)),0) as a2005,isnull(cast([2006] as numeric (5,2)),0) as a2006,isnull(cast([2007] as numeric (5,2)),0) as a2007, " + _
					  "			   isnull(cast([2008] as numeric (5,2)),0) as a2008,isnull(cast([2009] as numeric (5,2)),0) as a2009,isnull(cast([2010] as numeric (5,2)),0) as a2010, " + _
					  "			   isnull(cast([2011] as numeric (5,2)),0) as a2011,isnull(cast([2012] as numeric (5,2)),0) as a2012,isnull(cast([2013] as numeric (5,2)),0) as a2013,isnull(cast([2014] as numeric (5,2)),0) as a2014   " + _
					  "		from    " + _
					  "		 (    " + _
					  "			select anos_ccod,sede_tdesc,MATRICULA_UF from [ASG_VALOR_MATRICULA_SEDE] where MATRICULA_UF > 0   " + _
					  "		 )p    " + _
					  "		 PIVOT    " + _
					  "		 (    " + _
					  "		  AVG(MATRICULA_UF) " + _
 	   ...
 	   sqlTotalSede = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
					  ...
					  "		from    " + _
					  "		 (    " + _
					  "			select anos_ccod,MATRICULA_UF from [ASG_VALOR_MATRICULA_SEDE] where MATRICULA_UF > 0   " + _
					  "		 )p    " + _
					  "		 PIVOT    " + _
					  "		 (    " + _
					  "		  AVG(MATRICULA_UF) " + _
		  ...
		  selectSQLFacultad = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,facu_tdesc,MATRICULA_UF from  [ASG_VALOR_MATRICULA_FACULTAD] where MATRICULA_UF > 0 "    + _
							  "		)p "    + _
							  "		PIVOT "    + _
							  "		 ( "    + _
							  "		  AVG(MATRICULA_UF) "    + _
		   ...
		   sqlTotalFacultad = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod, MATRICULA_UF from  [ASG_VALOR_MATRICULA_FACULTAD] where MATRICULA_UF > 0 "    + _
							  "		)p "    + _
							  "		PIVOT "    + _
							  "		 ( "    + _
							  "		  AVG(MATRICULA_UF) "    + _
		   ...
		   selectSQLJornada = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,jorn_tdesc,MATRICULA_UF from  [ASG_VALOR_MATRICULA_JORNADA] where MATRICULA_UF > 0 "    + _
							  "		 )p "    + _
							  "		 PIVOT "    + _
							  "		 ( "    + _
							  "		  AVG(MATRICULA_UF) "    + _
		   ...
		   sqlTotalJornada  = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,MATRICULA_UF from  [ASG_VALOR_MATRICULA_JORNADA] where MATRICULA_UF > 0 "    + _
							  "		 )p "    + _
							  "		 PIVOT "    + _
							  "		 ( "    + _
							  "		  AVG(MATRICULA_UF) "    + _
		   ...
		   selectSQLCarrera = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "     MATRICULA_UF from [ASG_VALOR_MATRICULA_CARRERA] where MATRICULA_UF > 0 "+ filtroCarrera    + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     AVG(MATRICULA_UF) "    + _
		  ...
		  sqlTotalCarrera   = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "	from "    + _
							  "	( "    + _
							  "		select anos_ccod, MATRICULA_UF from [ASG_VALOR_MATRICULA_CARRERA] where MATRICULA_UF > 0 " + filtroCarrera   + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     AVG(MATRICULA_UF) "    + _
      ...
      ' Select all MatriculaNuevo into a Dictionary
      ' return a Dictionary of MatriculaNuevo objects - if successful, Nothing otherwise
...
end class 'MatriculaNuevoHelper
%>
