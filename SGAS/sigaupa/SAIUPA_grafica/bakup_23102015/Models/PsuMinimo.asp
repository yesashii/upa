      ...
      '
      ' This files defines the PsuMinimo model
      '
class PsuMinimo
...
class PsuMinimoHelper
      ...
      ' Select all PsuMinimo into a Dictionary
      ' return a Dictionary of PsuMinimo objects - if successful, Nothing otherwise
