      ...
      '
      ' This files defines the Postulante model
      '
class Postulante
...
class PostulanteHelper
      ...
      private sub Class_Initialize()
          ...
          selectSQL = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
					  ...
					  "		from   " + _
					  "		 (   "   + _
					  "			select anos_ccod,sede_tdesc,pers_ncorr from [SGA_POSTULANTES_SEDE]   " + _
					  "		 )p   "    + _
					  "		 PIVOT   " + _
					  "		 (   "     + _
					  "		  COUNT(pers_ncorr)  " + _
	   ...
	   sqlTotalSede = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
					  ...
					  "		from   " + _
					  "		 (   "   + _
					  "			select anos_ccod,pers_ncorr from [SGA_POSTULANTES_SEDE]   " + _
					  "		 )p   "    + _
					  "		 PIVOT   " + _
					  "		 (   "     + _
					  "		  COUNT(pers_ncorr)  " + _
		  ...
		  selectSQLFacultad = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,facu_tdesc,pers_ncorr from  [SGA_POSTULANTES_FACULTAD] "    + _
							  "		)p "    + _
							  "		PIVOT "    + _
							  "		 ( "    + _
							  "		  COUNT(pers_ncorr) "    + _
		   ...
		   sqlTotalFacultad = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod, pers_ncorr from  [SGA_POSTULANTES_FACULTAD] "    + _
							  "		)p "    + _
							  "		PIVOT "    + _
							  "		 ( "    + _
							  "		  COUNT(pers_ncorr) "    + _
		   ...
		   selectSQLJornada = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,jorn_tdesc,pers_ncorr from  [SGA_POSTULANTES_JORNADA] "    + _
							  "		 )p "    + _
							  "		 PIVOT "    + _
							  "		 ( "    + _
							  "		  COUNT(pers_ncorr) "    + _
		   ...
		   sqlTotalJornada  = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014  " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,pers_ncorr from  [SGA_POSTULANTES_JORNADA] "    + _
							  "		 )p "    + _
							  "		 PIVOT "    + _
							  "		 ( "    + _
							  "		  COUNT(pers_ncorr) "    + _
		   ...
		   selectSQLCarrera = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014  " + _
							  "	From  "    + _
							  "	(     "    + _
							  "		select replace(replace(replace(replace(replace(replace(carr_tdesc,'Ñ','N'),'Á','A'),'É','E'),'Í','I'),'Ó','O'),'Ú','U') as cabecera," + _
							  ...
							  "	from "    + _
							  "	( "    + _
							  "		select anos_ccod,carr_tdesc,pers_ncorr from [SGA_POSTULANTES_CARRERA] "+ filtroCarrera   + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     COUNT(pers_ncorr) "    + _
		   ...
		   sqlTotalCarrera  = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "	from "    + _
							  "	( "    + _
							  "		select anos_ccod,pers_ncorr from [SGA_POSTULANTES_CARRERA] " + filtroCarrera   + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     COUNT(pers_ncorr) "    + _
