      ...
      '
      ' This files defines the ArancelNuevo model
      '
class ArancelNuevo
      ...
      end class 'ArancelNuevo


      '======================
class ArancelNuevoHelper
	  ...
	  if session("_pers_ncorr_") = "0" then
          ...
          selectSQL = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014  " + _
					  ...
					  "		from    " + _
					  "		 (    " + _
					  "			select anos_ccod,sede_tdesc,arancel_uf from [ASG_VALOR_ARANCEL_SEDE] where arancel_uf > 0   " + _
					  "		 )p    " + _
					  "		 PIVOT    " + _
					  "		 (    " + _
					  "		  AVG(arancel_uf) " + _
 	   ...
 	   sqlTotalSede = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014  " + _
					  ...
					  "		from    " + _
					  "		 (    " + _
					  "			select anos_ccod,arancel_uf from [ASG_VALOR_ARANCEL_SEDE] where arancel_uf > 0   " + _
					  "		 )p    " + _
					  "		 PIVOT    " + _
					  "		 (    " + _
					  "		  AVG(arancel_uf) " + _
		  ...
		  selectSQLFacultad = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,facu_tdesc,arancel_uf from  [ASG_VALOR_ARANCEL_FACULTAD] where arancel_uf > 0 "    + _
							  "		)p "    + _
							  "		PIVOT "    + _
							  "		 ( "    + _
							  "		  AVG(arancel_uf) "    + _
		   ...
		   sqlTotalFacultad = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,arancel_uf from  [ASG_VALOR_ARANCEL_FACULTAD] where arancel_uf > 0 "    + _
							  "		)p "    + _
							  "		PIVOT "    + _
							  "		 ( "    + _
							  "		  AVG(arancel_uf) "    + _
		   ...
		   selectSQLJornada = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,jorn_tdesc,arancel_uf from  [ASG_VALOR_ARANCEL_JORNADA] where arancel_uf > 0 "    + _
							  "		 )p "    + _
							  "		 PIVOT "    + _
							  "		 ( "    + _
							  "		  AVG(arancel_uf) "    + _
		   ...
		   sqlTotalJornada  = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "		from "    + _
							  "		( "    + _
							  "			select anos_ccod,arancel_uf from  [ASG_VALOR_ARANCEL_JORNADA] where arancel_uf > 0 "    + _
							  "		 )p "    + _
							  "		 PIVOT "    + _
							  "		 ( "    + _
							  "		  AVG(arancel_uf) "    + _
		   ...
		   selectSQLCarrera = " select [tr].Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "     arancel_uf from [ASG_VALOR_ARANCEL_CARRERA] where arancel_uf > 0 "+ filtroCarrera    + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     AVG(arancel_uf) "    + _
			...
			sqlTotalCarrera = " select 'TOTALES' as Cabecera,[tr].a2005,[tr].a2006,[tr].a2007,[tr].a2008,[tr].a2009,[tr].a2010,[tr].a2011,[tr].a2012,[tr].a2013,[tr].a2014 " + _
							  ...
							  "	from "    + _
							  "	( "    + _
							  "		select anos_ccod,arancel_uf from [ASG_VALOR_ARANCEL_CARRERA] where arancel_uf > 0 "+ filtroCarrera    + _
							  "	)p "    + _
							  "	 PIVOT "    + _
							  "	 ( "    + _
							  "	     AVG(arancel_uf) "    + _
      ...
      ' Select all ArancelNuevo into a Dictionary
      ' return a Dictionary of ArancelNuevo objects - if successful, Nothing otherwise
