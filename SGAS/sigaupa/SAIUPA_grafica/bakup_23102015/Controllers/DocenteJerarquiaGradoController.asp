      <%
      class DocenteJerarquiaGradoController
      Dim Model
	  Dim ModelTotal
	  Dim ModelHoras
	  Dim ModelTotalHoras
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new DocenteJerarquiaGradoHelper
            ...
            %>   <!--#include file="../views/DocenteJerarquiaGrado/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/DocenteJerarquiaGrado/List_excel.asp" --> <%
        End Sub
