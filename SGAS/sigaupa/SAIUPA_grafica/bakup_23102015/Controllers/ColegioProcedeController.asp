      <%
      class ColegioProcedeController
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new ColegioProcedeHelper
            ...
            %>   <!--#include file="../views/ColegioProcede/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/ColegioProcede/List_excel.asp" --> <%
        End Sub
