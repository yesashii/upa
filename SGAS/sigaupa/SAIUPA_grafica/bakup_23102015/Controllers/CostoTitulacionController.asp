      <%
      class CostoTitulacionController
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new CostoTitulacionHelper
            ...
            %>   <!--#include file="../views/CostoTitulacion/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/CostoTitulacion/List_excel.asp" --> <%
        End Sub
