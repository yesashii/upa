      <%
      class DocentePromRentaController
      Dim Model
	  Dim ModelTotal
	  Dim ModelHoras
	  Dim ModelTotalHoras
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new DocentePromRentaHelper
            ...
            %>   <!--#include file="../views/DocentePromRenta/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/DocentePromRenta/List_excel.asp" --> <%
        End Sub
