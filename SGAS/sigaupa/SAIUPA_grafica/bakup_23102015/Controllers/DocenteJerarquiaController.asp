      <%
      class DocenteJerarquiaController
      Dim Model
	  Dim ModelTotal
	  Dim ModelHoras
	  Dim ModelTotalHoras
      ...
      private sub Class_Terminate()
        ...
        public Sub List(vars)
            Dim u
            set u = new DocenteJerarquiaHelper
            ...
            %>   <!--#include file="../views/DocenteJerarquia/List.asp" --> <%
        End Sub
		...
		public Sub List_excel(vars)
            ...
            %>   <!--#include file="../views/DocenteJerarquia/List_excel.asp" --> <%
        End Sub
