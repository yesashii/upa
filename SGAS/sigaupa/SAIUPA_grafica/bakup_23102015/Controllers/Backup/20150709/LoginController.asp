		...
		public Sub ListPost(vars)
            ...
            if t = 0 then 
		         ...
		         For each obj_T in Model.Items
				    ...
				    if obj_T.id = "13160" or obj_T.id = "243243" or obj_T.id = "242965" or obj_T.id = "108389" or obj_T.id = "270528" or obj_T.id = "131983" or obj_T.id = "128515" or  obj_T.id = "261928" or obj_T.id = "135842"  or obj_T.id = "95794" or obj_T.id = "258589" or obj_T.id = "23838" or obj_T.id = "99187"  or obj_T.id = "100"  then
