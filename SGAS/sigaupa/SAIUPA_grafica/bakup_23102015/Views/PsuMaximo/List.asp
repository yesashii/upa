     ...
     <div id="cuadro0">
     <br />
     <h1>Puntaje PSU Máximo</h1>
     <p><i>"Puntaje máximo obtenido en la PSU por los alumnos que se matricularon en la carrera durante este período".</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="9" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","PsuMaximo","List_excel", "partial=excel"&complemento_url)%>
