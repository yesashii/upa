	...
	<div id="capa4">
        ...
        <tr>
            <td width="100%" align="center">
                    <form id="login">
                        <h1>Bienvenido</h1>
                        <h4>El Sistema de Indicadores que se presenta a continuación, se orienta a entregar información relevante para apoyar la toma de decisiones de las autoridades académicas. Los datos en él contenidos, se encuentran debidamente validados, sobre la base de criterios y parámetros definidos por el Ministerio de Educación. Se espera que se utilicen estos datos como única fuente oficial de información institucional, a fin de ser consistentes con los antecedentes que la Dirección de Análisis y Aseguramiento de la Calidad remite a los organismos reguladores y el público en general.
