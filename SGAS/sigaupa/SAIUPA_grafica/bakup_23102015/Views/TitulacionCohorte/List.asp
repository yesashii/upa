      ...
      <script type="text/javascript">
          ...
          var Controller ='TitulacionCohorte';
          var Action = 'List';
      </script>
      <%
	  anio_consulta=""
     ...
     <div id="cuadro0">
     <br />
     <h1>Número de titulados de la cohorte</h1>
     <p><i>"Cantidad de alumnos titulados para la cohorte seleccionada".</i></p> 
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="13" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","TitulacionCohorte","List_excel", "partial=excel"&complemento_url)%>
                            <%if session("_pers_ncorr_") = "0" then 
							   response.Write(Html.ActionLink("<div class='btn' align='right'>Detalle "&maximo_anio&"</div>","ExcelDetalleTitulados","List_excel", "partial=excel"&url_detalle))
							  end if
							%>
                        </td>	
                    </tr>
