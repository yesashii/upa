     ...
     <div id="cuadro0">
     <br />
     <h1>Promedio de notas enseñanza media</h1>
     <p><i>"Promedio de notas de enseñanza media de los alumnos matriculados en la carrera durante este período".</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="9" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","NemPromedio","List_excel", "partial=excel"&complemento_url)%>
