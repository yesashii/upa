      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Periodo','Sede','Total Postulantes']
	  ...
	  var data_Facultad = google.visualization.arrayToDataTable([
          ['Periodo','Facultad','Total Postulantes']
		       <%Dim obj_f
			      cadena = ""
				  facu_seleccionada = ""
	  ...
	  var data_Jornada = google.visualization.arrayToDataTable([
          ['Periodo','Jornada','Total Postulantes']
		       <%Dim obj_j
			      cadena = ""
				  jorn_seleccionada = ""
	  ...
	  var data_Carrera = google.visualization.arrayToDataTable([
          ['Periodo','Carrera','Total Postulantes']
		       <%Dim obj_c
			      cadena = ""
				  carr_seleccionada = ""
     ...
     <div id="cuadro0">
     <br />
     <h1>No. de postulantes a la carrera</h1>
     <p><i>"Cantidad de postulantes a la carrera para el periodo en curso".</i></p>
     ...
     <div id="capa1">
               ...
               <table width="90%" align="center">
                    <tr valign="top">
                        <td colspan="10"><h3 class="shad">Seleccione periodo a consultar</h3></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    	<td colspan="10" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","Postulante","List_excel", "partial=excel"&complemento_url)%>
                            <%if session("_pers_ncorr_") = "0" then 
							   response.Write(Html.ActionLink("<div class='btn' align='right'>Detalle "&maximo_anio&"</div>","ExcelDetalle","List_excel", "partial=excel"&url_detalle))
							  end if
							%>
                        </td>	
                    </tr>
