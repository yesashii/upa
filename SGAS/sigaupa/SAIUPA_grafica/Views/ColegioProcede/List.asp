      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Periodo','Sede','MUNICIPAL','PARTICULAR','PARTICULAR SUBVENCIONADO','SIN CLASIFICACION']
					   ...
					   cadena = cadena + cabe
						if chequeo_2005 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.procedencia)= "MUNICIPAL" then
							...
							valor_periodo = 0
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.procedencia)= "PARTICULAR PAGADO" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
							...
							valor_periodo = 0
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.procedencia)= "PARTICULAR SUBVENCIONADO" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
							...
							valor_periodo = 0
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.procedencia)= "SIN CLASIFICACION" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
	  ...
	  var data_Facultad = google.visualization.arrayToDataTable([
          ['Periodo','Facultad','MUNICIPAL','PARTICULAR','PARTICULAR SUBVENCIONADO','SIN CLASIFICACION']
		       <%Dim obj_f
			      cadena = ""
				  facu_seleccionada = ""
 ...
 //Para Jornada
	  var data_Jornada = google.visualization.arrayToDataTable([
          ['Periodo','Jornada','MUNICIPAL','PARTICULAR','PARTICULAR SUBVENCIONADO','SIN CLASIFICACION']
		       <%Dim obj_j
			      cadena = ""
				  jorn_seleccionada = "" 
	  ...
	  var data_Carrera = google.visualization.arrayToDataTable([
          ['Periodo','Carrera','MUNICIPAL','PARTICULAR','PARTICULAR SUBVENCIONADO','SIN CLASIFICACION']
		       <%Dim obj_c
			      cadena = ""
				  carr_seleccionada = "" 
    ...
    <!-- <div class='GridViewScrollContainer'>-->
     <div id="cuadro0">
     <br />
     <h1>N° de alumnos matriculados por colegio de procedencia</h1>
     <p><i>"Cantidad de alumnos matriculados para el período en curso, según tipo de colegio de procedencia de enseñanza media".</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="9" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","ColegioProcede","List_excel", "partial=excel"&complemento_url)%>
