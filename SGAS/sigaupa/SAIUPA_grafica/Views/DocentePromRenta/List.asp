      ...
      <script type="text/javascript">
          ...
          var Controller ='DocentePromRenta';
          var Action = 'List';
      </script>
			...
			jQuery(document).ready(function(){
				jQuery("#tablaFacultad").gvChart({
					...
					gvSettings: {
						...
						hAxis: {title: "Periodo"},
						width: 500,
						colors:['#90c7a0','#eda64d','#1998cc','#f1f25a','#79ce5b'],
						height: 220
						}
				});
				...
				jQuery("#tablaHoras").gvChart({
					...
					gvSettings: {
						...
						hAxis: {title: "Periodo"},
						width: 500,
						colors:['#fa7874','#90c7a0','#eda64d','#1998cc','#f1f25a','#79ce5b'],
						height: 220
						}
				});	
     ...
     <div id="cuadro0">
     <br />
     <h1>Promedio Renta Docentes en UF</h1>
     <p><i>"Evolución de la renta mensual de un docente jornada completa de la unidad".</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="10" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","DocentePromRenta","List_excel", "partial=excel"&complemento_url)%>
                   ...
                   <td  width="40%" align="center" style='font-size: 0.6em;'>
                        <br />
                            <table id='tablaFacultad' style="display:none">
                              <caption>Promedio Renta Docentes en UF</caption>
                              <thead>
                                 <tr>
                                  <th></th>
                                  <%if chequeo_2009 <> "" then%>
                                ...
                                <tr>
                                  ...
                                  <%if chequeo_2009 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2_t.a2009),",",".") %></td>
                                  <%end if%>
                                  <%if chequeo_2010 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2_t.a2010),",",".") %></td>
                                  <%end if%>
                                  <%if chequeo_2011 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2_t.a2011),",",".") %></td>
                                  <%end if%>
                                  <%if chequeo_2012 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2_t.a2012),",",".") %></td>
                                  <%end if%>
                                  <%if chequeo_2013 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2_t.a2013),",",".") %></td>
                                  <%end if%>
								  <%if chequeo_2014 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2_t.a2014),",",".") %></td>
                                  <%end if%>
                                  <%if chequeo_2015 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2_t.a2015),",",".") %></td>
                                  <%end if%>
                                </tr>
                                  <% 
                                Next
                   ...
                   <td  width="40%" align="center" style='font-size: 0.6em;'>
                        <br />
                             <table id='tablaHoras' style="display:none">
                              <caption>Promedio valor hora en UF</caption>
                              <thead>
                                 <tr>
                                  <th></th>
                                  <%if chequeo_2009 <> "" then%>
                                ...
                                <tr>
                                  ...
                                  <%if chequeo_2009 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2h_t.a2009),",",".") %></td>
                                  <%end if%>
                                  <%if chequeo_2010 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2h_t.a2010),",",".") %></td>
                                  <%end if%>
                                  <%if chequeo_2011 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2h_t.a2011),",",".") %></td>
                                  <%end if%>
                                  <%if chequeo_2012 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2h_t.a2012),",",".") %></td>
                                  <%end if%>
                                  <%if chequeo_2013 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2h_t.a2013),",",".") %></td>
                                  <%end if%>
								  <%if chequeo_2014 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2h_t.a2014),",",".") %></td>
                                  <%end if%>
                                  <%if chequeo_2015 <> "" then%>
                                  <td><%=replace(Html.Encode(obj2h_t.a2015),",",".") %></td>
                                  <%end if%>
                                </tr>
                                  <% 
                                Next
