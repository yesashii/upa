      <%
	    Response.AddHeader "Content-Disposition", "attachment;filename=total_docentes_promedio_renta.xls"
      ...
      <table width="100%">
       	<tr>
        	          <th align="center" bgcolor="#99CC00">Promedio Renta Docentes en UF</th>
        ...
        <tr>
        	          <th align="center" bgcolor="#FF9900">Promedio valor hora en UF</th>
                      <%if chequeo_2009 <> "" then%>
