      <%
	    Response.AddHeader "Content-Disposition", "attachment;filename=PSU_Mínimo_nuevos.xls"
        Response.ContentType = "application/vnd.ms-excel"
	  %>
      <script type="text/javascript">
          //two variables Controller and Action have to be initialized in the View HTML code
          var Controller ='PsuMínimo';
      ...
      <html>
      <head>
      <title>Indicador de PSU mínimo registrado para alumnos nuevos</title>
