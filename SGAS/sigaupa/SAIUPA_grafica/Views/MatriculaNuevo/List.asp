      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Periodo','Sede','Promedio Matricula UF']
					...
					if instr(cadena, cabe) = 0 then 
					   cadena = cadena + cabe
						if chequeo_2005 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe then
								valor_periodo = replace(Html.Encode(obj01.a2005),",",".")
							  end if
							next
						...
						if chequeo_2006 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe then
								valor_periodo = replace(Html.Encode(obj01.a2006),",",".")
							  end if
							next
							response.Write(valor_periodo+"]")
						end if
						if chequeo_2007 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe then
								valor_periodo = replace(Html.Encode(obj01.a2007),",",".")
							  end if
							next
							response.Write(valor_periodo+"]")
						end if
						if chequeo_2008 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe then
								valor_periodo = replace(Html.Encode(obj01.a2008),",",".")
							  end if
							next
							response.Write(valor_periodo+"]")
						end if
						if chequeo_2009 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe then
								valor_periodo = replace(Html.Encode(obj01.a2009),",",".")
							  end if
							next
							response.Write(valor_periodo+"]")
						end if
						if chequeo_2010 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe then
								valor_periodo = replace(Html.Encode(obj01.a2010),",",".")
							  end if
							next
							response.Write(valor_periodo+"]")
						end if
						if chequeo_2011 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe  then
								valor_periodo = replace(Html.Encode(obj01.a2011),",",".")
							  end if
							next
							response.Write(valor_periodo+"]")
						end if
						if chequeo_2012 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe then
								valor_periodo = replace(Html.Encode(obj01.a2012),",",".")
							  end if
							next
							response.Write(valor_periodo+"]")
						end if
						if chequeo_2013 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe then
								valor_periodo = replace(Html.Encode(obj01.a2013),",",".")
							  end if
							next
							response.Write(valor_periodo+"]")
						end if
						if chequeo_2014 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe then
								valor_periodo = replace(Html.Encode(obj01.a2014),",",".")
							  end if
							next
							response.Write(valor_periodo+"]")
						end if
						if chequeo_2015 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe then
								valor_periodo = replace(Html.Encode(obj01.a2015),",",".")
							  end if
							next
							response.Write(valor_periodo+"]")
						end if
	  ...
	  var data_Facultad = google.visualization.arrayToDataTable([
          ['Periodo','Facultad','Promedio Matricula UF']
		       <%Dim obj_f
			      cadena = ""
				  facu_seleccionada = ""
	  ...
	  var data_Jornada = google.visualization.arrayToDataTable([
          ['Periodo','Jornada','Promedio Matricula UF']
		       <%Dim obj_j
			      cadena = ""
				  jorn_seleccionada = ""
	  ...
	  var data_Carrera = google.visualization.arrayToDataTable([
          ['Periodo','Carrera','Promedio Matricula UF']
		       <%Dim obj_c
			      cadena = ""
				  carr_seleccionada = ""
     ...
     <div id="cuadro0">
     <br />
     <h1>Valor matricula alumnos 1er año (UF)</h1>
     <p><i>"Valor  en unidad de fomento de la matricula al primer año de la carrera para este período."</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="10" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","MatriculaNuevo","List_excel", "partial=excel"&complemento_url)%>
