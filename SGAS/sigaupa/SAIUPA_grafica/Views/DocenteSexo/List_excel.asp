      <%
	    Response.AddHeader "Content-Disposition", "attachment;filename=total_docentes_sexo.xls"
        Response.ContentType = "application/vnd.ms-excel"
	  %>
      <script type="text/javascript">
          //two variables Controller and Action have to be initialized in the View HTML code
          var Controller ='DocenteSexo';
      ...
      <html>
      <head>
      <title>Indicador de Docentes por sexo</title>
      <meta http-equiv="Content-Type" content="text/html;">
      </head>
      <body >
      <table width="100%">
       	<tr>
        	          <th align="center" bgcolor="#99CC00">Docentes por Sexo</th>
        ...
        <tr>
        	          <th align="center" bgcolor="#FF9900">Horas Semanales por Sexo</th>
                      <%if chequeo_2009 <> "" then%>
