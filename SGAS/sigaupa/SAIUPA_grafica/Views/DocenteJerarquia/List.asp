     ...
     <div id="cuadro0">
     <br />
     <h1>N° de docentes por Jerarquia</h1>
     <p><i>"Cantidad de docentes y total de horas cronológicas semanales, distribuidas por Jerarquia".</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="9" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","DocenteJerarquia","List_excel", "partial=excel"&complemento_url)%>
                   ...
                   <td  width="40%" align="center" style='font-size: 0.6em;'>
                        <br />
                            <table id='tablaFacultad' style="display:none">
                              <caption>N° de Docentes por Jerarquia</caption>
                              <thead>
                                 <tr>
                                  <th></th>
                                  <%if chequeo_2009 <> "" then%>
                   ...
                   <td  width="40%" align="center" style='font-size: 0.6em;'>
                        <br />
                             <table id='tablaHoras' style="display:none">
                              <caption>Horas semanales por Jerarquia</caption>
                              <thead>
                                 <tr>
                                  <th></th>
                                  <%if chequeo_2009 <> "" then%>
