      <%
	    Response.AddHeader "Content-Disposition", "attachment;filename=total_docentes_jornada.xls"
        Response.ContentType = "application/vnd.ms-excel"
	  %>
      <script type="text/javascript">
          //two variables Controller and Action have to be initialized in the View HTML code
          var Controller ='DocenteJerarquia';
      ...
      <html>
      <head>
      <title>Indicador de Docentes por jerarquia</title>
      <meta http-equiv="Content-Type" content="text/html;">
      </head>
      <body >
      <table width="100%">
       	<tr>
        	          <th align="center" bgcolor="#99CC00">Docentes por Jerarquia</th>
        ...
        <tr>
        	          <th align="center" bgcolor="#FF9900">Horas Semanales por Jerarquia</th>
                      <%if chequeo_2009 <> "" then%>
                      ...
                      <%end if%>
					  <%if chequeo_2014 <> "" then%>
                      <th bgcolor="#FF9900">2014</th>
                      <%end if%>
                       <%if chequeo_2015 <> "" then%>
                      <th bgcolor="#FF9900">2015</th>
                      <%end if%>
         </tr>
        ...
        <tr>
                      ...
                      <%end if%>
					  <%if chequeo_2014 <> "" then%>
                      <td><%=Html.Encode(obj_tot_horas.a2014) %></td>
                      <%end if%>
                      <%if chequeo_2015 <> "" then%>
                      <td><%=Html.Encode(obj_tot_horas.a2015) %></td>
                      <%end if%>
        </tr>
                      <% 
                    Next
