	  ...
	  if request.form("c2014")="" then
	  	chequeo_2014=""
	  else
	    complemento_url = complemento_url&"&e2014=1"
		maximo_anio = 2014
	  end if
	   if request.form("c2015")="" then
	  	chequeo_2015=""
	  else
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Periodo','Sede','Total Extranjeros']
	  ...
	  var data_Facultad = google.visualization.arrayToDataTable([
          ['Periodo','Facultad','Total Extranjeros']
		       <%Dim obj_f
			      cadena = ""
				  facu_seleccionada = ""
	  ...
	  var data_Jornada = google.visualization.arrayToDataTable([
          ['Periodo','Jornada','Total Extranjeros']
		       <%Dim obj_j
			      cadena = ""
				  jorn_seleccionada = ""
	  ...
	  var data_Carrera = google.visualization.arrayToDataTable([
          ['Periodo','Carrera','Total Extranjeros']
		       <%Dim obj_c
			      cadena = ""
				  carr_seleccionada = ""
     ...
     <div id="cuadro0">
     <br />
     <h1>N° de extranjeros matriculados 1er año</h1>
     <p><i>"Cantidad de alumnos extranjeros matriculados a primer año de la carrera para el período en curso".</i></p>
     ...
     <div id="capa1">
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
						...
						<td width="10%" align="center"><input type="checkbox" disabled name="c2014" value="2014" <%=chequeo_2014%> onChange="document.formu_anos.submit();" ></td>
                        <td width="10%" align="center"><input type="checkbox" name="c2015" value="2015" <%=chequeo_2013%> onChange="document.formu_anos.submit();" ></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    	<td colspan="10" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","ExtrNuevo","List_excel", "partial=excel"&complemento_url)%>
