      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Periodo','Sede','15 a 19 años','20 a 24 años','25 a 29 años','30 a 34 años','35 a 39 años','40 y más años','SIN INFORMACION']
					   ...
					   cadena = cadena + cabe
						if chequeo_2005 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and replace(replace(Html.Encode(obj01.RangoEdad),"más","mas")," años","") = "15 a 19" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and replace(replace(Html.Encode(obj01.RangoEdad),"más","mas")," años","") = "20 a 24" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and replace(replace(Html.Encode(obj01.RangoEdad),"más","mas")," años","") = "25 a 29" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and replace(replace(Html.Encode(obj01.RangoEdad),"más","mas")," años","") = "30 a 34" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and replace(replace(Html.Encode(obj01.RangoEdad),"más","mas")," años","") = "35 a 39" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and replace(replace(Html.Encode(obj01.RangoEdad),"más","mas")," años","") = "40 y mas" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.RangoEdad)= "SIN INFORMACION" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
								response.Write(cstr(valor_periodo)+"]")
							else
								response.Write("0]")
							end if
						end if 
						...
						if chequeo_2014 <> "" then
							...
							response.Write(",['2015','"+cabe+"',")
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and replace(replace(Html.Encode(obj01.RangoEdad),"más","mas")," años","") = "15 a 19" then
								valor_periodo = Html.Encode(obj01.a2015)
							  end if
							next
							if isNumeric(valor_periodo) then
								response.Write(valor_periodo+",")
	  ...
	  var data_Facultad = google.visualization.arrayToDataTable([
          ['Periodo','Facultad','15 a 19 años','20 a 24 años','25 a 29 años','30 a 34 años','35 a 39 años','40 y más años','SIN INFORMACION']
		       <%Dim obj_f
			      cadena = ""
				  facu_seleccionada = ""
	  ...
	  var data_Jornada = google.visualization.arrayToDataTable([
          ['Periodo','Jornada','15 a 19 años','20 a 24 años','25 a 29 años','30 a 34 años','35 a 39 años','40 y más años','SIN INFORMACION']
		       <%Dim obj_j
			      cadena = ""
				  jorn_seleccionada = ""
	  ...
	  var data_Carrera = google.visualization.arrayToDataTable([
          ['Periodo','Carrera','15 a 19 años','20 a 24 años','25 a 29 años','30 a 34 años','35 a 39 años','40 y más años','SIN INFORMACION']
		       <%Dim obj_c
			      cadena = ""
				  carr_seleccionada = ""
    ...
    <!-- <div class='GridViewScrollContainer'>-->
     <div id="cuadro0">
     <br />
     <h1>Alumnos de 1er año por rango de edad (SIES)</h1>
     <p><i>"Cantidad de alumnos matriculados a primer año de la carrera durante este período, según rango de edad utilizado por el Ministerio de Educación".</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="9" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","MatrXEdadSIES","List_excel", "partial=excel"&complemento_url)%>
                                ...
                                <td width="100%" align="center">
                                	<table bgcolor="#FFFFFF" class="tabla">
                                        ...
                                        <tr>
                                          ...
                                          <%end if%>
										  <%if chequeo_2014 <> "" then%>
                                          <td colspan="2" bgcolor="#e85900"><font color="#FFFFFF" size="2"><strong><%=Html.Encode(obj_tot_facu.a2014) %></strong></font></td>
                                          <%end if%>
                                        </tr>
                                          <% 
                                        Next
                            ...
                            <tr>
                                ...
                                <table bgcolor="#FFFFFF" class="tabla">
                                    ...
                                    <tr>
                                      ...
                                      <%end if%>
									  <%if chequeo_2014 <> "" then%>
                                      <td colspan="2" bgcolor="#e85900"><font color="#FFFFFF" size="2"><strong><%=Html.Encode(obj_tot_jorn.a2014) %></strong></font></td>
                                      <%end if%>
                                      <%if chequeo_2015 <> "" then%>
                                      <td colspan="2" bgcolor="#e85900"><font color="#FFFFFF" size="2"><strong><%=Html.Encode(obj_tot_jorn.a2015) %></strong></font></td>
                                      <%end if%>
                                    </tr>
                                      <% 
                                    Next
                            ...
                            <tr>
                                ...
                                <table bgcolor="#FFFFFF" class="tabla">
                                    ...
                                    <tr>
                                      ...
                                      <%end if%>
                                      <%if chequeo_2015 <> "" then%>
                                      <td colspan="2" bgcolor="#e85900"><font color="#FFFFFF" size="2"><strong><%=Html.Encode(obj_tot_carr.a2015) %></strong></font></td>
                                      <%end if%>
                                    </tr>
                                    <% 
                                    Next
