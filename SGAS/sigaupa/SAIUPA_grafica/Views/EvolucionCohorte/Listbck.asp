	  ...
	  if maximo_anio <> "2014" then   chequeo_2014=""  end if
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Cohorte','Sede','Matr. Cohorte'
		   ...
		   <%'if maximo_anio + 14 <=  v_anio_actual then  response.Write(",'Año N°15'")  end if%>
		 ]
		   <%Dim obj0,obj01,obj02, valor_periodo,cabe
                  ...
                  For each obj0 in Model.Items
					...
					if anio_registro = maximo_anio then
						...
						'END IF
                        response.Write(",['"+anio_registro+"','"+cabe+"',"+Html.Encode(obj0.a_anos_0))
						if anio_registro + 1 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_1)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 2 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_2)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 3 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_3)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 4 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_4)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 5 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_5)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 6 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_6)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 7 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_7)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 8 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_8)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 9 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_9)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 10 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_10)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 11 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_11)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 12 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_12)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 13 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj0.a_anos_13)
							response.Write(","+valor_periodo)
						end if 
						'if anio_registro + 14 <=  v_anio_actual then
						'	valor_periodo = Html.Encode(obj0.a_anos_13)
						'	response.Write(","+valor_periodo)
						'end if 
						response.Write("]")
		   ...
		   <%     cadena = ""
                  ...
                  For each obj_f in ModelFacultad.Items
					...
					if anio_registro = maximo_anio then
						...
						'END IF
                        response.Write(",['"+anio_registro+"','"+cabe+"',"+Html.Encode(obj_f.a_anos_0))
						if anio_registro + 1 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_1)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 2 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_2)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 3 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_3)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 4 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_4)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 5 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_5)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 6 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_6)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 7 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_7)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 8 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_8)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 9 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_9)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 10 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_10)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 11 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_11)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 12 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_12)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 13 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_13)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 14 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_f.a_anos_13)
		   ...
		   <%     cadena = ""
                  ...
                  For each obj_j in ModelJornada.Items
					...
					if anio_registro = maximo_anio then
						...
						'END IF
                        response.Write(",['"+anio_registro+"','"+cabe+"',"+Html.Encode(obj_j.a_anos_0))
						if anio_registro + 1 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_1)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 2 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_2)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 3 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_3)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 4 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_4)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 5 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_5)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 6 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_6)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 7 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_7)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 8 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_8)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 9 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_9)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 10 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_10)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 11 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_11)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 12 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_12)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 13 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_13)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 14 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_j.a_anos_13)
		   ...
		   <%     cadena = ""
                  ...
                  For each obj_c in ModelCarrera.Items
					...
					if anio_registro = maximo_anio then
						...
						END IF
                        response.Write(",['"+anio_registro+"','"+cabe+"',"+Html.Encode(obj_c.a_anos_0))
						if anio_registro + 1 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_1)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 2 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_2)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 3 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_3)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 4 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_4)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 5 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_5)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 6 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_6)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 7 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_7)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 8 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_8)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 9 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_9)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 10 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_10)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 11 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_11)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 12 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_12)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 13 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_13)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 14 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_c.a_anos_13)
		   ...
		   <%     cadena = ""
                  For each obj_cd in ModelCarreraDetalle.Items
					...
					if anio_registro = maximo_anio then
						...
						if anio_registro + 1 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_1)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 2 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_2)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 3 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_3)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 4 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_4)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 5 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_5)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 6 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_6)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 7 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_7)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 8 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_8)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 9 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_9)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 10 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_10)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 11 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_11)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 12 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_12)
							response.Write(","+valor_periodo)
						end if 
						if anio_registro + 13 <=  v_anio_actual then
							valor_periodo = Html.Encode(obj_cd.a_anos_13)
							response.Write(","+valor_periodo)
						end if 
						response.Write("]")
						if anio_registro + 14 <=  v_anio_actual then
       ...
       var periodoPicker = new google.visualization.ControlWrapper({
        ...
        var ColumnChartSede = new google.visualization.ChartWrapper({
          ...
          'view': {'columns': [1,2
					...
					<%if maximo_anio + 14 <=  v_anio_actual then  response.Write(",16")  end if%>
		          ]}
        });
		...
		var table_carr_det = new google.visualization.ChartWrapper({
		  ...
		  'view': {'columns': [0,2,3
					...
					<%if maximo_anio + 14 <=  v_anio_actual then  response.Write(",17")  end if%>
		  ]}
        });
     ...
     <div id="cuadro0">
     <br />
     <h1>Evolución de Cohortes</h1>
     <p><i>"Cantidad de alumnos matriculados a primer año de la carrera para la cohorte ingresada y su comportamiento histórico".</i></p> 
     ...
     <div id="capa1">
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                        ...
                        <td align="center"><input type="radio" name="anio_consulta" value="2014" <%=chequeo_2014%> onChange="document.formu_anos.submit();" ></td>
                    </tr>
                    <tr>
                        ...
                        <td align="center"><font color="#999999">2014</font></td>
                    </tr>
                    <tr>
                    	<td colspan="13" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","EvolucionCohorte","List_excel", "partial=excel"&complemento_url)%>
