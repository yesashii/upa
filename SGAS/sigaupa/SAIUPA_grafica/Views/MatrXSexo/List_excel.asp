      <%
	    Response.AddHeader "Content-Disposition", "attachment;filename=total_matriculados_por_sexo.xls"
        Response.ContentType = "application/vnd.ms-excel"
	  %>
      <script type="text/javascript">
          //two variables Controller and Action have to be initialized in the View HTML code
          var Controller ='MatrXSexo';
      ...
      <html>
      <head>
      <title>Indicador de Matriculados por Sexo</title>
      ...
      <table width="100%">
	   ...
	   <tr>
                      ...
                      <th align="center" bgcolor="#CC9900">Sexo</th>
                      <%if chequeo_2005 <> "" then%>
        ...
        <tr>
                      ...
                      <td align="left"><%=Html.Encode(obj2.sexo) %></td>
                      <%if chequeo_2005 <> "" then%>
        ...
        <tr>
		 ...
		 <tr>  
                      ...
                      <th align="center" bgcolor="#3399CC">Sexo</th>
                      <%if chequeo_2005 <> "" then%>
         ...
         <tr>
                      ...
                      <td align="left"><%=Html.Encode(obj3.sexo) %></td>
                      <%if chequeo_2005 <> "" then%>
         ...
         <tr>
                      ...
                      <th align="center" bgcolor="#CC6600">Sexo</th>
                      <%if chequeo_2005 <> "" then%>
           ...
           <tr>
                      ...
                      <td align="left"><%=Html.Encode(obj4.sexo) %></td>
                      <%if chequeo_2005 <> "" then%>
