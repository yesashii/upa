      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Periodo','Sede','Femenino','Masculino']
					   ...
					   cadena = cadena + cabe
						if chequeo_2005 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.sexo)= "Femenino" then
							...
							valor_periodo = 0
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.sexo)= "Masculino" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							response.Write(valor_periodo+"]")
	  ...
	  var data_Facultad = google.visualization.arrayToDataTable([
          ['Periodo','Facultad','Femenino','Masculino']
		       <%Dim obj_f
			      cadena = ""
				  facu_seleccionada = ""
	  ...
	  var data_Jornada = google.visualization.arrayToDataTable([
          ['Periodo','Jornada','Femenino','Masculino']
		       <%Dim obj_j
			      cadena = ""
				  jorn_seleccionada = ""
	  ...
	  var data_Carrera = google.visualization.arrayToDataTable([
          ['Periodo','Carrera','Femenino','Masculino']
		       <%Dim obj_c
			      cadena = ""
				  carr_seleccionada = ""
     ...
     <div id="cuadro0">
     <br />
     <h1>Total matriculados por género (sexo)</h1>
     <p></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="10" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","MatrXSexo","List_excel", "partial=excel"&complemento_url)%>
