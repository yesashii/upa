      <%
	    Response.AddHeader "Content-Disposition", "attachment;filename=total_matriculados_por_rango_edad_Autoev.xls"
	  ...
	  if request.QueryString("e2015")="" then
	  	chequeo_2015=""
	  end if
	  %>
      <html>
      <head>
      <title>Indicador de Matriculados por Rango Edad Autoevaluación</title>
      ...
      <table width="100%">
       	<tr>
                      ...
                      <th bgcolor="#99CC00">2014</th>
                      <%end if%>
                       <%if chequeo_2015 <> "" then%>
                      <th bgcolor="#99CC00">2015</th>
                      <%end if%>
         </tr>
        ...
        <tr>
                    ...
                    %>
        <tr>
                      <td colspan="2" align="right"><strong><%=Html.Encode(obj_tot_sede.cabecera) %></strong></td>
                      <%if chequeo_2005 <> "" then%>
                      ...
                      <%end if%>
					  <%if chequeo_2014 <> "" then%>
                      <td><%=Html.Encode(obj_tot_sede.a2014) %></td>
                      <%end if%>
                      <%if chequeo_2015 <> "" then%>
                      <td><%=Html.Encode(obj_tot_sede.a2015) %></td>
                      <%end if%>
        </tr>
                      <% 
                    Next
	   ...
	   <!--<tr>
                      ...
                      <th align="center" bgcolor="#CC9900">Rango Edad</th>
                      <%if chequeo_2005 <> "" then%>
        ...
        <tr>
                      ...
                      <td align="left"><%=Html.Encode(obj2.RangoEdad) %></td>
                      <%if chequeo_2005 <> "" then%>
                    ...
                    %>
        <tr>
                      <td colspan="2" align="right"><strong><%=Html.Encode(obj_tot_facu.cabecera) %></strong></td>
                      <%if chequeo_2005 <> "" then%>
                      ...
                      <%end if%>
					  <%if chequeo_2014 <> "" then%>
                      <td><%=Html.Encode(obj_tot_facu.a2014) %></td>
                      <%end if%>
         </tr>
                      <% 
                    Next
		 ...
		 <tr>  
                      ...
                      <th align="center" bgcolor="#3399CC">Rango Edad</th>
                      <%if chequeo_2005 <> "" then%>
                      ...
                      <%end if%>
					  <%if chequeo_2014 <> "" then%>
                      <th bgcolor="#3399CC">2014</th>
                      <%end if%>
                      <%if chequeo_2015 <> "" then%>
                      <th bgcolor="#3399CC">2015</th>
                      <%end if%>
          </tr>
         ...
         <tr>
                      ...
                      <td align="left"><%=Html.Encode(obj3.RangoEdad) %></td>
                      <%if chequeo_2005 <> "" then%>
                      ...
                      <%end if%>
					  <%if chequeo_2014 <> "" then%>
                      <td><%=Html.Encode(obj3.a2014) %></td>
                      <%end if%>
                      <%if chequeo_2015 <> "" then%>
                      <td><%=Html.Encode(obj3.a2015) %></td>
                      <%end if%>
         </tr>
                      <% 
                    Next
                    ...
                    %>
         <tr>
                      <td colspan="2" align="right"><strong><%=Html.Encode(obj_tot_jorn.cabecera) %></strong></td>
                      <%if chequeo_2005 <> "" then%>
                      ...
                      <%end if%>
					  <%if chequeo_2014 <> "" then%>
                      <td><%=Html.Encode(obj_tot_jorn.a2014) %></td>
                      <%end if%>
                      <%if chequeo_2015 <> "" then%>
                      <td><%=Html.Encode(obj_tot_jorn.a2015) %></td>
                      <%end if%>
         </tr>
                      <% 
                    Next
         ...
         <tr>
                      ...
                      <th align="center" bgcolor="#CC6600">Rango Edad</th>
                      <%if chequeo_2005 <> "" then%>
                      ...
                      <%end if%>
					  <%if chequeo_2014 <> "" then%>
                      <th bgcolor="#CC6600">2014</th>
                      <%end if%>
                       <%if chequeo_2015 <> "" then%>
                      <th bgcolor="#CC6600">2015</th>
                      <%end if%>
           </tr>
           ...
           <tr>
                      ...
                      <td align="left"><%=Html.Encode(obj4.RangoEdad) %></td>
                      <%if chequeo_2005 <> "" then%>
                      ...
                      <%end if%>
					  <%if chequeo_2014 <> "" then%>
                      <td><%=Html.Encode(obj4.a2014) %></td>
                      <%end if%>
                      <%if chequeo_2015 <> "" then%>
                      <td><%=Html.Encode(obj4.a2015) %></td>
                      <%end if%>
           </tr>
                    <% 
                    Next
                    ...
                    %>
           <tr>
                      <td colspan="2" align="right"><strong><%=Html.Encode(obj_tot_carr.cabecera) %></strong></td>
                      <%if chequeo_2005 <> "" then%>
                      ...
                      <%end if%>
					  <%if chequeo_2014 <> "" then%>
                      <td><%=Html.Encode(obj_tot_carr.a2014) %></td>
                      <%end if%>
                      <%if chequeo_2015 <> "" then%>
                      <td><%=Html.Encode(obj_tot_carr.a2015) %></td>
                      <%end if%>
           </tr>
                    <% 
                    Next
