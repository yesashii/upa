      ...
      <script type="text/javascript">
          ...
          var Controller ='MatrXEdadAutoev';
          var Action = 'List';
      </script>
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
          ['Periodo','Sede','Menor o igual a 18 años','Mayor que 18 y menor o igual a 21','Mayor que 21 y menor o igual a 25','mayor de 25 años','SIN INFORMACION']
					   ...
					   cadena = cadena + cabe
						if chequeo_2005 <> "" then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.RangoEdad)= "Menor o igual a 18 " then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.RangoEdad)= "Mayor que 18 y menor o igual a 21" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.RangoEdad)= "Mayor que 21 y menor o igual a 25" then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
							...
							For each obj01 in Model.Items
							  if Html.Encode(obj01.cabecera) = cabe and Html.Encode(obj01.RangoEdad)= "mayor de 25 " then
								valor_periodo = Html.Encode(obj01.a2005)
							  end if
							next
							if isNumeric(valor_periodo) then
	  ...
	  var data_Facultad = google.visualization.arrayToDataTable([
          ['Periodo','Facultad','Menor o igual a 18 años','Mayor que 18 y menor o igual a 21','Mayor que 21 y menor o igual a 25','mayor de 25 años','SIN INFORMACION']
		       <%Dim obj_f
			      cadena = ""
				  facu_seleccionada = ""
	  ...
	  var data_Jornada = google.visualization.arrayToDataTable([
          ['Periodo','Jornada','Menor o igual a 18 años','Mayor que 18 y menor o igual a 21','Mayor que 21 y menor o igual a 25','mayor de 25 años','SIN INFORMACION']
		       <%Dim obj_j
			      cadena = ""
				  jorn_seleccionada = ""
	  ...
	  var data_Carrera = google.visualization.arrayToDataTable([
          ['Periodo','Carrera','Menor o igual a 18 años','Mayor que 18 y menor o igual a 21','Mayor que 21 y menor o igual a 25','mayor de 25 años','SIN INFORMACION']
		       <%Dim obj_c
			      cadena = ""
				  carr_seleccionada = ""
                  For each obj_c in ModelCarrera.Items
				    cabe = replace(replace(replace(replace(replace(replace(Html.Encode(obj_c.cabecera),"Ñ","N"),"Á","A"),"É","E"),"Í","I"),"Ó","O"),"Ú","U")
    ...
    <!-- <div class='GridViewScrollContainer'>-->
     <div id="cuadro0">
     <br />
     <h1>Alumnos de 1er año por rango de edad (Autoevaluación)</h1>
     <p><i>"Cantidad de alumnos matriculados a primer año de la carrera durante este período, según rango de edad utilizado por el sistema de autoevaluación".</i></p>
               ...
               <table width="90%" align="center">
                    ...
                    <tr>
                    	<td colspan="9" align="right">
				            <%=Html.ActionLink("<div class='btn' align='right'>Obtener Excel</div>","MatrXEdadAutoev","List_excel", "partial=excel"&complemento_url)%>
