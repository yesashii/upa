      <%
	    Response.AddHeader "Content-Disposition", "attachment;filename=total_docentes_edad.xls"
      ...
      <html>
      <head>
      <title>Indicador de Docentes por rango de edad</title>
      <meta http-equiv="Content-Type" content="text/html;">
      </head>
      <body >
      <table width="100%">
       	<tr>
        	          <th align="center" bgcolor="#99CC00">Docentes por Rango de edad</th>
        ...
        <tr>
        	          <th align="center" bgcolor="#009933">Horas Semanales Rango de edad</th>
                      <%if chequeo_2009 <> "" then%>
                      <th bgcolor="#99CC00">2009</th>
                      <%end if%>
                      <%if chequeo_2010 <> "" then%>
