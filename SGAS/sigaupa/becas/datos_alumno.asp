...
sql_carrera_postulante =   " SELECT d.carr_ccod + '/' + cast(isnull(protic.ano_ingreso_carrera(aa.pers_ncorr,d.carr_ccod),2006) as varchar) as carr_ccod ,D.CARR_TDESC +' '+ C.ESPE_TDESC as carr_tdesc  " &vbcrlf & _
							...
							" and cast(aa.peri_ccod as varchar)='"&periodo&"'" &vbcrlf &_ 
...
ano_primer_ingreso =   " SELECT aa.pers_ncorr,c.carr_ccod " &vbcrlf & _
							" from postulantes aa,detalle_postulantes a, ofertas_academicas b, " &vbcrlf & _
...
consulta = "  select b.pers_nrut, b.pers_xdv, b.pers_tape_paterno, b.pers_tape_materno, b.pers_tnombre, b.pers_ncorr," & vbCrLf &_
                ...
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td> 
                        ...
                        <tr>
                          <td width="70%">&nbsp;</td>
                          <td width="30%"><strong>FOLIO Nº </strong>
						     <%if esvacio(folio) then%>
                             <input type="text" name="pobe_nfolio" value="<%=folio%>" size="10" maxlength="10" id="NU-N">
							 <%else%>
							 <font size="+1" color="#CC0033"><%=folio%></font>
							 <input type="hidden" name="pobe_nfolio" value="<%=folio%>">
							 <%end if%>
                          </td>   
                        </tr>
                      </table>
                      ...
                      <table width="98%"  border="1" align="center" cellpadding="0" cellspacing="0">
                            <tr> 
                              <td width="40%"><strong>Fecha nacimiento </strong><br> <strong> 
                                ...
                                <input type="text" name="cod_estado" value="<%=estado_civil%>"  maxlength="2" size="2">
                                </strong> </td>
                            </tr>
                          </table>
                      <br>
					  ...
					  <br>
					      <table width="98%"  border="1" align="center" cellpadding="0" cellspacing="0">
                            <tr>
							 ...
							 <td align="center"><br><strong>Curso actual</strong> <br> <strong> 
                                <input type="text" name="pobe_nnivel" size="2" maxlength="2" value="<%=nivel%>">
                                </strong> </td>		
                            </tr>
                          </table>
                   </td>
