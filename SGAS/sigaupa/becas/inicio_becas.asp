...
f_busqueda.Carga_Parametros "inicio_becas.xml", "busqueda"
...
session("_periodo_POSTULACION") 	= 202
session("_periodo")= 202
...
if postulacion_con_familiar = "" or esVacio(postulacion_con_familiar) or isnull(postulacion_con_familiar) then 
	...
	postulacion_con_familiar = conexion.consultaUno("select a.post_ncorr from postulantes a, grupo_familiar b where a.post_ncorr = b.post_ncorr and cast(a.pers_ncorr as varchar)='"&pers_ncorr_temporal&"' and cast(a.peri_ccod as varchar)='"&v_peri_ccod&"' order by peri_ccod desc")
end if


if postulacion_con_familiar = "" or esVacio(postulacion_con_familiar) or isnull(postulacion_con_familiar) then 
	'response.Write("select a.post_ncorr from postulantes a, grupo_familiar b where a.post_ncorr = b.post_ncorr and cast(a.pers_ncorr as varchar)='"&pers_ncorr_temporal&"' and cast(a.peri_ccod as varchar)='"&v_peri_ccod&"' order by peri_ccod desc")
	postulacion_con_familiar = conexion.consultaUno("select a.post_ncorr from postulantes a, detalle_postulantes b where a.post_ncorr = b.post_ncorr and cast(a.pers_ncorr as varchar)='"&pers_ncorr_temporal&"' and cast(a.peri_ccod as varchar)='"&v_peri_ccod&"' and a.epos_ccod = 2 and b.eepo_ccod not in (1,3) order by peri_ccod desc")
end if
...
consulta = "select top 1 a.pers_ncorr,cast(a.pers_nrut as varchar) + '-' + a.pers_xdv as rut, " & vbCrLf &_
		   ...
		   " from personas_postulante a, postulantes b, ofertas_academicas c, aranceles d,detalle_postulantes e " & vbCrLf &_
		   " where a.pers_ncorr=b.pers_ncorr " & vbCrLf &_
                ...
                <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
				  ...
				  <tr>
				  		<td><%if (postulacion_con_familiar ="" or isnull(postulacion_con_familiar)) and q_pers_nrut <> "" then %>
							<div align="center" ><font size="3" color="#0000FF">Imposible realizar el proceso para este alumno ya que no presenta postulaciones para el semestre solicitado.</font></div> 
							<%end if%>
						</td>
				  </tr>
				  <tr>
