...
'###############################	MATRICULA	##################################
	...
	while f_consulta.Siguiente
		if f_consulta.ObtenerValor("ting_ccod") <> "3" and f_consulta.ObtenerValor("ting_ccod") <>"13" and f_consulta.ObtenerValor("ting_ccod") <>"51" then
...
'###############################	COLEGIATURA O ARANCEL 	##################################
	...
	i_ = 0
	while f_consulta.Siguiente
		if f_consulta.ObtenerValor("ting_ccod") <> "3"  and f_consulta.ObtenerValor("ting_ccod") <>"13" and f_consulta.ObtenerValor("ting_ccod") <>"51" and f_consulta.ObtenerValor("ting_ccod") <>"52" then		
		...
		'
		if f_consulta.ObtenerValor("ting_ccod") ="13" or f_consulta.ObtenerValor("ting_ccod") ="51"  or f_consulta.ObtenerValor("ting_ccod") ="52" then
...
consulta = "select '3' as max_cuotas_doc_matricula, " & vbCrLf &_
		   ...
		   "       '3' as max_cuotas_matricula, " & vbCrLf &_
...
if b_existe_fuas then
	msg_fuas="El alumno es beneficiario FUAS, debe documentar una letra por el valor referencial que cubra el credito y el resto en 10 documentos o segun corresponda."
	espacios=msg_fuas&"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
...
for (var i = 0; i < <%=f_detalle_pagos.NroFilas%>; i++) {
		if ((formulario.elements["detalle_pagos[" +i + "][c_ting_ccod]"].value==3) || (formulario.elements["detalle_pagos[" +i + "][c_ting_ccod]"].value==4) || (formulario.elements["detalle_pagos[" +i + "][c_ting_ccod]"].value==52)|| (formulario.elements["detalle_pagos[" +i + "][c_ting_ccod]"].value==13)|| (formulario.elements["detalle_pagos[" +i + "][c_ting_ccod]"].value==51) ) 
			{
...
//		+ parseInt(ncuotas_efec_matricula)
	...
	else
	 {
	   ...
	   if (frecuencia_anterior == 0 )
			  ...
			  if (estado == "matricula")
 			    {
				  ...
				  if ((fecha_efectivo == "")||(v_tipo_ingreso.value==6)||(v_tipo_ingreso.value==51))
			  ...
			  else
			   {
				 ...
				 if ((v_tipo_ingreso.value==6)||(v_tipo_ingreso.value==51)) // fecha actual para efectivo y tarjeta debito
				 	tabla.filas[p_fila].campos["sdfp_finicio_pago"].objeto.value = '<%=fc_datos.ObtenerValor("fecha_actual")%>';
			   }
			}
			else
		  ...
		  //alert("otra frecuencia");
				...
				if ((v_tipo_ingreso.value==6)||(v_tipo_ingreso.value==51)){
				    tabla.filas[p_fila].campos["sdfp_finicio_pago"].objeto.value = '<%=fc_datos.ObtenerValor("fecha_actual")%>';  
                    ...
                    <td><%pagina.DibujarSubtitulo "Datos del postulante"%>
                        ...
                        <div align="center">						
						  ...
						  <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
						   ...
						   <marquee><font color="#FF0000" size="3" style="font-style:italic; font-weight:bold; text-decoration:blink"><%=msg_fuas%></font></marquee>
						  <br><br>
