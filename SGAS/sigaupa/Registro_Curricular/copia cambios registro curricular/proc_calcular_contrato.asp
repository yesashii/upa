...
'	response.Write("<br>"&x&" -> "&response.Write(request.Form(x))) 
'next
'response.Write("<br>")
...
set f_elimina_fp_matricula = new CFormulario
f_elimina_fp_matricula.Carga_Parametros "genera_contrato_2.xml", "elimina_sdetalles_forma_pago"
f_elimina_fp_matricula.Inicializar conexion
f_elimina_fp_matricula.AgregaParam "variable", "fp_matricula"
f_elimina_fp_matricula.ProcesaForm
...
set f_elimina_fp_colegiatura = new CFormulario
f_elimina_fp_colegiatura.Carga_Parametros "genera_contrato_2.xml", "elimina_sdetalles_forma_pago"
f_elimina_fp_colegiatura.Inicializar conexion
f_elimina_fp_colegiatura.AgregaParam "variable", "fp_colegiatura"
f_elimina_fp_colegiatura.ProcesaForm
...
if EsVacio(v_stpa_ccod) then
	...
	'response.Write("<br>"&conexion.obtenerEstadoTransaccion&"<br>")
	f_forma_pago_matricula.MantieneTablas false
	'response.Write("<br>"&conexion.obtenerEstadoTransaccion&"<br>")
	f_forma_pago_colegiatura.MantieneTablas false
	'response.Write("<br>"&conexion.obtenerEstadoTransaccion&"<br>")
	f_elimina_fp_matricula.MantieneTablas false
	'response.Write("<br>"&conexion.obtenerEstadoTransaccion&"<br>")
	f_elimina_fp_colegiatura.MantieneTablas false
	'response.Write("<br>"&conexion.obtenerEstadoTransaccion&"<br>")
	...
	'conexion.EstadoTransaccion bejecutaP
'response.Write(sentencia&" ->"&conexion.obtenerEstadoTransaccion)
'response.End()	
	'-----------------------------------------------------------------------------------------------------
Response.Redirect("genera_contrato_2.asp?post_ncorr=" & Request.QueryString("post_ncorr") & "&#a_forma_pago")
