...
function Siguiente3()
{
  location.replace("Forma_Pago4.asp");
}
          ...
          <td height="0"><table border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="116" background="../imagenes/fondo1.gif" bgcolor="#D8D8DE"><div align="center"><font color="#FFFFFF">Generar
                ...
                <tr>
				 ...
				 <table width="632" border="0" align="center" bordercolor="#FFFFFF" bgcolor="#FFFFFF">
                      ...
                      <table width="632" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="224"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><b><font color="#666677" size="2">Generar
                          Contrato</font></b></font></td>
                          <td width="398">&nbsp;</td>
                        </tr>
                        <tr>
                      ...
                      <table width="632" border="0" align="center">
                        <tr>
                          <td width="85"><font size="2">Contrato</font></td>
                          <td width="18"><font size="2">:</font></td>
                          <td width="539"><font size="2">8989</font></td>
                        </tr>
                        <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="212" bgcolor="#D8D8DE"> <div align="right">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="2%">&nbsp;</td>
                        <td width="48%"><%botonera.dibujaboton "anterior3" %>
                        </td>
                        <td width="50%"><%botonera.dibujaboton "siguiente3"%></td>
                      </tr>
                    </table>
                  </div></td>
