...
botonera.carga_parametros "bloqueos.xml", "btn_activar_solicitudes"
...
function enviar(formulario){
		if(!(valida_rut(formulario.rut.value + '-' + formulario.dv.value))){
			...
			formulario.action = 'bloqueos1.asp';
			formulario.submit();
		}
}
                      ...
                      <tr> 
                        <td align="left"> 
                          ...
                          <br> <br> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr> 
                              <td align="center"><strong>LISTADO DE BLOQUEOS HIST&Oacute;RICOS 
                                </strong></td>
                            </tr>
                            <tr> 
                              <td align="right"> 
                          ...
                          * Para agregar un nuevo bloqueo, debe presionar el bot&oacute;n 
                          ...
                          <table width="1%" align="right" cellpadding="0" cellspacing="0">
                            <tr> 
                              <td><%botonera.dibujaboton "agregar"%><a href="javascript:agregar(document.editar);"><img src="images/agregar2.gif" width="66" height="20" border="0"></a></td>
                              <td>&nbsp;</td>
                              <td width="5%"></td>
                            </tr>
                          </table></td>
