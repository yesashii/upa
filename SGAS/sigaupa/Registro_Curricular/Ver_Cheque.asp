...
f_cheque.Carga_Parametros "genera_contrato_4.xml", "f_cheque"
f_cheque.Inicializar conexion



cc_cheque = "select case isnull(a.ding_bpacta_cuota,2) when 'S' then 1 else 2 end as pacta_cuota,a.ingr_ncorr,a.ting_ccod,a.ding_ndocto as ding_ndocto_c,a.ding_tcuenta_corriente," & vbCrLf &_
			"        a.ding_tcuenta_corriente as ding_tcuenta_corriente_c,a.ding_ndocto,a.banc_ccod," & vbCrLf &_
			"        a.banc_ccod as banc_ccod_c,convert(varchar,a.ding_fdocto,103) ding_fdocto,  " & vbCrLf &_
			"        a.DING_MDETALLE monto" & vbCrLf &_
			"    from detalle_ingresos a,bancos b" & vbCrLf &_
...
'response.Write("<pre>"&cc_cheque&"</pre>")
'response.End()
f_cheque.Consultar cc_cheque
f_cheque.siguiente
v_pacta=f_cheque.ObtenerValor("pacta_cuota")
              ...
              <td bgcolor="#D8D8DE">
                <form name="edicion">
                  <BR>
                          ...
                          <% f_cheque.DibujaCampo("ting_ccod") %>
                          <% f_cheque.DibujaCampo("banc_ccod") %>
                          <% f_cheque.DibujaCampo("ding_tcuenta_corriente") %>
						  <% f_cheque.DibujaCampo("ingr_ncorr") %>
						  <% f_cheque.DibujaCampo("pacta_cuota") %>
                    <table  border="0">
                      <tr> 
                        <td width="93"><font size="1">N&ordm; cheque</font></td>
                        <td width="17">:</td>
                        <td width="223"><font size="1"> 
                          <% f_cheque.DibujaCampo("ding_ndocto_c") %>
                          </font></td>
                      </tr>
                      <tr> 
                        ...
                        <td>:</td>
                        <td><font size="1"> 
                          <% f_cheque.DibujaCampo("banc_ccod_c") %>
                          </font></td>
                      </tr>
                      <tr>
                        ...
                        <td>:</td>
                        <td><font size="1">
                          <% f_cheque.DibujaCampo("ding_tcuenta_corriente_c") %>
                          </font></td>
                      </tr>
                      <tr> 
				...
				<%if v_pacta="1" then%>
                	<p>(<font color="#FF0000">*</font>) <font color="#0033FF">El cheque es parte de una pactacion, por lo que  la fecha del compromiso asociado tambien se modificará si corresponde. </font></p>
            	 	<p></p>
				<%end if%>
			  </td>
