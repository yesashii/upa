...
<%
cod_rol = Request.QueryString("codigo")
set pagina = new CPagina
pagina.Titulo = "Mantener Rol"
...
formulario.Carga_Parametros "Mant_Roles.xml", "f1_edicion"
formulario.Inicializar conexion

if cod_rol = "NUEVO" then
  srol_ncorr = conexion.consultauno("exec ObtenerSecuencia 'sis_roles'")	
  consulta = "select "&srol_ncorr&" as srol_ncorr, '' as srol_tdesc "
else
  consulta = "select * from sis_roles where srol_ncorr = " & cod_rol
end if
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <div align="left"><font color="#FFFFFF" size="1" face="Verdana, Arial, Helvetica, sans-serif">
	 					<% 
	  						if cod_rol = "NUEVO" then
        						Response.Write("Agrege el Nuevo Rol <BR>")
      						else
        						Response.Write("Modifique el Rol <BR>") 
      						end if    
                    ...
                    <table width="99%" border="0">
                      <tr> 
                        <td width="14%"> <div align="right"><strong> 
                            <%formulario.DibujaCampo("srol_ncorr") %>
                            Rol </strong></div></td>
                        <td width="7%"><div align="center"><strong>:</strong></div></td>
                        <td width="79%"> <%formulario.DibujaCampo("srol_tdesc")  %> </td>
                      </tr>
                    </table>
                    </form>
				  <br>				  </td>
