...
'-------------------------------------------------------------------
  ...
  if existe <> "" then
    sql = "SELECT   case isnull(b.sede_ccod,0) " & _
		  " when 0 then 0 " & _
		  " else 1 end as tiene_sede,  " & _
		" cast(cast('"&persona.ObtenerPersNCorr&"' as real) as numeric) as pers_ncorr,  a.sede_ccod, a.sede_tdesc, a.SEDE_TCALLE + ' ' + a.SEDE_TNRO as direccion_sede "&_ 
	   "FROM sedes a, sis_sedes_usuarios b "&_ 
