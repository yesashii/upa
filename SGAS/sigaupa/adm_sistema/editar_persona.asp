...
f_datos.Carga_Parametros "adm_personas.xml", "datos_persona"
f_datos.Inicializar conexion

set f_rut = new CFormulario
f_rut.Carga_Parametros "adm_personas.xml", "rut_persona"
...
'           "       b.dire_tcalle, b.dire_tnro, b.ciud_ccod, a.pers_temail, b.dire_tblock,b.dire_tdepto,b.dire_tpoblacion " & vbCrLf &_
...
"       a.pers_tfono, " & vbCrLf &_
"       b.dire_tcalle, " & vbCrLf &_
"       b.dire_tnro, " & vbCrLf &_
"       b.ciud_ccod, " & vbCrLf &_
"       a.pers_temail, " & vbCrLf &_
"       b.dire_tblock, " & vbCrLf &_
"       b.dire_tdepto, " & vbCrLf &_
"       b.dire_tpoblacion " & vbCrLf &_
"from   personas as a " & vbCrLf &_
"       left outer join direcciones as b " & vbCrLf &_
"                    on a.pers_ncorr = b.pers_ncorr " & vbCrLf &_
"                       and b.tdir_ccod = 1 " & vbCrLf &_
"where  a.pers_nrut = '" & q_pers_nrut & "'" & vbCrLf &_
"union " & vbCrLf &_
"select a.pers_ncorr, " & vbCrLf &_
"       a.pers_nrut, " & vbCrLf &_
"       a.pers_xdv, " & vbCrLf &_
"       a.pers_tape_paterno, " & vbCrLf &_
"       a.pers_tape_materno, " & vbCrLf &_
...
"       left outer join direcciones_publica as b " & vbCrLf &_
"                    on a.pers_ncorr = b.pers_ncorr " & vbCrLf &_
"                       and b.tdir_ccod = 1 " & vbCrLf &_
...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" bgcolor="#CC6600">	  <br>
