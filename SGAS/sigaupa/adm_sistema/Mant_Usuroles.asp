...
'MOTIVO						      : Corregir cï¿½ï¿½digo, eliminar sentencia *=
'LINEA						      : 97
'********************************************************************
...
consulta = "select a.srol_ncorr," & vbcrlf & _
"       a.srol_ncorr                                 as c_srol_ncorr, " & vbcrlf & _
"       a.srol_tdesc, " & vbcrlf & _
"       " & correlativo & "                          as pers_ncorr, " & vbcrlf & _
"       " & correlativo & "                          as c_pers_ncorr, " & vbcrlf & _
"       convert(datetime, b.srus_fmodificacion, 103) as srus_fmodificacion, " & vbcrlf & _
"       case isnull(b.srol_ncorr, 0) " & vbcrlf & _
"         when 0 then 0 " & vbcrlf & _
"         else 1 " & vbcrlf & _
"       end                                          as tiene_rol " & vbcrlf & _
"from   sis_roles as a " & vbcrlf & _
"       left outer join sis_roles_usuarios as b " & vbcrlf & _
"                    on a.srol_ncorr = b.srol_ncorr " & vbcrlf & _
"                       and b.pers_ncorr = " & correlativo & " " & vbcrlf & _
"order  by tiene_rol desc, " & vbcrlf & _
"          a.srol_tdesc asc  "
