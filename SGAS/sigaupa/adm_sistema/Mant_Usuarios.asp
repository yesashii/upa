...
pagina.Titulo = "mantenedor de usuarios"
'---------------------------------------------------------------------------------------------------
...
'--------------------------------------------------------------------------
 ...
 f_busqueda.Carga_Parametros "Mant_Usuarios.xml", "busqueda_usuarios"
...
consulta = "SELECT a.pers_ncorr, b.pers_nrut, a.susu_tlogin, a.susu_tclave, " & vbcrlf & _
		   " convert(datetime,a.susu_fmodificacion,103) as susu_fmodificacion,(select top 1 isnull(lower(email_nuevo),' ')as email_upa from cuentas_email_upa where pers_ncorr =b.pers_ncorr order by fecha_creacion desc)as email, "& vbcrlf & _
           "a.pers_ncorr as c_pers_ncorr, " & vbcrlf & _
		   " cast(b.pers_nrut as varchar) + '-' + b.pers_xdv as rut, " & vbcrlf & _
		   " b.pers_tape_paterno +' '+ b.pers_tape_materno +' '+ b.pers_tnombre as nombre_usuario "& vbcrlf & _
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="101" nowrap bgcolor="#D8D8DE"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="6%"><% botonera.dibujaboton "eliminar"%> </td>
                      <td width="94%">
