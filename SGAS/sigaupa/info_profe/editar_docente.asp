...
formulario.carga_parametros "lec_editar_docente.xml", "edicion_docente"
...
f_botonera.Carga_Parametros "lec_editar_docente.xml", "botonera"
				     ...
				     <form name="editar" method="post">
					  ...
					  <table width="85%" align="center">
                        ...
                        <tr>
                          ...
                          <td width="25%" ><b>:</b> <%=formulario.dibujaCampo("eciv_ccod")%></td>
							<td width="2%"><font color="#CC3300">*</font></td>
							<td width="20%">Jerarquia</td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="237" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><div align="center"><%if session("sin_pers_ncorr") <> 1 then%><%
					  
					  f_botonera.DibujaBoton("anterior")%><%end if%></div></td>
					  
					  
                      <td><div align="center"><%
					  f_botonera.agregabotonparam "siguiente", "url","perfeccionamiento.asp?pers_ncorr="&pers_ncorr
