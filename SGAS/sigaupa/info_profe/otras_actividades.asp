...
F_OtrasActividades.carga_parametros "lec_otras_actividades.xml", "otras_actividades"
...
f_botonera.Carga_Parametros "lec_otras_actividades.xml", "botonera"
	...
	<table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
			  ...
			  <tr>
                <td><img name="top_r2_c1" src="../imagenes/top_r2_c1.gif" width="9" height="17" border="0" alt=""></td>
                <td><%pagina.DibujarLenguetas lenguetas_masignaturas01, 1%></td>
                <td><img name="top_r2_c3" src="../imagenes/top_r2_c3.gif" width="7" height="17" border="0" alt=""></td>
              </tr>
              <tr>
                <td><img name="top_r3_c1" src="../imagenes/top_r3_c1.gif" width="9" height="2" border="0" alt=""></td>
              ...
              <tr>
                  ...
                  <td width="241" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                       <td><div align="center">
                          <%
						 f_botonera.agregabotonparam "anterior", "url", "experiencia_docente.asp?pers_ncorr="&pers_ncorr 
