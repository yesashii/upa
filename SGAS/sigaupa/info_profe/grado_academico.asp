...
Sqlpersfeccionamiento = " select '"&pers_ncorr&"' as pers_ncorr, a.gpro_ncorr,cast(b.grac_tdesc as varchar)+' "" '+ cast(a.gpro_tdescripcion as varchar)+'""' as GPRO_TDESCRIPCION, " & _
						" a.gpro_tinstitucion,a.gpro_ano_egreso, c.pais_tdesc,d.egra_tdesc " & _
...
F_Perfeccionamiento.carga_parametros "lec_grado_academico.xml", "grado_academico"
...
f_botonera.Carga_Parametros "lec_grado_academico.xml", "botonera"
                ...
                <tr>
                  ...
                  <td width="181" bgcolor="#D8D8DE"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><div align="center">
                          <%
						 f_botonera.agregabotonparam "anterior", "url", "perfeccionamiento.asp?pers_ncorr="&pers_ncorr 
						  f_botonera.DibujaBoton("anterior")%>
                      </div></td>
					  <td><div align="center">
                          <%f_botonera.agregabotonparam "siguiente", "url","experiencia_laboral.asp?pers_ncorr="&pers_ncorr
