...
if afecta_promedio="" or afecta_promedio="N" then
	...
	'	en este caso la asignatura no afectará al promedio del alumno ya que se encuentra con todos sus optativos realizados
       ...
       consulta_insercion2 = " insert into cargas_Academicas (matr_ncorr,secc_ccod,carg_afecta_promedio, audi_tusuario, audi_fmodificacion)"&_
	                     	 " values ("&matr_ncorr&","&seccion&",'S','"&v_usuario&"',getdate())"
