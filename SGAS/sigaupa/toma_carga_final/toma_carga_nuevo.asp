   ...
   asignaturas_disponibles_cons = " select distinct c.asig_ccod,c.asig_ccod asig_ccod_paso, c.asig_tdesc as asignatura, " & vbCrlf & _
	...
	if tipo_plan = "0" then
		asignaturas_disponibles_cons = asignaturas_disponibles_cons &  " SELECT DISTINCT b.asig_ccod, mc.nive_ccod,secc.moda_ccod,secc.secc_nhoras_pagar " & vbCrlf & _
										...
										"  WHERE b.asig_ccod=secc.asig_ccod and b.mall_ccod= mc.mall_ccod and b.mall_ccod=secc.mall_ccod and b.peri_ccod = secc.peri_ccod and secc.secc_ccod=bl.secc_ccod" & vbCrlf & _
		...
		filtro_plan = " and plan_ccod in (select distinct plan_ccod from asignaturas_comunes where cast(carr_ccod as varchar)='"&v_carr_ccod&"' and cast(peri_ccod as varchar)='"&peri_ccod&"')"
	else
            ...
            <form name="edicion">
			  <input type="hidden" name="matr_ncorr" value="<%=matr_ncorr%>">
					<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
					  <tr>
						<td><%pagina.DibujarSubtitulo "Seleccione las Asignaturas que desea dar al alumno"%>
						  <br>
