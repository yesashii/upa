...
'if cdbl(ultimo_anio)=2010 or cdbl(ultimo_anio)=2011 then
...
pdf.Cell 85,5,":"&ultimo_anio,"","L",""
	pdf.ln(13)
pdf.Cell 180,1,"Jornada                                                                    :"&jornada&"","","","L"
	pdf.ln(13)
pdf.Cell 180,1,"Sede                                                                         :"&nombre_sede&"","","","L"
	pdf.ln(13)
pdf.MultiCell 180,5,"Se extiende el presente certificado "&resto_mensaje&"","","","L"
pdf.Image "../certificados_dae/imagenes/firma2.jpg", 117, 185, 80, 30, "JPG"
pdf.ln(40)
pdf.SetFont "times","B",12
...
pdf.Cell 195,1,"Santiago: Sede Las Condes: Av.Las Condes 11.121 - Campus Lyon: Av. R. Lyon 227 - Campus Baquedano: Av. Ramón Carnicer 65.","","","C"
	pdf.ln(05)
pdf.Cell 180,1,"Melipilla : Sede Melipilla : Av. José Massoud 533 ","","","C"
	pdf.ln(05)
