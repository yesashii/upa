...
if(q_origen="1") then
 ...
 'q_pers_nrut=9968176
  ...
  pers_ncorr=115343'request.QueryString("pers_ncorr")
...
pdf.Cell 180,1,"INSTITUCIÓN","","","C" 
	pdf.ln(6)
	nombre=""&f_datos_antecedentes.ObtenerValor("nombre")&""
pdf.MultiCell 190,5,"Certifica que don (ña) "&nombre&" Cédula de Identidad N° "&FormatNumber(rut,0)&"- "&f_datos_antecedentes.ObtenerValor("dv")&" es alumna(o) regular de la Carrera de "&carrera&" "&jorn&", SEDE "&sede&", habiendo cursado a la fecha "&lleva_cursado&" año.","","J",""
	pdf.ln(6)
