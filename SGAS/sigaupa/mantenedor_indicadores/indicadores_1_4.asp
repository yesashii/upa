...
'Buscamos los datos pertenecientes al cuadro 1.4a
estimado_2009a = conexion.consultaUno("select  isnull(indi_1_4_a,0)  from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2009'")
estimado_2010a = conexion.consultaUno("select isnull(indi_1_4_a,0) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2010'")
estimado_2011a = conexion.consultaUno("select isnull(indi_1_4_a,0) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2011'")
estimado_2012a = conexion.consultaUno("select isnull(indi_1_4_a,0) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2012'")
estimado_2013a = conexion.consultaUno("select isnull(indi_1_4_a,0) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2013'")

base2008a = conexion.consultaUno("select isnull(indi_1_4_a,0) from mantenedor_dato_base_anual")

real_2009a = conexion.consultaUno("select isnull(indi_1_4_a,0) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2009'")
real_2010a = conexion.consultaUno("select isnull(indi_1_4_a,0) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2010'")
real_2011a = conexion.consultaUno("select isnull(indi_1_4_a,0) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2011'")
real_2012a = conexion.consultaUno("select isnull(indi_1_4_a,0) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2012'")
real_2013a = conexion.consultaUno("select isnull(indi_1_4_a,0) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2013'")
					...
					<tr>
						...
						<td width="96%" align="left">
							<font size="3" color="#FFCC66">
								<strong>1.4 Desarrollar líneas de investigación que contribuyan al mejoramiento del proceso enseñanza aprendizaje.</strong>
							</font>						
						</td>
						<td width="2%" align="center">&nbsp; </td>
					</tr>
					...
					<tr>
						<td colspan="3" align="center">
							<table width="85%" cellpadding="0" cellspacing="0" border="2" bordercolor="#FFCC66">
								...
								<tr>
									<td width="40%" align="center"><div align="justify"><font size="3" color="#FFCC66">N° de proyectos de investigación terminados y publicados</font></div></td>
									...
									<%if not esVacio(real_2009a) and not esVacio(estimado_2009a) then 
											if cint(real_2009a) >= cint(estimado_2009a) then 
											  flecha = "<img width='10' height='10' src='imagenes/verde_arriba.gif' border='0' title='El número de proyectos de investigación terminados y publicados es superior al estimado para el año'>"	
											elseif cint(real_2009a) < cint(estimado_2009a) then
											  flecha = "<img width='10' height='10' src='imagenes/roja_abajo.gif' border='0' title='El número de proyectos de investigación terminados y publicados es inferior al estimado para el año'>"	  
											else 
												flecha = "--"
											end if
									   else
