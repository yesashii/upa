...
f_agrega.Carga_Parametros "mantenedores_escuela.xml", "insert_indi_2_1_a"
...
base_indi_2_1_a= f_agrega.ObtenerValorPost (filai, "base_indi_2_1_a")
real_indi_2_1_a= f_agrega.ObtenerValorPost (filai, "real_indi_2_1_a")
estimativo_indi_2_1_a= f_agrega.ObtenerValorPost (filai, "estimativo_indi_2_1_a")
...
mdbe_ncorr=conectar.ConsultaUno("exec obtenerSecuencia 'mantenedor_dato_base_escuela'")
		strInser="insert into mantenedor_dato_base_escuela (mdbe_ncorr,sede_ccod,carr_ccod,jorn_ccod,tcar_ccod,indi_2_1_a,audi_tusuario,audi_fmodificacion)   values("&mdbe_ncorr&","&sede_ccod&","&carr_ccod&","&jorn_ccod&","&tcar_ccod&","&base_indi_2_1_a&",'"&usu&"',getDate())"
...
strInser="update mantenedor_dato_base_escuela set indi_2_1_a="&base_indi_2_1_a&", audi_tusuario="&usu&",audi_fmodificacion=getdate() where sede_ccod="&sede_ccod&" and carr_ccod="&carr_ccod&" and jorn_ccod="&jorn_ccod&" and tcar_ccod="&tcar_ccod&""
...
str_log="insert into log_datos_mantenedores_indicador (nombre_ncorr,valor_ncorr,indi_ccod,valor_ingresado,audi_tusuario,audi_fmodificacion)values('mdbe_ncorr',"&mdbe_ncorr&",'indi_2_1_a','"&base_indi_2_1_a&"',"&usu&",getDate())"
...
mdre_ncorr=conectar.ConsultaUno("exec obtenerSecuencia 'mantenedor_dato_real_escuela'")
		strInser="insert into mantenedor_dato_real_escuela (mdre_ncorr,sede_ccod,carr_ccod,jorn_ccod,tcar_ccod,anos_ccod,indi_2_1_a,audi_tusuario,audi_fmodificacion)   values("&mdre_ncorr&","&sede_ccod&","&carr_ccod&","&jorn_ccod&","&tcar_ccod&","&anos_ccod&","&real_indi_2_1_a&",'"&usu&"',getDate())"
...
strInser="update mantenedor_dato_real_escuela set indi_2_1_a="&real_indi_2_1_a&", audi_tusuario="&usu&",audi_fmodificacion=getdate() where sede_ccod="&sede_ccod&" and carr_ccod="&carr_ccod&" and jorn_ccod="&jorn_ccod&" and tcar_ccod="&tcar_ccod&" and anos_ccod="&anos_ccod&""
...
'-----------------------------------------------------------------------------------------------------------------------------------------
'aqui se guarda en un log la modificación
str_log="insert into log_datos_mantenedores_indicador (nombre_ncorr,valor_ncorr,indi_ccod,valor_ingresado,audi_tusuario,audi_fmodificacion)values('mdre_ncorr',"&mdre_ncorr&",'indi_2_1_a','"&real_indi_2_1_a&"',"&usu&",getDate())"
conectar2.ejecutaS (str_log)
'-----------------------------------------------------------------------------------------------------------------------------------------
...
mdee_ncorr=conectar.ConsultaUno("exec obtenerSecuencia 'mdee_ncorr'")
		strInser="insert into mantenedor_dato_estimativo_escuela (mdee_ncorr,sede_ccod,carr_ccod,jorn_ccod,tcar_ccod,anos_ccod,indi_2_1_a,audi_tusuario,audi_fmodificacion)   values("&mdee_ncorr&","&sede_ccod&","&carr_ccod&","&jorn_ccod&","&tcar_ccod&","&anos_ccod&","&estimativo_indi_2_1_a&",'"&usu&"',getDate())"
else
...
strInser="update mantenedor_dato_estimativo_escuela set indi_2_1_a="&estimativo_indi_2_1_a&", audi_tusuario="&usu&",audi_fmodificacion=getdate() where sede_ccod="&sede_ccod&" and carr_ccod="&carr_ccod&" and jorn_ccod="&jorn_ccod&" and tcar_ccod="&tcar_ccod&" and anos_ccod="&anos_ccod&""

end if
	conectar.ejecutaS (strInser)
'-----------------------------------------------------------------------------------------------------------------------------------------
'aqui se guarda en un log la modificación
str_log="insert into log_datos_mantenedores_indicador (nombre_ncorr,valor_ncorr,indi_ccod,valor_ingresado,audi_tusuario,audi_fmodificacion)values('mdee_ncorr',"&mdee_ncorr&",'indi_2_1_a','"&estimativo_indi_2_1_a&"',"&usu&",getDate())"
conectar2.ejecutaS (str_log)
'-----------------------------------------------------------------------------------------------------------------------------------------
