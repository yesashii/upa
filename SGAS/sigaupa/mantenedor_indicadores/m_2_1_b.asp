...
if tipo_mantenedora="1" then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_base_2_1_b"
	pre="base"
	anos="2009"
	ano_matricula = "2008"
elseif tipo_mantenedora="2"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_real_2_1_b"
	pre="real"
	anos=anos_ccod
	ano_matricula = anos
	valor=valor&" and g.anos_Ccod="&anos_ccod&""
elseif tipo_mantenedora="3"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_estimativo_2_1_b"
	pre="estimativo"
	anos="2009"
	valor=valor&" and g.anos_Ccod="&anos_ccod&""
end if
...
consulta = " select distinct a.sede_ccod,e.jorn_ccod,d.carr_tdesc,c.carr_ccod,d.tcar_ccod, b.sede_tdesc as sede,e.jorn_tdesc as jornada,d.carr_tdesc as carrera ,case d.tcar_ccod when 1 then 'Pregrado' else 'Postgrado' end as tipo_carrera,isnull(indi_2_1_b,0) as "&pre&"_indi_2_1_b"& vbCrLf &_
		   ...
		   "		on a.sede_ccod=g.sede_ccod and e.jorn_ccod=g.jorn_ccod and c.carr_ccod=g.carr_ccod"& vbCrLf &_
...
consulta = " select sede_ccod,jorn_ccod,carr_tdesc,carr_ccod,tcar_ccod,sede,jornada,carrera,tipo_carrera, "& vbCrLf &_
           " case isnull(indi_2_1_b,1000) when 1000 then total_matriculados else indi_2_1_b end as "&pre&"_indi_2_1_b "& vbCrLf &_
           " from "& vbCrLf &_
 		   " ( "& vbCrLf &_
           ...
           "   	   especialidades T3, postulantes T5     "& vbCrLf &_
		   ...
		   "	   and TT.sede_ccod= b.sede_ccod  and T2.post_ncorr=T5.post_ncorr and T5.post_bnuevo='S'  "& vbCrLf &_
		   ...
		   "       and exists (select 1 from contratos cont1, compromisos comp1 where T2.post_ncorr=cont1.post_ncorr and T2.matr_ncorr=cont1.matr_ncorr and cont1.cont_ncorr=comp1.comp_ndocto and tcom_ccod in (1,2) ) "&vbCrLf&_
          ...
          <tr>
            <td><table width="700" border="0">
				...
				<input type="hidden" name="ma[0][tipo_indi]" value="<%=tipo_indi%>">
				  ...
				  <tr>
					<td>
						<p class="Estilo36" align="center">El n&uacute;mero de alumnos  nuevos anuales entregados por carrera </p>
					</td>
				  </tr>
					<tr>
					   <td>
            ...
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				    <td>
						<div align="center">
                  			<%f_botonera.AgregaBotonParam "guardar", "url", "m_2_1_b_proc.asp"
