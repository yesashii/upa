...
if total_base > 0 then
	consulta_base ="(select isnull(indi_1_1_b,0) as base_indi_1_1_b from mantenedor_dato_base_anual)as base_indi_1_1_b"
else
...
if total_real > 0 then
 	...
 	consulta_real =",(select isnull(indi_1_1_b,0) as real_indi_1_1_b from mantenedor_dato_real_anual where anos_ccod="&anos_ccod&")as real_indi_1_1_b"
else
...
if total_estimativo > 0 then
	...
	consulta_estimativo =",(select isnull(indi_1_1_b,0) as estimativo_indi_1_1_b from mantenedor_dato_estimativo_anual where anos_ccod=2010) as estimativo_indi_1_1_b_2010,(select isnull(indi_1_1_b,0) as estimativo_indi_1_1_b from mantenedor_dato_estimativo_anual where anos_ccod=2011) as estimativo_indi_1_1_b_2011,(select isnull(indi_1_1_b,0) as estimativo_indi_1_1_b from mantenedor_dato_estimativo_anual where anos_ccod=2012) as estimativo_indi_1_1_b_2012,(select isnull(indi_1_1_b,0) as estimativo_indi_1_1_b from mantenedor_dato_estimativo_anual where anos_ccod=2013) as estimativo_indi_1_1_b_2013"
else
	consulta_estimativo=",(select 0 )as estimativo_indi_1_1_b_2010,(select 0 )as estimativo_indi_1_1_b_2011,(select 0 )as estimativo_indi_1_1_b_2012,(select 0 )as estimativo_indi_1_1_b_2013"
end if
...
var mant=<%=tipo_mantenedora%>;
		 ...
		 document.edicion.elements["ma[0][estimativo_indi_1_1_b_2010]"].disabled=true;
		 document.edicion.elements["ma[0][estimativo_indi_1_1_b_2011]"].disabled=true;
		 document.edicion.elements["ma[0][estimativo_indi_1_1_b_2012]"].disabled=true;
		 document.edicion.elements["ma[0][estimativo_indi_1_1_b_2013]"].disabled=true;
		 }
		 else if (mant==2){
				...
				<table width="700" border="0">
					<tr valign="top" align="center">
						...
						<input type="hidden" name="ma[0][tipo_indi]" value="<%=tipo_indi%>">
						  ...
						  <tr>
							<td>
							<p class="Estilo36" align="center"><strong>(Número de alumnos participantes en Programa de Formación General Optativa ) / (Número total de alumnos) </strong></p>
							</td>
						  </tr>
						  <tr valign="top" align="center">
