...
elseif tipo_mantenedora="2"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_real_1_1_a"
	pre="real"
	anos=anos_ccod
	valor=valor&" and g.anos_ccod="&anos_ccod&""
elseif tipo_mantenedora="3"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_estimativo_1_1_a"
	pre="estimativo"
	anos="2009"
	valor=valor&" and g.anos_ccod="&anos_ccod&""
end if
...
consulta ="select distinct a.sede_ccod,e.jorn_ccod,d.carr_tdesc,c.carr_ccod,d.tcar_ccod, b.sede_tdesc as sede,e.jorn_tdesc as jornada,d.carr_tdesc as carrera ,case d.tcar_ccod when 1 then 'Pregrado' else 'Postgrado' end as tipo_carrera,isnull(indi_1_1_a,90) as "&pre&"_indi_1_1_a "& vbCrLf &_
				...
				<table width="700" border="0">
					<tr valign="top" align="center">
						...
						<input type="hidden" name="ma[0][tipo_indi]" value="<%=tipo_indi%>">
						  ...
						  <tr>
							<td>
							<p class="Estilo36" align="center"><strong>Porcentaje de alumnos de 1er año en programa de apoyo y seguimiento por escuela</strong></p>
							</td>
						  </tr>
						  <tr valign="top">
						   <td>
