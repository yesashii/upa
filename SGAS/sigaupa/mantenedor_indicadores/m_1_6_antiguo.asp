...
if tipo_mantenedora="1"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_base_1_6"
	anos="2009"
	pre="base"
elseif tipo_mantenedora="2"   then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_real_1_6"
	anos=anos_ccod
	pre="real"
	valor=valor&" and g.anos_Ccod="&anos_ccod&""
elseif tipo_mantenedora="3"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_estimativo_1_6"
	anos="2009"
	pre="estimativo"
	valor=valor&" and g.anos_Ccod="&anos_ccod&""
end if
...
consulta ="select distinct a.sede_ccod,e.jorn_ccod,d.carr_tdesc,c.carr_ccod,d.tcar_ccod, b.sede_tdesc as sede,e.jorn_tdesc as jornada,d.carr_tdesc as carrera ,case d.tcar_ccod when 1 then 'Pregrado' else 'Postgrado' end as tipo_carrera,isnull(indi_1_6_a,0) as "&pre&"_indi_1_6"& vbCrLf &_
...
"union"& vbCrLf &_
"select distinct a.sede_ccod,e.jorn_ccod,d.carr_tdesc,c.carr_ccod,d.tcar_ccod, b.sede_tdesc as sede,e.jorn_tdesc as jornada,d.carr_tdesc as carrera ,case d.tcar_ccod when 1 then 'Pregrado' else 'Postgrado' end as tipo_carrera,isnull(indi_1_6_b,0) as "&pre&"_indi_1_6"& vbCrLf &_
"from ofertas_academicas a "& vbCrLf &_
"join sedes b"& vbCrLf &_
"on a.sede_ccod=b.sede_ccod"& vbCrLf &_
"join especialidades c"& vbCrLf &_
...
"where f.anos_Ccod='"&anos&"'"& vbCrLf &_
"and exists (select 1 from alumnos tt where tt.ofer_ncorr=a.ofer_ncorr and tt.emat_ccod=1)"& vbCrLf &_
"order by sede,carrera,jornada,d.tcar_ccod"


' "select a.sede_ccod,jorn_ccod,c.carr_tdesc,c.carr_ccod,tcar_ccod, a.sede_ccod as sede,jorn_ccod as jornada,c.carr_ccod as carrera ,tcar_ccod as tipo_carrera"& vbCrLf &_ 
'"from ofertas_academicas a, especialidades b,carreras c,alumnos d,postulantes e"& vbCrLf &_
'"where a.espe_ccod=b.espe_ccod"& vbCrLf &_
'"and b.carr_ccod=c.carr_ccod"& vbCrLf &_
'"and c.carr_ccod<>820"& vbCrLf &_
'"and a.ofer_ncorr=d.ofer_ncorr"& vbCrLf &_
'"and d.post_ncorr=e.post_ncorr"& vbCrLf &_
'"and a.peri_ccod=e.peri_ccod"& vbCrLf &_
'"and a.peri_ccod in (select peri_ccod from periodos_academicos where anos_ccod=2009)"& vbCrLf &_
'"and emat_ccod=1"& vbCrLf &_
'"group by a.sede_ccod,jorn_ccod,c.carr_ccod,carr_tdesc,tcar_ccod"& vbCrLf &_
'"order by a.sede_ccod,carr_tdesc,jorn_ccod,tcar_ccod"
 					...
 					<table>
						  <tr>
							<td align="center">
								...
								<%elseif tipo_mantenedora="3" then%>
									<p class="Estilo35"><strong>Informaci&oacute;n Estimativas para el Año <%=anos_ccod%> de </strong></p>
								<%end if%>
							</td>
						  </tr>
						  <tr>
							<td>
								<p class="Estilo36">Los programas implementados,&nbsp; que son nuevos  para el a&ntilde;o </p>
							</td>
						  </tr>
						  <tr>
							   <td>
            ...
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				  <td>
				   <div align="center">
                  		<%f_botonera.AgregaBotonParam "guardar", "url", "m_1_6_proc.asp"
