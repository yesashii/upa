...
'Buscamos los datos pertenecientes al cuadro 1.7a
estimado_2009a = conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_estimativo_escuela where cast(anos_ccod as varchar)='2009' and tcar_ccod = 1")
estimado_2010a = conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_estimativo_escuela where cast(anos_ccod as varchar)='2010' and tcar_ccod = 1")
estimado_2011a = conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_estimativo_escuela where cast(anos_ccod as varchar)='2011' and tcar_ccod = 1")
estimado_2012a = conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_estimativo_escuela where cast(anos_ccod as varchar)='2012' and tcar_ccod = 1")
estimado_2013a = conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_estimativo_escuela where cast(anos_ccod as varchar)='2013' and tcar_ccod = 1")

base2008a = "119" 'conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_base_escuela where tcar_ccod = 1")

real_2009a = conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_real_escuela where cast(anos_ccod as varchar)='2009'  and tcar_ccod = 1")
real_2010a = conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_real_escuela where cast(anos_ccod as varchar)='2010'  and tcar_ccod = 1")
real_2011a = conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_real_escuela where cast(anos_ccod as varchar)='2011'  and tcar_ccod = 1")
real_2012a = conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_real_escuela where cast(anos_ccod as varchar)='2012'  and tcar_ccod = 1")
real_2013a = conexion.consultaUno("select isnull(sum(indi_1_7_b),0) from mantenedor_dato_real_escuela where cast(anos_ccod as varchar)='2013'  and tcar_ccod = 1")
%>
					...
					<tr>
						...
						<td width="96%" align="left">
							<font size="3" color="#FFCC66">
								<strong>1.7 Diseñar e implementar un programa selectivo de intercambio académico nacional e internacional.</strong>
							</font>						
						</td>
						<td width="2%" align="center">&nbsp; </td>
					</tr>
					...
					<tr>
						<td colspan="3" align="center">
							<table width="85%" cellpadding="0" cellspacing="0" border="2" bordercolor="#d45502">
								...
								<tr>
									<td width="40%" align="center"><div align="justify"><font size="3" color="#d45502">Movilidad estudiantil internacional anual.</font></div></td>
									...
									<%if not esVacio(real_2009a) and not esVacio(estimado_2009a) then 
											if cint(real_2009a) >= cint(estimado_2009a) then 
											  flecha = "<img width='10' height='10' src='imagenes/verde_arriba.gif' border='0' title='La movilidad estudiantil internacional es superior al estimado para el año'>"	
											elseif cint(real_2009a) < cint(estimado_2009a) then
											  flecha = "<img width='10' height='10' src='imagenes/roja_abajo.gif' border='0' title='La movilidad estudiantil internacional es inferior al estimado para el año'>"	  
											else 
												flecha = "--"
											end if
									   else
