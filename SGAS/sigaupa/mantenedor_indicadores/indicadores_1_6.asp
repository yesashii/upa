...
'Buscamos los datos pertenecientes al cuadro 1.6a
estimado_2009a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2009'")
estimado_2010a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2010'")
estimado_2011a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2011'")
estimado_2012a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2012'")
estimado_2013a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2013'")

base2008a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_base_anual")

real_2009a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2009'")
real_2010a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2010'")
real_2011a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2011'")
real_2012a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2012'")
real_2013a = conexion.consultaUno("select sum(indi_1_6_a) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2013'")

'Buscamos los datos pertenecientes al cuadro 1.6b
estimado_2009b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2009'")
estimado_2010b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2010'")
estimado_2011b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2011'")
estimado_2012b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2012'")
estimado_2013b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_estimativo_anual where cast(anos_ccod as varchar)='2013'")

base2008b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_base_anual")

real_2009b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2009'")
real_2010b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2010'")
real_2011b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2011'")
real_2012b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2012'")
real_2013b = conexion.consultaUno("select sum(indi_1_6_b) from mantenedor_dato_real_anual where cast(anos_ccod as varchar)='2013'")
%>
					...
					<tr>
						...
						<td width="96%" align="left">
							<font size="3" color="#FFCC66">
								<strong>1.6 Diseñar e implementar nuevos programas académicos de pre y postgrado acorde a las necesidades de la sociedad y las áreas del conocimiento a las que se adscribe la Universidad.</strong>
							</font>						
						</td>
						<td width="2%" align="center">&nbsp; </td>
					</tr>
					...
					<tr>
						<td colspan="3" align="center">
							<table width="85%" cellpadding="0" cellspacing="0" border="2" bordercolor="#d45502">
								...
								<tr>
									<td width="40%" align="center"><div align="justify"><font size="3" color="#d45502">N° de nuevos programas académicos de pregrado implementados</font></div></td>
									...
									<%if not esVacio(real_2009a) and not esVacio(estimado_2009a) then 
											if cint(real_2009a) >= cint(estimado_2009a) then 
											  flecha = "<img width='10' height='10' src='imagenes/verde_arriba.gif' border='0' title='El número nuevos programas académicos de pregrado implementados es superior al estimado para el año'>"	
											elseif cint(real_2009a) < cint(estimado_2009a) then
											  flecha = "<img width='10' height='10' src='imagenes/roja_abajo.gif' border='0' title='El número nuevos programas académicos de pregrado implementados es inferior al estimado para el año'>"	  
											else 
												flecha = "--"
											end if
									   else
					...
					<tr>
						<td colspan="3" align="center">
							<table width="85%" cellpadding="0" cellspacing="0" border="2" bordercolor="#d45502">
								...
								<tr>
									<td width="40%" align="center"><div align="justify"><font size="3" color="#d45502">Número de nuevos programas académicos de postgrado implementados</font></div></td>
									<td width="10%" align="center"><font size="3" color="#d45502"><strong><%=base2008b%></strong></font></td>
									  <%if not esVacio(real_2009b) and not esVacio(estimado_2009b) then 
											if cint(real_2009b) >= cint(estimado_2009b) then 
											  flecha = "<img width='10' height='10' src='imagenes/verde_arriba.gif' border='0' title='El número nuevos programas académicos de postgrado implementados es superior al estimado para el año'>"	
											elseif cint(real_2009b) < cint(estimado_2009b) then
											  flecha = "<img width='10' height='10' src='imagenes/roja_abajo.gif' border='0' title='El número nuevos programas académicos de postgrado implementados es inferior al estimado para el año'>"	  
											else 
												flecha = "--"
											end if
									   else
