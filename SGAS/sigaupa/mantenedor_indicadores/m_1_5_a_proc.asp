...
base_indi_1_5_a= f_agrega.ObtenerValorPost (filai, "base_indi_1_5_a")
real_indi_1_5_a= f_agrega.ObtenerValorPost (filai, "real_indi_1_5_a")
estimativo_indi_1_5_a= f_agrega.ObtenerValorPost (filai, "estimativo_indi_1_5_a")
...
mdbe_ncorr=conectar.ConsultaUno("exec obtenerSecuencia 'mantenedor_dato_base_escuela'")
		...
		strInser="insert into mantenedor_dato_base_escuela (mdbe_ncorr,sede_ccod,carr_ccod,jorn_ccod,tcar_ccod,indi_1_5_a,audi_tusuario,audi_fmodificacion)   values("&mdbe_ncorr&","&sede_ccod&","&carr_ccod&","&jorn_ccod&","&tcar_ccod&","&base_indi_1_5_a&",'"&usu&"',getDate())"
...
mdbe_ncorr=conectar.ConsultaUno("select mdbe_ncorr from mantenedor_dato_base_escuela where sede_ccod="&sede_ccod&" and carr_ccod="&carr_ccod&" and jorn_ccod="&jorn_ccod&" and tcar_ccod="&tcar_ccod&"")
	...
	strInser="update mantenedor_dato_base_escuela set indi_1_5_a="&base_indi_1_5_a&", audi_tusuario="&usu&",audi_fmodificacion=getdate() where sede_ccod="&sede_ccod&" and carr_ccod="&carr_ccod&" and jorn_ccod="&jorn_ccod&" and tcar_ccod="&tcar_ccod&""
...
str_log="insert into log_datos_mantenedores_indicador (nombre_ncorr,valor_ncorr,indi_ccod,valor_ingresado,audi_tusuario,audi_fmodificacion)values('mdbe_ncorr',"&mdbe_ncorr&",'indi_1_5_a','"&base_indi_1_5_a&"',"&usu&",getDate())"
...
mdbe_ncorr=conectar.ConsultaUno("exec obtenerSecuencia 'mantenedor_dato_real_escuela'")
		...
		strInser="insert into mantenedor_dato_real_escuela (mdre_ncorr,sede_ccod,carr_ccod,jorn_ccod,tcar_ccod,anos_ccod,indi_1_5_a,audi_tusuario,audi_fmodificacion)   values("&mdbe_ncorr&","&sede_ccod&","&carr_ccod&","&jorn_ccod&","&tcar_ccod&","&anos_ccod&","&real_indi_1_5_a&",'"&usu&"',getDate())"
...
mdre_ncorr=conectar.ConsultaUno("select mdre_ncorr from mantenedor_dato_real_escuela where sede_ccod="&sede_ccod&" and carr_ccod="&carr_ccod&" and jorn_ccod="&jorn_ccod&" and tcar_ccod="&tcar_ccod&" and anos_ccod="&anos_ccod&"")
		...
		strInser="update mantenedor_dato_real_escuela set indi_1_5_a="&real_indi_1_5_a&", audi_tusuario="&usu&",audi_fmodificacion=getdate() where sede_ccod="&sede_ccod&" and carr_ccod="&carr_ccod&" and jorn_ccod="&jorn_ccod&" and tcar_ccod="&tcar_ccod&" and anos_ccod="&anos_ccod&""

end if
	conectar.ejecutaS (strInser)
'-----------------------------------------------------------------------------------------------------------------------------------------
'aqui se guarda en un log la modificación
str_log="insert into log_datos_mantenedores_indicador (nombre_ncorr,valor_ncorr,indi_ccod,valor_ingresado,audi_tusuario,audi_fmodificacion)values('mdre_ncorr',"&mdre_ncorr&",'indi_1_5_a','"&real_indi_1_5_a&"',"&usu&",getDate())"
conectar2.ejecutaS (str_log)
'-----------------------------------------------------------------------------------------------------------------------------------------
...
mdee_ncorr=conectar.ConsultaUno("exec obtenerSecuencia 'mdee_ncorr'")
		...
		strInser="insert into mantenedor_dato_estimativo_escuela (mdee_ncorr,sede_ccod,carr_ccod,jorn_ccod,tcar_ccod,anos_ccod,indi_1_5_a,audi_tusuario,audi_fmodificacion)   values("&mdee_ncorr&","&sede_ccod&","&carr_ccod&","&jorn_ccod&","&tcar_ccod&","&anos_ccod&","&estimativo_indi_1_5_a&",'"&usu&"',getDate())"
...
mdee_ncorr=conectar.ConsultaUno("select mdee_ncorr from mantenedor_dato_estimativo_escuela where sede_ccod="&sede_ccod&" and carr_ccod="&carr_ccod&" and jorn_ccod="&jorn_ccod&" and tcar_ccod="&tcar_ccod&" and anos_ccod="&anos_ccod&"")
	...
	strInser="update mantenedor_dato_estimativo_escuela set indi_1_5_a="&estimativo_indi_1_5_a&", audi_tusuario="&usu&",audi_fmodificacion=getdate() where sede_ccod="&sede_ccod&" and carr_ccod="&carr_ccod&" and jorn_ccod="&jorn_ccod&" and tcar_ccod="&tcar_ccod&" and anos_ccod="&anos_ccod&""

end if
	conectar.ejecutaS (strInser)
'-----------------------------------------------------------------------------------------------------------------------------------------
'aqui se guarda en un log la modificación
str_log="insert into log_datos_mantenedores_indicador (nombre_ncorr,valor_ncorr,indi_ccod,valor_ingresado,audi_tusuario,audi_fmodificacion)values('mdee_ncorr',"&mdee_ncorr&",'indi_1_5_a','"&estimativo_indi_1_5_a&"',"&usu&",getDate())"
conectar2.ejecutaS (str_log)
'-----------------------------------------------------------------------------------------------------------------------------------------
