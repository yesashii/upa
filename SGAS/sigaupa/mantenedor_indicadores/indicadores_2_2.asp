...
estimado_2009a = conexion.consultaUno("select isnull(sum(indi_2_2_a),40) from mantenedor_dato_estimativo_escuela where cast(anos_ccod as varchar)='2009'")
estimado_2010a = conexion.consultaUno("select isnull(sum(indi_2_2_a),40) from mantenedor_dato_estimativo_escuela where cast(anos_ccod as varchar)='2010'")
estimado_2011a = conexion.consultaUno("select isnull(sum(indi_2_2_a),50) from mantenedor_dato_estimativo_escuela where cast(anos_ccod as varchar)='2011'")
estimado_2012a = conexion.consultaUno("select isnull(sum(indi_2_2_a),50) from mantenedor_dato_estimativo_escuela where cast(anos_ccod as varchar)='2012'")
estimado_2013a = conexion.consultaUno("select isnull(sum(indi_2_2_a),50) from mantenedor_dato_estimativo_escuela where cast(anos_ccod as varchar)='2013'")

base2008a = conexion.consultaUno("select isnull(sum(indi_2_2_a),40) from mantenedor_dato_base_escuela")

real_2009a = conexion.consultaUno("select isnull(sum(indi_2_2_a),0) from mantenedor_dato_real_escuela where cast(anos_ccod as varchar)='2009'")
real_2010a = conexion.consultaUno("select isnull(sum(indi_2_2_a),0) from mantenedor_dato_real_escuela where cast(anos_ccod as varchar)='2010'")
real_2011a = conexion.consultaUno("select isnull(sum(indi_2_2_a),0) from mantenedor_dato_real_escuela where cast(anos_ccod as varchar)='2011'")
real_2012a = conexion.consultaUno("select isnull(sum(indi_2_2_a),0) from mantenedor_dato_real_escuela where cast(anos_ccod as varchar)='2012'")
real_2013a = conexion.consultaUno("select isnull(sum(indi_2_2_a),0) from mantenedor_dato_real_escuela where cast(anos_ccod as varchar)='2013'")
					...
					<tr>
						...
						<td width="96%" align="left">
							<font size="3" color="#FFCC66">
								<strong>2.2 Establecer mecanismos para la gestión académica, que aseguren su eficiencia y efectividad.</strong>
							</font>						
						</td>
						<td width="2%" align="center">&nbsp; </td>
					</tr>
					...
					<tr>
						<td colspan="3" align="center">
							<table width="85%" cellpadding="0" cellspacing="0" border="2" bordercolor="#FFCC66">
								...
								<tr>
									<td width="40%" align="center"><div align="justify"><font size="3" color="#FFCC66">Titulación oportuna (n+1) </font></div></td>
									...
									<%if not esVacio(real_2009a) and not esVacio(estimado_2009a) then 
											if cint(real_2009a) >= cint(estimado_2009a) then 
											  flecha = "<img width='10' height='10' src='imagenes/verde_arriba.gif' border='0' title='El porcentaje de titulación oportuna es superior al estimado para el año'>"	
											elseif cint(real_2009a) < cint(estimado_2009a) then
											  flecha = "<img width='10' height='10' src='imagenes/roja_abajo.gif' border='0' title='El porcentaje de titulación oportuna es inferior al estimado para el año'>"	  
											else 
												flecha = "--"
											end if
									   else
