...
if tipo_mantenedora="1" then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_base_3_4_a"
	pre="base"
	anos="2009"
elseif tipo_mantenedora="2"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_real_3_4_a"
	pre="real"
	anos=anos_ccod
	valor=valor&" and b.anos_Ccod="&anos_ccod&""
elseif tipo_mantenedora="3"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_estimativo_3_4_a"
	pre="estimativo"
	anos="2009"
	valor=valor&" and b.anos_Ccod="&anos_ccod&""
end if
...
consulta = "select a.sede_ccod,a.sede_tdesc as sede ,indi_3_4_a_obligatoria as "&pre&"_indi_3_4_a_obligatoria,indi_3_4_a_complementaria as "&pre&"_indi_3_4_a_complementaria from sedes a left outer join mantenedor_dato_"&pre&"_sede b on a.sede_ccod=b.sede_ccod "&valor&" where a.sede_ccod in(1,2,4,8) "


'"select a.sede_ccod,a.jorn_ccod,c.carr_tdesc,c.carr_ccod,c.tcar_ccod, a.sede_ccod as sede,a.jorn_ccod as jornada,c.carr_ccod as carrera ,c.tcar_ccod as tipo_carrera,indi_3_4_a as "&pre&"_indi_3_4_a"& vbCrLf &_ 
'"from ofertas_academicas a, especialidades b,carreras c,alumnos d,postulantes e,mantenedor_dato_"&pre&"_sede f"& vbCrLf &_
...
'"and a.peri_ccod in (select peri_ccod from periodos_academicos where anos_ccod="&anos_ccod&")"& vbCrLf &_
'"and emat_ccod=1"& vbCrLf &_
'"and a.sede_ccod=f.sede_ccod"& vbCrLf &_
'""&valor&""& vbCrLf &_
'"group by a.sede_ccod,a.jorn_ccod,c.carr_ccod,carr_tdesc,c.tcar_ccod,indi_3_4_a"& vbCrLf &_
'"order by a.sede_ccod,c.carr_tdesc,a.jorn_ccod,c.tcar_ccod"
          ...
          <tr>
            <td><table width="700" border="0">
				...
				<input type="hidden" name="ma[0][tipo_indi]" value="<%=tipo_indi%>">
				  ...
				  <tr>
					<td>
					<p class="Estilo36" align="center"><strong>Cantidad de bibliografía obligatoria y complementaria disponible por sede</strong></p>
					</td>
				  </tr>
					<tr>
					   <td>
            ...
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				 <td>
				  <div align="center">
                  	<%f_botonera.AgregaBotonParam "guardar", "url", "m_3_4_a_proc.asp"
