...
if tipo_mantenedora="1" then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_base_1_5_b"
	pre="base"
	anos="2009"
elseif tipo_mantenedora="2" then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_real_1_5_b"
	pre="real"
	anos=anos_ccod
	valor=valor&" and g.anos_Ccod="&anos_ccod&""
elseif tipo_mantenedora="3" then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_estimativo_1_5_b"
	anos="2009"
	pre="estimativo"
	valor=valor&" and g.anos_Ccod="&anos_ccod&""
end if
...
consulta = "select distinct a.sede_ccod,e.jorn_ccod,d.carr_tdesc,c.carr_ccod,d.tcar_ccod, b.sede_tdesc as sede,e.jorn_tdesc as jornada,d.carr_tdesc as carrera ,case d.tcar_ccod when 1 then 'Pregrado' else 'Postgrado' end as tipo_carrera,isnull(indi_1_5_b,0) as "&pre&"_indi_1_5_b"& vbCrLf &_
				...
				<td width="100%" align="center">
					...
					<input type="hidden" name="ma[0][tipo_indi]" value="<%=tipo_indi%>">
					  ...
					  <tr>
						...
						<%elseif tipo_mantenedora="3" then%>
							<p class="Estilo35"><strong>Informaci&oacute;n Estimativo para el Año <%=anos_ccod%> de </strong></p>
						<%end if%>
						</td>
					  </tr>
					  <tr>
						<td>
						<p class="Estilo36" align="center"><strong>Las carreras que terminaron su proceso de autoevaluación planificado para el año </strong></p>
						</td>
					  </tr>
					  <tr>
					   <td>
            ...
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
				  <td>
				    <div align="center">
                  		<%f_botonera.AgregaBotonParam "guardar", "url", "m_1_5_b_proc.asp"
