...
if tipo_mantenedora="1" then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_base_3_1_a"
	pre="base"
	anos="2009"
elseif tipo_mantenedora="2"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_real_3_1_a"
	pre="real"
	anos=anos_ccod
	valor=valor&" and b.anos_Ccod="&anos_ccod&""
elseif tipo_mantenedora="3"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_estimativo_3_1_a"
	pre="estimativo"
	anos="2009"
	valor=valor&" and b.anos_Ccod="&anos_ccod&""
end if
...
consulta =  "select a.sede_ccod,a.sede_tdesc as sede,indi_3_1_1_a as "&pre&"_indi_3_1_a,indi_3_1_2_a_sala as "&pre&"_indi_3_1_2_a_sala,indi_3_1_2_a_laboratorio as "&pre&"_indi_3_1_2_a_laboratorio,indi_3_1_2_a_taller as "&pre&"_indi_3_1_2_a_taller from sedes a left outer join mantenedor_dato_"&pre&"_sede b on a.sede_ccod=b.sede_ccod "&valor&" where a.sede_ccod in(1,2,4,8) "
		  ...
		  <tr>
            <td><table width="700" border="0">
				...
				<input type="hidden" name="ma[0][tipo_indi]" value="<%=tipo_indi%>">
				  ...
				  <tr>
					<td>
						<p class="Estilo36" align="center"><strong>Cantidad de metros cuadrados construidos y</strong></p>
						<p class="Estilo36" align="center"><strong>Cantidad de salas, talleres o laboratorios por sedes disponibles.</strong></p>
					</td>
				  </tr>
					<tr>
					   <td>
            ...
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td>
				  	<div align="center">
                  		<%f_botonera.AgregaBotonParam "guardar", "url", "m_3_1_1_a_proc.asp"
