					...
					<tr>
						<td colspan="3" align="center">
							<table width="85%" cellpadding="0" cellspacing="0" border="2" bordercolor="#d45502">
								...
								<tr>
									<td width="40%" align="center"><div align="justify"><font size="3" color="#d45502">(Número de programas de Pregrado con Perfil de Egreso actualizado)/(Número total de Programas de Pregrado)</font></div></td>
									...
									<%if not esVacio(real_2009a) and not esVacio(estimado_2009a) then 
											if cint(real_2009a) >= cint(estimado_2009a) then 
											  flecha = "<img width='10' height='10' src='imagenes/verde_arriba.gif' border='0' title='El número de programas de pregrado con perfil de egreso actualizado es superior al estimado para el año'>"	
											elseif cint(real_2009a) < cint(estimado_2009a) then
											  flecha = "<img width='10' height='10' src='imagenes/roja_abajo.gif' border='0' title='El número de programas de pregrado con perfil de egreso actualizado es inferior al estimado para el año'>"	  
											else 
												flecha = "--"
											end if
									   else
					...
					<tr>
						<td colspan="3" align="center">
							<table width="85%" cellpadding="0" cellspacing="0" border="2" bordercolor="#d45502">
								...
								<tr>
									<td width="40%" align="center"><div align="justify"><font size="3" color="#d45502">(Número de Programas de Postgrado con Perfil de Egreso actualizado)/(Número total de Programas de Postgrado)</font></div></td>
									<td width="10%" align="center"><font size="3" color="#d45502"><strong><%=base2008b%>%</strong></font></td>
									  <%if not esVacio(real_2009b) and not esVacio(estimado_2009b) then 
											if cint(real_2009b) >= cint(estimado_2009b) then 
											  flecha = "<img width='10' height='10' src='imagenes/verde_arriba.gif' border='0' title='El número de programas de postgrado con perfil de egreso actualizado es superior al estimado para el año'>"	
											elseif cint(real_2009b) < cint(estimado_2009b) then
											  flecha = "<img width='10' height='10' src='imagenes/roja_abajo.gif' border='0' title='El número de programas de postgrado con perfil de egreso actualizado es inferior al estimado para el año'>"	  
											else 
												flecha = "--"
											end if
									   else
