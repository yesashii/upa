					...
					<tr>
						...
						<td width="96%" align="left">
							<font size="3" color="#FFCC66">
								<strong>4.1 Fortalecer un sistema de reclutamiento, selección e inducción que permita incorporar al proyecto educativo de la universidad, personas con talento, habilidades y capacidades pertinentes al perfil requerido.</strong>
							</font>						
						</td>
						<td width="2%" align="center">&nbsp; </td>
					</tr>
					...
					<tr>
						<td colspan="3" align="center">
							<table width="85%" cellpadding="0" cellspacing="0" border="2" bordercolor="#FFCC66">
								...
								<tr>
									<td width="40%" align="center"><div align="justify"><font size="3" color="#FFCC66">[(Número de personas reclutadas y seleccionadas en 30 días)/(Número total de personas reclutadas y seleccionadas en el año)]*100</font></div></td>
									...
									<%if not esVacio(real_2009a) and not esVacio(estimado_2009a) then 
											if cint(real_2009a) >= cint(estimado_2009a) then 
											  flecha = "<img width='10' height='10' src='imagenes/verde_arriba.gif' border='0' title='La razón de personas reclutadas y seleccionadas en 30 días es superior al estimado para el año'>"	
											elseif cint(real_2009a) < cint(estimado_2009a) then
											  flecha = "<img width='10' height='10' src='imagenes/roja_abajo.gif' border='0' title='La razón de personas reclutadas y seleccionadas en 30 días es inferior al estimado para el año'>"	  
											else 
												flecha = "--"
											end if
									   else
					...
					<tr>
						<td colspan="3" align="center">
							<table width="85%" cellpadding="0" cellspacing="0" border="2" bordercolor="#FFCC66">
								...
								<tr>
									<td width="40%" align="center"><div align="justify"><font size="3" color="#FFCC66">N° de personas que cursen el programa de inducción</font></div></td>
									...
									<%if not esVacio(real_2009b) and not esVacio(estimado_2009b) then 
											if cint(real_2009b) >= cint(estimado_2009b) then 
											  flecha = "<img width='10' height='10' src='imagenes/verde_arriba.gif' border='0' title='El N° de personas que cursan el programa de inducción es superior al estimado para el año'>"	
											elseif cint(real_2009b) < cint(estimado_2009b) then
											  flecha = "<img width='10' height='10' src='imagenes/roja_abajo.gif' border='0' title='El N° de personas que cursan el programa de inducción es inferior al estimado para el año'>"	  
											else 
												flecha = "--"
											end if
									   else
