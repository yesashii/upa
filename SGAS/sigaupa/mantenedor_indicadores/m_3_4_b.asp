...
if tipo_mantenedora="1" then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_base_3_4_b"
	pre="base"
	anos="2009"
elseif tipo_mantenedora="2"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_real_3_4_b"
	pre="real"
	anos=anos_ccod
	valor=valor&" and g.anos_Ccod="&anos_ccod&""
elseif tipo_mantenedora="3"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_estimativo_3_4_b"
	pre="estimativo"
	anos="2009"
	valor=valor&" and g.anos_Ccod="&anos_ccod&""
end if
...
consulta ="select distinct a.sede_ccod,e.jorn_ccod,d.carr_tdesc,c.carr_ccod,d.tcar_ccod, b.sede_tdesc as sede,e.jorn_tdesc as jornada,d.carr_tdesc as carrera ,case d.tcar_ccod when 1 then 'Pregrado' else 'Postgrado' end as tipo_carrera,isnull(indi_3_4_b,0) as "&pre&"_indi_3_4_b"& vbCrLf &_
         ...
         <tr>
		  ...
		  <tr>
            <td><table width="700" border="0">
				...
				<input type="hidden" name="ma[0][sede]" value="<%=sede%>">
				  <table>
				  <tr>
					<td align="center">
					<%if tipo_mantenedora="1" then%>
				  ...
				  <tr>
					<td>
						<p class="Estilo36" align="center"><strong>Relación de cumplimiento requerimientos proyectos de carrera anuales </strong></p>
					</td>
				  </tr>
					<tr>
					   <td>
            ...
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td>
				  	<div align="center">
                  		<%f_botonera.AgregaBotonParam "guardar", "url", "m_3_4_b_proc.asp"
