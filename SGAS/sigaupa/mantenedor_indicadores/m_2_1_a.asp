...
if tipo_mantenedora="1" then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_base_2_1_a"
	pre="base"
	anos="2009"
	campo="isnull(indi_2_1_a,0) as "&pre&"_indi_2_1_a"
elseif tipo_mantenedora="2"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_real_2_1_a"
	pre="real"
	anos=anos_ccod
	valor=valor&" and g.anos_Ccod="&anos_ccod&""
	campo=" isnull(indi_2_1_a,0) as "&pre&"_indi_2_1_a"
elseif tipo_mantenedora="3"  then
	f_mantenedor.Carga_Parametros "mantenedores_escuela.xml", "f_mantenedor_estimativo_2_1_a"
	pre="estimativo"
	anos="2009"
	valor=valor&" and g.anos_Ccod="&anos_ccod&""
	campo=" isnull(indi_2_1_a,0) as "&pre&"_indi_2_1_a"
...
consulta = "select distinct a.sede_ccod,e.jorn_ccod,d.carr_tdesc,c.carr_ccod,d.tcar_ccod, b.sede_tdesc as sede,e.jorn_tdesc as jornada,d.carr_tdesc as carrera ,case d.tcar_ccod when 1 then 'Pregrado' else 'Postgrado' end as tipo_carrera,isnull(indi_2_1_a,0) as "&pre&"_indi_2_1_a"& vbCrLf &_
          ...
          <tr>
            <td><table width="700" border="0">
				...
				<input type="hidden" name="ma[0][tipo_indi]" value="<%=tipo_indi%>">
				  ...
				  <tr>
					<td>
						<p class="Estilo36" align="center">Porcentaje de retención entregado para el año  </p>
					</td>
				  </tr>
					<tr>
					   <td>
            ...
            <td width="31%" height="20"><div align="center">
              <table width="90%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td>
				  	<div align="center">
                  		<%f_botonera.AgregaBotonParam "guardar", "url", "m_2_1_a_proc.asp"
