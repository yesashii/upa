...
set @contador_compromisos = ( select count(*) from COMPROMISOS
                              ...
                              and   year(AUDI_FMODIFICACION) = year(getdate())
...
and year(com.AUDI_FMODIFICACION) = year(getdate())
...
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Dirección: Av. Las Condes 11.121, Las Condes
Teléfono: 2 2862 5220
Web: www.upacifico.cl | ltorres@upacifico.cl 
