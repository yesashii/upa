...
"                '1' as bloque,                                         " & vbCrLf &_
"                'A' as accion,                                         " & vbCrLf &_
"                '"&sede&"' as sede_ccod,                               " & vbCrLf &_
"                '"&subseccion&"' as ssec_ncorr,                        " & vbCrLf &_
...
sede = <%=sede%>;
	docente = persona(formulario);
	direccion="edicion_plan_acad.asp?ssec_ncorr="+subseccion+"&pers_ncorr=" + docente+"&sede_ccod="+sede + "&accion=B"+ "&bloque=1";
	resultado=window.open(direccion, 'ventana1', "width=600 height=380, left=100, top=50, resizable,scrollbars=yes");
	//formulario.submit();
}
