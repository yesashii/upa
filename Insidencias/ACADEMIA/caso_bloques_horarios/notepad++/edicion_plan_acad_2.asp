...
url_leng_1 = "edicion_plan_acad_2.asp?leng=1&bloq_ccod="&a&"&ssec_ncorr="&b&"&pers_ncorr="&c
url_leng_2 = "edicion_plan_acad_2.asp?leng=2&bloq_ccod="&a&"&ssec_ncorr="&b&"&pers_ncorr="&c
...
sql = "select isnull(b.srol_npermiso,0) from sis_roles_usuarios a, sis_roles b where cast(a.pers_ncorr as varchar)='"&pers_ncorr_temporal&"' and a.srol_ncorr=b.srol_ncorr AND b.srol_ncorr = 280"
'response.write sql
permiso_bloque=conec_resul.consultaUno(sql)

sql = "select isnull(b.srol_npermiso,0) from sis_roles_usuarios a, sis_roles b where cast(a.pers_ncorr as varchar)='"&pers_ncorr_temporal&"' and a.srol_ncorr=b.srol_ncorr AND b.srol_ncorr = 281"
'response.write "<br>"&sql
permiso_asignacion=conec_resul.consultaUno(sql)
'
'tipo_permiso
'
'1.- Bloques Horarios
...
if usuario_iniciado="13670470" or usuario_iniciado="9498228" or usuario_iniciado="14255933" or usuario_iniciado="12799369" or usuario_iniciado="14255933" or usuario_iniciado="16232812" then
	permiso_bloque="1"  
end if
...
bloquesHorarios = conec_resul.ConsultaUno(consulta)

if bloquesHorarios > 0 then permiso_bloque="1" end if
...
asignacionDocente = conec_resul.ConsultaUno(consulta)
if asignacionDocente > 0 then permiso_asignacion="2" end if
'------------------------------------------------------------------------------------------------------------------------------------------
if permiso_bloque="1" then
...
sql = "select count(*) from personas a, sis_roles_usuarios b where a.pers_ncorr=b.pers_ncorr and cast(a.pers_nrut as varchar)='"&usuario_secion&"' and srol_ncorr = 27"
'response.write sql
de_docencia = conec_resul.consultaUno(sql)

sql = "select anos_ccod from sub_secciones a, periodos_academicos b where cast(ssec_ncorr as varchar)='"&subseccion&"' and a.peri_ccod=b.peri_ccod"
'response.write sql
anos_ccod = conec_resul.consultaUno(sql)
							...
							<td>
								<table border="0" cellpadding="0" cellspacing="0" width="83%">
									...
									<tr>
										...
										<td>
											<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#D8D8DE">
												<tr bgcolor="#D8D8DE">
													<td bgcolor="#D8D8DE">
														<%pagina.DibujarLenguetasFClaro Array(Array("Bloques Horario", url_leng_1), Array("Asignacion Docente", url_leng_2)), CInt(q_leng) %>
													</td>
												</tr>
											</table>
										</td>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td bgcolor="#D8D8DE">
											...
											<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
												<p>
												<!--Subtitulos de las carpetas-->
													<%
														select case q_leng
															case "1"
																pagina.Titulo = "Bloques Horarios"
															case "2"
																pagina.Titulo = "Asignacion Docentes"
														end select
													%>
												</p>
																		...
																		<td width="282">
																			<%select case q_leng
																				case "1"%>
																					<% if permiso_bloque = "1" then %>
																						<table align="left">
																							<tr> 
																								...
																								<td height="15" colspan="4" align="right"><font color="#FF0000">*</font>Campos obligatorios</td>
																								<td width="1%">&nbsp;</td>
																								<td width="1%">&nbsp;</td>
																							</tr>
																							<tr> 
																								...
																								<br>
																								<td align="right">&nbsp;</td>
																								<td width="31%" height="15" align="right"><font size="1"><strong>Asignatura - Secci&oacute;n</strong></font></td>
																							...
																							<%if mensaje_cambio = "" then %>
																								...
																								<tr> 
																									...
																									<td width="27%"><font color="#FF0000"><div id="desc_cupos">&nbsp;</div></font></td>
																									<td>&nbsp;</td>
																									<td>&nbsp;</td>
																								</tr>
																								<tr> 
																					...
																					<% else %>
																						<table>
																							<tr><td>NO POSEE PERMISO PARA BLOQUE HORARIO</td></tr>
																						</table>
																					<% end if
																			case "2"
																				if permiso_asignacion = "2" then 
																				sql="SELECT BLOQ_FINICIO_MODULO,BLOQ_FTERMINO_MODULO FROM BLOQUES_HORARIOS WHERE BLOQ_CCOD="&a
																				
																				'response.write sql
																				SET formulario = new CFormulario
																				formulario.Carga_Parametros "tabla_vacia.xml", "tabla_vacia"
																				formulario.Inicializar conec_resul
																				...
																				<table width="98%"  border="0" cellspacing="0" cellpadding="0">
																					...
																					<%if tiene_eliminados <> "0" then %>		
																						<tr>
																							<td align="left"> (R): Indica que el docente ha sido eliminado</td>
																						</tr>
																					<%end if%>
																			...
																			<%else%>
																				<table>
																					<tr><td>NO POSEE PERMISO PARA ASIGNAR DOCENTE</td></tr>
																				</table>
																			<%end if%>
																		<%end select%>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<%if sys_cierra_planificacion=false  then%>
												<% 'response.Write(permiso_bloque)
												if permiso_bloque = "1" and mensaje_cambio="" and leng= "1" then%>
													<td>
														<div align="center">
