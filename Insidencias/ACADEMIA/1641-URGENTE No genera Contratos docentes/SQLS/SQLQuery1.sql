select distinct e.tcdo_ccod                                               as tipo_contrato, 
                e.tcdo_ccod, 
                e.cdoc_ncorr, 
                b.sede_ccod, 
                b.carr_ccod, 
                ...
                , 
                max(d.tcat_valor)										  as categoria, 
                (select tcat_valor 
                 from   tipos_categoria 
                 where  tcat_ccod = protic.obtiene_categoria_carrera(a.pers_ncorr, '1', '47 ', '1', '242', 0))        as valor_categoria 
                , 
                protic.obtener_nombre_completo(a.pers_ncorr, 
                'a')         as nom, 
                protic.anexos_pendientes(a.pers_ncorr, '47 ') as pendientes, 
                protic.anexos_pendientes(a.pers_ncorr, '47 ') as calcular, 
                --protic.anexos_nuevos(a.pers_ncorr,2012) as anexos_nuevos ,    
                protic.anexos_nuevos_escuela(a.pers_ncorr, '47 ', 
                '1', '1', 2016)   as 
                anexos_nuevos_escuela, 
                protic.anexos_nuevos(a.pers_ncorr, 2016)          as anexos_creados, 
                protic.maxima_duracion_asignatura(a.pers_ncorr)   as duracion_asignatura 
from   personas a 
