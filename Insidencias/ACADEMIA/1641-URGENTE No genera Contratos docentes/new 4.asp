...
'---------------------------------------------------------------------------------------------------
 ...
 consulta = " Select * " & vbCrLf &_ 
			...
			"     and cast(year(a.CDOC_ffin) as varchar)>='"&anos_ccod&"'"& vbCrLf &_ 
			"     and a.ecdo_ccod <> 3 "

 imprime_cadena consulta, 0
...
imprime_cadena consulta_contrato, 0
...
consulta_anexos = " Select *, b.eane_ccod as estado ,b.anex_ncodigo as anexo, a.cdoc_ncorr as contrato  " & vbCrLf &_ 
			...
			" 		 and cast(year(b.ANEX_FINICIO) as varchar)='"&anos_ccod&"' "& vbCrLf &_ 			
			"        and a.ecdo_ccod=1"
			
 imprime_cadena "consulta_anexos: <br/>"&consulta_anexos, 0
