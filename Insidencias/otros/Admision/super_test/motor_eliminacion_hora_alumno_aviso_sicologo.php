...
<!-- -->
<p id="parrafo">El Alumno(a) <strong>'.$nom_alum.'</strong> Ha anulado la hora que agendo para el día <strong>'.$dia_hora.'</strong> <strong>'.$fecha_hora.'</strong> en el bloque de <strong>'.$bloque_hora.'</strong></p>
</br>
<p id="aviso" align="left">No respondas a este correo, este mensaje ha sido generado automaticamente. </p></td>
</tr>
</table>
</body>
</html>';
...
$resultado = mail($mail,"Una Hora ha sido Cancelada", $mensaje, $cabeceras);
//
if ($resultado) {
	echo 'true';
} else {
