...
<!-- -->
<p id="parrafo">Has anulado tu hora con el o la Sicólogo(a) <strong>'.$nom_sico.'</strong> para el día <strong>'.$dia_hora.'</strong> <strong>'.$fecha_hora.'</strong> en el bloque de <strong>'.$bloque_hora.'</strong></p>
...
<br>
<p id="aviso" align="left">No respondas a este correo, este mensaje ha sido generado automaticamente, <br> si necesitas contactarte con tu sicólogo hazlo en el Pacífico Online o desde la página Web de la Universidad. </p></td>
</tr>
</table>
</body>
</html>';
...
$resultado = mail($mail,"Tu Hora ha sido Cancelada", $mensaje, $cabeceras);
//
if ($resultado) {
	echo 'true';
} else {
