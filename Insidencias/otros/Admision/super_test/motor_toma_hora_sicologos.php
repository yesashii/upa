...
<!-- -->
<p id="parrafo">Has agendado una hora con el o la Sicólogo(a) <strong>'.$nom_sico.'</strong>,</p>
...
$cabeceras .= 'Bcco: mshaw@upacifico.cl' . "\r\n";
$resultado = mail($mail,"Tu Hora ha sido Tomada", $mensaje, $cabeceras);
//
if ($resultado) {
	echo 'true';
} else {
