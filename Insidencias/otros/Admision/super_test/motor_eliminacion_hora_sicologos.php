...
<!-- -->
<p id="parrafo">el o la Sicólogo(a) <strong>'.$nom_sico.'</strong>,ha anulado tu hora para el día <strong>'.$dia_hora.'</strong> <strong>'.$fecha_hora.'</strong> en el bloque de <strong>'.$bloque_hora.'</strong></p>
