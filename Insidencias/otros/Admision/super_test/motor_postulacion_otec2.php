...
<td align="left">
<!--  -->
<span id="parrafo">Estimado(a) : <strong>'.$nom_post.'</strong> &nbsp; &nbsp; </td>
</tr>
</table>
<!-- -->
<p id="parrafo">Tu postulación al programa <strong>'.$programa.'</strong> ha sido registrada exitosamente, tu número de postulación es <strong>'.$pote_ncorr.'</strong>.</p>
