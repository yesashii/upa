    ...
    public class contratos : DataSet {
        ...
        public class _TableDataTable : DataTable, System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.columnjerarquia.ReadOnly = true;
            }
        ...
        public class _TableRow : DataRow {
            ...
            public string jerarquia {
                get {
                    try {
                        return ((string)(this[this.table_Table.jerarquiaColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("No se puede obtener el valor porque es DBNull.", e);
                    }
                ...
                set {
                    this[this.table_Table.jerarquiaColumn] = value;
                }
            }
            ...
            public bool IsjerarquiaNull() {
                return this.IsNull(this.table_Table.jerarquiaColumn);
            }
            
            public void SetjerarquiaNull() {
                this[this.table_Table.jerarquiaColumn] = System.Convert.DBNull;
            }
        }
