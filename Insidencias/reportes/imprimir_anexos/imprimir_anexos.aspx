...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="WebForm1" method="post" runat="server">
			<CR:CRYSTALREPORTVIEWER id="VerContrato" style="Z-INDEX: 101; LEFT: 21px; POSITION: absolute; TOP: 17px" runat="server" Width="350px" Height="50px"></CR:CRYSTALREPORTVIEWER></form>
	</body>
</HTML>
