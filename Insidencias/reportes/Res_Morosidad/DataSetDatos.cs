...
namespace Res_Morosidad {
    ...
    public class DataSetDatos : DataSet {
        ...
        public class T_DatosDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public T_DatosRow AddT_DatosRow(string FECHA_CORTE, string SEDE_TDESC, string CARRERA, string TING_TDESC, string COMPROMETIDO, string SALDO) {
        ...
        public class T_DatosRow : DataRow {
            ...
            public string TING_TDESC {
                get {
                    try {
                        return ((string)(this[this.tableT_Datos.TING_TDESCColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("No se puede obtener el valor porque es DBNull.", e);
                    }
                ...
                set {
                    this[this.tableT_Datos.TING_TDESCColumn] = value;
                }
            }
            ...
            public bool IsTING_TDESCNull() {
                return this.IsNull(this.tableT_Datos.TING_TDESCColumn);
            }
            
            public void SetTING_TDESCNull() {
                this[this.tableT_Datos.TING_TDESCColumn] = System.Convert.DBNull;
            }
