...
namespace repactaciones {
    ...
    public class DataSet1 : DataSet {
        ...
        public class DETALLESDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public DETALLESRow AddDETALLESRow(int ORDEN, string ENCABEZADO, int TING_CCOD, int INGR_NCORR, int DING_NDOCTO, string BANC_TDESC, System.DateTime DING_FDOCTO, int BANC_CCOD, string TING_TDESC, int MONTO1, int MONTO2, int MONTO3) {
            ...
            private void InitClass() {
                ...
                this.columnDING_NDOCTO = new DataColumn("DING_NDOCTO", typeof(int), null, System.Data.MappingType.Element);
        ...
        public class DETALLESRow : DataRow {
            ...
            public int DING_NDOCTO {
                get {
                    try {
                        return ((int)(this[this.tableDETALLES.DING_NDOCTOColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("No se puede obtener el valor porque es DBNull.", e);
                    }
