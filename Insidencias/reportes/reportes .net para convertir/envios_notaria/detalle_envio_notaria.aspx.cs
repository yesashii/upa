...
namespace envios_notaria
{
	...
	public class WebForm1 : System.Web.UI.Page
	{
		...
		protected envios_notaria.DataSet1 dataSet11;
		...
		{
		 string sql;
			sql =  "SELECT a.envi_ncorr, a.envi_fenvio, h.inen_tdesc, b.ting_ccod, b.ingr_ncorr, ";
		...
		{    
			...
			this.dataSet11 = new envios_notaria.DataSet1();
