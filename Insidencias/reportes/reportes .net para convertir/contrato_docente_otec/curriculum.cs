...
namespace contrato_docente_otec {
    ...
    public class curriculum : ReportClass {
    ...
    public class Cachedcurriculum : Component, ICachedReport {
        
        public Cachedcurriculum() {
        }
