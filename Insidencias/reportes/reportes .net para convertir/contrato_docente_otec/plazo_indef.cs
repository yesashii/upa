...
namespace contrato_docente_otec {
    ...
    public class plazo_indef : ReportClass {
    ...
    public class Cachedplazo_indef : Component, ICachedReport {
        
        public Cachedplazo_indef() {
        }
        ...
        public virtual ReportDocument CreateReport() {
            plazo_indef rpt = new plazo_indef();
            rpt.Site = this.Site;
            return rpt;
        }
