...
namespace contrato_docente_otec {
    ...
    public class plazoFijo : ReportClass {
    ...
    public class CachedplazoFijo : Component, ICachedReport {
        
        public CachedplazoFijo() {
        }
