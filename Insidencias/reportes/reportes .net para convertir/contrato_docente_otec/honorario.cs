...
namespace contrato_docente_otec {
    ...
    public class honorario : ReportClass {
    ...
    public class Cachedhonorario : Component, ICachedReport {
        
        public Cachedhonorario() {
        }
