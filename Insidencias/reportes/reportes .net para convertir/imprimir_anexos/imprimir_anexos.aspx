...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="WebForm1" method="post" runat="server">
			<CR:CRYSTALREPORTVIEWER id="VerContrato" style="Z-INDEX: 101; POSITION: absolute; TOP: 17px; LEFT: 21px" runat="server" Width="350px" Height="50px"></CR:CRYSTALREPORTVIEWER></form>
	</body>
</HTML>
