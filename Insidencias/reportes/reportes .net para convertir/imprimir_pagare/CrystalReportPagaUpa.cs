...
namespace imprimir_pagare {
    ...
    public class CrystalReportPagaUpa : ReportClass {
        
        public CrystalReportPagaUpa() {
        }
    ...
    public class CachedCrystalReportPagaUpa : Component, ICachedReport {
        
        public CachedCrystalReportPagaUpa() {
        }
