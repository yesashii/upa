	...
	return (sql);
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( imprimirFinanza=="S")
			{
				...
				else if (tipo_pagare=="B1")// Pagare Cae
				{ 
				...
				else if (tipo_pagare=="B2")// Pagare Cae
				{ 
			...
			CrystalReportPagaCae1 reporteCae = new CrystalReportPagaCae1();
