...
namespace imprimir_contrato_1 {
    ...
    public class ReporteMagister : ReportClass {
        
        public ReporteMagister() {
        }
        
        public override String ResourceName {
            get {
                return "ReporteMagister.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReporteMagister : Component, ICachedReport {
        
        public CachedReporteMagister() {
        }
        ...
        public virtual ReportDocument CreateReport() {
            ReporteMagister rpt = new ReporteMagister();
            rpt.Site = this.Site;
            return rpt;
        }
