...
//listo
		private string generar_sql_contrato(string Contrato, string Periodo, int numero_hoja, string nombre_hoja) 
		{
		  string sql = "";
			...
			sql=" SELECT  '"+numero_hoja +" ' as numero_hoja, '"+ nombre_hoja+" ' as nombre_hoja, a.cont_ncorr, CONVERT(VARCHAR(10),protic.trunc(a.cont_fcontrato))+' '+ CONVERT(VARCHAR(5),CONVERT(TIME,a.cont_fcontrato)) as f_contrato, a.audi_tusuario, 'Carrera       :   ' +cast(e.carr_tdesc as varchar(100)) as carrera, ";
...
//listo		
		private string generar_sql_cuotas (string Contrato, string Periodo)
		{
			...
			sql = sql +" 	and isnull(f.ting_ccod,0) in (0, 3, 4,13,51,52,59,66,173,174,175)  ";
...
*/
		...
		{
			string SQL = "";
			SQL = SQL +"select ' " + numero_hoja + " '                         as numero_hoja, \n";
			SQL = SQL +"       ' " + nombre_hoja + " '                         as nombre_hoja, \n";
			SQL = SQL +"       b.comp_ndocto                                   as cont_ncorr, \n";
			SQL = SQL +"       b.comp_fdocto                                   as f_contrato, \n";
			SQL = SQL +"       b.audi_tusuario, \n";
			SQL = SQL +"       'Curso         :   ' + d.tdet_tdesc             as carrera, \n";
			SQL = SQL +"       protic.obtener_rut(b.pers_ncorr)                as rut_alumno, \n";
			SQL = SQL +"       ''                                              as ano_ingreso, \n";
			SQL = SQL +"       e.pers_tape_paterno                             as paterno_alumno, \n";
			SQL = SQL +"       e.pers_tape_materno                             as materno_alumno, \n";
			SQL = SQL +"       e.pers_tnombre                                  as nombres_alumno, \n";
			SQL = SQL +"       protic.obtener_direccion(e.pers_ncorr, 1, 'CN') as direccion_alumno, \n";
			SQL = SQL +"       g.ciud_tcomuna                                  as ciudad_alumno, \n";
			SQL = SQL +"       g.ciud_tdesc                                    as comuna_alumno, \n";
			SQL = SQL +"       e.pers_tfono                                    as fono_alumno, \n";
			SQL = SQL +"       protic.obtener_rut(i.pers_ncorr)                as rut_apoderado, \n";
			SQL = SQL +"       i.pers_tfono                                    as fono_apoderado, \n";
			SQL = SQL +"       i.pers_tape_paterno                             as paterno_apoderado, \n";
			SQL = SQL +"       i.pers_tape_materno                             as materno_apoderado, \n";
			SQL = SQL +"       i.pers_tnombre                                  as nombres_apoderado, \n";
			SQL = SQL +"       protic.obtener_direccion(i.pers_ncorr, 1, 'CN') as direccion_apoderado, \n";
			SQL = SQL +"       k.ciud_tcomuna                                  as ciudad_apoderado, \n";
			SQL = SQL +"       k.ciud_tdesc                                    as comuna_apoderado, \n";
			SQL = SQL +"       l.igas_tcodigo, \n";
			SQL = SQL +"       m.ccos_tcodigo, \n";
			SQL = SQL +"       '2'                                             as tipo_impresion \n";
			SQL = SQL +"from   sim_pactaciones as a \n";
			SQL = SQL +"       inner join compromisos as b \n";
			SQL = SQL +"               on a.comp_ndocto = b.comp_ndocto \n";
			SQL = SQL +"                  and a.tcom_ccod = b.tcom_ccod \n";
			SQL = SQL +"                  and a.inst_ccod = b.inst_ccod \n";
			SQL = SQL +"       inner join tipos_detalle as d \n";
			SQL = SQL +"               on a.tdet_ccod = d.tdet_ccod \n";
			SQL = SQL +"       inner join personas as e \n";
			SQL = SQL +"               on b.pers_ncorr = e.pers_ncorr \n";
			SQL = SQL +"       inner join direcciones as f \n";
			SQL = SQL +"               on e.pers_ncorr = f.pers_ncorr \n";
			SQL = SQL +"                  and f.tdir_ccod = 1 \n";
			SQL = SQL +"       inner join ciudades as g \n";
			SQL = SQL +"               on f.ciud_ccod = g.ciud_ccod \n";
			SQL = SQL +"       inner join direcciones as j \n";
			SQL = SQL +"               on j.tdir_ccod = 1 \n";
			SQL = SQL +"       inner join personas as i \n";
			SQL = SQL +"               on i.pers_ncorr = j.pers_ncorr \n";
			SQL = SQL +"       inner join (select max(d.pers_ncorr_codeudor) as pers_ncorr_codeudor \n";
			SQL = SQL +"                   from   sim_pactaciones as a \n";
			SQL = SQL +"                          inner join abonos as b \n";
			SQL = SQL +"                                  on a.tcom_ccod = b.tcom_ccod \n";
			SQL = SQL +"                                     and a.inst_ccod = b.inst_ccod \n";
			SQL = SQL +"                                     and a.comp_ndocto = b.comp_ndocto \n";
			SQL = SQL +"                          inner join ingresos as c \n";
			SQL = SQL +"                                  on b.ingr_ncorr = c.ingr_ncorr \n";
			SQL = SQL +"                          inner join detalle_ingresos as d \n";
			SQL = SQL +"                                  on c.ingr_ncorr = d.ingr_ncorr \n";
			SQL = SQL +"                   where  a.comp_ndocto = ' " + Contrato + " ') as h \n";
			SQL = SQL +"               on isnull(h.pers_ncorr_codeudor, b.pers_ncorr) = i.pers_ncorr \n";
			SQL = SQL +"       inner join ciudades as k \n";
			SQL = SQL +"               on j.ciud_ccod = k.ciud_ccod \n";
			SQL = SQL +"       left outer join itemes_gasto as l \n";
			SQL = SQL +"                    on d.igas_ccod = l.igas_ccod \n";
			SQL = SQL +"       left outer join centros_costo as m \n";
			SQL = SQL +"                    on d.ccos_ccod = m.ccos_ccod \n";
			SQL = SQL +"where  a.comp_ndocto = ' " + Contrato + " ' ";
...
//listo
		private string generar_sql_cuotas_pact(string contrato) 
		{
			...
			SQL = SQL +  "  LEFT OUTER JOIN plazas i ";
			SQL = SQL +  "  	ON f.plaz_ccod = i.plaz_ccod ";
			SQL = SQL +  "  where  	e.ting_ccod in (16, 33, 173,174,175) ";
			SQL = SQL +  "  	and a.comp_ndocto = ' " + contrato + "'";
