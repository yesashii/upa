...
namespace informe_1 {
    ...
    public class datosInforme : DataSet {
        ...
        protected datosInforme(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            datosInforme cln = ((datosInforme)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "datosInforme";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/datosInforme.xsd";
