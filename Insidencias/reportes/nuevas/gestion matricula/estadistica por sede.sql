Select aa.sede_ccod,aa.sede_tdesc, aa.carr_ccod, f.carr_tdesc+'- ('+(substring(e.jorn_tdesc,1,1))+')' as carr_tdesc, 
 ...
 where a.sede_ccod = '1'  
  ...
  and c.audi_tusuario not in ('Agregabase_saenzBeta2','AgregaBaseSaenzBeta2','AgregaNota2T','AgregaNota37','AgregaNota3Nuevo','AgregaNota41','AgregaNota42', 
                   ...
                   'Agregaprotix_saenzBeta2','AgregaProtixSaenzBeta2','ajuste matricula')  
 ...
 where c.emat_ccod in (1,4,8,2,15,16)  and c.audi_tusuario not like '%ajunte matricula%' and c.audi_tusuario not like '%ajuste matricula%'
 and a.sede_ccod = '1'  
 And c.pers_ncorr > 0  
