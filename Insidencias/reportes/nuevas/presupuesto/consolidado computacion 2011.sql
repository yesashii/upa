select area_tdesc as area,ccen_tdesc as concepto,nombremes as mes,ccco_ncantidad as cantidad,esol_tdesc as estado,ccco_tdesc as detalle
from presupuesto_upa.protic.centralizar_solicitud_computacion a, 
...
where a.tpre_ccod in (3) and a.tpre_ccod=b.tpre_ccod   
