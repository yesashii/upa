...
protic.obtener_nombre_carrera(c.ofer_ncorr,'CJ') as carrera,i.sede_tdesc as sede_carrera,ii.sede_tdesc as sede_actuali,
...
a.ding_ndocto as num_docto, cast(a.ding_mdocto as numeric) as monto, (protic.total_recepcionar_cuota(c.tcom_ccod,c.inst_ccod,c.comp_ndocto,c.dcom_ncompromiso)) as total_abonado,
a.banc_ccod,
...
from detalle_ingresos a, ingresos b , abonos c, compromisos d, estados_detalle_ingresos e,detalle_compromisos f
...
and d.comp_ndocto=f.comp_ndocto
and d.tcom_ccod=f.tcom_ccod
and d.inst_ccod=f.inst_ccod ) as ab 
