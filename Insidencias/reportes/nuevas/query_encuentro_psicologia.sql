select sum(g.ingr_mtotal) as monto_pago,g.ingr_nfolio_referencia as comprobante,
protic.trunc(max(g.ingr_fpago)) as fecha_inscripcion,d.tdet_tdesc as programa,
 protic.obtener_nombre(b.pers_ncorr,'n') as alumno,protic.obtener_rut(b.pers_ncorr) as rut,
...
and c.tdet_ccod in (1382)
group by g.ingr_nfolio_referencia,b.pers_ncorr,c.tdet_ccod,d.tdet_tdesc 
