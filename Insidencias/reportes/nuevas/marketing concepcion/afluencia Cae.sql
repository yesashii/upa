select cast(pers_nrut as varchar)+'-'+cast(pers_xdv as varchar) as rut,d.post_ncorr,a.pers_ncorr, f.carr_tdesc as carrera, c.sede_ccod, f.area_ccod, c.peri_ccod,
 ...
 where a.pers_ncorr = d.pers_ncorr   
   ...
   and d.audi_tusuario not in ('Agregabase_saenzBeta2','AgregaBaseSaenzBeta2','AgregaNota2T','AgregaNota37','AgregaNota3Nuevo','AgregaNota41','AgregaNota42',  
    ...
    and d.post_ncorr in (
        ...
        UNION
        select distinct post_ncorr from alumno_credito where tdet_ccod='1402'
    )                   
 group by a.pers_ncorr, f.carr_tdesc, e.carr_ccod,f.area_ccod, c.peri_ccod,pers_nrut, pers_xdv, pers_tnombre,
          pers_tape_paterno,pers_tape_materno,pers_fnacimiento,d.matr_ncorr, d.post_ncorr, c.sede_ccod
