select b.sede_tdesc,a.facu_ccod,a.sede_ccod,a.facultad ,
cast(sum(total_arancel) as numeric) as arancel,cast(sum(total_titulacion) as numeric) as titulacion, cast(isnull(sum(total_arancel),0)+isnull(sum(total_titulacion),0) as numeric) as total
From (
         ...
         from (     
          ...
          case when b.ting_ccod is null and a.ingr_mefectivo is not null then a.ingr_mefectivo 
            ...
            join contratos e
                ...
                and e.peri_ccod in (select peri_ccod from periodos_academicos where anos_ccod ='2006')
            join alumnos f
