select distinct susu_tlogin as login, susu_tclave as clave, protic.obtener_rut(a.pers_ncorr) as  rut,
protic.obtener_nombre_completo(a.pers_ncorr,'n') as _docente, 
