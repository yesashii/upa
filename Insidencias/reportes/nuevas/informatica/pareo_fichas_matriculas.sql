select carrera,emat_tdesc,matr_ncorr,tipo_alumno,max(tipo_evento) as tipo_evento,--max(even_tnombre) as nombre_evento,
...
from (
        select  d.pers_tnombre as nombres,d.pers_tape_paterno as paterno, d.pers_tape_materno as materno,
...
carrera,ciud_tcomuna,ciud_tdesc,tipo_alumno,anio_rendido--,tipo_evento
