...
isnull((select top 1 post_nano_paa from postulantes tt where tt.pers_ncorr=a.pers_ncorr and isnull(post_npaa_verbal,0) > 0 and isnull(post_npaa_matematicas,0) > 0 and tt.post_ncorr=d.post_ncorr and post_nano_paa=2009 ),
       0 ) as anio_psu,
isnull((select top 1 post_npaa_verbal from postulantes tt where tt.pers_ncorr=a.pers_ncorr and isnull(post_npaa_verbal,0) > 0 and isnull(post_npaa_matematicas,0) > 0 and tt.post_ncorr=d.post_ncorr),
       0 ) as verbal,
isnull((select top 1 post_npaa_matematicas from postulantes tt where tt.pers_ncorr=a.pers_ncorr and isnull(post_npaa_matematicas,0) > 0 and isnull(post_npaa_verbal,0) > 0 and tt.post_ncorr=d.post_ncorr),
       0 )  as matematicas,
