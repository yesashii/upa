...
isnull((select top 1 post_nano_paa from postulantes tt where tt.pers_ncorr=a.pers_ncorr and isnull(post_npaa_verbal,0) > 0 and isnull(post_npaa_matematicas,0) > 0  order by POST_NANO_PAA desc),
       0 ) as verbal,
