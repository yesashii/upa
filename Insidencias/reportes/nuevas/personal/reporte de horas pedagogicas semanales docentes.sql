select rut,nombre_docente,tipo_profesor,grado,descripcion_grado,pers_ncorr,sum(sesiones) as sesiones,sum (hora_semana) as hora_semana_peda,sum(horas_pedagogicas_semana) as horas_pedagogicas_crono
from (
...
group by rut,nombre_docente,tipo_profesor,grado,pers_ncorr,descripcion_grado
