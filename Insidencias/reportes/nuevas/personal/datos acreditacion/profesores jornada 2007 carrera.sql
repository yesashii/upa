...
cc.sexo_tdesc as genero,aa.tipo_profesor,carrera,aa.grado,
...
from  (
        ...
        pers_ncorr,rut,tipo_profesor,carrera,
        ...
        from (
            ...
            cast(sum(sesiones)as numeric)+b.anex_nhoras_coordina as horas,duas_tdesc as regimen,tipo_profesor,carrera    
            from (  
                select  e.sede_tdesc as sede,a.pers_ncorr,(c.dane_nsesiones/2) as sesiones,c.duas_ccod, 
                b.anex_ncorr,c.dane_msesion as monto_cuota,o.tpro_tdesc as tipo_profesor,q.carr_tdesc as carrera   
                  From contratos_docentes_upa a, anexos b, detalle_anexos c, personas d,  sedes e,    
 			                 asignaturas j, secciones n,tipos_profesores o,profesores p, carreras q      
                ...
                group by e.sede_tdesc,c.secc_ccod,a.pers_ncorr,b.anex_ncorr,a.cdoc_ncorr,c.dane_nsesiones,c.dane_msesion,tpro_tdesc ,c.duas_ccod,q.carr_tdesc   
             ) as aa,    
            anexos b, duracion_asignatura c   
            where aa.anex_ncorr=b.anex_ncorr
            and  aa.duas_ccod=c.duas_ccod
            group by sede,b.anex_ncorr,pers_ncorr,b.anex_nhoras_coordina,monto_cuota,b.anex_ncuotas,tipo_profesor,duas_tdesc,carrera
        ) as t
        group by sede,rut,regimen,tipo_profesor,pers_ncorr,carrera
...
cc.sexo_tdesc,bb.pers_tnombre, bb.pers_tape_paterno, bb.pers_tape_materno, carrera  
...
q.sexo_tdesc as genero,o.tpro_tdesc as tipo_profesor,k.carr_tdesc as carrera,protic.obtener_grado_docente(a.pers_ncorr,'G') as grado,
...
case admd_jornada when 1 then 'Completa' else 'Media' end as jornada
      From contratos_docentes_upa a, anexos b, detalle_anexos c, personas d,  sedes e,    
          ...
          bloques_horarios i,secciones j, carreras k  
 	  Where a.cdoc_ncorr     =   b.cdoc_ncorr     
 		 and b.anex_ncorr    =   c.anex_ncorr     
 		 and a.pers_ncorr    =   d.pers_ncorr     
 		 and b.sede_ccod     =   e.sede_ccod     
         ...
         and c.bloq_ccod=i.bloq_ccod
         and i.SECC_CCOD = j.SECC_CCOD
         and j.carr_ccod=k.carr_ccod
         ...
         and n.carr_ccod in (select carr_ccod from carreras where tcar_ccod=1)
         --and convert(datetime,b.anex_finicio,103)<=convert(datetime,'30/04/2006',103)
         and a.pers_ncorr not in (27208,12258)
