--##########################################
-- listado profesores 2006
select distinct a.tpro_ccod,protic.obtener_rut(b.pers_ncorr) as rut,b.pers_tape_paterno as apellido_paterno,
b.pers_tape_materno as apellido_materno,b.pers_tnombre as nombre_docente,max(isnull(prof_ingreso_uas,0)) as ano_ingreso
from profesores a, personas b, bloques_profesores c ,bloques_horarios d, secciones e
where a.pers_ncorr=b.pers_ncorr
and b.pers_ncorr=c.pers_ncorr
and c.bloq_ccod=d.bloq_ccod
and d.secc_ccod=e.secc_ccod
and e.peri_ccod in (202,204,205)
and a.tpro_ccod=1
group by a.tpro_ccod,b.pers_ncorr,b.pers_tape_paterno,
b.pers_tape_materno,b.pers_tnombre
...
((sum(horas)*76)/60)/case regimen when 'ANUAL'then 36
...
group by rut,nombre_docente,regimen,tipo_profesor,tipo_profesor,pers_ncorr
