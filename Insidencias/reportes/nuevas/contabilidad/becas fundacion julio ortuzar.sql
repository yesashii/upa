  select distinct o.ingr_nfolio_referencia as comprobante, mcaj_ncorr as caja, protic.trunc(ingr_fpago) as fecha_pago,
             i.tben_tdesc, a.stde_ccod, b.stde_tdesc, c.esde_tdesc, a.post_ncorr, d.pers_ncorr, a.ofer_ncorr, e.sede_ccod,   
		     ...
		     h.carr_tdesc,cast(a.sdes_mmatricula as int) as sdes_mmatricula,   
		     ...
		     from sdescuentos a,stipos_descuentos b,sestados_descuentos c,   
		           ...
		           especialidades g,carreras h,tipos_beneficios i,sedes j, contratos k, abonos l, ingresos o   
