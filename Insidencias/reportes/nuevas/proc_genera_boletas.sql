Alter procedure genera_boletas (
@p_opcion numeric,
    ...
    INTO @r_tbol_ccod, @r_monto_total, @r_pers_ncorr
	    ...
	    begin
            ...
            set @v_boleta_actual= null
                ...
                select @v_boleta_actual=isnull(rbca_nactual,rbca_ninicio) , @v_rbca_ncorr=rbca_ncorr, @v_rbca_nfin=rbca_nfin
              ...
              insert into boletas(bole_ncorr,bole_nboleta,ebol_ccod,tbol_ccod,bole_mtotal,bole_fboleta, ingr_nfolio_referencia,sede_ccod, pers_ncorr, pers_ncorr_aval,mcaj_ncorr,audi_tusuario,audi_fmodificacion) 
                    values (@v_bole_ncorr,@v_boleta_actual,1,@r_tbol_ccod,@r_monto_total,getdate(),@p_folio_ccod,@p_sede_ccod, @r_pers_ncorr,@v_pers_ncorr_aval,@p_mcaj_ncorr,@p_audi_tusuario,getdate())
