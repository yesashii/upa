...
from alumnos al, ofertas_academicas oa, estados_matriculas em,periodos_academicos pa, observaciones_estado_matricula oe
where al.alum_nmatricula='7777'
and al.ofer_ncorr= oa.ofer_ncorr
and oa.peri_ccod>=230
