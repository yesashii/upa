...
and a.mcaj_ncorr in (
            select distinct mcaj_ncorr from ingresos -- and ingr_ncorrelativo_caja is not null 
            where convert(datetime,ingr_fpago,103) 
            BETWEEN  convert(datetime,'01/01/2007',103) and convert(datetime,'31/12/2007',103)
        )
