...
(select tcat_valor from tipos_categoria where tcat_ccod in (protic.obtiene_categoria_carrera(a.pers_ncorr,e.sede_ccod,d.carr_ccod,h.jorn_ccod,210,0))) as valor_categoria,
