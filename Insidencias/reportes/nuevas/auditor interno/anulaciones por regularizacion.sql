select mc.mcaj_ncorr,mc.sede_ccod,isnull(g.banc_tdesc,'sin banco') as banco,protic.trunc(d.ding_fdocto) as fecha_vencimiento, d.ding_ndocto  as numero_docto, t.ting_tdesc as tipo_docto,
cast(d.ding_mdocto as numeric)  as monto_docto,cast(k.abon_mabono as numeric) as monto_anulado, protic.trunc(a.ingr_fpago) as fecha_pago,
protic.obtener_rut(a.pers_ncorr) as rut_alumno,e.edin_tdesc as estado, c.ting_tdesc as tipo_regularizacion,ccos_tcompuesto as centro_costo,
