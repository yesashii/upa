...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<CR:CRYSTALREPORTVIEWER id="CrystalReportViewer1" style="Z-INDEX: 101; LEFT: 31px; POSITION: absolute; TOP: 23px" runat="server" Width="350px" Height="50px"></CR:CRYSTALREPORTVIEWER></form>
	</body>
</HTML>
