...
namespace morosidad_cobranza
{
	...
	public class WebForm1 : System.Web.UI.Page
	{
		...
		protected morosidad_cobranza.DataSetDatos dataSetDatos1;
		...
		private string Generar_SQL_Datos(string SEDE, string FIN)
		{
			string sql = "";
				...
				sql =       "select '" + FIN + "' as fecha_corte, d.sede_tdesc, obtener_nombre_carrera(c.ofer_ncorr, 'CEJ') as carrera,        \n";
				...
				sql = sql + "	   decode(ubicacion_morosidad(i.ting_ccod, i.ding_ndocto, i.ingr_ncorr),'0','OTRO','1', 'UAS (CARTERA)', '2', 'FERYSEC (PREJUDICIAL)', '3','FACTORY (JUDICIAL)') as grupo \n";
				...
				sql = sql + "group by d.sede_tdesc, obtener_nombre_carrera(c.ofer_ncorr, 'CEJ'), ubicacion_morosidad(i.ting_ccod, i.ding_ndocto, i.ingr_ncorr)  \n";
				...
				sql = sql + "		   case protic.ubicacion_morosidad(i.ting_ccod, i.ding_ndocto, i.ingr_ncorr) when '0' then 'OTRO' when '1' then 'UPACIFICO (CARTERA)' when '2' then 'COBRACAR (COBRANZA)' when '3' then 'SOCOFIN (COBRANZA)' end as grupo \n";
				sql = sql + "	from personas a, alumnos b, ofertas_academicas c, sedes d, \n";
				sql = sql + "	     compromisos e, detalle_compromisos f, abonos g, ingresos h, detalle_ingresos i, tipos_ingresos j \n";
				sql = sql + "	where a.pers_ncorr = b.pers_ncorr \n";
				sql = sql + "	  and b.ofer_ncorr = c.ofer_ncorr \n";
				...
				sql = sql + "	group by d.sede_tdesc, protic.obtener_nombre_carrera(c.ofer_ncorr, 'CEJ'), protic.ubicacion_morosidad(i.ting_ccod, i.ding_ndocto, i.ingr_ncorr)  \n";
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			DbDataAdapter.Fill(dataSetDatos1);
