...
namespace rep_det_cob {
    ...
    public class datosReporte : DataSet {
        ...
        public class reporteDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public reporteRow AddreporteRow(string TIPO, string FECHA_EMISION, string NRO_NDOCTO, string MONTO, string FECHA_VEN, string ESTADO, string RUT_ALUMNO, string RUT_APODERADO, string c_corriente) {
        ...
        public class reporteRow : DataRow {
            ...
            public string c_corriente {
                get {
                    try {
                        return ((string)(this[this.tablereporte.c_corrienteColumn]));
                    }
                    catch (InvalidCastException e) {
                        throw new StrongTypingException("No se puede obtener el valor porque es DBNull.", e);
                    }
                ...
                set {
                    this[this.tablereporte.c_corrienteColumn] = value;
                }
            }
            ...
            public bool Isc_corrienteNull() {
                return this.IsNull(this.tablereporte.c_corrienteColumn);
            }
            
            public void Setc_corrienteNull() {
                this[this.tablereporte.c_corrienteColumn] = System.Convert.DBNull;
            }
        }
